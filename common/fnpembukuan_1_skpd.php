...
class Pembukuan_skpdObj2 extends DaftarObj2{
	var $Prefix = 'Pembukuan2skpd'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
...
function genDaftar($Kondisi='', $Order='', $Limit='', $noAwal = 0, $Mode=1, $vKondisi_old=''){
		...
		$TampilOpt =
			...
			<td style='padding:1 8 0 8; '  valign=\"top\">".
			 "<table><tr><td width='100'>BIDANG</td><td width='10'>:</td><td>".
					$this->cmbQueryBidang('fmSKPDBidang',$fmSKPDBidang,'','onchange=Pembukuan2skpd.BidangAfter() '.$disabled1,'--- Pilih BIDANG ---','00')."</td></tr>".
				"<tr><td width='100'>SKPD</td><td width='10'>:</td><td>".
					$this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=Pembukuan2skpd.SKPDAfter() '.$disabled1,'--- Pilih SKPD ---','00').
				"</td></tr></table>".
			"</td>
			</tr></table>".
			...
			genFilterBar(
				array(	
					...
					"<input $cbxSubunit id='cbxSubunit' type='checkbox' value='checked' name='cbxSubunit'> SUBUNIT "
	...
	function setKolomHeader($Mode=1, $Checkbox=''){
		...
		$headerTable =
			"<thead><tr>
				<th class=\"th02\" width='30' rowspan=2>No.</th>
				<th class=\"th02\" rowspan=2>SKPD</th>
			...
			<tr>
				...
				<th class=\"th02\" >Jumlah<br>Harga (Rp.)</th>
				<th class=\"th02\" >Jumlah<br>Barang</th>				
				<th class=\"th02\" >Jumlah<br>Harga (Rp.)</th>
				<th class=\"th02\" >Jumlah<br>Barang</th>				
				<th class=\"th02\" >Jumlah<br>Harga (Rp.)</th>
...
$Pembukuan2skpd = new Pembukuan_skpdObj2();
