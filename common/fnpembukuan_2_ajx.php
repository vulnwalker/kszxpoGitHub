...
.nfmt5 {
	...
	**/
	...
	function genDaftarOpsi(){
		global $Main,$fmFiltThnBuku, $HTTP_,$HTTP_COOKIE_VARS;
		...
		$fmSemester=empty($_REQUEST['fmSemester'])? '2' : $_REQUEST['fmSemester']; 
...
table
	...
	function gen_table_data($Mode=1){
		...
		$jnsrekap = $_REQUEST['jnsrekap'];
		//$fmFiltThnBuku = empty($_REQUEST['fmFiltThnBuku'])? date('Y') : $_REQUEST['fmFiltThnBuku']; 
		$fmFiltThnBuku = empty($_REQUEST['fmFiltThnBuku'])? $thnAnggaran : $_REQUEST['fmFiltThnBuku']; 
		$des = $jnsrekap==1? 2:0;
		...
		$smter=empty($_REQUEST['fmSemester'])? '2' : $_REQUEST['fmSemester']; 
