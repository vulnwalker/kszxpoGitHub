<?php
//kertas kerja
class RekapSKPDObj extends DaftarObj2{
	var $Prefix = 'RekapSKPD'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
	...
	//cetak --------------------
	var $cetak_xls=FALSE ;
	var $fileNameExcel='RekapSKPD.xls';
	var $Cetak_Judul = 'Rekap  SKPD';
	//var $Cetak_Header;
	var $Cetak_Mode=2;
	...
	**/
	...
	function genDaftarInitial(){
		...
		return		
			...
			//"<input type='hidden'  name='fmLvlSkpd' id=fmLvlSkpd' value='$fmLvlSkpd'>". 
				//$vOpsi['TampilOpt'].
			"</div>".
	...
	function setCetakTitle(){
		...
		$judul=" <DIV ALIGN=CENTER>Rekap ";
		if ($this->cetak_xls==TRUE)
		{
			$judul="<table width='100%'><tr><td colspan=6>Rekap x</td></tr></table>";
		}
		return $judul;
	}
	...
	function genDaftarOpsi(){
		...
		$c1 = $_REQUEST['RekapSKPDSkpdfmURUSAN'];
		$c = $_REQUEST['RekapSKPDSkpdfmSKPD'];
		$d = $_REQUEST['RekapSKPDSkpdfmUNIT'];
		$e = $_REQUEST['RekapSKPDSkpdfmSUBUNIT'];	
		$e1 = $_REQUEST['RekapSKPDSkpdfmSUBUNIT'];
		$arrLevelSKPD = array(
			array('1','Level 2'),
			array('2','Level 3'),
			array('3','Level 4'),
		...
		if($c1=="00" || empty($c1)){
			...
			if($c1!="00") $fmLvlSkpd=0; 
			if($c!="00") $fmLvlSkpd=1;
			if($d!="00") $fmLvlSkpd=2;
			if($e!="00") $fmLvlSkpd=3;
			if($e1!="000") $fmLvlSkpd=4;				
		}
...
table
	...
	global $Main,$HTTP_COOKIE_VARS;
		...
		$d = $_REQUEST['RekapSKPDSkpdfmUNIT'];
		$e = $_REQUEST['RekapSKPDSkpdfmSUBUNIT'];	
		$e1 = $_REQUEST['RekapSKPDSkpdfmSEKSI'];
		...
		$headerTable =
			...
			"<tr>
				...
				<th class=\"th02\" rowspan='3' >Total</th>
			</tr>
			<tr>
	...
	// $smter=$_POST['$fmSemester'];
		...
		$cek = $Main->SHOW_CEK  ? $cek : '';
			$ListData .="<tr class='row1'>
				...
				<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td>
				<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td>	<td class='GarisDaftar' align=right>&nbsp;</td> <td class='GarisDaftar' align=right>&nbsp;</td><td class='GarisDaftar' align=right>&nbsp;</td><td class='GarisDaftar' align=right>&nbsp;</td>
			...
			switch($fmLvlSkpd){
				...
				case '4': $get_table="ref_skpd"; $sel="c1,c,d,e,e1"; $konLvl1="c1<>'000'"; break;
			...
			*/	
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				//tampil aset tetap -------------------------------------------------------------------
				$rowno ++;
				if($fmLvlSkpd=='1' || $fmLvlSkpd=='2' || $fmLvlSkpd=='3' || $fmLvlSkpd=='4'){
					$bold = ($isix['c']=='00') || ($isix['c']<>'00' && $isix['d']=='00') || ($isix['c']<>'00' && $isix['d']<>'00' && $isix['e']<>'00' && $isix['e1']=='000') ? 1 : 0;
				}else{
					$bold = 0;
				}
				...
				if(($isix['e1'] != '' || $isix['e1']!='000') ) {$arrParamSKPD[] = "e1=".$isix['e1']."";}
				else{ $arrParamSKPD[] = "e1=000";}				
				...
				if($fmLvlSkpd=='1' || $fmLvlSkpd=='2' || $fmLvlSkpd=='3' || $fmLvlSkpd=='4'){
					if($isix['c']=='00'){
						...
						$ve = "<b>$e</b>";
						$ve1 = "<b>$e1</b>";
					}elseif($isix['c']<>'00' && $isix['d']<>'00' && $isix['e']<>'00' && $isix['e1']=='000'){
						//$vnmbarang = "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>";
						...
						$vnmbidang = "<b><span class='tab60'>{$isix['nm_skpd']}</span></b>";
						$vc1 = "{$isix['c1']}";
						$vc = "$kdBidang";
						$vd = "$d";
						$ve = "$e";
					...
					if($fmLvlSkpd=='1'){
						...
						$vc1 = $isix['c']=='00' ? "<b>{$isix['c1']}</b>" : "{$isix['c1']}";
						$vc = $isix['c']=='00' ? "<b>$kdBidang</b>" : "$kdBidang";
						$vd = $isix['c']=='00' ? "<b>$d</b>" : "$d";
						$ve = $isix['c']=='00' ? "<b>$e</b>" : "$e";
						$ve1 = $isix['c']=='00' ? "<b>$e1</b>" : "$e1";
					}else{
				...
				//kode barang f,g,h,i
				if($fmLvlSkpd=='1'){
					$daftarKodeBarang = "<td class='GarisDaftar' align=right>$vc</td>";
				}elseif($fmLvlSkpd=='2'){
					$daftarKodeBarang = "<td class='GarisDaftar' align=right>$vc</td>
										<td class='GarisDaftar' align=right>$vd</td>";
				}elseif($fmLvlSkpd=='3'){
					$daftarKodeBarang = "<td class='GarisDaftar' align=right>$vc</td>
										<td class='GarisDaftar' align=right>$vd</td>
										<td class='GarisDaftar' align=right>$ve</td>";
				}elseif($fmLvlSkpd=='4'){
					$daftarKodeBarang = "<td class='GarisDaftar' align=right>$vc</td>
										<td class='GarisDaftar' align=right>$vd</td>
										<td class='GarisDaftar' align=right>$ve</td>
										<td class='GarisDaftar' align=right>$ve1</td>";
				}else{
					$daftarKodeBarang = "";
				}
				...
				<td class='GarisDaftar' align=right>$vc1</td>
				$daftarKodeBarang
				<td class='GarisDaftar' >$vnmbidang</td>
				
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=01&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_1' name='vrekap'>$TampilJmlSaldoAwSKPD</a></td>
				
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=02&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_2' name='vrekap'>$TampilJmlSusutAw</a></td>
				
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=03&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlBelanjaSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=04&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlAtribusiSKPD</a></td>".
				
				"<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=05&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlHibahDSKPD</a></td>". //penerimaan hibah				
				"<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=01&kb=06&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlKapitalisasiDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=01&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlKapitalisasiKSKPD</a></td>
				
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=02&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlHibahKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=03&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlMutasiDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=04&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlMutasiKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=05&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlPenilaianDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=06&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlPenghapusanKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=01&ka=02&kb=07&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlPenghapusanKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&kint=02&ka=00&kb=00&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlPenghapusanKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$hrefAk&tanpasusut=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlPenghapusanKSKPD</a></td>
			...
			if($KondisiSKPD!=""){
				...
				if(($e1 != '' || $e1!='000') ) {$arrParamSKPD[] = "e1=".$e1."";}
				else{ $arrParamSKPD[] = "e1=000";}								
				$paramSKPD = join('&', $arrParamSKPD);
				$paramSKPD = $paramSKPD==''? '' : '&'.$paramSKPD;	
				//$paramSKPD = $paramSKPD;						
	...
	function setCetak_Header($Mode=''){
		...
		return
			...
			<tr>
				<td class=\"judulcetak\" colspan=6>REKAP </td>
			</tr>
			</table>"	
			.$printSKPD."<br>";
	}
	...
	function rekapSKPD(){
		...
		*/
		...
		$aqry = " select  ".			
			...
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='02' and jns_trans<>10, debet-kredit  ,0) ) as total2_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='02' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total2_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='03' and jns_trans<>10, debet-kredit  ,0) ) as total3_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='03' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total3_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='04' and jns_trans<>10, debet-kredit  ,0) ) as total4_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='04' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total4_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='05' and jns_trans<>10, debet-kredit  ,0) ) as total5_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='05' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total5_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='06' and jns_trans<>10, debet-kredit  ,0) ) as total6_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='01' and kb='06' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total6_2, 
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='01' and jns_trans<>10, debet-kredit  ,0) ) as total7_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='01' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total7_2,

			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='02' and jns_trans<>10, debet-kredit  ,0) ) as total8_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='02' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total8_2,

			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='03' and jns_trans<>10, debet-kredit  ,0) ) as total9_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='03' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total9_2,

			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='04' and jns_trans<>10, debet-kredit  ,0) ) as total10_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='04' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total10_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='05' and jns_trans<>10, debet-kredit  ,0) ) as total11_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='05' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total11_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='06' and jns_trans<>10, debet-kredit  ,0) ) as total112_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='06' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total112_2,
			
			sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='07' and jns_trans<>10, debet-kredit  ,0) ) as total13_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='01' and ka='02' and kb='07' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total13_2,

			sum( if( tgl_buku<='$tgl2' and kint='02' and ka='00' and kb='00' and jns_trans<>10, debet-kredit  ,0) ) as total14_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and kint='02' and ka='00' and kb='00' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total14_2,
			sum( if( tgl_buku<='$tgl2' and jns_trans<>10, debet-kredit  ,0) ) as total15_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku<='$tgl2' and jns_trans<>10, jml_barang_d - jml_barang_k  ,0) ) as total15_2
			".
