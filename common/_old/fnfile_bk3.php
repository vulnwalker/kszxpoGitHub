...
function WilSKPD1($kol1_width=100,$mode='') {   
...
function inputFormatRibuan3($obj="obj", $params="", $value=0, $ket=' pemisah pecahan dengan titik (mis: 1.5)',$obj2,$objsum) {
    global $$obj; //$$obj = round($$obj,0);
    //onKeyPress=\"return isNumberKey(event); \"
	//$str = " <input type=\"text\" name=\"$obj\" id=\"$obj\" value=\"" . $value . "\"
	if ($value == 0){
...
function bilang($x){
  ...
  elseif ($x < 1000000000000000)
	...
	function Penatausahaan_FormEntry($currID=0, $btCariBrg=TRUE , $entryMutasi=FALSE){
		...
		if ($tgl_buku<=$Main->TAHUN_CUTOFF.'-12-31' && $Baru==0)
		{
		   	$DataReadonly=true;
		...
		".formEntryBase2('Harga Beli Satuan ',':',
		'Rp.'.inputFormatRibuan3("fmHARGABARANGBELI", ($entryMutasi==FALSE? $htmlreadonly:' readonly="" ')),'','','','valign="top" height="24"')."		
		".formEntryBase2('Harga Atribusi Satuan',':',
		'Rp.'.inputFormatRibuan3("fmHARGABARANGATRIBUSI", ($entryMutasi==FALSE? $htmlreadonly:' readonly="" ') ),'','','','valign="top" height="24"')."		
		".formEntryBase2('Harga Perolehan Satuan ',':',
		...
		cmb2Dv2('fmKONDISIBARANG',$fmKONDISIBARANG,$Main->KondisiBarang,'',$DataReadonly), 
		"","","","valign='top' height='24'")."		
							...
							if($CekBaru == 0){
								...
								for ($noREG = $Mulai;$noREG < $Sampai;$noREG++){
									...
									$Qry = "insert into buku_induk 
										...
										'$ref_idpemegang','$ref_idpemegang2','$ref_idpenanggung',
										'".$UID."', $fmIDLama, '$fmJUMLAHBARANG','$fmSTATUSASET','$fmHARGABARANGBELI','$fmHARGABARANGATRIBUSI','$ref_idatribusi')";//, '".$POST['sesi']."$noREG') ";					
