...
function PrintSKPD($xls=''){//$fmSKPD='', $fmUNIT='', $fmSUBUNIT='', $fmSEKSI='') {
    ...
    $Hsl = "<table cellpadding=0 cellspacing=0 border=0 width='100%'>
			<!-- <tr> <td style='font-weight:bold;font-size:10pt;width:150' >Kepemilikan Barang</td><td style='font-weight:bold;font-size:10pt;width:25' >:</td><td style='font-weight:bold;font-size:10pt' >$KEPEMILIKAN</td> </tr> --> 
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' width='150'>PROVINSI</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' >". $Main->Provinsi[1]." </td> </tr> 
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >KABUPATEN/KOTA</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' > $WILAYAH</td> </tr> 
			
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >BIDANG</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' > $SKPD</td> </tr> 
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >SKPD</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' > $UNIT</td> </tr> 
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >UNIT</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' > $SUBUNIT</td> </tr> 
			<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >SUB UNIT</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td colspan='4' style='font-weight:bold;font-size:10pt' > $SEKSI</td> </tr> 
			</table>";		
	}
    return $Hsl;
}
...
function Penatausahaan_GetListDet2($idBI, $fmKIB, 
		...
		$cbxDlmRibu,$clRow, $clGaris, $tampilCheckbox, $cp2=1, $kondTglAkhir='')
	{
		...
		$k1= $kondTglAkhir==''? '': "and tgl_peng <='$kondTglAkhir' ";
		...
		if ($txls=="1"){					
			...
			$ListData .= 
			Penatausahaan_genTableRowJml($clRow, $clGaris, $colspan, 
				array("<span style='font-style:italic;float:right'>Jumlah Penyusutan (Rp)</span>",
	...
	$dokumen_file, $tgl_buku, $UID,  $fmIDLama; //{$idBI,}
		...
		switch ($Act){		
			case 'Simpan' :{
				...
				if ($errmsg=='' && $thnTglBuku < $Main->TAHUN_CUTOFF ){ $errmsg = 'Tahun Tanggal Buku tidak lebih kecil dari 2009!'; }				
