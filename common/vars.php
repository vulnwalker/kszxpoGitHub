...
<script src="js/skpd.js" type="text/javascript"></script>	
	...
	<script src="js/sensus.js" type="text/javascript"></script>	
		...
		<script src="js/kodetanah/kodetanah.js" type="text/javascript"></script>	
		<script src="js/kapitalisasi/kapitalisasi_ins.js" type="text/javascript"></script>
		<script src="js/fnCariPegawai.js" type="text/javascript"></script>	
		<script src="js/kondisi/kondisi_ins.js" type="text/javascript"></script>		
...
$Main->SettingPenyusutan=
		...
		"kibE"=>array(
					array("1","Ya"),
					array("2","Tidak"),
					array("3","YA (Hanya Aset Renovasi)")
		),
		"ATB"=>array(
					array("1","Ya"),
					array("2","Tidak")
		...
		"persentase"=>array(
					...
					array("4","Rehab pertama dari Nilai Perolehan Awal, Rehab selanjutnya dari Nilai buku + Harga Rehab")					
		),
