<?php
//kertas kerja
class KertasKerjaBaruObj extends DaftarObj2{
	var $Prefix = 'KertasKerjaBaru'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
...
.nfmt5 {
	...
	*/
		...
		*/
		...
		$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">	".	
				 $this->WilSKPD_ajx3($this->Prefix.'Skpd') . 
				 /**"<table>
					<tr><td width='100'>URUSAN</td><td width='10'>:</td><td>".
						//$this->cmbQueryUrusan('fmSKPDUrusan',$fmSKPDUrusan,'','onchange=SOTKBaru.UrusanAfter() '.$disabled1,'--- Pilih URUSAN ---','00').
						$this->cmbQueryUrusan('fmSKPDUrusan',$fmSKPDUrusan,'','onchange=KertasKerjaBaru.UrusanAfter() '.$disabled1,'--- Pilih URUSAN ---','00').
					"</td></tr>
					<tr><td width='100'>BIDANG</td><td width='10'>:</td><td>".
						$this->cmbQueryBidang('fmSKPDBidang2',$fmSKPDBidang2,'','onchange=KertasKerjaBaru.BidangAfter2() '.$disabled1,'--- Pilih BIDANG ---','00')."</td></tr>".
					"<tr><td width='100'>SKPD</td><td width='10'>:</td><td>".
						$this->cmbQuerySKPD('fmSKPDskpd2',$fmSKPDskpd2,'','onchange=KertasKerjaBaru.SKPDAfter2() '.$disabled1,'--- Pilih SKPD ---','00').
					"</td></tr>".
					"<tr><td width='100'>UNIT</td><td width='10'>:</td><td>".
						$this->cmbQueryUnit('fmSKPDUnit2',$fmSKPDUnit2,'','onchange=KertasKerjaBaru.UnitAfter2() '.$disabled1,'--- Pilih UNIT ---','00').
					"</td></tr>".
	...
	function setPage_OtherScript(){
		...
		return "<script src='js/skpdbaru.js' type='text/javascript'></script>
...
$KertasKerjaBaru= new KertasKerjaBaruObj();
