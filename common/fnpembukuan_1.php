...
function genDaftar($Kondisi='', $Order='', $Limit='', $noAwal = 0, $Mode=1, $vKondisi_old=''){
	...
	$menu_penyusutan
	<A href=\"pages.php?Pg=Rekap1\" title='Rekap BI' $styleMenu >REKAP BI</a> 
	...
	function setKolomHeader($Mode=1, $Checkbox=''){
		...
		$headerTable =
			"<thead><tr>
				...
				<th class=\"th02\" width='50' >Golongan</th>
				<th class=\"th02\" width='50' >Kode Bidang Barang</th>				
...
group by f,g with rollup
 ...
 where aa.ka='01' and aa.kb<>'00'"; //echo $sqry;
		...
		while($isi=mysql_fetch_array($Qry)){
			...
			if ($no==1)	{
		        ...
		        $ListData .= "
					...
					<td class=\"$clGaris\" align=left colspan=2 ><b>A.&nbsp;&nbsp;&nbsp;&nbsp;Aset Tetap</b></td>
		...
		//penyusutan -----------------------------------------------------------------------------
		if($Main->PENYUSUTAN){
			$susut = mysql_fetch_array(mysql_query("select sum(harga) as tot ".
				" from v1_penyusutan where 1=1 ".$KondisiSKPD." and tgl<='$tglAkhir' "));
			$vTotSusut = '('.number_format($susut['tot'],2,',','.') .')';
	...
	// aset lainnya baru ------------------------------------------------------------------------------
	 ...
	 $bqry="
		...
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=1 and kint='01' and ka='02',debet,0)) as debet_hp, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=1 and kint='01' and ka='02',harga_atribusi,0)) as debet_atribusi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=3 and kint='01' and ka='02',debet,0)) as debet_kapitalisasi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=3 and kint='01' and ka='02',kredit,0)) as kredit_kapitalisasi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=4 and kint='01' and ka='02',debet,0)) as debet_hibah, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=4 and kint='01' and ka='02',kredit,0)) as kredit_hibah, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=5 and kint='01' and ka='02',debet,0)) as debet_mutasi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=5 and kint='01' and ka='02',kredit,0)) as kredit_mutasi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=6 and kint='01' and ka='02',kredit,0)) as debet_penilaian,
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=7 and kint='01' and ka='02',debet,0)) as debet_penghapusan,  
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=7 and kint='01' and ka='02',kredit,0)) as kredit_penghapusan, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=8 and kint='01' and ka='02',debet,0)) as debet_koreksi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=8 and kint='01' and ka='02',kredit,0)) as kredit_koreksi, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=9 and kint='01' and ka='02',debet,0)) as debet_reklass, 
		sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=9 and kint='01' and ka='02',kredit,0)) as kredit_reklass, 
	...
	while($isi=mysql_fetch_array($Qry)){
		...
		*/
		...
		$bqry=
			...
			sum(if(tgl_buku<'$tglAwal',jml_barang_d,0)) as debet_saldoawal_brg, sum(if(tgl_buku<'$tglAwal',jml_barang_k,0)) as kredit_saldoawal_brg,
			sum(if(tgl_buku<'$tglAwal',debet,0)) as debet_saldoawal, sum(if(tgl_buku<'$tglAwal',kredit,0)) as kredit_saldoawal,
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=1 and kint='02',debet,0)) as debet_hp, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=1 and kint='02',harga_atribusi,0)) as debet_atribusi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=3 and kint='02',debet,0)) as debet_kapitalisasi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=3 and kint='02',kredit,0)) as kredit_kapitalisasi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=4 and kint='02',debet,0)) as debet_hibah, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=4 and kint='02',kredit,0)) as kredit_hibah, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=5 and kint='02',debet,0)) as debet_mutasi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=5 and kint='02',kredit,0)) as kredit_mutasi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=6 and kint='02',debet,0)) as debet_penilaian, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=7 and kint='02',debet,0)) as debet_penghapusan,  
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=7 and kint='02',kredit,0)) as kredit_penghapusan, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=8 and kint='02',debet,0)) as debet_koreksi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=8 and kint='02',kredit,0)) as kredit_koreksi, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=9 and kint='02',debet,0)) as debet_reklass, 
			sum(if(tgl_buku<='$tglAkhir' && tgl_buku>='$tglAwal' && jns_trans=9 and kint='02',kredit,0)) as kredit_reklass, 
