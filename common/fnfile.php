...
//include ('fnpenatausaha_akun.php');
include ('fncekintraekstra.php');
include ('fnkoreksi2.php');
include ('fnstatusaset.php');

function checkPenetapanRKBMD($tahun, $jenisAnggaran , $jenisRKBMD, $c1,$c,$d){
    return mysql_num_rows(mysql_query("select * from penetapan_rkbmd where tahun = '$tahun' and jenis_anggaran ='$jenisAnggaran' and jenis_rkbmd = '$jenisRKBMD' and c1 ='$c1' and c='$c' and d='$d'")) ;

  //  return "select * from penetapan_rkbmd where tahun = '$tahun' and jenis_anggaran ='$jenisAnggaran' and jenis_rkbmd = '$jenisRKBMD' and c1 ='$c1' and c='$c' and d='$d'" ;
}
function getImageReport(){
    // $logoReport = mysql_fetch_array(mysql_query("SELECT * from general_setting where option_name = 'logo_report'"));
    // $logoReporti = mysql_fetch_array(mysql_query("SELECT * from images where id = '".$logoReport[option_value]."' "));
    // $logoReportk = mysql_fetch_array(mysql_query("SELECT * from images_kategori where id = '".$logoReporti[kategori]."' "));
    $getLokasiGambar = mysql_fetch_array(mysql_query("select * from settingperencanaan"));
    // $lokasiGambar = "Media/images/".$logoReportk[nama]."/".$logoReporti[directory];
...
function WilSKPD_ajxVWSKPD($prefix='', $tblwidth='100%', $kol1_width=100,$mode='') {
    ...
    $PilihUrusan = "<option value='0' >--- Semua Urusan ---</option>";
	 ...
	 if(!isset($fmUrusan) ){
			...
			foreach ($arrayData as $key => $value) {
			 ...
			 if($CurrentSubUnit !='000' ){
			 	$fmSEKSI = $CurrentSubUnit;
			 	$fmSUBUNIT = $CurrentUnit;
				$fmUNIT = $CurrentSKPD;
				$fmSKPD = $CurrentBidang;
				$fmUrusan = $CurrentUrusan;
	...
	foreach ($HTTP_COOKIE_VARS as $key => $value) {
		...
		if($VulnWalkerSubUnit != '000'){
			$fmSEKSI = $VulnWalkerSubUnit;
			$fmSUBUNIT = $VulnWalkerUnit;
			$fmUNIT = $VulnWalkerSKPD;
			$fmSKPD = $VulnWalkerBidang;
			$fmUrusan = $VulnWalkerUrusan;
   	...
   	//skpd -------------------
	if($VulnWalkerUrusan != '0'){
		$aqry = "select * from ref_skpd where c1 ='$VulnWalkerUrusan' and  c ='00' and d='00' and e ='00' and e1 ='000'  order by c1";
	}else{
	...
	if($VulnWalkerBidang !='00'){
		$aqry = "select * from ref_skpd where 1=1 and c1='$fmUrusan' and c= '$VulnWalkerBidang' and d='00' and c1='$fmUrusan' order by c";
	}else{
		$aqry = "select * from ref_skpd where 1=1 and c1='$fmUrusan' and c!= '00' and d='00' and c1='$fmUrusan' order by c";
	}
	...
	if($VulnWalkerSKPD !='00'){
		$Qry = mysql_query("select * from ref_skpd where c1='$fmUrusan' and c='$fmSKPD' and d = '$VulnWalkerSKPD' and e = '00' and c1='$fmUrusan' $KondisiUNIT order by d");
	}else{
		$Qry = mysql_query("select * from ref_skpd where c1='$fmUrusan' and c='$fmSKPD' and d <> '00' and e = '00' and c1='$fmUrusan' $KondisiUNIT order by d");
	}
	...
	$kdSubUnit0 = genNumber(0, $Main->SUBUNIT_DIGIT );
	if($VulnWalkerUnit !='00'){
		$aqry = "select * from ref_skpd where c1='$fmUrusan' and c='$fmSKPD' and d = '$fmUNIT' and e = '$VulnWalkerUnit' and e1='$kdSubUnit0' $KondisiSUBUNIT order by e";
	}else{
	...
	if($VulnWalkerSubUnit !='000'){
		$Qry = mysql_query("select * from ref_skpd where c1='$fmUrusan' and c='$fmSKPD' and d = '$fmUNIT' and e = '$fmSUBUNIT' and e1 = '$VulnWalkerSubUnit' $KondisiSEKSI order by e1");
	}else{
		$Qry = mysql_query("select * from ref_skpd where c1='$fmUrusan' and c='$fmSKPD' and d = '$fmUNIT' and e = '$fmSUBUNIT' and e1 <> '000' $KondisiSEKSI order by e1");
	}
...
function PrintSKPD3($provinsi,$kota,$fmURUSAN,$fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI,$xls=FALSE) {
    ...
    $URUSAN = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where c='00' and c1='$fmURUSAN' "));
    $URUSAN = $URUSAN[0];
    $SKPD = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where d='00' and c1='$fmURUSAN' and c='$fmSKPD' "));
    $SKPD = $SKPD[0];
    $UNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where  c='$fmSKPD' and d <> '00' and e = '00' and d='$fmUNIT' and c1='$fmURUSAN'"));
    $UNIT = $UNIT[0];
    $SUBUNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where  c='$fmSKPD' and d = '$fmUNIT' and e <> '00' and e='$fmSUBUNIT' and c1='$fmURUSAN' "));
    $SUBUNIT = $SUBUNIT[0];
    $SEKSI = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where  c='$fmSKPD' and d = '$fmUNIT' and e = '$fmSUBUNIT' and e1='$fmSEKSI' and e1<>'00' and e1<>'000' and c1='$fmURUSAN' "));
    $SEKSI = $SEKSI[0];
	if ($xls==TRUE)
	{
    $Hsl = "<table cellpadding=0 cellspacing=0 border=0 width='100%'>
			...
			<tr valign=top> <td  colspan=2 >KABUPATEN/KOTA</td><td align=center >:</td><td style='font-weight:bold;font-size:10pt' > $kota</td> </tr>
			<tr valign=top> <td  colspan=2 >URUSAN</td><td align=center >:</td><td style='font-weight:bold;font-size:10pt' > $urusan/td> </tr>
    ...
    $Hsl = "<table cellpadding=0 cellspacing=0 border=0 width='100%'>
			...
			<tr valign=top> <td style='font-weight:bold;font-size:10pt'  >KABUPATEN/KOTA</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td style='font-weight:bold;font-size:10pt' > $kota</td> </tr>
			<tr valign=top> <td style='font-weight:bold;font-size:10pt'  >URUSAN</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td style='font-weight:bold;font-size:10pt' > $URUSAN</td> </tr>
...
function PrintTTD2($kota,$pagewidth = '30cm', $xls=FALSE, $cp1='', $cp2='', $cp3='', $cp4='', $cp5='' ) {
    ...
    $NAMASKPD = "";
    $JABATANSKPD = "";
    $TITIMANGSA = "$kota, " . JuyTgl1(date("Y-m-d"));
    if (c == '04') {
...
function tahapPerencanaanV3($namaModul, $jenis_anggaran){
		date_default_timezone_set("Asia/Bangkok");
		$getNomorModul = mysql_fetch_array(mysql_query("select * from ref_modul where nama_modul = '$namaModul' ")) ;
		$requestor = $getNomorModul['id_modul'];
		$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan"));
		$tahun = $getSettingan['tahun'];
		$wajib_validasi = $getSettingan['wajib_validasi'];
		$provinsi = $getSettingan['provinsi'];
		$kota = $getSettingan['kota'];
		$getTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_modul = '$requestor' and tahun = '$tahun' and anggaran = '$jenis_anggaran'"));
		if($wajib_validasi == '1')$wajib_validasi = TRUE;

		$getPengelolaBarang = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengelola']."'"));
		$getPejabat = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pejabat']."'"));
		$getPengurus = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengurus']."'"));
		$result=  array('pengelolaBarang' => $getPengelolaBarang['nama'],
						'pejabat' => $getPejabat['nama'],
						'pengurus' => $getPengurus['nama'] ,
						'nipPengelola' => $getPengelolaBarang['nip'],
						'nipPengurus' => $getPengurus['nip'],
						'nipPejabat' => $getPejabat['nip'],
						 'wajib_validasi' => $wajib_validasi,
						 'jenisForm' => $getTahap['jenis_form_modul'],
						  'nomorUrut' => $getTahap['no_urut'],
						   'tahun' => $tahun,
						   'jenisAnggaran' => $jenis_anggaran,
						    "idTahap" => $getTahap['id_tahap'],
							'idModul' => $requestor ,
							'provinsi' => $provinsi,
							'kota' => $kota,
		'settingAnggaran' => $getSettingan['jenis_anggaran']
							 );
		return $result;

}
function tahapKoreksi($namaModul,$jenis_anggaran){
		date_default_timezone_set("Asia/Bangkok");
		$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan"));
		$tahun = $getSettingan['tahun'];
		$wajib_validasi = $getSettingan['wajib_validasi'];
		$provinsi = $getSettingan['provinsi'];
		$kota = $getSettingan['kota'];
		$getTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_modul = '$namaModul' and tahun = '$tahun' and anggaran = '$jenis_anggaran'"));
		if($wajib_validasi == '1')$wajib_validasi = TRUE;
		$getPengelolaBarang = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengelola']."'"));
		$getPejabat = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pejabat']."'"));
		$getPengurus = mysql_fetch_array(mysql_query("select * from tandatanganpengelolabarang_v3 where id = '".$getSettingan['pengurus']."'"));
...
function VulnWalkerTahap($namaModul){
		date_default_timezone_set("Asia/Bangkok");
		$getNomorModul = mysql_fetch_array(mysql_query("select * from ref_modul where nama_modul = '$namaModul'")) ;
		$requestor = $getNomorModul['id_modul'];
		$angkaMulai = str_replace("-","",date("Y-m-d"));
		$jamMulai = str_replace(":","",date("H:i"));
		$angkaMulaiLengkap = $angkaMulai.str_replace(":","",$jamMulai);
		$query2 = "select * from ref_tahap_anggaran where (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) <= '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap' ) or (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) < '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap'  ) and status_penyusunan = 'AKTIF'";
		 $muter = mysql_query($query2);
		 $result = array();
		 while( $baris = mysql_fetch_array($muter)){
		    if (strpos($baris[5], $requestor) !== false ) {
				 $jenisForm = $baris['jenis_form_modul'];
				 $nomorUrut = $baris['no_urut'] ;
				 $tahun = $baris['tahun'];
				 $jenisAnggaran = $baris['anggaran'];
				 $idTahap = $baris['id_tahap'];
				 $idModul = $baris['id_modul'];
				 $result=  array('jenisForm' => $jenisForm, 'nomorUrut' => $nomorUrut, 'tahun' => $tahun, 'jenisAnggaran' => $jenisAnggaran,"query" => $query2, "idTahap" => $idTahap, 'idModul' => $idModul  );
			}
		 }
...
function VulnWalkerLASTTahap(){
		...
		$query2 = "select * from ref_tahap_anggaran where (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) < '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap' ) or (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) < '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap'  ) and status_penyusunan = 'AKTIF'";
		 ...
		 while( $baris = mysql_fetch_array($muter)){
				 ...
				 $currentTahap = $baris['nama_tahap'];
				 $result = array( 'currentTahap' => $currentTahap );
		 }
...
function VulnWalkerTahap_v2($namaModul){
		date_default_timezone_set("Asia/Bangkok");
		$getNomorModul = mysql_fetch_array(mysql_query("select * from ref_modul where nama_modul = '$namaModul' ")) ;
		$requestor = $getNomorModul['id_modul'];
		$angkaMulai = str_replace("-","",date("Y-m-d"));
		...
		$query2 = "select * from ref_tahap_anggaran where (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) <= '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap' ) or (concat(REPLACE(tanggal_mulai,'-',''), REPLACE(jam_mulai,':','') ) < '$angkaMulaiLengkap' and  concat(REPLACE(tanggal_selesai,'-',''), REPLACE(jam_selesai,':','')) > '$angkaMulaiLengkap'  ) ";
		 ...
		 while( $baris = mysql_fetch_array($muter)){
		    if (strpos($baris[5], $requestor) !== false ) {
				 ...
				 $idTahap = $baris['id_tahap'];
				 $idModul = $baris['id_modul'];
				 $result=  array('jenisForm' => $jenisForm,
				 				 'nomorUrut' => $nomorUrut,
								 'tahun' => $tahun,
		...
		$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan"));
		if($getSettingan['bypass_jadwal'] == '1'){
			$grabSettingan = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_modul ='$requestor' and status_penyusunan = 'AKTIF'"));
			foreach ($grabSettingan as $key => $value) {
			 	 $$key = $value;
				}
			$result=  array(    'jenisForm' => $jenis_form_modul,
				 				 'nomorUrut' => $no_urut,
								 'tahun' => $tahun,
...
function CekJadwal_V2($namaModul){
		date_default_timezone_set("Asia/Bangkok");
		$getNomorModul = mysql_fetch_array(mysql_query("select * from ref_modul where nama_modul = '$namaModul' ")) ;
		$requestor = $getNomorModul['id_modul'];
		$angkaMulai = str_replace("-","",date("Y-m-d"));
...
function VulnWalkerLASTTahap_v2(){
		date_default_timezone_set("Asia/Bangkok");
...
function settinganPerencanaan_v2(){
	$getSettingan = mysql_fetch_array(mysql_query("select * from settingperencanaan"));
				 $tahun = $getSettingan['tahun'];
				 $provinsi = $getSettingan['provinsi'];
				 $kota = $getSettingan['kota'];
...
function CmbUrusanBidangSkpd($prefix='', $tblwidth='100%', $kol1_width=100,$mode='') {
   //global $DisAbled;
	...
	/*setcookie('CurrentUrusan',$fmSKPDUrusan);
	setcookie('CurrentBidang',$fmSKPDBidang);
	setcookie('CurrentSKPD',$fmSKPDskpd);*/
	foreach ($HTTP_COOKIE_VARS as $key => $value) {
		  			$$key = $value;
	 	}
	   ...
	   if(!isset($fmSKPDUrusan) ){
	 	...
	 	if($VulnWalkerSKPD != '00'){
			$fmSKPDskpd = $VulnWalkerSKPD;
			$fmSKPDBidang = $VulnWalkerBidang;
			$fmSKPDUrusan = $VulnWalkerUrusan;
		}elseif($VulnWalkerBidang != '00'){
			$fmSKPDBidang = $VulnWalkerBidang;
			$fmSKPDUrusan = $VulnWalkerUrusan;
		}elseif($VulnWalkerUrusan != '0'){
	...
	if($VulnWalkerUrusan != '0'){
		 $aqry = "select * from ref_skpd where d='00' and c ='00' and c1='$VulnWalkerUrusan' order by c1";
	}else{
	...
	if($VulnWalkerBidang !='00'){
		$aqry = "select * from ref_skpd where 1=1 and d='00' and c ='$VulnWalkerBidang' and c1='$fmSKPDUrusan' order by c";
	}else{
	...
	$ListSKPD =
		"<div id='".$prefix."CbxBidang'>
			...
			> $PilihSKPD $Ops</select><div style='display:none'></div></div>";
	if($VulnWalkerSKPD!='00'){
		 $Qry = mysql_query("select * from ref_skpd where c='$fmSKPDBidang' and d = '$VulnWalkerSKPD' and e = '00' and c1='$fmSKPDUrusan' order by d");
	}else{
...
function WilSKPD_ajxVW($prefix='', $tblwidth='100%', $kol1_width=100,$mode='') {
    ...
    $PilihSEKSI = "<option value='000'>--- Semua SUB UNIT ---</option>";
...
function setWilSKPD() {
    global $fmURUSAN, $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main,
	...
	//echo "<br> fmURUSAN2 = '".$fmURUSAN."'";
	//$fmURUSAN = $_REQUEST['fmURUSAN']; di listbi

	if (empty($fmURUSAN)) {
        if (isset($HTTP_COOKIE_VARS['cofmURUSAN'])) {
...
function WilSKPD1($kol1_width=100,$mode='',$readonly='') {
	global $fmURUSAN, $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI,
	$fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main, $HTTP_COOKIE_VARS, $Pg, $SPg;

   /**$fmURUSAN dll diset di setWilSKPD()
   **/
	$disURUSAN = $DisAbled;
    $disSKPD = $DisAbled;
    $disUNIT = $DisAbled;
	...
	//if ($HTTP_COOKIE_VARS["coURUSAN"] != "0" && $HTTP_COOKIE_VARS["coURUSAN"] != "") {
	if ($HTTP_COOKIE_VARS["coURUSAN"] !== "0") {
        ...
        $PilihURUSAN = "";   //echo "<br>KondisiSKPD=".$KondisiSKPD ;
    }
    if ($HTTP_COOKIE_VARS["coSKPD"] !== "00") {
        $fmSKPD = $HTTP_COOKIE_VARS["coSKPD"];
        $HTTP_COOKIE_VARS["cofmSKPD"] = $fmSKPD;
	...
	if($Main->URUSAN){
	    ...
	    $aqry = "select * from ref_skpd where c1<>'0' and c='00' $KondisiURUSAN order by c1"; $cekskpd="<div style='display:none'> fmURUSAN='$fmURUSAN'   $aqry</div>";
		$Qry = mysql_query($aqry);
	    $Ops = "";
	    while ($isi = mysql_fetch_array($Qry)) {
	        $sel = $fmURUSAN == $isi['c1'] ? "selected" : "";
	    ...
	    $ListURUSAN =
			$cekskpd .
			"<select $disURUSAN name='fmURUSAN' id='fmURUSAN'
				onChange=\"adminForm.target='';adminForm.action='';adminForm.fmSKPD.value='00'; adminForm.fmUNIT.value='00';adminForm.fmSUBUNIT.value='00';adminForm.fmSEKSI.value='$kdSubUnit0';adminForm.submit()\"
			>
			$PilihURUSAN $Ops</select>";
	}

	//SKPD ------------------------------------------------
    $aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmURUSAN' and c<>'00' and d='00' $KondisiSKPD order by c":
    		"select * from ref_skpd where c<>'00' and d='00' $KondisiSKPD order by c";
	$Qry = mysql_query($aqry);
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
        $sel = $fmSKPD == $isi['c'] ? "selected" : "";
    ...
    $ListSKPD =
		...
		$PilihSKPD $Ops</select>";
	//UNIT -------------------------------------------------
	$aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d <> '00' and e = '00'  $KondisiUNIT order by d" :
		"select * from ref_skpd where c='$fmSKPD' and d <> '00' and e = '00'  $KondisiUNIT order by d";
    $Qry = mysql_query($aqry);
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
        $sel = $fmUNIT == $isi['d'] ? "selected" : "";
	...
	//SUBUNIT ------------------------------------------------
	$aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d = '$fmUNIT' and e <> '00'  and e1='$kdSubUnit0' $KondisiSUBUNIT order by e":
		"select * from ref_skpd where c='$fmSKPD' and d = '$fmUNIT' and e <> '00'  and e1='$kdSubUnit0' $KondisiSUBUNIT order by e";;
    $Qry = mysql_query($aqry);
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
        $sel = $fmSUBUNIT == $isi['e'] ? "selected" : "";
	...
	//SEKSI ------------------------------------------------
	$aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d = '$fmUNIT' and e='$fmSUBUNIT' and e1<> '$kdSubUnit0' $KondisiSEKSI order by nm_skpd":
		"select * from ref_skpd where c='$fmSKPD' and d = '$fmUNIT' and e='$fmSUBUNIT' and e1<> '$kdSubUnit0' $KondisiSEKSI order by nm_skpd";
    $Qry = mysql_query($aqry);
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
        $sel = $fmSEKSI == $isi['e1'] ? "selected" : "";
...
*/
	if ($mode=='1'){
		$vURUSAN = $Main->URUSAN ? "<tr valign=\"top\"> <td width='$kol1_width'>URUSAN</td>
							<td width='10'>:</td>
							<td>
							<input type=text  name='nmurusan' id='nmurusan' value='$nmURUSAN' readonly size='80' >
							<input type=hidden  name='fmURUSAN' id='fmURUSAN' value='$fmURUSAN' >" : '';
		...
		$vURUSAN = $Main->URUSAN ? "<tr valign=\"top\"> <td width='$kol1_width'>URUSAN</td>   <td width='10'>:</td>   <td>$ListURUSAN</td> </tr>" : '';
...
function WilSKPD_ajx4($prefix='', $tblwidth='100%', $kol1_width=100,$mode='') {
    /*****************************
	jika fm belum diisi (='' atau = 0) , maka ambil cookies . *syarat nilai pilih semua tidak boleh 0 dan ''
	- untuk hal awal --> ambil dari cookies berdasar group (mis: coSKPD), jika coSKPD tidak diset --> ambil dari form (cofm)  
	...
	***********************************/
	...
	if ($HTTP_COOKIE_VARS["coURUSAN"] !== "0") { //jika diset dari user group --> ambil dari cookie
        $fmURUSAN = $HTTP_COOKIE_VARS["coURUSAN"];        
        $KondisiURUSAN = " and c1='$fmURUSAN'";
        $PilihURUSAN = "";
    }
	else{ //jika tidak diset user group 		
		if($fmURUSAN == '' || $fmURUSAN==0){ //jika belum diset di halaman --> ambil dari cokies halaman sebelumnya
			$fmURUSAN = $HTTP_COOKIE_VARS['cofmURUSAN'];
		}
	}
	if ($HTTP_COOKIE_VARS["coSKPD"] !== "00") {
...
function filterSKPD($prefix='', $tblwidth='100%', $kol1_width=100,$mode='') {
    //global $DisAbled;
    global $Main, $fmURUSAN, $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI, $fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main, $HTTP_COOKIE_VARS, $Pg, $SPg;
    //$disSKPD = ""; $disUNIT = ""; $disSUBUNIT = "";
    //echo "<br>Group=".login_getGroup();
...
function WilSKPDList() {//without table, just list
	...
	//URUSAN
	if($Main->URUSAN){
		$aqry = "select * from ref_skpd where c1<>'0' and c='00' $KondisiURUSAN order by c1"; $cekskpd="<div style='display:none'>$aqry</div>";
		$Qry = mysql_query($aqry);
	    $Ops = "";
	    while ($isi = mysql_fetch_array($Qry)) {
	        $sel = $fmURUSAN == $isi['c1'] ? "selected" : "";
	        $Ops .= "<option $sel value='{$isi['c1']}'>{$isi['nm_skpd']}</option>\n";
	    }
	    $ListURUSAN = "<select $disURUSAN name='fmURUSAN'
				onChange=\"adminForm.target='_self';adminForm.action='?Pg=$Pg&SPg=$SPg';
					adminForm.fmUNIT.value='00';adminForm.submit()\">$PilihURUSAN $Ops</select>";
	}
...
function WilSKPDList_() {//without table, just list
    global $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main, $HTTP_COOKIE_VARS, $Pg, $SPg;
    $disSKPD = "";
    $disUNIT = "";
    $disSUBUNIT = "";
...
function PrintSKPD($xls=''){//$fmSKPD='', $fmUNIT='', $fmSUBUNIT='', $fmSEKSI='') {
    global $fmURUSAN, $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main,
...
//    $xls = ($xls==TRUE) ? '1':$xls;
	...
	if($Main->URUSAN == 1){
		$URUSAN = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where c='00' and c1='$fmURUSAN' "));
	    $URUSAN = $URUSAN[0];
	    $SKPD = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where c1='$fmURUSAN'  and c='$fmSKPD' and c<>'00' and d='00'  "));
	    $SKPD = $SKPD[0];
	    $UNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where c1='$fmURUSAN'  and  c='$fmSKPD' and d='$fmUNIT' and d <> '00' and e = '00'  "));
	    $UNIT = $UNIT[0];
	    $SUBUNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where c1='$fmURUSAN'  and  c='$fmSKPD' and d = '$fmUNIT'  and e='$fmSUBUNIT' and e <> '00' "));
	    $SUBUNIT = $SUBUNIT[0];
	    $SEKSI = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where c1='$fmURUSAN'  and  c='$fmSKPD' and d = '$fmUNIT' and e = '$fmSUBUNIT' and e1='$fmSEKSI' and e1<>'00' and e1<>'000' "));
	    $SEKSI = $SEKSI[0];
	}
	else{
	...
	if ($xls!='1'){
		$vurusan = $Main->URUSAN == 1? "<tr valign=top> <td style='font-weight:bold;font-size:10pt' >URUSAN</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td style='font-weight:bold;font-size:10pt' > $URUSAN</td> </tr> ": '';
	    $Hsl = "<table cellpadding=0 cellspacing=0 border=0 width='100%'>
				<!-- <tr> <td style='font-weight:bold;font-size:10pt;width:150' >Kepemilikan Barang</td><td style='font-weight:bold;font-size:10pt;width:25' >:</td><td style='font-weight:bold;font-size:10pt' >$KEPEMILIKAN</td> </tr> -->
		...
		$vurusan = $Main->URUSAN == 1? "<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >URUSAN</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td  style='font-weight:bold;font-size:10pt' > $URUSAN</td> </tr> ": '';
...
function PrintSKPD2_urusan($fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI,$xls=FALSE) {
    //global $fmWIL, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmTAHUNANGGARAN, $fmKEPEMILIKAN,
	global $Main;
	//$HTTP_COOKIE_VARS, $SKPD, $UNIT, $SUBUNIT;
...
function Penghapusan_daftar_mutasi_OPD() {
    ...
    $KondisiSUBUNIT = "";
    $KondisiSEKSI = "";
    $PilihURUSAN = '<option value="">--- Semua Urusan ---</option>';
    $PilihSKPD = '<option value="">--- Semua Bidang ---</option>';
	...
	//urusan -------------------
    //$aqry = "select * from ref_skpd where d='00'  order by c";
    $aqry = "select * from ref_skpd where 1=1 and c1<>'0' and c='00' $KondisiURUSAN order by c1";
    $Qry = mysql_query($aqry);
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
        $sel = $fmPenghapusanURUSAN == $isi['c1'] ? "selected" : "";
        $Ops .= '<option ' . $sel . ' value="' . $isi['c1'] . '">' . $isi['nm_skpd'] . '</option>\n';
    }
	$ListURUSAN = '
		<select ' . $disURUSAN . ' name="fmPenghapusanURUSAN"
			onChange="adminForm.target=\'_self\';adminForm.action=\'?Pg=' . $Pg . '&SPg=' . $SPg . '\';
			adminForm.fmPenghapusanSKPD.value=\'00\';
			adminForm.submit()">' .
            $PilihURUSAN . ' ' . $Ops .
            '</select>';

//Bidang -----------------
 	$aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmPenghapusanURUSAN' and c<>'00' and d='00' $KondisiSKPD order by c":
    		"select * from ref_skpd where d='00' $KondisiSKPD order by c";
	$Qry = mysql_query($aqry);
    //$Qry = mysql_query("select * from ref_skpd where d='00' $KondisiSKPD order by c");
    $Ops = "";
    while ($isi = mysql_fetch_array($Qry)) {
    ...
    //OPD -------------
    $aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmPenghapusanURUSAN' and c='$fmPenghapusanSKPD' and d <> '00' and e = '00'  $KondisiUNIT order by d" :
		"select * from ref_skpd where c='$fmPenghapusanSKPD' and d <> '00' and e = '00'  $KondisiUNIT order by d";
    $Qry = mysql_query($aqry);
	$Qry = mysql_query($aqry);
    ...
    //Unit --------------------
    $aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmPenghapusanURUSAN' and c='$fmPenghapusanSKPD' and d = '$fmPenghapusanUNIT' and e <> '00'  and e1='$kdSubUnit0' $KondisiSUBUNIT order by e":
		"select * from ref_skpd where c='$fmPenghapusanSKPD' and d = '$fmPenghapusanUNIT' and e <> '00'  and e1='$kdSubUnit0' $KondisiSUBUNIT order by e";
	$Qry = mysql_query($aqry);
    ...
    //Sub Unit --------------------
   $aqry = $Main->URUSAN ? "select * from ref_skpd where c1='$fmPenghapusanURUSAN' and c='$fmPenghapusanSKPD' and d = '$fmPenghapusanUNIT' and e='$fmPenghapusanSUBUNIT' and e1<> '$kdSubUnit0' $KondisiSEKSI order by nm_skpd":
		"select * from ref_skpd where c='$fmPenghapusanSKPD' and d = '$fmPenghapusanUNIT' and e='$fmPenghapusanSUBUNIT' and e1<> '$kdSubUnit0' $KondisiSEKSI order by nm_skpd";
	$Qry = mysql_query($aqry);
...
function Mutasi_RekapByBrg_GetList2($fmKEPEMILIKAN, $fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT,
	...
	$KondisiC_ = $fmSKPD == "00" ? "" : " and bb.c='$fmSKPD'";
    $KondisiD = $fmUNIT == "00" ? "" : " and d='$fmUNIT' ";
    ...
    $Kondisi = $Main->URUSAN == 1 ? "  a1='$fmKEPEMILIKAN' and a='{$Main->Provinsi[0]}'	and c1='$fmURUSAN' $KondisiC $KondisiD $KondisiE $KondisiE1 " :
				"  a1='$fmKEPEMILIKAN' and a='{$Main->Provinsi[0]}'	and c='$fmSKPD' $KondisiD $KondisiE $KondisiE1 ";
    $Kondisi_ = $Main->URUSAN == 1 ? "  bb.a1='$fmKEPEMILIKAN' and bb.a='{$Main->Provinsi[0]}'	and bb.c1='$fmURUSAN' $fmSKPD_ $KondisiD_ $KondisiE_ $KondisiE1_ " :
				"  bb.a1='$fmKEPEMILIKAN' and bb.a='{$Main->Provinsi[0]}'	and bb.c='$fmSKPD' $KondisiD_ $KondisiE_ $KondisiE1_ ";
    /*if($Main->URUSAN == 1){
		if ($fmURUSAN == "00") {
	        $Kondisi = "  a1='$fmKEPEMILIKAN' and a='{$Main->Provinsi[0]}' $KondisiC $KondisiD $KondisiE $KondisiE1";
	        $Kondisi_ = "  bb.a1='$fmKEPEMILIKAN' and bb.a='{$Main->Provinsi[0]}'	$KondisiC_ $KondisiD_ $KondisiE_ $KondisiE1_ ";
	    }
	}else{
		if ($fmSKPD == "00") {
...
function Mutasi_GetList($cetak=0) {
    ...
    global $fmSemester, $fmTahun, $fmKEPEMILIKAN, $fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmKIB;
    ...
    //Kondisi ----------------------------------
    //$KondisiC1 = $fmURUSAN == "00" || $fmURUSAN == "0"  ? "" : " and c1='$fmURUSAN' ";
    $KondisiC = $fmSKPD == "00" ? "" : " and c='$fmSKPD' ";
    $KondisiD = $fmUNIT == "00" ? "" : " and d='$fmUNIT' ";
    $KondisiE = $fmSUBUNIT == "00" ? "" : " and e='$fmSUBUNIT' ";
    $KondisiE1 = $fmSEKSI == "00" || $fmSEKSI == "000" ? "" : " and e1='$fmSEKSI' ";
    $Kondisi = " and a1='" . $fmKEPEMILIKAN . "' and a='{$Main->Provinsi[0]}' $KondisiC1 $KondisiC $KondisiD $KondisiE $KondisiE1 ";
    if ($fmKIB != '') {
        $Kondisi .= " and f = '$fmKIB' ";
    }
	//kondisi barang
...
function getKondisiSKPD() {
    global $Main, $fmKEPEMILIKAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmURUSAN;
	$kdSubUnit0 = genNumber(0, $Main->SUBUNIT_DIGIT );
	if($Main->URUSAN==1) {
		$KondisiC1 =  ($fmURUSAN == '' || $fmURUSAN == '0') ?  '' :" and c1='$fmURUSAN' " ;
	}
    ...
    $KondisiSKPD = "a1='" . $fmKEPEMILIKAN . "' and a='{$Main->Provinsi[0]}' $KondisiC1 $KondisiC $KondisiD $KondisiE $KondisiE1 ";
    // echo "<br>KondisiSKPD=".$KondisiSKPD;
    return $KondisiSKPD;
}
...
function getKondisiSKPD2($fmKEPEMILIKAN, $a, $b,  $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI='', $fmURUSAN='', $tanpaKepemilikan=0) {
    global $Main, $HTTP_COOKIE_VARS;//, $fmKEPEMILIKAN, $fmSKPD, $fmUNIT, $fmSUBUNIT;
    ...
    if($Main->URUSAN==1) {
		...
		if($fmURUSAN != '' && $fmURUSAN != '0') {
			$KondisiC1 = " and c1='$fmURUSAN' " ;
		}else{
			if($HTTP_COOKIE_VARS['coURUSAN'] !='0' ) $KondisiC1 = " and c1='". $HTTP_COOKIE_VARS['coURUSAN']."'";
		}
		//if(=
	}
    //$KondisiC = $fmSKPD == '' || $fmSKPD == '00' ? "" : " and c='$fmSKPD' ";
	if($fmSKPD != '' && $fmSKPD != '00') {
		$KondisiC = " and c='$fmSKPD' " ;
	}else{
		if($HTTP_COOKIE_VARS['coSKPD'] !='0' ) $KondisiC = " and c='". $HTTP_COOKIE_VARS['coSKPD']."'";
	}
    //$KondisiD =  $fmUNIT == '' || $fmUNIT == "00" ? "" : " and d='$fmUNIT' ";
	if($fmUNIT != '' && $fmUNIT != '00') {
		$KondisiD = " and d='$fmUNIT' " ;
	}else{
		if($HTTP_COOKIE_VARS['coUNIT'] !='0' ) $KondisiD = " and d='". $HTTP_COOKIE_VARS['coUNIT']."'";
	}
    //$KondisiE = $fmSUBUNIT == '' || $fmSUBUNIT == "00" ? "" : " and e='$fmSUBUNIT' ";
	if($fmSUBUNIT != '' && $fmSUBUNIT != '00') {
		$KondisiE = " and e='$fmSUBUNIT' " ;
	}else{
		if($HTTP_COOKIE_VARS['coSUBUNIT'] !='0' ) $KondisiE = " and e='". $HTTP_COOKIE_VARS['coSUBUNIT']."'";
	}

	//$KondisiE1 = $fmSEKSI == '' || $fmSEKSI == "00" || $fmSEKSI == "000" ? "" : " and e1='$fmSEKSI' ";
	if($fmSEKSI != '' && $fmSEKSI != '00' && $fmSEKSI != '000') {
		$KondisiE1 = " and e1='$fmSEKSI' " ;
	}else{
		if($HTTP_COOKIE_VARS['coSEKSI'] !='0' ) $KondisiE1 = " and e1='". $HTTP_COOKIE_VARS['coSEKSI']."'";
	}

    //$cek .= '<br> fmKEPEMILIKANt = '.$fmKEPEMILIKAN;
    if($tanpaKepemilikan==1){
		$KondisiSKPD = " a='$a' and b='$b' $KondisiC1 $KondisiC $KondisiD $KondisiE $KondisiE1 ";

	}else{
		$KondisiSKPD = "a1='$fmKEPEMILIKAN' and a='$a' and b='$b' $KondisiC1 $KondisiC $KondisiD $KondisiE $KondisiE1 ";
	}
...
function getKondisiSKPD3($fmKEPEMILIKAN, $a, $b, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI='', $fmURUSAN='') {
...
function bilang($x){
  ...
  elseif ($x < 1000000000000000)
	...
	function Penatausahaan_BIGetKib($f, $KondisiKIB){
		//get data detil kib untuk kolom dftar BI
		//dipakai di pages\cetak\listmutasi_xls.ph, common\fnpindahtangan1.php, common\fnpenghapusan1.php,common\fnpenghapusan.php,
		//common\fnpengaman.php, common\fnpemanfaat.php, common\fnpelihara.php, \common\fnkoreksi2.php, \common\fnhapussebagian.php, \common\fngantirugi.php
		global $Main, $sort1;
		global $ISI5, $ISI6, $ISI7, $ISI10, $ISI12, $ISI15;
	...
	function Penatausahaan_BIGetKib_hapus($f, $KondisiKIB){
		...
		//dipakai di : common\fnpindahtangan1.ph, common\fnpindahtangan.ph, common\fnpenghapusan1.ph, common\fnpenghapusan.ph,
		//common\fnpengaman.ph, common\fnpemanfaat.ph, \common\fnpelihara.ph, common\fnkoreksi2.ph, common\fnhapussebagian.php,
		//common\fngantirugi.php
		global $Main, $sort1;
		global $ISI5, $ISI6, $ISI7, $ISI10, $ISI12, $ISI15;
		$ISI5=''; $ISI6=''; $ISI7=''; $ISI10=''; $ISI12=''; $ISI15='';
		//echo"<br>f=".$f;
	...
	function Penatausahaan_FormEntry($currID=0, $btCariBrg=TRUE , $entryMutasi=FALSE){
		//dipakai di : pages\penerimaan\distribusi.ph, pages\gantirugi\tgr_ketetapan.php, pages\gantirugi\tgr_ketetapan.php,
		//pages\05\set_mutasi.ph, pages\05\entryidi_lama_reclass.php, pages\05\entryidi_lama.php
...
*/
		...
		//edit sudah closing
		//if($Baru == 0 && ((sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1']) || ($old['id'] <> $old['idawal'])) || ($old['status_barang']=='2' || $old['staset']=='7') || ($old['refid_terima']<>'' || $old['refid_terima']<>'0'))){
		if($Baru == 0 && (
			(sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']))
			 ||($old['id'] <> $old['idawal'])
			 ||($old['status_barang']=='2') || ($old['staset']=='7')
			 //||($old['refid_terima']<>'' && $old['refid_terima']<>'0')
			 || !($old['refid_terima']=='' || $old['refid_terima']=='0'  )
			)
		){
				$entryBrg =
		...
		switch ($Main->VERSI_NAME){
			case 'BDG_BARAT': case 'BOGOR': {
				if( sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']) == FALSE || $Baru==1){//tidak closing
					$vstAset = //'';//"<input type=''>";
		...
		if($Baru == 0 && ((sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']) 
		|| ($old['id'] <> $old['idawal'])) || ($old['status_barang']=='2' || $old['staset']=='7') 
		//|| ($old['refid_terima']<>'' || $old['refid_terima']<>'0')
		|| !($old['refid_terima']=='' || $old['refid_terima']=='0' )
		)){
					$vstAset = //'';//"<input type=''>";
		...
		//entry bast ---------------------------------------------------------------------------
		if($Main->MODUL_BAST){
			//if($Baru == 0 && ((sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']) || ($old['id'] <> $old['idawal'])) || ($old['status_barang']=='2' || $old['staset']=='7') || ($old['refid_terima']<>'' || $old['refid_terima']<>'0'))){
			if($Baru == 0 && (
				(sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']))
				 ||($old['id'] <> $old['idawal'])
				 ||($old['status_barang']=='2') || ($old['staset']=='7')
		...
		//if($Baru == 0 && ((sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']) || ($old['id'] <> $old['idawal'])) || ($old['status_barang']=='2' || $old['staset']=='7') || ($old['refid_terima']<>'' || $old['refid_terima']<>'0'))){//jika edit, cek tgl closing, readonly yg tidak bisa di edit
		//jika edit, cek tgl closing, readonly yg tidak bisa di edit
		if($Baru == 0 && (
			(sudahClosing($tgl_buku, $old['c'], $old['d'], $old['e'], $old['e1'], $old['c1']))
			 ||($old['id'] <> $old['idawal'])
			 ||($old['status_barang']=='2') || ($old['staset']=='7')
	...
	// end program&kegiatan -------------------------------------------------------------------------------------------------------------------------------------------
			...
			//kondisi barang-----------------------------------------------------------------------------------------
			if ($Baru == 0 && $cekKondisi['cnt']>1){//sudah ada perubahan kondisi
				$enKondisiBrg=
				formEntryBase2("Kondisi Barang",":",

											$Main->KondisiBarang[$fmKONDISIBARANG-1][1].
						"<input type=hidden name='fmKONDISIBARANG' id='fmKONDISIBARANG' value ='$fmKONDISIBARANG'  >",
						"","","","valign='top' height='24'");
		...
		"<tr><td>Pengurus Barang/Pembantu</td><td>:</td><td>".
			"<script>
				pilihPemegang = function(){
					var me = this;
					if( document.getElementById('fmURUSAN')) PegawaiPilih.fmURUSAN = document.getElementById('fmURUSAN').value;
	...
	function Penatausahaan_FormEntry_Kib($kd){
		//dipakai di: pages\penerimaan\distribusi.php, pages\gantirugi\tgr_ketetapan.ph
		...
		$fmHAKPAKAI_KIB_A, $fmTGLSERTIFIKAT_KIB_A, $fmNOSERTIFIKAT_KIB_A, $fmPENGGUNAAN_KIB_A, $fmKET_KIB_A, $fmBLOK_KIB_A, $fmPERSIL_KIB_A;
		...
		switch($kd){
			...
			case 1:{//KIB A
				if($Main->VERSI_NAME == 'CIREBON_KAB'){
					$fmEntryBlok = formEntryBase2('Blok',':','<input type="text" name="fmBLOK_KIB_A" value="'.$fmBLOK_KIB_A.'" style="width:187px">',
									'','','','valign="top" height="24"');
					$fmEntryPersil = formEntryBase2('No. Persil',':','<input type="text" name="fmPERSIL_KIB_A" value="'.$fmPERSIL_KIB_A.'" style="width:187px">',
									'','','','valign="top" height="24"');
				}
				$hsl="
				<tr valign=\"top\">
			...
			case 3:{//kib c
				...
				<td width=''>:</td>
				<script>
				CariKdTanah = function(){
					kodetanah.CariKdTanah($kd);
				}
				</script>
				<td>
				".txtField('fmNOKODETANAH_KIB_C',$fmNOKODETANAH_KIB_C,'100','63','text','')."
				<input type='button' name='carikd' id='carikd' value='Cari' onclick='CariKdTanah($kd)'><span style='color: red'></span>
				...
				<td width=''>:</td>
				<td>
				<textarea cols=60 rows=2 name='fmLETAK_KIB_C' id='fmLETAK_KIB_C'>$fmLETAK_KIB_C</textarea>
				</td>
				</tr>
				".formEntryBase2('Kampung/Komplek',':','<input type="text" name="kampung" id="kampung" value="'.$kampung.'" style="width:187px">',
				'','width=""','','valign="top" height="24"')."
				".formEntryBase2('RT',':','<input type="text" name="rt" id="rt" value="'.$rt.'" size="4" maxlength="3">',
				'','width=""','','valign="top" height="24"')."
				".formEntryBase2('RW',':','<input type="text" name="rw" id="rw" value="'.$rw.'" size="4" maxlength="4">',
				'','width=""','','valign="top" height="24"')."
				<script language=\"JavaScript\" src=\"js/wilayah.js\" type=\"text/javascript\"></script>
				".formEntryBase2('Kota/Kabupaten',':',selKabKota_txt_div($alamat_b,$alamat_kota,'',1,'Wilayah'),
				'','','','valign="top" height="24"')."
				...
				".formEntryBase2('Kelurahan/Desa',':','<input type="text" name="alamat_kel" id="alamat_kel" value="'.$alamat_kel.'" style="width:187px">',
				'','width=""','','valign="top" height="24"')."
				".formEntryKoordinatGPS('barang',$koordinat_gps, $koord_bidang)."
			...
			case 4:{//kib d
				...
				<td >Nomor Kode Tanah</td>
				<td width=''>:</td>
				<td>".txtField('fmNOKODETANAH_KIB_D',$fmNOKODETANAH_KIB_D,'100','50','text','')."&nbsp;<input type='button' name='carikd' id='carikd' value='Cari' onclick='CariKdTanah($kd)'></td>
				</tr>
				<tr valign=\"top\">
				<td >Letak/Alamat</td>
				<td width=''>:</td>
				<td>
				<textarea cols=60 rows=2 name='fmALAMAT_KIB_D' id='fmALAMAT_KIB_D'>$fmALAMAT_KIB_D</textarea>
				</td>
				</tr>
				".formEntryBase2('Kampung/Komplek',':','<input type="text" name="kampung" id="kampung" value="'.$kampung.'" style="width:187px">',
				'','width=""','','valign="top" height="24"')."
...
//				'<input type="text" name="alamat_kec" value="'.$alamat_kec.'">'
	...
	function Penatausahaan_GetData($idbi, $hanyaStatusInv = TRUE ){
		...
		$fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmSKPD_old, $fmUNIT_old, $fmSUBUNIT_old,	$fmSEKSI_old,
		...
		$bersertifikat,$alamat_kota, $fmBLOK_KIB_A, $fmPERSIL_KIB_A;
			...
			**/
			...
			switch( $isi['f'] ){
				case '01': {
					...
					$fmBLOK_KIB_A = $isi['blok'];
					$fmPERSIL_KIB_A = $isi['persil'];
					break;
				}
				case '02':{
...
*/
	...
	function Penatausahaan_genTableRowKibC($clRow, $clGaris, $tampilCheckbox,  $isi, $no, $tampilCbxKeranjang='', $tipe='', $ketpenanggungjawab=''){
		...
		$vbast = "<td class=\"$clGaris\" >".$isi['no_ba']."/<br>".TglInd($isi['tgl_ba'])."/<br>$vkegiatan".$isi['no_spk']."/<br>".TglInd($isi['tgl_spk'])."</td>";
		$vspk = "";//$vspk = "<td class=\"$clGaris\" >".$isi['no_spk']."/<br>".TglInd($isi['tgl_spk'])."</td>";
	...
	function Penatausahaan_genTableRowJml($clRow, $clGaris, $colspan, $arr, $susut=FALSE,$fmKIB, $idBI='', $colapse=TRUE , $cetak=FALSE ){
		...
		if($Main->MODUL_SPK)$vspk="";//$vspk	= "<td class=\"$clGaris\"></td>";
		if($susut==FALSE){
			//$colspan = 11;
...
*/
	...
	function Penatausahaan_genTableRowDet($fmKIB,$clRow, $clGaris, $tampilCheckbox, $arr, $susut=FALSE, $idBI='', $colapse = TRUE, $cetak=FALSE){
		global $Main;
		//\common\fnpenatausaha.php, Penatausahaan_GetListDet()
...
function Penatausahaan_FormEntry_reclass($currID=0, $btCariBrg=TRUE , $entryMutasi=FALSE){
	//dipakai di :pages\05\entryidi_lama_reclass.php
		global $Main, $btnTampilKib, $titleAct, $DisAbled;
		global $Pg, $SPg, $fmIDBARANG, $fmNMBARANG, $fmTAHUNPEROLEHAN, $fmREGISTER, $fmSATUAN;
...
function getNilaiPerolehan($idbi, $tglperolehan){
	global $Main;
	$aqry="select get_nilai_perolehan($idbi,'$tglperolehan') as NilaiBuku " ;
	$get = mysql_fetch_array(mysql_query($aqry));
	return $get['NilaiBuku'];
}
...
function tglSusutAkhir($idbi){
    $isSusut = FALSE;
	$aqry = "select * from buku_induk where id ='$idbi'";
	$qry = mysql_query($aqry);
	while($isi = mysql_fetch_array($qry)){
		$tglSusutAkhir = date ('Y-m-t', strtotime($isi['thn_susut_ak'].'-'.$isi['bln_susut_ak'].'-01')); //tgl akhr susut
		//$isSusut =  compareTanggal($tgl, $tglSusutAkhir)==0 || compareTanggal($tgl, $tglSusutAkhir)==1 ; //tgl <= tgl susut
	}
	return $tglSusutAkhir;
}

function isSudahSusut($idbi, $tgl){
	$isSusut = FALSE;
	$tglSusutAkhir = tglSusutAkhir($idbi);
	$isSusut =  compareTanggal($tgl, $tglSusutAkhir)==0 || compareTanggal($tgl, $tglSusutAkhir)==1 ; //tgl <= tgl susut
...
function cekBI($idbi){
	$cek = '';
	$qry =  mysql_query( "select sf_cek_idbi($idbi) as cek ");
	while($isi=mysql_fetch_array($qry) ){
		//$arr = $isi['cek'];
		//$arr = explode('\n', $isi['cek'] );
		$cek .= $isi['cek'];//$arr[0];//
...
function sudahClosing($tgl, $c='00', $d='00', $e='00', $e1='000', $c1='0'){
	global $Main;
	$tglclosing = getTglClosing($c,$d,$e,$e1,$c1);
	$hsl =  compareTanggal($tgl, $tglclosing)==0 || compareTanggal($tgl,$tglclosing)==1 ;
	return $hsl;
}

function getTglClosing($c='00', $d='00', $e='00', $e1='000', $c1='0'){
	...
	//}else{
		//if($Main->CLOSING_SKPD){
			...
			$aqry = "select * from t_closing where $vc1 c='$c' and d='$d' and e='$e' and e1='$e1' order by Id desc limit 0,1 "; $cek .= $aqry;
			$get = mysql_fetch_array(mysql_query($aqry ));

			if($get['tgl']== NULL){
				$aqry = "select * from t_closing where $vc1 c='$c' and d='$d' and e='$e' and e1='000' order by Id desc limit 0,1 "; $cek .= $aqry;
				$get = mysql_fetch_array(mysql_query( $aqry ));
			}
			if($get['tgl']== NULL){
				$aqry = "select * from t_closing where $vc1 c='$c' and d='$d' and e='00' and e1='000' order by Id desc limit 0,1 " ; $cek .= $aqry;
				$get = mysql_fetch_array(mysql_query($aqry));
			}
			if($get['tgl']== NULL){
				$aqry = "select * from t_closing where $vc1 c='$c' and d='00' and e='00' and e1='000' order by Id desc limit 0,1 "; $cek .= $aqry;
				$get = mysql_fetch_array(mysql_query( $aqry ));
			}
			if($get['tgl']==NULL){
				$aqry = "select * from t_closing where $vc1 c='00' and d='00' and e='00' and e1='000'  order by Id desc limit 0,1 " ; $cek .= $aqry;
				$get = mysql_fetch_array(mysql_query( $aqry));
			}

			if($get['tgl']==NULL && $Main->URUSAN==1){
				$aqry = "select * from t_closing where c1='0' and c='00' and d='00' and e='00' and e1='000'  order by Id desc limit 0,1 " ; $cek .= $aqry;
				$get = mysql_fetch_array(mysql_query( $aqry));
			}
		...
		if ($i==0){	$clGaris = $cetak? "GarisCetak3": "GarisDaftar3";}else{	$clGaris = $cetak? "GarisCetak2": "GarisDaftar2";			}
			...
			if($isi2['thn_perolehan']!=$thn && $thn <>''){
				...
				switch ($fmKIB){
					...
					default: $colspan = $cetak ? 11: 12; break;
				}
			...
			switch($isi2['jenis']){
				case'1': {
					//$jenis=' Pemeliharaan';
					$pelihara = mysql_fetch_array(mysql_query("select * from pemeliharaan where id = '".$isi2['id']."'"));
					/*switch($pelihara['cara_perolehan']!='' && $pelihara['refid_retensi']==''){
						case '1' : $jenis = 'Pemeliharaan'; break;//$jenis = 'Pemeliharaan - Belanja Modal '; break;
						case '2' : $jenis = 'Pemeliharaan'; break;//$jenis = 'Pemeliharaan - Belanja BarJas '; break;
						case '3' : $jenis = 'Pemeliharaan'; break;//$jenis = 'Pemeliharaan - dari Hibah '; break;
						case '4' : $jenis = 'Penggabungan '; break;
						default : $jenis = 'Retensi';break;
					}*/
					if($pelihara['refid_retensi']!=''){
						$jenis = 'Retensi ';
					}elseif($pelihara['cara_perolehan']==4){
						$jenis = 'Penggabungan ';
					}else{
						$jenis = 'Pemeliharaan';
					}
				...
				if($Baru==1){//baru
					...
					if($errmsg=='' &&
						 ( $tgl_buku!=$old['tgl_buku'] ||
							...
							( ($old['tgl_spk']!='0000-00-00' && $old['tgl_spk']!='') && $tgl_spk!= $old['tgl_spk'] ) ||
							( ($old['no_spk']!=NULL && $old['no_spk']!='') && $no_spk!= $old['no_spk'] ) ||
							( ($old['tgl_ba']!='0000-00-00' && $old['tgl_ba']!='') && $tgl_ba!= $old['tgl_ba'] ) ||
							( ($old['no_ba']!=NULL && $old['no_ba']!='') && $no_ba!= $old['no_ba'] )
						 )
						 &&
						( sudahClosing($tgl_buku, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmURUSAN)
							|| ($old['id']<>$old['idawal']) || ($old['status_barang']=='2' || $old['staset']=='7')
							//|| ($old['refid_terima']<>'' || $old['refid_terima']<>'0'))
							|| !(($old['refid_terima']=='' || $old['refid_terima']=='0' ) )  )
						)
					{
							$edata = '';
							if($tgl_buku!=$old['tgl_buku']  ) $edata = 'Tanggal Buku';
						 	if($fmURUSAN != $old['c1'] ) $edata = 'Urusan';
							if($fmSKPD != $old['c']  ) $edata = 'Bidang';
							if($fmUNIT != $old['d']  ) $edata = 'SKPD';
							if($fmSUBUNIT != $old['e']  ) $edata = 'Unit';
							if($fmSEKSI != $old['e1']  ) $edata = 'Sub Unit';
							if($fmIDBARANG != $old['f'].".".$old['g'].".".$old['h'].".".$old['i'].".".$old['j']  ) $edata = 'kode barang';
							if($fmTAHUNPEROLEHAN != $old['thn_perolehan']  ) $edata = 'tahun perolehan';
							if($fmREGISTER != $old['noreg']  ) $edata = 'No. Register';
							if($fmHARGABARANGBELI != $old['harga_beli']  ) $edata = 'Harga Beli';
							if($fmHARGABARANGATRIBUSI != $old['harga_atribusi']  ) $edata = 'Harga Atribusi';
							if($fmHARGABARANG != $old['harga']  ) $edata = 'Jumlah Harga';
							if($fmJUMLAHBARANG != $old['jml_barang']  ) $edata = 'Jumlah Harga';
							if($fmSATUAN != $old['satuan']  ) $edata = 'Satuan';
							if($fmASALUSUL != $old['asal_usul']  ) $edata = 'Cara Perolehan';
							if($fmJENISHIBAH != $old['jns_hibah']  ) $edata = 'Sumber Dana';
							if($fmSTATUSASET != $old['staset']  ) $edata = 'Status Aset';
							if($fmKONDISIBARANG != $old['kondisi']  ) $edata = 'Kondisi';
							if(( ($old['tgl_spk']!='0000-00-00' && $old['tgl_spk']!='') && $tgl_spk!= $old['tgl_spk'] )  ) $edata = 'Tanggal Kontrak';
							if(( ($old['no_spk']!=NULL && $old['no_spk']!='') && $no_spk!= $old['no_spk'] )  ) $edata = 'No. Kontrak';
							if(( ($old['tgl_ba']!='0000-00-00' && $old['tgl_ba']!='') && $tgl_ba!= $old['tgl_ba'] )  ) $edata = 'Tanggal BAST';
							if(( ($old['no_ba']!=NULL && $old['no_ba']!='') && $no_ba!= $old['no_ba'] )  ) $edata = 'No. BAST';


							if(sudahClosing($tgl_buku, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmSEKSI, $fmURUSAN)) $errmsg='Data '.$edata.' sudah closing tidak bisa diedit !';
							if($old['id']<>$old['idawal'])  $errmsg='Data '.$edata.' sudah Mutasi/Reklas tidak bisa diedit !';
							if($old['status_barang']=='2' || $old['staset']=='7')$errmsg='Data '.$edata.' sudah Pemanfaatan tidak bisa diedit !';
							//if($old['refid_terima']<>'' || $old['refid_terima']<>'0') $errmsg='Data '.$edata.' Hasil Posting Penerimaan tidak bisa diedit !';
							if(!($old['refid_terima']=='' || $old['refid_terima']=='0' ||  $old['refid_terima'] == NULL) ) $errmsg='Data '.$edata.' Hasil Posting Penerimaan tidak bisa diedit  !';
							//die($errmsg);
							$fmURUSAN = $old['c1'];
							$fmSKPD = $old['c'];
							$fmUNIT = $old['d'];
				...
				if($errmsg == ''){
					...
					switch($Baru){
						case '0':{//edit ------------------------------------------------------------------
								...
								//cek no baru --------------------
								if( ($fmURUSAN_old != $fmURUSAN)||($fmSKPD_old != $fmSKPD)|| ($fmUNIT_old != $fmUNIT)|| ($fmSUBUNIT_old != $fmSUBUNIT)||
									...
									($fmIDBARANG != $fmIDBARANG_old) || ($fmTAHUNANGGARAN != $fmTAHUNANGGARAN_old) || $fmSEKSI !=$fmSEKSI_old )
								{
										$CekBaru = mysql_num_rows(mysql_query(
											"select * from buku_induk where concat(a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg)=
											'$fmKEPEMILIKAN{$Main->Provinsi[0]}$fmWIL$fmSKPD$fmURUSAN$fmUNIT$fmSUBUNIT$fmSEKSI{$ArBarang[0]}{$ArBarang[1]}{$ArBarang[2]}{$ArBarang[3]}{$ArBarang[4]}$fmTAHUNPEROLEHAN$fmREGISTER'")
										);
								}
								...
								*/
								...
								if($errmsg ==''){
									...
									if($Sukses == FALSE) $errmsg ='Gagal Simpan BI';
									if($Sukses){
										...
										**/
										...
										if( $Sukses && $fmSTATUSASET <> $old['staset'] && ($fmSTATUSASET ==9 || $old['staset'] == 9 )){
											...
											if( $get['cnt'] <= 1 ){
												...
												if($fmSTATUSASET==9){
													...
													if($Sukses == FALSE) $errmsg = 'Gagal Simpan aset lainlain';
												}
										...
										if( $Sukses && $fmSTATUSASET <> $old['staset'] && ($fmSTATUSASET ==10 || $old['staset'] == 10 ) ){
											...
											if( $get['cnt'] <= 1 ){
												...
												if($fmSTATUSASET ==10){
													...
													if($Sukses == FALSE) $errmsg = 'Gagal Simpan kapitalisasi';
												}
										...
										if($Sukses && $fmSTATUSASET <> $old['staset'] && ($fmSTATUSASET ==3 || $fmSTATUSASET ==9 || $fmSTATUSASET ==10 ) ){
											...
											if( $get['cnt'] <= 1 ){
												...
												if($Sukses == FALSE) $errmsg = 'Gagal Simpan history aset';
												//**/
										...
										if($Sukses){
											...
											//if( $trns['cnt']==1  ){
												...
												if($old['tgl_buku']!=$tgl_buku || $old['jml_harga'] !=$fmJUMLAHHARGA ||
													...
													$Sukses =mysql_query(" call sp_jurnal_bi('$idbi') ; ");
													//	mysql_query(" select sf_jurnal_bi($idbi) as cek ; ");
													if($Sukses == FALSE) $errmsg = 'Gagal Update Jurnal';
												}
												//}
											//}
										}
									...
									//UPDATE KIB B
											...
											//echo $Qry ;
											$Sukses = mysql_query($Qry);
											if($Sukses == FALSE) $errmsg = 'Gagal Simpan KIB';
										}
									//UPDATE KIB C
						...
						case '1':{	//simpan baru ------------------------------------------------------------
							...
							if($errmsg==''){
								...
								$Kriteria = "concat(a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg)='$fmKEPEMILIKAN{$Main->Provinsi[0]}$fmWIL$fmURUSAN$fmSKPD$fmUNIT$fmSUBUNIT$fmSEKSI{$ArBarang[0]}{$ArBarang[1]}{$ArBarang[2]}{$ArBarang[3]}{$ArBarang[4]}$fmTAHUNPEROLEHAN$fmREGISTER'";
								$str = "select *  from buku_induk where concat(a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg)=
								'$fmKEPEMILIKAN{$Main->Provinsi[0]}$fmWIL$fmURUSAN$fmSKPD$fmUNIT$fmSUBUNIT$fmSEKSI{$ArBarang[0]}{$ArBarang[1]}{$ArBarang[2]}{$ArBarang[3]}{$ArBarang[4]}$fmTAHUNPEROLEHAN$fmREGISTER'";
										...
										*/
										...
										if ($Sukses== FALSE){
											...
											*/
											...
											$Kriteria = "concat(a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg)=
												'$fmKEPEMILIKAN{$Main->Provinsi[0]}$fmWIL$fmURUSAN$fmSKPD$fmUNIT$fmSUBUNIT$fmSEKSI{$ArBarang[0]}{$ArBarang[1]}{$ArBarang[2]}{$ArBarang[3]}{$ArBarang[4]}$fmTAHUNANGGARAN$fmREGISTER'";
											...
											***/
											...
											if($ArBarang[0]=="01"){
													if ($alamat_b !=''){$alamat_a = $Main->DEF_PROPINSI;}
														$Qry =
														"insert into kib_a (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,luas,
											...
											//SIMPAN KIB B
														...
														$Qry = "insert into kib_b (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,merk,ukuran,bahan,no_pabrik,
											...
											//SIMPAN KIB C
														...
														(a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,
											...
											//SIMPAN KIB D
														...
														if ($alamat_b !=''){$alamat_a = $Main->DEF_PROPINSI;}
														$Qry = "insert into kib_d (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,konstruksi,
														panjang,lebar,luas,
														alamat,alamat_kel, alamat_kec, alamat_a, alamat_b, koordinat_gps,koord_bidang,
											...
											//SIMPAN KIB E
														...
														$Qry = "insert into kib_e (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,buku_judul,buku_spesifikasi,
											...
											//SIMPAN KIB F
														...
														$Qry = "insert into kib_f (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,
											...
											//kib g
												...
												$Qry = "insert into kib_g (a1,a,b,c1,c,d,e,e1,f,g,h,i,j,tahun,noreg,
				...
				if($Act=="Hapus" && count($cidBI) > 0){
					for($i = 0; $i<count($cidBI); $i++)	{
						...
						if($isi = mysql_fetch_array($Qry))	{
							...
							if($errmsg=='' && (!($old['refid_terima']=='' || $old['refid_terima']=='0' ) ) ) $errmsg = 'Barang tidak dapat dihapus karena data dari penerimaan !';
