<?php
//kertas kerja
class KertasKerja2Obj extends DaftarObj2{
	var $Prefix = 'KertasKerja2'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
	...
	//cetak --------------------
	var $cetak_xls=FALSE ;
	var $fileNameExcel='KertasKerja2.xls';
	...
	global $Main,$HTTP_COOKIE_VARS;
		...
		$headerTable =
			...
			"<tr>
				...
				<th class=\"th02\" colspan='2' >PENERIMAAN KAPITALISASI</th>
				<th class=\"th02\" rowspan='1' >PENERIMAAN HIBAH</th>
				<th class=\"th02\" rowspan='1' >PENERIMAAN KOREKSI</th>
				
				<th class=\"th02\" rowspan='1' >PEMELIHARAAN BM</th>
				<th class=\"th02\" rowspan='1' >PEMELIHARAAN BARJAS</th>
				<th class=\"th02\" rowspan='1' >PEMELIHARAAN HIBAH</th>
				
				<th class=\"th02\" colspan='1'>PEMELIHARAAN KOREKSI</th>
				...
				<!--<th class=\"th02\" >PENGHAPUSAN SEBAGIAN</th>
				<th class=\"th02\" >DOUBLE CATAT</th>
				-->
			</tr>
			<tr>
				$tampilKodeBarang
				...
				<th class=\"th03\" width='100' >DEBET</th>
				<th class=\"th03\" width='100' >DEBET</th><!-- penerimaan hibah -->
				
				
				<th class=\"th03\" width='100' >DEBET</th>	<!-- kapitalisasi d -->			
				<th class=\"th03\" width='100' >KREDIT</th><!-- kapitalisasi -->
				
				<th class=\"th03\" width='100' >KREDIT</th><!-- pemindahtangan hibah -->
		...
		$cek = $Main->SHOW_CEK  ? $cek : '';
			...
			*/	
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				"<td class='GarisDaftar' align=right><a href='$href&jns_trans=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_32' name='vrekap'></a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&jns_trans=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_33' name='vrekap'></a></td>".
				
				"<td class='GarisDaftar' align=right><a href='$href&jns_trans=4&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlHibahDSKPD</a></td>". //penerimaan hibah
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_27' name='vrekap'></a></td>".//27penerimaan - koreksi
				
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_22' name='vrekap'></a></td>".//22penerimaan - pemeliharaan - belanja modal
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_23' name='vrekap'></a></td>".//23penerimaan - pemeliharaan - barang jasa
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_26' name='vrekap'></a></td>".//26penerimaan - pemeliharaan - hibah
				
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_24' name='vrekap'></a></td>".//24penerimaan - pemeliharaan - koreksi & penggabungan - debet
				//"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_25' name='vrekap'></a></td>".//25penerimaan - pemeliharaan - koreksi & penggabungan - kredit
				...
				".
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_30' name='vrekap'></a></td>".//30 penggabungan d
				"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_31' name='vrekap'></a></td>".//31 penggabungan k
				...
				"<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_21' name='vrekap_$rowno"."_21'></a></td>". //nilai buku
				
				//"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_28' name='vrekap'></a></td>".//28 penghapusan sebagian
				//"<td class='GarisDaftar' align=right><a href='$href' target='blank_'  style='color:black;' id='vrekap_$rowno"."_29' name='vrekap'></a></td>".//29 double catat
			...
			<td class='GarisDaftar' align=right><a href='$hrefAk&jns_trans=10' target='blank_'  style='color:black;' id='vrekap_$rowno"."_20' name='vrekap' >$TampilJmlSusutAk</a></td>
			".
			"<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_21' name='vrekap'></a></td>". //nilai buku
				...
				if($fmLvlBrg == '2' || $fmLvlBrg=='3'){
					if($isix['g']<>'24'){
						if( ($fmLvlBrg=='2' && $isix['h']=='00') || ($fmLvlBrg=='3' && $isix['h']=='00' && $isix['i']=='00') ){
							...
							"<td class='GarisDaftar' align=right><a href='$href&jns_trans2=6' target='blank_'  style='color:black;' id='vrekap_$rowno"."_32' name='vrekap'></a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&jns_trans=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_33' name='vrekap'></a></td>".
	...
	function rekapNeraca(){
		...
		*/
		...
		$aqry = " select  ".
			...
			" sum( if( tgl_buku<'$tgl1' and jns_trans<>10, debet-kredit ,0) ) as total1_1, ".  // saldo awal harga
			" sum( if( tgl_buku<'$tgl1' and jns_trans<>10, jml_barang_d-jml_barang_k ,0) ) as total1_2, ". //saldo awal jml  barang
			" sum( if( tgl_buku<'$tgl1' and jns_trans=10, kredit-debet ,0) ) as total2_1, ".  //saldo awal penyusutan			
						
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=1 and jns_trans2=1, debet,0) ) as total3_1, ".    //penerimaan harga - bukan pemeliharaan
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=1 and jns_trans2=1, jml_barang_d,0) ) as total3_2, ".  //penerimaan jml
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=2, debet ,0) ) as total4_1, ".	//peneriman - atribusi 
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=1 or jns_trans2=6 ), debet ,0) ) as total32_1, ".	//penerimaan kapitalisasi dan pembelian ekstra d
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=1 or jns_trans2=6 ), jml_barang_d ,0) ) as total32_2, ".	//penerimaan kapitalisasi dan pembelian kstra d
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=1 or jns_trans2=6 ), kredit ,0) ) as total33_1, ".	//penerimaan kapitalisasi dan pembelian ekstra k
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=1 or jns_trans2=6 ), jml_barang_k ,0) ) as total33_2, ".	//penerimaan kapitalisasi dan pembelian ekstra k
			
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=4 and (jns_trans2=2 or  jns_trans2=3), debet  ,0) ) as total7_1, ". // penerimaan - hibah/lainnya		
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=4 and (jns_trans2=2 or  jns_trans2=3), jml_barang_d  ,0) ) as total7_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2=7, debet  ,0) ) as total27_1, ". 	//penerimaan - koreksi  
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2=7, jml_barang_d  ,0) ) as total27_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=1 and jns_trans2=9, debet ,0) ) as total22_1, ".	//penerimaan - pemeliharaan - belanja modal
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and jns_trans2=9, debet ,0) ) as total23_1, ".	//penerimaan - pemeliharaan - barang jasa
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2=9 and jns_trans3=5, debet ,0) ) as total24_1, ".	//penerimaan - pemeliharaan - koreksi - debet
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2=9, kredit ,0) ) as total25_1, ".	//penerimaan - pemeliharaan - koreksi & penggabungan - kredit			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=4 and jns_trans2=9, debet -kredit ,0) ) as total26_1, ".	//penerimaan - pemeliharaan - hibah
			
				
							
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=22 or jns_trans2=11), debet  ,0) ) as total5_1, ".	// kapital debet ekstra/intra - hapus sebagian
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3  and (jns_trans2=22 or jns_trans2=11), jml_barang_d  ,0) ) as total5_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=22 or jns_trans2=11), kredit  ,0) ) as total6_1, ".	//kapital kredit	ekstra/intra - hapus sebagian
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3 and (jns_trans2=22 or jns_trans2=11), jml_barang_k  ,0) ) as total6_2, ".
						
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=4, kredit  ,0) ) as total8_1, ".  	//pemindahtangan hibah kredit
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=4, jml_barang_k  ,0) ) as total8_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=5, debet  ,0) ) as total9_1, ".	//mutasi debet			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=5, jml_barang_d  ,0) ) as total9_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=5, kredit  ,0) ) as total10_1, ".	//mutasi kredit
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=5, jml_barang_k  ,0) ) as total10_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=6, debet-kredit  ,0) ) as total11_1, ".	//penilaian debet (+/-)
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=6, jml_barang_d - jml_barang_k  ,0) ) as total11_2, ".
			
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=6, kredit  ,0) ) as total12_1, ".	//penilaian kredit	?	
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=6, jml_barang_k  ,0) ) as total12_2, ".
			
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=7, debet  ,0) ) as total13_1, ". 		
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=7, jml_barang_d  ,0) ) as total13_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=7, kredit  ,0) ) as total12_1, ".	//penghapusan
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=7, jml_barang_k  ,0) ) as total12_2, ". 	
			  			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2<>9 and jns_trans2<>7 and jns_trans2<>37, debet  ,0) ) as total13_1, ". 	//koreksi debet - bukan koreksi  pemeliharaan - bukan koreksi pengadaan - bukan penggabungan
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2<>9 and jns_trans2<>7 and jns_trans2<>37, jml_barang_d  ,0) ) as total13_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2<>9 and jns_trans2<>7 and jns_trans2<>37, kredit  ,0) ) as total14_1, ".	//koreksi kredit		
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2<>9 and jns_trans2<>7 and jns_trans2<>37, jml_barang_k  ,0) ) as total14_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=9, debet  ,0) ) as total15_1, ".	//reklas debet
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=9, jml_barang_d  ,0) ) as total15_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=9, kredit  ,0) ) as total16_1, ".	//reklas kredit	
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=9, jml_barang_k  ,0) ) as total16_2, ".
			
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=10, debet  ,0) ) as total17_1, ". 	//penyusutan debt
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=10, kredit  ,0) ) as total18_1, ".	//penyusutan kredit
			
			
			" sum( if( tgl_buku<='$tgl2' and jns_trans<>10, debet-kredit ,0) ) as total19_1, ".  //saldo akhir harga
			" sum( if( tgl_buku<='$tgl2' and jns_trans<>10, jml_barang_d-jml_barang_k ,0) ) as total19_2, ". //saldo akhir jml
			" sum( if( tgl_buku<='$tgl2' and jns_trans=10, kredit-debet ,0) ) as total20_1, ".   //saldo akhir penyusutan
			" sum( if( tgl_buku<='$tgl2' and jns_trans<>10, debet-kredit ,0) ) - sum( if( tgl_buku<='$tgl2' and jns_trans=10, kredit-debet ,0) ) as total21_1, ". //nilai buku
			
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans<>10 and jns_trans2=11, kredit ,0) ) as total28_1, ".	//penghapusan sebagian
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans<>10 and jns_trans2=38, kredit ,0) ) as total29_1, ".	//double catat
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=8 and jns_trans2=9 and jns_trans3=4, debet ,0) ) as total30_1, ".//penggabungan debet
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans<>10 and jns_trans2=37, kredit ,0) ) as total31_1, ".	//penggabungan kredit
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans<>10 and jns_trans2=37, jml_barang_k ,0) ) as total31_2, ".	//penggabungan kredit
			
			
			
			//" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=3, jml_barang_d  ,0) ) as total22_2, ".
...
$KertasKerja2= new KertasKerja2Obj();
