...
class RekapBIObj extends DaftarObj2{
	var $Prefix = 'RekapBI'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
	...
	//cetak --------------------
	var $cetak_xls=FALSE ;
	var $fileNameExcel='rekapbi.xls';
	var $Cetak_Judul = 'Rekap BI';
	//var $Cetak_Header;
	var $Cetak_Mode=2;
	...
	var $PageTitle ='Penatausahaan';// 'Rekap Neraca';
	...
	function setTitle(){
		...
		return 'Rekapitulasi Buku Inventaris Barang';
	}
	...
	global $Main, $Menu;	
		...
		if($Main->MENU_VERSI==3){
			...
			<A href=\"pages.php?Pg=Rekap3\" title='Rekap Mutasi' >REKAP MUTASI</a>
			$menu_rekapneraca_2
			| <A href=\"pages.php?Pg=Rekap1\" title='Rekap BI' style='color:blue;'>NERACA</a>
			  &nbsp&nbsp&nbsp
			</td></tr></table>
			";
		}else{
		...
		$menubar = 			//"<tr height='22' valign='top'><td >".
			...
			<A href=\"index.php?Pg=05&SPg=08\" title='Aset Tetap Lainnya'>KIB E</a>  |  
			<A href=\"index.php?Pg=05&SPg=09\" title='Konstruksi Dalam Pengerjaan'>KIB F</a>  |  
			<A href=\"index.php?Pg=05&SPg=09\" title='Aset Tidak Berwujud'>KIB G</a>  | ".
			
			"<A href=\"index.php?Pg=05&SPg=KIR\" title='Kartu Inventaris Ruangan'>KIR</a> | ". 
						
			"<A href=\"index.php?Pg=05&SPg=11\" title='Rekap BI' $styleMenu>REKAP BI</a> | ".
			//if($Main->MODUL_MUTASI) $menubar=$menubar.
			"<A href=\"index.php?Pg=05&SPg=12\" title='Daftar Mutasi'>MUTASI</a>  |
			<A href=\"index.php?Pg=05&SPg=13\" title='Rekap Mutasi'>REKAP MUTASI</a> ".
	...
	**/
	...
	function genDaftarOpsi(){
		...
		$fmFiltThnBuku = $_REQUEST['fmFiltThnBuku']==''?$thn_login: $_REQUEST['fmFiltThnBuku'];
	...
	// $smter=$_POST['$fmSemester'];
		...
		while($isi=mysql_fetch_array($Qry)){
			...
			*/
			...
			/**
			switch($fmLvlBrg){
				case '1': $get_table="v_ref_kib_keu"; $sel="f,g"; $konLvl1=""; break; //lv2
				case '2': $get_table="v_ref_kib_keu_h_lv3"; $sel="f,g,h"; $konLvl1=""; break; //lv3
				case '3': $get_table="v_ref_kib_keu_h1"; $sel="f,g,h,i"; $konLvl1=""; break; //lv4
				default : $get_table="v_ref_kib_keu"; $sel="f,g"; $konLvl1="and g='00'"; break; //lv1
			}**/
			
			switch($fmLvlBrg){
				case '1': $get_table="v_ref_rekapbi"; $sel="f,g"; $konLvl1=" and h='00'"; break; //lv2
				case '2': $get_table="v_ref_rekapbi"; $sel="f,g,h"; $konLvl1=" and i='00'"; break; //lv3
				case '3': $get_table="v_ref_rekapbi"; $sel="f,g,h,i"; $konLvl1=" and j='000'"; break; //lv4
				default : $get_table="v_ref_rekapbi"; $sel="f,g"; $konLvl1="and g='00'"; break; //lv1
			}
				$bqry =
					//"select kint,ka,kb, $sel,nm_barang ,
					"select kb, $sel,nm_barang ,
					...
					where  kb<>'00' $konLvl1";  //die('list='.$bqry);
				...
				***/
				...
				if($fmLvlBrg=='2' || $fmLvlBrg=='3'){
					if($isix['g']=='00'){
						...
						//$vnmbarang = "<b>&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>";
						//$vnmbarang = "<b><span style='margin-left:20px;float:left;'>{$isix['nm_barang']}</span></b>";
				...
				//gen param href ----------------------------------------------------------------------------------------------------------
				//khusus aset tidak berwujud jika g='00'
				if($isix['f']=='07' && $isix['g']=='00') {
					 $isix['g']='24';
				}else{
					$isix['g1']=$isix['g'];
				...
				$hrefAw = "pages.php?Pg=JurnalBI$paramSKPD$paramKdAkun&tgl2=$tglAwal2";
				$hrefAk = "pages.php?Pg=JurnalBI$paramSKPD$paramKdAkun&tgl2=$tglAkhir";
				$href 	= "pages.php?Pg=JurnalBI$paramSKPD$paramKdAkun&tgl1=$tglAwal&tgl2=$tglAkhir";
