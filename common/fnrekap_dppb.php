...
class RekapDppbObj extends DaftarObj2{
	var $Prefix = 'rekapdppb';
	var $SHOW_CEK = TRUE;	
	var $TblName = 'v1_pengadaan_pemeliharaan';
	...
	//var $cetak_xls = TRUE;
	var $fileNameExcel='rekapdppbmd.xls';
	var $Cetak_Judul = 'REKAP PENGADAAN PEMELIHARAAN BARANG MILIK DAERAH';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'Rekap Pengadaan Pemeliharaan Barang Milik Daerah ';
	...
	function setNavAtas(){
		return
			...
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				<a href="pages.php?Pg=dpb" title="Daftar Pengadaan Barang Milik Daerah">DPBMB</a>  |  
