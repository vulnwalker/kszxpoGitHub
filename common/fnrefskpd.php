...
class RefSKPDObj  extends DaftarObj2{	
	var $Prefix = 'refSKPD';
	...
	//var $cetak_xls=TRUE ;
	var $fileNameExcel='daftarSKPD.xls';
	var $Cetak_Judul = 'DAFTAR SKPD';	
	var $Cetak_Mode=2;
...
genFilterBar(
				array( 
					...
					//"<div id='cbxRuangGedung' style='flaot:left'>	".
					"<span id='cbxKota'>".
					genComboBoxQry( 'fmSKPD', $fmSKPD, 
						"select * from ref_skpd where d='00'  ",
						'c', 'nm_skpd', '-- Semua BIDANG --',"style='width:140'" ).
					"</span"
				)				
...
$refSKPD = new RefSKPDObj();


class RefSKPDPilihObj  extends RefSKPDObj{
	var $Prefix = 'refSKPDPilih';
	var $elCurrPage="HalDefault";
	var $TblName = 'ref_skpd'; //daftar
	var $TblName_Hapus = 'ref_skpd';
	var $MaxFlush = 10;
	...
	var $PageIcon = 'images/masterdata_ico.gif';
	//var $cetak_xls=TRUE ;
	var $fileNameExcel='ref_skpd.xls';
...
$refSKPDPilih = new RefSKPDPilihObj();
