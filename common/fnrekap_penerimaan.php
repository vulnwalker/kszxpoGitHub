...
class RekapPenerimaanObj extends DaftarObj2{
	var $Prefix = 'rekappenerimaan';
	var $SHOW_CEK = TRUE;	
	var $TblName = 'v1_penerimaan';
	...
	var $PageTitle = 'Penerimaan';
	var $PageIcon = 'images/penerimaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	//var $cetak_xls = TRUE;
	var $fileNameExcel='rekappenerimaan.xls';
	var $Cetak_Judul = 'REKAP PENERIMAAN BARANG MILIK DAERAH';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'Rekap Penerimaan Barang Milik Daerah ';		
	}
	function setNavAtas(){
	global $Main;
		...
		if ( $Main->VERSI_NAME == 'JABAR') {
			...
			<a href="pages.php?Pg=rekappenerimaan" style="color:blue;" title="Rekap Daftar Penerimaan Barang Milik Daerah">Rekap Penerimaan</a>  |  
	...
	function setDaftar_hal($jmlData){
		...
		$get = mysql_fetch_array(mysql_query(
			"select count(*) as cnt from ref_barang where h='00' and i='00' and j ='00'"
		));
		$jmlData = $get['cnt'];
...
$rekappenerimaan = new RekapPenerimaanObj();
