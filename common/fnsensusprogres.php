...
class SensusProgresObj extends DaftarObj2{
	...
	function setPage_HeaderOther(){	
		...
		if($Main->MENU_VERSI==3){
			...
			<A href=\"pages.php?Pg=SensusScan$link_inventaris\" title='Hasil Scan' $styleMenu2_9>Hasil Scan</a> |
			...
			<A href=\"pages.php?Pg=SensusHasil2$link_inventaris\" title='Rekapitulasi Hasil Sensus' $styleMenu2_4_>Hasil Sensus</a>   | 			
			<A href=\"pages.php?Pg=SensusProgres$link_inventaris\" title='Sensus Progress' $styleMenu2_4>Sensus Progress</a>   
			  &nbsp&nbsp&nbsp
			</td></tr></table>"
			;
		}else{
