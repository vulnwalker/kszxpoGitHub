...
bb.debet_penilaian,bb.kredit_penghapusan,bb.debet_koreksi,bb.kredit_koreksi,bb.debet_reklass,bb.kredit_reklass,
...
// aset lainnya v_jurnal_aset_lainnya -------------------------------------------------------------------------
	 $bqry="
...
// aset extra v_jurnal_aset_ekstra -------------------------------------------------------------------------------------
...
/*
select `db_atsbd_srg`.`buku_induk`.`a1` AS `a1`,`db_atsbd_srg`.`buku_induk`.`a` AS `a`,`db_atsbd_srg`.`buku_induk`.`b` AS `b`,`db_atsbd_srg`.`buku_induk`.`c` AS `c`,`db_atsbd_srg`.`buku_induk`.`d` AS `d`,`db_atsbd_srg`.`buku_induk`.`e` AS `e`,`db_atsbd_srg`.`buku_induk`.`e1` AS `e1`,`db_atsbd_srg`.`buku_induk`.`f` AS `f`,`db_atsbd_srg`.`buku_induk`.`g` AS `g`,`db_atsbd_srg`.`buku_induk`.`jml_barang` AS `jml_barang_d`,0 AS `jml_barang_k`,ifnull(`db_atsbd_srg`.`buku_induk`.`jml_harga`,0) AS `debet`,0 AS `kredit`,`db_atsbd_srg`.`buku_induk`.`tgl_buku` AS `tgl_buku`,ifnull(`db_atsbd_srg`.`buku_induk`.`harga_atribusi`,0) AS `harga_atribusi`,`db_atsbd_srg`.`buku_induk`.`asal_usul` AS `asal_usul`,`db_atsbd_srg`.`buku_induk`.`status_barang` AS `status_barang`,`db_atsbd_srg`.`buku_induk`.`staset` AS `staset`,if((`db_atsbd_srg`.`buku_induk`.`asal_usul` = 1),1,if((`db_atsbd_srg`.`buku_induk`.`asal_usul` = 2),4,if((`db_atsbd_srg`.`buku_induk`.`asal_usul` = 4),5,if((`db_atsbd_srg`.`buku_induk`.`asal_usul` = 5),9,1)))) AS `jns_trans`
from `db_atsbd_srg`.`buku_induk` union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`aa`.`biaya_pemeliharaan` AS `debet`,0 AS `kredit`,`aa`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,3 AS `jns_trans`
from (`db_atsbd_srg`.`pemeliharaan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where (`aa`.`tambah_aset` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`aa`.`biaya_pengamanan` AS `debet`,0 AS `kredit`,`aa`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,3 AS `jns_trans`
from (`db_atsbd_srg`.`pengamanan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where (`aa`.`tambah_aset` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`aa`.`harga_hapus` AS `kredit`,`aa`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,3 AS `jns_trans`
from (`db_atsbd_srg`.`penghapusan_sebagian` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) union all select `db_atsbd_srg`.`buku_induk`.`a1` AS `a1`,`db_atsbd_srg`.`buku_induk`.`a` AS `a`,`db_atsbd_srg`.`buku_induk`.`b` AS `b`,`db_atsbd_srg`.`buku_induk`.`c` AS `c`,`db_atsbd_srg`.`buku_induk`.`d` AS `d`,`db_atsbd_srg`.`buku_induk`.`e` AS `e`,`db_atsbd_srg`.`buku_induk`.`e1` AS `e1`,`db_atsbd_srg`.`buku_induk`.`f` AS `f`,`db_atsbd_srg`.`buku_induk`.`g` AS `g`,0 AS `jml_barang_d`,`db_atsbd_srg`.`buku_induk`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`db_atsbd_srg`.`buku_induk`.`jml_harga` AS `kredit`,`db_atsbd_srg`.`buku_induk`.`tgl_buku` AS `tgl_buku`,`db_atsbd_srg`.`buku_induk`.`harga_atribusi` AS `harga_atribusi`,`db_atsbd_srg`.`buku_induk`.`asal_usul` AS `asal_usul`,`db_atsbd_srg`.`buku_induk`.`status_barang` AS `status_barang`,`db_atsbd_srg`.`buku_induk`.`staset` AS `staset`,3 AS `jns_trans`
from `db_atsbd_srg`.`buku_induk`
where (`db_atsbd_srg`.`buku_induk`.`staset` = 10) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_pemindahtanganan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,4 AS `jns_trans`
from (`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where (`aa`.`bentuk_pemindahtanganan` = 3) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,4 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_pemindahtanganan`))))
where (`aa`.`bentuk_pemindahtanganan` = 3) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,4 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_pemindahtanganan`))))
where (`aa`.`bentuk_pemindahtanganan` = 3) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,4 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_pemindahtanganan`))))
where (`aa`.`bentuk_pemindahtanganan` = 3) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,5 AS `jns_trans`
from (`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where ((`aa`.`mutasi` = 1) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,5 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 1) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,5 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 1) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,5 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 1) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,7 AS `jns_trans`
from (`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where ((`aa`.`mutasi` = 0) and ((`bb`.`staset` <= 3) or (`bb`.`staset` = 8))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,7 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 0) and ((`bb`.`staset` <= 3) or (`bb`.`staset` = 8))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,7 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 0) and ((`bb`.`staset` <= 3) or (`bb`.`staset` = 8))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,7 AS `jns_trans`
...
where ((`aa`.`mutasi` = 0) and ((`bb`.`staset` <= 3) or (`bb`.`staset` = 8))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_pemindahtanganan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where ((`aa`.`bentuk_pemindahtanganan` <> 3) and (`aa`.`bentuk_pemindahtanganan` <> 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_pemindahtanganan`))))
where ((`aa`.`bentuk_pemindahtanganan` <> 3) and (`aa`.`bentuk_pemindahtanganan` <> 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_pemindahtanganan`))))
where ((`aa`.`bentuk_pemindahtanganan` <> 3) and (`aa`.`bentuk_pemindahtanganan` <> 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,`aa`.`staset` AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_pemindahtanganan`))))
where ((`aa`.`bentuk_pemindahtanganan` <> 3) and (`aa`.`bentuk_pemindahtanganan` <> 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where ((`aa`.`mutasi` = 2) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 2) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tambah_aset` = 1) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 2) and (`aa`.`sudahmutasi` = 1)) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`penghapusan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`cc`.`id_bukuinduk` = `aa`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_penghapusan`))))
where ((`aa`.`mutasi` = 2) and (`aa`.`sudahmutasi` = 1)) union all select `db_atsbd_srg`.`buku_induk`.`a1` AS `a1`,`db_atsbd_srg`.`buku_induk`.`a` AS `a`,`db_atsbd_srg`.`buku_induk`.`b` AS `b`,`db_atsbd_srg`.`buku_induk`.`c` AS `c`,`db_atsbd_srg`.`buku_induk`.`d` AS `d`,`db_atsbd_srg`.`buku_induk`.`e` AS `e`,`db_atsbd_srg`.`buku_induk`.`e1` AS `e1`,`db_atsbd_srg`.`buku_induk`.`f` AS `f`,`db_atsbd_srg`.`buku_induk`.`g` AS `g`,0 AS `jml_barang_d`,`db_atsbd_srg`.`buku_induk`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,ifnull(`db_atsbd_srg`.`buku_induk`.`jml_harga`,0) AS `kredit`,`db_atsbd_srg`.`buku_induk`.`tgl_buku` AS `tgl_buku`,0 AS `harga_atribusi`,`db_atsbd_srg`.`buku_induk`.`asal_usul` AS `asal_usul`,`db_atsbd_srg`.`buku_induk`.`status_barang` AS `status_barang`,`db_atsbd_srg`.`buku_induk`.`staset` AS `staset`,9 AS `jns_trans`
from `db_atsbd_srg`.`buku_induk`
where (`db_atsbd_srg`.`buku_induk`.`staset` = 9) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`aa`.`biaya_pemeliharaan` AS `kredit`,`aa`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`pemeliharaan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on(((`aa`.`id_bukuinduk` = `bb`.`id`) and (`bb`.`staset` = 9))))
where (`aa`.`tambah_aset` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`aa`.`biaya_pengamanan` AS `kredit`,`aa`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`pengamanan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on(((`aa`.`id_bukuinduk` = `bb`.`id`) and (`bb`.`staset` = 9))))
where (`aa`.`tambah_aset` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`aa`.`harga_hapus` AS `debet`,0 AS `kredit`,`aa`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`penghapusan_sebagian` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on(((`aa`.`id_bukuinduk` = `bb`.`id`) and (`bb`.`staset` = 9)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_pemindahtanganan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`)))
where (`aa`.`bentuk_pemindahtanganan` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_pemindahtanganan`) and (`cc`.`tambah_aset` = 1))))
where (`aa`.`bentuk_pemindahtanganan` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_pemindahtanganan`) and (`cc`.`tambah_aset` = 1))))
where (`aa`.`bentuk_pemindahtanganan` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemindahtanganan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_pemindahtanganan`))))
where (`aa`.`bentuk_pemindahtanganan` = 1) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_gantirugi` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`gantirugi` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`gantirugi` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_gantirugi`) and (`cc`.`tambah_aset` = 1)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`gantirugi` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_gantirugi`) and (`cc`.`tambah_aset` = 1)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`gantirugi` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_gantirugi`)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,`bb`.`jml_barang` AS `jml_barang_k`,0 AS `debet`,`bb`.`jml_harga` AS `kredit`,`aa`.`tgl_pemanfaatan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from (`db_atsbd_srg`.`pemanfaatan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pemeliharaan` AS `kredit`,`cc`.`tgl_pemeliharaan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemanfaatan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pemeliharaan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pemeliharaan` < `aa`.`tgl_pemanfaatan`) and (`cc`.`tambah_aset` = 1)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,0 AS `debet`,`cc`.`biaya_pengamanan` AS `kredit`,`cc`.`tgl_pengamanan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemanfaatan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`pengamanan` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_pengamanan` < `aa`.`tgl_pemanfaatan`) and (`cc`.`tambah_aset` = 1)))) union all select `bb`.`a1` AS `a1`,`bb`.`a` AS `a`,`bb`.`b` AS `b`,`bb`.`c` AS `c`,`bb`.`d` AS `d`,`bb`.`e` AS `e`,`bb`.`e1` AS `e1`,`bb`.`f` AS `f`,`bb`.`g` AS `g`,0 AS `jml_barang_d`,0 AS `jml_barang_k`,`cc`.`harga_hapus` AS `debet`,0 AS `kredit`,`cc`.`tgl_penghapusan` AS `tgl_buku`,0 AS `harga_atribusi`,0 AS `asal_usul`,0 AS `status_barang`,0 AS `staset`,9 AS `jns_trans`
from ((`db_atsbd_srg`.`pemanfaatan` `aa` join `db_atsbd_srg`.`buku_induk` `bb` on((`aa`.`id_bukuinduk` = `bb`.`id`))) join `db_atsbd_srg`.`penghapusan_sebagian` `cc` on(((`aa`.`id_bukuinduk` = `cc`.`id_bukuinduk`) and (`cc`.`tgl_penghapusan` < `aa`.`tgl_pemanfaatan`))))
*/
