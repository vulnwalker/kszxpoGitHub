<?php
//kertas kerja
class KertasKerjaObj extends DaftarObj2{
	var $Prefix = 'KertasKerja'; //jsname
	var $SHOW_CEK = FALSE;
	var $withform = TRUE;
	//daftar -------------------
	...
	//cetak --------------------
	var $cetak_xls=FALSE ;
	var $fileNameExcel='KertasKerja.xls';
	var $Cetak_Judul = 'Kertas Kerja';
	//var $Cetak_Header;
	var $Cetak_Mode=2;
...
.nfmt5 {
	...
	*/
	...
	function getQueryPost($mode = 0){
		global $Main, $HTTP_COOKIE_VARS;
		//0 = mode cari, 1 = mode post
		$aqry = '';
		$prog = $_REQUEST['prog'];
		$awal = $_REQUEST['awal'];
		...
		/**
		$arrKond = array();
		if($c1!='00' && $c1!='') $arrKond[] = " c1='$c1' "; 
		if($c!='00' && $c!='') $arrKond[] = " c='$c' "; 
		if($d!='00' && $d!='') $arrKond[] = " d='$d' "; 
		if($e!='00' && $e!='') $arrKond[] = " e='$e' "; 
		if($e1!='00' && $e1!='') $arrKond[] = " e1='$e1' ";
		...
		if($awal==1){
			# cari saldo awal yg belum post - perolehan
			$aqry = "insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid) "+
				"select  distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 0 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 1 as mode, '$sessionID' AS sessionid "+
				"from t_jurnal_aset where year(tgl_buku) < '$thnAnggaran' and jns_trans<>10 $Kondisi and  "+ 
				"concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j) not in (  "+
				"select concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j) from t_jurnal_aset_rekap where stposting = 1 $Kondisi and jns_trans=0 and year(tgl_buku) < '$thnAnggaran' );";
			$qry = mysql_query($aqry);
			if($qry==FALSE) die($aqry);
			# cari saldo awal yg belum post - penyusutan
			$qry = mysql_query("insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid)  "+
				"select  distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 10 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 2 as mode, '$sessionID' AS sessionid  "+
				"from t_jurnal_aset where year(tgl_buku) < '$thnAnggaran' and jns_trans=10 $Kondisi and  "+
				"concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j) not in (  "+
				"select concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j) from t_jurnal_aset_rekap where stposting = 1 $Kondisi and jns_trans=10 and year(tgl_buku) < '$thnAnggaran' );");
			if($qry==FALSE) die('tes2');	
			# cari transaksi sem1 
			$qry = mysql_query("insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid) "+
				"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 3 as mode, '$sessionID' AS sessionid "+
				"from t_jurnal_aset where year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku <= concat('$thnAnggaran','-06-30')  and  "+
				"concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3) not in ( "+
				"select concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3) from t_jurnal_aset_rekap  "+
				"where stposting = 1 and year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku <= concat('$thnAnggaran','-06-30') );");
			if($qry==FALSE) die('tes3');
			# cari transaksi sem2 
			$qry = mysql_query("insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid) "+
				"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 4 as mode, '$sessionID' AS sessionid "+
				"from t_jurnal_aset where year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku > concat($thnAnggaran,'-06-30')  and  "+
				"concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3) not in ( "+
				"select concat(c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3) from t_jurnal_aset_rekap  "+
				"where stposting = 1 and year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku > concat('$thnAnggaran','-06-30') );");
			if($qry==FALSE) die('tes4');
		...
		* **/
		...
		//if($pernahPost==0){
		if($mode == 0){
			//$aqry = "select   c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j,jns_trans, jns_trans2,jns_trans3 from v_ref_jurnal_post $Kondisi ";
			$aqry = "select distinct  c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j,jns_trans, jns_trans2,jns_trans3, mode from tmp_belumpost_jurnalrekap where sessionid='$sessionID' ";
		}else{
			$aqry = "select distinct  c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j,jns_trans, jns_trans2,jns_trans3,mode,".
				"sf_jurnal_rekap_v2( c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j,jns_trans, jns_trans2, jns_trans3, '$thnAnggaran', '$UID',  mode ) ".			
				"from tmp_belumpost_jurnalrekap where sessionid='$sessionID' ";
		}
	...
	function getJmlDataPost(){
		...
		if($c1=='00' || $c1 =='' || $c1 =='0'){
			$get = mysql_fetch_array(mysql_query("select count(*) as cnt from t_jurnal_aset where c1 is null or c is null or d is null or e is null or e1 is null  "));
			if($err=='' && $get['cnt']>0 ) $err = "Ada data jurnal dengan kode SKPD null, Harap hubungi admin!";		
		}
		
		$get = mysql_fetch_array(mysql_query("select count(*) as cnt from t_jurnal_aset where tgl_buku is null $Kondisi "));
		if($err=='' && $get['cnt']>0 ) $err = "Ada data jurnal dengan tanggal buku null, Harap hubungi admin!";
		
		$get = mysql_fetch_array(mysql_query("select count(*) as cnt from t_jurnal_aset where f1 is null or f2 is null or f is null or g is null or h is null or i is null or j is null $Kondisi "));
		if($err=='' && $get['cnt']>0 ) $err = "Ada data jurnal dengan kode barang null, Harap hubungi admin!";
		
		$get = mysql_fetch_array(mysql_query("select count(*) as cnt from t_jurnal_aset where kint is null or ka is null or kb is null $Kondisi "));
		if($err=='' && $get['cnt']>0 ) $err = "Ada data jurnal dengan kode rekap null, Harap hubungi admin!";
		
		//$get = mysql_fetch_array(mysql_query("select count(*) as cnt from t_jurnal_aset where jns_trans is null or jns_trans2 is null or jns_trans3 is null  "));
		//if($err=='' && $get['cnt']>0 ) $err = "Ada data jurnal dengan jns_trans null, Harap hubungi admin!";
		
		if($err == ''){
				
			
			mysql_query("update t_jurnal_aset set jns_trans=0 where jns_trans is null;");
			mysql_query("update t_jurnal_aset set jns_trans2=0 where jns_trans2 is null;");
			mysql_query("update t_jurnal_aset set jns_trans3=0 where jns_trans3 is null;");
			//$aqry = "select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans, jns_trans2, jns_trans3 from t_jurnal_aset  ";
			mysql_query("delete from tmp_belumpost_jurnalrekap where tgl_create <= DATE_SUB(NOW() , INTERVAL 2 DAY)  ");
			...
			**/
			...
			if($awal==1){
				...
				# cari saldo awal yg belum post - perolehan
				if($err==''){
					$aqry = "insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select  distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 0 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 1 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran ".
						"from t_jurnal_aset where year(tgl_buku) < '$thnAnggaran' and jns_trans<>10 and stposting=0 $Kondisi ;";
						//" union distinct  ".
					$qry = mysql_query($aqry); 
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					$aqry =
						"insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select  distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 0 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 1 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran ".
						"from t_jurnal_aset_rekap where stposting = 0 $Kondisi and jns_trans=0 and year(tgl_buku) < '$thnAnggaran' ;";
					$qry = mysql_query($aqry); 
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					...
					# cari saldo awal yg belum post - penyusutan
					$aqry = "insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran)  ".
						"select distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 10 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 2 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran  ".
						"from t_jurnal_aset where year(tgl_buku) < '$thnAnggaran' and jns_trans=10 and stposting=0 $Kondisi   ;";				
				...
				if($err==''){
					$aqry =
						"insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran)  ".
						"select distinct c1,c,d,e,e1, kint, ka, kb, f1,f2,f,g,h,i,j, 10 as jns_trans, 0 as jns_trans2, 0 as jns_trans3 , 2 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran  ".
						" from t_jurnal_aset_rekap where stposting = 0 $Kondisi and jns_trans=10 and year(tgl_buku) < '$thnAnggaran' ;";
					$qry = mysql_query($aqry); //$cek.= $aqry;
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					...
					# cari transaksi sem1 
					$aqry = "insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 3 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran ".
						"from t_jurnal_aset where year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku <= concat('$thnAnggaran','-06-30') and stposting=0  ";
					$qry = mysql_query($aqry); //$cek = $aqry;
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					$aqry =
						//" union distinct  ".
						"insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 3 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran  from t_jurnal_aset_rekap  ".
						"where stposting = 0 and year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku <= concat('$thnAnggaran','-06-30') ;";
					$qry = mysql_query($aqry); //$cek.= $aqry;
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					...
					# cari transaksi sem2 
					$aqry = "insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 4 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran  ".
						"from t_jurnal_aset where year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku > concat($thnAnggaran,'-06-30') and stposting=0   ";
					$qry = mysql_query($aqry); //$cek = $aqry;
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
				if($err==''){
					$aqry =
						//" union distinct  ".
						"insert into tmp_belumpost_jurnalrekap ( c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , mode, sessionid, uid, thn_anggaran) ".
						"select distinct c1,c,d,e,e1, kint,ka,kb, f1,f2,f,g,h,i,j, jns_trans,jns_trans2,jns_trans3 , 4 as mode, '$sessionID' AS sessionid, '$UID' as uid, '$thnAnggaran' as thn_anggaran from t_jurnal_aset_rekap  ".
						"where stposting = 0 and year(tgl_buku) = '$thnAnggaran' $Kondisi and tgl_buku > concat('$thnAnggaran','-06-30') ;";
					$qry = mysql_query($aqry); $cek .= $aqry;
					if($qry==FALSE) $err='Gagal, user lain sedang posting';
				}
			...
			$aqry = $this->getQueryPost(0);// $cek .= $aqry;
			$qry = mysql_query($aqry);
			$content->jmldata = mysql_num_rows($qry);
		}
	...
	function posting(){
		...
		$jml = $Main->SETTING['POST_REKAP_STEP']==''? 50: $Main->SETTING['POST_REKAP_STEP']; 
		...
		$aqry = $this->getQueryPost(1). "  limit $prog,$jml ";
		$qry = mysql_query($aqry);
		
		$cek = $aqry;
		if($qry == FALSE) $err = 'Gagal query';
		$content->jml = $jml;
		
		
		return	array ('cek'=>$cek, 'err'=>$err, 'content'=>$content, 'json'=>$json);
	}
	function postingFinal(){
		global $Main, $HTTP_COOKIE_VARS;
		$cek = ''; $err=''; $content=''; $json=TRUE;
		
		$sessionID = $_REQUEST['sessionID'];
		//$aqry = "delete from tmp_belumpost_jurnalrekap where sessionid='$sessionID' ";
		//$qry = mysql_query($aqry);
		//if($qry == FALSE) $err = 'Gagal Posting Final';
	...
	function set_selector_other($tipe){
		...
		switch($tipe){				
			case 'postingFinal':{			    
				$fm = $this->postingFinal();// $this->total();				
				$cek = $fm['cek'];
				$err = $fm['err'];
				$content = $fm['content'];	
				$json = $fm['json'];// die '$json='.$json;
				break;
			}	
			case 'rekapNeraca':{			    
	...
	function rekapNeraca(){
		...
		*/
		...
		$aqry = " select  ".
			...
			" sum( if( tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans=2, debet ,0) ) as total2_1, ".
		...
		$pageArr = array(
				...
				if($Main->HEADER_JSON) header('Content-Type: application/json');
				echo $page;		
		//die('tes'.$json);
		*/
		//$cek = '';
	...
	function genDaftarInitial(){
		...
		return		
			...
			"<div id='{$this->Prefix}_cont_opsi' style='position:relative'>". 
				//$vOpsi['TampilOpt'].
				"<input type='hidden' id='fmSemester' name='fmSemester' value='2'> ". //default tahunan
			"</div>".
	...
	function setPage_HeaderOther(){
		...
		if($Main->VERSI_NAME=='JABAR' && $Main->MENU_VERSI <3){
			...
			$menu_rekapneraca_2 = $Main->REKAP_NERACA_2 ?
				" | <A href=\"pages.php?Pg=".$this->Prefix."\" title='Rekap Neraca' $styleMenu >REKAP NERACA</a>": '';
			...
			$menu_penyusutan = $Main->PENYUSUTAN ? " <A href=\"index.php?Pg=05&jns=penyusutan\" $styleMenuPenyusutan title='Penyusutan'>PENYUSUTAN</a> |   ":'';
			$menu_rekapneraca_2 = $Main->REKAP_NERACA_2 ? " | <A href=\"pages.php?Pg=".$this->Prefix."\" title='Rekap Neraca' $styleMenu >KERTAS KERJA</a>": '';
			$menu_kibg1 = $Main->MODUL_ASET_LAINNYA?
				"<A href=\"index.php?Pg=05&SPg=kibg&jns=atb\" $styleMenu3_9 title='Aset Tak Berwujud'>ASET TAK BERWUJUD</a> |":'';
	...
	function genDaftarOpsi(){
		...
		*/
		...
		if ($fmFiltThnBuku=='') $fmFiltThnBuku = $HTTP_COOKIE_VARS['coThnAnggaran'];
		
		
		$TampilOpt =
			"<table width=\"100%\" class=\"adminform\">	<tr>		
			<td width=\"100%\" valign=\"top\">		
				" . WilSKPD_ajx4($this->Prefix.'Skpd') . 
			"</td>
			<td style='padding:6'>
			</td>
			</tr></table>".
			...
			genFilterBar(
				...
				),$this->Prefix.".formPost()",TRUE
			)
			;
		//die('tess2'.$this->Prefix);
	...
	global $Main,$HTTP_COOKIE_VARS;
		...
		$headerTable =
			"<tr>
				...
				<th class=\"th02\" >$belanjaModal</th>
				<th class=\"th02\" >ATRIBUSI</th>
				<th class=\"th02\" colspan=2 title='Pemeliharaan, Kapitalisasi Ekstra/Intra'>KAPITALISASI</th>
				<th class=\"th02\" colspan=2 title='Hibah, Lainnya, Pemindahtanganan Hibah'>HIBAH / LAINNYA</th>
				<th class=\"th02\" colspan=2 >PINDAH ANTAR SKPD</th>
				<th class=\"th02\" >PENILAIAN</th>
				<th class=\"th02\" >PENGHAPUSAN</th>
				<th class=\"th02\" colspan=2 title='Koreksi Harga, Baru Catat, Double Catat, Penngabungan'>KOREKSI PEMBUKUAN </th>
				<th class=\"th02\" colspan=2 title='Reklas KIB, Reklas Aset Lain Lain, Pemindahtanganan, Ganti Rugi, Pemusnahan, Pemanfaatan' >REKLASS </th>
				
				<th class=\"th02\" colspan=2 title='Mutasi Perubahan Akum. Penyusutan'>AKUM. PENYUSUTAN </th>
	...
	// $smter=$_POST['$fmSemester'];
		...
		$cek = $Main->SHOW_CEK  ? $cek : '';
			...
			*/	
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				$hrefAw = "pages.php?Pg=".$this->pgJurnal."$paramSKPD$paramKdAkun&tgl2=$tglAwal2";
				$hrefAk = "pages.php?Pg=".$this->pgJurnal."$paramSKPD$paramKdAkun&tgl2=$tglAkhir";
				$href 	= "pages.php?Pg=".$this->pgJurnal."$paramSKPD$paramKdAkun&tgl1=$tglAwal&tgl2=$tglAkhir";
				...
				if($fmLvlBrg=='2' || $fmLvlBrg=='3'){
					if($isix['g']=='00'){
						...
						//$vnmbarang = "<b>&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>";
						$vnmbarang = "<b><span class='tab20'>{$isix['nm_barang']}</span></b>";
						$vf = "<b>{$isix['f']}</b>";
						$vg = "<b>$kdBidang</b>";
						$vh = "<b>$h</b>";
						$vi = "<b>$i</b>";
						...
						//$vnmbarang = "<b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>";
						$vnmbarang = "<b><span class='tab30'>{$isix['nm_barang']}</span></b>";
						$vf = "<b>{$isix['f']}</b>";
						$vg = "<b>$kdBidang</b>";
						$vh = "<b>$h</b>";
						$vi = "<b>$i</b>";
						...
						$vnmbarang = "<b><span class='tab40'>{$isix['nm_barang']}</span></b>";
						$vf = "{$isix['f']}";
						$vg = "$kdBidang";
						$vh = "$h";
						$vi = "$i";
					...
					if($fmLvlBrg=='1'){
						//$vnmbarang = $isix['g']=='00' ?  "<b>&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>" : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}";
						$vnmbarang = $isix['g']=='00' ?  "<b><span class='tab15'>{$isix['nm_barang']}</span></b>" : "<span class='tab30'>{$isix['nm_barang']}</span>";
				...
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlBelanjaSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlAtribusiSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlKapitalisasiDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlKapitalisasiKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlHibahDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlHibahKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlMutasiDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlMutasiKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=6' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlPenilaianDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=7&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlPenghapusanKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlPembukuanDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlPembukuanKSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlReklassDSKPD</a></td>
				<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_16' name='vrekap'>$TampilJmlReklassKSKPD</a></td>
			...
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=1&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_3' name='vrekap' >$TampilJmlTotBelanjaSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=2&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_4' name='vrekap' >$TampilJmlTotAtribusiSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_5' name='vrekap' >$TampilJmlTotKapitalisasiDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_6' name='vrekap' >$TampilJmlTotKapitalisasiKSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_7' name='vrekap' >$TampilJmlTotHibahDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_8' name='vrekap' >$TampilJmlTotHibahKSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_9' name='vrekap' >$TampilJmlTotMutasiDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_10' name='vrekap' >$TampilJmlTotMutasiKSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=6' target='blank_' style='color:black' id='vrekap_$rowno"."_11' name='vrekap' >$TampilJmlTotPenilaianDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=7&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_12' name='vrekap' >$TampilJmlTotPenghapusanKSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_13' name='vrekap' >$TampilJmlTotPembukuanDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_14' name='vrekap' >$TampilJmlTotPembukuanKSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=1' target='blank_' style='color:black' id='vrekap_$rowno"."_15' name='vrekap' >$TampilJmlTotReklassDSKPD</a></td>
			<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=2' target='blank_' style='color:black' id='vrekap_$rowno"."_16' name='vrekap' >$TampilJmlTotReklassKSKPD</a></td>
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				*/
				...
				//if($fmLvlBrg=='1' || $fmLvlBrg=='2' || $fmLvlBrg=='3'){
					//$isixg = $isix['g']; 
				//}else{
					$isixg = $isix['g']<>'24'? '' : $isix['g']; 
				//}
				$paramKdAkun = "&kint={$isix['kint']}&ka={$isix['ka']}&kb={$isix['kb']}&g=$isixg&h={$isix['h']}&i={$isix['i']}&bold=$bold";
				//$tglAwal2 = ($fmFiltThnBuku-1).'-12-31';
				$hrefAw = "pages.php?Pg=".$this->pgJurnal."$paramSKPD$paramKdAkun&tgl2=$tglAwal2";
				...
				if($fmLvlBrg == '2' || $fmLvlBrg=='3'){
					if($isix['g']<>'24'){
						if( ($fmLvlBrg=='2' && $isix['h']=='00') || ($fmLvlBrg=='3' && $isix['h']=='00' && $isix['i']=='00') ){
							...
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=1&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlBelanjaSKPD</a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=2&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlAtribusiSKPD</a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlKapitalisasiDSKPD</a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlKapitalisasiKSKPD</a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlHibahDSKPD</a></td>".
							"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlHibahKSKPD</a></td>".
		...
		//tampil total aset (aset tetap + aset lainnya ) --------------------------------------------
			...
			$ListData .="<tr class='row1'>".
				...
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=1&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlBelanjaTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=2&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlAtribusiTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlKapitalisasiDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlKapitalisasiKTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlHibahDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlHibahKTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlMutasiDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlMutasiKTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=6' target='blank_' style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlPenilaianDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=7&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlPenghapusanKTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlPembukuanDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlPembukuanKTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=1' target='blank_' style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlReklassDTot</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=2' target='blank_' style='color:black;' id='vrekap_$rowno"."_16' name='vrekap'>$TampilJmlReklassKTot</a></td>".
			...
			$ListData .="<tr class='row1'>".
				...
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=1&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlTotBelanjaEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=2&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlTotAtribusiEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlTotKapitalisasiDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=3&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlTotKapitalisasiKEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlTotHibahDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=4&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlTotHibahKEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlTotMutasiDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=5&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlTotMutasiKEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=6' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlTotPenilaianDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=7&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlTotPenghapusanKEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlTotPembukuanDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=8&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlTotPembukuanKEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlTotReklassDEkstra</a></td>".
				"<td class='GarisDaftar' align=right><a href='$href&tanpasusut=1&jns_trans=9&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_16' name='vrekap'>$TampilJmlTotReklassKEkstra</a></td>".
	...
	// $smter=$_POST['$fmSemester'];
		...
		while($isi=mysql_fetch_array($Qry)){
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				$hrefAw = "pages.php?Pg=".$this->Prefix."$paramSKPD$paramKdAkun&tgl2=$tglAwal2";
				$hrefAk = "pages.php?Pg=".$this->Prefix."$paramSKPD$paramKdAkun&tgl2=$tglAkhir";
				$href 	= "pages.php?Pg=".$this->Prefix."$paramSKPD$paramKdAkun&tgl1=$tglAwal&tgl2=$tglAkhir";
				$vnmbarang = $isix['g']=='00' ?  "<b>&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}</b>" : "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{$isix['nm_barang']}";
				$ListData .="<tr>
...
$KertasKerja= new KertasKerjaObj();
