...
class KoreksiCls {
		...
		*/
		...
		if ($fmst==1){//baru
			...
			//if($fmTAMBAHASET==1 || $fmTAMBAHMasaManfaat==1){
				if($errmsg =='' && compareTanggal($bi['tgl_buku'],$tgl)==2) $errmsg = 'Tanggal Koreksi tidak kecil dari Tanggal Buku Barang !';				
				if($errmsg =='' && $bi['thn_perolehan']<$thn_perolehan) $errmsg = 'Tahun Perolehan tidak kecil dari Tahun Perolehan Buku Barang !';				
				if($errmsg=='' && sudahClosing($tgl,$bi['c'],$bi['d'],$bi['e'],$bi['e1'],$bi['c1']))$err = 'Tanggal sudah Closing !';
		...
		//if($errmsg=='' && $old_pemelihara['tgl_pemeliharaan']<$tgl_susutAkhir['tgl']){			
			...
			if($errmsg=='' && sudahClosing($tgl,$bi['c'],$bi['d'],$bi['e'],$bi['e1'],$bi['c1'])){
				if($errmsg=='' && $old_koreksi['tgl']!=$tgl)$errmsg = 'Tanggal Koreksi tidak bisa di edit,karena sudah closing !';
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg = 'Tanggal Perolehan tidak bisa di edit,karena sudah closing !';
				if($errmsg=='' && $old_koreksi['harga_baru']!=$harga_baru)$errmsg = 'Harga Perolehan Baru tidak bisa di edit,karena sudah closing !';
				}			
			//cek tgl buku lama < tgl susut akhir 
			if($errmsg=='' && $old_koreksi['tgl']<$tgl_susutAkhir['tgl']){
				if($errmsg=='' && $old_koreksi['tgl']!=$tgl)$errmsg = 'Tanggal Koreksi tidak bisa di edit,sudah ada penyusutan !';
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg = 'Tanggal Perolehan tidak bisa di edit,sudah ada penyusutan !';
				if($errmsg=='' && $old_koreksi['harga_baru']!=$harga_baru)$errmsg = 'Harga Perolehan Baru tidak bisa di edit,sudah ada penyusutan !';
				}
			...
			if(($errmsg=='' && $old_koreksi['tgl']<$tgl_korAkhir['tgl']) || ($old_koreksi['tgl']==$tgl_korAkhir['tgl'] && $old_koreksi['tgl_create']<$tgl_korAkhir['tgl_create'])){
				if($errmsg=='' && $old_koreksi['tgl']!=$tgl)$errmsg = 'Tanggal Koreksi tidak bisa di edit,sudah ada koreksi harga !';
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg = 'Tanggal Perolehan tidak bisa di edit,sudah ada koreksi harga !';
				if($errmsg=='' && $old_koreksi['harga_baru']!=$harga_baru)$errmsg = 'Harga Perolehan Baru tidak bisa di edit,sudah ada koreksi harga !';
				}
			...
			if(($errmsg=='' && $old_koreksi['tgl']<$tgl_nilaiAkhir['tgl_penilaian']) || ($old_koreksi['tgl']==$tgl_nilaiAkhir['tgl_penilaian'] && $old_koreksi['tgl_create']<$tgl_nilaiAkhir['tgl_create'])){
				if($errmsg=='' && $old_koreksi['tgl']!=$tgl)$errmsg = 'Tanggal Koreksi tidak bisa di edit,sudah ada penilaian !';
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg = 'Tanggal Perolehan tidak bisa di edit,sudah ada penilaian !';
				if($errmsg=='' && $old_koreksi['harga_baru']!=$harga_baru)$errmsg = 'Harga Perolehan Baru tidak bisa di edit,sudah ada penilaian !';
				}
			...
			if(($errmsg=='' && $old_koreksi['tgl']<$tgl_hpsAkhir['tgl_penghapusan']) || ($old_koreksi['tgl']==$tgl_hpsAkhir['tgl_penghapusan'] && $old_koreksi['tgl_create']<$tgl_hpsAkhir['tgl_create'])){
				if($errmsg=='' && $old_koreksi['tgl']!=$tgl)$errmsg = 'Tanggal Koreksi tidak bisa di edit,sudah ada penghapusan sebagian !';
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg = 'Tanggal Perolehan tidak bisa di edit,sudah ada penghapusan sebagian !';
				if($errmsg=='' && $old_koreksi['harga_baru']!=$harga_baru)$errmsg = 'Harga Perolehan Baru tidak bisa di edit,sudah ada penghapusan sebagian !';
				}	
			//cek (tgl tgl_perolehan >= tgl ba buku_induk 
			if($errmsg=='' && $old_koreksi['tgl_perolehan']<$gentgl_perolehan ){
				if($errmsg=='' && $old_koreksi['tgl_perolehan']!=$tgl_perolehan)$errmsg ='Tanggal Perolehan tidak lebih kecil dari Tanggal BAST/Buku Barang !';
			}											
		}
	...
	function genKondisi($fmKEPEMILIKAN, $a, $b, $fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI,$fmURUSAN,
