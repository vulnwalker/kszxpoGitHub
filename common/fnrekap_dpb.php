...
class RekapDpbObj extends DaftarObj2{
	...
	//var $cetak_xls = TRUE;
	var $fileNameExcel='rekapdpbmd.xls';
	var $Cetak_Judul = 'REKAP PENGADAAN BARANG MILIK DAERAH';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'Rekap Pengadaan Barang Milik Daerah ';
	...
	function setDaftar_hal($jmlData){
		...
		$get = mysql_fetch_array(mysql_query(
			"select count(*) as cnt from ref_barang where h='00' and i='00' and (j ='00' or j='$kdSubsubkel0')"
		));
		$jmlData = $get['cnt'];
