...
class JurnalBIObj  extends DaftarObj2{	
	var $Prefix = 'JurnalBI';
	...
	//var $FieldSum = array('debet','jml_barang_d','kredit','jml_barang_k','debet-kredit','saldo_barang');//array('jml_harga');
	var $fieldSum_lokasi = array( 5,6,7,8,9,10);
	var $totalCol = 19;
	var $SumValue = array();
	...
	function setSumHal_query($Kondisi, $fsum){
		...
		//array('debet','jml_barang_d','kredit','jml_barang_k','saldo_harga','saldo_barang');/
		//return "select $fsum from $this->TblName $Kondisi "; //echo $aqry;
		return "select count(*) as cnt,
				sum(jml_barang_d) as sum_jml_barang_d, sum(debet) as sum_debet,
				sum(jml_barang_k) as sum_jml_barang_k,sum(kredit) as sum_kredit,
				sum(jml_barang_d-jml_barang_k) as sum_saldo_barang,sum(debet-kredit) as sum_saldo_harga  from $this->TblName $Kondisi "; //echo $aqry;
	...
	function genDaftarInitial(){
		...
		if($Main->URUSAN==1){
			$urusan = "<input type='hidden' id='".$this->Prefix."SkpdfmURUSAN' name='".$this->Prefix."SkpdfmURUSAN' value='$c1'  >";
		}
		...
		$hidden = 
			...
			"$urusan
			<input type='hidden' id='".$this->Prefix."SkpdfmSKPD' name='".$this->Prefix."SkpdfmSKPD' value='$c'  >".	
			"<input type='hidden' id='".$this->Prefix."SkpdfmUNIT' name='".$this->Prefix."SkpdfmUNIT' value='$d'  >".	
			"<input type='hidden' id='".$this->Prefix."SkpdfmSUBUNIT' name='".$this->Prefix."SkpdfmSUBUNIT' value='$e'  >".	
			"<input type='hidden' id='".$this->Prefix."SkpdfmSEKSI' name='".$this->Prefix."SkpdfmSEKSI' value='$e1'  >".	
