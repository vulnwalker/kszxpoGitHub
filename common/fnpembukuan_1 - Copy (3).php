...
global $Main,$HTTP_COOKIE_VARS;
	...
	(bb.debet_saldoawal - bb.kredit_saldoawal+
	bb.debet_hp+bb.debet_kapitalisasi-bb.kredit_kapitalisasi+bb.debet_hibah-bb.kredit_hibah+bb.debet_mutasi-bb.kredit_mutasi+
		...
		while($isi=mysql_fetch_array($Qry)){
			...
			*/
	        ...
	        $jmlHrg_akhir = 
				...
				$susut;
			*/
			$jmlBrg_akhir = 0;//jmlhitakhir
			$jmlHrg_akhir = $isi['jmlhitakhir'];
			//hit total --------------------------------------------------------------------------------
	        //awal ----------------------------------------
