...
function genDaftar($Kondisi='', $Order='', $Limit='', $noAwal = 0, $Mode=1, $vKondisi_old=''){
	...
	function rekapNeraca(){
		...
		*/
		...
		if( ($kint=='01' && $ka=='01') || ($kint=='01' && $ka=='02' && $kb=='04' )  ){ //hanya utk aset tetap dan atb
	...
	function genDaftarOpsi(){
		...
		$fmFiltThnBuku = $_REQUEST['fmFiltThnBuku']==''?$HTTP_COOKIE_VARS['coThnAnggaran'] : $_REQUEST['fmFiltThnBuku'];
