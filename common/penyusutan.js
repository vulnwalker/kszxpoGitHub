...
var Penyusutan = new DaftarObj2({
	...
	daftaropsierror_click : function(heightmax){	//alert('tess');
		...
		if( img_src == icon_down ){                                                            
			...
			document.getElementById('div_border').style.height = '525px';
			document.getElementById('Penyusutan_form_div').style.width = '700px';
			document.getElementById('Penyusutan_form_div').style.height = '450px';
		}else{ 
			img.setAttribute('src', icon_down);
			div.style.height=heightmin;
			document.getElementById('div_border').style.width = '418px';
			document.getElementById('div_border').style.height = '278px';
			document.getElementById('Penyusutan_form_div').style.width = '400px';
			document.getElementById('Penyusutan_form_div').style.height = '200px';			
		}
	},
						...
						if(persen<100) {
							...
							if(resp.content.msg_jml_error==''){
								...
								alert(resp.content.msg_jml_error+' !');
							 	...
							 	me.susutError(resp.content.NoSesi);
								//document.getElementById('div_border').style.width = '715px';
								//document.getElementById('div_border').style.height = '475px';
								//document.getElementById('Penyusutan_form_div').style.width = '700px';
								//document.getElementById('Penyusutan_form_div').style.height = '400px';
								//me.daftaropsierror_click(270);							
							}
						}
					}else{
						alert(resp.err);
