...
.nfmt5 {
	...
	var $PageTitle = 'Inventaris dan Sensus';
	var $PageIcon = 'images/sensus_ico.png';
	var $pagePerHal= '9999';
	...
	*/
	...
	global $Main;	
		...
		if($jns=='inventarisasi'){
			$styleMenu2_10 = " style='color:blue;' ";
			$styleMenu2_11 = "";
			$link_inventaris="&jns=inventarisasi";
		}else{
			$styleMenu2_10 = "";
			$styleMenu2_11 = " style='color:blue;' ";
			$link_inventaris="";
		}
		$menu_pembukuan =
		...
		if($Main->MENU_VERSI==3){
			$menusensus = $menusensus = "<!--menubar_page-->
			<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin: 1 0 0 0'>
			<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
			<A href=\"index.php?Pg=05&SPg=belumsensus&jns=inventarisasi\" title='Inventarisasi' $styleMenu2_10>INVENTARISASI</a> |
			<A href=\"index.php?Pg=05&SPg=belumsensus\" title='Sensus' $styleMenu2_11>SENSUS</a> 
			&nbsp&nbsp&nbsp
			</td></tr>
			<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
			<!-- <A href=\"pages.php?Pg=sensus&menu=kertaskerja\" title='Kertas Kerja' $styleMenu2_5>Kertas Kerja</a> |  -->
			<A href=\"index.php?Pg=05&SPg=belumsensus$link_inventaris\" title='Belum Cek' $styleMenu2_1>Belum Cek</a> |
			
			<A href=\"pages.php?Pg=SensusScan$link_inventarisi\" title='Hasil Scan' $styleMenu2_9>Hasil Scan</a> |
			<A href=\"pages.php?Pg=SensusTidakTercatat$link_inventaris\" title='Barang Tidak Tercatat' $styleMenu2_8>Tidak Tercatat</a> |
			
			<A href=\"pages.php?Pg=sensus&menu=ada$link_inventaris\" title='Ada Barang' $styleMenu2_2>Ada</a>  |  
			<A href=\"pages.php?Pg=sensus&menu=tidakada$link_inventaris\" title='Tidak Ada Barang' $styleMenu2_5>Tidak Ada</a>  |  
			<!--<A href=\"pages.php?Pg=sensus&menu=diusulkan\" title='Diusulkan Penghapusan' $styleMenu2_3>Diusulkan</a>  |  -->
			<A href=\"pages.php?Pg=SensusHasil2$link_inventaris\" title='Rekapitulasi Hasil Sensus' $styleMenu2_4>Hasil Sensus</a>   | 			
			<A href=\"pages.php?Pg=SensusProgres$link_inventaris\" title='Sensus Progress' $styleMenu2_4_>Sensus Progress</a>   
			  &nbsp&nbsp&nbsp
			</td></tr></table>"
			;
		}else{
			$menusensus="<!--menubar_page-->
