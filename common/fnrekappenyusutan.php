...
class RekapPenyusutanObj extends DaftarObj2{
	...
	//cetak --------------------
	var $cetak_xls=FALSE ;
	var $fileNameExcel='RekapPenyusutan.xls';
...
.nfmt5 {
	...
	var $PageIcon = 'images/penyusutan_ico.png';
	var $pagePerHal= '9999';
	...
	function rekapNeraca(){
		...
		*/
		...
		if($Main->VERSI_NAME=='SERANG'){
			$aqry = " select *, (total1-total2-total3-total4+total5+total6+total7) as total8 from (select ".
				" sum(if(tgl_buku<'$tgl1',kredit-debet,0)) as total1, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=15,debet,0)) as total2, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=16 or jns_trans2=19) ,debet,0)   ) as total3, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=31 or jns_trans2=37 or jns_trans2=38 or jns_trans3=41) ,debet,0)) as total4, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=15,kredit,0)) as total5, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=16 or jns_trans2=19) , kredit,0)) as total6, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=31 or jns_trans3=41) ,kredit,0)) as total7, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=14 or jns_trans2=17 or jns_trans2=18) ,debet,0)) as total9, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=22,debet,0)) as total10, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=21,debet,0)) as total11, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=30 and jns_trans3 <> 41,kredit,0)) as total12, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=22,kredit,0)) as total13, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=21,kredit,0)) as total14, ".
				" sum(if(tgl_buku<='$tgl2' ,kredit-debet,0)) as total15, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2',debet,0)) as total16, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2',kredit,0)) as total17 ".
				" from $tbl ".
				" $Kondisi ) as aa"; $cek.=$aqry;			
		}else{
			$aqry = " select  ".
				" sum(if(tgl_buku<'$tgl1',kredit-debet,0)) as total1, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=15,debet,0)) as total2, ".
				//" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=16,debet,0)) as total3, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=16 or jns_trans2=17 or jns_trans2=18 or jns_trans2=19)   ,debet,0)   ) as total3, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=14,debet,0)) as total4, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=22,debet,0)) as total5, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=21,debet,0)) as total6, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=17 or jns_trans2=26 or jns_trans2=27 or jns_trans2=32),debet,0)) as tota18, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=39,debet,0)) as tota19, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and ( jns_trans2=31 or jns_trans2=37 or jns_trans2=38 or jns_trans3=41 ),debet,0)) as total7, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=30 and jns_trans3<>41,kredit,0)) as total8, ".
				//" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=31,kredit,0)) as total9, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=31 or jns_trans3=41 ) ,kredit,0)) as total9, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=15,kredit,0)) as total10, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=16 or jns_trans2=17 or jns_trans2=18 or jns_trans2=19), kredit,0)) as total11, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=22,kredit,0)) as total12, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=21,kredit,0)) as total13, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and (jns_trans2=17 or jns_trans2=26 or jns_trans2=27 or jns_trans2=32),kredit,0)) as total20, ".
			  	" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=39,kredit,0)) as total21, ".				
				" sum(if(tgl_buku<='$tgl2' ,kredit-debet,0)) as total15, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2',debet,0)) as total16, ".
				" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2',kredit,0)) as total17 ".
				" from $tbl ".
		...
		$content->kol15 =  is_null($hsl['cnt15'])? 0 : $hsl['cnt15'] ; //jml akhir					
		$content->idel = $idel;
		...
		if($Main->VERSI_NAME=='SERANG'){
			...
			$content->total14 = is_null($hsl['total15'])? 0 :$hsl['total15']; //jml Akhir			
		}
		$content->total15 = is_null($hsl['total15'])? 0 :$hsl['total15']; //jml debet
		$content->total16 = is_null($hsl['total16'])? 0 :$hsl['total16']; //jml kredit
		$content->total17 = is_null($hsl['total17'])? 0 :$hsl['total17']; //jml kredit	
		$content->total18 = is_null($hsl['total18'])? 0 :$hsl['total18']; //jml kredit
		$content->total19 = is_null($hsl['total19'])? 0 :$hsl['total19']; //jml kredit			
		$content->total20 = is_null($hsl['total20'])? 0 :$hsl['total20']; //jml kredit
		$content->total21 = is_null($hsl['total21'])? 0 :$hsl['total21']; //jml kredit	
		//cek nilai total
		$totaljml = $content->total1+$content->total2+$content->total3+$content->total4+$content->total5+$content->total6+$content->total7+$content->total8+$content->total9+$content->total10+$content->total11+$content->total12+$content->total13+$content->total14+$content->total15+$content->total16+$content->total17;
		if($totaljml==0 && $tampilKosong==0){
			$content->totalkosong = "kosong";	
		}
		...
		$content->vtotal17 =  $bold ? '<b>'. number_format($content->total17,$des,',' , '.' ) .'</b>':  number_format($content->total17,$des,',' , '.' );	
		$content->vtotal18 =  $bold ? '<b>'. number_format($content->total18,$des,',' , '.' ) .'</b>':  number_format($content->total18,$des,',' , '.' );	
		$content->vtotal19 =  $bold ? '<b>'. number_format($content->total19,$des,',' , '.' ) .'</b>':  number_format($content->total19,$des,',' , '.' );								
		$content->vtotal20 =  $bold ? '<b>'. number_format($content->total20,$des,',' , '.' ) .'</b>':  number_format($content->total20,$des,',' , '.' );	
		$content->vtotal21 =  $bold ? '<b>'. number_format($content->total21,$des,',' , '.' ) .'</b>':  number_format($content->total21,$des,',' , '.' );	
		/*$arrTotN = array();
		$arrVTotN = array();
		for ($i=0;$i<10;$i++){
			for ($j=0;$j<4;$j++){
...
*/
		...
		return	array ('cek'=>htmlspecialchars($cek), 'err'=>$err, 'content'=>$content, 'json'=>$json);
	}
	...
	function genDaftar($Kondisi='', $Order='', $Limit='', $noAwal = 0, $Mode=1, $vKondisi_old=''){
		...
		*/
		...
		return array('cek'=>htmlspecialchars($cek),'content'=>$ListData, 'err'=>$err);
	}
	...
	function setPage_HeaderOther(){
		...
		if($Main->VERSI_NAME=='JABAR'){
			...
			$menubar3 = 
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>".
					"<A href=\"index.php?Pg=05&jns=penyusutan\"  title='Penyusutan' >PENYUSUTAN</a> ".
					"| <A href=\"pages.php?Pg=RekapPenyusutan\"  title='Rekap Penyusutan' $styleMenu >REKAP PENYUSUTAN</a>   ".
					"&nbsp&nbsp&nbsp".
					"</td></tr>";
				$menubar="<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">".$menubar3."</table>".
					"";		
			}else{
	...
	function genDaftarOpsi(){
		...
		$fmLvlBrg = $_REQUEST['fmLvlBrg'];
		$fmKONDBRG = $_REQUEST['fmKONDBRG'];
		$jnsrekap = $_REQUEST['jnsrekap'];
		$fmSemester = $_REQUEST['fmSemester']==''? 2 : $_REQUEST['fmSemester'];
		...
		$LevelBarang = "Level Barang ".cmb2D_v2('fmLvlBrg',$fmLvlBrg,$arrLevel,'','Level 1');
		
		if ($fmFiltThnBuku=='') $fmFiltThnBuku = $HTTP_COOKIE_VARS['coThnAnggaran'];//date('Y');
		$TampilOpt =
	...
	function PrintSKPD2($fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI,$xls=FALSE) {
    global $Main; 
	//global $fmWIL, $fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, $fmTAHUNANGGARAN, $fmKEPEMILIKAN, $Main, 
...
//    $xls = ($xls==TRUE) ? '1':$xls;
	...
	if($Main->URUSAN == 1){
	    $URUSAN = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where c1='$fmURUSAN' and c='00' "));
	    $URUSAN = $URUSAN[0];
	    $SKPD = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d='00'"));
	    $SKPD = $SKPD[0];
	    $UNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where c1='$fmURUSAN' and  c='$fmSKPD' and d <> '00' and e = '00' and d='$fmUNIT' "));
	    $UNIT = $UNIT[0];
	    $SUBUNIT = mysql_fetch_array(mysql_query("select nm_skpd from ref_skpd  where c1='$fmURUSAN' and  c='$fmSKPD' and d = '$fmUNIT' and e <> '00' and e='$fmSUBUNIT' and e1='$kdSubUnit0'"));
	    $SUBUNIT = $SUBUNIT[0];
	    ...
	    $SEKSI = $SEKSI[0];
		$td_urusan="<tr valign=top> <td style='font-weight:bold;font-size:10pt' >URUSAN</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td style='font-weight:bold;font-size:10pt' > $URUSAN</td> </tr> ";
		$td_urusan_excell="<tr valign=top> <td colspan='2'  style='font-weight:bold;font-size:10pt' >URUSAN</td><td style='width:10;font-weight:bold;font-size:10pt' >:</td><td style='font-weight:bold;font-size:10pt' > $URUSAN</td> </tr> ";		
	}else{
	...
	function genCetak_($xls= FALSE, $Mode=''){
		global $Main;
		...
		if($fmTplDetail){
			...
			if($Main->VERSI_NAME=='SERANG'){
				...
				$Detail = "<tr>
					...
					<th class=\"th02\" >Beban Penyusutan</th>
					<th class=\"th02\" >Kapitalisasi</th>				
\				</tr>";				
			}else{
				$cols1 = "colspan='18'";
				...
				$Detail = "<tr>
					...
					<th class=\"th02\" >Kapitalisasi</th>
					<th class=\"th02\" >Aset Lain-lain</th>
					<th class=\"th02\" >Pemindahtanganan</th>	
					<th class=\"th02\" >Pemusnahan</th>	
					<th class=\"th02\" >Koreksi Penyusutan</th>
					<th class=\"th02\" >Beban Penyusutan</th>
					<th class=\"th02\" >Koreksi Penyusutan</th>
					<th class=\"th02\" >Pindah Antar SKPD</th>				
		...
		if($Main->VERSI_NAME=='SERANG' && $Detail!=""){
			$headerTable =
				...
				"<tr>
					...
					<th class=\"th02\" $rows2 >Keadaan per<br>31 Desember $thnsbl</th>
					<th class=\"th02\" $cols2 >Koreksi Keadaan per<br>31 Desember $thnsbl</th>
					<th class=\"th02\" $rows2 >Keadaan per <br>$headerTglAwalThn</th>
				...
				"<tr>
					...
					<th class=\"th02\" $cols3>Bertambah</th>
					<th class=\"th02\" $cols3>Berkurang</th>
					<th class=\"th02\" $cols3>Bertambah</th>
				</tr>".
				$Detail.
				"<tr>
					...
					<th class=\"th03\" $cols3>9</th>				
					<th class=\"th03\" >10</th>
					<th class=\"th03\" $cols3>11</th>		
					<th class=\"th03\" $cols3>12</th>		
					<th class=\"th03\" >13</th>						
				</tr>";
		}else{
			$headerTable =
		...
		$headerTable=
			//"<input type='hidden' id='daftarcetak' name='daftarcetak' value='' >".
			"<div id='div_cek' style='display:none'>$cek</div>".
			$headerTable.$this->gen_table_data($Mode);
		return $headerTable;
	}
	
	function setKolomHeader__($Mode=1, $Checkbox=''){
		global $Ref, $Main;
		$cetak = $Mode==2 || $Mode==3 ;
		$cbxDlmRibu = $_POST['cbxDlmRibu'];
		$fmTplDetail = $_POST['fmTplDetail'];
	...
	function gen_table_data($Mode=1){
		...
		while($isi=mysql_fetch_array($Qry)){
			...
			if ( $cbxTotal ==TRUE){
				$KondisiSKPDx = "1=1";
				if($c1!='0' && $c1 !='') $KondisiSKPDx .= " and c1= '$c1' ";
				if($c!='00' && $c !='') $KondisiSKPDx .=  $KondisiSKPDx ==''? " c= '$c' " : " and c= '$c' ";//" and c= '$c' ";
				if($d!='00' && $d !='') $KondisiSKPDx .=  $KondisiSKPDx ==''? " d= '$d' " : " and d= '$d' ";
				$paramSKPD = "&c1=$c1&c=$c&d=$d&e=$e&e1=$e1";		$cek.= ' no=1 ';		
			}else{
				if ($c1=='0'){
					if ($e1=='00' || $e1=='000' ){
						$KondisiSKPDx=" c1='".$isi['c1']."' and c='".$isi['c']."' and d='".$isi['d']."' ";							
					} else {
						$KondisiSKPDx=" c1='".$isi['c1']."' and c='".$isi['c']."' and d='".$isi['d']."' and e='".$isi['e']."' and e1='".$isi['e1']."' ";					
					}
				}else{
					if ($e1=='00' || $e1=='000' ){
				...
				$paramSKPD = "&c1=".$isi['c1']."&c=".$isi['c']."&d=".$isi['d']."&e=".$isi['e']."&e1=".$isi['e1'];
				$cek.= ' no=2 ';
			}
		...
		//}
			...
			switch($fmLvlBrg){
				case '1': $sel="f,g"; $konLvl1="and h='00'"; break;
				case '2': $sel="f,g,h"; $konLvl1="and i='00'"; break;
				case '3': $sel="f,g,h,i"; $konLvl1=""; break;
				default : $sel="f,g"; $konLvl1="and g='00'"; break;
			}
			...
			$hrefSblm 	= "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun&tgl2=$tgl1";			
			...
			if($fmTplDetail){
				if($Main->VERSI_NAME=="SERANG"){
					...
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=1&jns_trans2=15&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_2' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=2&jns_trans2=16&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=3&jns_trans2=31&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=1&jns_trans2=15&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=2&jns_trans2=16&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
					
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=3&jns_trans2=31&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$hrefSblm&GrpSusut=4&keadaanPer1Januari=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=5&jns_trans2=14&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6&jns_trans2=22&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=8&jns_trans2=30&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6jns_trans2=22&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
					<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>	
					</tr>"	;					
				}else{
					$TampiljmlIntrakomptabel="<td class='GarisDaftar' align=right><a href='$hrefAw' target='blank_'  style='color:black;' id='vrekap_$rowno"."_1' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=1&jns_trans2=15&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_2' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=2&jns_trans2=16&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_3' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=5&jns_trans2=14&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_4' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6&jns_trans2=22&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_5' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_6' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
					
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=9&jns_trans2=27&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_18' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>													
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=10&jns_trans2=39&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_19' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>													
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=3&jns_trans2=31&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_7' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=8&jns_trans2=30&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_8' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=3&jns_trans2=31&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_9' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=1&jns_trans2=15&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_10' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=2&jns_trans2=16&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6&jns_trans2=22&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
					
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=9&jns_trans2=27&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_20' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>													
					<td class='GarisDaftar' align=right><a href='$href&GrpSusut=10&jns_trans2=39&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_21' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>													
				...
				if($Main->VERSI_NAME=="SERANG"){
					$TampiljmlIntrakomptabel="<td class='GarisDaftar' align=right><a href='$hrefAw' target='blank_'  style='color:black;' id='vrekap_$rowno"."_1' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
									<td class='GarisDaftar' align=right><a href='$href&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_16' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
									<td class='GarisDaftar' align=right><a href='$href&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_17' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>						
									<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>	
									</tr>"	;				
				}else{
					$TampiljmlIntrakomptabel="<td class='GarisDaftar' align=right><a href='$hrefAw' target='blank_'  style='color:black;' id='vrekap_$rowno"."_1' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
			...
			$ListData .="<tr class='row1' id='row_vrekap_$rowno'>
			...
			/*$bqry =
				"select aa.kint,aa.ka,aa.kb,aa.f,aa.g, aa.h, aa.i, aa.nm_barang, $saldo_awal, $saldo_akhir ".
				...
				"on aa.f=bb.f and aa.g=bb.g and aa.h=bb.h and aa.i=bb.i where  aa.ka='01' $konLvl1";*/
			$bqry =
				"select kint,ka,kb,f,g, h, i, nm_barang ".
				"from v_ref_kib_keu_penyusutan ". 
				"where kint='01' and ka='01' $konLvl1";					
			...
			while($isix=mysql_fetch_array($aQry)){
				...
				if ( $isix['f']=='00' ){//total aset tetap
					...
					$hrefAw = "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun&tgl2=$tgl1";
					$hrefAk = "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun&tgl2=$tgl2";
					$href 	= "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun&tgl1=$tgl1&tgl2=$tgl2";						$hrefSblm 	= "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun&tgl2=$tgl1";	
					...
					if($fmTplDetail){
						if($Main->VERSI_NAME=="SERANG"){
							...
							<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=1' target='blank_'  style='color:black;' id='vrekap_$rowno"."_11' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
							<td class='GarisDaftar' align=right><a href='$href&GrpSusut=8&jns_trans2=30&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
							<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6&jns_trans2=22&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
							<td class='GarisDaftar' align=right><a href='$href&GrpSusut=7&jns_trans2=21&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
							<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>	
							</tr>"	;
						}else{
					...
					$TampiljmlAsetTetap;
				  	...
				  	//if($tampilKosong==1){
						...
						$hrefSblm 	= "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun$ParamBarang&tgl2=$tgl1";	
						...
						$ListData .="<tr class='row0' id='row_vrekap_$rowno'>
		...
		if ($isix['g']=='00'){//total aset lainnya
			...
			$QryAL="select $saldo_awal, $saldo_debet, $saldo_kredit, $saldo_akhir  from (select IFNULL(f,'00') as f,IFNULL(g,'00') as g, IFNULL(h,'00') as h, IFNULL(i,'00') as i, ". 
					" sum(if(tgl_buku<'$tgl1',kredit-debet,0)) as total1, ".
					" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=15,debet,0)) as total2, ".
					" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=16,debet,0)) as total3, ".
					" sum(if(tgl_buku>='$tgl1' and tgl_buku<='$tgl2' and jns_trans2=14,debet,0)) as total4, ".
					...
					" from $tblSusut where c<>'' ".$KondisiSKPD." and kint='01' and ka='02' and kb='".$isix['kb']."' and jns_trans = 10 group by kint,ka) as bb";
	...
	/*$bqry3=	"select aa.kint,aa.ka,aa.kb,aa.kb,aa.f,aa.g, aa.h, aa.i, aa.nm_barang, $saldo_awal, $saldo_debet, $saldo_kredit, $saldo_akhir ".
	  ...
	  while($isix=mysql_fetch_array($aQry)){
		...
		if ($isix['g']=='00'){//total ekstra
			...
			$hrefSblm 	= "pages.php?Pg=JurnalPenyusutan$paramSKPD$paramKdAkun$ParamBarang&tgl2=$tgl1";	
				if($fmTplDetail){
					if($Main->VERSI_NAME=="SERANG"){
						...
						<td class='GarisDaftar' align=right><a href='$href&GrpSusut=8&jns_trans2=30&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_12' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
						<td class='GarisDaftar' align=right><a href='$href&GrpSusut=6&jns_trans2=22&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_13' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
						<td class='GarisDaftar' align=right><a href='$hrefAk&GrpSusut=7&jns_trans2=21&debet=2' target='blank_'  style='color:black;' id='vrekap_$rowno"."_14' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>
						<td class='GarisDaftar' align=right><a href='$hrefAk' target='blank_'  style='color:black;' id='vrekap_$rowno"."_15' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>	
						</tr>"	;
					}else{
						$TampiljmlRincianEkstrakomptabel="<td class='GarisDaftar' align=right><a href='$hrefAw' target='blank_'  style='color:black;' id='vrekap_$rowno"."_1' name='vrekap'>$TampilJmlSaldoAkSKPD</a></td>				
			...
			$ListData .=
			"<tr class='row0' id='row_vrekap_$rowno'>
			<td align=center class='$clGaris'>$rowno.</td>
	...
	function setCetak_Header($Mode=''){
		...
		return
			...
			.$this->PrintSKPD2($fmURUSAN, $fmSKPD, $fmUNIT, $fmSUBUNIT,$fmSEKSI,$this->cetak_xls)."<br>";
