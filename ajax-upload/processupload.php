...
if(isset($_POST))
{
	...
	$DestinationDirectory	= 'ajax-upload/uploads/';//'/home/ajax-image-upload-progressbar/uploads/'; //Upload Directory ends with / (slash)
	$Quality 				= 90;
	...
	switch(strtolower($ImageType))
	{
		...
		default:
			...
			//else
			//$target_file = $DestinationDirectory.$ImageName;
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		//$content->fname=$DestinationDirectory.$ThumbPrefix.$NewImageName;
		$content->fname=$ThumbPrefix.$NewImageName;
		$pageArr = array(
