...
class popupRekeningObj  extends DaftarObj2{	
	...
	case 'formBaru':{				
		...
		$content = array('kode_rekening' => $kode_rekening, 'nama_rekening' => $nama_rekening, 'cmbPekerjaan' => $cmbPekerjaan);
		break;
	   }
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="left"',"<a style='cursor:pointer;' onclick= popupRekening.windowSave('$kode_rekening')> ".$isi["nm_rekening"]." </a>");
...
/*	$_REQUEST['filterAkun'] = $filterAkun;*/
	...
	$TampilOpt = 
			...
			<td>".
			cmbQuery1("fmKELOMPOK",$fmKELOMPOK,"select l,nm_rekening from ref_rekening where k='$fmBIDANG' and l !='0' and m = '0' and n='00' and o='00'","onChange=\"$this->Prefix.refreshList(true)\"$kondisiRka",'Pilih','').
			"</td>
			</tr><tr>
