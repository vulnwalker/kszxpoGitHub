...
class rkaPPKD1_v2Obj  extends DaftarObj2{	
	...
	$getJumlahBarang = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkaPPKD1_v2_idplh'"));
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'sesuai':{
			...
			$getrkaPPKD1_v2nya = mysql_fetch_array(mysql_query($queryRows));
...
if(empty($rkaPPKD1_v2->tahun)){
	...
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$rkaPPKD1_v2->idTahap'"));
	$rkaPPKD1_v2->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$rkaPPKD1_v2->idTahap'"));
...
if($rkaPPKD1_v2->jenisForm != "PENYUSUNAN"){
$get1 = mysql_fetch_array(mysql_query("select max(id_anggaran)  from view_rka_ppkd_1 where jenis_form_modul = 'PENYUSUNAN' "));
	...
	$arrayHasil =  VulnWalkerLASTTahap_v2();
	$rkaPPKD1_v2->currentTahap = $arrayHasil['currentTahap'];
			$rkaPPKD1_v2->jenisForm = "";
			$rkaPPKD1_v2->jenisFormTerakhir = "PENYUSUNAN";
			$rkaPPKD1_v2->idTahap = $get2['id_tahap'];
			$rkaPPKD1_v2->nomorUrut = $get2['no_urut'];
			$rkaPPKD1_v2->urutTerakhir = $get2['no_urut'];
}
