...
class settingperencanaanObj  extends DaftarObj2{
	...
	function SimpanUbah(){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
		...
		mysql_query("update general_setting set option_value ='$kota' where option_name = 'alamat_pemda'");

	 $qry = "UPDATE settingperencanaan  SET  jenis_anggaran = '".$_REQUEST['cmbJenisAnggaran']."',  tahun = '$tahun', logo = '$logo'";$cek.=$qry;
   ...
   function setPage_OtherScript(){
		...
		return
			"<script type='text/javascript' src='js/perencanaan_v3/settingPerencanaan.js' language='JavaScript' ></script>".
...
";
	...
	$logo = $daqry['logo'];
	$getNamaKota = mysql_fetch_array(mysql_query("select * from general_setting where option_name = 'alamat_pemda'"));
					...
					$this->isiform(
						array(
							...
							array(
								...
								'name'=>'tahun',
								'label-width'=>'230px;',
								'value'=>"<input type ='text' id='tahun' name='tahun' value='$tahun' style='width:40px;'>",
							),
							array(
								'label'=>'<b>JENIS ANGGARAN</b>',
								'name'=>'jenisAnggaran',
								'label-width'=>'230px;',
								'value'=>cmbArray('cmbJenisAnggaran',$daqry['jenis_anggaran'], $arrayJenisAnggaran,'--- PILIH ---',"style='width:300px;'"),
							),
							array(
								'label'=>'<b>Kabupaten/Kota</b>',
								'name'=>'kota',
