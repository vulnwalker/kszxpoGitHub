...
class koreksiPengelolaPersediaanObj  extends DaftarObj2{
	...
	var $reportURL7 = "pages.php?Pg=koreksiPengelolaPersediaan&tipe=Persediaan7";
	var $statusPenetapan ="";
	...
	function setPage_HeaderOther(){
			if($_GET['modul'] =='persediaan'){
					...
					<A href=\"pages.php?Pg=koreksiPengelolaPersediaan&modul=persediaan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
		...
		-->
				...
				<A href=\"pages.php?Pg=koreksiPengelolaPersediaan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
				...
				<A href=\"pages.php?Pg=koreksiPengelolaPersediaan\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a>
	...
	case 'formBaru':{
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			}elseif(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '3' and tahun ='$this->tahun' and jenis_anggaran ='PERUBAHAN' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan'")) != 0){
...
$koreksiPengelolaPersediaan->statusPenetapan = checkPenetapanRKBMD($koreksiPengelolaPersediaan->tahun,$koreksiPengelolaPersediaan->jenisAnggaran,"PERSEDIAAN");
