...
class koreksiPengelolaPengadaanPerubahanObj  extends DaftarObj2{
	var $Prefix = 'koreksiPengelolaPengadaanPerubahan';
	...
	var $FormName = 'koreksiPengelolaPengadaanPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaanPerubahan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a>

		&nbsp&nbsp&nbsp
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaanPerubahan\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaanPerubahan\" title='RKBMD PENGELOLA' > PEMELIHARAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($koreksiPengelolaPengadaanPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPengadaanPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPengadaanPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentkoreksiPengelolaPengadaanPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPengadaanPerubahan['c1'];
					$parentC = $getParentkoreksiPengelolaPengadaanPerubahan['c'];
					$parentD = $getParentkoreksiPengelolaPengadaanPerubahan['d'];
					$parentE = $getParentkoreksiPengelolaPengadaanPerubahan['e'];
					$parentE1= $getParentkoreksiPengelolaPengadaanPerubahan['e1'];
					...
					if($cmbJeniskoreksiPengelolaPengadaanPerubahan == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPengadaanPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPengadaanPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPengadaanPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentkoreksiPengelolaPengadaanPerubahan['c1'];
					$parentC = $getParentkoreksiPengelolaPengadaanPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPengadaanPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPengadaanPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPengadaanPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPengadaanPerubahannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPengelolaPengadaanPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPengelolaPengadaanPerubahannya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPengadaanPerubahan.js' language='JavaScript' ></script>".
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPengadaanPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPengadaanPerubahan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['koreksiPengelolaPengadaanPerubahanSkpdfmUrusan'];
	 $c = $dt['koreksiPengelolaPengadaanPerubahanSkpdfmSKPD'];
	 $d = $dt['koreksiPengelolaPengadaanPerubahanSkpdfmUNIT'];
	 $e = $dt['koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI'];
	 ...
	 /*if($e1 != '000'){
	 	...
	 	$arrayJenisLaporan = array(
							   array('Pengadaan14', 'PERUBAHAN RKBMD PENGADAAN PROVINSI/KABUPATEN/KOTA'),
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("koreksiPengelolaPengadaanPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPengadaanPerubahan' id='cmbJeniskoreksiPengelolaPengadaanPerubahan' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['koreksiPengelolaPengadaanPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPengadaanPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPengadaanPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPengadaanPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPengadaanPerubahanSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPengadaanPerubahan = $_REQUEST['cmbJeniskoreksiPengelolaPengadaanPerubahan'];
		$arrKondisi = array();
...
<br><br><br><br><br></span></td>
	...
	function Pengadaan14($xls =FALSE){
		global $Main;

		$this->fileNameExcel = "PERUBAHAN RKBMD PENGADAAN PROVINSI/KABUPATEN/KOTA";
		$align = "right";
		$xls = $_GET['xls'];
		...
		$getLastTahap = mysql_fetch_array(mysql_query("select max(id_anggaran) from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and j!='000' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN' and jenis_form_modul ='KOREKSI PENGELOLA'"));
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' ")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '5' and tahun ='$this->tahun' and jenis_anggaran = 'MURNI' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_jenis_pemeliharaan ='0' "));
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');

				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '3' and tahun ='$this->tahun' and jenis_anggaran = 'PERUBAHAN' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_jenis_pemeliharaan ='0' "));
...
$koreksiPengelolaPengadaanPerubahan = new koreksiPengelolaPengadaanPerubahanObj();
...
$koreksiPengelolaPengadaanPerubahan->jenisForm = $jenisForm;
$koreksiPengelolaPengadaanPerubahan->nomorUrut = $nomorUrut;
$koreksiPengelolaPengadaanPerubahan->urutTerakhir = $nomorUrut;
$koreksiPengelolaPengadaanPerubahan->tahun = $tahun;
$koreksiPengelolaPengadaanPerubahan->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPengadaanPerubahan->idTahap = $idTahap;
$koreksiPengelolaPengadaanPerubahan->username = $_COOKIE['coID'];
$koreksiPengelolaPengadaanPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPengadaanPerubahan->wajibValidasi == TRUE){
	$koreksiPengelolaPengadaanPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPengadaanPerubahan->sqlValidasi = " ";
}

$koreksiPengelolaPengadaanPerubahan->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPengadaanPerubahan->kota = $arrayResult['kota'];
$koreksiPengelolaPengadaanPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPengadaanPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPengadaanPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPengadaanPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPengadaanPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPengadaanPerubahan->nipPejabat = $arrayResult['nipPejabat'];
