<?php
class rkbmdPerubahan_ins_v3Obj  extends DaftarObj2{
	var $Prefix = 'rkbmdPerubahan_ins_v3';
	...
	var $FormName = 'rkbmdPerubahan_ins_v3Form';
	var $noModul=14;
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPerubahan_ins.js' language='JavaScript' ></script>".
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_ins_v3.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_ins_v3.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPerubahan_ins_v3.CekAda(); ','-- KEGIATAN --');
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPerubahan_ins_v3.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPerubahan_ins_v3.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPerubahan_ins_v3.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPerubahan_ins_v3.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPerubahan_ins_v3.finish()'>
...
$rkbmdPerubahan_ins_v3 = new rkbmdPerubahan_ins_v3Obj();

$arrayResult = tahapPerencanaanV3($rkbmdPerubahan_ins_v3->modul,"PERUBAHAN");
...
$rkbmdPerubahan_ins_v3->jenisForm = $jenisForm;
$rkbmdPerubahan_ins_v3->nomorUrut = $nomorUrut;
$rkbmdPerubahan_ins_v3->urutTerakhir = $nomorUrut;
$rkbmdPerubahan_ins_v3->tahun = $tahun;
$rkbmdPerubahan_ins_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPerubahan_ins_v3->idTahap = $idTahap;
$rkbmdPerubahan_ins_v3->username = $_COOKIE['coID'];
$rkbmdPerubahan_ins_v3->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPerubahan_ins_v3->wajibValidasi == TRUE){
	$rkbmdPerubahan_ins_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPerubahan_ins_v3->sqlValidasi = " ";
}
