...
class penetapanRKBMDPersediaanNewObj  extends DaftarObj2{
	var $Prefix = 'penetapanRKBMDPersediaanNew';
	...
	var $FormName = 'penetapanRKBMDPersediaanNewForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL7 = "pages.php?Pg=penetapanRKBMDPersediaanNew&tipe=Persediaan7";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPersediaanSkpdfmUrusan'];
      $dt['c'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPersediaanSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPersediaanSkpdfmUNIT'];
      $fm = $this->setForm($dt);
    }
  ...
  $oldy=mysql_fetch_array(
   ...
   if( $err=='' && $kategori =='' ) $err= 'Kategori Belum Di Pilih !!';
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=penetapanRKBMDPersediaanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> PENETAPAN RKBMD </a>
		...
		<A href=\"pages.php?Pg=penetapanRKBMDPersediaanNew\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($penetapanRKBMDPersediaanNewSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($penetapanRKBMDPersediaanNewSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($penetapanRKBMDPersediaanNewSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($penetapanRKBMDPersediaanNewSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($penetapanRKBMDPersediaanNewSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanNewSkpdfmSKPD' and d='$penetapanRKBMDPersediaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanNewSkpdfmSKPD' and d='$penetapanRKBMDPersediaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanNewSkpdfmSKPD' and d='$penetapanRKBMDPersediaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentpenetapanRKBMDPersediaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentpenetapanRKBMDPersediaanNew['c1'];
					$parentC = $getParentpenetapanRKBMDPersediaanNew['c'];
					$parentD = $getParentpenetapanRKBMDPersediaanNew['d'];
					$parentE = $getParentpenetapanRKBMDPersediaanNew['e'];
					$parentE1= $getParentpenetapanRKBMDPersediaanNew['e1'];
					...
					if($cmbJenispenetapanRKBMDPersediaanNew == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['penetapanRKBMDPersediaanNew_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentpenetapanRKBMDPersediaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentpenetapanRKBMDPersediaanNew as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentpenetapanRKBMDPersediaanNew['c1'];
					$parentC = $getParentpenetapanRKBMDPersediaanNew['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$penetapanRKBMDPersediaanNew_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$penetapanRKBMDPersediaanNew_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getpenetapanRKBMDPersediaanNewnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getpenetapanRKBMDPersediaanNewnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpenetapanRKBMDPersediaanNewnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getpenetapanRKBMDPersediaanNewnya['volume_barang'] < $angkaKoreksi){
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	...
	function tetapkanRKBMD($dt){
	 ...
	 if(!empty($_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']) && $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan'] !='0' ){

	   if(empty($_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']) || $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD'] =='00'){
	      $err = "Pilih Bidang";
	   }elseif(empty($_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']) || $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT'] =='00'){
	      $err = "Pilih SKPD";
	   }else{
	     $getNamaUrusan = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c= '00' and d= '00'"));
	     $namaUrusan = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan'].". ".$getNamaUrusan['nm_skpd'];
	     $getNamaBidang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d= '00'"));
	     $namaBidang = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD'].". ".$getNamaBidang['nm_skpd'];
	     $getNamaSKPD = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d= '".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'"));
	     $namaSKPD = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT'].". ".$getNamaSKPD['nm_skpd'];
	   }
	 }else{
	 ...
	 if(mysql_num_rows(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  and c1 ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'  ")) !=0){
	      ...
	      $getData = mysql_fetch_array(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and  c1 ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."' "));
				if(mysql_num_rows(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'")) == 0){
						$getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where id ='".$getData['id_data_penetapan']."'"));
				}else{
						$getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'"));
				}
	      ...
	      $getIdPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'"));
	...
	$this->form_fields = array(
	  ...
	  $this->form_menubawah =
	    "
	    <input type='hidden' name='c1' id='c1' value='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan']."'>
	    <input type='hidden' name='c' id='c' value='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD']."'>
	    <input type='hidden' name='d' id='d' value='".$_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT']."'>
	...
	function Laporan($dt){
	 ...
	 $d = $dt['penetapanRKBMDPersediaanSkpdfmUNIT'];
      ...
      <input type='button' value='TTD' onclick ='".$this->Prefix.".Baru()' title='TTD' >
			...
			"<input type='button' value='Batal' onclick ='penetapanRKBMDPersediaan.Close()' >";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVWSKPD("penetapanRKBMDPersediaanNewSkpd") .
			"
			<input type='hidden' id='penetapanRKBMDPersediaanNewSkpdfmSUBUNIT' name='penetapanRKBMDPersediaanNewfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPersediaanNewSkpdfmSEKSI' name='penetapanRKBMDPersediaanNewfmSEKSI' >
			<input type='hidden' id='penetapanRKBMDPersediaanNewSkpdCbxSubUnit' name='penetapanRKBMDPersediaanNewfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPersediaanNewSkpdCbxSeksi' name='penetapanRKBMDPersediaanNewfmSEKSI' >
			</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenispenetapanRKBMDPersediaanNew' id='cmbJenispenetapanRKBMDPersediaanNew' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUrusan'];
		$c    = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmSKPD'];
		$d    = $_REQUEST['penetapanRKBMDPersediaanNewSkpdfmUNIT'];
		if(isset($d)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenispenetapanRKBMDPersediaanNew = $_REQUEST['cmbJenispenetapanRKBMDPersediaanNew'];
		$arrKondisi = array();
    ...
    $arrKondisi[] = "f != '06' and f!='07' and f!='01' and f!='02' and f!='03' and f!='04' and f!='05'";
		...
		echo "
								...
								<thead>
									<tr>
										<th class='th01' rowspan='2' style='width:20px;' >NO</th>
										<th class='th01' rowspan='2' style='width: 5%;'>SKPD/<br>PROGRAM/<br>KEGIATAN/<br>OUTPUT  </th>
										<th class='th02' rowspan='1' colspan='4' >PENETAPAN BMD</th>
										<th class='th01' rowspan='2' style='width: 5%;'>CARA<br>PEMENUHAN</th>
										<th class='th01' rowspan='2' style='width: 6%;'>KETERANGAN</th>
									</tr>
									<tr>
        ...
        $getDataKoreksi = mysql_fetch_array(mysql_query("select sum(volume_barang) from view_rkbmd where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' "));
        $volBar = number_format($getDataKoreksi['sum(volume_barang)'],0,',','.');
        ...
        $kebutuhanRill = number_format($kebutuhanRiil,0,'.',',');
        $nomorUrutSebelumnya = $lastNomorUrut -1;
        $getDataSebelumnya = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '$nomorUrutSebelumnya' and tahun='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck ='$ck' and dk ='$dk' and p = '$p' and q= '$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'"));
        $jumlahBarangSebelumnya = $getDataSebelumnya['volume_barang'];
...
function excel($dt){
	 ...
	 $c1 = $dt['penetapanRKBMDPersediaanNewSkpdfmUrusan'];
	 $c = $dt['penetapanRKBMDPersediaanNewSkpdfmSKPD'];
	 $d = $dt['penetapanRKBMDPersediaanNewSkpdfmUNIT'];
	 $e = $dt['penetapanRKBMDPersediaanNewSkpdfmSUBUNIT'];
	 $e1 = $dt['penetapanRKBMDPersediaanNewSkpdfmSEKSI'];
...
$penetapanRKBMDPersediaanNew = new penetapanRKBMDPersediaanNewObj();
...
$penetapanRKBMDPersediaanNew->jenisForm = $jenisForm;
$penetapanRKBMDPersediaanNew->nomorUrut = $nomorUrut;
$penetapanRKBMDPersediaanNew->urutTerakhir = $nomorUrut;
$penetapanRKBMDPersediaanNew->tahun = $tahun;
$penetapanRKBMDPersediaanNew->jenisAnggaran = $jenisAnggaran;
$penetapanRKBMDPersediaanNew->idTahap = $idTahap;
$penetapanRKBMDPersediaanNew->username = $_COOKIE['coID'];
$penetapanRKBMDPersediaanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($penetapanRKBMDPersediaanNew->wajibValidasi == TRUE){
	$penetapanRKBMDPersediaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
	$penetapanRKBMDPersediaanNew->sqlValidasi = " ";
}

$penetapanRKBMDPersediaanNew->provinsi = $arrayResult['provinsi'];
$penetapanRKBMDPersediaanNew->kota = $arrayResult['kota'];
$penetapanRKBMDPersediaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$penetapanRKBMDPersediaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$penetapanRKBMDPersediaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$penetapanRKBMDPersediaanNew->nipPengelola = $arrayResult['nipPengelola'];
$penetapanRKBMDPersediaanNew->nipPengurus = $arrayResult['nipPengurus'];
$penetapanRKBMDPersediaanNew->nipPejabat = $arrayResult['nipPejabat'];
