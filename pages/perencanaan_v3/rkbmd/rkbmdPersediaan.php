...
class rkbmdPersediaan_v3Obj  extends DaftarObj2{
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPersediaan_v3&tipe=Persediaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPersediaan_v3&tipe=Persediaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPersediaan_v3&tipe=Persediaan3";
	var $statusPenetapan = "";
	function setTitle(){
	...
	function setPage_HeaderOther(){
			if($_GET['modul'] =='persediaan'){
				...
				<A href=\"pages.php?Pg=rkbmdPersediaan_v3&modul=persediaan\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
				...
				<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
				<A href=\"pages.php?Pg=rkbmdPersediaan_v3&modul=persediaan\" title='RKBMD'  style='color : blue;' > INPUT </a> |
				<A href=\"pages.php?Pg=koreksiPenggunaPersediaan&modul=persediaan\" title='RKBMD PENGGUNA' > KOREKSI </a>
			 ...
			 -->
					...
					<A href=\"pages.php?Pg=rkbmdPersediaan_v3\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a> |
					...
					<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
					<A href=\"pages.php?Pg=rkbmdPersediaan_v3\" title='RKBMD'  style='color : blue;' > INPUT </a> |
					<A href=\"pages.php?Pg=koreksiPenggunaPersediaan\" title='RKBMD PENGGUNA' > KOREKSI </a>
	...
	case 'formBaru':{
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
					...
					$parentDK = $getParentrkbmdPersediaan_v3['dk'];
					...
					while($getKoreksi = mysql_fetch_array($grabExceptID)){
						foreach ($getKoreksi as $key => $value) {
						 ...
						 $getIDawal = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_tahap = '$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck ='$ck' and dk ='$dk' and p='$p' and $q='$q' and f='$f' and g='$g' and h = '$h' and i='$i' and j='$j' and j1='$j1' and id_jenis_pemeliharaan ='0'"));
	   ...
	   case 'remove':{
			...
			if(checkPenetapanRKBMD($this->tahun,$this->jenisAnggaran,"PERSEDIAAN",$getDataSKPD['c1'],$getDataSKPD['c'],$getDataSKPD['d']) != 0 ){
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	...
	function getDaftarOpsi($Mode=1){
		...
		while($dataKegiatan = mysql_fetch_array($getAllKegiatan)){
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where id_tahap ='$this->idTahap' $this->kondisiSKPD and c1='".$dataKegiatan['c1']."' and c='".$dataKegiatan['c']."' and d='".$dataKegiatan['d']."' and e='".$dataKegiatan['e']."' and e1='".$dataKegiatan['e1']."' and ck='".$dataKegiatan['ck']."' and bk='".$dataKegiatan['bk']."' and ck='".$dataKegiatan['ck']."' and dk='".$dataKegiatan['dk']."' and p='".$dataKegiatan['p']."' and q='".$dataKegiatan['q']."' and j!='000' and f='08' $kondisiBlackListBarang ")) == 0){
		...
		while($dataProgram = mysql_fetch_array($getAllProgram)){
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where id_tahap ='$this->idTahap' $this->kondisiSKPD and c1='".$dataProgram['c1']."' and c='".$dataProgram['c']."' and d='".$dataProgram['d']."' and e='".$dataProgram['e']."' and e1='".$dataProgram['e1']."' and ck='".$dataProgram['ck']."' and bk='".$dataProgram['bk']."' and ck='".$dataProgram['ck']."' and dk='".$dataProgram['dk']."' and p='".$dataProgram['p']."' and f='08'  and j!='000' $kondisiBlackListBarang ")) == 0){
		...
		while($dataSKPD = mysql_fetch_array($getAllSKPD)){
		    ...
		    if(mysql_num_rows(mysql_query("select * from view_rkbmd where id_tahap ='$this->idTahap' $this->kondisiSKPD and c1='".$dataSKPD['c1']."' and c='".$dataSKPD['c']."' and d='".$dataSKPD['d']."' and e='".$dataSKPD['e']."' and e1='".$dataSKPD['e1']."'  and j!='000' $kondisiBlackListBarang ")) == 0){
...
function Persediaan1($xls =FALSE){
    ...
    $arrayTandaTangan1 = explode(';', $getJenisReport1['tanda_tangan']);
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' $this->kondisiBarang $kondisiValid")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang $kondisiValid")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' $this->kondisiBarang $kondisiValid")) == 0){
						if($j != '000'){
...
$rkbmdPersediaan_v3->statusPenetapan = checkPenetapanRKBMD($rkbmdPersediaan_v3->tahun,$rkbmdPersediaan_v3->jenisAnggaran,"PERSEDIAAN");
