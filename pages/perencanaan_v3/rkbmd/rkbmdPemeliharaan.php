...
class rkbmdPemeliharaan_v3Obj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaan_v3';
	...
	var $FormName = 'rkbmdPemeliharaan_v3Form';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPemeliharaan_v3&tipe=Pemeliharaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPemeliharaan_v3&tipe=Pemeliharaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPemeliharaan_v3&tipe=Pemeliharaan3";
	var $statusPenetapa = "";
	//untuk view
	function setTitle(){
	...
	<!--	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		...
		<A href=\"pages.php?Pg=rkbmdPemeliharaan_v3\" title='RKBMD PENGELOLA'  style='color : blue;'> PEMELIHARAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPemeliharaan_v3\" title='RKBMD'  style='color : blue;' > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PENGELOLA' > KOREKSI </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$rkbmdPemeliharaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPemeliharaan_v3SkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$rkbmdPemeliharaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPemeliharaan_v3SkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPemeliharaan_v3SkpdfmUrusan;
		     $parentC = $rkbmdPemeliharaan_v3SkpdfmSKPD;
			 $parentD = $rkbmdPemeliharaan_v3SkpdfmUNIT;
			 $parentE = $rkbmdPemeliharaan_v3SkpdfmSUBUNIT;
			 $parentE1= $rkbmdPemeliharaan_v3SkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
				 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '00' and e1='000' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				 $lastID = $getDatarenja['id_anggaran'];
				 $parentE = '00';
			 	 $parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaan_v3SkpdfmUrusan' and c = '$rkbmdPemeliharaan_v3SkpdfmSKPD' and d='$rkbmdPemeliharaan_v3SkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaan_v3 = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaan_v3_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaan_v3 = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaan_v3 as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaan_v3['c1'];
					$parentC = $getParentrkbmdPemeliharaan_v3['c'];
					$parentD = $getParentrkbmdPemeliharaan_v3['d'];
					$parentE = $getParentrkbmdPemeliharaan_v3['e'];
					$parentE1= $getParentrkbmdPemeliharaan_v3['e1'];
					...
					$execute = mysql_query("select * from view_rkbmd where  c1='$parentC1' and c='$parentC' and d='$parentD' and e='".$getParentrkbmdPemeliharaan_v3['e']."' and e1='".$getParentrkbmdPemeliharaan_v3['e1']."' and bk='".$getParentrkbmdPemeliharaan_v3['bk']."' and ck='".$getParentrkbmdPemeliharaan_v3['ck']."' and dk='".$getParentrkbmdPemeliharaan_v3['dk']."' and p='".$getParentrkbmdPemeliharaan_v3['p']."' and q='".$getParentrkbmdPemeliharaan_v3['q']."' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and f !='00' and id_jenis_pemeliharaan !='0'  $exceptID  ");
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaan_v3_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaan_v3_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
			$id = $_REQUEST['rkbmdPemeliharaan_v3_cb'];
			$getDataSKPD = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]' "));

			if(checkPenetapanRKBMD($this->tahun,$this->jenisAnggaran,"PEMELIHARAAN",$getDataSKPD['c1'],$getDataSKPD['c'],$getDataSKPD['d']) != 0 ){
		...
		case 'koreksi':{
			...
			$getrkbmdPemeliharaan_v3nya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaan_v3nya as $key => $value) {
				  $$key = $value;
			}
	...
	function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPemeliharaan.js' language='JavaScript' ></script>
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
					...
					$headerTable =
					 ...
					 <tr>
					   ...
					   <th class='th01' align='center' rowspan='3' colspan='1' width='50'>PROGRAM/ KEGIATAN/ OUTPUT</th>
				   	 <th class='th02' align='center' rowspan='1' colspan='7' width='300'>BARANG YANG DIPELIHARA</th>
					   <th class='th02' align='center' rowspan='1' colspan='8' width='200'>USULAN KEBUTUHAN PEMELIHARAAN</th>
					   $tergantung
					   </tr>
					   <tr>
					      <th class='th01' align='center' rowspan='2' colspan='1' width='300'>KODE/NAMA BARANG</th>
	 ...
	 foreach ($isi as $key => $value) {
		  $$key = $value;
				...
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$tampilHeader = "<td class='$cssclass' align='left' colspan='17' style='vertical-align:middle;'><span $style>".$header."</span></td>";
					...
					if($this->wajibValidasi == TRUE)$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 if(empty($getBarang['satuan'])){
						 	$satuanBarang = "UNIT";
					 }else{
						  $satuanBarang = $getBarang['satuan'];
					 }
					 //$Koloms.= "<td class='$cssclass' align='center'>$no</td>";
					 $Koloms.= "<td class='$cssclass' align='center'></td>";
					 $urutBarang = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p.".".$q.".".$f1.".".$f.".".$g.".".$h.".".$i.".".$j;
					 $Koloms.= $tampilHeader;
					 if($urut != $this->lastUrut ){
						 if($urutBarang == $this->urutBarang){
 							$Koloms.= "<td class='$cssclass' align='center'></td>";
 							$Koloms.= "<td class='$cssclass' align='center'></td>";
 							$Koloms.= "<td class='$cssclass' align='center'></td>";
 							$Koloms.= "<td class='$cssclass' align='center'></td>";
							...
							$Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$kodeBarang <br> $namaBarang</td>";
						 	...
						 	$Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>".$satuanBarang."</td>";
						 	$Koloms.= "<td class='$cssclass' align='CENTER' style='vertical-align:middle;'>MILIK</td>";
					 ...
					 $kodeRekening = $k.".".$l.".".$m.".".$n.".".$o;
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$uraian_pemeliharaan / <br>$keterangan </td>";
					 $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($jumlah1,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$satuan1</td>";
					 $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($jumlah2,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$satuan2</td>";
					 $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($volume_barang,0,',','.')."</td>";
					...
					if($this->wajibValidasi == TRUE)$Koloms.= "<td class='$cssclass' align='center' style='vertical-align:middle;'>"."<img src='images/administrator/images/$validnya' width='20px' heigh='20px' style='cursor:pointer;'  onclick=$this->Prefix.Validasi('$id_anggaran');> "."</td>";

				 }
				 $this->lastUrut  = $urut;
				 $this->urutBarang = $urutBarang;
					$Koloms = array(
					 	array("Y", $Koloms),
					 );
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaan_v3Skpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaan_v3' id='cmbJenisrkbmdPemeliharaan_v3' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaan_v3SkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaan_v3SkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaan_v3SkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaan_v3SkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaan_v3SkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaan_v3 = $_REQUEST['cmbJenisrkbmdPemeliharaan_v3'];
		$arrKondisi = array();
    ...
    if ($getJenisUkuran == 'L') {
      ...
      $height = "33cm";
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			$grabKegiatan = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q!='0' and j='000' $this->kondisiBarang");
				while($row2s = mysql_fetch_array($grabKegiatan)){
					foreach ($row2s as $key => $value) {
						  $$key = $value;
					}
...
$rkbmdPemeliharaan_v3 = new rkbmdPemeliharaan_v3Obj();
$arrayResult = tahapPerencanaanV3($rkbmdPemeliharaan_v3->modul,"MURNI");
...
$rkbmdPemeliharaan_v3->jenisForm = $jenisForm;
$rkbmdPemeliharaan_v3->nomorUrut = $nomorUrut;
$rkbmdPemeliharaan_v3->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaan_v3->tahun = $tahun;
$rkbmdPemeliharaan_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaan_v3->idTahap = $idTahap;
$rkbmdPemeliharaan_v3->username = $_COOKIE['coID'];
$rkbmdPemeliharaan_v3->wajibValidasi =  $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaan_v3->wajibValidasi == TRUE){
	$rkbmdPemeliharaan_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaan_v3->sqlValidasi = " ";
}

$rkbmdPemeliharaan_v3->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaan_v3->kota = $arrayResult['kota'];
$rkbmdPemeliharaan_v3->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaan_v3->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaan_v3->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaan_v3->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaan_v3->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaan_v3->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPemeliharaan_v3->settingAnggaran = $arrayResult['settingAnggaran'];

$rkbmdPemeliharaan_v3->statusPenetapan = checkPenetapanRKBMD($rkbmdPemeliharaan_v3->tahun,$rkbmdPemeliharaan_v3->jenisAnggaran,"PEMELIHARAAN");
