...
class rphbmdObj  extends DaftarObj2{
	...
	function setMenuView(){
		return
			...
			"<td>".genPanelIcon("javascript:".$this->Prefix.".CetakSemua()","print_f2.png",'Laporan',"Laporan")."</td>";
...
-->
		...
		<A href=\"pages.php?Pg=rphbmd\" title='RKBMD PENGHAPUSAN' style='color : blue;'> PENGHAPUSAN </a>
