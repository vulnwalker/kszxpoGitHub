...
class penetapanRKBMDPemeliharaanObj  extends DaftarObj2{
	var $Prefix = 'penetapanRKBMDPemeliharaan';
	...
	var $FormName = 'penetapanRKBMDPemeliharaanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL7 = "pages.php?Pg=penetapanRKBMDPemeliharaan&tipe=Pengadaan7";
...
-->
		...
		<A href=\"pages.php?Pg=penetapanRKBMDPemeliharaan\" title='RKBMD PENGELOLA'  style='color : blue;'> PENETAPAN RKBMD </a>
		...
		<A href=\"pages.php?Pg=penetapanRKBMDPemeliharaan\" title='RKBMD PENGELOLA' style='color : blue;' > PEMELIHARAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($penetapanRKBMDPemeliharaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($penetapanRKBMDPemeliharaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($penetapanRKBMDPemeliharaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($penetapanRKBMDPemeliharaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($penetapanRKBMDPemeliharaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPemeliharaanSkpdfmUrusan' and c = '$penetapanRKBMDPemeliharaanSkpdfmSKPD' and d='$penetapanRKBMDPemeliharaanSkpdfmUNIT' and e = '$penetapanRKBMDPemeliharaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPemeliharaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPemeliharaanSkpdfmUrusan' and c = '$penetapanRKBMDPemeliharaanSkpdfmSKPD' and d='$penetapanRKBMDPemeliharaanSkpdfmUNIT' and e = '$penetapanRKBMDPemeliharaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPemeliharaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPemeliharaanSkpdfmUrusan' and c = '$penetapanRKBMDPemeliharaanSkpdfmSKPD' and d='$penetapanRKBMDPemeliharaanSkpdfmUNIT' and e = '$penetapanRKBMDPemeliharaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPemeliharaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentpenetapanRKBMDPemeliharaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentpenetapanRKBMDPemeliharaan['c1'];
					$parentC = $getParentpenetapanRKBMDPemeliharaan['c'];
					$parentD = $getParentpenetapanRKBMDPemeliharaan['d'];
					$parentE = $getParentpenetapanRKBMDPemeliharaan['e'];
					$parentE1= $getParentpenetapanRKBMDPemeliharaan['e1'];
					...
					if($cmbJenispenetapanRKBMDPemeliharaan == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['penetapanRKBMDPemeliharaan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentpenetapanRKBMDPemeliharaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentpenetapanRKBMDPemeliharaan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentpenetapanRKBMDPemeliharaan['c1'];
					$parentC = $getParentpenetapanRKBMDPemeliharaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$penetapanRKBMDPemeliharaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$penetapanRKBMDPemeliharaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getpenetapanRKBMDPemeliharaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getpenetapanRKBMDPemeliharaannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpenetapanRKBMDPemeliharaannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getpenetapanRKBMDPemeliharaannya['volume_barang'] < $angkaKoreksi){
	   ...
	   if(empty($angka))$angka = 25;
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/penetapanRKBMDPemeliharaan.js' language='JavaScript' ></script>
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	...
	function tetapkanRKBMD($dt){
	 ...
	 if(!empty($_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']) && $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan'] !='0' ){

	   if(empty($_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']) || $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD'] =='00'){
	      $err = "Pilih Bidang";
	   }elseif(empty($_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']) || $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT'] =='00'){
	      $err = "Pilih SKPD";
	   }else{
	     $getNamaUrusan = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c= '00' and d= '00'"));
	     $namaUrusan = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan'].". ".$getNamaUrusan['nm_skpd'];
	     $getNamaBidang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d= '00'"));
	     $namaBidang = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD'].". ".$getNamaBidang['nm_skpd'];
	     $getNamaSKPD = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d= '".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'"));
	     $namaSKPD = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT'].". ".$getNamaSKPD['nm_skpd'];
	   }
	 }else{
	 ...
	 if(mysql_num_rows(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  and c1 ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'  ")) !=0){
	      ...
	      $getData = mysql_fetch_array(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and  c1 ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."' "));

				if(mysql_num_rows(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'")) == 0){
				    $getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where id ='".$getData['id_data_penetapan']."'"));
				}else{
				    $getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'"));
				}
	      ...
	      $getIdPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1 ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'"));
	...
	$this->form_fields = array(
	  ...
	  $this->form_menubawah =
	    "
	    <input type='hidden' name='c1' id='c1' value='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan']."'>
	    <input type='hidden' name='c' id='c' value='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD']."'>
	    <input type='hidden' name='d' id='d' value='".$_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT']."'>
	...
	function Laporan($dt){
	 ...
	 $e = $dt['penetapanRKBMDPemeliharaanSkpdfmSUBUNIT'];
	 $e1 = $dt['penetapanRKBMDPemeliharaanSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVWSKPD("penetapanRKBMDPemeliharaanSkpd") .
			"
			<input type='hidden' id='penetapanRKBMDPemeliharaanSkpdfmSUBUNIT' name='penetapanRKBMDPemeliharaanfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPemeliharaanSkpdfmSEKSI' name='penetapanRKBMDPemeliharaanfmSEKSI' >
			<input type='hidden' id='penetapanRKBMDPemeliharaanSkpdCbxSubUnit' name='penetapanRKBMDPemeliharaanfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPemeliharaanSkpdCbxSeksi' name='penetapanRKBMDPemeliharaanfmSEKSI' >
			</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenispenetapanRKBMDPemeliharaan' id='cmbJenispenetapanRKBMDPemeliharaan' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUrusan'];
		$c    = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmSKPD'];
		$d    = $_REQUEST['penetapanRKBMDPemeliharaanSkpdfmUNIT'];
		if(isset($d)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenispenetapanRKBMDPemeliharaan = $_REQUEST['cmbJenispenetapanRKBMDPemeliharaan'];
		$arrKondisi = array();
...
$penetapanRKBMDPemeliharaan = new penetapanRKBMDPemeliharaanObj();
...
$penetapanRKBMDPemeliharaan->jenisForm = $jenisForm;
$penetapanRKBMDPemeliharaan->nomorUrut = $nomorUrut;
$penetapanRKBMDPemeliharaan->urutTerakhir = $nomorUrut;
$penetapanRKBMDPemeliharaan->tahun = $tahun;
$penetapanRKBMDPemeliharaan->jenisAnggaran = $jenisAnggaran;
$penetapanRKBMDPemeliharaan->idTahap = $idTahap;
$penetapanRKBMDPemeliharaan->username = $_COOKIE['coID'];
$penetapanRKBMDPemeliharaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($penetapanRKBMDPemeliharaan->wajibValidasi == TRUE){
	$penetapanRKBMDPemeliharaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$penetapanRKBMDPemeliharaan->sqlValidasi = " ";
}

$penetapanRKBMDPemeliharaan->provinsi = $arrayResult['provinsi'];
$penetapanRKBMDPemeliharaan->kota = $arrayResult['kota'];
$penetapanRKBMDPemeliharaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$penetapanRKBMDPemeliharaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$penetapanRKBMDPemeliharaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$penetapanRKBMDPemeliharaan->nipPengelola = $arrayResult['nipPengelola'];
$penetapanRKBMDPemeliharaan->nipPengurus = $arrayResult['nipPengurus'];
$penetapanRKBMDPemeliharaan->nipPejabat = $arrayResult['nipPejabat'];
