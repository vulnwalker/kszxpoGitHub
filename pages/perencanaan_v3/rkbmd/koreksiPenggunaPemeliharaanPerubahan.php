...
class koreksiPenggunaPemeliharaanPerubahanObj  extends DaftarObj2{
	var $Prefix = 'koreksiPenggunaPemeliharaanPerubahan';
	...
	var $FormName = 'koreksiPenggunaPemeliharaanPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $username = "";
             ...
             var $reportURL11 = "pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan&tipe=Pemeliharaan11";
             var $reportURL12 = "pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan&tipe=Pemeliharaan12";
             var $reportURL13 = "pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan&tipe=Pemeliharaan13";
	var $wajibValidasi = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=koreksiPenggunaPengadaanPerubahan\" title='RKBMD'  > PENGADAAN </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan\" title='RKBMD PENGELOLA' style='color : blue;'  > PEMELIHARAAN </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a>

		&nbsp&nbsp&nbsp
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPemeliharaanPerubahan_v3\" title='RKBMD'  > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan\" title='RKBMD PENGELOLA' style='color : blue;' > KOREKSI </a>
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentkoreksiPenggunaPemeliharaanPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPenggunaPemeliharaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPemeliharaanPerubahan['c'];
					$parentD = $getParentkoreksiPenggunaPemeliharaanPerubahan['d'];
					$parentE = $getParentkoreksiPenggunaPemeliharaanPerubahan['e'];
					$parentE1= $getParentkoreksiPenggunaPemeliharaanPerubahan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPenggunaPemeliharaanPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPemeliharaanPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPenggunaPemeliharaanPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentkoreksiPenggunaPemeliharaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPemeliharaanPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPenggunaPemeliharaanPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPenggunaPemeliharaanPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getkoreksiPenggunaPemeliharaanPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPenggunaPemeliharaanPerubahannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif( $getkoreksiPenggunaPemeliharaanPerubahannya['volume_barang'] >= $angkaKoreksi ) {
						...
						if( $getkoreksiPenggunaPemeliharaanPerubahannya['volume_barang'] >= $angkaKoreksi )  {
	...
	function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPenggunaPemeliharaanPerubahan.js' language='JavaScript' ></script>".
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPemeliharaanPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPemeliharaanPerubahan.koreksi('$id_anggaran');></img> ";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("koreksiPenggunaPemeliharaanPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPenggunaPemeliharaanPerubahan' id='cmbJeniskoreksiPenggunaPemeliharaanPerubahan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPenggunaPemeliharaanPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPenggunaPemeliharaanPerubahanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPenggunaPemeliharaanPerubahan = $_REQUEST['cmbJeniskoreksiPenggunaPemeliharaanPerubahan'];
		$arrKondisi = array();
		if(isset($e1)){
		...
		$arrKondisi[] = "( id_jenis_pemeliharaan != 0 OR (id_jenis_pemeliharaan = 0 and f = '00' and uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN' ) ) ";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['koreksiPenggunaPemeliharaanPerubahanSkpdfmUrusan'];
	 $c = $dt['koreksiPenggunaPemeliharaanPerubahanSkpdfmSKPD'];
	 $d = $dt['koreksiPenggunaPemeliharaanPerubahanSkpdfmUNIT'];
	 $e = $dt['koreksiPenggunaPemeliharaanPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPenggunaPemeliharaanPerubahanSkpdfmSEKSI'];
	 ...
	 /*if($e1 != '000'){
	 	 ...
	 	 $arrayJenisLaporan = array(
							   array('Pemeliharaan11', 'PERUBAHAN USULAN RKBMD PEMELIHARAAN PADA PENGGUNA BARANG'),
							   array('Pemeliharaan12', 'PERUBAHAN HASIL PENELAAHAN RKBMD PEMELIHARAAN OLEH PENGELOLA BARANG'),
							   array('Pemeliharaan13', 'PERUBAHAN RKBMD PEMELIHARAAN PADA PENGGUNA BARANG'),
...
function Pemeliharaan11($xls =FALSE){
		global $Main;
		...
		$this->fileNameExcel = "PERUBAHAN USULAN RKBMD PEMELIHARAAN PADA PENGGUNA BARANG";
		$align = "center";
		$xls = $_GET['xls'];
		...
		$getAllParent = mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$lastNomorUrut' and f='00' and q !='0' ");
				while($rows = mysql_fetch_array($getAllParent)){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$lastNomorUrut' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'  and f != '00' and id_jenis_pemeliharaan !='0'  "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p,'.',q) != '$concat'";
						$cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$lastNomorUrut' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and f !='00' and id_jenis_pemeliharaan !='0' "));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p) != '$concat'";
							$cekSKPD = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$lastNomorUrut' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and id_jenis_pemeliharaan !='0' "));
							if($cekSKPD == 0){
								$concat = $c1.".".$c.".".$d.".".$e.".".$e1;
								$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1) != '$concat'";
							}
			...
			//$arrKondisi[] =  "no_urut = '$lastNomorUrut'";
		$grabBarang = mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$lastNomorUrut' and f!='00' and q !='0' ");
		while($rows = mysql_fetch_array($grabBarang)){
			foreach ($rows as $key => $value) {
				 	 $$key = $value;
					}
			if($id_jenis_pemeliharaan == '0'){
				$concatBarang = $f.".".$g.".".$h.".".$i.".".$j;
				$arrKondisi[] = "concat(f,'.',g,'.',h,'.',i,'.',j) != '$concatBarang'";
			}
		}
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and  uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN' $this->kondisiBarang  $Kondisi order by urut";
...
PERUBAHAN USULAN RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH<br>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran ='MURNI' and no_urut = '5'"));
				...
				$namaKegiatan = "<td align='left' style='padding-left: 20px;' class='GarisCetak' colspan='3'>".$programKegiatan;
			}else{
...
function Pemeliharaan12($xls =FALSE){
		global $Main;
		...
		$this->fileNameExcel = "PERUBAHAN HASIL PENELAAHAN RKBMD PEMELIHARAAN OLEH PENGELOLA BARANG";
		$align = "center";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
						...
						<tr>
							...
							<table style='width: 100%; border: none; margin-bottom: 1%;'>
								<tr>
									...
									<td style='text-align: center;'>
										<span style='font-size:18px;font-weight:bold;text-decoration: '>
ERUBAHAN HASIL PENELAAHAN RENCANA KEBUTUHAN PEMELIHARAAN BARANG MILIK DAERAH<br>
					(PERUBAHAN RENCANA PEMELIHARAAN)<br>
					PENGUNA BARANG ".strtoupper($penggunaBarang)."
										</span>
									</td>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran ='MURNI' and no_urut = '5'"));
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');
				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran ='PERUBAHAN' and no_urut = '3'"));
	...
	if (sizeof($arrayTandaTangan12)==1) {
			...
			echo
					...
					<div style='margin-left:-181px;width:50%;' >Telah Diperiksa : </div>
					<table table width='100%' class='cetak' border='1' style='margin-left:90px;width:50%;'>
						<tr>
							<th class='th01'>No</th>
							<th class='th01'>Nama</th>
...
function Pemeliharaan13($xls =FALSE){
		global $Main;
		...
		$this->fileNameExcel = "PERUBAHAN RKBMD PEMELIHARAAN PADA PENGGUNA BARANG";
		$align = "center";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			";
				...
				$naonkitu ="
				  <tr valign='top'>
					<td align='$align' class='GarisCetak'>$no</td>
					<td align='left' class='GarisCetak' colspan='2'>".$programKegiatan." <br> ".$kodeBarang."</td>
...
function Pemeliharaan7($xls =FALSE){
		...
		$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and p !='0' and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			foreach ($rows as $key => $value) {
				  $$key = $value;
			}
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
			$grabKegiatan = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q!='0' and j='000'");
				while($row2s = mysql_fetch_array($grabKegiatan)){
					foreach ($row2s as $key => $value) {
						  $$key = $value;
					}
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' ")) == 0){
						if($q != '0'){
							$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
							$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p,'.',q) !='$concat'";
						}
					}else{
						$grabBarang = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000'");
						while($row3s = mysql_fetch_array($grabBarang)){
							foreach ($row3s as $key => $value) {
								  $$key = $value;
							}
							$concat = $f.".".$g.".".$h.".".$i.".".$j;
							if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
								if($j != '000'){
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !='RKBMD PENGADAAN' and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and uraian_pemeliharaan !='RKBMD PERSEDIAAN'   $Kondisi order by urut";
		$aqry = mysql_query($qry);
...
$koreksiPenggunaPemeliharaanPerubahan = new koreksiPenggunaPemeliharaanPerubahanObj();
...
$koreksiPenggunaPemeliharaanPerubahan->jenisForm = $jenisForm;
$koreksiPenggunaPemeliharaanPerubahan->nomorUrut = $nomorUrut;
$koreksiPenggunaPemeliharaanPerubahan->urutTerakhir = $nomorUrut;
$koreksiPenggunaPemeliharaanPerubahan->tahun = $tahun;
$koreksiPenggunaPemeliharaanPerubahan->jenisAnggaran = $jenisAnggaran;
$koreksiPenggunaPemeliharaanPerubahan->idTahap = $idTahap;
$koreksiPenggunaPemeliharaanPerubahan->username = $_COOKIE['coID'];
$koreksiPenggunaPemeliharaanPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPenggunaPemeliharaanPerubahan->wajibValidasi == TRUE){
	$koreksiPenggunaPemeliharaanPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPenggunaPemeliharaanPerubahan->sqlValidasi = " ";
}
$koreksiPenggunaPemeliharaanPerubahan->provinsi = $arrayResult['provinsi'];
$koreksiPenggunaPemeliharaanPerubahan->kota = $arrayResult['kota'];
$koreksiPenggunaPemeliharaanPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPenggunaPemeliharaanPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPenggunaPemeliharaanPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPenggunaPemeliharaanPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPenggunaPemeliharaanPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPenggunaPemeliharaanPerubahan->nipPejabat = $arrayResult['nipPejabat'];
