...
class popupBarangPemeliharaan_v3Obj  extends DaftarObj2{
	var $Prefix = 'popupBarangPemeliharaan_v3';
	...
	var $FormName = 'popupBarangPemeliharaan_v3Form';
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $concat = $isi['c1'].".".$isi['c'].".".$isi['d'].".".$isi['e'].".".$isi['e1'].".".$isi['f'].'.'.$isi['g'].'.'.$isi['h'].'.'.$isi['i'].'.'.$isi['j'];
	 	...
	 	if($isi['j'] == '000'){
 		 ...
 		 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangPemeliharaan_v3.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
$popupBarangPemeliharaan_v3 = new popupBarangPemeliharaan_v3Obj();
