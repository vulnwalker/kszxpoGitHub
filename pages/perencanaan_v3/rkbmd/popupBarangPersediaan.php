...
class popupBarangRKBMDPersediaan_v3Obj  extends DaftarObj2{
	var $Prefix = 'popupBarangRKBMDPersediaan_v3';
	...
	var $FormName = 'popupBarangRKBMDPersediaan_v3Form';
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		$kode_barang=$get['f'].'.'.$get['g'].'.'.$get['h'].'.'.$get['i'].'.'.$get['j'].'.'.$get['j1'];
		 ...
		 $cek = "select * from ref_barang where  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1'";
		 $content = array('kodeBarang'=>$kode_barang, 'namaBarang'=>$get['nm_barang'],'satuanBarang'=>$get['satuan'] , 'kebutuhanMaksimal' =>$getKebutuhanMaksimal['jumlah'], "kebutuhanOptimal"=> $kebutuhanOptimal, "kebutuhanRill" => $getKebutuhanMaksimal['jumlah'] - $kebutuhanOptimal, 'tak' => "select * from ref_barang where  f='$f' and g='$g' and h='$h' and i='$i' and j='$j'" );
		break;
	   }
...
/*			'' => array(
	...
	elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && !empty($fmSUBKELOMPOK) && !empty($fmSUBSUBKELOMPOK))
	{
	 ...
	 <tr>
	   ...
	   <th class='th01' align='left' width='400'>NAMA BARANG</th>
	   <th class='th01' align='left' width='200'>OBYEK</th>
	   <th class='th01' align='left' width='200'>RINCIAN OBYEK</th>
	   <th class='th01' align='left' width='200'>SUB RINCIAN OBYEK</th>
		 <th class='th01' align='left' width='200'>SUB SUB RINCIAN OBYEK</th>
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $kode_barang=$isi['f'].'.'.$isi['g'].'.'.$isi['h'].'.'.$isi['i'].'.'.$isi['j'].'.'.$isi['j1'];
	 $Koloms = array();
	 $Koloms[] = array('align="center" ', $no.'.' );
	 if($isi['j'] == '000'){
	 	$Koloms[] = array('align="left"  style="font-weight : bold;" ',$kode_barang);
	 }else{
	 	$Koloms[] = array('align="left"  style="border-left-style: none;"',$kode_barang);
	 }

 	 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangRKBMDPersediaan_v3.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
	...
	$TampilOpt =
			...
			<td>".
			cmbQuery1("cmbJenis",$cmbJenis,"select f as valueCmbJenis, nm_barang from ref_barang where f != '00'  and g ='00' and h ='00' and i='00' and f != '01' and f!='02' and f!='03' and f!='04' and f!='05' and f!='06' and f!='07' and j = '000' and j1 = '0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
			</tr><tr>
			<td style='width:170px;'>OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbObyek",$cmbObyek,"select g as valueCmbObyek, nm_barang from ref_barang where f = '$cmbJenis'  and g !='00' and h ='00' and i='00' and j = '000' and j1 = '0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
			</tr><tr>
			<td style='width:170px;'>RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbRincianObyek",$cmbRincianObyek,"select h as valueCmbRincianObyek, nm_barang from ref_barang where  f = '$cmbJenis'  and g ='$cmbObyek' and h !='00' and i='00' and j = '000' and j1 = '0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
				</tr>
			<tr>
			<td style='width:170px;'>SUB RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbSubRincianObyek",$cmbSubRincianObyek,"select i as valueCmbSubRincianObyek, nm_barang from ref_barang where  f = '$cmbJenis'  and g ='$cmbObyek' and h ='$cmbRincianObyek' and i != '00' and j = '000' and j1 = '0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
				</tr>
			<tr>
			<td style='width:170px;'>SUB-SUB RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbSubSubRincianObyek",$cmbSubSubRincianObyek,"select j as valueCmbSubSubRincianObyek, nm_barang from ref_barang where  f = '$cmbJenis'  and g ='$cmbObyek' and h ='$cmbRincianObyek' and i='$cmbSubRincianObyek' and j != '000' and j1 = '0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
				</tr>
			<tr>
			<td style='width:170px;'>SUB-SUB-SUB RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbSubSubSubRincianObyek",$_REQUEST['cmbSubSubSubRincianObyek'],"select j1, nm_barang from ref_barang where  f = '$cmbJenis'  and g ='$cmbObyek' and h ='$cmbRincianObyek' and i='$cmbSubRincianObyek' and j = '$cmbSubSubRincianObyek' and j1!='0000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
				</tr>
...
$popupBarangRKBMDPersediaan_v3 = new popupBarangRKBMDPersediaan_v3Obj();
