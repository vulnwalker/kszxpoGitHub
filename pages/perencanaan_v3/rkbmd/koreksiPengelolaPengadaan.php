...
class koreksiPengelolaPengadaanObj  extends DaftarObj2{
	...
	var $reportURL7 = "pages.php?Pg=koreksiPengelolaPengadaan&tipe=Pengadaan7";
	var $statusPenetapan ="";
...
-->
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
	...
	case 'formBaru':{
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			}elseif(checkPenetapanRKBMD($this->tahun,$this->jenisAnggaran,"PENGADAAN",$c1,$c,$d) != 0 ){
...
$koreksiPengelolaPengadaan->statusPenetapan = checkPenetapanRKBMD($koreksiPengelolaPengadaan->tahun,$koreksiPengelolaPengadaan->jenisAnggaran,"PENGADAAN");
