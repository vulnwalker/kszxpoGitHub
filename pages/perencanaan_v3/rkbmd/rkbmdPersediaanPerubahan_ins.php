<?php
class rkbmdPersediaanPerubahan_ins_v3Obj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanPerubahan_ins_v3';
	...
	var $FormName = 'rkbmdPersediaanPerubahan_ins_v3Form';
	var $noModul=14;
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPersediaanPerubahan_ins.js' language='JavaScript' ></script>".
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_ins_v3.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_ins_v3.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPersediaanPerubahan_ins_v3.CekAda(); ','-- KEGIATAN --');
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPersediaanPerubahan_ins_v3.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPersediaanPerubahan_ins_v3.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPersediaanPerubahan_ins_v3.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPersediaanPerubahan_ins_v3.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPersediaanPerubahan_ins_v3.finish()'>
...
$rkbmdPersediaanPerubahan_ins_v3 = new rkbmdPersediaanPerubahan_ins_v3Obj();

$arrayResult = tahapPerencanaanV3($rkbmdPersediaanPerubahan_ins_v3->modul,"PERUBAHAN");
...
$rkbmdPersediaanPerubahan_ins_v3->jenisForm = $jenisForm;
$rkbmdPersediaanPerubahan_ins_v3->nomorUrut = $nomorUrut;
$rkbmdPersediaanPerubahan_ins_v3->urutTerakhir = $nomorUrut;
$rkbmdPersediaanPerubahan_ins_v3->tahun = $tahun;
$rkbmdPersediaanPerubahan_ins_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanPerubahan_ins_v3->idTahap = $idTahap;
$rkbmdPersediaanPerubahan_ins_v3->username = $_COOKIE['coID'];
$rkbmdPersediaanPerubahan_ins_v3->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPersediaanPerubahan_ins_v3->wajibValidasi == TRUE){
	$rkbmdPersediaanPerubahan_ins_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanPerubahan_ins_v3->sqlValidasi = " ";
}
