...
class koreksiPengelolaPemeliharaanNewObj  extends DaftarObj2{
  var $Prefix = 'koreksiPengelolaPemeliharaanNew';
  ...
  var $FormName = 'koreksiPengelolaPemeliharaanNewForm';
  var $kode_skpd = '';
  var $modul = "RKBMD";
  var $jenisForm = "";
  var $tahun = "";
  ...
  var $reportURL4 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan4";
  var $reportURL5 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan5";
  var $reportURL6 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan6";
  var $reportURL7 = "pages.php?Pg=koreksiPengelolaPemeliharaanNew&tipe=Pemeliharaan7";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'koreksiPengelolaPemeliharaanSkpdfmUrusan'];
      $dt['c'] = $_REQUEST[$this->Prefix.'koreksiPengelolaPemeliharaanSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'koreksiPengelolaPemeliharaanSkpdfmUNIT'];
      $dt['e'] = $_REQUEST[$this->Prefix.'koreksiPengelolaPemeliharaanSkpdfmSUBUNIT'];
      $dt['e1'] = $_REQUEST[$this->Prefix.'koreksiPengelolaPemeliharaanSkpdfmSEKSI'];
      $fm = $this->setForm($dt);
    }
...
function setForm($dt,$c1,$c,$d,$e,$e1){  
      ...
      if($err=='' && $oldy['cnt']>0) $err="NIP '$nippegawai' Sudah Ada";
        if($err==''){
          ...
          $jenisKegiatan = $_REQUEST['jenisKegiatan'];
            if($jenisKegiatan == "Pemeliharaan4" || $jenisKegiatan == "Pemeliharaan6"){
              $kategorinaey = 1;
            }else{
              $kategorinaey = 2;
            }
  ...
  function setPage_HeaderOther(){
    ...
    <A href=\"pages.php?Pg=koreksiPengelolaPemeliharaanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
    <A href=\"pages.php?Pg=penetapanRKBMDPemeliharaan\" title='RKBMD PENGELOLA' > PENETAPAN RKBMD </a>

    &nbsp&nbsp&nbsp
    </td></tr>

    <tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
    <A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD'   > PENGADAAN </a> |
    <A href=\"pages.php?Pg=koreksiPengelolaPemeliharaanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> PEMELIHARAAN </a> |
   ...
   $cek = ''; $err=''; $content=''; $json=TRUE;
    ...
    case 'Laporan':{
      foreach ($_REQUEST as $key => $value) {
       ...
       /*if($koreksiPengelolaPemeliharaanNewSkpdfmUrusan =='0'){
        $err = "Pilih Urusan";
       }elseif($koreksiPengelolaPemeliharaanNewSkpdfmSKPD =='00'){
        $err = "Pilih Bidang";
       }elseif($koreksiPengelolaPemeliharaanNewSkpdfmUNIT =='00'){
        $err = "Pilih SKPD";
       }elseif($koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT =='00'){
        $err = "Pilih Unit";
       }elseif($koreksiPengelolaPemeliharaanNewSkpdfmSEKSI =='000'){
        $err = "Pilih Sub Unit";
       }else{*/
    ...
    case 'newTab':{
       ...
       $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanNewSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
       $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanNewSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
       $lastID = $getDatarenja['id_anggaran'];
        if($cekKeberadaanMangkluk != 0){
          if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
            $getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanNewSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
            if($getJumlahRenjaValidasi == 0){
              $err = "Renja Belum Di Validasi";
            }
          }

          $getParentkoreksiPengelolaPemeliharaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
          $parentC1 = $getParentkoreksiPengelolaPemeliharaanNew['c1'];
          $parentC = $getParentkoreksiPengelolaPemeliharaanNew['c'];
          $parentD = $getParentkoreksiPengelolaPemeliharaanNew['d'];
          $parentE = $getParentkoreksiPengelolaPemeliharaanNew['e'];
          $parentE1= $getParentkoreksiPengelolaPemeliharaanNew['e1'];
    ...
    case 'editTab':{
       $id = $_REQUEST['koreksiPengelolaPemeliharaanNew_cb'];
      foreach ($_REQUEST as $key => $value) {
          $$key = $value;
       }
          $nomorUrutSebelumnya = $this->nomorUrut - 1;
          $getParentkoreksiPengelolaPemeliharaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
          foreach ($getParentkoreksiPengelolaPemeliharaanNew as $key => $value) {
             $$key = $value;
           }
          $parentC1 = $getParentkoreksiPengelolaPemeliharaanNew['c1'];
          $parentC = $getParentkoreksiPengelolaPemeliharaanNew['c'];
    ...
    case 'SaveValid':{
       ...
       $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPemeliharaanNew_idplh'"));
       ...
       $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPemeliharaanNew_idplh'");
       mysql_query($query);
    ...
    case 'koreksi':{
      ...
      $getkoreksiPengelolaPemeliharaanNewnya = mysql_fetch_array(mysql_query($queryRows));
      foreach ($getkoreksiPengelolaPemeliharaanNewnya as $key => $value) {
          $$key = $value;
      }
      ...
      if($this->jenisForm !='KOREKSI PENGGUNA' && $this->jenisForm !='KOREKSI PENGELOLA'){
        ...
        $err = "RKBMD Telah Ditetapkan";
      }elseif(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '3' and tahun ='$this->tahun' and jenis_anggaran ='PERUBAHAN' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan'")) != 0){
       ...
       $explodeKodeRekeningKoreksi = explode('.',$kodeRekeningKoreksi);
       $volumeKoreksi = $angkaKoreksi * $angkaKuantiti;
       $explodeSatuan = explode("/",$satuan_barang);
       $dataSesuai = array(
                      ...
                      'i' => $i,
                      'j' => $j,
                      'k' => $explodeKodeRekeningKoreksi[0],
                      'l' => $explodeKodeRekeningKoreksi[1],
                      'm' => $explodeKodeRekeningKoreksi[2],
                      'n' => $explodeKodeRekeningKoreksi[3],
                      'o' => $explodeKodeRekeningKoreksi[4],
                      'id_buku_induk' => $id_buku_induk,
                      'cara_pemenuhan' => $caraPemenuhan,
                      'volume_barang' => $volumeKoreksi,
                      'jumlah1' => $angkaKoreksi ,
                      'jumlah2' => $angkaKuantiti,
                      ...
                      'user_update' => $_COOKIE['coID'],
                      'tanggal_update' => date('Y-m-d'),
                      'keterangan' => $namaRekeningKoreksi
        ...
        $concat = $kodeSKPD.".".$kodeBarang;
          ...
          if($getkoreksiPengelolaPemeliharaanNewnya['jumlah1'] < $angkaKoreksi ){
              $err = "Jumlah Barang tidak dapat melebihi pengajuan";
          }
          if($err == ""){
            $cekKoreksi =  mysql_num_rows(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
            if($cekKoreksi > 0 ){
               $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
                  $idnya = $getID['id_anggaran'];

                if( $getkoreksiPengelolaPemeliharaanNewnya['volume_barang'] >= $volumeKoreksi ) {
                  mysql_query(VulnWalkerUpdate("tabel_anggaran",$dataSesuai,"id_anggaran = '$idnya'"));
                  $cek = VulnWalkerUpdate("tabel_anggaran",$dataSesuai,"id_anggaran = '$idnya'");
                }elseif($getkoreksiPengelolaPemeliharaanNewnya['volume_barang'] < $volumeKoreksi){
  ...
  function setPage_OtherScript(){
    ...
    return
      ...
      <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
       "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPemeliharaanNew.js' language='JavaScript' ></script>
  ...
  function setKolomHeader($Mode=1, $Checkbox=''){
   $NomorColSpan = $Mode==1? 2: 1;
          ...
          $headerTable =
             "<thead>
             <tr>
               <th class='th01' align='center' rowspan='3' colspan='1' width='50'>PROGRAM/ KEGIATAN/ OUTPUT</th>
                 <th class='th02' align='center' rowspan='1' colspan='5' width='200'>BARANG YANG DIPELIHARA</th>
               <th class='th02' align='center' rowspan='1' colspan='7' width='200'>USULAN KEBUTUHAN PEMELIHARAAN</th>
               <th class='th02' align='center' rowspan='2' colspan='3' width='100'>DISETUJUI PENGGUNA</th>
               <th class='th02' align='center' rowspan='2' colspan='3' width='100'>DISETUJUI PENGELOLA</th>
                 <th class='th01' align='center' rowspan='3' colspan='1' width='50'>KOREKSI PENGELOLA</th>
               </tr>
               <tr>
                <th class='th01' align='center' rowspan='2' colspan='1' width='300'>NAMA BARANG</th>
                ...
                <th class='th01' align='center' rowspan='2' colspan='1' width='600'>URAIAN PEMELIHARAAN / REKENING</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>JML</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>SATUAN</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>KUAN TITAS</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>SATUAN</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>VOL</th>
                <th class='th01' align='center' rowspan='2' colspan='1'  width='50'>SATUAN</th>
               ...
               <th class='th01' align='center' rowspan='1' colspan='1' width='50'>KUAN TITAS</th>
               <th class='th01' align='center' rowspan='1' colspan='1' width='50'>VOL</th>
  ...
  function setKolomData($no, $isi, $Mode, $TampilCheckBox){
   ...
   foreach ($isi as $key => $value) {
      $$key = $value;
          ...
          $tampilHeader = "<td class='$cssclass' align='left' colspan='20' style='vertical-align:middle;'><span $style>".$header."</span></td>";
          ...
          // $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
           $Koloms.= $tampilHeader;
           if($urut != $this->lastUrutan){
            $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$kodeBarang <br> $namaBarang</td>";
            $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($baik + $kurangBaik + $rusakBerat,0,',','.')."</td>";
            $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($baik,0,',','.')."</td>";
            $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($kurangBaik,0,',','.')."</td>";
            $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($rusakBerat,0,',','.')."</td>";
           }else{
           ...
           $getDataKoreksi = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' "));
           $kondisiWarna = "red";

             if(mysql_num_rows(mysql_query("select * from view_rkbmd where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan'"))  > 0){
           ...
           $getJumlahBarangPertama = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut = '$nomorurutkurang2' and uraian_pemeliharaan ='$uraian_pemeliharaan'"));
           $kodeRekening = $k.".".$l.".".$m.".".$n.".".$o;
           if($kondisiWarna != 'red'){
              $keterangan = $getDataKoreksi['keterangan'];
              $kodeRekening = $getDataKoreksi['k'].".".$getDataKoreksi['l'].".".$getDataKoreksi['m'].".".$getDataKoreksi['n'].".".$getDataKoreksi['o'];
           }
           $Koloms.= "<td class='$cssclass' style='color:$kondisiWarna ;' align='left'>$uraian_pemeliharaan <input type='hidden' id='hiddenKodeRekeningKoreksi$id_anggaran' value='$kodeRekening'><input type='hidden' id='hiddenNamaRekeningKoreksi$id_anggaran' value='$keterangan'></span> /<br><span id='spanNamaRekeningKoreksi$id_anggaran'>$keterangan</span></td>";
           ...
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($getJumlahBarangPertama['jumlah1'],0,',','.')."</td>";
           $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>".$getJumlahBarangPertama['satuan1']."</td>";
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($getJumlahBarangPertama['jumlah2'],0,',','.')."</td>";
           $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>".$getJumlahBarangPertama['satuan2']."</td>";
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>".number_format($jumlahBarangPertama,0,',','.')."</td>";
           $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>".$getJumlahBarangPertama['satuan_barang']."</td>";

          // $Koloms.= "<td class='$cssclass' align='left'>".$keterangan."</td>";
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'><input type='hidden' id='hiddenJumlah$id_anggaran' value='$jumlah1'> ".number_format($jumlah1,0,',','.')."</td>";
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'><input type='hidden' id='hiddenKuantiti$id_anggaran' value='$jumlah2' style='vertical-align:middle;'> ".number_format($jumlah2,0,',','.')."</td>";
           $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'><input type='hidden' id='volumeBarang$id_anggaran' value='$volume_barang' style='vertical-align:middle;'>".number_format($volume_barang,0,',','.')."</td>";
           ...
           $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='right' style='vertical-align:middle;'><span id='spanJumlah$id_anggaran' style='vertical-align:middle;'>".number_format($getDataKoreksi['jumlah1'],0,',','.')." </span>  </td>";
           $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='right' style='vertical-align:middle;'><span id='spanKuantiti$id_anggaran' style='vertical-align:middle;'>".number_format($getDataKoreksi['jumlah2'],0,',','.')." </span>  </td>";
           $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='right' style='vertical-align:middle;'><span id='spanVolume$id_anggaran' style='vertical-align:middle;'>".number_format($getDataKoreksi['jumlah1'] * $getDataKoreksi['jumlah2'],0,',','.')." </span>  </td>";
           ...
           $Koloms.= "<td class='$cssclass' id='updatePengguna$id_anggaran' align='center'><span id='save$id_anggaran' style='vertical-align:middle;'>$aksi</span></td>";
         }


         $this->lastUrutan = $urut;
        $Koloms = array(
              array("Y", $Koloms),
             );
...
function Pemeliharaan4($xls =FALSE){
    ...
    $getPenggunaBarang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='00' and e1='$e1'"));
    ...
    echo "
                ...
                <thead>
                  <tr>
                    ...
                    <th class='th01' rowspan='3' style='width: 14%;'>KUASA PENGGUNA BARANG/<br>PROGRAM/<br>KEGIATAN/<br>OUTPUT</th>
    ...
    while($daqry = mysql_fetch_array($aqry)){
      ...
      if($p == '0'){
        ...
        $nomorurutSetelahnya = $this->nomorUrut ;
...
function Pemeliharaan5($xls =FALSE){
    ...
    while($daqry = mysql_fetch_array($aqry)){
      ...
      if($p == '0'){
        ...
        $nomorr = $this->nomorUrut -1;
        $getnomorr = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck ='$ck' and dk ='$dk' and p = '$p' and q= '$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and no_urut='$nomorr' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
        $isinomorr = number_format($getnomorr['volume_barang'],0,'.',',');

      }
      if ($p == '0') {
        $namaProgram = "<td align='left' class='GarisCetak' colspan='15'>".$programKegiatan."</td>";
        ...
        $namaKegiatan = "<td align='left' style='padding-left: 10px;' class='GarisCetak' colspan='15'>".$programKegiatan." </td>";
        ...
        $namaKegiatan2 = "<td align='left' style='padding-left: 15px;' class='GarisCetak' colspan='15'>".$programKegiatan."</br>OUTPUT : $outputan </td>";
      }
      ...
      ";
        ...
        "
                <tr valign='top'>
                  ...
                  <td align='right' class='GarisCetak'><span style='float: left;'>(".number_format($getJumlahBarangSetelahnya['jumlah1'],0,'.',',')." x ".number_format($getJumlahBarangSetelahnya['jumlah2'],0,'.',',').")</span><br> $volumeBarangSetelahnya</td>
                  <td align='left' class='GarisCetak'>$satuan_barang</td>
                  <td align='right' class='GarisCetak'><span style='float: left;'>($jumlah1 x $jumlah2)</span><br> $volBar</td>
                  <td align='left' class='GarisCetak'>$satuan_barang</td>
                  <td align='left' class='GarisCetak'>$catatan</td>
                </tr>
      ";
    ...
    echo "
          ...
          <table table width='100%' class='cetak' border='1' style='width: 70%;'>
            <tr>
              <th class='th01'>No</th>
              <th class='th01' style='width: 195;'>Nama</th>
              <th class='th01'>Jabatan</th>
              <th class='th01' style='width: 125px;'>TTD / Paraf</th>
              <th class='th01' >Tanggal</th>
            </tr>
            <tr>
    ...
    echo "
                ...
                <thead>
                  ...
                  <tr>
                    ...
                    <th class='th01' rowspan='2' style='width: 4%'>JUMLAH</th>
                    <th class='th01' rowspan='2' style='width: 4%'>SATUAN</th>
                    <th class='th01' rowspan='2' style='width: 4%;'>STATUS<br>BARANG</th>
                    <th class='th02' rowspan='1' colspan='3' >KONDISI BARANG</th>
                    <th class='th01' rowspan='2' >NAMA PEMELIHARAAN</th>
                    <th class='th01' rowspan='2' style='width: 4%'>JUMLAH</th>
                    <th class='th01' rowspan='2' style='width: 4%'>SATUAN</th>
      ...
      ";
        ...
        "
                <tr valign='top'>
                  ...
                  <td align='right' class='GarisCetak'>$kb</td>
                  <td align='right' class='GarisCetak'>$rb</td>
                  <td align='left' class='GarisCetak'>$uraian_pemeliharaan <span style='float: right;'>(".number_format($getJumlahBarangSetelahnya['jumlah1'],0,'.',',')." x ".number_format($getJumlahBarangSetelahnya['jumlah2'],0,'.',',').")</span></td>
                  <td align='right' class='GarisCetak'>$volumeBarangSetelahnya</td>
                  <td align='left' class='GarisCetak'>$satuan_barang</td>
                  <td align='left' class='GarisCetak'>$catatan</td>
                </tr>
...
function Pemeliharaan7($xls =FALSE){
    ...
    echo "
                ...
                <thead>
                  <tr>
                    <th class='th01' rowspan='3' style='width:20px;' >NO</th>
                    <th class='th01' rowspan='3' >PENGGUNA BARANG/<br>PROGRAM/<br>KEGIATAN/<br>OUTPUT</th>
                    <th class='th02' rowspan='1' colspan='8' >BARANG YANG DIPELIHARA</th>
                    <th class='th02' rowspan='1' colspan='3' >RENCANA KEBUTUHAN PEMELIHARAAN BMD YANG DISETUJUI</th>
...
function excel($dt){
   ...
   $c1 = $dt['koreksiPengelolaPemeliharaanNewSkpdfmUrusan'];
   $c = $dt['koreksiPengelolaPemeliharaanNewSkpdfmSKPD'];
   $d = $dt['koreksiPengelolaPemeliharaanNewSkpdfmUNIT'];
   $e = $dt['koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT'];
   $e1 = $dt['koreksiPengelolaPemeliharaanNewSkpdfmSEKSI'];
  ...
  $TampilOpt =
      ...
      <td width=\"100%\" valign=\"top\">" .
        WilSKPD_ajxVW("koreksiPengelolaPemeliharaanNewSkpd") .
      "</td>
      <td >" .
      "</td></tr>
      <tr><td>
      <input type='hidden' name='cmbJeniskoreksiPengelolaPemeliharaanNew' id='cmbJeniskoreksiPengelolaPemeliharaanNew' value='PEMELIHARAAN'>
      </td></tr>
      </table>";
  ...
  function getDaftarOpsi($Mode=1){
    global $Main, $HTTP_COOKIE_VARS;
    $UID  = $_COOKIE['coID'];
    $c1   = $_REQUEST['koreksiPengelolaPemeliharaanNewSkpdfmUrusan'];
    $c    = $_REQUEST['koreksiPengelolaPemeliharaanNewSkpdfmSKPD'];
    $d    = $_REQUEST['koreksiPengelolaPemeliharaanNewSkpdfmUNIT'];
    $e    = $_REQUEST['koreksiPengelolaPemeliharaanNewSkpdfmSUBUNIT'];
    $e1   = $_REQUEST['koreksiPengelolaPemeliharaanNewSkpdfmSEKSI'];
    $fmKODE = $_REQUEST['fmKODE'];
    $fmBARANG = $_REQUEST['fmBARANG'];
    $cmbJeniskoreksiPengelolaPemeliharaanNew = $_REQUEST['cmbJeniskoreksiPengelolaPemeliharaanNew'];
    $arrKondisi = array();
    if(isset($e1)){
  ...
  function Laporan($dt,$c1,$c,$d,$e,$e1){
   ...
   $this->form_height = 100;
   $this->form_caption = 'LAPORAN RKBMD PEMELIHARAAN';
   $c1 = $dt['koreksiPengelolaPemeliharaanSkpdfmUrusan'];
   $c = $dt['koreksiPengelolaPemeliharaanSkpdfmSKPD'];
   $d = $dt['koreksiPengelolaPemeliharaanSkpdfmUNIT'];
   $e = $dt['koreksiPengelolaPemeliharaanSkpdfmSUBUNIT'];
   $e1 = $dt['koreksiPengelolaPemeliharaanSkpdfmSEKSI'];
    $arrayJenisLaporan = array(
                 // array('Pemeliharaan7', 'RKBMD PEMELIHARAAN PROVINSI/KABUPATEN/KOTA'),
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='koreksiPengelolaPemeliharaan.Close()' >";
...
$koreksiPengelolaPemeliharaanNew = new koreksiPengelolaPemeliharaanNewObj();
...
$koreksiPengelolaPemeliharaanNew->jenisForm = $jenisForm;
$koreksiPengelolaPemeliharaanNew->nomorUrut = $nomorUrut;
$koreksiPengelolaPemeliharaanNew->urutTerakhir = $nomorUrut;
$koreksiPengelolaPemeliharaanNew->tahun = $tahun;
$koreksiPengelolaPemeliharaanNew->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPemeliharaanNew->idTahap = $idTahap;
$koreksiPengelolaPemeliharaanNew->username = $_COOKIE['coID'];
$koreksiPengelolaPemeliharaanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPemeliharaanNew->wajibValidasi == TRUE){
  $koreksiPengelolaPemeliharaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
  $koreksiPengelolaPemeliharaanNew->sqlValidasi = " ";
}
$koreksiPengelolaPemeliharaanNew->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPemeliharaanNew->kota = $arrayResult['kota'];
$koreksiPengelolaPemeliharaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPemeliharaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPemeliharaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPemeliharaanNew->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPemeliharaanNew->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPemeliharaanNew->nipPejabat = $arrayResult['nipPejabat'];

$koreksiPengelolaPemeliharaanNew->statusPenetapan = checkPenetapanRKBMD($koreksiPengelolaPemeliharaanNew->tahun,$koreksiPengelolaPemeliharaanNew->jenisAnggaran,"PEMELIHARAAN");
