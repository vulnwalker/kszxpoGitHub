...
class koreksiPenggunaPemeliharaanObj  extends DaftarObj2{
	var $Prefix = 'koreksiPenggunaPemeliharaan';
	...
	var $PageTitle = 'RKBMD PEMELIHARAAN PENGGUNA BARANG';
	...
	var $FormName = 'koreksiPenggunaPemeliharaanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL4 = "pages.php?Pg=koreksiPenggunaPemeliharaan&tipe=Pemeliharaan4";
	var $reportURL5 = "pages.php?Pg=koreksiPenggunaPemeliharaan&tipe=Pemeliharaan5";
	var $reportURL6 = "pages.php?Pg=koreksiPenggunaPemeliharaan&tipe=Pemeliharaan6";
	var $statusPenetapan = "";

	function setTitle(){

		return 'RKBMD PEMELIHARAAN PENGGUNA BARANG';
	}
...
-->
		...
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		...
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PENGELOLA'  style='color : blue;'> PEMELIHARAAN </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaan\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPemeliharaan_v3\" title='RKBMD'   > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PENGELOLA' style='color : blue;' > KOREKSI </a>
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($koreksiPenggunaPemeliharaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPenggunaPemeliharaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPenggunaPemeliharaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPemeliharaanSkpdfmUrusan' and c = '$koreksiPenggunaPemeliharaanSkpdfmSKPD' and d='$koreksiPenggunaPemeliharaanSkpdfmUNIT' and e = '$koreksiPenggunaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPemeliharaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentkoreksiPenggunaPemeliharaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPenggunaPemeliharaan['c1'];
					$parentC = $getParentkoreksiPenggunaPemeliharaan['c'];
					$parentD = $getParentkoreksiPenggunaPemeliharaan['d'];
					$parentE = $getParentkoreksiPenggunaPemeliharaan['e'];
					$parentE1= $getParentkoreksiPenggunaPemeliharaan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPenggunaPemeliharaan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPemeliharaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPenggunaPemeliharaan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentkoreksiPenggunaPemeliharaan['c1'];
					$parentC = $getParentkoreksiPenggunaPemeliharaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPenggunaPemeliharaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPenggunaPemeliharaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getkoreksiPenggunaPemeliharaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPenggunaPemeliharaannya as $key => $value) {
				  $$key = $value;
			}
			...
			if($this->jenisForm !='KOREKSI PENGGUNA' && $this->jenisForm !='KOREKSI PENGELOLA'){
			...
			}elseif(checkPenetapanRKBMD($this->tahun,$this->jenisAnggaran,"PEMELIHARAAN",$c1,$c,$d) != 0 ){
				$err = "RKBMD TELAH DI TETAPKAN";
			}elseif(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$nextNomorUrut' and tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan ='$uraian_pemeliharaan'")) != 0){
			 ...
			 $dataSesuai = array(
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				...
				if($getkoreksiPenggunaPemeliharaannya['jumlah1'] < $angkaKoreksi ){
			  ...
			  if($err == ""){
						...
						if($cekKoreksi > 0 ){
							 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan ='$uraian_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
								...
								}elseif( $getkoreksiPenggunaPemeliharaannya['volume_barang'] >= $volumeKoreksi ) {
								...
								if( $getkoreksiPenggunaPemeliharaannya['volume_barang'] >= $volumeKoreksi )  {
									mysql_query(VulnWalkerInsert("tabel_anggaran", $dataSesuai));
									$cek = VulnWalkerInsert("tabel_anggaran", $dataSesuai);
	...
	function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPenggunaPemeliharaan.js' language='JavaScript' ></script>
			 <script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPemeliharaanNew.js' language='JavaScript' ></script>
	 ...
	 foreach ($isi as $key => $value) {
		  $$key = $value;
				...
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$tampilHeader = "<td class='$cssclass' align='left' colspan='19' style='vertical-align:middle;'><span $style>".$header."</span></td>";
					...
					$Koloms.= $tampilHeader;
					 ...
					 $Koloms.= "<td class='$cssclass' style='color:$kondisiWarna ;' align='left' style='vertical-align:middle;'>$uraian_pemeliharaan <input type='hidden' id='hiddenKodeRekeningKoreksi$id_anggaran' value='$kodeRekening'><input type='hidden' id='hiddenNamaRekeningKoreksi$id_anggaran' value='$keterangan'></span>  / <br><span id='spanNamaRekeningKoreksi$id_anggaran'>$keterangan</span></td>";
					 ...
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$satuan1</td>";
					 $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'><input type='hidden' id='hiddenKuantiti$id_anggaran' value='$jumlah2'>".number_format($jumlah2,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>$satuan2</td>";
					 $Koloms.= "<td class='$cssclass' align='right' style='vertical-align:middle;'>
					 		<input type='hidden' id='volumeBarang$id_anggaran' value='$volume_barang'>


					 		".number_format($volume_barang,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' style='vertical-align:middle;'>
					 		".$satuan_barang."</td>";
					 // $namaRekeningKoreksi = $getDataKoreksi['keterangan'];
					 // $Koloms.= "<td class='$cssclass' align='left'><span id='spanNamaRekeningKoreksi$id_anggaran'>$namaRekeningKoreksi</span></td>";
					 $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='$align' style='vertical-align:middle;'><span id='spanJumlah$id_anggaran' style='vertical-align:middle;'>".number_format($getDataKoreksi['jumlah1'],0,',','.')." </span>  </td>";
					 $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='$align' style='vertical-align:middle;'><span id='spanKuantiti$id_anggaran'>".number_format($getDataKoreksi['jumlah2'],0,',','.')." </span>  </td>";
					 $Koloms.= "<td class='$cssclass' id='alignKoreksi' align='$align' style='vertical-align:middle;'><span id='spanVolume$id_anggaran'>".number_format($getDataKoreksi['jumlah1'] * $getDataKoreksi['jumlah2'],0,',','.')." </span>  </td>";
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPemeliharaan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPemeliharaan.koreksi('$id_anggaran');></img> ";
					 $Koloms.= "<td class='$cssclass'  id='updatePengguna$id_anggaran' align='center' style='vertical-align:middle;'><span id='save$id_anggaran'>$aksi</span></td>";
				 }
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("koreksiPenggunaPemeliharaanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPenggunaPemeliharaan' id='cmbJeniskoreksiPenggunaPemeliharaan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['koreksiPenggunaPemeliharaanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPenggunaPemeliharaanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPenggunaPemeliharaanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPenggunaPemeliharaanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPenggunaPemeliharaanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPenggunaPemeliharaan = $_REQUEST['cmbJeniskoreksiPenggunaPemeliharaan'];
		$arrKondisi = array();
		if(isset($e1)){
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['koreksiPenggunaPemeliharaanSkpdfmUrusan'];
	 $c = $dt['koreksiPenggunaPemeliharaanSkpdfmSKPD'];
	 $d = $dt['koreksiPenggunaPemeliharaanSkpdfmUNIT'];
	 $e = $dt['koreksiPenggunaPemeliharaanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPenggunaPemeliharaanSkpdfmSEKSI'];
...
function Pemeliharaan4($xls =FALSE){
    ...
    $arrayTandaTangan4 = explode(';', $getJenisReport4['tanda_tangan']);
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' $this->kondisiBarang $jenisSKPD")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
			$grabKegiatan = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q!='0' and j='000'");
				while($row2s = mysql_fetch_array($grabKegiatan)){
					foreach ($row2s as $key => $value) {
						  $$key = $value;
					}
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang $jenisSKPD ")) == 0){
						if($q != '0'){
							$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
							$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p,'.',q) !='$concat'";
						}
					}else{
						$grabBarang = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang");
						while($row3s = mysql_fetch_array($grabBarang)){
							foreach ($row3s as $key => $value) {
								  $$key = $value;
							}
							$concat = $f.".".$g.".".$h.".".$i.".".$j;
							if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' $this->kondisiBarang $jenisSKPD ")) == 0){
								if($j != '000'){
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and  uraian_pemeliharaan !='RKBMD PENGADAAN' and  uraian_pemeliharaan !='RKBMD PERSEDIAAN'  $this->kondisiBarang  $Kondisi order by urut";
			...
			$grabKegiatan = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q!='0' and j='000'");
				while($row2s = mysql_fetch_array($grabKegiatan)){
					...
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang $jenisSKPD ")) == 0){
						...
						$grabBarang = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !='RKBMD PENGADAAN' and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000'");
						while($row3s = mysql_fetch_array($grabBarang)){
							foreach ($row3s as $key => $value) {
								  $$key = $value;
							}
...
$koreksiPenggunaPemeliharaan = new koreksiPenggunaPemeliharaanObj();
...
$koreksiPenggunaPemeliharaan->jenisForm = $jenisForm;
$koreksiPenggunaPemeliharaan->nomorUrut = $nomorUrut;
$koreksiPenggunaPemeliharaan->urutTerakhir = $nomorUrut;
$koreksiPenggunaPemeliharaan->tahun = $tahun;
$koreksiPenggunaPemeliharaan->jenisAnggaran = $jenisAnggaran;
$koreksiPenggunaPemeliharaan->idTahap = $idTahap;
$koreksiPenggunaPemeliharaan->username = $_COOKIE['coID'];
$koreksiPenggunaPemeliharaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPenggunaPemeliharaan->wajibValidasi == TRUE){
	$koreksiPenggunaPemeliharaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPenggunaPemeliharaan->sqlValidasi = " ";
}
$koreksiPenggunaPemeliharaan->provinsi = $arrayResult['provinsi'];
$koreksiPenggunaPemeliharaan->kota = $arrayResult['kota'];
$koreksiPenggunaPemeliharaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPenggunaPemeliharaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPenggunaPemeliharaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPenggunaPemeliharaan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPenggunaPemeliharaan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPenggunaPemeliharaan->nipPejabat = $arrayResult['nipPejabat'];

$koreksiPenggunaPemeliharaan->statusPenetapan = checkPenetapanRKBMD($koreksiPenggunaPemeliharaan->tahun,$koreksiPenggunaPemeliharaan->jenisAnggaran,"PEMELIHARAAN");
