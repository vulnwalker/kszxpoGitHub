<?php
class koreksiPemeliharaanNewObj  extends DaftarObj2{
  var $Prefix = 'koreksiPemeliharaanNew';
  ...
  var $FormName = 'koreksiPemeliharaanNewForm';
  var $kode_skpd = '';
  var $modul = "RKBMD";
  var $jenisForm = "";
  var $tahun = "";
  ...
  // var $reportURL1 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan1";
  var $reportURL2 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan2";
  var $reportURL3 = "pages.php?Pg=koreksiPemeliharaanNew&tipe=Pemeliharaan3";
   ...
   $cek = ''; $err=''; $content=''; $json=TRUE;
    ...
    case 'Laporan':{
      foreach ($_REQUEST as $key => $value) {
       ...
       if($koreksiPemeliharaanNewSkpdfmUrusan =='0'){
        $err = "Pilih Urusan";
       }elseif($koreksiPemeliharaanNewSkpdfmSKPD =='00'){
        $err = "Pilih Bidang";
       }elseif($koreksiPemeliharaanNewSkpdfmUNIT =='00'){
        $err = "Pilih SKPD";
       }elseif($koreksiPemeliharaanNewSkpdfmSUBUNIT =='00'){
        $err = "Pilih Unit";
       }elseif($koreksiPemeliharaanNewSkpdfmSEKSI =='000'){
        $err = "Pilih Sub Unit";
       }else{
    ...
    case 'newTab':{
       ...
       $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPemeliharaanNewSkpdfmSKPD' and d='$koreksiPemeliharaanNewSkpdfmUNIT' and e = '$koreksiPemeliharaanNewSkpdfmSUBUNIT' and e1='$koreksiPemeliharaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
       $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPemeliharaanNewSkpdfmSKPD' and d='$koreksiPemeliharaanNewSkpdfmUNIT' and e = '$koreksiPemeliharaanNewSkpdfmSUBUNIT' and e1='$koreksiPemeliharaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
       $lastID = $getDatarenja['id_anggaran'];
       $parentC1 = $koreksiPemeliharaanNewSkpdfmUrusan;
         $parentC = $koreksiPemeliharaanNewSkpdfmSKPD;
       $parentD = $koreksiPemeliharaanNewSkpdfmUNIT;
       $parentE = $koreksiPemeliharaanNewSkpdfmSUBUNIT;
       $parentE1= $koreksiPemeliharaanNewSkpdfmSEKSI;
       if($cekKeberadaanMangkluk == 0){
         $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPemeliharaanNewSkpdfmSKPD' and d='$koreksiPemeliharaanNewSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
         $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPemeliharaanNewSkpdfmSKPD' and d='$koreksiPemeliharaanNewSkpdfmUNIT' and e = '00' and e1='000' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
         $lastID = $getDatarenja['id_anggaran'];
         $parentE = '00';
         $parentE1= '000';
        ...
        if($cekKeberadaanMangkluk != 0){
          if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
            $getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPemeliharaanNewSkpdfmUrusan' and c = '$koreksiPemeliharaanNewSkpdfmSKPD' and d='$koreksiPemeliharaanNewSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
            if($getJumlahRenjaValidasi == 0){
              $err = "Renja Belum Di Validasi";
            }
          }

          $getParentkoreksiPemeliharaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
    ...
    case 'editTab':{
       $id = $_REQUEST['koreksiPemeliharaanNew_cb'];
      foreach ($_REQUEST as $key => $value) {
          $$key = $value;
       }
          $nomorUrutSebelumnya = $this->nomorUrut - 1;
          $getParentkoreksiPemeliharaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
          foreach ($getParentkoreksiPemeliharaanNew as $key => $value) {
             $$key = $value;
           }
          $parentC1 = $getParentkoreksiPemeliharaanNew['c1'];
          $parentC = $getParentkoreksiPemeliharaanNew['c'];
          $parentD = $getParentkoreksiPemeliharaanNew['d'];
          $parentE = $getParentkoreksiPemeliharaanNew['e'];
          $parentE1= $getParentkoreksiPemeliharaanNew['e1'];
    ...
    case 'SaveValid':{
       ...
       $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPemeliharaanNew_idplh'"));
       ...
       $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPemeliharaanNew_idplh'");
       mysql_query($query);
    ...
    case 'koreksi':{
      ...
      $getkoreksiPemeliharaanNewnya = mysql_fetch_array(mysql_query($queryRows));
      foreach ($getkoreksiPemeliharaanNewnya as $key => $value) {
          $$key = $value;
      }
       ...
       $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
        ...
        if($cekKoreksi > 0 ){
           $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
            ...
            if( $getkoreksiPemeliharaanNewnya['volume_barang'] >= $angkaKoreksi ) {
              mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
            }elseif($getkoreksiPemeliharaanNewnya['volume_barang'] < $angkaKoreksi){
...
function Pemeliharaan2($xls =FALSE){
    ...
    echo "
                ...
                <thead>
                  <tr>
                    ...
                    <th class='th01' rowspan='3' style='width: 5%;'>PROGRAM/<br>KEGIATAN/<br>OUTPUT</th>
                  ...
                  <tr>
                    ...
                    <th class='th01' rowspan='2' colspan='2' style='width: 4%;'>SATUAN</th>
    ...
    while($daqry = mysql_fetch_array($aqry)){
      ...
      ";
        ...
        $nomorurutplus = $no_urut+1;
        $getjumalhkoreksi = mysql_fetch_array(mysql_query("SELECT * from view_rkbmd where no_urut = '$nomorurutplus' and tahun = '$this->tahun' and jenis_anggaran = 'MURNI' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan'  and uraian_pemeliharaan ='$uraian_pemeliharaan'"));
        $naonkitu =
        "
                <tr valign='top'>
                  <td align='$align' class='GarisCetak'></td>
                  ...
                  <td align='left' class='GarisCetak'>$satuan_barang</td>
                  <td align='right' class='GarisCetak'><span style='float: left;'>(".$getjumalhkoreksi['jumlah1']." x ".$getjumalhkoreksi['jumlah2'].")</span><br> $volumeBarangSetelahnya</td>
                  <td align='left' class='GarisCetak'>$satuan_barang</td>
      ...
      ";
        ...
        "
                <tr valign='top'>
                  <td align='$align' class='GarisCetak'></td>
                  <td align='left' class='GarisCetak' colspan='1'></td>
                  <td align='left' class='GarisCetak' colspan='2'>".$kodeBarang." <span style='float: right;'>($jumlah1 x $jumlah2)</span><br>".$namaBarang."</td>
                  <td align='left' class='GarisCetak' >$volBar</td>
                  <td align='left' class='GarisCetak' >".$satuan_barang."</td>
                  <td align='center' class='GarisCetak' >$status_barang</td>
                  <td align='right' class='GarisCetak'>$b</td>
                  <td align='right' class='GarisCetak'>$kb</td>
...
function Laporan($dt){
   ...
   if($e1 != '000'){
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='koreksiPenggunaPemeliharaan.Close()' >";
...
$koreksiPemeliharaanNew = new koreksiPemeliharaanNewObj();
$arrayResult = tahapPerencanaanV3($koreksiPemeliharaanNew->modul,"MURNI");
...
$koreksiPemeliharaanNew->jenisForm = $jenisForm;
$koreksiPemeliharaanNew->nomorUrut = $nomorUrut;
$koreksiPemeliharaanNew->urutTerakhir = $nomorUrut;
$koreksiPemeliharaanNew->tahun = $tahun;
$koreksiPemeliharaanNew->jenisAnggaran = $jenisAnggaran;
$koreksiPemeliharaanNew->idTahap = $idTahap;
$koreksiPemeliharaanNew->username = $_COOKIE['coID'];
$koreksiPemeliharaanNew->wajibValidasi =  $arrayResult['wajib_validasi'];
if($koreksiPemeliharaanNew->wajibValidasi == TRUE){
  $koreksiPemeliharaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
  $koreksiPemeliharaanNew->sqlValidasi = " ";
}

$koreksiPemeliharaanNew->provinsi = $arrayResult['provinsi'];
$koreksiPemeliharaanNew->kota = $arrayResult['kota'];
$koreksiPemeliharaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPemeliharaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPemeliharaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPemeliharaanNew->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPemeliharaanNew->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPemeliharaanNew->nipPejabat = $arrayResult['nipPejabat'];
$koreksiPemeliharaanNew->settingAnggaran = $arrayResult['settingAnggaran'];
?>