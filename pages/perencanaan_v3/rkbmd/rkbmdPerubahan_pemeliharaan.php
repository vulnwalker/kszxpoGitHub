<?php
class rkbmdPerubahan_pemeliharaan_v3Obj  extends DaftarObj2{
	var $Prefix = 'rkbmdPerubahan_pemeliharaan_v3';
	...
	var $FormName = 'rkbmdPerubahan_pemeliharaan_v3Form';
	var $noModul=14;
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPerubahan_pemeliharaan.js' language='JavaScript' ></script>".
	...
	if($hitungData > 1){
		...
		if($realConcat == $min){
			...
			$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_pemeliharaan_v3.subHapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_pemeliharaan_v3.moveList('$id');></img> ";
		}else{
	...
	function tabelPemeliharaan(){
		...
		while($dt = mysql_fetch_array($aqry)){
			...
			if($dt['id_jenis_pemeliharaan'] == '' || $dt['id_jenis_pemeliharaan'] == '0'){
				$action = "<img id='action$id' src='datepicker/save.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_pemeliharaan_v3.subSubSave('$id');>";
				...
				$action = "<img id='action$id' src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPerubahan_pemeliharaan_v3.subSubDel('$id');>";
			...
			$datanya.="
				...
				<tr class='row0'>
					<td class='GarisDaftar' align='right'><a onclick=rkbmdPerubahan_pemeliharaan_v3.subSubEdit($id) style='cursor:pointer;'>$no</a></td>
				...
				array("
					<table class='koptable' style='min-width:900px;' border='1'>
						<tr>
							...
							<th class='th01'>
								<span id='atasbutton'>
								<a href='javascript:rkbmdPerubahan_pemeliharaan_v3.$tujuan' id='linkAtasButton' /><img id='gambarAtasButton' src='$gambar' style='width:20px;height:20px;' /></a>
								</span>
							</th>
						</tr>
						$datanya
	...
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,'onchange=rkbmdPerubahan_pemeliharaan_v3.CekAda(); ','-- KEGIATAN --');
	$username = $_COOKIE['coID'];
	$matiButton = "";
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPerubahan_pemeliharaan_v3.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $matiButton >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<button type='button' id='findBarang' onclick=rkbmdPerubahan_pemeliharaan_v3.CariBarang('$filterSKPD'); > Cari </button>
									",
								),
							array(
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPerubahan_pemeliharaan_v3.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPerubahan_pemeliharaan_v3.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPerubahan_pemeliharaan_v3.finish()'>
...
$rkbmdPerubahan_pemeliharaan_v3 = new rkbmdPerubahan_pemeliharaan_v3Obj();

$arrayResult = tahapPerencanaanV3($rkbmdPerubahan_pemeliharaan_v3->modul,"PERUBAHAN");
...
$rkbmdPerubahan_pemeliharaan_v3->jenisForm = $jenisForm;
$rkbmdPerubahan_pemeliharaan_v3->nomorUrut = $nomorUrut;
$rkbmdPerubahan_pemeliharaan_v3->urutTerakhir = $nomorUrut;
$rkbmdPerubahan_pemeliharaan_v3->tahun = $tahun;
$rkbmdPerubahan_pemeliharaan_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPerubahan_pemeliharaan_v3->idTahap = $idTahap;
$rkbmdPerubahan_pemeliharaan_v3->username = $_COOKIE['coID'];
$rkbmdPerubahan_pemeliharaan_v3->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPerubahan_pemeliharaan_v3->wajibValidasi == TRUE){
	$rkbmdPerubahan_pemeliharaan_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPerubahan_pemeliharaan_v3->sqlValidasi = " ";
}
