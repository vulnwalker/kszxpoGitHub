...
class rkbmdPengadaan_v3Obj  extends DaftarObj2{
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPengadaan_v3&tipe=Pengadaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPengadaan_v3&tipe=Pengadaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPengadaan_v3&tipe=Pengadaan3";
	...
	<!--	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD'  style='color : blue;' > INPUT </a> |
	...
	case 'formBaru':{
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
					...
					$parentDK = $getParentrkbmdPengadaan_v3['dk'];
	   ...
	   case 'remove':{
			...
			if(checkPenetapanRKBMD($this->tahun,$this->jenisAnggaran,"PENGADAAN",$getDataSKPD['c1'],$getDataSKPD['c'],$getDataSKPD['d']) != 0 ){
...
function Pengadaan2($xls =FALSE){
        ...
        $namaKegiatan = "<td align='left' style='padding-left: 10px;' class='GarisCetak' colspan='12'>".$programKegiatan."</br>OUTPUT : $outputan </td>";
      }else{
        $namaProgram = "<td align='left' class='GarisCetak' colspan='12'>".$programKegiatan."</td>";
      }
