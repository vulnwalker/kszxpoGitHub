...
function Pemeliharaan14($xls =FALSE){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and no_urut = '3' and jenis_anggaran = 'PERUBAHAN' and tahun ='$this->tahun' "));
