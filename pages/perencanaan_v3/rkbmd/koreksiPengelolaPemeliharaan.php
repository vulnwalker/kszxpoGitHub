...
class koreksiPengelolaPemeliharaanObj  extends DaftarObj2{
	var $Prefix = 'koreksiPengelolaPemeliharaan';
	...
	var $FormName = 'koreksiPengelolaPemeliharaanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL7 = "pages.php?Pg=koreksiPengelolaPemeliharaan&tipe=Pemeliharaan7";
...
-->
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaan\" title='RKBMD PENGELOLA'  style='color : blue;'> PEMELIHARAAN </a> |
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($koreksiPengelolaPemeliharaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPemeliharaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPemeliharaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPemeliharaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPemeliharaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentkoreksiPengelolaPemeliharaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPemeliharaan['c1'];
					$parentC = $getParentkoreksiPengelolaPemeliharaan['c'];
					$parentD = $getParentkoreksiPengelolaPemeliharaan['d'];
					$parentE = $getParentkoreksiPengelolaPemeliharaan['e'];
					$parentE1= $getParentkoreksiPengelolaPemeliharaan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPemeliharaan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPemeliharaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPemeliharaan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentkoreksiPengelolaPemeliharaan['c1'];
					$parentC = $getParentkoreksiPengelolaPemeliharaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPemeliharaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPemeliharaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPemeliharaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPemeliharaannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $melebihi = "Kebutuhan Riil";
					...
					if($getkoreksiPengelolaPemeliharaannya['jumlah1'] < $angkaKoreksi ){
					...
					if($err == ""){
						...
						if($cekKoreksi > 0 ){
							 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and uraian_pemeliharaan = '$uraian_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
								...
								if( $getkoreksiPengelolaPemeliharaannya['volume_barang'] >= $volumeKoreksi ) {
								...
								}elseif($getkoreksiPengelolaPemeliharaannya['volume_barang'] < $volumeKoreksi){
	...
	function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPemeliharaan.js' language='JavaScript' ></script>
...
function excel($dt){
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("koreksiPengelolaPemeliharaanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPemeliharaan' id='cmbJeniskoreksiPengelolaPemeliharaan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['koreksiPengelolaPemeliharaanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPemeliharaanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPemeliharaanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPemeliharaanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPemeliharaanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPemeliharaan = $_REQUEST['cmbJeniskoreksiPengelolaPemeliharaan'];
		$arrKondisi = array();
		if(isset($e1)){
...
$koreksiPengelolaPemeliharaan = new koreksiPengelolaPemeliharaanObj();
...
$koreksiPengelolaPemeliharaan->jenisForm = $jenisForm;
$koreksiPengelolaPemeliharaan->nomorUrut = $nomorUrut;
$koreksiPengelolaPemeliharaan->urutTerakhir = $nomorUrut;
$koreksiPengelolaPemeliharaan->tahun = $tahun;
$koreksiPengelolaPemeliharaan->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPemeliharaan->idTahap = $idTahap;
$koreksiPengelolaPemeliharaan->username = $_COOKIE['coID'];
$koreksiPengelolaPemeliharaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPemeliharaan->wajibValidasi == TRUE){
	$koreksiPengelolaPemeliharaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPemeliharaan->sqlValidasi = " ";
}
$koreksiPengelolaPemeliharaan->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPemeliharaan->kota = $arrayResult['kota'];
$koreksiPengelolaPemeliharaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPemeliharaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPemeliharaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPemeliharaan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPemeliharaan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPemeliharaan->nipPejabat = $arrayResult['nipPejabat'];

$koreksiPengelolaPemeliharaan->statusPenetapan = checkPenetapanRKBMD($koreksiPengelolaPemeliharaan->tahun,$koreksiPengelolaPemeliharaan->jenisAnggaran,"PEMELIHARAAN");
