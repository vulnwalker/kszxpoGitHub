...
/*			'' => array(
	...
	elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && !empty($fmSUBKELOMPOK) && !empty($fmSUBSUBKELOMPOK))
	{
	 ...
	 <tr>
	   ...
	   <th class='th01' align='left' width='50'>KODE BARANG</th>
	   <th class='th01' align='left' width='400'>NAMA BARANG</th>

	   <th class='th01' align='left' width='200'>JENIS</th>
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($isi['j'] == '000'){
 	 ...
 	 $Koloms[] = array('align="left" ',"<a style='cursor:pointer;' onclick = popupBarangRKBMD_v3.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
	 $getNamaJenisObyek = mysql_fetch_array(mysql_query("select * from ref_barang where f='$f' and g='00' and h='00' and i='00' and j='000'"));
	 $getNamaObyek = mysql_fetch_array(mysql_query("select * from ref_barang where f='$f' and g='$g' and h='00' and i='00' and j='000'"));
	 $getNamaRincianObyek = mysql_fetch_array(mysql_query("select * from ref_barang where f='$f' and g='$g' and h='$h' and i='00' and j='000'"));
	 $getNamaSubRincianObyek = mysql_fetch_array(mysql_query("select * from ref_barang where f='$f' and g='$g' and h='$h' and i='$i' and j='000'"));
	 $Koloms[] = array('align="left" ',$getNamaJenisObyek['nm_barang']);
