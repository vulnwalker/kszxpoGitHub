...
class koreksiPengelolaPersediaanNewObj  extends DaftarObj2{
	var $Prefix = 'koreksiPengelolaPersediaanNew';
	...
	var $FormName = 'koreksiPengelolaPersediaanNewForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
  ...
  var $reportURL4 = "pages.php?Pg=koreksiPersediaanNew&tipe=Persediaan4";
  var $reportURL5 = "pages.php?Pg=koreksiPersediaanNew&tipe=Persediaan5";
  var $reportURL6 = "pages.php?Pg=koreksiPersediaanNew&tipe=Persediaan6";
	var $reportURL7 = "pages.php?Pg=koreksiPengelolaPersediaanNew&tipe=Persediaan7";
	var $statusPenetapan ="";
  ...
  $oldy=mysql_fetch_array(
   ...
   if( $err=='' && $kategori =='' ) $err= 'Kategori Belum Di Pilih !!';
      ...
      if($err=='' && $oldy['cnt']>0) $err="NIP '$nippegawai' Sudah Ada";
        if($err==''){
          ...
          $jenisKegiatan = $_REQUEST['jenisKegiatan'];
            if($jenisKegiatan == "Persediaan4" || $jenisKegiatan == "Persediaan6"){
              $kategorinaey = 1;
            }else{
              $kategorinaey = 2;
            }
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPersediaanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
		...
		<A href=\"pages.php?Pg=koreksiPengelolaPersediaanNew\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($koreksiPengelolaPersediaanNewSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPersediaanNewSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPersediaanNewSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPersediaanNewSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPersediaanNewSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanNewSkpdfmSKPD' and d='$koreksiPengelolaPersediaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanNewSkpdfmSKPD' and d='$koreksiPengelolaPersediaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanNewSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanNewSkpdfmSKPD' and d='$koreksiPengelolaPersediaanNewSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentkoreksiPengelolaPersediaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPersediaanNew['c1'];
					$parentC = $getParentkoreksiPengelolaPersediaanNew['c'];
					$parentD = $getParentkoreksiPengelolaPersediaanNew['d'];
					$parentE = $getParentkoreksiPengelolaPersediaanNew['e'];
					$parentE1= $getParentkoreksiPengelolaPersediaanNew['e1'];
					...
					if($cmbJeniskoreksiPengelolaPersediaanNew == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPersediaanNew_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPersediaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPersediaanNew as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentkoreksiPengelolaPersediaanNew['c1'];
					$parentC = $getParentkoreksiPengelolaPersediaanNew['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPersediaanNew_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPersediaanNew_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPersediaanNewnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPersediaanNewnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPengelolaPersediaanNewnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPengelolaPersediaanNewnya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPersediaanNew.js' language='JavaScript' ></script>".
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	 ...
	 foreach ($isi as $key => $value) {
	   ...
	   if($this->jenisForm=="PENYUSUNAN"){
				...
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					if($this->wajibValidasi==TRUE)$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
				 }elseif($p!= '0' && $q=='0'){
					...
					if($this->wajibValidasi==TRUE)$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
					 ...
					 $Koloms.= "<td class='$cssclass' align='center' valign='middle'>$no</td>";
					 $Koloms.= "<td class='$cssclass' align='center' valign='middle'></td>";
					 $Koloms.= $tampilHeader;
					 $Koloms.= "<td class='$cssclass' align='left' valign='middle' valign='middle'>$namaBarang</td>";
					 $Koloms.= "<td class='$cssclass' align='right' valign='middle' valign='middle'>".number_format($volume_barang,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' valign='middle' valign='middle'>$satuan_barang</td>";
					 $Koloms.= "<td class='$cssclass' align='right' valign='middle' valign='middle'>".number_format($kebutuhanRiil,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='right' valign='middle' valign='middle'>".number_format($kebutuhanMax,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='right' valign='middle' valign='middle'>".number_format($jumlahOptimal,0,',','.')."</td>";
					 $Koloms.= "<td class='$cssclass' align='left' valign='middle' valign='middle'>$catatan</td>";
					 ...
					 if($this->wajibValidasi==TRUE){
					 	$Koloms.= "<td class='$cssclass' align='center'  valign='middle'>"."<img src='images/administrator/images/$validnya' width='20px' heigh='20px' style='cursor:pointer;'  onclick=$this->Prefix.Validasi('$id_anggaran');> "."</td>";
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPersediaanNew.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPersediaanNew.koreksi('$id_anggaran');></img>";
	   		...
	   		if($this->jenisFormTerakhir == "PENYUSUNAN"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						if($this->wajibValidasi==TRUE)$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
						 ...
						 $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
						 $Koloms.= $tampilHeader;
						 $Koloms.= "<td class='$cssclass' align='left' valign='middle'>$namaBarang</td>";
						 $Koloms.= "<td class='$cssclass' align='right' valign='middle'>".number_format($volume_barang,0,',','.')."</td>";
						 $Koloms.= "<td class='$cssclass' align='left' valign='middle'>$satuan_barang</td>";
						 $Koloms.= "<td class='$cssclass' align='right' valign='middle'>".number_format($kebutuhanRiil,0,',','.')."</td>";
						 $Koloms.= "<td class='$cssclass' align='right' valign='middle'>".number_format($kebutuhanMax,0,',','.')."</td>";
						 $Koloms.= "<td class='$cssclass' align='right' valign='middle'>".number_format($jumlahOptimal,0,',','.')."</td>";
			...
			elseif($this->jenisFormTerakhir == "KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
						 ...
						 $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
						 $Koloms.= $tampilHeader;
						 $Koloms.= "<td class='$cssclass' align='left' valign='middle' ><span style='color:black;'>$namaBarang</span></td>";
						 ...
						 $Koloms.= "<td class='$cssclass' align='left' valign='middle'>$caraPemenuhan </td>";
			...
			elseif($this->jenisFormTerakhir == "KOREKSI PENGELOLA"){
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left' valign='middle'></td>";
						 ...
						 $Koloms.= "<td class='$cssclass' align='right' valign='middle'>".number_format($getDataDuaTahapSebelumnya['volume_barang'],0,',','.')."</td>";
	...
	function Laporan($dt){
	 ...
	 $e1 = $dt['koreksiPengelolaPersediaanSkpdfmSEKSI'];
      ...
      <input type='button' value='TTD' onclick ='".$this->Prefix.".Baru()' title='TTD' >
			...
			"<input type='button' value='Batal' onclick ='koreksiPengelolaPersediaan.Close()' >";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("koreksiPengelolaPersediaanNewSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPersediaanNew' id='cmbJeniskoreksiPengelolaPersediaanNew' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['koreksiPengelolaPersediaanNewSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPersediaanNewSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPersediaanNewSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPersediaanNewSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPersediaanNewSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPersediaanNew = $_REQUEST['cmbJeniskoreksiPengelolaPersediaanNew'];
		$arrKondisi = array();
...
function Persediaan5($xls =FALSE){
    ...
    echo "
                ...
                <thead>
                  <tr>
                    ...
                    <th class='th01' rowspan='3'  style='width: 5%;'>CARA<br>PEMENUHAN</th>
    ...
    while($daqry = mysql_fetch_array($aqry)){
      ...
      if($p == '0'){
        ...
        $jumlahOptimal = number_format($jumlahOptimal,0,'.',',');
        $kebutuhanRill = number_format($kebutuhanRiil,0,'.',',');
        $nomorUrutSebelumnya = $lastNomorUrut + 2;
        $getDataSebelumnya = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '$nomorUrutSebelumnya' and tahun='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck ='$ck' and dk ='$dk' and p = '$p' and q= '$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'"));
        $jumlahBarangSebelumnya = $getDataSebelumnya['volume_barang'];
      ...
      ";
        ...
        "
                <tr valign='top'>
                  ...
                  <td align='right' class='GarisCetak'>$jumlahBarangSebelumnya</td>
                  <td align='left' class='GarisCetak' >".$satuan_barang."</td>
                  <td align='left' class='GarisCetak' >".$getDataSebelumnya[cara_pemenuhan]."</td>
                  <td align='left' class='GarisCetak' >".$catatan."</td>
                </tr>
      ";
      }
...
function excel($dt){
	 ...
	 $c1 = $dt['koreksiPengelolaPersediaanNewSkpdfmUrusan'];
	 $c = $dt['koreksiPengelolaPersediaanNewSkpdfmSKPD'];
	 $d = $dt['koreksiPengelolaPersediaanNewSkpdfmUNIT'];
	 $e = $dt['koreksiPengelolaPersediaanNewSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPengelolaPersediaanNewSkpdfmSEKSI'];
	 	$arrayJenisLaporan = array(
							   array('Persediaan7', 'RKBMD PERSEDIAAN PROVINSI/KABUPATEN/KOTA'),
...
$koreksiPengelolaPersediaanNew = new koreksiPengelolaPersediaanNewObj();
...
$koreksiPengelolaPersediaanNew->jenisForm = $jenisForm;
$koreksiPengelolaPersediaanNew->nomorUrut = $nomorUrut;
$koreksiPengelolaPersediaanNew->urutTerakhir = $nomorUrut;
$koreksiPengelolaPersediaanNew->tahun = $tahun;
$koreksiPengelolaPersediaanNew->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPersediaanNew->idTahap = $idTahap;
$koreksiPengelolaPersediaanNew->username = $_COOKIE['coID'];
$koreksiPengelolaPersediaanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPersediaanNew->wajibValidasi == TRUE){
	$koreksiPengelolaPersediaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPersediaanNew->sqlValidasi = " ";
}

$koreksiPengelolaPersediaanNew->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPersediaanNew->kota = $arrayResult['kota'];
$koreksiPengelolaPersediaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPersediaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPersediaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPersediaanNew->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPersediaanNew->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPersediaanNew->nipPejabat = $arrayResult['nipPejabat'];

$koreksiPengelolaPersediaanNew->statusPenetapan = checkPenetapanRKBMD($koreksiPengelolaPersediaanNew->tahun,$koreksiPengelolaPersediaanNew->jenisAnggaran,"PERSEDIAAN");
