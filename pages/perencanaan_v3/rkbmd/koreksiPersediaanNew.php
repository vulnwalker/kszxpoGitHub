<?php 
class koreksiPersediaanNewObj  extends DaftarObj2{
  var $Prefix = 'koreksiPersediaanNew';
  ...
  var $FormName = 'koreksiPersediaanNewForm';
  var $kode_skpd = '';
  var $modul = "RKBMD";
  var $jenisForm = "";
  var $tahun = "";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'koreksiPenggunaPersediaanSkpdfmUrusan'];
      $dt['c'] = $_REQUEST[$this->Prefix.'koreksiPenggunaPersediaanSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'koreksiPenggunaPersediaanSkpdfmUNIT'];
      $dt['e'] = $_REQUEST[$this->Prefix.'koreksiPenggunaPersediaanSkpdfmSUBUNIT'];
      $dt['e1'] = $_REQUEST[$this->Prefix.'koreksiPenggunaPersediaanSkpdfmSEKSI'];
      $fm = $this->setForm($dt);
    }
...
function set_selector_other2($tipe){
   ...
   $cek = ''; $err=''; $content=''; $json=TRUE;
    ...
    case 'excel':{
      foreach ($_REQUEST as $key => $value) {
       ...
       if($koreksiPersediaanNewSkpdfmUrusan =='0'){
        $err = "Pilih Urusan";
       }elseif($koreksiPersediaanNewSkpdfmSKPD =='00'){
        $err = "Pilih Bidang";
       }elseif($koreksiPersediaanNewSkpdfmUNIT =='00'){
        $err = "Pilih SKPD";
       }else{
  ...
  case 'formBaru':{
    ...
    case 'newTab':{
       ...
       $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPersediaanNewSkpdfmUrusan' and c = '$koreksiPersediaanNewSkpdfmSKPD' and d='$koreksiPersediaanNewSkpdfmUNIT' and e = '$koreksiPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPersediaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
       $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPersediaanNewSkpdfmUrusan' and c = '$koreksiPersediaanNewSkpdfmSKPD' and d='$koreksiPersediaanNewSkpdfmUNIT' and e = '$koreksiPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPersediaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
       $lastID = $getDatarenja['id_anggaran'];
        if($cekKeberadaanMangkluk != 0){
          if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
            $getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPersediaanNewSkpdfmUrusan' and c = '$koreksiPersediaanNewSkpdfmSKPD' and d='$koreksiPersediaanNewSkpdfmUNIT' and e = '$koreksiPersediaanNewSkpdfmSUBUNIT' and e1='$koreksiPersediaanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
            if($getJumlahRenjaValidasi == 0){
              $err = "Renja Belum Di Validasi";
            }
          }

          $getParentkoreksiPersediaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
          $parentC1 = $getParentkoreksiPersediaanNew['c1'];
          $parentC = $getParentkoreksiPersediaanNew['c'];
          $parentD = $getParentkoreksiPersediaanNew['d'];
          $parentE = $getParentkoreksiPersediaanNew['e'];
          $parentE1= $getParentkoreksiPersediaanNew['e1'];
          ...
          if($cmbJeniskoreksiPersediaanNew == 'PERSEDIAAN'){
            $kemana = 'ins_v3';
          }else{
    ...
    case 'editTab':{
       $id = $_REQUEST['koreksiPersediaanNew_cb'];
      foreach ($_REQUEST as $key => $value) {
          $$key = $value;
       }
          $nomorUrutSebelumnya = $this->nomorUrut - 1;
          $getParentkoreksiPersediaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
          foreach ($getParentkoreksiPersediaanNew as $key => $value) {
             $$key = $value;
           }
          $parentC1 = $getParentkoreksiPersediaanNew['c1'];
          $parentC = $getParentkoreksiPersediaanNew['c'];
    ...
    case 'SaveValid':{
       ...
       $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPersediaanNew_idplh'"));
       ...
       $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPersediaanNew_idplh'");
       mysql_query($query);
    ...
    case 'koreksi':{
      ...
      $getkoreksiPersediaanNewnya = mysql_fetch_array(mysql_query($queryRows));
      foreach ($getkoreksiPersediaanNewnya as $key => $value) {
          $$key = $value;
      }
       ...
       $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
        ...
        if($cekKoreksi > 0 ){
           $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
            ...
            }elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPersediaanNewnya['volume_barang'] >= $angkaKoreksi )  ){
              mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
            }elseif($getkoreksiPersediaanNewnya['volume_barang'] < $angkaKoreksi){
            ...
            if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) ) && $getkoreksiPersediaanNewnya['volume_barang'] >= $angkaKoreksi ){
  ...
  function Laporan($dt,$c1,$c,$d,$e,$e1){
   ...
   $e1 = $dt['koreksiPenggunaPersediaanSkpdfmSEKSI'];
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='koreksiPenggunaPersediaan.Close()' >";
  ...
  global $Main;
    ...
    $getAllParent = mysql_query("select * from view_rkbmd where  tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and f='00' and q !='0' and id_jenis_pemeliharaan = '0' and c1='$c1' and c='$c'  and d='$d'");
        while($rows = mysql_fetch_array($getAllParent)){
          ...
          $cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'  and f !='00' and f != '01' and f != '02' and f != '03' and f != '04' and f != '05' and f != '06' and id_jenis_pemeliharaan ='0' $this->kondisiBarang "));
          if($cekKegiatan == 0){
            $concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p.".".$q;
            $arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p,'.',q) != '$concat'";
            $cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and f !='00' and f != '01' and f != '02' and f != '03' and f != '04' and f != '05' and f != '06' and id_jenis_pemeliharaan ='0' $this->kondisiBarang"));
            if($cekProgram == 0){
              $concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p;
              $arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p) != '$concat'";
              $cekSKPD = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'  and f !='00' and f != '01' and f != '02' and f != '03' and f != '04' and f != '05' and f != '06' and id_jenis_pemeliharaan ='0' $this->kondisiBarang"));
              if($cekSKPD == 0){
                $concat = $c1.".".$c.".".$d.".".$e.".".$e1;
  ...
  function Persediaan6($xls =FALSE){
    ...
    echo "
                ...
                <thead>
                  <tr>
                    <th class='th01' rowspan='2' style='width:20px;' >NO</th>
                    <th class='th01' rowspan='2' >KUASA PENGGUNA BARANG/<br>PROGRAM/<br>KEGIATAN/<br>OUTPUT</th>
...
$koreksiPersediaanNew = new koreksiPersediaanNewObj();
...
$koreksiPersediaanNew->jenisForm = $jenisForm;
$koreksiPersediaanNew->nomorUrut = $nomorUrut;
$koreksiPersediaanNew->urutTerakhir = $nomorUrut;
$koreksiPersediaanNew->tahun = $tahun;
$koreksiPersediaanNew->jenisAnggaran = $jenisAnggaran;
$koreksiPersediaanNew->idTahap = $idTahap;
$koreksiPersediaanNew->username = $_COOKIE['coID'];
$koreksiPersediaanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPersediaanNew->wajibValidasi == TRUE){
  $koreksiPersediaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
  $koreksiPersediaanNew->sqlValidasi = " ";
}

$koreksiPersediaanNew->provinsi = $arrayResult['provinsi'];
$koreksiPersediaanNew->kota = $arrayResult['kota'];
$koreksiPersediaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPersediaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPersediaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPersediaanNew->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPersediaanNew->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPersediaanNew->nipPejabat = $arrayResult['nipPejabat'];
?>