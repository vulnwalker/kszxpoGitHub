...
class pemindahtangananNewObj  extends DaftarObj2{
  var $Prefix = 'pemindahtangananNew';
  ...
  var $FormName = 'pemindahtangananNewForm';
  var $kode_skpd = '';
  var $modul = "RKBMD";
  var $jenisForm = "";
  var $tahun = "";
  ...
  var $reportURL7 = "pages.php?Pg=pemindahtangananNew&tipe=Pengadaan7";
  var $statusPenetapan ="";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'rpebmdSkpdfmURUSAN'];
      $dt['c'] = $_REQUEST[$this->Prefix.'rpebmdSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'rpebmdSkpdfmUNIT'];
      $dt['e'] = $_REQUEST[$this->Prefix.'rpebmdSkpdfmSUBUNIT'];
      $dt['e1'] = $_REQUEST[$this->Prefix.'rpebmdSkpdfmSEKSI'];
      $fm = $this->setForm($dt);
    }
...
function simpan(){
  ...
  function setPage_HeaderOther(){
    ...
    <A href=\"pages.php?Pg=pemindahtangananNew\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
    ...
    <tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
    <A href=\"pages.php?Pg=pemindahtangananNew\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
   ...
   $cek = ''; $err=''; $content=''; $json=TRUE;
    ...
    case 'excel':{
      foreach ($_REQUEST as $key => $value) {
       ...
       /*if($pemindahtangananNewSkpdfmUrusan =='0'){
        $err = "Pilih Urusan";
       }elseif($pemindahtangananNewSkpdfmSKPD =='00'){
        $err = "Pilih Bidang";
       }elseif($pemindahtangananNewSkpdfmUNIT =='00'){
        $err = "Pilih SKPD";
       }elseif($pemindahtangananNewSkpdfmSUBUNIT =='00'){
        $err = "Pilih Unit";
       }elseif($pemindahtangananNewSkpdfmSEKSI =='000'){
        $err = "Pilih Sub Unit";
       }else{*/
  ...
  case 'formBaru':{       
    ...
    case 'newTab':{
       ...
       $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$pemindahtangananNewSkpdfmUrusan' and c = '$pemindahtangananNewSkpdfmSKPD' and d='$pemindahtangananNewSkpdfmUNIT' and e = '$pemindahtangananNewSkpdfmSUBUNIT' and e1='$pemindahtangananNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
       $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$pemindahtangananNewSkpdfmUrusan' and c = '$pemindahtangananNewSkpdfmSKPD' and d='$pemindahtangananNewSkpdfmUNIT' and e = '$pemindahtangananNewSkpdfmSUBUNIT' and e1='$pemindahtangananNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
       $lastID = $getDatarenja['id_anggaran'];
        if($cekKeberadaanMangkluk != 0){
          if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
            $getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$pemindahtangananNewSkpdfmUrusan' and c = '$pemindahtangananNewSkpdfmSKPD' and d='$pemindahtangananNewSkpdfmUNIT' and e = '$pemindahtangananNewSkpdfmSUBUNIT' and e1='$pemindahtangananNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
            if($getJumlahRenjaValidasi == 0){
              $err = "Renja Belum Di Validasi";
            }
          }

          $getParentpemindahtangananNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
          $parentC1 = $getParentpemindahtangananNew['c1'];
          $parentC = $getParentpemindahtangananNew['c'];
          $parentD = $getParentpemindahtangananNew['d'];
          $parentE = $getParentpemindahtangananNew['e'];
          $parentE1= $getParentpemindahtangananNew['e1'];
          ...
          if($cmbJenispemindahtangananNew == 'PENGADAAN'){
            $kemana = 'ins_v3';
          }else{
    ...
    case 'editTab':{
       $id = $_REQUEST['pemindahtangananNew_cb'];
      foreach ($_REQUEST as $key => $value) {
          $$key = $value;
       }
          $nomorUrutSebelumnya = $this->nomorUrut - 1;
          $getParentpemindahtangananNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
          foreach ($getParentpemindahtangananNew as $key => $value) {
             $$key = $value;
           }
          $parentC1 = $getParentpemindahtangananNew['c1'];
          $parentC = $getParentpemindahtangananNew['c'];
    ...
    case 'SaveValid':{
       ...
       $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$pemindahtangananNew_idplh'"));
       ...
       $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$pemindahtangananNew_idplh'");
       mysql_query($query);
    ...
    case 'koreksi':{
      ...
      $getpemindahtangananNewnya = mysql_fetch_array(mysql_query($queryRows));
      foreach ($getpemindahtangananNewnya as $key => $value) {
          $$key = $value;
      }
       ...
       $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
        ...
        if($cekKoreksi > 0 ){
           $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
            ...
            if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpemindahtangananNewnya['volume_barang'] >= $angkaKoreksi )  ){
              mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
            }elseif($getpemindahtangananNewnya['volume_barang'] < $angkaKoreksi){
...
/*    $nomorUrutSebelumnya = $this-> -1;*/
     ...
     elseif($this->jenisForm=="KOREKSI PENGGUNA"){
          ...
          if($f == '00' && $q =='0')$TampilCheckBox = "";
            ...
            $Koloms.= "<td class='$cssclass' align='left'></td>";
             ...
             $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=pemindahtangananNew.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=pemindahtangananNew.koreksi('$id_anggaran');></img>";
  ...
  function CetakSemua($dt,$c1,$c,$d,$e,$e1){
   ...
   $this->form_caption = 'LAPORAN RENCANA PEMINDAHTANGANAN';

   $c1 = $dt['rpebmdSkpdfmURUSAN'];
   $c = $dt['rpebmdSkpdfmSKPD'];
   $d = $dt['rpebmdSkpdfmUNIT'];
   $e = $dt['rpebmdSkpdfmSUBUNIT'];
   $e1 = $dt['rpebmdSkpdfmSEKSI'];

    $arrayJenisLaporan = array(
                 array('CetakSadayana', 'RENCANA PEMINDAHTANGANAN'),
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='rpebmd.Close()' >";
  ...
  function CetakHal($dt,$c1,$c,$d,$e,$e1){
   ...
   $e1 = $dt['rpebmdSkpdfmSEKSI'];
    ...
    $arrayJenisLaporan = array(
                 array('CetakPerHal', 'RENCANA PEMINDAHTANGANAN'),
  ...
  $TampilOpt =
      ...
      <td width=\"100%\" valign=\"top\">" .
        WilSKPD_ajxVW("pemindahtangananNewSkpd") .
      "</td>
      <td >" .
      "</td></tr>
      <tr><td>
      <input type='hidden' name='cmbJenispemindahtangananNew' id='cmbJenispemindahtangananNew' value='PENGADAAN'>
      </td></tr>
      </table>";
  ...
  function getDaftarOpsi($Mode=1){
    global $Main, $HTTP_COOKIE_VARS;
    $UID  = $_COOKIE['coID'];
    $c1   = $_REQUEST['pemindahtangananNewSkpdfmUrusan'];
    $c    = $_REQUEST['pemindahtangananNewSkpdfmSKPD'];
    $d    = $_REQUEST['pemindahtangananNewSkpdfmUNIT'];
    $e    = $_REQUEST['pemindahtangananNewSkpdfmSUBUNIT'];
    $e1   = $_REQUEST['pemindahtangananNewSkpdfmSEKSI'];
    if(isset($e1)){
    ...
    $fmKODE = $_REQUEST['fmKODE'];
    $fmBARANG = $_REQUEST['fmBARANG'];
    $cmbJenispemindahtangananNew = $_REQUEST['cmbJenispemindahtangananNew'];
    $arrKondisi = array();
  ...
  function CetakSadayana($xls =FALSE){
    ...
    ";
    $no = 1;
    $queryTrencanaPemanfaatan = mysql_query("SELECT * from t_rencana_pemindahtanganan where c1 = '".$_GET[urusan]."' and c = '".$_GET[bidang]."' and d = '".$_GET[skpd]."' and e = '".$_GET[unit]."' and e1 = '".$_GET[subunit]."' ");
    ...
    while ($isiTrencanaPemanfaatan = mysql_fetch_array($queryTrencanaPemanfaatan)) {
      ...
      $total = mysql_fetch_array(mysql_query("SELECT SUM(harga) from t_rencana_pemindahtanganan where c1 = '$isiTrencanaPemanfaatan[c1]' and c = '$isiTrencanaPemanfaatan[c]' and d = '$isiTrencanaPemanfaatan[d]' and e = '$isiTrencanaPemanfaatan[e]' and e1 = '$isiTrencanaPemanfaatan[e1]' "));
      $totalnaey = number_format($total['SUM(harga)'],2,',','.');

      if ($isiTrencanaPemanfaatan[bentuk_pemindahtanganan] == 1) {
        $pemindahtanganan = "Penjualan";
      }elseif ($isiTrencanaPemanfaatan[bentuk_pemindahtanganan] == 2) {
        $pemindahtanganan = "Tukar Menukar";
      }elseif ($isiTrencanaPemanfaatan[bentuk_pemindahtanganan] == 3) {
        $pemindahtanganan = "Hibah";
      }elseif ($isiTrencanaPemanfaatan[bentuk_pemindahtanganan] == 4) {
        $pemindahtanganan = "Penyertaan Modal";
      }
      ...
      "
            <tr valign='top'>
              ...
              <td align='left' class='GarisCetak'>".$pemindahtanganan."</td>
  ...
  function CetakPerHal($xls =FALSE){
    ...
    echo $naonkitu;
    echo "<tr valign='top'>
              <td align='left' class='GarisCetak' colspan='7' style='text-align: center; font-weight: bold;'>Total Per Hal</td>
              <td align='right' class='GarisCetak' style='font-weight: bold;'>".$totalnaey."</td>
              <td align='left' class='GarisCetak' colspan='5' style='font-weight: bold;'></td>
            </tr>";
    $naonkitu = "";
...
function excel($dt){
   ...
   $c1 = $dt['pemindahtangananNewSkpdfmUrusan'];
   $c = $dt['pemindahtangananNewSkpdfmSKPD'];
   $d = $dt['pemindahtangananNewSkpdfmUNIT'];
   $e = $dt['pemindahtangananNewSkpdfmSUBUNIT'];
   $e1 = $dt['pemindahtangananNewSkpdfmSEKSI'];
...
$pemindahtangananNew = new pemindahtangananNewObj();
...
$pemindahtangananNew->jenisForm = $jenisForm;
$pemindahtangananNew->nomorUrut = $nomorUrut;
$pemindahtangananNew->urutTerakhir = $nomorUrut;
$pemindahtangananNew->tahun = $tahun;
$pemindahtangananNew->jenisAnggaran = $jenisAnggaran;
$pemindahtangananNew->idTahap = $idTahap;
$pemindahtangananNew->username = $_COOKIE['coID'];
$pemindahtangananNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($pemindahtangananNew->wajibValidasi == TRUE){
  $pemindahtangananNew->sqlValidasi = " and status_validasi ='1' ";
}else{
  $pemindahtangananNew->sqlValidasi = " ";
}

$pemindahtangananNew->provinsi = $arrayResult['provinsi'];
$pemindahtangananNew->kota = $arrayResult['kota'];
$pemindahtangananNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$pemindahtangananNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$pemindahtangananNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$pemindahtangananNew->nipPengelola = $arrayResult['nipPengelola'];
$pemindahtangananNew->nipPengurus = $arrayResult['nipPengurus'];
$pemindahtangananNew->nipPejabat = $arrayResult['nipPejabat'];

$pemindahtangananNew->statusPenetapan = checkPenetapanRKBMD($pemindahtangananNew->tahun,$pemindahtangananNew->jenisAnggaran,"PENGADAAN");
