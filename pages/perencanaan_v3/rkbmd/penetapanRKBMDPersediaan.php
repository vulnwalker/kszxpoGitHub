...
class penetapanRKBMDPersediaanObj  extends DaftarObj2{
	var $Prefix = 'penetapanRKBMDPersediaan';
	...
	var $PageTitle = 'PENETAPAN RKBMD PERSEDIAAN';
	...
	var $FormName = 'penetapanRKBMDPersediaanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $nipPejabat = "";
	var $nipPengurus ="";
	var $kondisiBarang = " and f != '06' and f!='07' and f!='01' and f!='02' and f!='03' and f!='04' and f!='05'";
	var $reportURL7 = "pages.php?Pg=penetapanRKBMDPersediaan&tipe=Persediaan7";

	//untuk view
	function setTitle(){
		return 'PENETAPAN RKBMD PERSEDIAAN';
	}
	...
	function setPage_HeaderOther(){
		if($_GET['modul'] =='persediaan'){
				...
				<A href=\"pages.php?Pg=penetapanRKBMDPersediaan&modul=persediaan\" title='RKBMD PENGELOLA'  style='color : blue;'> PENETAPAN RKBMD </a>
	...
	-->
			...
			<A href=\"pages.php?Pg=rkbmdPersediaan_v3\" title='RKBMD'   > RKBMD </a> |
			<A href=\"pages.php?Pg=koreksiPengelolaPersediaan\" title='RKBMD PENGELOLA'  > RKBMD PENGELOLA </a> |
			<A href=\"pages.php?Pg=penetapanRKBMDPersediaan\" title='RKBMD PENGELOLA'  style='color : blue;'> PENETAPAN RKBMD </a>
			...
			<A href=\"pages.php?Pg=penetapanRKBMDPersediaan\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($penetapanRKBMDPersediaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($penetapanRKBMDPersediaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($penetapanRKBMDPersediaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($penetapanRKBMDPersediaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($penetapanRKBMDPersediaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'cancelPenetapanPersediaan':{
			mysql_query("delete from penetapan_rkbmd where tahun='$this->tahun' and jenis_anggaran = 'MURNI' and jenis_rkbmd = 'PERSEDIAAN'");
			break;
		}
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanSkpdfmSKPD' and d='$penetapanRKBMDPersediaanSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanSkpdfmSKPD' and d='$penetapanRKBMDPersediaanSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPersediaanSkpdfmUrusan' and c = '$penetapanRKBMDPersediaanSkpdfmSKPD' and d='$penetapanRKBMDPersediaanSkpdfmUNIT' and e = '$penetapanRKBMDPersediaanSkpdfmSUBUNIT' and e1='$penetapanRKBMDPersediaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentpenetapanRKBMDPersediaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentpenetapanRKBMDPersediaan['c1'];
					$parentC = $getParentpenetapanRKBMDPersediaan['c'];
					$parentD = $getParentpenetapanRKBMDPersediaan['d'];
					$parentE = $getParentpenetapanRKBMDPersediaan['e'];
					$parentE1= $getParentpenetapanRKBMDPersediaan['e1'];
					...
					if($cmbJenispenetapanRKBMDPersediaan == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['penetapanRKBMDPersediaan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentpenetapanRKBMDPersediaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentpenetapanRKBMDPersediaan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentpenetapanRKBMDPersediaan['c1'];
					$parentC = $getParentpenetapanRKBMDPersediaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$penetapanRKBMDPersediaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$penetapanRKBMDPersediaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getpenetapanRKBMDPersediaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getpenetapanRKBMDPersediaannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpenetapanRKBMDPersediaannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getpenetapanRKBMDPersediaannya['volume_barang'] < $angkaKoreksi){
	   ...
	   if(empty($angka))$angka = 25;
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/penetapanRKBMDPersediaan.js' language='JavaScript' ></script>
			 	<script type='text/javascript' src='js/perencanaan_v3/rkbmd/penetapanRKBMDPersediaanNew.js' language='JavaScript' ></script>".
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	...
	function tetapkanRKBMD($dt){
	 ...
	 $this->form_caption = 'PENETAPAN RKBMD PERSEDIAAN';
	 $catatan = $dt['catatan'];
	 $idnya = $dt['id_anggaran'];

	 if(!empty($_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']) && $_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan'] !='0' ){

	   if(empty($_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']) || $_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD'] =='00'){
	      $err = "Pilih Bidang";
	   }elseif(empty($_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']) || $_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT'] =='00'){
	      $err = "Pilih SKPD";
	   }else{
	     $getNamaUrusan = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c= '00' and d= '00'"));
	     $namaUrusan = $_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan'].". ".$getNamaUrusan['nm_skpd'];
	     $getNamaBidang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d= '00'"));
	     $namaBidang = $_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD'].". ".$getNamaBidang['nm_skpd'];
	     $getNamaSKPD = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d= '".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'"));
	     $namaSKPD = $_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT'].". ".$getNamaSKPD['nm_skpd'];
	   }
	 }else{
	 ...
	 if(mysql_num_rows(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  and c1 ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'  ")) !=0){
	      ...
	      $getData = mysql_fetch_array(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and  c1 ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."' "));
				if(mysql_num_rows(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'")) == 0){
						$getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where id ='".$getData['id_data_penetapan']."'"));
				}else{
						$getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'"));
				}
	      ...
	      $getIdPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1 ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'"));
	...
	$this->form_fields = array(
	  ...
	  $this->form_menubawah =
	    "
	    <input type='hidden' name='c1' id='c1' value='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan']."'>
	    <input type='hidden' name='c' id='c' value='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD']."'>
	    <input type='hidden' name='d' id='d' value='".$_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT']."'>
	 ...
	 foreach ($isi as $key => $value) {
		...
		$status_validasi = $isi['status_validasi'];
					...
					//	$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $getDataKoreksi = mysql_fetch_array(mysql_query("select sum(volume_barang) from view_rkbmd where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' "));
						 $kondisiWarna = "red";
						 ...
						 $getIsiBarangTahapSebelumnya = mysql_fetch_array(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutDuaTahapSebelumnya' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan'"));
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['penetapanRKBMDPersediaanSkpdfmUrusan'];
	 $c = $dt['penetapanRKBMDPersediaanSkpdfmSKPD'];
	 $d = $dt['penetapanRKBMDPersediaanSkpdfmUNIT'];
	 $e = $dt['penetapanRKBMDPersediaanSkpdfmSUBUNIT'];
	 $e1 = $dt['penetapanRKBMDPersediaanSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVWSKPD("penetapanRKBMDPersediaanSkpd") .
			"
			<input type='hidden' id='penetapanRKBMDPersediaanSkpdfmSUBUNIT' name='penetapanRKBMDPersediaanfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPersediaanSkpdfmSEKSI' name='penetapanRKBMDPersediaanfmSEKSI' >
			<input type='hidden' id='penetapanRKBMDPersediaanSkpdCbxSubUnit' name='penetapanRKBMDPersediaanfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPersediaanSkpdCbxSeksi' name='penetapanRKBMDPersediaanfmSEKSI' >
			</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenispenetapanRKBMDPersediaan' id='cmbJenispenetapanRKBMDPersediaan' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['penetapanRKBMDPersediaanSkpdfmUrusan'];
		$c    = $_REQUEST['penetapanRKBMDPersediaanSkpdfmSKPD'];
		$d    = $_REQUEST['penetapanRKBMDPersediaanSkpdfmUNIT'];
		if(isset($d)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenispenetapanRKBMDPersediaan = $_REQUEST['cmbJenispenetapanRKBMDPersediaan'];
		$arrKondisi = array();
		...
		while($dataBarang = mysql_fetch_array($getAllBarangFromRKBMD)){
					// $arrKondisi[] = "VulnWalker select * from view_rkbmd where id_tahap = '$this->idTahap' $this->kondisiBarang  $this->kondisiSKPD and c1='".$dataBarang['c1']."' and c='".$dataBarang['c']."' and d='".$dataBarang['d']."' and ck='".$dataBarang['ck']."' and dk='".$dataBarang['dk']."'  and dk='".$dataBarang['dk']."' and p='".$dataBarang['p']."' and q='".$dataBarang['q']."' and f='".$dataBarang['f']."' and g='".$dataBarang['g']."' and h='".$dataBarang['h']."' and i='".$dataBarang['i']."' and j='".$dataBarang['j']."' and volume_barang !='0' VulnWalker ";
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where id_tahap = '$this->idTahap' $this->kondisiBarang  $this->kondisiSKPD and c1='".$dataBarang['c1']."' and c='".$dataBarang['c']."' and d='".$dataBarang['d']."' and ck='".$dataBarang['ck']."' and dk='".$dataBarang['dk']."'  and dk='".$dataBarang['dk']."' and p='".$dataBarang['p']."' and q='".$dataBarang['q']."' and f='".$dataBarang['f']."' and g='".$dataBarang['g']."' and h='".$dataBarang['h']."' and i='".$dataBarang['i']."' and j='".$dataBarang['j']."' and j1='".$dataBarang['j1']."' and volume_barang !='0'")) == 0){
		...
		$Kondisi = $Kondisi =='' ? '':' Where '.$Kondisi." group by c1,c,d,bk,ck,dk,p,q,f,g,h,i,j,j1";
...
function Persediaan1($xls =FALSE){
		...
		$grabSubUnit = mysql_fetch_array(mysql_query("select * from ref_skpd where c1 = '$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$subunit = $grabSubUnit['nm_skpd'];
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' $Kondisi order by urut";
		$aqry = mysql_query($qry);
		$getKuasapenggunaBarang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$kuasaPenggunaBarang = $getKuasapenggunaBarang['nm_skpd'];
...
function Persediaan2($xls =FALSE){
	...
	global $Main;
		...
		$arrKondisi = array();
		$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			foreach ($rows as $key => $value) {
				  $$key = $value;
			}
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' $kondisiValid")) == 0){
				if($p !='0'){
					$concat = $bk.".".$ck.".".$dk.".".$p;
					$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
				}
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $kondisiValid")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p,'.',q) !='$concat'";
					}
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  $Kondisi order by urut";
		$aqry = mysql_query($qry);
		$getPenggunaBarang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='00' and e1='000'"));
		$penggunaBarang = $getPenggunaBarang['nm_skpd'];
		//MULAI Halaman Laporan ------------------------------------------------------------------------------------------
	...
	function Persediaan5($xls =FALSE){
		...
		$lastNomorUrut = $getLastTahap['no_urut'];
		$arrKondisi = array();
		$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and p !='0' and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			foreach ($rows as $key => $value) {
				  $$key = $value;
			}
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' ")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p,'.',q) !='$concat'";
					}
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
						if($j != '000'){
							$arrKondisi[] = " concat(f,'.',g,'.',h,'.',i,'.',j) !='$concat' ";
						}
					}
	...
	function Persediaan7($xls =FALSE){
		global $Main;
		...
		$this->fileNameExcel = "RKBMD PERSEDIAAN PROVINSI/KABUPATEN/KOTA";
		$align = "center";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		$getLastTahap = mysql_fetch_array(mysql_query("select max(id_anggaran) from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and j!='000' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN') and jenis_form_modul ='KOREKSI PENGELOLA'"));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = $getLastTahap['no_urut'];
		$arrKondisi = array();
		$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and p !='0' and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			foreach ($rows as $key => $value) {
				  $$key = $value;
			}
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' $this->kondisiBarang ")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$dk.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',dk,'.',p,'.',q) !='$concat'";
					}
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
						if($j != '000'){
							$arrKondisi[] = " concat(f,'.',g,'.',h,'.',i,'.',j) !='$concat' ";
						}
					}
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  $this->kondisiBarang $Kondisi order by urut";
		$aqry = mysql_query($qry);
...
$penetapanRKBMDPersediaan = new penetapanRKBMDPersediaanObj();
...
$penetapanRKBMDPersediaan->jenisForm = $jenisForm;
$penetapanRKBMDPersediaan->nomorUrut = $nomorUrut;
$penetapanRKBMDPersediaan->urutTerakhir = $nomorUrut;
$penetapanRKBMDPersediaan->tahun = $tahun;
$penetapanRKBMDPersediaan->jenisAnggaran = $jenisAnggaran;
$penetapanRKBMDPersediaan->idTahap = $idTahap;
$penetapanRKBMDPersediaan->username = $_COOKIE['coID'];
$penetapanRKBMDPersediaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($penetapanRKBMDPersediaan->wajibValidasi == TRUE){
	$penetapanRKBMDPersediaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$penetapanRKBMDPersediaan->sqlValidasi = " ";
}

$penetapanRKBMDPersediaan->provinsi = $arrayResult['provinsi'];
$penetapanRKBMDPersediaan->kota = $arrayResult['kota'];
$penetapanRKBMDPersediaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$penetapanRKBMDPersediaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$penetapanRKBMDPersediaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$penetapanRKBMDPersediaan->nipPengelola = $arrayResult['nipPengelola'];
$penetapanRKBMDPersediaan->nipPengurus = $arrayResult['nipPengurus'];
$penetapanRKBMDPersediaan->nipPejabat = $arrayResult['nipPejabat'];
