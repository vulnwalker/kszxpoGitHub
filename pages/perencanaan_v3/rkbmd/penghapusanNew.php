...
class penghapusanNewObj  extends DaftarObj2{
  var $Prefix = 'penghapusanNew';
  ...
  var $FormName = 'penghapusanNewForm';
  var $kode_skpd = '';
  var $modul = "RKBMD";
  var $jenisForm = "";
  var $tahun = "";
  ...
  var $reportURL7 = "pages.php?Pg=penghapusanNew&tipe=Pengadaan7";
  var $statusPenetapan ="";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'rphbmdSkpdfmURUSAN'];
      $dt['c'] = $_REQUEST[$this->Prefix.'rphbmdSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'rphbmdSkpdfmUNIT'];
      $dt['e'] = $_REQUEST[$this->Prefix.'rphbmdSkpdfmSUBUNIT'];
      $dt['e1'] = $_REQUEST[$this->Prefix.'rphbmdSkpdfmSEKSI'];
      $fm = $this->setForm($dt);
    }
...
function simpan(){
  ...
  function setPage_HeaderOther(){
    ...
    <A href=\"pages.php?Pg=penghapusanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> |
    ...
    <tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
    <A href=\"pages.php?Pg=penghapusanNew\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
   ...
   $cek = ''; $err=''; $content=''; $json=TRUE;
    ...
    case 'excel':{
      foreach ($_REQUEST as $key => $value) {
       ...
       /*if($penghapusanNewSkpdfmUrusan =='0'){
        $err = "Pilih Urusan";
       }elseif($penghapusanNewSkpdfmSKPD =='00'){
        $err = "Pilih Bidang";
       }elseif($penghapusanNewSkpdfmUNIT =='00'){
        $err = "Pilih SKPD";
       }elseif($penghapusanNewSkpdfmSUBUNIT =='00'){
        $err = "Pilih Unit";
       }elseif($penghapusanNewSkpdfmSEKSI =='000'){
        $err = "Pilih Sub Unit";
       }else{*/
  ...
  case 'formBaru':{       
    ...
    case 'newTab':{
       ...
       $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penghapusanNewSkpdfmUrusan' and c = '$penghapusanNewSkpdfmSKPD' and d='$penghapusanNewSkpdfmUNIT' and e = '$penghapusanNewSkpdfmSUBUNIT' and e1='$penghapusanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
       $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penghapusanNewSkpdfmUrusan' and c = '$penghapusanNewSkpdfmSKPD' and d='$penghapusanNewSkpdfmUNIT' and e = '$penghapusanNewSkpdfmSUBUNIT' and e1='$penghapusanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
       $lastID = $getDatarenja['id_anggaran'];
        if($cekKeberadaanMangkluk != 0){
          if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
            $getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penghapusanNewSkpdfmUrusan' and c = '$penghapusanNewSkpdfmSKPD' and d='$penghapusanNewSkpdfmUNIT' and e = '$penghapusanNewSkpdfmSUBUNIT' and e1='$penghapusanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
            if($getJumlahRenjaValidasi == 0){
              $err = "Renja Belum Di Validasi";
            }
          }

          $getParentpenghapusanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
          $parentC1 = $getParentpenghapusanNew['c1'];
          $parentC = $getParentpenghapusanNew['c'];
          $parentD = $getParentpenghapusanNew['d'];
          $parentE = $getParentpenghapusanNew['e'];
          $parentE1= $getParentpenghapusanNew['e1'];
          ...
          if($cmbJenispenghapusanNew == 'PENGADAAN'){
            $kemana = 'ins_v3';
          }else{
    ...
    case 'editTab':{
       $id = $_REQUEST['penghapusanNew_cb'];
      foreach ($_REQUEST as $key => $value) {
          $$key = $value;
       }
          $nomorUrutSebelumnya = $this->nomorUrut - 1;
          $getParentpenghapusanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
          foreach ($getParentpenghapusanNew as $key => $value) {
             $$key = $value;
           }
          $parentC1 = $getParentpenghapusanNew['c1'];
          $parentC = $getParentpenghapusanNew['c'];
    ...
    case 'SaveValid':{
       ...
       $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$penghapusanNew_idplh'"));
       ...
       $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$penghapusanNew_idplh'");
       mysql_query($query);
    ...
    case 'koreksi':{
      ...
      $getpenghapusanNewnya = mysql_fetch_array(mysql_query($queryRows));
      foreach ($getpenghapusanNewnya as $key => $value) {
          $$key = $value;
      }
       ...
       $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
        ...
        if($cekKoreksi > 0 ){
           $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
            ...
            if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpenghapusanNewnya['volume_barang'] >= $angkaKoreksi )  ){
              mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
            }elseif($getpenghapusanNewnya['volume_barang'] < $angkaKoreksi){
  ...
  function setPage_OtherScript(){
    ...
    return
      ...
      <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
       "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/penghapusanNew.js' language='JavaScript' ></script>".
      $scriptload;
  }
...
/*    $nomorUrutSebelumnya = $this-> -1;*/
     ...
     elseif($this->jenisForm=="KOREKSI PENGGUNA"){
          ...
          if($f == '00' && $q =='0')$TampilCheckBox = "";
            ...
            $Koloms.= "<td class='$cssclass' align='left'></td>";
             ...
             $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=penghapusanNew.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=penghapusanNew.koreksi('$id_anggaran');></img>";
  ...
  function CetakSemua($dt,$c1,$c,$d,$e,$e1){
   ...
   $this->form_caption = 'LAPORAN RENCANA PENGHAPUSAN';

   $c1 = $dt['rphbmdSkpdfmURUSAN'];
   $c = $dt['rphbmdSkpdfmSKPD'];
   $d = $dt['rphbmdSkpdfmUNIT'];
   $e = $dt['rphbmdSkpdfmSUBUNIT'];
   $e1 = $dt['rphbmdSkpdfmSEKSI'];

    $arrayJenisLaporan = array(
                 array('CetakSadayana', 'RENCANA PENGHAPUSAN'),
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='rphbmd.Close()' >";
  ...
  function CetakHal($dt,$c1,$c,$d,$e,$e1){
   ...
   $e1 = $dt['rphbmdSkpdfmSEKSI'];
    ...
    $arrayJenisLaporan = array(
                 array('CetakPerHal', 'RENCANA PENGHAPUSAN'),
  ...
  $TampilOpt =
      ...
      <td width=\"100%\" valign=\"top\">" .
        WilSKPD_ajxVW("penghapusanNewSkpd") .
      "</td>
      <td >" .
      "</td></tr>
      <tr><td>
      <input type='hidden' name='cmbJenispenghapusanNew' id='cmbJenispenghapusanNew' value='PENGADAAN'>
      </td></tr>
      </table>";
  ...
  function getDaftarOpsi($Mode=1){
    global $Main, $HTTP_COOKIE_VARS;
    $UID  = $_COOKIE['coID'];
    $c1   = $_REQUEST['penghapusanNewSkpdfmUrusan'];
    $c    = $_REQUEST['penghapusanNewSkpdfmSKPD'];
    $d    = $_REQUEST['penghapusanNewSkpdfmUNIT'];
    $e    = $_REQUEST['penghapusanNewSkpdfmSUBUNIT'];
    $e1   = $_REQUEST['penghapusanNewSkpdfmSEKSI'];
    if(isset($e1)){
    ...
    $fmKODE = $_REQUEST['fmKODE'];
    $fmBARANG = $_REQUEST['fmBARANG'];
    $cmbJenispenghapusanNew = $_REQUEST['cmbJenispenghapusanNew'];
    $arrKondisi = array();
  ...
  function CetakSadayana($xls =FALSE){
    ...
    ";
    $no = 1;
    $queryTrencanaPemanfaatan = mysql_query("SELECT * from t_rencana_penghapusan where c1 = '".$_GET[urusan]."' and c = '".$_GET[bidang]."' and d = '".$_GET[skpd]."' and e = '".$_GET[unit]."' and e1 = '".$_GET[subunit]."' ");
    ...
    while ($isiTrencanaPemanfaatan = mysql_fetch_array($queryTrencanaPemanfaatan)) {
      ...
      $total = mysql_fetch_array(mysql_query("SELECT SUM(harga) from t_rencana_penghapusan where c1 = '$isiTrencanaPemanfaatan[c1]' and c = '$isiTrencanaPemanfaatan[c]' and d = '$isiTrencanaPemanfaatan[d]' and e = '$isiTrencanaPemanfaatan[e]' and e1 = '$isiTrencanaPemanfaatan[e1]' "));
...
function excel($dt){
   ...
   $c1 = $dt['penghapusanNewSkpdfmUrusan'];
   $c = $dt['penghapusanNewSkpdfmSKPD'];
   $d = $dt['penghapusanNewSkpdfmUNIT'];
   $e = $dt['penghapusanNewSkpdfmSUBUNIT'];
   $e1 = $dt['penghapusanNewSkpdfmSEKSI'];
...
$penghapusanNew = new penghapusanNewObj();
...
$penghapusanNew->jenisForm = $jenisForm;
$penghapusanNew->nomorUrut = $nomorUrut;
$penghapusanNew->urutTerakhir = $nomorUrut;
$penghapusanNew->tahun = $tahun;
$penghapusanNew->jenisAnggaran = $jenisAnggaran;
$penghapusanNew->idTahap = $idTahap;
$penghapusanNew->username = $_COOKIE['coID'];
$penghapusanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($penghapusanNew->wajibValidasi == TRUE){
  $penghapusanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
  $penghapusanNew->sqlValidasi = " ";
}

$penghapusanNew->provinsi = $arrayResult['provinsi'];
$penghapusanNew->kota = $arrayResult['kota'];
$penghapusanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$penghapusanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$penghapusanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$penghapusanNew->nipPengelola = $arrayResult['nipPengelola'];
$penghapusanNew->nipPengurus = $arrayResult['nipPengurus'];
$penghapusanNew->nipPejabat = $arrayResult['nipPejabat'];

$penghapusanNew->statusPenetapan = checkPenetapanRKBMD($penghapusanNew->tahun,$penghapusanNew->jenisAnggaran,"PENGADAAN");
