...
class rkbmdPengadaanPerubahan_v3Obj  extends DaftarObj2{
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPengadaanPerubahan_v3&tipe=Pengadaan8";
	var $reportURL3 = "pages.php?Pg=rkbmdPengadaanPerubahan_v3&tipe=Pengadaan9";
	var $reportURL2 = "pages.php?Pg=rkbmdPengadaanPerubahan_v3&tipe=Pengadaan10";
	...
	function setPage_HeaderOther(){
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD'  style='color : blue;' > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPengadaanPerubahan\" title='RKBMD PENGELOLA' > KOREKSI </a>
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $nextNomorUrut = $this->nomorUrut + 1;
			   	  $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaanPerubahan_v3nya['volume_barang'] >= $angkaKoreksi )  ){
