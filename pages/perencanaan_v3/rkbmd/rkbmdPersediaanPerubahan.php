...
class rkbmdPersediaanPerubahan_v3Obj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanPerubahan_v3';
	...
	var $FormName = 'rkbmdPersediaanPerubahan_v3Form';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		...
		<A href=\"pages.php?Pg=rkbmdPemeliharaanPerubahan_v3\" title='RKBMD PENGELOLA'  > PEMELIHARAAN </a> |
		<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD PERSEDIAAN' style='color : blue;' > PERSEDIAAN </a>

		&nbsp&nbsp&nbsp
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD'  style='color : blue;' > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD PENGELOLA' > KOREKSI </a>
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'koreksiAlasanPerubahan':{
			...
			$getrkbmdPersediaanPerubahan_v3nya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPersediaanPerubahan_v3nya as $key => $value) {
				  $$key = $value;
			}
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $nextNomorUrut = $this->nomorUrut + 1;
			   	  $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanPerubahan_v3nya['volume_barang'] >= $angkaKoreksi )  ){
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPersediaanPerubahan_v3SkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPersediaanPerubahan_v3SkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPersediaanPerubahan_v3SkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPersediaanPerubahan_v3SkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanPerubahan_v3SkpdfmUrusan' and c = '$rkbmdPersediaanPerubahan_v3SkpdfmSKPD' and d='$rkbmdPersediaanPerubahan_v3SkpdfmUNIT' and e = '$rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT' and e1='$rkbmdPersediaanPerubahan_v3SkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanPerubahan_v3SkpdfmUrusan' and c = '$rkbmdPersediaanPerubahan_v3SkpdfmSKPD' and d='$rkbmdPersediaanPerubahan_v3SkpdfmUNIT' and e = '$rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT' and e1='$rkbmdPersediaanPerubahan_v3SkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPersediaanPerubahan_v3SkpdfmUrusan;
		     $parentC = $rkbmdPersediaanPerubahan_v3SkpdfmSKPD;
			 $parentD = $rkbmdPersediaanPerubahan_v3SkpdfmUNIT;
			 $parentE = $rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT;
			 $parentE1= $rkbmdPersediaanPerubahan_v3SkpdfmSEKSI;
				...
				$parentE1= '000';
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanPerubahan_v3SkpdfmUrusan' and c = '$rkbmdPersediaanPerubahan_v3SkpdfmSKPD' and d='$rkbmdPersediaanPerubahan_v3SkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPersediaanPerubahan_v3 == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPersediaanPerubahan_v3_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPersediaanPerubahan_v3 = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPersediaanPerubahan_v3 as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPersediaanPerubahan_v3['c1'];
					$parentC = $getParentrkbmdPersediaanPerubahan_v3['c'];
					$parentD = $getParentrkbmdPersediaanPerubahan_v3['d'];
					$parentE = $getParentrkbmdPersediaanPerubahan_v3['e'];
					$parentE1= $getParentrkbmdPersediaanPerubahan_v3['e1'];
					$getIdRenja = mysql_fetch_array(mysql_query("select * from view_renja where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$parentC1' and c = '$parentC' and d = '$parentD' and e = '$parentE' and e1 = '$parentE1' and p = '0' and q = '0' and no_urut = '$nomorUrutSebelumnya' "));
					$idrenja = $getIdRenja['id_anggaran'];
					if($idrenja == 0){
						$parentE = '00';
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPersediaanPerubahan_v3_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPersediaanPerubahan_v3_idplh'");
			 mysql_query($query);
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanPerubahan_v3nya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPersediaanPerubahan_v3nya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPersediaanPerubahan.js' language='JavaScript' ></script>".
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_v3.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_v3.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPersediaanPerubahan_v3SkpdfmUrusan'];
	 $c = $dt['rkbmdPersediaanPerubahan_v3SkpdfmSKPD'];
	 $d = $dt['rkbmdPersediaanPerubahan_v3SkpdfmUNIT'];
	 $e = $dt['rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPersediaanPerubahan_v3SkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPersediaanPerubahan_v3Skpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPersediaanPerubahan_v3' id='cmbJenisrkbmdPersediaanPerubahan_v3' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		...
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPersediaanPerubahan_v3SkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPersediaanPerubahan_v3SkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPersediaanPerubahan_v3SkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPersediaanPerubahan_v3SkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPersediaanPerubahan_v3SkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPersediaanPerubahan_v3 = $_REQUEST['cmbJenisrkbmdPersediaanPerubahan_v3'];
		$arrKondisi = array();
...
$rkbmdPersediaanPerubahan_v3 = new rkbmdPersediaanPerubahan_v3Obj();
$arrayResult = tahapPerencanaanV3($rkbmdPersediaanPerubahan_v3->modul,"PERUBAHAN");
...
$rkbmdPersediaanPerubahan_v3->jenisForm = $jenisForm;
$rkbmdPersediaanPerubahan_v3->nomorUrut = $nomorUrut;
$rkbmdPersediaanPerubahan_v3->urutTerakhir = $nomorUrut;
$rkbmdPersediaanPerubahan_v3->tahun = $tahun;
$rkbmdPersediaanPerubahan_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanPerubahan_v3->idTahap = $idTahap;
$rkbmdPersediaanPerubahan_v3->username = $_COOKIE['coID'];
$rkbmdPersediaanPerubahan_v3->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPersediaanPerubahan_v3->wajibValidasi == TRUE){
	$rkbmdPersediaanPerubahan_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanPerubahan_v3->sqlValidasi = " ";
}
$rkbmdPersediaanPerubahan_v3->provinsi = $arrayResult['provinsi'];
$rkbmdPersediaanPerubahan_v3->kota = $arrayResult['kota'];

$rkbmdPersediaanPerubahan_v3->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPersediaanPerubahan_v3->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPersediaanPerubahan_v3->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPersediaanPerubahan_v3->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPersediaanPerubahan_v3->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPersediaanPerubahan_v3->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPersediaanPerubahan_v3->settingAnggaran = $arrayResult['settingAnggaran'];
