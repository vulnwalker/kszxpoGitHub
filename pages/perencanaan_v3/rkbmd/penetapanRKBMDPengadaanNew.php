...
class penetapanRKBMDPengadaanNewObj  extends DaftarObj2{
	var $Prefix = 'penetapanRKBMDPengadaanNew';
	...
	var $FormName = 'penetapanRKBMDPengadaanNewForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL7 = "pages.php?Pg=penetapanRKBMDPengadaanNew&tipe=Pengadaan7";
  ...
  //  $dat_urusan= $_REQUEST['dat_urusan'];
    ...
    if ($urusan=='0'){
      ...
      $dt['c1'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPengadaanSkpdfmUrusan'];
      $dt['c'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPengadaanSkpdfmSKPD'];
      $dt['d'] = $_REQUEST[$this->Prefix.'penetapanRKBMDPengadaanSkpdfmUNIT'];
      $fm = $this->setForm($dt);
    }
  ...
  $oldy=mysql_fetch_array(
   ...
   if( $err=='' && $kategori =='' ) $err= 'Kategori Belum Di Pilih !!';
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=penetapanRKBMDPengadaanNew\" title='RKBMD PENGELOLA'  style='color : blue;'> PENETAPAN RKBMD </a>

		&nbsp&nbsp&nbsp
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=penetapanRKBMDPengadaanNew\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($penetapanRKBMDPengadaanNewSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($penetapanRKBMDPengadaanNewSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($penetapanRKBMDPengadaanNewSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($penetapanRKBMDPengadaanNewSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($penetapanRKBMDPengadaanNewSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	  ...
	  case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPengadaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPengadaanNewSkpdfmSKPD' and d='$penetapanRKBMDPengadaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPengadaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPengadaanNewSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPengadaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPengadaanNewSkpdfmSKPD' and d='$penetapanRKBMDPengadaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPengadaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPengadaanNewSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$penetapanRKBMDPengadaanNewSkpdfmUrusan' and c = '$penetapanRKBMDPengadaanNewSkpdfmSKPD' and d='$penetapanRKBMDPengadaanNewSkpdfmUNIT' and e = '$penetapanRKBMDPengadaanNewSkpdfmSUBUNIT' and e1='$penetapanRKBMDPengadaanNewSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentpenetapanRKBMDPengadaanNew = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentpenetapanRKBMDPengadaanNew['c1'];
					$parentC = $getParentpenetapanRKBMDPengadaanNew['c'];
					$parentD = $getParentpenetapanRKBMDPengadaanNew['d'];
					$parentE = $getParentpenetapanRKBMDPengadaanNew['e'];
					$parentE1= $getParentpenetapanRKBMDPengadaanNew['e1'];
					...
					if($cmbJenispenetapanRKBMDPengadaanNew == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['penetapanRKBMDPengadaanNew_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentpenetapanRKBMDPengadaanNew = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentpenetapanRKBMDPengadaanNew as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentpenetapanRKBMDPengadaanNew['c1'];
					$parentC = $getParentpenetapanRKBMDPengadaanNew['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$penetapanRKBMDPengadaanNew_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$penetapanRKBMDPengadaanNew_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getpenetapanRKBMDPengadaanNewnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getpenetapanRKBMDPengadaanNewnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getpenetapanRKBMDPengadaanNewnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getpenetapanRKBMDPengadaanNewnya['volume_barang'] < $angkaKoreksi){
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	...
	function tetapkanRKBMD($dt){
	 ...
	 if(!empty($_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']) && $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan'] !='0' ){

		 if(empty($_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']) || $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD'] =='00'){
				$err = "Pilih Bidang";
		 }elseif(empty($_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']) || $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT'] =='00'){
				$err = "Pilih SKPD";
		 }else{
			 $getNamaUrusan = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c= '00' and d= '00'"));
			 $namaUrusan = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan'].". ".$getNamaUrusan['nm_skpd'];
			 $getNamaBidang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d= '00'"));
			 $namaBidang = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD'].". ".$getNamaBidang['nm_skpd'];
			 $getNamaSKPD = mysql_fetch_array(mysql_query("select * from ref_skpd where c1= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d= '".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'"));
			 $namaSKPD = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT'].". ".$getNamaSKPD['nm_skpd'];
		 }
	 }else{
	 ...
	 if(mysql_num_rows(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran'  and c1 ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'  ")) !=0){
				...
				$getData = mysql_fetch_array(mysql_query("select * from penetapan_rkbmd where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and  c1 ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."' "));

				if(mysql_num_rows(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'")) == 0){
				    $getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where id ='".$getData['id_data_penetapan']."'"));
				}else{
				    $getDataPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran ='MURNI' and c1 ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'"));
				}
		   	...
		   	$batalkanPenetapan = "<input type='button' value='Simpan' onclick ='".$this->Prefix.".saveTetapkanRKBMD()' title='Simpan' >  ";
				...
				$getIdPenetapan = mysql_fetch_array(mysql_query("select * from ref_data_penetapan where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1 ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."' and c ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."' and d ='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'"));
 ...
 $this->form_fields = array(
		...
		$this->form_menubawah =
			"
			<input type='hidden' name='c1' id='c1' value='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan']."'>
			<input type='hidden' name='c' id='c' value='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD']."'>
			<input type='hidden' name='d' id='d' value='".$_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT']."'>
	...
	function Laporan($dt){
	 ...
	 $d = $dt['penetapanRKBMDPengadaanSkpdfmUNIT'];
      ...
      <input type='button' value='TTD' onclick ='".$this->Prefix.".Baru()' title='TTD' >
			...
			"<input type='button' value='Batal' onclick ='penetapanRKBMDPengadaan.Close()' >";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVWSKPD("penetapanRKBMDPengadaanNewSkpd") .
			"
			<input type='hidden' id='penetapanRKBMDPengadaanNewSkpdfmSUBUNIT' name='penetapanRKBMDPengadaanNewfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPengadaanNewSkpdfmSEKSI' name='penetapanRKBMDPengadaanNewfmSEKSI' >
			<input type='hidden' id='penetapanRKBMDPengadaanNewSkpdCbxSubUnit' name='penetapanRKBMDPengadaanNewfmSUBUNIT' >
			<input type='hidden' id='penetapanRKBMDPengadaanNewSkpdCbxSeksi' name='penetapanRKBMDPengadaanNewfmSEKSI' >
			</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenispenetapanRKBMDPengadaanNew' id='cmbJenispenetapanRKBMDPengadaanNew' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUrusan'];
		$c    = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmSKPD'];
		$d    = $_REQUEST['penetapanRKBMDPengadaanNewSkpdfmUNIT'];
		if(isset($d)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenispenetapanRKBMDPengadaanNew = $_REQUEST['cmbJenispenetapanRKBMDPengadaanNew'];
		$arrKondisi = array();
    ...
    $arrKondisi[] = "f != '06' and f!='07' and f!='08'";
		...
		echo "
								...
								<thead>
									<tr>
										<th class='th01' rowspan='2' style='width:20px;' >NO</th>
										<th class='th01' rowspan='2' >SKPD/<br>PROGRAM/<br>KEGIATAN/<br>OUTPUT</th>
										<th class='th02' rowspan='1' colspan='6' >PENETAPAN BMD</th>
                    ...
                    <th class='th01' style='width: 5%;'>CARA PEMENUHAN</th>
                    <th class='th02' style='width: 12%;'>KETERANGAN</th>
									</tr>
								</thead>
...
function excel($dt){
	 ...
	 $c1 = $dt['penetapanRKBMDPengadaanNewSkpdfmUrusan'];
	 $c = $dt['penetapanRKBMDPengadaanNewSkpdfmSKPD'];
	 $d = $dt['penetapanRKBMDPengadaanNewSkpdfmUNIT'];
	 $e = $dt['penetapanRKBMDPengadaanNewSkpdfmSUBUNIT'];
	 $e1 = $dt['penetapanRKBMDPengadaanNewSkpdfmSEKSI'];
...
$penetapanRKBMDPengadaanNew = new penetapanRKBMDPengadaanNewObj();
...
$penetapanRKBMDPengadaanNew->jenisForm = $jenisForm;
$penetapanRKBMDPengadaanNew->nomorUrut = $nomorUrut;
$penetapanRKBMDPengadaanNew->urutTerakhir = $nomorUrut;
$penetapanRKBMDPengadaanNew->tahun = $tahun;
$penetapanRKBMDPengadaanNew->jenisAnggaran = $jenisAnggaran;
$penetapanRKBMDPengadaanNew->idTahap = $idTahap;
$penetapanRKBMDPengadaanNew->username = $_COOKIE['coID'];
$penetapanRKBMDPengadaanNew->wajibValidasi = $arrayResult['wajib_validasi'];
if($penetapanRKBMDPengadaanNew->wajibValidasi == TRUE){
	$penetapanRKBMDPengadaanNew->sqlValidasi = " and status_validasi ='1' ";
}else{
	$penetapanRKBMDPengadaanNew->sqlValidasi = " ";
}

$penetapanRKBMDPengadaanNew->provinsi = $arrayResult['provinsi'];
$penetapanRKBMDPengadaanNew->kota = $arrayResult['kota'];
$penetapanRKBMDPengadaanNew->pengelolaBarang = $arrayResult['pengelolaBarang'];
$penetapanRKBMDPengadaanNew->pejabatPengelolaBarang = $arrayResult['pejabat'];
$penetapanRKBMDPengadaanNew->pengurusPengelolaBarang = $arrayResult['pengurus'];
$penetapanRKBMDPengadaanNew->nipPengelola = $arrayResult['nipPengelola'];
$penetapanRKBMDPengadaanNew->nipPengurus = $arrayResult['nipPengurus'];
$penetapanRKBMDPengadaanNew->nipPejabat = $arrayResult['nipPejabat'];
