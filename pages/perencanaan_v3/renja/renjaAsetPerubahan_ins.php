<?php
class renjaAsetPerubahan_insObj  extends DaftarObj2{
	var $Prefix = 'renjaAsetPerubahan_ins';
	...
	var $FormName = 'renjaAsetPerubahan_insForm';
	var $noModul=14;
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							array(
							 ...
							 array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='renjaAsetPerubahan_ins.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							  ),
							  array(
								'label'=>'KEGIATAN',
								'labelWidth'=>150,
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renjaAsetPerubahan_ins_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renjaAsetPerubahan_ins = new renjaAsetPerubahan_insObj();

$arrayResult = tahapPerencanaanV3($renjaAsetPerubahan_ins->modul,"PERUBAHAN");
...
$renjaAsetPerubahan_ins->jenisForm = $jenisForm;
$renjaAsetPerubahan_ins->nomorUrut = $nomorUrut;
$renjaAsetPerubahan_ins->tahun = $tahun;
$renjaAsetPerubahan_ins->jenisAnggaran = $jenisAnggaran;
$renjaAsetPerubahan_ins->idTahap = $idTahap;
$renjaAsetPerubahan_ins->username = $_COOKIE['coID'];
$renjaAsetPerubahan_ins->wajibValidasi = $Main->wajibValidasi;
