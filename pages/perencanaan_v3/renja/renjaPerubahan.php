	  ...
	  switch($tipe){
		...
		case 'newTab':{
			...
			case 'editTab':{
			 ...
			 $content = array('ID_PLAFON' => $ID_PLAFON,  'ID_EDIT' => $renjaPerubahan_v3_cb[0] , 'query ' =>"select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$c1' and c = '$c' and d='$d' and e='00' and e1='000' and bk='0' and ck = '0' and dk = '0' and p ='0' and q = '0' and no_urut = '$nomor' ");
