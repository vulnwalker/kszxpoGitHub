<?php
class renjaPerubahan_ins_v3Obj  extends DaftarObj2{	
	var $Prefix = 'renjaPerubahan_ins_v3';
	...
	var $FormName = 'renjaPerubahan_ins_v3Form';
	var $noModul=14; 
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							array(
							 ...
							 array( 
								...
								<input type='button' value='Cari' id='findProgram' onclick ='renjaPerubahan_ins_v3.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >" 
							  ),
							  array( 
								'label'=>'KEGIATAN',
								'labelWidth'=>150, 
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renjaPerubahan_ins_v3_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renjaPerubahan_ins_v3 = new renjaPerubahan_ins_v3Obj();

$arrayResult = tahapPerencanaanV3($renjaPerubahan_ins_v3->modul,"PERUBAHAN");
...
$renjaPerubahan_ins_v3->jenisForm = $jenisForm;
$renjaPerubahan_ins_v3->nomorUrut = $nomorUrut;
$renjaPerubahan_ins_v3->tahun = $tahun;
$renjaPerubahan_ins_v3->jenisAnggaran = $jenisAnggaran;
$renjaPerubahan_ins_v3->idTahap = $idTahap;
$renjaPerubahan_ins_v3->username = $_COOKIE['coID'];
$renjaPerubahan_ins_v3->wajibValidasi = $Main->wajibValidasi;
