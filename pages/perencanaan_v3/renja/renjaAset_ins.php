<?php
class renjaAset_insObj  extends DaftarObj2{
	var $Prefix = 'renjaAset_ins';
	...
	var $FormName = 'renjaAset_insForm';
	var $noModul=14;
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							array(
							 ...
							 array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='renjaAset_ins.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							  ),
							  array(
								'label'=>'KEGIATAN',
								'labelWidth'=>150,
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renjaAset_ins_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renjaAset_ins = new renjaAset_insObj();

$arrayResult = tahapPerencanaanV3($renjaAset_ins->modul,"MURNI");
...
$renjaAset_ins->jenisForm = $jenisForm;
$renjaAset_ins->nomorUrut = $nomorUrut;
$renjaAset_ins->tahun = $tahun;
$renjaAset_ins->jenisAnggaran = $jenisAnggaran;
$renjaAset_ins->idTahap = $idTahap;
$renjaAset_ins->username = $_COOKIE['coID'];
$renjaAset_ins->wajibValidasi = $Main->wajibValidasi;
