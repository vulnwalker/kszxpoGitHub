...
class JurnalPenyusutan2Obj extends DaftarObj2{
	var $Prefix = 'JurnalPenyusutan2';
								...
								<table cellspacing='0' cellpadding='0' border='0' style='height:28'>
									...
									<tr>
										<td align='left' style='padding:1 8 0 8; '>
											...
											Kode Rekap : <input type='text' name='kode_rekap' id='kode_rekap' value='".$kint.'.'.$ka.'.'.$kb."'> &nbsp;&nbsp;&nbsp;
											Kode Barang : <input type='text' name='kode_barang' id='kode_barang' value='".$kode_brg."'> &nbsp;&nbsp;&nbsp;".
...
$JurnalPenyusutan2 = new JurnalPenyusutan2Obj();
