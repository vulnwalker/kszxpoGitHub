...
class JurnalPenyusutanObj extends DaftarObj2{
	...
	function genDaftarOpsi(){
		...
		if($Main->VERSI_NAME=='SERANG'){			
			$arrGrpSusut = array(
				array('1','Pindah Antar SKPD'),
				array('2','Reklas'),	
				array('3','Koreksi Penyusutan'),
				array('4','1 Januari'),
				array('5','Penghapusan'),
				array('6','Kapitalisasi'),
				array('7','Aset Lain-lain'),
				array('8','Penyusutan'),
		...
		$keadaanPer1Januari = $_REQUEST['keadaanPer1Januari'];
		$cbkeadaanPer1Januari = $keadaanPer1Januari==1?1:$_REQUEST['cbkeadaanPer1Januari'];
		$checked = $cbkeadaanPer1Januari==1?'checked':'';
		$GrpSusut = $_REQUEST['GrpSusut'];
		if($Main->VERSI_NAME=='SERANG'){
			$cb1Januari="<input type='checkbox' id='cbkeadaanPer1Januari' name='cbkeadaanPer1Januari' value='1' $checked> Keadaan Per 1 Januari";
		}else{
			//$cmbGrpSusut="";
			$cb1Januari="";			
		}
		$cmbGrpSusut=cmbArray('GrpSusut',$GrpSusut,$arrGrpSusut,'--Group--','')."&nbsp&nbsp;&nbsp;";		
		#$kode_brg = $f ==''? '' : $f.'.'.$g.'.'.$h.'.'.$i;
		/*$hidden	= 
								...
								<table cellspacing='0' cellpadding='0' border='0' style='height:28'>
									...
									<tr>
										<td align='left' style='padding:1 8 0 8; '>
											...
											$cmbGrpSusut.
											cmbArray('jns_trans2',$jnsTrans2,$Main->jnsTrans2,'--Transaksi--','')."&nbsp&nbsp;&nbsp;
	...
	function getDaftarOpsi($Mode=1){
		...
		$UID = $_COOKIE['coID']; 
		//kondisi -----------------------------------
		$cbkeadaanPer1Januari = $_REQUEST['cbkeadaanPer1Januari'];				
		...
		$tgl1 = $_REQUEST['tgl1'];
		if($tgl1!='' && $cbkeadaanPer1Januari!=1) $arrKondisi[] = " tgl_buku >='$tgl1' ";
		$tgl2 = $_REQUEST['tgl2'];
		if($tgl2!='' && $cbkeadaanPer1Januari!=1) $arrKondisi[] = " tgl_buku <='$tgl2' ";
		$debet = $_REQUEST['debet'];
		if($debet!='') {
			switch ($debet){
		...
		if($GrpSusut!='') {
			switch($GrpSusut){
				...
				case '1' : $arrKondisi[] = " (jns_trans2 =15) "; break;
				case '2' : $arrKondisi[] = " (jns_trans2=16 or jns_trans2=19)"; break;
				case '3' : $arrKondisi[] = " (jns_trans2=31 or jns_trans2=37 or jns_trans2=38 or jns_trans3=41) "; break;
				case '4' : $arrKondisi[] = " (jns_trans2=15 or jns_trans2=16 or jns_trans2=19 or jns_trans2=31 or jns_trans2=37 or jns_trans2=38 or jns_trans3=41 or (jns_trans2 =30 and tgl_buku <='$tgl2')) "; break;
				case '5' : $arrKondisi[] = " (jns_trans2=14 or jns_trans2=17 or jns_trans2=18) "; break;
				case '6' : $arrKondisi[] = " (jns_trans2=22) "; break;
				case '7' : $arrKondisi[] = " (jns_trans2=21) "; break;
				case '8' : $arrKondisi[] = " (jns_trans2=30 and jns_trans3 <> 41) "; break;				
				case '9' : $arrKondisi[] = " (jns_trans2=17 or jns_trans2=26 or jns_trans2=27 or jns_trans2=32) "; break;
				case '10' : $arrKondisi[] = " (jns_trans2=39) "; break;
				default : $arrKondisi[] = " " ; break;
			}
		...
		/*if($Main->VERSI_NAME=='SERANG'){
			...
			if($jns_trans2!='') {
				switch($jns_trans2){
					...
					case '14' : $arrKondisi[] = " (jns_trans2 =14 or jns_trans2=17 or jns_trans2=18) "; break;
					case '16' : $arrKondisi[] = " (jns_trans2=16 or jns_trans2=19)"; break;
					case '30' : $arrKondisi[] = " (jns_trans2 =30 and jns_trans3 <> 41) "; break;
					case '31' : $arrKondisi[] = " (jns_trans2 =31 or  jns_trans3=41 or jns_trans2=37 or jns_trans2=38) "; break;
					default : $arrKondisi[] = " jns_trans2='$jns_trans2' " ; break;
				}
		...
		if($cbkeadaanPer1Januari==1) $arrKondisi[] = " (jns_trans2=15 or jns_trans2=16 or jns_trans2=17 or jns_trans2=18 or jns_trans2=19 or jns_trans2=31 or jns_trans2=37 or jns_trans2=38 or jns_trans3=41 or (jns_trans2 =30 and tgl_buku <='$tgl2'))";				
		/*$jns_trans2 = $_REQUEST['jns_trans2'];
		if($jns_trans2!='') {
			switch($jns_trans2){
				case '14' : $arrKondisi[] = " (jns_trans2 ='14'  or jns_trans2='37' or jns_trans2='38' )"; break;
				case '16' : $arrKondisi[] = " ( jns_trans2='16' or jns_trans2='17' or jns_trans2='18' or jns_trans2='19' )"; break;
				default :  $arrKondisi[] = " jns_trans2='$jns_trans2' ";
			}
...
<th class='th01' rowspan=2>Uraian</th>
	...
	function setDaftar_query($Kondisi='', $Order='', $Limit=''){		
		$aqry =  "select " .
				//a1,a,b,
				" c1,c,d,e,e1,f,g,h,i,j,idawal,idbi,tgl_buku,debet,kredit,(kredit-debet) as total, jns_trans2, kint ".
				" from ".
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
		global $Main,$HTTP_COOKIE_VARS;
			...
			$uraian = $Main->jnsTrans2[$isi['jns_trans2']-1][1];
			if($isi['jns_trans3'] == '41'  ){
				$uraian = 'Koreksi Penyusutan';
			}			
	...
	function genDaftarInitial(){
		...
		return		
			...
			"<input type='hidden' id='keadaanPer1Januari' name='keadaanPer1Januari' value='$keadaanPer1Januari'>".
			"<input type='hidden' id='cbkeadaanPer1Januari' name='cbkeadaanPer1Januari' value='$keadaanPer1Januari'>".
			"<input type='hidden' id='GrpSusut' name='GrpSusut' value='$GrpSusut'>".
