...
class MasterSpecObj  extends DaftarObj2{	
	var $Prefix = 'MasterSpec';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'ref_spec_persediaan'; //daftar
	var $TblName_Hapus = 'ref_spec_persediaan';
	var $MaxFlush = 10;
	var $TblStyle = array( 'koptable', 'cetak','cetak'); //berdasar mode
	var $ColStyle = array( 'GarisDaftar', 'GarisCetak','GarisCetak');
	var $KeyFields = array('j');
	...
	var $Cetak_Judul = 'SPESIFIKASI';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'MasterSpecForm'; 	
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="left" width="100"',$isi['j']);
 	 $Koloms[] = array('align="left" width="200"',$isi['nama_spec']); 	 	 	 
	 return $Koloms;
	}
	...
	$fmDESC1 = cekPOST('fmDESC1');
	 ...
	 $arr = array(
			...
			array('selectspec','Nama Spesifikasi'),	
			);
	...
	function getDaftarOpsi($Mode=1){
		...
		switch($fmPILCARI){
			...
			case 'selectspec': $arrKondisi[] = " nama_spec like '%".$fmPILCARIvalue."%'"; break;					 	
		}
		...
		switch($fmORDER1){
			...
			case '2': $arrOrders[] = " nama_spec $Asc1 " ;break;
