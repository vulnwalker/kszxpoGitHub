...
if ($fmSUBSUBKELOMPOK==''){	$fmSUBSUBKELOMPOK =$kdSubsubkel0;}
if (!(($fmBIDANG == '' ||$fmBIDANG =='00') && ($fmKELOMPOK == '' ||$fmKELOMPOK =='00') 
 	&& ($fmSUBKELOMPOK == '' ||$fmSUBKELOMPOK =='00') && ($fmSUBSUBKELOMPOK == '' ||$fmSUBSUBKELOMPOK ==$kdSubsubkel0)) ){
	...
	if ($fmSUBSUBKELOMPOK != $kdSubsubkel0){ $Kondisi .= " and i ='$fmSUBSUBKELOMPOK'";}
...
while($isi=mysql_fetch_array($Qry))
{
	...
	$List.= 
		...
		<td><a href='#' cursor='hand' onClick=\"KlikGunakan('".
			...
			"','".$isi['harga']."','".$isi['tahun']."' )\">$Isi2 </a></td>
		<td align='center'>". 
			$isi['tahun'].
			
		"</td>
		<td align='left'>".$isi['merk_barang']."</td>
...
<script>
	...
	function KlikGunakan(idbi,isi1,isi2, merk, jml, satuan, harga,tahun){
		/***************************
		* idbi = id dkb yg terpilih
		*************************/
		...
		var id = parent.document.getElementById('dpb_idplh').value;
		/*
		alert(
			'../../pages.php?Pg=dpb&ajx=1&tipe=hitPengadaanSebelumnya&tahun='+tahun+
				'&c='+c+'&d='+d+'&e='+e+'&e1='+e1+'&kdbrg='+isi1+'&id='+id+'&ref_iddkb='+idbi
		);*/
		$.ajax({
			
			url: '../../pages.php?Pg=dpb&ajx=1&tipe=hitPengadaanSebelumnya&tahun='+tahun+
				'&c='+c+'&d='+d+'&e='+e+'&e1='+e1+'&kdbrg='+isi1+'&id='+id+'&ref_iddkb='+idbi
				,
...
<table class=\"adminheading\">
	<tr>
		<th height=\"47\" class=\"searchtext\">Pencarian Data Kebutuhan Barang Milik Daerah </th>
		...
		<td vAlign=top>
			<table align=center class=\"adminlist\" border =1>	
				...
				<tr>
					...
					<th align='center' width='150'>Merk / Type / Ukuran / Spesifikasi</th>					
