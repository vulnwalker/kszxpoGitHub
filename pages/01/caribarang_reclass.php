...
if ($Baru == 0){
	...
	//$kdbid = $KIB;
	$nmbid = table_get_value("select nm_barang from ref_barang where f='".$kdbid."' and g ='00' and h = '00' and i='00' and j='00'", "nm_barang");
	$cek .= '<br> nm bid = '.$nmbid;
	$fmBIDANG = $kdbid;
	$ListBidang = '
...
*/
//	if ($KIB == '03' || $KIB == ''){
		$ListBidang = cmbQuery("fmBIDANG",$fmBIDANG,"select f,nm_barang from ref_barang where f!='00' and g ='00' and h = '00' and i='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih','');		
/*	}else{	
...
$ListKelompok = cmbQuery("fmKELOMPOK",$fmKELOMPOK,
	"select g,nm_barang from ref_barang where f='$fmBIDANG' and g !='00' and h = '00' and i='00' and j='00'",
	"onChange=\"adminForm.submit()\"",'Pilih','');
$ListSubKelompok = cmbQuery("fmSUBKELOMPOK",$fmSUBKELOMPOK,"select h,nm_barang from ref_barang where f='$fmBIDANG' and g ='$fmKELOMPOK' and h != '00' and i='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih','');
$ListSubSubKelompok = cmbQuery("fmSUBSUBKELOMPOK",$fmSUBSUBKELOMPOK,"select i,nm_barang from ref_barang where f='$fmBIDANG' and g ='$fmKELOMPOK' and h = '$fmSUBKELOMPOK' and i!='00' and j='00'","onChange=\"adminForm.submit()\"",'Pilih','');
...
<script>
	...
	function KlikGunakan(isi1,isi2, fmname)
	{
		//if (fmname== null){
		...
		/*else{
			...
			parent.document.getElementById($objID)value=isi1;
			parent.document.getElementById($objNM)value=isi2;
			//fm.submit();
		}*/
	}
</script>
