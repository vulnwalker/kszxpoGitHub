...
class refstandarharga_v2Obj  extends DaftarObj2{	
	var $Prefix = 'refstandarharga_v2';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'ref_std_harga_v2'; //daftar
	var $TblName_Hapus = 'ref_std_harga_v2';
	var $MaxFlush = 10;
	...
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='refstandarharga_v2.xls';
	var $Cetak_Judul = 'refstandarharga_v2';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'refstandarharga_v2Form'; 
	var $kdbrg = '';	
		...
		if($err==''){
			...
			if($fmST == 0){
				$data = array('f'=>$f,
				 ...
				 mysql_query(VulnWalkerInsert("ref_std_harga_v2",$data));
				 $cek .=VulnWalkerInsert("ref_std_harga_v2",$data);
				...
				$data = array(	  'spesifikasi'=>$spesifikasi,
					 ...
					 mysql_query(VulnWalkerUpdate("ref_std_harga_v2",$data,"concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang'"));
					 $cek .=VulnWalkerInsert("ref_std_harga_v2",$data);
	...
	function setPage_OtherScript(){
		...
		return 
			 ...
			 <script type='text/javascript' src='js/master/refstandarharga_v2/refstandarharga.js' language='JavaScript' ></script>
	...
	$cek ='';
		...
		$this->form_fmST = 1;				
		//get data 
		$aqry = "SELECT * FROM  ref_std_harga_v2 WHERE  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' "; $cek.=$aqry;
	...
	function setForm($dt){	
	 ...
	 $this->form_height = 250;
	  if ($this->form_fmST==0) {
		...
		$getNamaBarang =  mysql_fetch_array(mysql_query("select * from ref_barang_v2 where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' "));
       ...
       //items ----------------------
		 $this->form_fields = array(
			...
			'standarSatuanHarga' => array( 
						...
						'labelWidth'=>120, 
						'value'=> "<input type='text' name='standarSatuanHarga' id='standarSatuanHarga' value='$standarSatuanHarga' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='document.getElementById(`bantu`).innerHTML = popupBarang_v2.formatCurrency(this.value);' style='text-align:right' placeholder='Rp.'> <font color='red' id='bantu' name='bantu'></font>"  
							  ),
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $arrayGetNamabarang = mysql_fetch_array(mysql_query("select * from ref_barang_v2 where concat(f,'-',g,'-',h,'-',i,'-',j) = '$kodeBarang' "));
...
$refstandarharga_v2 = new refstandarharga_v2Obj();
