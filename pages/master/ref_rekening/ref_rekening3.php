...
class ref_rekening3Obj  extends DaftarObj2{	
	var $Prefix = 'ref_rekening3';
	...
	var $FormName = 'ref_rekening3Form';
	var $noModul=9; 
	...
	function genDaftarInitial($nm_rekening='', $height=''){
		$filterRekening = $_REQUEST['filterRekening'];
		$vOpsi = $this->genDaftarOpsi();
		return			
			"<div id='{$this->Prefix}_cont_title' style='position:relative'></div>". 
			"<div id='{$this->Prefix}_cont_opsi' style='position:relative'>". 		
			"<input type='hidden' id='".$this->Prefix."nm_rekening' name='".$this->Prefix."nm_rekening' value='$nm_rekening'>".
  ...
  function pilihKA(){
	global $Main;	 
		...
		$content->unit=cmbQuery('fmKB',$fmkb,$queryl,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKB()"','&nbsp&nbsp----- Pilih Kode Kelompok -----')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKB()' title='Baru' >";
	...
	global $Main;
		...
		$content->unit=cmbQuery('fmKC',$fmkc,$queryKC,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKC()"','&nbsp&nbsp-------- Pilih Jenis --------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKC()' title='Baru' >";$cek.=$queryJenis;
	...
	global $Main;
		...
		$content->unit=cmbQuery('fmKD',$fmkd,$queryKD,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKD()"','&nbsp&nbsp-------- Pilih Sub Objek --------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKD()' title='Baru' >";$cek.=$queryJenis;
	...
	//	$fmJenis2 = $_REQUEST['fmJenis2'];
		...
		$content->unit=cmbQuery('fmKB',$kbnew,$queryKB,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKB()"','&nbsp&nbsp-------- Pilih Kelompok -------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKB()' title='Baru' >";
	...
	//	$fmJenis2 = $_REQUEST['fmJenis2'];
		...
		$content->unit=cmbQuery('fmKC',$kcnew,$queryKC,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKC()"','&nbsp&nbsp-------- Pilih Jenis -------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKC()' title='Baru' >";
	...
	//	$fmJenis2 = $_REQUEST['fmJenis2'];
	 ...
	 $queryKD="SELECT n, concat(n,' . ', nm_rekening) as vnama  FROM ref_rekening WHERE k='$ka02' and l='$kb02' and m='$kc02' and n<>'00' and o='00'" ;
		...
		$content->unit=cmbQuery('fmKD',$kdnew,$queryKD,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKD()"','&nbsp&nbsp-------- Pilih Objek -------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKD()' title='Baru' >";
	 ...
	 //items ----------------------
	  $this->form_fields = array(
			...
			'Kelompok' => array( 
						...
						<input type='text' name='rekening' id='rekening' value='".$datak1."' style='width:480px;' readonly>
			...
			'kode_kelompok' => array( 
						...
						<input type='text' name='nama' id='nama' value='".$nama."' placeholder='Nama Kode Kelompok' style='width:445px;'>
						</div>", 
						 ),		
	 ...
	 //items ----------------------
	  $this->form_fields = array(
			...
			'kode_akun' => array( 
						...
						'labelWidth'=>100, 
						'value'=>"<div style='float:left;'>
						<input type='text' name='Akun' id='Akun' value='".$datak1."' style='width:480px;' readonly>
			...
			'kode_objek' => array( 
						...
						<input type='text' name='nama' id='nama' value='".$nama."' placeholder='Nama Kode Objek' style='width:445px;'>
						</div>", 
						 ),		
...
//		
	 ...
	 //items ----------------------
	  $this->form_fields = array(
			...
			'kode_Akun' => array( 
						...
						'labelWidth'=>120, 
						'value'=>
						"<div id='cont_ka'>".cmbQuery('fmKA',$ka,$queryKA,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKA()"','-------- Pilih Kode Rekening ------------------')."</div>",
						 ),	
			...
			'kode_kelompok' => array( 
						...
						'labelWidth'=>100, 
						'value'=>
						"<div id='cont_kb'>".cmbQuery('fmKB',$kb,$queryKB,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKB()"','-------- Pilih Kode Kelompok ------------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKB()' title='Kode Kelompok' ></div>",
						 ),
			...
			'kode_Jenis' => array( 
						...
						'labelWidth'=>100, 
						'value'=>
						"<div id='cont_kc'>".cmbQuery('fmKC',$kc,$queryKC,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKC()"','-------- Pilih Kode Jenis --------------------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKC()' title='kode jenis' ></div>",
						 ),	
			...
			'kode_Objek' => array( 
						...
						'labelWidth'=>100, 
						'value'=>
						"<div id='cont_kd'>".cmbQuery('fmKD',$kd,$queryKD,'style="width:500px;"onchange="'.$this->Prefix.'.pilihKD()"','-------- Pilih Kode Objek ---------------')."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"."<input type='button' value='Baru' onclick ='".$this->Prefix.".BaruKD()' title='Kode Objek' ></div>",
						 ),		
			'Kode_Rincian_Objek' => array( 
						'label'=>'Kode Rincian Objek',
						'labelWidth'=>100, 
						...
						<input type='text' name='nama' id='nama' value='".$nama."' placeholder='Nama Kode Rincian Objek' style='width:449px;'>
						</div>", 
						 ),		
			/*'Kode_Rincian_Objek' => array( 
						'label'=>'Kode Rincian Objek',
	...
	function setKolomHeader($Mode=1, $Checkbox=''){
	 ...
	 $headerTable =
	  "<thead>
	   ...
	   <th class='th01' width='400'  width='100'>Kode</th>
	...
	$kode_rekening=$isi['k'].'.'.$isi['l'].'.'.$isi['m'].'.'.$isi['n'].'.'.$isi['o'];
	 $Koloms[] = array('align="center" width="" ',"<a style='cursor:pointer;' onclick=ref_rekening3.windowSave('$kode_rekening')>".$kode_rekening."</a>");
	...
	$filterRekening = cekPOST('filterRekening');		
	...
	if(!empty($_POST['filterRekening'])) {
		$arrakun = explode('.',$filterRekening);
		if($arrakun['0'] <> '') {
			$fmBIDANG = $arrakun['0'];
			$get = mysql_fetch_array(mysql_query(
				"select k,l,m,n,o,nm_rekening from ref_rekening where k='$fmBIDANG' and l='0'"));// $vthnakun "
				
			
			$listBidang = $get['k'].'. '. $get['nm_rekening']."<input type='hidden' id= 'fmBIDANG' name='fmBIDANG' value='$fmBIDANG' >";
		}
		if($arrakun['1'] <> '') {
			$fmKELOMPOK = $arrakun['1'];
			$get = mysql_fetch_array(mysql_query(
				"select k,l,m,n,o, nm_rekening from ref_rekening where k='$fmBIDANG' and l='$fmKELOMPOK' and m='0'")); //$vthnakun
				$cek.="select k,l,m,n,o, nm_rekening from ref_rekening where k='$fmBIDANG' and l='$fmKELOMPOK' and m='0'";
			
			$listKelompok = $get['k'].'.'.$get['l'].'. '. $get['nm_rekening']."<input type='hidden' id= 'fmKELOMPOK' name='fmKELOMPOK' value='$fmKELOMPOK' >";
		}
		if($arrakun['2'] <> ''){
			$fmSUBKELOMPOK = $arrakun['2'];
			$get = mysql_fetch_array(mysql_query(
				"select k,l,m,n,o, nm_rekening  from ref_rekening where k='$fmBIDANG' and l='$fmKELOMPOK' and m='$fmSUBKELOMPOK' and n='00'"));// $vthnakun
			
			$listSubKelompok = $get['k'].'.'.$get['l'].'.'.$get['m'].'. '.$get['nm_rekening']."<input type='hidden' id= 'fmSUBKELOMPOK' name='fmSUBKELOMPOK' value='$fmSUBKELOMPOK' >";
		}
		if($arrakun['3'] <> '') {
			$fmSUBSUBKELOMPOK = $arrakun['3'];
			$get = mysql_fetch_array(mysql_query(
				"select k,l,m,n,o, nm_rekening  from ref_rekening where k='$fmBIDANG' and l='$fmKELOMPOK' and m='$fmSUBKELOMPOK' and n='$fmSUBSUBKELOMPOK' and o='000'"));//$vthnakun 
				
			$listSubSubKelompok = $get['k'].'. '.$get['l'].'.'.$get['m'].'.'.$get['n'].'. '.$get['nm_rekening']."<input type='hidden' id= 'fmSUBSUBKELOMPOK' name='fmSUBSUBKELOMPOK' value='$fmSUBSUBKELOMPOK' >";
		}
		
	}
//	$cek .= " select ka,nm_account from ref_jurnal where ka<>'0' and kb='0'";// $vthnakun;  "; 
	if($arrakun['0'] == '') $listBidang = cmbQuery1("fmBIDANG",$fmBIDANG,"select k,nm_rekening from ref_rekening where k!='0' and l='0' ","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','');
	
	if($arrakun['1'] == '') $listKelompok = cmbQuery1("fmKELOMPOK",$fmKELOMPOK,"select l,nm_rekening from ref_rekening where k='$fmBIDANG' and l!='0' and m='0' ","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','');
	
	if($arrakun['2'] == '') $listSubKelompok = cmbQuery1("fmSUBKELOMPOK",$fmSUBKELOMPOK,"select m,nm_rekening from ref_rekening where k='$fmBIDANG' and l ='$fmKELOMPOK' and m!='0' and n='00' ","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','');
	
	if($arrakun['3'] == '') $listSubSubKelompok = cmbQuery1("fmSUBSUBKELOMPOK",$fmSUBSUBKELOMPOK,"select n,nm_rekening from ref_rekening where k='$fmBIDANG' and l ='$fmKELOMPOK' and m = '$fmSUBKELOMPOK' and n!='00' and o='000' ","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','');
	...
	$TampilOpt = 
			...
			<tr><td>
				...
				Nama Akun : <input type='text' id='fmRekening' name='fmRekening' value='".$fmRekening."' size=30px>&nbsp".
				"<input type='hidden' id='filterRekening' name='filterRekening' value='".$filterRekening."'>".
	...
	function getDaftarOpsi($Mode=1){
		...
		if(empty($fmBIDANG) && empty($fmKELOMPOK) && empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
		$arrKondisi[]= "k!=0 and l!=0 and m!=0 and n!=00 and o!=000";	
		}
		elseif(!empty($fmBIDANG) && empty($fmKELOMPOK) && empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
			$arrKondisi[]= "k =$fmBIDANG";	
		//	$arrKondisi[]= "k=$fmBIDANG and l!=0 and m!=0 and n!=00 and o!=000"; 		
		}
		elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
		...
		if(!empty($_POST['fmRekening'])) $arrKondisi[] = " nm_rekening like '%".$_POST['fmRekening']."%'";
		
		if(!empty($_POST['filterRekening'])) $arrKondisi[] = " concat(k,'.',l,'.',m,'.',n,'.',o) like '".$_POST['filterRekening']."%'";					
	...
	//	$arrKondisi[]= "ke !=0";
		...
		$arrOrders = array();
		switch($fmORDER1){
		//	case '': $arrOrders[] = " concat(k,l,m,n,o) $ASC " ;break;
			case '1': $arrOrders[] = " concat(k,l,m,n,o) $Asc1 " ;break;
			case '2': $arrOrders[] = " nama_barang $Asc1 " ;break;
		
		}

			$Order= join(',',$arrOrders);	
			$OrderDefault = ' order by k,l,m,n,o ';// Order By no_terima desc ';
	...
	function getDaftarOpsi($Mode=1){
		...
		elseif(!empty($fmBIDANG) && empty($fmKELOMPOK) && empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
			$arrKondisi[]= "k=$fmBIDANG and l!=0 and m!=0 and n!=00 and o!=000"; //$arrKondisi[]= "f =$fmBIDANG and g!=00 and h=00 and i=00 and j=00";			
		}
		elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
			$arrKondisi[]= "k =$fmBIDANG and l=$fmKELOMPOK and m!=0 and n!=00 and o!=000";//$arrKondisi[]= "f =$fmBIDANG and g=$fmKELOMPOK and h!=00 and i=00 and j=00";			
		}
		elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && !empty($fmSUBKELOMPOK) && empty($fmSUBSUBKELOMPOK))
		{
			$arrKondisi[]= "k =$fmBIDANG and l=$fmKELOMPOK and m=$fmSUBKELOMPOK and n!=00 and o!=000";//$arrKondisi[]= "f =$fmBIDANG and g=$fmKELOMPOK and h=$fmSUBKELOMPOK and i!=00 and j=00";				
		}
		elseif(!empty($fmBIDANG) && !empty($fmKELOMPOK) && !empty($fmSUBKELOMPOK) && !empty($fmSUBSUBKELOMPOK))
		{
			$arrKondisi[]= "k =$fmBIDANG and l=$fmKELOMPOK and m=$fmSUBKELOMPOK and n=$fmSUBSUBKELOMPOK and o!=000";//$arrKondisi[]= "f =$fmBIDANG and g=$fmKELOMPOK and h=$fmSUBKELOMPOK and i=$fmSUBSUBKELOMPOK and j!=00";			
		}
		if(!empty($_POST['fmKODE'])) $arrKondisi[] = " concat(k,'.',l,'.',m,'.',n,'.',o) like '".$_POST['fmKODE']."%'";					
...
$ref_rekening3 = new ref_rekening3Obj();
?>