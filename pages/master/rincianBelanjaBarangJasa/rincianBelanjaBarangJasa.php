	 	...
	 	$err ="Pilih Kode Rekening !";
				...
				if($err==''){
						...
						while($rows = mysql_fetch_array($getData)){
							...
							$query = VulnWalkerUpdate("ref_barang",$data,"f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1' ");
							mysql_query($query);
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if(mysql_num_rows(mysql_query("select * from ref_barang where k12='$k' and l12='$l' and m12='$m' and n12='$n' and o12='$o'")) == 0){
	    ...
	    while($dataBarang = mysql_fetch_array($getAllBarangFromRekening)){
	        ...
	        $kodeBarang = $dataBarang['f'].".".$dataBarang['g'].".".$dataBarang['h'].".".$dataBarang['i'].".".$dataBarang['j'].".".$dataBarang['j1'];
	        $syntax = "select * from ref_barang where concat(f,'.',g,'.',h,'.',i,'.',j,'.',j1) = '$kodeBarang'";
	        $getBarang = mysql_fetch_array(mysql_query($syntax));
	        $listNamaBarang.= $dataBarang['f'].".".$dataBarang['g'].".".$dataBarang['h'].".".$dataBarang['i'].".".$dataBarang['j'].".".$dataBarang['j1']." &nbsp ".$getBarang['nm_barang']."<br>";
	        $nomorUrut += 1;
	    }
	 }
	      ...
	      <td width=\"40%\" valign=\"top\"><h2>BARANG</h2>
	        <table>
	          <tr>".
	            ...
	            <td>".
	            cmbQuery1("cmbJenis",$cmbJenis,"select f as valueCmbJenis, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f != '00'  and g ='00' and h ='00' and i='00' and j = '000'  and f !='06' ","onChange=$this->Prefix.refreshList(true) ",'Pilih','').
	            "</td>
	            </tr><tr>
