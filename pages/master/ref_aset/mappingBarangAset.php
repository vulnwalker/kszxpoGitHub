...
class mappingBarangAsetObj  extends DaftarObj2{
	var $Prefix = 'mappingBarangAset';
	...
	var $FormName = 'mappingBarangAsetForm';

	function setTitle(){
		return 'Mapping Barang Aset';
	}
	...
	function setPage_OtherScript(){
		...
		return
			 "<script type='text/javascript' src='js/master/ref_aset/mappingBarangAset.js' language='JavaScript' ></script>".
...
$mappingBarangAset = new mappingBarangAsetObj();
