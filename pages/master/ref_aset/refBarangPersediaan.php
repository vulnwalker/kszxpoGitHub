...
class refBarangPersediaanObj  extends DaftarObj2{
	var $Prefix = 'refBarangPersediaan';
	...
	var $FormName = 'refBarangPersediaanForm';
	...
	function setPage_OtherScript(){
		...
		return
			 "<script type='text/javascript' src='js/master/ref_aset/refBarangPersediaan.js' language='JavaScript' ></script>".
...
$refBarangPersediaan = new refBarangPersediaanObj();
