...
class mappingBarangPersediaanObj  extends DaftarObj2{
	var $Prefix = 'mappingBarangPersediaan';
	...
	var $FormName = 'mappingBarangPersediaanForm';

	function setTitle(){
		return 'Mapping Barang Persediaan';
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'jenisChanged':{
		 ...
		 // if(empty($jenisChanged)){
			//  	$err = "Pilih Jenis Barang";
		 // }
		 // if(empty($err)){
			 		if($jenisBarang == "1"){
						...
						$isiSpanKodeBarang = " <input type='text' id='f' name='f' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$f' $chmod644> &nbsp <input type='text' id='g' name='g' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$g' $chmod644> &nbsp <input type='text' id='h' name='h' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$h' $chmod644> &nbsp <input type='text' id='i' name='i' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$i' $chmod644>
						&nbsp <input type='text' id='j' name='j' style='width:30px;' maxlength='3' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$j' $chmod644>
	...
	function setPage_OtherScript(){
		...
		return
			 "<script type='text/javascript' src='js/master/ref_aset/mappingBarangPersediaan.js' language='JavaScript' ></script>".
...
/*		$dt['residu'] = $dt['residu'] == '' ?0: $dt['residu'];
   ...
   // $comboJenisBarang = cmbArray('cmbJenisBarang',$jenisBarang,$arrayJenisbarang,'-- JENIS BARANG --',"onchange = $this->Prefix.jenisChanged();");
    $comboJenisBarang = "<input type='hidden' value='1' id='cmbJenisBarang' name='cmbJenisBarang' >";
...
/*			'' => array(
			...
			// 													 'label'=>'JENIS BARANG',
			// 													 'labelWidth'=>200,
			// 													 'value'=>$comboJenisBarang
			// ),
			'kode_barang' => array(
								'label'=>'KODE BARANG',
								'labelWidth'=>200,
								'value'=>"$comboJenisBarang<span id='spanKodeBarang'> <input type='text' id='f' name='f' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$f' $chmod644> &nbsp <input type='text' id='g' name='g' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$g' $chmod644> &nbsp <input type='text' id='h' name='h' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$h' $chmod644> &nbsp <input type='text' id='i' name='i' style='width:25px;' maxlength='2' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$i' $chmod644> &nbsp <input type='text' id='j' name='j' style='width:30px;' maxlength='3' onkeypress='return event.charCode >= 48 && event.charCode <= 57' value='$j' $chmod644>$inputanPersediaan
								</span>
								 &nbsp
									"
									 ),
			...
			'nama_barang' => array(
								...
								'type'=>'text',
								'id'=>'nama_barang',
								'param'=>"style='width:250ppx;' size=50px readonly"
									 ),
			'satuan' => array(
								'label'=>'SATUAN',
								'labelWidth'=>250,
...
$mappingBarangPersediaan = new mappingBarangPersediaanObj();
