...
class standarSatuanHargaObj  extends DaftarObj2{
	...
	$NomorColSpan = $Mode==1? 2: 1;
	 $headerTable =
	  "<thead>
	   ...
	   <th class='th01' width='200' align='center'>KODE BARANG</th>
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $textSpanKodeBarang = $kodeBarang."<br>".$getDataBarang['nm_barang'];
	...
	$TampilOpt =
			...
			<tr><td>
				Uraian : <input type='text' id='filterUraian' name='filterUraian' value='".$filterUraian."' size=30px>&nbsp
