...
class ref_gudangObj  extends DaftarObj2{	
	var $Prefix = 'ref_gudang';
	...
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='ref_gudang.xls';
	var $Cetak_Judul = 'GUDANG';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'ref_gudangForm'; 
	var $kdbrg = '';	
	...
	//get data -----------------
	 ...
	 //if( $err=='' && $id_gudang =='' ) $err= 'id gudang Belum Di Isi !!';
	 if( $err=='' && $nama_gudang =='') $err= 'nama gudang Belum Di Isi !!';
	...
	function setPage_OtherScript(){
		...
		return 
			 ...
			 <script type='text/javascript' src='js/master/ref_gudang/".strtolower($this->Prefix).".js' language='JavaScript' ></script>
			 ".
   ...
   $dt=array();
	...
	/* global $SensusTmp, $Main;
	 ...
	 $this->form_height = 100;
	  if ($this->form_fmST==0) {
		...
		$id_gudang=$dt['id_gudang'];
		$nama_gudang=$dt['nm_gudang'];
       ...
       //items ----------------------
		 $this->form_fields = array(
			...
			/*'ID' => array( 
						...
						'value'=>"<input type='text' name='id_gudang' id='id_gudang' size='50' maxlength='50' value='".$id_gudang."'>",
			...
			'Nama' => array( 
						...
						'value'=>"<input type='text' name='nama_gudang' id='nama_gudang' size='50' maxlength='50' value='".$nama_gudang."'>",
						'row_params'=>"valign='top'",
						'type'=>'' 
									 ),					 
			);
	 ...
	 $headerTable =
	  "<thead>
	   <tr>
  	   ...
  	   $Checkbox		
	   <th class='th01' width='200' colspan='4'>Kode SKPD</th>
	   
	   <th class='th01' width='400' align='center'>Nama Gudang</th>
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="center" width="100" ',genNumber($isi['c'],2));
	 $Koloms[] = array('align="center" width="100" ',genNumber($isi['d'],2));
	 $Koloms[] = array('align="center" width="100" ',genNumber($isi['e'],2));
	 $Koloms[] = array('align="center" width="100" ',genNumber($isi['e1'],3));
	 //$Koloms[] = array('align="left"',$isi['id_gudang']);
	 $Koloms[] = array('align="left"',$isi['nm_gudang']);
	...
	function getDaftarOpsi($Mode=1){
		...
		$fmPILCARI = $_REQUEST['fmPILCARI'];	
		$fmPILCARIvalue = $_REQUEST['fmPILCARIvalue'];
		$ref_gudangSkpdfmSEKSI = $_REQUEST['ref_gudangSkpdfmSEKSI'];//ref_skpdSkpdfmSKPD
		$ref_gudangSkpdfmSKPD = $_REQUEST['ref_gudangSkpdfmSKPD'];
		$ref_gudangSkpdfmUNIT = $_REQUEST['ref_gudangSkpdfmUNIT'];
		$ref_gudangSkpdfmSUBUNIT = $_REQUEST['ref_gudangSkpdfmSUBUNIT'];
		//Cari 
		...
		switch($fmPILCARI){			
			...
			case 'selectNama': $arrKondisi[] = " nm_gudang like '%$fmPILCARIvalue%'"; break;	
								 	
		}	
		if($ref_gudangSkpdfmSKPD!='00' and $ref_gudangSkpdfmSKPD !='')$arrKondisi[]= "c='$ref_gudangSkpdfmSKPD'";
		if($ref_gudangSkpdfmUNIT!='00' and $ref_gudangSkpdfmUNIT !='')$arrKondisi[]= "d='$ref_gudangSkpdfmUNIT'";
		if($ref_gudangSkpdfmSUBUNIT!='00' and $ref_gudangSkpdfmSUBUNIT !='')$arrKondisi[]= "e='$ref_gudangSkpdfmSUBUNIT'";
		if($ref_gudangSkpdfmSEKSI!='00' and $ref_gudangSkpdfmSEKSI !='')$arrKondisi[]= "e1='$ref_gudangSkpdfmSEKSI'";
		/*$arrKondisi = array();		
		...
		switch($fmORDER1){
			...
			case '2': $arrOrders[] = " nm_gudang $Asc1 " ;break;
