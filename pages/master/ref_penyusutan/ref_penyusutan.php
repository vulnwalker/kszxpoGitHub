...
class ref_penyusutanObj  extends DaftarObj2{	
	var $Prefix = 'ref_penyusutan';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'ref_penyusutan'; //daftar
	var $TblName_Hapus = 'ref_penyusutan';
	var $MaxFlush = 10;
	...
	var $PageTitle = 'Referensi Penyusutan';
	...
	var $FormName = 'ref_penyusutanForm'; 
	var $kdbrg = '';	
	...
	function setPage_OtherScript(){
		...
		return 
			 ...
			 <script type='text/javascript' src='js/master/ref_penyusutan/".strtolower($this->Prefix).".js' language='JavaScript' ></script>
			 ".
	...
	/* global $SensusTmp, $Main;
	 ...
	 $this->form_height = 120;
	  if ($this->form_fmST==0) {
		...
		$nilai_sisa=number_format($dt['residu'],2,",",".");
       //items ----------------------
		 $this->form_fields = array(
			...
			'nilai' => array( 
						...
						'value'=>//number_format($dt['residu'],2,",",".")
					//	inputFormatRibuan3("number_format($dt['residu'],2,",",".")")
						"<input type='text' name='residu' id='residu' size='35' maxlength='50' value='".floatval($dt['residu'])."'>"
						,
						'row_params'=>"valign='top'",
						'type'=>'' 
									 ),
			'masa' => array( 
					...
					//	 inputFormatRibuan3("masa_manfaat")
						"<input type='text' name='masa_manfaat' id='masa_manfaat' size='35' maxlength='50' value='".floatval($dt['masa_manfaat'])."'>"
						,
						'row_params'=>"valign='top'",
						'type'=>'' 
	...
	$NomorColSpan = $Mode==1? 2: 1;
	 $headerTable =
	  "<thead>
	   ...
	   <th class='th01' width='350' align='center'>Nama Barang</th>
	   <th class='th01' width='350' align='center'>Estimasi Nilai Sisa (%)</th>
	   <th class='th01' width='350' align='center'>Estimasi Masa Manfaat (thn)</th>
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="center"',$isi['residu']);
	...
	function getDaftarOpsi($Mode=1){
		...
		switch($fmPILCARI){
			...
			case 'selecttshun': $arrKondisi[] = " tahun like '%".$fmPILCARIvalue."%'"; break;					 	
		}
...
$ref_penyusutan = new ref_penyusutanObj();
