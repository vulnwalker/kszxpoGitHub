...
class listBarangBelanjaModalObj  extends DaftarObj2{
 ...
 function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/master/refstdbutuh/listBarangBelanjaModal.js' language='JavaScript' ></script>
...
function setKolomHeader($Mode=1, $Checkbox=''){
	...
	$TampilOpt =
			...
			<td>".
			cmbQuery1("cmbJenis",$cmbJenis,"select f as valueCmbJenis, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f != '00'  and g ='00' and h ='00' and i='00' and j = '000' and f !='06' and f !='07' and f !='08'","onChange=listBarangBelanjaModal.refreshList(true) ",'Pilih','').
			"</td>
			</tr><tr>
