...
if((sudahClosing($tgl_buku,$fmSKPD,$fmUNIT,$fmSUBUNIT,$fmSEKSI,$fmURUSAN)) || ($old['id']<>$old['idawal']) || ($old['status_aset']=='2' || $old['staset']=='7') || ($old['refid_terima']<>'' || $old['refid_terima']<>'0')){
	$readonly="readonly";
}	
//get jml transaksi
