...
$fmLUAS_KIB_A = cekPOST("fmLUAS_KIB_A");
	...
	$fmBLOK_KIB_A = cekPOST("fmBLOK_KIB_A");
	$fmPERSIL_KIB_A = cekPOST("fmPERSIL_KIB_A");
...
if ($errmsg==''  && $Main->CEK_BI==1){
			$errmsg = cekBI($fmIDLama);
if ($errmsg!= '') $errmsg = 'Warning, ID Barang '.$fmIDLama. ' tidak bisa diedit! ( '.$errmsg.' ) Harap hubungi Admin';
		}
