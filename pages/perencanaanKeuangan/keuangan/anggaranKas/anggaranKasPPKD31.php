...
class anggaranKasPPKD31Obj  extends DaftarObj2{
	var $Prefix = 'anggaranKasPPKD31';
	...
	var $pagePerHal ='';
	//var $cetak_xls=TRUE ;
	var $fileNameExcel='anggaranKasPPKD31.xls';
	var $namaModulCetak='DPA';
	var $Cetak_Judul = 'DPA';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'anggaranKasPPKD31Form';
	var $modul = "DPA";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setTitle(){
		return 'ANGGARAN KAS PPKD PEMBIAYAAN PENERIMAAN '.$this->jenisAnggaran.' TAHUN '.$this->tahun;
	}
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'sync':{
				if($this->jenisForm == 'READ'){
						...
						while($subRincian = mysql_fetch_array($getAllSubRincian)){
									$queryCekProgram = "select * from view_dpa_ppkd_3_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$subRincian['bk']."' and ck ='".$subRincian['ck']."' and dk='".$subRincian['dk']."' and p ='".$subRincian['p']."' and q='0' and id_tahap='$this->idTahap' ";
									...
									$queryCekKegiatan= "select * from view_dpa_ppkd_3_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$subRincian['bk']."' and ck ='".$subRincian['ck']."' and dk='".$subRincian['dk']."' and p ='".$subRincian['p']."' and q='".$subRincian['q']."' and id_tahap='$this->idTahap' ";
		...
		case 'Remove':{
			$id = $_REQUEST['anggaranKasPPKD31_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			}
			...
			$getAll = mysql_query("select * from view_dpa_ppkd_3_1 where concat(k,'.',l,'.',m,'.',n,'.',o) ='$kodeRek' and id_tahap='$this->idTahap' and (rincian_perhitungan !='' or f!='00' )   and c1='$cmbUrusan' and c='$cmbBidang' and d='$cmbSKPD' and e='$cmbUnit' and e1='$cmbSubUnit' and bk='$bk' and ck='$ck' and p='$hiddenP' and q='$q' order by o1, rincian_perhitungan");
		...
		case 'checkAlokasi':{
			...
			$d = $cmbSKPD;
			$p = $hiddenP;
			$terpilih = $anggaranKasPPKD31_cb[0];
			...
			if($this->jenisForm != "READ"){
				...
				$o = $getKodeRekening['o'];
				$jenisAlokasi = "";
				if(mysql_num_rows(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$p' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka = '3.1' and jenis_dpa = 'DPA-PPKD'")) != 0){
					$getAlokasi = mysql_fetch_array(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$p' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka = '3.1' and jenis_dpa = 'DPA-PPKD'"));
			...
			if($this->jenisForm != "READ"){
				...
				if($err == ""){
					...
					if(mysql_num_rows(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$p' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_rka ='3.1'  and jenis_dpa = 'DPA-PPKD'")) == 0){
						...
						$grepId = mysql_fetch_array(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$c1' and c='$c' and d ='$d' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$p' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o'  and jenis_dpa = 'DPA-PPKD' and jenis_rka = '3.1'"));
						$id = $grepId['id'];
						$data = array(
										'jenis_alokasi_kas' => $jenisAlokasi,
										"alokasi_jan" => $jan,
	 ...
	 function setPage_HeaderOther(){
		 ...
		 <A href=\"pages.php?Pg=anggaranKasPPKD221\" title='BELANJA' > BELANJA </a> |
		 <A href=\"pages.php?Pg=anggaranKasPPKD1PAD\" title='PENDAPATAN' > PENDAPATAN </a> |
		 <A href=\"pages.php?Pg=anggaranKasPPKD31\" title='PEMBIAYAAN'  style='color:blue;' > PEMBIAYAAN </a>

		 &nbsp&nbsp&nbsp
		 </td></tr>

		 <tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		 <A href=\"pages.php?Pg=anggaranKasPPKD31\" title='PENERIMAAN' style='color:blue;' > PENERIMAAN </a> |
		 <A href=\"pages.php?Pg=anggaranKasPPKD32\" title='PENGELUARAN'  > PENGELUARAN </a>
   ...
   function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/anggaranKas/anggaranKasPPKD31.js' language='JavaScript' ></script>
	...
	function Info(){
	 ...
	 $this->form_caption = 'INFO ALOKASI DPA-PPKD 3.1';
	 ...
	 $this->form_height = 400;
	  if ($this->form_fmST==0) {
		...
		foreach ($dt as $key => $value) {
		 ...
		 $jenis_rka = $jenis_rka;
		 $cmbJenisDPA = cmbArray('cmbJenisDPAForm',$jenis_rka,$arrayJenisDPA,'-- JENIS DPA --','onchange=anggaranKasPPKD31.unlockFindRekening();');
	 	 if(empty($jenis_rka)){
	  ...
	  $this->form_fields = array(
			...
			'kode7' => array(
						...
						'value'=> "<input type='text' id='kodeRekening' name='kodeRekening' style='width:120px;' readonly value = '$kodeRekening'> &nbsp&nbsp
						 ...
						 <button type='button' id='findRekening' onclick=anggaranKasPPKD31.findRekening('$jenis_rka'); $tergantungJenis> CARI </button> "
						 ),
			'kode8' => array(
						'label'=>'HARGA SATUAN',
						'labelWidth'=>150,
						'value'=> "<input type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='anggaranKasPPKD31.bantu();' > <span id='bantu' style='color:red;'> </span>"
						 ),
...
/*		 $arrayResult = VulnWalkerTahap_v2('RKA');
	...
	$Koloms = array();
			...
			// $marginStatus = "20px;";
			 ...
			 $getDataAnggaranKas = mysql_fetch_array(mysql_query("select * from anggaran_kas where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and jenis_dpa = 'DPA-PPKD' $kondisiSKPD and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and k='$k' and l='$l' and m='$m' and n='$n' and o='$o' "));
	...
	foreach ($_COOKIE as $key => $value) {
	  ...
	  $urusan = cmbQuery('cmbUrusan',$selectedC1,$codeAndNameUrusan,'onchange=anggaranKasPPKD31.refreshList(true);','-- URUSAN --');

	  $codeAndNameBidang = "select c, concat(c, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c !='00' and d='00' and e='00' and e1='000' ";
	  $bidang = cmbQuery('cmbBidang',$selectedC,$codeAndNameBidang,'onchange=anggaranKasPPKD31.refreshList(true);','-- BIDANG --');

	  $codeAndNameSKPD = "select d, concat(d, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c='$selectedC' and d!='00' and e='00' and e1='000' ";
	  $skpd= cmbQuery('cmbSKPD',$selectedD,$codeAndNameSKPD,'onchange=anggaranKasPPKD31.refreshList(true);','-- SKPD --');
...
function Laporan($xls =FALSE){
		...
		$arrKondisi[] = "c1 = '$cmbUrusan'";
  		...
  		$arrKondisi[] = "c1 != '0'";
			...
			$getIDTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where no_urut ='$this->urutTerakhir' and tahun ='$this->tahun' and anggaran='$this->jenisAnggaran'"));
				...
				$getAllParent = mysql_query("select * from view_dpa_ppkd_3_1 where id_tahap ='$idTahap'  and o1 !='0' and k='0' and n='0' and j='000'  ");
				while($rows = mysql_fetch_array($getAllParent)){
					foreach ($rows as $key => $value) {
				 	 $$key = $value;
					}
					$cekPekerjaan = mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where o1 = '$o1' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or j!='000') "));
					if($cekPekerjaan == 0){
						$arrKondisi[] = "o1 !='$o1'";
					}else{
						...
						while($row2s = mysql_fetch_array($getAllRekening)){
							...
							$cekRekening = mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where k ='$k' and l='$l' and m='$m' and n='$n' and o='$o' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or j!='000') "));
							if($cekRekening == 0){
								$concat = $k.".".$l.".".$m.".".$n.".".$o;
								...
								while($row3s = mysql_fetch_array($getAllProgram)){
									...
									$cekProgram = mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where bk ='$bk' and ck='$ck' and p='$p' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or j!='000') "));
									if($cekProgram == 0){
										$concat = $bk.".".$ck.".".$p;
										...
										while($row4s = mysql_fetch_array($getAllKegiatan)){
											...
											$cekKegiatan = mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_tahap ='$idTahap' $kondisiRekening $kondisiSKPD and (rincian_perhitungan !='' or j!='000') "));
											if($cekKegiatan == 0){
												$concat = $bk.".".$ck.".".$p;
												$arrKondisi[] = "concat(bk,'.',ck,'.',p)  !='$concat'";
											}else{
				...
				$grabNonMapingRekening= mysql_query("select * from view_dpa_ppkd_3_1 where id_tahap ='$idTahap' and (LENGTH(k) > 1) and j='000'");
				while($got = mysql_fetch_array($grabNonMapingRekening)){
					if(mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where id_tahap ='$idTahap' and k ='".$got['k']."' and l ='".$got['l']."' and m ='".$got['m']."' and n ='".$got['n']."' and o ='".$got['o']."' and ( rincian_perhitungan !='' or  j!='000' ) $kondisiRekening $kondisiSKPD ")) != 0){
						$arrKondisi[] = "id_tahap = '$idTahap' or id_anggaran ='".$got['id_anggaran']."'";
					}

				}

				$grabNonHostedRekening= mysql_query("select * from view_dpa_ppkd_3_1 where id_tahap ='$idTahap' and (LENGTH(k) = 1 and k !='0') and j='000'");
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			$grabWihtCondition = mysql_query("select * from view_dpa_ppkd_3_1 where $Kondisi group by c1,c,d,bk,ck,p,q,k,l,m,n,o,catatan,id_jenis_pemeliharaan");
				while($rows = mysql_fetch_array($grabWihtCondition)){
			 	...
			 	if(in_array($grubId, $this->publicGrupId)) {
					    $jumlah_harga = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from view_dpa_ppkd_3_1 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and id_tahap = '$idTahap' "));
				 		$jumlah_harga= $jumlah_harga['sum(jumlah_harga)'];
						$volume_rek  = mysql_fetch_array(mysql_query("select sum(volume_rek) from view_dpa_ppkd_3_1 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and id_tahap = '$idTahap' "));
			...
			if(in_array($id_anggaran, $this->publicExcept)) {
				...
				";
				}elseif($j != '000' && mysql_num_rows(mysql_query("select * from view_dpa_ppkd_3_1 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and id_tahap = '$idTahap' ")) > 1 ){
					echo "";
				}else{
					echo "
								<tr valign='top'>
...
function formAlokasi($dt){
	...
	$arrayJenisPerhitungan = array(
	 ...
	 $this->publicSum = "select sum(jumlah_harga) from tabel_anggaran where (rincian_perhitungan !='' or f !='00' ) and id_tahap='$this->idTahap' and tahun ='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and jenis_rka ='3.1' and nama_modul = 'DPA-PPKD' and c1= '$cmbUrusan' and c ='$cmbBidang' and d='$cmbSKPD' and bk = '$bk' and ck ='$ck' and dk ='$dk' and p = '$hiddenP' and q='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' ";
	 $getSumJumlah = mysql_fetch_array(mysql_query($this->publicSum));
	 $jumlahHargaForm =$getSumJumlah['sum(jumlah_harga)'];
	 if(mysql_num_rows(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka ='3.1' and jenis_dpa = 'DPA-PPKD'")) != 0 ){
	 	$grabSPD = mysql_fetch_array(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and  k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka ='3.1' and jenis_dpa = 'DPA-PPKD'"));
...
function formAlokasiTriwulan(){
	...
	$arrayJenisPerhitungan = array(
	 ...
	 if(mysql_num_rows(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$hiddenP' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka ='3.1' and jenis_dpa = 'DPA-PPKD'")) != 0 ){
	 	$grabSPD = mysql_fetch_array(mysql_query("select * from anggaran_kas where tahun ='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 ='$cmbUrusan' and c='$cmbBidang' and d ='$cmbSKPD' and bk ='$bk' and ck ='$ck' and dk ='$dk' and p='$hiddenP' and q ='$q' and k='$k' and l='$l' and m='$m' and n ='$n' and o ='$o' and jenis_rka ='3.1' and jenis_dpa = 'DPA-PPKD'"));
		foreach ($grabSPD as $key => $value) {
				  $$key = $value;
		}
		$jan = $alokasi_jan;
...
$anggaranKasPPKD31 = new anggaranKasPPKD31Obj();


$arrayResult = VulnWalkerTahap_v2($anggaranKasPPKD31->modul);
$jenisForm = $arrayResult['jenisForm'];
$nomorUrut = $arrayResult['nomorUrut'];
$tahun = $arrayResult['tahun'];
$jenisAnggaran = $arrayResult['jenisAnggaran'];
...
$anggaranKasPPKD31->jenisForm = $jenisForm;
$anggaranKasPPKD31->nomorUrut = $nomorUrut;
$anggaranKasPPKD31->urutTerakhir = $nomorUrut;
$anggaranKasPPKD31->tahun = $tahun;
$anggaranKasPPKD31->jenisAnggaran = $jenisAnggaran;
$anggaranKasPPKD31->idTahap = $idTahap;

$anggaranKasPPKD31->username = $_COOKIE['coID'];


if(empty($anggaranKasPPKD31->tahun)){
	...
	/*$anggaranKasPPKD31->tahun = "select max(id_anggaran) as max from view_dpa_ppkd_3_1 where nama_modul = 'anggaranKasPPKD31'";*/
	$anggaranKasPPKD31->tahun  = $get2['tahun'];
	$anggaranKasPPKD31->jenisAnggaran = $get2['jenis_anggaran'];
	$anggaranKasPPKD31->urutTerakhir = $get2['no_urut'];
	$anggaranKasPPKD31->jenisFormTerakhir = $get2['jenis_form_modul'];
	$anggaranKasPPKD31->urutSebelumnya = $anggaranKasPPKD31->urutTerakhir - 1;
	...
	$anggaranKasPPKD31->namaTahapTerakhir = $namaTahap['nama_tahap'];
	...
	$anggaranKasPPKD31->masaTerakhir = $lastTanggalMulai." JAM : ".$namaTahap['jam_mulai']."  s/d  ".$lastTanggalSelesai." JAM : ".$namaTahap['jam_selesai'];

	$arrayHasil =  VulnWalkerLASTTahap_v2();
	$anggaranKasPPKD31->currentTahap = $arrayHasil['currentTahap'];
}else{
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$anggaranKasPPKD31->idTahap'"));
	$anggaranKasPPKD31->currentTahap = $getCurrenttahap['nama_tahap'];

	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$anggaranKasPPKD31->idTahap'"));
	$anggaranKasPPKD31->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$anggaranKasPPKD31->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$arrayMasa = explode("-",$namaTahap['tanggal_mulai']);
	$lastTanggalMulai = $arrayMasa[2]."-".$arrayMasa[1]."-".$arrayMasa[0];
	$arrayMasa2 = explode("-",$namaTahap['tanggal_selesai']);
...
$anggaranKasPPKD31->provinsi = $setting['provinsi'];
$anggaranKasPPKD31->kota = $setting['kota'];
$anggaranKasPPKD31->pengelolaBarang = $setting['pengelolaBarang'];
$anggaranKasPPKD31->pejabatPengelolaBarang = $setting['pejabat'];
$anggaranKasPPKD31->pengurusPengelolaBarang = $setting['pengurus'];
$anggaranKasPPKD31->nipPengelola = $setting['nipPengelola'];
$anggaranKasPPKD31->nipPengurus = $setting['nipPengurus'];
$anggaranKasPPKD31->nipPejabat = $setting['nipPejabat'];
