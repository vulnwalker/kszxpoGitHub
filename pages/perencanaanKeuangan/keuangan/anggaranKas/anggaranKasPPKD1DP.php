...
class anggaranKasPPKD1DPObj  extends DaftarObj2{
	var $Prefix = 'anggaranKasPPKD1DP';
	...
	var $pagePerHal ='';
	//var $cetak_xls=TRUE ;
	var $fileNameExcel='anggaranKasPPKD1DP.xls';
	var $namaModulCetak='DPA';
	var $Cetak_Judul = 'DPA';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'anggaranKasPPKD1DPForm';
	var $modul = "DPA";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setTitle(){
		return 'ANGGARAN KAS PPKD DANA PERIMBANGAN '.$this->jenisAnggaran.' TAHUN '.$this->tahun;
	}
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'Remove':{
			$id = $_REQUEST['anggaranKasPPKD1DP_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			}
		...
		case 'checkAlokasi':{
			...
			$d = $cmbSKPD;
			$p = $hiddenP;
			$terpilih = $anggaranKasPPKD1DP_cb[0];
	 ...
	 function setPage_HeaderOther(){
		 	...
		 	<A href=\"pages.php?Pg=anggaranKasPPKD1DP\" title='PENDAPATAN'  style='color:blue;'> PENDAPATAN </a> |
		 	...
		 	<A href=\"pages.php?Pg=anggaranKasPPKD1DP\" title='DANA PERIMBANGAN' style='color:blue;' > DANA PERIMBANGAN </a> |
   ...
   function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/anggaranKas/anggaranKasPPKD1DP.js' language='JavaScript' ></script>
	 ...
	 $this->form_height = 400;
	  if ($this->form_fmST==0) {
		...
		foreach ($dt as $key => $value) {
		 ...
		 $jenis_rka = $jenis_rka;
		 $cmbJenisDPA = cmbArray('cmbJenisDPAForm',$jenis_rka,$arrayJenisDPA,'-- JENIS DPA --','onchange=anggaranKasPPKD1DP.unlockFindRekening();');
	 	 if(empty($jenis_rka)){
	  ...
	  $this->form_fields = array(
			...
			'kode7' => array(
						...
						'value'=> "<input type='text' id='kodeRekening' name='kodeRekening' style='width:120px;' readonly value = '$kodeRekening'> &nbsp&nbsp
						 ...
						 <button type='button' id='findRekening' onclick=anggaranKasPPKD1DP.findRekening('$jenis_rka'); $tergantungJenis> CARI </button> "
						 ),
			'kode8' => array(
						'label'=>'HARGA SATUAN',
						'labelWidth'=>150,
						'value'=> "<input type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='anggaranKasPPKD1DP.bantu();' > <span id='bantu' style='color:red;'> </span>"
						 ),
...
/*		 $arrayResult = VulnWalkerTahap_v2('RKA');
	...
	foreach ($_COOKIE as $key => $value) {
	  ...
	  $urusan = cmbQuery('cmbUrusan',$selectedC1,$codeAndNameUrusan,'onchange=anggaranKasPPKD1DP.refreshList(true);','-- URUSAN --');

	  $codeAndNameBidang = "select c, concat(c, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c !='00' and d='00' and e='00' and e1='000' ";
	  $bidang = cmbQuery('cmbBidang',$selectedC,$codeAndNameBidang,'onchange=anggaranKasPPKD1DP.refreshList(true);','-- BIDANG --');

	  $codeAndNameSKPD = "select d, concat(d, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c='$selectedC' and d!='00' and e='00' and e1='000' ";
	  $skpd= cmbQuery('cmbSKPD',$selectedD,$codeAndNameSKPD,'onchange=anggaranKasPPKD1DP.refreshList(true);','-- SKPD --');
...
$anggaranKasPPKD1DP = new anggaranKasPPKD1DPObj();


$arrayResult = VulnWalkerTahap_v2($anggaranKasPPKD1DP->modul);
$jenisForm = $arrayResult['jenisForm'];
$nomorUrut = $arrayResult['nomorUrut'];
$tahun = $arrayResult['tahun'];
$jenisAnggaran = $arrayResult['jenisAnggaran'];
...
$anggaranKasPPKD1DP->jenisForm = $jenisForm;
$anggaranKasPPKD1DP->nomorUrut = $nomorUrut;
$anggaranKasPPKD1DP->urutTerakhir = $nomorUrut;
$anggaranKasPPKD1DP->tahun = $tahun;
$anggaranKasPPKD1DP->jenisAnggaran = $jenisAnggaran;
$anggaranKasPPKD1DP->idTahap = $idTahap;

$anggaranKasPPKD1DP->username = $_COOKIE['coID'];


if(empty($anggaranKasPPKD1DP->tahun)){
	...
	/*$anggaranKasPPKD1DP->tahun = "select max(id_anggaran) as max from view_dpa_ppkd_1 where nama_modul = 'anggaranKasPPKD1DP'";*/
	$anggaranKasPPKD1DP->tahun  = $get2['tahun'];
	$anggaranKasPPKD1DP->jenisAnggaran = $get2['jenis_anggaran'];
	$anggaranKasPPKD1DP->urutTerakhir = $get2['no_urut'];
	$anggaranKasPPKD1DP->jenisFormTerakhir = $get2['jenis_form_modul'];
	$anggaranKasPPKD1DP->urutSebelumnya = $anggaranKasPPKD1DP->urutTerakhir - 1;
	...
	$anggaranKasPPKD1DP->namaTahapTerakhir = $namaTahap['nama_tahap'];
	...
	$anggaranKasPPKD1DP->masaTerakhir = $lastTanggalMulai." JAM : ".$namaTahap['jam_mulai']."  s/d  ".$lastTanggalSelesai." JAM : ".$namaTahap['jam_selesai'];

	$arrayHasil =  VulnWalkerLASTTahap_v2();
	$anggaranKasPPKD1DP->currentTahap = $arrayHasil['currentTahap'];
}else{
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$anggaranKasPPKD1DP->idTahap'"));
	$anggaranKasPPKD1DP->currentTahap = $getCurrenttahap['nama_tahap'];

	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$anggaranKasPPKD1DP->idTahap'"));
	$anggaranKasPPKD1DP->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$anggaranKasPPKD1DP->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$arrayMasa = explode("-",$namaTahap['tanggal_mulai']);
	$lastTanggalMulai = $arrayMasa[2]."-".$arrayMasa[1]."-".$arrayMasa[0];
	$arrayMasa2 = explode("-",$namaTahap['tanggal_selesai']);
...
$anggaranKasPPKD1DP->provinsi = $setting['provinsi'];
$anggaranKasPPKD1DP->kota = $setting['kota'];
$anggaranKasPPKD1DP->pengelolaBarang = $setting['pengelolaBarang'];
$anggaranKasPPKD1DP->pejabatPengelolaBarang = $setting['pejabat'];
$anggaranKasPPKD1DP->pengurusPengelolaBarang = $setting['pengurus'];
$anggaranKasPPKD1DP->nipPengelola = $setting['nipPengelola'];
$anggaranKasPPKD1DP->nipPengurus = $setting['nipPengurus'];
$anggaranKasPPKD1DP->nipPejabat = $setting['nipPejabat'];
