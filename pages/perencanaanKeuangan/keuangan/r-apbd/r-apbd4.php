	  ...
	  switch($tipe){	
		...
		case 'sync':{	
			...
			while($rows = mysql_fetch_array($getAllFromRka221)){
				...
				if(mysql_fetch_array(mysql_query("select * from view_r_apbd4 where c1 = '$c1' and c='00' and d='00' and e='00' and e1='000' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap = '$this->idTahap' ")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => '00',
				...
				if(mysql_fetch_array(mysql_query("select * from view_r_apbd4 where c1 = '$c1' and c='$c' and d='00' and e='00' and e1='000' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap = '$this->idTahap'")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => $c,
				...
				if(mysql_fetch_array(mysql_query("select * from view_r_apbd4 where c1 = '$c1' and c='$c' and d='$d' and e='00' and e1='000' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap = '$this->idTahap'")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => $c,
				...
				if(mysql_fetch_array(mysql_query("select * from view_r_apbd4 where  c1='$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and p='$p' and q='0' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap = '$this->idTahap'")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => $c,
				...
				if(mysql_fetch_array(mysql_query("select * from view_r_apbd4 where c1='$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and id_tahap = '$this->idTahap'")) > 0){
				}else{
					$data = array(
									'c1' => $c1,
									'c' => $c,
...
if(empty($r_apbd4_v2->tahun)){
	...
	$r_apbd4_v2->idTahap = $idtahapTerakhir;
