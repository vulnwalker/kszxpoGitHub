<?php
class renja_ins_v2Obj  extends DaftarObj2{	
	var $Prefix = 'renja_ins_v2';
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v2/renja/popupProgram.js' language='JavaScript' ></script>
			<script type='text/javascript' src='js/perencanaan_v2/popupUrusanBidangProgram.js' language='JavaScript' ></script>
			<script type='text/javascript' src='js/perencanaan_v2/popupUrusan.js' language='JavaScript' ></script>
...
$comboBoxJenisKegiatan = cmbArray('jenisKegiatan',$jenisKegiatan,$arrayComboJenisKegiatan,'-- JENIS KEGIATAN --','onchange = renja_v2.jenisChanged();');			
...
$comboBoxJenisKegiatan = cmbArray('jenisKegiatan',$selectedJenisKegiatan,$arrayComboJenisKegiatan,'','onchange = renja_v2.jenisChanged();');		 
$comboBoxUnit =  cmbQuery('cmbUnitForm', $selectedUnit, $codeAndNameUnit,' '.$disabledCariProgram.' onChange=\''.$this->Prefix.'.BidangAfterform()\'','-- Semua Unit Kerja --'); 
$comboBoxSubUnit =  cmbQuery('cmbSubUnitForm', $selectedSubUnit, $codeAndNameSubUnit,' '.$disabledCariProgram.' onChange=\''.$this->Prefix.'.BidangAfterform()\'','-- Semua Sub Unit Kerja --');       
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							'value'=>"<input type='text' id='sisaPlafon' name='sisaPlafon' value='Rp. ".number_format($sisaPlafon,2,',','.')."' style='text-align:right; width :200px;' readonly>  ", 
							 ...
							 array( 
								...
								<input type='button' value='Cari' id='findProgram' onclick ='renja_ins_v2.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >" 
							  ),
							  array( 
								'label'=>'KEGIATAN',
								'labelWidth'=>150, 
							...
							array( 
								...
								'parrams' => "style='width:400px;' placeholder='KELOMPOK SASARAN KEGIATAN'"
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renja_ins_v2_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renja_ins_v2 = new renja_ins_v2Obj();

$arrayResult = tahapPerencanaanV3($renja_ins_v2->modul,"MURNI");
...
$renja_ins_v2->jenisForm = $jenisForm;
$renja_ins_v2->nomorUrut = $nomorUrut;
$renja_ins_v2->tahun = $tahun;
$renja_ins_v2->jenisAnggaran = $jenisAnggaran;
$renja_ins_v2->idTahap = $idTahap;
$renja_ins_v2->username = $_COOKIE['coID'];
$renja_ins_v2->wajibValidasi = $Main->wajibValidasi;
