...
class rkaPPKDObj  extends DaftarObj2{	
	...
	$getJumlahBarang = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkaPPKD_idplh'"));
	...
	<A href=\"pages.php?Pg=rkaPPKD1\" title='RKA-PPKD MURNI'  > RKA-PPKD 1 </a> |
	...
	<A href=\"pages.php?Pg=rkaPPKD\" title='RKA-PPKD MURNI' style='color:blue;' > RKA-PPKD </a> 
   ...
   function setPage_OtherScript(){
		...
		return 	
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD.js' language='JavaScript' ></script> 
...
if(empty($rkaPPKD->tahun)){
	...
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$rkaPPKD->idTahap'"));
	$rkaPPKD->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$rkaPPKD->idTahap'"));
...
$rkaPPKD->provinsi = $setting['provinsi'];
$rkaPPKD->kota = $setting['kota'];
$rkaPPKD->pengelolaBarang = $setting['pengelolaBarang'];
$rkaPPKD->pejabatPengelolaBarang = $setting['pejabat'];
$rkaPPKD->pengurusPengelolaBarang = $setting['pengurus'];
$rkaPPKD->nipPengelola = $setting['nipPengelola'];
$rkaPPKD->nipPengurus = $setting['nipPengurus'];
$rkaPPKD->nipPejabat = $setting['nipPejabat'];


if($rkaPPKD->jenisForm != "PENYUSUNAN"){
$get1 = mysql_fetch_array(mysql_query("select max(id_anggaran)  from view_rka_ppkd_1 where jenis_form_modul = 'PENYUSUNAN' "));
	...
	$rkaPPKD->currentTahap = $arrayHasil['currentTahap'];
			$rkaPPKD->jenisForm = "";
			$rkaPPKD->jenisFormTerakhir = "PENYUSUNAN";
			$rkaPPKD->idTahap = $get2['id_tahap'];
			$rkaPPKD->nomorUrut = $get2['no_urut'];
			$rkaPPKD->urutTerakhir = $get2['no_urut'];
}
