...
class rkaPPKD1Obj  extends DaftarObj2{	
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'Gruping':{	
			...
			if(!isset($rkaPPKD1_cb)){
				$err = "Pilih Data";
			}
			$dt = implode(',',$rkaPPKD1_cb);
	...
	<A href=\"pages.php?Pg=rkaPPKD1\" title='RKA-PPKD MURNI' style='color:blue;' > RKA-PPKD 1 </a> |
	<A href=\"pages.php?Pg=rkaPPKD21\" title='RKA-PPKD MURNI'  > RKA-PPKD 2.1 </a> |
	<A href=\"pages.php?Pg=rkaPPKD31\" title='RKA-PPKD MURNI'  > RKA-PPKD 3.1 </a> |
	<A href=\"pages.php?Pg=rkaPPKD32\" title='RKA-PPKD MURNI'  > RKA-PPKD 3.2 </a> |
   ...
   function setPage_OtherScript(){
		...
		return 	
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD1.js' language='JavaScript' ></script> 
...
$rkaPPKD1->urutTerakhir = $nomorUrut;
$rkaPPKD1->tahun = $tahun;
$rkaPPKD1->jenisAnggaran = $jenisAnggaran;
$rkaPPKD1->idTahap = $idTahap;

$rkaPPKD1->username = $_COOKIE['coID'];

$rkaPPKD1->wajibValidasi = $Main->wajibValidasi;
if($Main->wajibValidasi == TRUE){
	$rkaPPKD1->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkaPPKD1->sqlValidasi = " ";
}
...
$rkaPPKD1->provinsi = $setting['provinsi'];
$rkaPPKD1->kota = $setting['kota'];
$rkaPPKD1->pengelolaBarang = $setting['pengelolaBarang'];
$rkaPPKD1->pejabatPengelolaBarang = $setting['pejabat'];
$rkaPPKD1->pengurusPengelolaBarang = $setting['pengurus'];
$rkaPPKD1->nipPengelola = $setting['nipPengelola'];
$rkaPPKD1->nipPengurus = $setting['nipPengurus'];
$rkaPPKD1->nipPejabat = $setting['nipPejabat'];

if($rkaPPKD1->jenisForm != "PENYUSUNAN"){
$get1 = mysql_fetch_array(mysql_query("select max(id_anggaran)  from view_rka_ppkd_1 where jenis_form_modul = 'PENYUSUNAN' "));
	...
	$rkaPPKD1->currentTahap = $arrayHasil['currentTahap'];
			$rkaPPKD1->jenisForm = "";
			$rkaPPKD1->jenisFormTerakhir = "PENYUSUNAN";
			$rkaPPKD1->idTahap = $get2['id_tahap'];
			$rkaPPKD1->nomorUrut = $get2['no_urut'];
			$rkaPPKD1->urutTerakhir = $get2['no_urut'];
}
