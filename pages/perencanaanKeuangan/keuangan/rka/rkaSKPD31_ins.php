<?php
class rkaSKPD31_insObj  extends DaftarObj2{
	var $Prefix = 'rkaSKPD31_ins';
	...
	var $Cetak_Judul = 'RKA-SKPD 3.1';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rkaSKPD31_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return 'RKA-SKPD 3.1 TAHUN '.$this->tahun ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_pembiayaan_penerimaan",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_pembiayaan_penerimaan where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_pembiayaan_penerimaan",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_31 values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					...
					mysql_query("delete from temp_rincian_pembiayaan_penerimaan where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_31 values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_pembiayaan_penerimaan where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'rincianBelanja':{
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'"));
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_pembiayaan_penerimaan",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_pembiayaan_penerimaan",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_31 values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_31 values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_pembiayaan_penerimaan where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'subRincianBelanja':{
			$cek = '';
			$err = '';
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id ='".$_REQUEST['idRekeningBelanja']."'"));
			$getNamaRekening = mysql_fetch_array(mysql_query("select * from ref_rekening where k ='".$getData['k']."' and l ='".$getData['l']."' and m ='".$getData['m']."' and n ='".$getData['n']."' and o ='".$getData['o']."'"));
			$namaRekening = $getNamaRekening['nm_rekening'];

			$getDataRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id = '".$_REQUEST['id']."'"));
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_31 values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_pembiayaan_penerimaan where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$getUrutanPosisi = mysql_fetch_array(mysql_query("select max(urutan_posisi) from temp_sub_rincian_pembiayaan_penerimaan where username = '$this->username' and id_rincian_belanja = '$idRincianBelanja' order by urutan_posisi"));
				...
				$query = VulnWalkerInsert("temp_sub_rincian_pembiayaan_penerimaan",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_pembiayaan_penerimaan",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			$getRekeningKosong = mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where username = '$this->username'");
			while($dataRekening = mysql_fetch_array($getRekeningKosong)){
					$dataRincianBelanjaKosong = mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id_rekening_belanja = '".$dataRekening['id']."'");
					...
					while ($dataRincianBelanja = mysql_fetch_array($dataRincianBelanjaKosong)) {
							if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where username = '$this->username' and id_rincian_belanja ='".$dataRincianBelanja['id']."'")) == 0){
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$queryCekRekening = "select * from view_rka_3_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja='' and id_tahap='$this->idTahap' ";
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							...
							$getIdRincianBelanja = mysql_fetch_array(mysql_query("select * from rincian_belanja where tahun = '$this->tahun' and jenis_anggaran
							 ...
							 $queryCekRincianBelaja = "select * from view_rka_3_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='0' and f2='0' and f='00' and g='00' and h ='00' and i ='00' and j ='000' and id_tahap='$this->idTahap'";
							 ...
							 $queryCekSubRincian = "select * from view_rka_3_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '".$subRincianBelanja['uraian']."' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='".$subRincianBelanja['f1']."' and f2='".$subRincianBelanja['f2']."' and f='".$subRincianBelanja['f']."' and g='".$subRincianBelanja['g']."' and h ='".$subRincianBelanja['h']."' and i ='".$subRincianBelanja['i']."' and j ='".$subRincianBelanja['j']."' and id_tahap='$this->idTahap'";
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaSKPD31_ins.js' language='JavaScript' ></script>".
	...
	$vOrder=
			...
			,'','','').
				...
				genFilterBar(
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaSKPD31_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaSKPD31_ins.closeTab()'>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_pembiayaan_penerimaan where username = '$this->username' order by k,l,m,n,o ";$cek.=$qry;
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			$getDataRincianBelanja = mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id_rekening_belanja = '$id'");
			while ($dataRincianBelanja = mysql_fetch_array($getDataRincianBelanja)) {
					if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where id_rincian_belanja = '".$dataRincianBelanja['id']."'")) !=0){
							if($statusMerah == ''){
									$warna = "black";
							}
					}else{
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pembiayaan_penerimaan where id_rekening_belanja = '$idRekeningBelanja' and username = '$this->username' order by id ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan where username = '$this->username' and id_rincian_belanja = '$id'")) != 0 ){
				$warna = "black";
			}
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_pembiayaan_penerimaan where id_rincian_belanja = '$idRincianBelanja' order by urutan_posisi ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		// $getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id ='$idRekeningBelanja'"));
	...
	function addRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pembiayaan_penerimaan where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_pembiayaan_penerimaan  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_penerimaan where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_penerimaan where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaSKPD31_ins = new rkaSKPD31_insObj();
...
$rkaSKPD31_ins->jenisForm = $jenisForm;
$rkaSKPD31_ins->nomorUrut = $nomorUrut;
$rkaSKPD31_ins->tahun = $tahun;
$rkaSKPD31_ins->jenisAnggaran = $jenisAnggaran;
$rkaSKPD31_ins->idTahap = $idTahap;
$rkaSKPD31_ins->username = $_COOKIE['coID'];
