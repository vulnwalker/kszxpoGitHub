...
class rkaSKPD1Obj  extends DaftarObj2{	
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'Gruping':{	
			...
			if(!isset($rkaSKPD1_cb)){
				$err = "Pilih Data";
			}
			$dt = implode(',',$rkaSKPD1_cb);
	...
	<A href=\"pages.php?Pg=rkaSKPD221\" title='RKA-SKPD MURNI'  > RKA-SKPD 2.2.1 </a> |
	<A href=\"pages.php?Pg=rkaSKPD22\" title='RKA-SKPKD MURNI'  > RKA-SKPD 2.2 </a> |
	<A href=\"pages.php?Pg=rkaSKPD21\" title='RKA-SKPKD MURNI'  > RKA-SKPD 2.1 </a> |
	<A href=\"pages.php?Pg=rkaSKPD1\" title='RKA-SKPKD MURNI' style='color:blue;' > RKA-SKPD 1 </a> |
   ...
   function setPage_OtherScript(){
		...
		return 	
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaSKPD1.js' language='JavaScript' ></script> 
...
$rkaSKPD1->urutTerakhir = $nomorUrut;
$rkaSKPD1->tahun = $tahun;
$rkaSKPD1->jenisAnggaran = $jenisAnggaran;
$rkaSKPD1->idTahap = $idTahap;
$rkaSKPD1->username = $_COOKIE['coID'];

$rkaSKPD1->wajibValidasi = $Main->wajibValidasi;
if($Main->wajibValidasi == TRUE){
	$rkaSKPD1->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkaSKPD1->sqlValidasi = " ";
}
...
$rkaSKPD1->provinsi = $setting['provinsi'];
$rkaSKPD1->kota = $setting['kota'];
$rkaSKPD1->pengelolaBarang = $setting['pengelolaBarang'];
$rkaSKPD1->pejabatPengelolaBarang = $setting['pejabat'];
$rkaSKPD1->pengurusPengelolaBarang = $setting['pengurus'];
$rkaSKPD1->nipPengelola = $setting['nipPengelola'];
$rkaSKPD1->nipPengurus = $setting['nipPengurus'];
$rkaSKPD1->nipPejabat = $setting['nipPejabat'];


if($rkaSKPD1->jenisForm != "PENYUSUNAN"){
$get1 = mysql_fetch_array(mysql_query("select max(id_anggaran)  from view_rka_1 where jenis_form_modul = 'PENYUSUNAN' "));
	...
	$rkaSKPD1->currentTahap = $arrayHasil['currentTahap'];
			$rkaSKPD1->jenisForm = "";
			$rkaSKPD1->jenisFormTerakhir = "PENYUSUNAN";
			$rkaSKPD1->idTahap = $get2['id_tahap'];
			$rkaSKPD1->nomorUrut = $get2['no_urut'];
			$rkaSKPD1->urutTerakhir = $get2['no_urut'];
}
