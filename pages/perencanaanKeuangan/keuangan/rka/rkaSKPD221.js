...
/*			  rkaSKPD221.formAlokasi(id);*/
   ...
   SaveCatatan: function(id){
	...
	saveEditSubRincian: function(id){
		...
		$.ajax({
			...
			data: {
							...
							satuan1 : $("#satuan1"+id).val(),
							satuan2 : $("#satuan2"+id).val(),
	...
	hitungVolume: function(id){
			$("#volume"+id).val($("#jumlah"+id).val() * $("#kuantitas"+id).val());
			var hasilKali = $("#jumlah"+id).val() * $("#kuantitas"+id).val() * $("#hargaSatuan"+id).val();
