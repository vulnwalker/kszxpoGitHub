...
class rkaSKPD22Obj  extends DaftarObj2{
	...
	function setMenuView(){
		return
			"<td>".genPanelIcon("javascript:rkaSKPD22.Laporan()","print_f2.png",'Laporan',"asd")."</td>";
	...
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=rkaSKPD221\" title='INPUT'  > INPUT </a> |
	<A href=\"pages.php?Pg=rkaSKPD22\" title='REKAP' style='color:blue;' > REKAP </a>
   ...
   function setPage_OtherScript(){
		...
		return
			...
			<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaSKPD22.js' language='JavaScript' ></script>
...
$rkaSKPD22->username = $_COOKIE['coID'];

$rkaSKPD22->wajibValidasi = $Main->wajibValidasi;
if($Main->wajibValidasi == TRUE){
	$rkaSKPD22->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkaSKPD22->sqlValidasi = " ";
}
...
if(empty($rkaSKPD22->tahun)){
	...
	$rkaSKPD22->idTahap = $get2['id_tahap'];
...
$rkaSKPD22->provinsi = $setting['provinsi'];
$rkaSKPD22->kota = $setting['kota'];
$rkaSKPD22->pengelolaBarang = $setting['pengelolaBarang'];
$rkaSKPD22->pejabatPengelolaBarang = $setting['pejabat'];
$rkaSKPD22->pengurusPengelolaBarang = $setting['pengurus'];
$rkaSKPD22->nipPengelola = $setting['nipPengelola'];
$rkaSKPD22->nipPengurus = $setting['nipPengurus'];
$rkaSKPD22->nipPejabat = $setting['nipPejabat'];

if($rkaSKPD22->jenisForm != "PENYUSUNAN"){
$get1 = mysql_fetch_array(mysql_query("select max(id_anggaran)  from view_rka_2_2_1 where jenis_form_modul = 'PENYUSUNAN' "));
	...
	$rkaSKPD22->currentTahap = $arrayHasil['currentTahap'];
			$rkaSKPD22->jenisForm = "";
			$rkaSKPD22->jenisFormTerakhir = "PENYUSUNAN";
			$rkaSKPD22->idTahap = $get2['id_tahap'];
			$rkaSKPD22->nomorUrut = $get2['no_urut'];
			$rkaSKPD22->urutTerakhir = $get2['no_urut'];
}
