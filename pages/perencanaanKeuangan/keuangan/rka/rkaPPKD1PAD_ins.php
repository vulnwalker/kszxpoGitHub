<?php
class rkaPPKD1PAD_insObj  extends DaftarObj2{
	var $Prefix = 'rkaPPKD1PAD_ins';
	...
	var $FormName = 'rkaPPKD1PAD_insForm';
	var $noModul=14;
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_pendapatan_pad_ppkd",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_pendapatan_pad_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_pendapatan_pad_ppkd",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_pendapatan_pad_ppkd where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_pendapatan_pad_ppkd where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_pendapatan_pad_ppkd",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_pendapatan_pad_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_pendapatan_pad_ppkd where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_pad_ppkd values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_pendapatan_pad_ppkd where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerInsert("temp_sub_rincian_pendapatan_pad_ppkd",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_pendapatan_pad_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_1_pad_ppkd where username = '$this->username'");
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD1PAD_ins.js' language='JavaScript' ></script>".
	...
	$vOrder=
			...
			,'','','').
				...
				genFilterBar(
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaPPKD1PAD_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaPPKD1PAD_ins.closeTab()'>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_pendapatan_pad_ppkd where username = '$this->username' ";$cek.=$qry;
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pendapatan_pad_ppkd where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_pendapatan_pad_ppkd where id_rincian_belanja = '$idRincianBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where id ='$idRekeningBelanja'"));
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_pendapatan_pad_ppkd  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaPPKD1PAD_ins = new rkaPPKD1PAD_insObj();
...
$rkaPPKD1PAD_ins->jenisForm = $jenisForm;
$rkaPPKD1PAD_ins->nomorUrut = $nomorUrut;
$rkaPPKD1PAD_ins->tahun = $tahun;
$rkaPPKD1PAD_ins->jenisAnggaran = $jenisAnggaran;
$rkaPPKD1PAD_ins->idTahap = $idTahap;
$rkaPPKD1PAD_ins->username = $_COOKIE['coID'];
