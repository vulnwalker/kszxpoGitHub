...
class detailVolumeObj  extends DaftarObj2{	
	var $Prefix = 'detailVolume';
 ...
 function setPage_OtherScript(){
		...
		return 	
			...
			<script type='text/javascript' src='js/pages/perencanaan_v2/rka/detail_volume/detailVolume.js' language='JavaScript'></script>
...
$detailVolume = new detailVolumeObj();
$detailVolume->username = $_COOKIE['coID'];
?>