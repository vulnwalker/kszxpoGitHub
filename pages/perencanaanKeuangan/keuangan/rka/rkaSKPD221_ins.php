<?php
class rkaSKPD221_insObj  extends DaftarObj2{
	var $Prefix = 'rkaSKPD221_ins';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'temp_rka_221'; //bonus
	var $TblName_Hapus = 'temp_rka_221';
	var $MaxFlush = 10;
	...
	var $FormName = 'rkaSKPD221_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return "RKA-SKPD 2.2.1 TAHUN $this->tahun" ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'getDataSSH':{
			...
			$getKodeBarang = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_belanja_langsung where id = '$id'"));
			$kodeBarang = $getKodeBarang['f'].".".$getKodeBarang['g'].".".$getKodeBarang['h'].".".$getKodeBarang['i'].".".$getKodeBarang['j'].".".$getKodeBarang['j1'];
			$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id = '$idRekeningBelanja'"));
			$kodeRekening = $getKodeRekening['k'].".".$getKodeRekening['l'].".".$getKodeRekening['m'].".".$getKodeRekening['n'].".".$getKodeRekening['o'];
		...
		case 'subRincianBelanja':{
			$cek = '';
			$err = '';
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id ='".$_REQUEST['idRekeningBelanja']."'"));
			...
			$getDataRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_langsung where id = '".$_REQUEST['id']."'"));
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_langsung where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_221 values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_belanja_langsung where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_belanja_langsung where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_221 values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_belanja_langsung where id ='".$dataSubRincian['id']."'");
			}
			$cek = '';
			$err = '';
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_belanja_langsung where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_221 values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_belanja_langsung where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'rincianBelanja':{
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id ='".$_REQUEST['id']."'"));
			$getNamaRekening = mysql_fetch_array(mysql_query("select * from ref_rekening where k ='".$getData['k']."' and l ='".$getData['l']."' and m ='".$getData['m']."' and n ='".$getData['n']."' and o ='".$getData['o']."'"));
			$namaRekening = $getNamaRekening['nm_rekening'];
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_221 values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_belanja_langsung where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_belanja_langsung where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_221 values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_belanja_langsung where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_belanja_langsung where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_221 values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_belanja_langsung where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'saveNewRekening':{
			...
			if(empty($kodeRekening)){
			...
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_belanja_langsung where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rekening_rka_belanja_langsung",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_belanja_langsung where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_belanja_langsung where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_belanja_langsung",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_belanja_langsung where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				...
				$query = VulnWalkerUpdate("temp_rincian_belanja_langsung",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_belanja_langsung where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				$err = "Uraian Sudah Ada !";
			}else{
				...
				$query = VulnWalkerInsert("temp_rincian_belanja_langsung",$data);
				mysql_query($query);
			}
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$err = "Isi Volume";
			}elseif(!empty($kodeBarang) && !empty($jenisAtribusi)){
				$err = "Silahkan uncheck Atribusi bila ingin menambahkan barang ";
			}else{

				if(empty($kodeBarang) || !empty($jenisAtribusi)){
						$f1 = '0';
						$f2 = '0';
						$f = '00';
						$g = '00';
				...
				$getUrutanPosisi = mysql_fetch_array(mysql_query("select max(urutan_posisi) from temp_sub_rincian_belanja_langsung where username = '$this->username' and id_rincian_belanja = '$idRincianBelanja' order by urutan_posisi"));
				...
				$data = array(
							...
							'jenis_atribusi' => $jenisAtribusi,
							'urutan_posisi' => $urutanPosisi

							);
				$query = VulnWalkerInsert("temp_sub_rincian_belanja_langsung",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_belanja_langsung",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'setGenNya':{
			if($this->statusForm == "EDIT"){
				$grabMinId = mysql_fetch_array(mysql_query("select min(id) from temp_rka_221 where user = '$this->username'"));
				$id = $grabMinId['min(id)'];
				$status = "OK";
			}else{
				$status ="ERROR";
		...
		case  'SaveAlokasi':{
			...
			$username = $_COOKIE['coID'] ;
			mysql_query("delete from temp_alokasi_rka_v2 where user ='$username'");
			$data = array('jan' => $jan,
						  'feb' => $feb,
						  'mar' => $mar,
						  'apr'	=> $apr,
		...
		case  'SaveRincianVolume':{
			...
			$username = $_COOKIE['coID'];
			mysql_query("delete from temp_rincian_volume_v2 where user='$username'");
		...
		case 'detailVolume':{
			...
			if($statusDetail != '1'){
				...
				while($got = mysql_fetch_array($getItemSama)){
					...
					mysql_query(VulnWalkerInsert('temp_detail_volume_rka_2_2_1',$data));
		...
		case 'saveDetailVolume':{
			$getTotal = mysql_fetch_array(mysql_query("select sum(jumlah) from temp_detail_volume_rka_2_2_1 where username ='$this->username'"));
		...
		case 'finish':{
			...
			$getRekeningKosong = mysql_query("select * from temp_rekening_rka_belanja_langsung where username = '$this->username'");
			while($dataRekening = mysql_fetch_array($getRekeningKosong)){
					$dataRincianBelanjaKosong = mysql_query("select * from temp_rincian_belanja_langsung where id_rekening_belanja = '".$dataRekening['id']."'");
					...
					while ($dataRincianBelanja = mysql_fetch_array($dataRincianBelanjaKosong)) {
							if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_belanja_langsung where username = '$this->username' and id_rincian_belanja ='".$dataRincianBelanja['id']."'")) == 0){
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_belanja_langsung where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_belanja_langsung  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_langsung where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$queryCekProgram = "select * from view_rka_2_2_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='0' and id_tahap='$this->idTahap' ";
							...
							$queryCekKegiatan= "select * from view_rka_2_2_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and id_tahap='$this->idTahap' ";
							...
							$queryCekRekening = "select * from view_rka_2_2_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja='' and id_tahap='$this->idTahap' ";
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_langsung where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							...
							$getIdRincianBelanja = mysql_fetch_array(mysql_query("select * from rincian_belanja where tahun = '$this->tahun' and jenis_anggaran
							 ...
							 $queryCekRincianBelaja = "select * from view_rka_2_2_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='0' and f2='0' and f='00' and g='00' and h ='00' and i ='00' and j ='000' and id_tahap='$this->idTahap'";
							 ...
							 $queryCekSubRincian = "select * from view_rka_2_2_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '".$subRincianBelanja['uraian']."' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='".$subRincianBelanja['f1']."' and f2='".$subRincianBelanja['f2']."' and f='".$subRincianBelanja['f']."' and g='".$subRincianBelanja['g']."' and h ='".$subRincianBelanja['h']."' and i ='".$subRincianBelanja['i']."' and j ='".$subRincianBelanja['j']."' and id_tahap='$this->idTahap'";
							 if(mysql_num_rows(mysql_query($queryCekSubRincian)) == 0){
									 ...
									 $arraySubRincian = array(
																...
																'satuan_total' => $satuanTotal,
																'jenis_atribusi' => $subRincianBelanja['jenis_atribusi'],
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_221 where username = '$this->username'");
		...
		case 'SaveJob':{
	    	...
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getMaxLeftUrut = mysql_fetch_array(mysql_query("select max(left_urut) from ref_pekerjaan where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and k='$k' and l='$l' and m='$m' and  n='$n' and o ='$o'"));
			...
			$codeAndNamePekerjaan = "select id, nama_pekerjaan from ref_pekerjaan where concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' ";
			$getCurrentInsert = mysql_fetch_array(mysql_query("select max(id) from ref_pekerjaan where concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'"));
		...
		case 'cekNoUrut':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $username = $_COOKIE['coID'];
			 $cekRow = mysql_num_rows(mysql_query("select * from temp_rka_221 where o1 = '$noPekerjaan'   and user ='$username' "));
			 if($cekRow == 0){
			 	$get = mysql_fetch_array(mysql_query("select max(urut) from temp_rka_221 where  user ='$username' and delete_status !='1'  "));
			 	$urut = $get['max(urut)'] + 1;
			 }else{
			 	 $get = mysql_fetch_array(mysql_query("select * from temp_rka_221 where o1 = '$noPekerjaan'   and user ='$username' "));
				 $urut = $get['urut'];
			 }
		...
		case 'hapus2':{
	    	 $id = $_REQUEST['id'];
			 $get = mysql_fetch_array(mysql_query("select * from temp_rka_221 where id='$id' "));
			 $username = $_COOKIE['coID'];
			 $noPekerjaan = $get['o1'];
			 $noUrutPekerjaan = $get['urut'];
			 mysql_query("update  temp_rka_221 set delete_status = '1', o1 ='0' where id='$id'");
			 $execute = mysql_query("select * from temp_rka_221  where user='$username' and o1='$noPekerjaan' and delete_status = '0' order by o1, rincian_perhitungan");
			 $angkaUrut = 1;
			 while($rows = mysql_fetch_array($execute)){
				...
				$dataEditNoUrut = array('urut' => $noUrutPekerjaan,
			 						 	'o2' => $angkaUrut);
				$idTemp = $rows['id'];
				mysql_query(VulnWalkerUpdate("temp_rka_221",$dataEditNoUrut," id='$idTemp'"));
				$angkaUrut = $angkaUrut + 1;

				$content .= VulnWalkerUpdate("temp_rka_221",$dataEditNoUrut," id='$idTemp'");
			 }
		break;
	    }
		...
		case 'saveEdit':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $grabGroup = mysql_fetch_array(mysql_query("select * from $this->TblName where id = '$id'"));
			 ...
			 $ekseGetTempData = mysql_query("select * from temp_rka_221 where user = '$username'  and bk = '$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'  and f!='$f' and g!='$g' and h != '$h' and i !='$i' and j !='$j' and rincian_perhitungan !='$rincian_perhitungan'  and delete_status = '0'");
			 $kondisiIDAwal = "";
			 ...
			 $cekDulu = mysql_num_rows(mysql_query("select * from view_renja where c1= '$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' "));
			 $getJumlahPaguDiTabelAnggaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from view_rka_2_2_1  where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and  e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and  q='$q'  and rincian_perhitungan !='' $kondisiIDAwal and f!='$f' and g!='$g' and h != '$h' and i !='$i' and j !='$j' and rincian_perhitungan !='$rincian_perhitungan' "));
			 if($cekDulu == 0){
			 	$getPaguIndikatif = mysql_fetch_array(mysql_query("select * from view_renja where c1= '$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' "));
			 	$getJumlahPaguDiTabelAnggaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from view_rka_2_2_1  where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d'  and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and  q='$q'  and rincian_perhitungan !='' $kondisiIDAwal and f!='$f' and g!='$g' and h != '$h' and i !='$i' and j !='$j' and rincian_perhitungan !='$rincian_perhitungan' "));
			 }
			 ...
			 if(empty($volumeRek)){
				...
				//$err = "select sum(jumlah_harga) from view_rka_2_2_1  where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and  e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and  q='$q'  and rincian_perhitungan !='' $kondisiIDAwal and f!='$f' and g!='$g' and h != '$h' and i !='$i' and j !='$j' and rincian_perhitungan !='$rincian_perhitungan'";
			 }
			 if($this->jenisForm != 'PENYUSUNAN'){
				$err = "TAHAP PENYUSUNAN TELAH HABIS";
			}
			 ...
			 if($this->statusForm == "EDIT"){
			 	 $prepairWhile = mysql_query("select * from temp_detail_volume_rka_2_2_1 where username = '$this->username'");
				 while($toktok =mysql_fetch_array($prepairWhile)){
				 ...
				 $query = VulnWalkerUpdate("temp_rka_221",$data,"id='$id_awal'");
				 mysql_query($query);
				 }
			 	$lanjut = "finish";
			 }else{
			 		 if($kodeBarang == '....' || empty($kodeBarang)){
					 	$f = '00';
					 	$g = '00';
					 	$h = '00';
					 	$i = '00';
				 ...
				 $query = VulnWalkerUpdate("temp_rka_221",$data,"id='$id'");
				 mysql_query($query);
			 }
		...
		case 'Simpan2':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getIdTahapRenjaTerakhir = mysql_fetch_array(mysql_query("select max(id_tahap) as max from view_renja where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' "));
			 $idTahapRenja = $getIdTahapRenjaTerakhir['max'];
			 $ekseGetTempData = mysql_query("select * from temp_rka_221 where user = '$username'  and bk = '$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id !='$id' and delete_status = '0'");
			 $kondisiIDAwal = "";
			 while($baris = mysql_fetch_array($ekseGetTempData)){
			 	$idParent = $baris['id_awal'];
				$kondisiIDAwal = $kondisiIDAwal." and id_anggaran != '$idParent'" ;
			 ...
			 $getJumlahPaguDiTabelAnggaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from view_rka_2_2_1  where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and  e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and  q='$q'  and rincian_perhitungan !='' $kondisiIDAwal "));
			 $getPaguIndikatif = mysql_fetch_array(mysql_query("select * from view_renja where c1= '$c1' and c='$c' and d='$d'  and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' "));
			 $cekDulu = mysql_num_rows(mysql_query("select * from view_renja where c1= '$c1' and c='$c' and d='$d'  and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' "));

			 if($cekDulu == 0){
			 	$getJumlahPaguDiTabelAnggaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from view_rka_2_2_1  where id_tahap='$this->idTahap' and c1='$c1' and c='$c' and d='$d' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and  q='$q'  and rincian_perhitungan !='' $kondisiIDAwal "));
				$getPaguIndikatif = mysql_fetch_array(mysql_query("select * from view_renja where c1= '$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' "));
			 	$stat = "select * from view_renja where c1= '$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_tahap = '$idTahapRenja' ";
			 }
			 $paguYangTerpakaiDiTabelAnggaran = $getJumlahPaguDiTabelAnggaran['sum(jumlah_harga)'];
		...
		case 'edit':{
				...
				$got = mysql_fetch_array(mysql_query("select
													  sum(volume_rek) as volume_rek
													  from temp_rka_221 where
													  user = '$this->username'
				...
				$codeAndNameProgram = "select p,concat(p,'. ',nama) from ref_program where bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='0'";
				$cmbProgram = cmbQuery('p',$p,$codeAndNameProgram,'disabled','-- PROGRAM --');
				$codeAndNameKegiatan = "select q,concat(q,'. ',nama) from ref_program where bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'";
		...
		case 'setSatuanHarga':{
			...
			if($get['standar_satuan_harga'] == NULL || empty($f)){
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaSKPD221_ins.js' language='JavaScript' ></script>".
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/detail_volume/detailVolume.js' language='JavaScript' ></script>".
			"
    ...
    $username = $_COOKIE['coID'];
	$Koloms = array();
	$grabWihtCondition = mysql_query("select * from temp_rka_221 where user = '$this->username' group by c1,c,d,bk,ck,dk,p,q,k,l,m,n,o,catatan,id_jenis_pemeliharaan");
			while($rows = mysql_fetch_array($grabWihtCondition)){
				if(mysql_num_rows(mysql_query("select * from temp_rka_221 where user = '$this->username'  and c1 = '".$rows['c1']."' and c='".$rows['c']."' and d='".$rows['d']."' and bk = '".$rows['bk']."' and ck ='".$rows['ck']."' and dk ='".$rows['dk']."' and p='".$rows['p']."' and q='".$rows['q']."' and f='".$rows['f']."' and g='".$rows['g']."' and h ='".$rows['h']."' and i ='".$rows['i']."' and j ='".$rows['j']."' and k='".$rows['k']."' and l = '".$rows['l']."' and m = ".$rows['m']." and n ='".$rows['n']."' and o='".$rows['o']."' and catatan = '".$rows['catatan']."' and id_jenis_pemeliharaan = '".$rows['id_jenis_pemeliharaan']."' ")) >= 2 && $rows['j'] !='000'){
	...
	$grubId = $isi['c1'].".".$isi['c'].".".$isi['d'].".".$isi['bk'].".".$isi['ck'].".".$isi['dk'].".".$isi['p'].".".$isi['q'].".".$isi['f'].".".$isi['g'].".".$isi['h'].".".$isi['i'].".".$isi['j'].".".$isi['k'].".".$isi['l'].".".$isi['m'].".".$isi['n'].".".$isi['o'].".".$isi['catatan'].".".$isi['id_jenis_pemeliharaan'];
       if(in_array($grubId, $this->publicGrupId)) {
            $jumlah_harga = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from temp_rka_221 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',dk,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and user = '$this->username' "));
            $jumlah_harga= $jumlah_harga['sum(jumlah_harga)'];
            $volume_rek  = mysql_fetch_array(mysql_query("select sum(volume_rek) from temp_rka_221 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',dk,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and user = '$this->username' "));
		...
		if($f !='00' || $rincian_perhitungan != ''){
			...
			$getTotal = mysql_fetch_array(mysql_query("select sum(volume_rek) as volRek, sum(jumlah_harga) as jumlahHarga from temp_rka_221 where o1 ='$o1' and user='$username' and delete_status !='1'"));
		...
		if($j =='000'){
			...
			$this->publicNomor += 1;
		}elseif($j != '000' && mysql_num_rows(mysql_query("select * from temp_rka_221 where concat(c1,'.',c,'.',d,'.',bk,'.',ck,'.',dk,'.',p,'.',q,'.',f,'.',g,'.',h,'.',i,'.',j,'.',k,'.',l,'.',m,'.',n,'.',o,'.',catatan,'.',id_jenis_pemeliharaan) = '$grubId' and user = '$this->username'  ")) > 1 ){
				$Koloms= array();
		}
	...
	$selectedDK = $concatSKPD[7];
	$selectedP = $concatSKPD[8];
	$selectedQ = $concatSKPD[9];
	foreach ($_REQUEST as $key => $value) {
				 	 	$$key = $value;
	...
	$arrayNameProgram = mysql_fetch_array(mysql_query("select * from ref_program where bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='0' "));
	$program = $arrayNameProgram['nama'];

	$arrayNameKegiatan = mysql_fetch_array(mysql_query("select * from ref_program where bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' "));
	...
	$program = "<input type='hidden' id='bk' name='bk' value='$selectedBK'> <input type='hidden' id='ck' name='ck' value='$selectedCK'> <input type='hidden' id='dk' name='dk' value='$selectedDK'> <input type='hidden' id='hiddenP' name='hiddenP' value='$selectedP'>".cmbArray('p',$selectedBK.".".$selectedCK.".".$selectedDK.".".$selectedP,$arrayP,'-- PROGRAM --',"onchange=$this->Prefix.programChanged(); disabled");

	$codeAndNameKegiatan = mysql_query("select tabel_anggaran.bk, tabel_anggaran.ck, tabel_anggaran.dk, tabel_anggaran.p, tabel_anggaran.q, ref_program.nama from tabel_anggaran  inner join ref_program on tabel_anggaran.bk = ref_program.bk and tabel_anggaran.ck = ref_program.ck and tabel_anggaran.p = ref_program.p and tabel_anggaran.q = ref_program.q  inner join ref_tahap_anggaran on tabel_anggaran.id_tahap = ref_tahap_anggaran.id_tahap where ref_tahap_anggaran.no_urut = '$nomorUrutSebelumnya' and tabel_anggaran.tahun ='$this->tahun' and tabel_anggaran.jenis_anggaran = '$this->jenisAnggaran' and tabel_anggaran.c1 = '$selectedC1' and tabel_anggaran.c = '$selectedC' and tabel_anggaran.d = '$selectedD'  and tabel_anggaran.q !='0' and tabel_anggaran.bk='$selectedBK' and tabel_anggaran.ck='$selectedCK' and tabel_anggaran.dk='$selectedDK' and tabel_anggaran.p='$selectedP'  ");
	$qSama = "";
	$arrayQ = array() ;
	...
	$this->kondisiTemp = mysql_num_rows(mysql_query("select * from $this->TblName where user ='$this->username' and e1 !='000' "));
	if($this->statusForm != "EDIT" && $this->kondisiTemp == 0){
		$finish = "<tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkaSKPD221_ins.finish()'>
	...
	$vOrder=
						...
						array(
							...
							array(
								...
								'value'=>$kegiatan.
								 ...
								 <input type='hidden' name='postBK' id ='postBK' value='$bk'>
								 <input type='hidden' name='postCK' id ='postCK' value='$ck'>
								 <input type='hidden' name='postDK' id ='postDK' value='$dk'>
								 <input type='hidden' name='postP' id ='postP' value='$p'>
								 <input type='hidden' name='postQ' id ='postQ' value='$q'>
								 "
							),
						)
					)
			...
			,'','','').
				...
				genFilterBar(
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaSKPD221_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaSKPD221_ins.closeTab()'>
	...
	function getDaftarOpsi($Mode=1){
		...
		$arrKondisi = array();
		$username = $_COOKIE['coID'];
		$getAll = mysql_query("select * from temp_rka_221 where rincian_perhitungan ='' and f='00' and user = '$username' and o1!='0'");
		while($rows = mysql_fetch_array($getAll)){
			foreach ($rows as $key => $value) {
				 	 	$$key = $value;
			}
			if(mysql_num_rows(mysql_query("select * from temp_rka_221 where user ='$username' and (rincian_perhitungan !='' or f!='00' ) and o1='$o1' and delete_status = '0'")) == 0){
				mysql_query("delete from temp_rka_221 where id='$id'");
			}else{
...
function genForm2($withForm=TRUE){
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_belanja_langsung where username = '$this->username' order by k,l,m,n,o ";$cek.=$qry;
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			$getDataRincianBelanja = mysql_query("select * from temp_rincian_belanja_langsung where id_rekening_belanja = '$id'");
			while ($dataRincianBelanja = mysql_fetch_array($getDataRincianBelanja)) {
					if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_belanja_langsung where id_rincian_belanja = '".$dataRincianBelanja['id']."'")) !=0){
							if($statusMerah ==''){
									$warna = "black";
							}
					}else{
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_belanja_langsung where id_rekening_belanja = '$idRekeningBelanja' and username = '$this->username' order by id ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_belanja_langsung where username = '$this->username' and id_rincian_belanja = '$id'")) != 0 ){
				$warna = "black";
			}
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_belanja_langsung where id_rincian_belanja = '$idRincianBelanja' and username = '$this->username' order by urutan_posisi ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			if($f == '08'){
					$getNamaBarangPersediaan = mysql_fetch_array(mysql_query("select * from ref_barang where f1 ='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and j1='$j1'"));
					$uraian = $getNamaBarangPersediaan['nm_barang'];
			}
			$datanya.="
						<tr class='row0'>
							<td class='GarisDaftar' align='center'>$no</a></td>
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		if($getKodeRekening['k'] == '5' && $getKodeRekening['l'] == '2' && $getKodeRekening['m'] == '3'){
			...
			$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' > <input type='hidden' id='teralokasi'> &nbsp <button type='button' onclick='$this->Prefix.findSSH(0);'>SSH</button>  <span id='bantuSatuanHarga'>";// &nbsp <span id='bantuSatuanHarga' style='color:red;'></span>

		}elseif($getKodeRekening['k'] == '5' && $getKodeRekening['l'] == '2' && $getKodeRekening['m'] == '2'){
			$findBarangBelanjaModal = "<input type='text' id='uraianBelanja' name='uraianBelanja' onkeyUp=$this->Prefix.clearBarang(); style = 'width:70%;'> &nbsp <input type='button' value='Barang'  onclick=$this->Prefix.CariBarangPersediaan(); style='cursor:pointer;'> &nbsp <input type='checkbox' name='checkboxAtribusi' id='checkboxAtribusi' onclick=$this->Prefix.jenisAtribusiChanged(); > Atribusi";
			$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' > <input type='hidden' id='teralokasi'> &nbsp <button type='button' onclick='$this->Prefix.findSSH(0);'>SSH</button>  <span id='bantuSatuanHarga'>";// &nbsp <span id='bantuSatuanHarga' style='color:red;'></span>

		}else{
			$findBarangBelanjaModal = "<input type='text' id='uraianBelanja' name='uraianBelanja' style = 'width:85%;'> <input type='checkbox' name='checkboxAtribusi' id='checkboxAtribusi' onclick=$this->Prefix.jenisAtribusiChanged();> Atribusi  ";
			$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' > <input type='hidden' id='teralokasi'> &nbsp <button type='button' onclick='$this->Prefix.findSSH(0);'>SSH</button> <input type='hidden' id='teralokasi'>  <span id='bantuSatuanHarga'>";
		}
			...
			"
					...
					<table class='koptable'  style='min-width:900px;' border='1'>
						<tr>
							...
							<th class='th01' width='200px;'>VOLUME </th>
							<th class='th01' width='200px;'>SATUAN </th>
							<th class='th01' width='200px;'>HARGA SATUAN </th>
							<th class='th01' width='100px;'>JUMLAH </th>
							<th class='th01' width='50px;'>
								<span id='atasbutton'>
								<a href='javascript:$this->Prefix.$tujuan' id='linkAtasButton' /><img id='gambarAtasButton' src='$gambar' style='width:20px;height:20px;' /></a>
						...
						<tr class='row0'>
							...
							<td class='GarisDaftar' align='left'>
								...
								<input type='hidden' name='jenisAtribusi' id='jenisAtribusi' value='$jenis_atribusi' >
								$findBarangBelanjaModal
							</td>
							<td class='GarisDaftar' align='left'>
	...
	function editSubRincianBelanja($idRekeningBelanja,$idRincianBelanja,$idEdit){
		...
		if($id == $idEdit){
			...
			if($jenis_atribusi == "ya")$statusChecked  = "checked";
			$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id ='$idRekeningBelanja'"));
			if($getKodeRekening['k'] == '5' && $getKodeRekening['l'] == '2' && $getKodeRekening['m'] == '3'){
				...
				$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN'  onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan' value='".$this->removeKoma($harga_satuan)."'  >  &nbsp <button type='button' onclick='$this->Prefix.findSSH($id);'>SSH</button>  <span id='bantuSatuanHarga'>";// &nbsp <span id='bantuSatuanHarga' style='color:red;'></span>
				...
				$findBarangBelanjaModal = "<input type='text' id='uraianBelanja' name='uraianBelanja' value='$uraian' onkeyUp=$this->Prefix.clearBarang(); style = 'width:70%;'> &nbsp <input type='button' value='Barang'  onclick=$this->Prefix.CariBarangPersediaan(); style='cursor:pointer;'> &nbsp<input type='checkbox' name='checkboxAtribusi' id='checkboxAtribusi' onclick=$this->Prefix.jenisAtribusiChanged(); $statusChecked > Atribusi ";
				$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan'  value='".$this->removeKoma($harga_satuan)."' > <input type='hidden' id='teralokasi'> &nbsp <button type='button' onclick='$this->Prefix.findSSH($id);'>SSH</button> <span id='bantuSatuanHarga'>
				'";// &nbsp <span id='bantuSatuanHarga' style='color:red;'></span>

			}else{
				$findBarangBelanjaModal = "<input type='text' id='uraianBelanja' name='uraianBelanja'  style = 'width:85%;' value='$uraian'><input type='checkbox' name='checkboxAtribusi' id='checkboxAtribusi' onclick=$this->Prefix.jenisAtribusiChanged(); $statusChecked > Atribusi  ";
				$kolomHargaSatuan = "<input style='width:50%;' placeholder='HARGA SATUAN'  value='".$this->removeKoma($harga_satuan)."'  onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='$this->Prefix.bantu();' type='text' name='hargaSatuan' id='hargaSatuan' value='$hargaSatuan' >  &nbsp <button type='button' onclick='$this->Prefix.findSSH($id);'> <span id='bantuSatuanHarga'> ";
			}
			...
			if($f=='08'){
				...
				$getNamaBarang = mysql_fetch_array(mysql_query("select * from ref_barang where concat(f1,'.',f2,'.',f,'.',g,'.',h,'.',i,'.',j,'.',j1) ='$kodeBarang'"));
			...
			"
					...
					<table class='koptable'  style='min-width:900px;' border='1'>
						<tr>
							...
							<th class='th01' width='600px;'>URAIAN </th>
							<th class='th01' width='200px;'>VOLUME </th>
							<th class='th01' width='150px;'>SATUAN </th>
							<th class='th01' width='200px;'>HARGA SATUAN </th>
							<th class='th01' width='100px;'>JUMLAH </th>
							<th class='th01' width='50px;'>
								<span id='atasbutton'>
...
function editData(){
	 ...
	 $execute = mysql_query("select * from temp_sub_rincian_belanja_langsung  where username ='$this->username' ");
	 while($subRincianBelanja = mysql_fetch_array($execute)){
		 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_langsung where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
		 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_langsung where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaSKPD221_ins = new rkaSKPD221_insObj();
...
$rkaSKPD221_ins->jenisForm = $jenisForm;
$rkaSKPD221_ins->nomorUrut = $nomorUrut;
$rkaSKPD221_ins->tahun = $tahun;
$rkaSKPD221_ins->jenisAnggaran = $jenisAnggaran;
$rkaSKPD221_ins->idTahap = $idTahap;
$rkaSKPD221_ins->username = $_COOKIE['coID'];

$cekKondisi = mysql_num_rows(mysql_query("select * from temp_rka_221 where user= '$rkaSKPD221_ins->username' and j !='000' and e1!='000'"));
if($cekKondisi != 0 ){
	$rkaSKPD221_ins->statusForm = "EDIT";
}else{
	$rkaSKPD221_ins->statusForm = "BARU";}
?>
