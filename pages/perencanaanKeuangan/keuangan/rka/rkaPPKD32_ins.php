<?php
class rkaPPKD32_insObj  extends DaftarObj2{
	var $Prefix = 'rkaPPKD32_ins';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'temp_rka_32'; //bonus
	var $TblName_Hapus = 'temp_rka_32';
	var $MaxFlush = 10;
	...
	var $Cetak_Judul = 'RKA-PPKD 3.2';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rkaPPKD32_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return 'RKA-PPKD 3.2 TAHUN '.$this->tahun ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_pembiayaan_pengeluaran_ppkd",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_pembiayaan_pengeluaran_ppkd",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_32_ppkd values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_32_ppkd values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_pembiayaan_pengeluaran_ppkd where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_32_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_pembiayaan_pengeluaran_ppkd",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_pembiayaan_pengeluaran_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_32_ppkd values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_32_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_32_ppkd values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerInsert("temp_sub_rincian_pembiayaan_pengeluaran_ppkd",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_pembiayaan_pengeluaran_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			// elseif(mysql_num_rows(mysql_query("select * from temp_rka_232  where user ='$username' and delete_status = '0'")) == 0){
			// 	$err = "Data kosong";
			// }

			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$queryCekRekening = "select * from view_rka_ppkd_3_2 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja='' and id_tahap='$this->idTahap' ";
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							...
							$getIdRincianBelanja = mysql_fetch_array(mysql_query("select * from rincian_belanja where tahun = '$this->tahun' and jenis_anggaran
							 ...
							 $queryCekRincianBelaja = "select * from view_rka_ppkd_3_2 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='0' and f2='0' and f='00' and g='00' and h ='00' and i ='00' and j ='000' and id_tahap='$this->idTahap'";
							 ...
							 $queryCekSubRincian = "select * from view_rka_ppkd_3_2 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '".$subRincianBelanja['uraian']."' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='".$subRincianBelanja['f1']."' and f2='".$subRincianBelanja['f2']."' and f='".$subRincianBelanja['f']."' and g='".$subRincianBelanja['g']."' and h ='".$subRincianBelanja['h']."' and i ='".$subRincianBelanja['i']."' and j ='".$subRincianBelanja['j']."' and id_tahap='$this->idTahap'";
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_32_ppkd where username = '$this->username'");
		...
		case 'SaveJob':{
			...
			$getMaxUrut = mysql_fetch_array(mysql_query("select max(urut) from temp_rka_32 where user ='$username'"));
		...
		case 'SaveEditJob':{
			...
			$getUrut = mysql_fetch_array(mysql_query("select * from temp_rka_32 where o1='$o1'"));
			$urut = $getUrut['urut'];
		...
		case 'cekNoUrut':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $username = $_COOKIE['coID'];
			 $cekRow = mysql_num_rows(mysql_query("select * from temp_rka_32 where o1 = '$noPekerjaan'   and user ='$username' "));
			 if($cekRow == 0){
			 	$get = mysql_fetch_array(mysql_query("select max(urut) from temp_rka_32 where  user ='$username' and delete_status !='1' and o1 !='0' "));
			 	$urut = $get['max(urut)'] + 1;
			 }else{
			 	 $get = mysql_fetch_array(mysql_query("select * from temp_rka_32 where o1 = '$noPekerjaan'   and user ='$username' "));
				 $urut = $get['urut'];
			 }
		...
		case 'hapus2':{
	    	 $id = $_REQUEST['id'];
			 $get = mysql_fetch_array(mysql_query("select * from temp_rka_32 where id='$id' "));
			 $username = $_COOKIE['coID'];
			 $noPekerjaan = $get['o1'];
			 $noUrutPekerjaan = $get['urut'];
			 mysql_query("update  temp_rka_32 set delete_status = '1', o1 ='0' where id='$id'");
			 $execute = mysql_query("select * from temp_rka_32  where user='$username' and o1='$noPekerjaan' and delete_status = '0 order by o1, rincian_perhitungan");
			 $angkaUrut = 1;
			 while($rows = mysql_fetch_array($execute)){
				...
				$dataEditNoUrut = array('urut' => $noUrutPekerjaan,
			 						 	'o2' => $angkaUrut);
				$idTemp = $rows['id'];
				mysql_query(VulnWalkerUpdate("temp_rka_32",$dataEditNoUrut," id='$idTemp'"));
				$angkaUrut = $angkaUrut + 1;

				$content .= VulnWalkerUpdate("temp_rka_32",$dataEditNoUrut," id='$idTemp'");
			 }
		break;
	    }
		...
		case 'saveEdit':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $query = VulnWalkerUpdate("temp_rka_32",$data,"id='$id'");
			 mysql_query($query);
		...
		case 'edit':{
				...
				mysql_query(VulnWalkerInsert('temp_alokasi_rka_32_v2',$dataAlokasi));
				/*if($satuan_total == ''){
					$statusAlokasi = 'false';
				}else{*/
					$statusAlokasi = 'true';
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD32_ins.js' language='JavaScript' ></script>".
	...
	$Koloms[] = array('align="center" width="10"', $no );
		if($f != '00' || $rincian_perhitungan != ''){
			...
			$getTotal = mysql_fetch_array(mysql_query("select sum(volume_rek) as volRek, sum(jumlah_harga) as jumlahHarga from temp_rka_32 where o1 ='$o1' and user='$username' and delete_status !='1'"));
	 ...
	 //items ----------------------
	  $this->form_fields = array(
			'' => array(
						'label'=>'NAMA SATUAN',
						'labelWidth'=>130,
						'value'=>"<input type='text' name='namaSatuan' id='namaSatuan' style='width:320px;'>",
						 ),
	...
	$arrayJenisPerhitungan = array(
	 ...
	 $username = $_COOKIE['coID'];
	 $getAlokasi = mysql_fetch_array(mysql_query("select * from temp_alokasi_rka_32_v2 where user='$username'"));
	...
	$vOrder=
			...
			,'','','').
				...
				array(
					$this->isiform(
						array(
							...
							// 			<button type='button' id='findRekening' onclick=$this->Prefix.findRekening('3.2'); > Cari </button>
							// 		",
							// 	),
							// array(
				...
				genFilterBar(
					...
					<input type='hidden' name='FMST_pengeluaran_det' id='FMST_pengeluaran_det' value='".$dt['FMST_pengeluaran_det']."' />
					<table>
						<tr>
							<td><table cellpadding='0' cellspacing='0' border='0' id='toolbar'>
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaPPKD32_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaPPKD32_ins.closeTab()'>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where username = '$this->username' ";$cek.=$qry;
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd where id_rincian_belanja = '$idRincianBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where id ='$idRekeningBelanja'"));
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_pembiayaan_pengeluaran_ppkd  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pembiayaan_pengeluaran_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pembiayaan_pengeluaran_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaPPKD32_ins = new rkaPPKD32_insObj();
...
$rkaPPKD32_ins->jenisForm = $jenisForm;
$rkaPPKD32_ins->nomorUrut = $nomorUrut;
$rkaPPKD32_ins->tahun = $tahun;
$rkaPPKD32_ins->jenisAnggaran = $jenisAnggaran;
$rkaPPKD32_ins->idTahap = $idTahap;
$rkaPPKD32_ins->username = $_COOKIE['coID'];
