<?php
class rkaPPKD1LP_insObj  extends DaftarObj2{
	var $Prefix = 'rkaPPKD1LP_ins';
	...
	var $Cetak_Judul = 'RKA-PPKD 1';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rkaPPKD1LP_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return 'RKA-PPKD 1 TAHUN '.$this->tahun ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_pendapatan_lp_ppkd",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_pendapatan_lp_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_pendapatan_lp_ppkd",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_pendapatan_lp_ppkd where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_pendapatan_lp_ppkd where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_pendapatan_lp_ppkd",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_pendapatan_lp_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_pendapatan_lp_ppkd where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_lp_ppkd values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_pendapatan_lp_ppkd where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerInsert("temp_sub_rincian_pendapatan_lp_ppkd",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_pendapatan_lp_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$queryCekRekening = "select * from view_rka_ppkd_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja='' and id_tahap='$this->idTahap' ";
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							...
							$getIdRincianBelanja = mysql_fetch_array(mysql_query("select * from rincian_belanja where tahun = '$this->tahun' and jenis_anggaran
							 ...
							 $queryCekRincianBelaja = "select * from view_rka_ppkd_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='0' and f2='0' and f='00' and g='00' and h ='00' and i ='00' and j ='000' and id_tahap='$this->idTahap'";
							 ...
							 $queryCekSubRincian = "select * from view_rka_ppkd_1 where c1='$postUrusan' and c = '$postBidang' and d='$postSKPD' and  rincian_perhitungan = '".$subRincianBelanja['uraian']."' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='".$subRincianBelanja['f1']."' and f2='".$subRincianBelanja['f2']."' and f='".$subRincianBelanja['f']."' and g='".$subRincianBelanja['g']."' and h ='".$subRincianBelanja['h']."' and i ='".$subRincianBelanja['i']."' and j ='".$subRincianBelanja['j']."' and id_tahap='$this->idTahap'";
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_1_lp_ppkd where username = '$this->username'");
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD1LP_ins.js' language='JavaScript' ></script>".
	...
	function pageShow(){
		...
		"<html>".
			$this->genHTMLHead().
			"<body >".
			"<table id='KerangkaHal' class='menubar' cellspacing='0' celllpding='0' border='0' width='100%' height='100%' >".
				"<tr height='34'><td>".
					$this->setPage_Header().
					"<div id='header' ></div>".
				"</td></tr>".
	...
	$vOrder=
			genFilterBar(
				...
				genFilterBar(
					...
					<table>
						<tr>
							<td><table celllpding='0' cellspacing='0' border='0' id='toolbar'>
			...
			,'','','').
				...
				genFilterBar(
					array(
					"
						<input type='hidden' name='".$this->Prefix."_ilplh' id='".$this->Prefix."_ilplh' value='$ilplhnya' />
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaPPKD1LP_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaPPKD1LP_ins.closeTab()'>
	...
	function genFilterBarVulnWalker($Filters, $onClick, $withButton=TRUE, $TombolCaption='Tampilkan', $Style='FilterBar'){
		...
		while( $i < count($Filters) ){
			...
			$Content.= "<td  align='left' style='lpding:1 8 0 8; $border'>".
							$Filters[$i].
						"</td>";
			$i++;
		}
		//tombol
		if($withButton){
			$Content.= "<td  align='left' style='lpding:1 8 0 8;'>
		...
		/*return  "
			<table class='$Style' width='100%' style='margin: 4 0 0 0' cellspacing='0' celllpding='0' border='0'>
			<tr><td>
				<table cellspacing='0' celllpding='0' border='0'>
				<tr valign='middle'>
					$Content
				</tr>
				</table>
		...
		return  "
			...
			<div class='$Style' >
				...
				<table cellspacing='0' celllpding='0' border='0' style='height:28;width:100%;'>
				<tr valign='middle'>
					$Content
				</tr>
				</table>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_pendapatan_lp_ppkd where username = '$this->username' ";$cek.=$qry;
	...
	function tabelRekeningSelectedRincian($idSelected){
		...
		$datanya='';
		$username = $_COOKIE['coID'];
		$refid_terima = addslashes($_REQUEST[$this->Prefix."_ilplh"]);
		$qry = "select * from temp_rekening_rka_pendapatan_lp_ppkd where username = '$this->username' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pendapatan_lp_ppkd where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_pendapatan_lp_ppkd where id_rincian_belanja = '$idRincianBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where id ='$idRekeningBelanja'"));
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_pendapatan_lp_ppkd  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_lp_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_lp_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaPPKD1LP_ins = new rkaPPKD1LP_insObj();
...
$rkaPPKD1LP_ins->jenisForm = $jenisForm;
$rkaPPKD1LP_ins->nomorUrut = $nomorUrut;
$rkaPPKD1LP_ins->tahun = $tahun;
$rkaPPKD1LP_ins->jenisAnggaran = $jenisAnggaran;
$rkaPPKD1LP_ins->idTahap = $idTahap;
$rkaPPKD1LP_ins->username = $_COOKIE['coID'];
