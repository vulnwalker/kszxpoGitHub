<?php
class rkaPPKD21_insObj  extends DaftarObj2{
	var $Prefix = 'rkaPPKD21_ins';
	...
	var $Cetak_Judul = 'RKA-PPKD 2.1';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rkaPPKD21_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return 'RKA-PPKD 2.1 TAHUN '.$this->tahun ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_belanja_tidak_langsung_ppkd",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_belanja_tidak_langsung_ppkd",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_21_ppkd values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_21_ppkd values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_belanja_tidak_langsung_ppkd where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_21_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_belanja_tidak_langsung_ppkd where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_belanja_tidak_langsung_ppkd",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_belanja_tidak_langsung_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_21_ppkd values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_21_ppkd values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_belanja_tidak_langsung_ppkd where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_21_ppkd values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_belanja_tidak_langsung_ppkd where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerInsert("temp_sub_rincian_belanja_tidak_langsung_ppkd",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_belanja_tidak_langsung_ppkd",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							if(mysql_num_rows(mysql_query("select * from rincian_belanja where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$postUrusan' and c='$postBidang' and d='$postPPKD' and bk='$postBK' and ck='$postCK' and dk='$postDK' and p='$postP' and q='$postQ' and k='".$getRekeningBelanja['k']."' and l='".$getRekeningBelanja['l']."' and m='".$getRekeningBelanja['m']."' and n='".$getRekeningBelanja['n']."' and o='".$getRekeningBelanja['o']."' and sumber_dana = '".$getRekeningBelanja['sumber_dana']."' and nama_rincian_belanja = '".$getRincianBelanja['uraian']."'  ")) == 0){
							...
							$queryCekRekening = "select * from view_rka_ppkd_2_1 where c1='0' and j = '000' and rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja='' and id_tahap='$this->idTahap' ";
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));

							$getIdRincianBelanja = mysql_fetch_array(mysql_query("select * from rincian_belanja where tahun = '$this->tahun' and jenis_anggaran
							 ='$this->jenisAnggaran' and c1 ='".$postUrusan."' and c ='".$postBidang."' and d ='".$postPPKD."' and bk ='".$postBK."'  and ck ='".$postCK."' and dk ='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and nama_rincian_belanja = '".$getUplineName['uraian']."'  "));

							 $queryCekRincianBelaja = "select * from view_rka_ppkd_2_1 where c1='$postUrusan' and c = '$postBidang' and d='$postPPKD' and  rincian_perhitungan = '' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='0' and f2='0' and f='00' and g='00' and h ='00' and i ='00' and j ='000' and id_tahap='$this->idTahap'";
							 ...
							 $queryCekSubRincian = "select * from view_rka_ppkd_2_1 where c1='$postUrusan' and c = '$postBidang' and d='$postPPKD' and  rincian_perhitungan = '".$subRincianBelanja['uraian']."' and bk ='".$postBK."' and ck ='".$postCK."' and dk='".$postDK."' and p ='".$postP."' and q='".$postQ."' and k ='".$getRekeningBelanja['k']."' and l ='".$getRekeningBelanja['l']."' and m ='".$getRekeningBelanja['m']."' and n ='".$getRekeningBelanja['n']."' and o ='".$getRekeningBelanja['o']."' and id_rincian_belanja = '".$getIdRincianBelanja['id']."'  and f1 ='".$subRincianBelanja['f1']."' and f2='".$subRincianBelanja['f2']."' and f='".$subRincianBelanja['f']."' and g='".$subRincianBelanja['g']."' and h ='".$subRincianBelanja['h']."' and i ='".$subRincianBelanja['i']."' and j ='".$subRincianBelanja['j']."' and id_tahap='$this->idTahap'";
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_21_ppkd where username = '$this->username'");
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaPPKD21_ins.js' language='JavaScript' ></script>".
		...
		"<html>".
			...
			"<table id='KerangkaHal' class='menubar' cellspacing='0' cellpadding='0' border='0' width='100%' height='100%' >".
				...
				"<tr height='*' valign='top'> <td >".
					...
					<input type='hidden' name='concatPPKD' value='".$_REQUEST['skpd']."' />
	...
	$concatPPKD = $_REQUEST['concatPPKD'];
	$concatPPKD = explode('.',$concatPPKD);
	$c1 = $concatPPKD[0];
	$c = $concatPPKD[1];
	$d = $concatPPKD[2];
	$e = $concatPPKD[3];
	...
	$arrayNamePPKD = mysql_fetch_array(mysql_query("select * from ref_skpd where c1 ='$c1' and c='$c' and d='$d' and e='00' and e1='000'"));
	$namaPPKD = $arrayNamePPKD['nm_skpd'];
	...
	$vOrder=
			genFilterBar(
				...
				genFilterBar(
					...
					<input type='hidden' name='postPPKD' id ='postPPKD' value='$d'>
					<table>
						<tr>
			...
			,'','','').
				...
				array(
					$this->isiform(
						array(
							...
							// 			<button type='button' id='findRekening' onclick=$this->Prefix.findRekening('2.1'); > Cari </button>
							// 		",
							// 	),
							// array(
				...
				genFilterBar(
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaPPKD21_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaPPKD21_ins.closeTab()'>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where username = '$this->username' ";$cek.=$qry;
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_belanja_tidak_langsung_ppkd where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_belanja_tidak_langsung_ppkd where id_rincian_belanja = '$idRincianBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		$getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where id ='$idRekeningBelanja'"));
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_belanja_tidak_langsung_ppkd  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_belanja_tidak_langsung_ppkd where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_belanja_tidak_langsung_ppkd where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaPPKD21_ins = new rkaPPKD21_insObj();
...
$rkaPPKD21_ins->jenisForm = $jenisForm;
$rkaPPKD21_ins->nomorUrut = $nomorUrut;
$rkaPPKD21_ins->tahun = $tahun;
$rkaPPKD21_ins->jenisAnggaran = $jenisAnggaran;
$rkaPPKD21_ins->idTahap = $idTahap;
$rkaPPKD21_ins->username = $_COOKIE['coID'];
