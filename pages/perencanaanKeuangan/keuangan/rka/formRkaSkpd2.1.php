<?php
class formRkaSkpd21_v2Obj  extends DaftarObj2{	
	var $Prefix = 'formRkaSkpd21_v2';
	...
	var $FormName = 'formRkaSkpd21_v2Form';
	var $noModul=14; 
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'finish':{		
			...
			}elseif(mysql_num_rows(mysql_query("select * from temp_rka_21  where user ='$username'  and delete_status = '0'")) == 0){
				$err = "Data kosong";
			}
			
			if(empty($err)){
				$execute = mysql_query("select * from temp_rka_21  where user ='$username' ");
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v2/rka/formRkaSkpd2.1.js' language='JavaScript' ></script>".
			...
			genFilterBar(
				...
				genFilterBar(
					...
					<td class='border:none'> 
						<a class='toolbar' id='btsave' href='javascript:formRkaSkpd21_v2.$tujuan'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='btcancel' href='javascript:formRkaSkpd21_v2.closeTab()'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='finish' href='javascript:formRkaSkpd21_v2.finish()'> 
	...
	function getDaftarOpsi($Mode=1){
		...
		$arrKondisi = array();		
		$username = $_COOKIE['coID'];
		$getAll = mysql_query("select * from temp_rka_21 where rincian_perhitungan ='' and user = '$username'");
...
$formRkaSkpd21_v2 = new formRkaSkpd21_v2Obj();
...
$formRkaSkpd21_v2->jenisForm = $jenisForm;
$formRkaSkpd21_v2->nomorUrut = $nomorUrut;
$formRkaSkpd21_v2->tahun = $tahun;
$formRkaSkpd21_v2->jenisAnggaran = $jenisAnggaran;
$formRkaSkpd21_v2->idTahap = $idTahap;
