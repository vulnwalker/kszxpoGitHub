...
class popupBarangPemeliharaan_v2Obj  extends DaftarObj2{	
	var $Prefix = 'popupBarangPemeliharaan_v2';
	...
	var $FormName = 'popupBarangPemeliharaan_v2Form'; 	
...
/*			'' => array( 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $getMinID = mysql_fetch_array(mysql_query("select min(Id) as min from view_barang_rkbmd_pemeliharaan where concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',f,'.',g,'.',h,'.',i,'.',j) = '$concat'"));
	 if($isi['Id'] == $getMinID['min']){
	 	...
	 	if($isi['j'] == '000'){
 		 ...
 		 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangPemeliharaan_v2.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
$popupBarangPemeliharaan_v2 = new popupBarangPemeliharaan_v2Obj();
