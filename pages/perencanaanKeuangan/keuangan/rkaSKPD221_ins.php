	  ...
	  switch($tipe){
		...
		case 'subRincianBelanja':{
			...
			$content = array('tabelRincianBelanja' => $this->tabelRincianBelanjaSelected($_REQUEST['idRekeningBelanja'],$_REQUEST['id']),
												'tabelSubRincianBelanja' => $this->tabelSubRincianBelanja($_REQUEST['id'])
												);
		break;
		}
		...
		case 'rincianBelanja':{
			...
			$content = array('tabelRekening' => $this->tabelRekeningSelectedRincian($_REQUEST['id']) , 'tabelRincianBelanja' => $this->tabelRincianBelanja($_REQUEST['id']), 'tabelSubRincianBelanja' => $this->tabelSubRincianBelanja() );
		break;
		}
   ...
   function setPage_OtherScript(){
	 ...
	 //items ----------------------
	  $this->form_fields = array(
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
						'value'=>"<input type='hidden' id='volumeRek' value='$dt'>  <input type='text' id='jumlah1' value='$jumlah1' onkeyup='$this->Prefix.setTotalRincian();'  onkeypress='return event.charCode >= 48 && event.charCode <= 57' placeholder='JUMLAH'> &nbsp &nbsp <input type='text' name ='satuan1' id ='satuan1'>",
						 ),
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
			...
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
						'value'=>"<input type='text' id='jumlah2' placeholder='JUMLAH' value='$jumlah2' onkeyup='$this->Prefix.setTotalRincian();'  onkeypress='return event.charCode >= 48 && event.charCode <= 57'> &nbsp &nbsp <input type='text' name ='satuan2' id ='satuan2'>",
						 ),
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
			...
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
						'value'=>"<input type='text' id='jumlah3' placeholder='JUMLAH' value='$jumlah3' onkeyup='$this->Prefix.setTotalRincian();'  onkeypress='return event.charCode >= 48 && event.charCode <= 57'> &nbsp &nbsp <input type='text' name ='satuan3' id ='satuan3'>",
						 ),
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
			...
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
						'value'=>"<input type='text' value='$totalResult' placeholder='JUMLAH' id='jumlah4' readonly > &nbsp &nbsp <span id='detailVolumeRincian'>",
						 ),
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
			...
			array( 		'label' => '',
						'labelWidth' => 1,
						'pemisah' => ' ',
						'value'=>"<input type='text' value='$rincianVolume' placeholder=''  id='rincianVolumeTemp' style='width:350px;' > ",
						 ),
	...
	$vOrder=
			...
			genFilterBar(
				...
				<tbody><tr valign='middle' align='center'>
				<td class='border:none'>
					<b>RINCIAN BELANJA</b> <input type='hidden' name='currentRincianRekening' id = 'currentRincianRekening' >
				</td>
				</tr>
				</tbody></table>
						"
			...
			genFilterBar(
				...
				<tbody><tr valign='middle' align='center'>
				<td class='border:none'>
					<b>SUB RINCIAN BELANJA</b> <input type='hidden' name='currentRincianBelanja' id = 'currentRincianBelanja' >
				</td>
				</tr>
				</tbody></table>
						"
...
function genForm2($withForm=TRUE){
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_belanja_langsung where username = '$this->username' ";$cek.=$qry;
		...
		foreach ($dt as $key => $value) {
			...
			$datanya.="
						...
						<tr class='row0'>
							...
							<td class='GarisDaftar' align='center'><input type='checkbox' onclick = $this->Prefix.rincianBelanja($id);></td>
							<td class='GarisDaftar' align='left'>
								<span onclick = $this->Prefix.rincianBelanja($id); style='color:red;cursor:pointer;'> $kodeRekening </span>
							</td>
			...
			"
					...
					<table class='koptable'   width= 100% border='1'>
						<tr>
							...
							<th class='th01' width='20x;'>&nbsp</th>
							<th class='th01' width='100px;'>KODE REKENING  </th>
							<th class='th01' width='800px;'>URAIAN</th>
		...
		foreach ($dt as $key => $value) {
			...
			if($id == $idSelected){
				$datanya.="
							...
							<tr class='row0'>
								<td class='GarisDaftar' align='center'>$no</a></td>
								<td class='GarisDaftar' align='center'><input type='checkbox' onclick = $this->Prefix.rincianBelanja($id); style='color:blue;cursor:pointer;' checked></td>
								<td class='GarisDaftar' align='left'>
									<span onclick = $this->Prefix.rincianBelanja($id); style='color:blue;cursor:pointer;'> $kodeRekening </span>
								</td>
								<td class='GarisDaftar'>
									$namaRekening
								</td>
		...
		$content =
			"
					...
					<table class='koptable'  style='min-width:900px;' border='1'>
						<tr>
							<th class='th01' width='50px;'>NO</th>
							<th class='th01' width='20px;'>&nbsp</th>
							<th class='th01' width='100px;'>KODE REKENING  </th>
		...
		$content ="
					...
					<table class='koptable' style='min-width:900px;' border='1'>
						...
						<tr class='row0'>
							<td class='GarisDaftar' align='center'>$no</a></td>
							<td class='GarisDaftar' align='left'>
								<input type='text' id='kodeRekening' name='kodeRekening' style='width:100px;' > &nbsp <img src='datepicker/search.png'  onclick=$this->Prefix.findRekening(); style='width:20px;height:20px;margin-bottom:-5px; cursor:pointer;'>
							</td>
							<td class='GarisDaftar'>
		...
		while($dt = mysql_fetch_array($aqry)){
			...
			if($id == $idEdit){
				...
				$datanya.= "<tr class='row0'>
							<td class='GarisDaftar' align='center'>$no</a></td>
							<td class='GarisDaftar' align='left'>
								<input type='text' id='kodeRekening' style='width:100px;' name='kodeRekening'  value='$kodeRekening'> &nbsp <img src='datepicker/search.png'  onclick=$this->Prefix.findRekening(); style='width:20px;height:20px;margin-bottom:-5px; cursor:pointer;'>
							</td>
							<td class='GarisDaftar'>
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_belanja_langsung where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			$datanya.="
						...
						<tr class='row0'>
							<td class='GarisDaftar' align='center'>$no</a></td>
							<td class='GarisDaftar' align='center'><input type='checkbox' onclick = $this->Prefix.subRincianBelanja($id);> </td>
							<td class='GarisDaftar' align='left'>
								<span onclick = $this->Prefix.subRincianBelanja($id); style='color:red;cursor:pointer;'> $uraian </span>
							</td>
							<td class='GarisDaftar' align='center'>
			...
			"
					...
					<table class='koptable'  style='min-width:900px;' border='1'>
						<tr>
							...
							<th class='th01' width='20px;'>&nbsp</th>
							<th class='th01' width='400px;'>URAIAN </th>
							<th class='th01' width='50px;'>
								<span id='atasbutton'>
								<a href='javascript:$this->Prefix.$tujuan' id='linkAtasButton' /><img id='gambarAtasButton' src='$gambar' style='width:20px;height:20px;' /></a>
								</span>
		...
		foreach ($dt as $key => $value) {
			...
			if($id == $idSelected){
				$datanya.="
							...
							<tr class='row0'>
								<td class='GarisDaftar' align='center'>$no</a></td>
								<td class='GarisDaftar' align='center'><input type='checkbox' onclick = $this->Prefix.subRincianBelanja($id); checked></td>
								<td class='GarisDaftar' align='left'>
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_belanja_langsung where id_rincian_belanja = '$idRincianBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			$datanya.="
						<tr class='row0'>
							...
							<td class='GarisDaftar' align='right'>
								".number_format($hasilKali* $harga_satuan,0,',','.')."
							</td>
							<td class='GarisDaftar' align='center'>
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		if(!empty($satuan3)){
			$satuanVolume = $volume1." ".$satuan1." / ".$volume2." ".$satuan2." / ".$volume3." ".$satuan3;
			$hasilKali = $volume1 * $volume2 * $volume3;
		}elseif(!empty($satuan2)){
			$satuanVolume = $volume1." ".$satuan1." / ".$volume2." ".$satuan2;
			$hasilKali = $volume1 * $volume2 ;
		}elseif(!empty($satuan1)){
			$satuanVolume = $volume1." ".$satuan1;
			$hasilKali = $volume1  ;
		}
		$datanya.="
					<tr class='row0'>
