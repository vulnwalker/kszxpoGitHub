			...
			<div id='pagetitle'>
					...
					<td align='right'>
						...
						<a style='background: no-repeat url(images/administrator/images/home_24.png);
									width:24;height:24;display: inline-block;position:absolute' href='tesmenuv5.php' title='Main Menu'>
						</a>
						</div>
						...
						<a style='background: no-repeat url(images/administrator/images/Setting2_24.png);
									width:24;height:24;display: inline-block;position:absolute' href='pages.php?Pg=bypassTahap_v2' title='Tahap'>
						</a>
						</div>
						</td></tr></tbody></table>
...
function genTableRow($Koloms, $RowAtr='', $KolomClassStyle=''){
	...
	if (count($Koloms)>0 && $statusLock != 1){$baris ="<tr $RowAtr > $baris </tr>"; }
	return $baris;
}
