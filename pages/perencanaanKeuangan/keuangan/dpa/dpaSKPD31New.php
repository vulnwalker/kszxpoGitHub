...
class dpaSKPD31NewObj  extends DaftarObj2{
	var $Prefix = 'dpaSKPD31New';
	...
	var $pagePerHal ='';
	//var $cetak_xls=TRUE ;
	var $fileNameExcel='dpaSKPD31New.xls';
	var $namaModulCetak='DPA';
	var $Cetak_Judul = 'DPA';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'dpaSKPD31NewForm';
	var $modul = "DPA";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
   ...
   // if( $err=='' && $kategori =='' ) $err= 'Kategori Belum Di Pilih !!';
    ...
    break;
	 ...
	 function setPage_HeaderOther(){
 	   ...
 	   <A href=\"pages.php?Pg=dpaSKPD31New\" title='dpa-SKPKD MURNI' style='color:blue;'  > PEMBIAYAAN </a> |
 	   ...
 	   <tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
 	   <A href=\"pages.php?Pg=dpaSKPD31New\" title='PENERIMAAN'  style='color:blue;' > PENERIMAAN </a> |
...
$fmORDER1 = $_REQUEST['fmORDER1'];
	...
	foreach ($_COOKIE as $key => $value) {
		...
		$urusan = cmbQuery('cmbUrusan',$selectedC1,$codeAndNameUrusan,'onchange=dpaSKPD31New.refreshList(true);','-- URUSAN --');

		$codeAndNameBidang = "select c, concat(c, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c !='00' and d='00' and e='00' and e1='000' ";
		$bidang = cmbQuery('cmbBidang',$selectedC,$codeAndNameBidang,'onchange=dpaSKPD31New.refreshList(true);','-- BIDANG --');

		$codeAndNameSKPD = "select d, concat(d, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c='$selectedC' and d!='00' and e='00' and e1='000' ";
		$skpd= cmbQuery('cmbSKPD',$selectedD,$codeAndNameSKPD,'onchange=dpaSKPD31New.refreshList(true);','-- SKPD --');
		...
		$unit = cmbQuery('cmbUnit',$selectedE,$codeAndNameUnit,'onchange=dpaSKPD31New.refreshList(true);','-- UNIT --');
		...
		$subunit = cmbQuery('cmbSubUnit',$selectedE1,$codeAndNameSubUnit,'onchange=dpaSKPD31New.refreshList(true);','-- SUB UNIT --');
...
function Laporan($dt){
   ...
   $dari = $_REQUEST['dari'];
     ...
     $arrayJenisLaporan = array(
                 array('dpaSKPD31', 'DPA-SKPD 3 MURNI'),
    ...
    $this->form_menubawah =
      ...
      "<input type='button' value='Batal' onclick ='dpaSKPD31.Close()' >";
    ...
    echo 
      ...
      <script type='text/javascript' src='assets/js/bootstrap.min.js'></script>".
						...
						<tr>
							...
							<table style='width: 100%; margin-bottom: 1%;'>
								...
								<tr style='border-bottom: 1px solid;'>
									<th class='th02' colspan='7' style='text-align: center; border-top: 1px solid; border-right: 1px solid; padding: 4px;'>
		...
		echo "
								...
								<table class='cetak' style='width:100.2%; border-bottom: 1px solid; margin-left: -1px; margin-top: -0.8%;'>
								<thead>
									<tr>
										<th colspan='10' style='text-align: center; border-top: 1px solid; padding: 3px;' >
											RINCIAN DOKUMEN PELAKSANAAN ANGGARAN<br>
											PENDAPATAN SATUAN KERJA PERANGKAT DAERAH
										</th>
									</tr>
									<tr>
										<th class='th02' rowspan='2' >KODE REKENING</th>
										<th class='th02' rowspan='2' >URAIAN</th>
										<th class='th02' rowspan='1' colspan='3' >Rincian Perhitungan</th>
										<th class='th02' rowspan='2' >JUMLAH (Rp)</th>
									</tr>
									<tr>
										<th class='th02' >VOLUME</th>
										<th class='th02' >SATUAN</th>
										<th class='th02' >HARGA SATUAN</th>
									</tr>
									<tr>
										<th class='th01' >1</th>
										<th class='th01' >2</th>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if (!empty($k) && !empty($l) && !empty($m)  && !empty($n)  && !empty($o)  && empty($id_rincian_belanja) ){
				//Rekening
						...
						$getDataViewDPA221 = mysql_fetch_array(mysql_query("select * from view_dpa_3_1 where id_tahap = '$this->idTahap' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and k ='$k' and l='$l' and m='$m' and n='$n' and o='$o' $kondisiSKPD $kondisiRekening"));
      ...
      $arrayRekening4[] = $k.".".$l.".".$m.".".$n;
		...
		echo 				"<tr valign='top'>
									<td align='right' colspan='5' class='GarisCetak' style='border: 1px solid;'><b>JUMLAH</b></td>
		...
		echo 			
						"<table style='width:100.3%; border: 1px solid; margin-left: -1px;'>
							<tr>
...
$dpaSKPD31New = new dpaSKPD31NewObj();

$arrayResult = VulnWalkerTahap_v2($dpaSKPD31New->modul);
...
$dpaSKPD31New->jenisForm = $jenisForm;
$dpaSKPD31New->nomorUrut = $nomorUrut;
$dpaSKPD31New->urutTerakhir = $nomorUrut;
$dpaSKPD31New->tahun = $tahun;
$dpaSKPD31New->jenisAnggaran = $jenisAnggaran;
$dpaSKPD31New->idTahap = $idTahap;
$dpaSKPD31New->username = $_COOKIE['coID'];

if(empty($dpaSKPD31New->tahun)){
	...
	/*$dpaSKPD31New->tahun = "select max(id_anggaran) as max from view_dpa_3_1 where nama_modul = 'dpaSKPD31New'";*/
	$dpaSKPD31New->tahun  = $get2['tahun'];
	$dpaSKPD31New->jenisAnggaran = $get2['jenis_anggaran'];
	$dpaSKPD31New->urutTerakhir = $get2['no_urut'];
	$dpaSKPD31New->jenisFormTerakhir = $get2['jenis_form_modul'];
	$dpaSKPD31New->urutSebelumnya = $dpaSKPD31New->urutTerakhir - 1;
	...
	$dpaSKPD31New->namaTahapTerakhir = $namaTahap['nama_tahap'];
	...
	$dpaSKPD31New->masaTerakhir = $lastTanggalMulai." JAM : ".$namaTahap['jam_mulai']."  s/d  ".$lastTanggalSelesai." JAM : ".$namaTahap['jam_selesai'];

	$arrayHasil =  VulnWalkerLASTTahap_v2();
	$dpaSKPD31New->currentTahap = $arrayHasil['currentTahap'];
}else{
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD31New->idTahap'"));
	$dpaSKPD31New->currentTahap = $getCurrenttahap['nama_tahap'];

	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$dpaSKPD31New->idTahap'"));
	$dpaSKPD31New->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$dpaSKPD31New->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$arrayMasa = explode("-",$namaTahap['tanggal_mulai']);
	$lastTanggalMulai = $arrayMasa[2]."-".$arrayMasa[1]."-".$arrayMasa[0];
	$arrayMasa2 = explode("-",$namaTahap['tanggal_selesai']);
...
$dpaSKPD31New->provinsi = $setting['provinsi'];
$dpaSKPD31New->kota = $setting['kota'];
$dpaSKPD31New->pengelolaBarang = $setting['pengelolaBarang'];
$dpaSKPD31New->pejabatPengelolaBarang = $setting['pejabat'];
$dpaSKPD31New->pengurusPengelolaBarang = $setting['pengurus'];
$dpaSKPD31New->nipPengelola = $setting['nipPengelola'];
$dpaSKPD31New->nipPengurus = $setting['nipPengurus'];
$dpaSKPD31New->nipPejabat = $setting['nipPejabat'];
