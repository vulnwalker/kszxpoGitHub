...
class rkbmdPersediaanUnitKerjaObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanUnitKerja';
	...
	var $FormName = 'rkbmdPersediaanUnitKerjaForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPersediaanUnitKerja&tipe=Persediaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPersediaanUnitKerja&tipe=Persediaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPersediaanUnitKerja&tipe=Persediaan3";
	function setTitle(){
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanUnitKerja\" title='RKBMD' > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanUnitKerja\" title='RKBMD PENGELOLA' > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanUnitKerja\" title='RKBMD PERSEDIAAN'  style='color : blue;'  > PERSEDIAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPersediaanUnitKerjaSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPersediaanUnitKerjaSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPersediaanUnitKerjaSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPersediaanUnitKerjaSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPersediaanUnitKerjaSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPersediaanUnitKerjaSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPersediaanUnitKerjaSkpdfmUrusan;
		     $parentC = $rkbmdPersediaanUnitKerjaSkpdfmSKPD;
			 $parentD = $rkbmdPersediaanUnitKerjaSkpdfmUNIT;
			 $parentE = $rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPersediaanUnitKerjaSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPersediaanUnitKerja == 'PERSEDIAAN'){
						$kemana = 'ins';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPersediaanUnitKerja_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPersediaanUnitKerja = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPersediaanUnitKerja as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPersediaanUnitKerja['c1'];
					$parentC = $getParentrkbmdPersediaanUnitKerja['c'];
					$parentD = $getParentrkbmdPersediaanUnitKerja['d'];
					$parentE = $getParentrkbmdPersediaanUnitKerja['e'];
					$parentE1= $getParentrkbmdPersediaanUnitKerja['e1'];
					$parentBK = $getParentrkbmdPersediaanUnitKerja['bk'];
					$parentCK = $getParentrkbmdPersediaanUnitKerja['ck'];
					$parentDK = $getParentrkbmdPersediaanUnitKerja['dk'];
					$parentP = $getParentrkbmdPersediaanUnitKerja['p'];
					$parentQ = $getParentrkbmdPersediaanUnitKerja['q'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPersediaanUnitKerja_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPersediaanUnitKerja_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPersediaanUnitKerjanya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPersediaanUnitKerjanya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanUnitKerjanya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPersediaanUnitKerjanya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPersediaanUnitKerja.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerja.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerja.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPersediaanUnitKerjaSkpdfmUrusan'];
	 $c = $dt['rkbmdPersediaanUnitKerjaSkpdfmSKPD'];
	 $d = $dt['rkbmdPersediaanUnitKerjaSkpdfmUNIT'];
	 $e = $dt['rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPersediaanUnitKerjaSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPersediaanUnitKerjaSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPersediaanUnitKerja' id='cmbJenisrkbmdPersediaanUnitKerja' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPersediaanUnitKerjaSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPersediaanUnitKerjaSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPersediaanUnitKerjaSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPersediaanUnitKerjaSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPersediaanUnitKerjaSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPersediaanUnitKerja = $_REQUEST['cmbJenisrkbmdPersediaanUnitKerja'];
		$arrKondisi = array();
...
$rkbmdPersediaanUnitKerja = new rkbmdPersediaanUnitKerjaObj();
$arrayResult = tahapPerencanaanV3($rkbmdPersediaanUnitKerja->modul,"MURNI");
...
$rkbmdPersediaanUnitKerja->jenisForm = $jenisForm;
$rkbmdPersediaanUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPersediaanUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPersediaanUnitKerja->tahun = $tahun;
$rkbmdPersediaanUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanUnitKerja->idTahap = $idTahap;
$rkbmdPersediaanUnitKerja->username = $_COOKIE['coID'];
$rkbmdPersediaanUnitKerja->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPersediaanUnitKerja->wajibValidasi == TRUE){
	$rkbmdPersediaanUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanUnitKerja->sqlValidasi = " ";
}
$rkbmdPersediaanUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPersediaanUnitKerja->kota = $arrayResult['kota'];

$rkbmdPersediaanUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPersediaanUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPersediaanUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPersediaanUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPersediaanUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPersediaanUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPersediaanUnitKerja->settingAnggaran = $arrayResult['settingAnggaran'];
