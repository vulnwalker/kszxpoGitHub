...
class rkbmdPemeliharaanSKPDPerubahanObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanSKPDPerubahan';
	...
	var $FormName = 'rkbmdPemeliharaanSKPDPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $username = "";
             ...
             var $reportURL11 = "pages.php?Pg=rkbmdPemeliharaanSKPDPerubahan&tipe=Pemeliharaan11";
             var $reportURL12 = "pages.php?Pg=rkbmdPemeliharaanSKPDPerubahan&tipe=Pemeliharaan12";
             var $reportURL13 = "pages.php?Pg=rkbmdPemeliharaanSKPDPerubahan&tipe=Pemeliharaan13";
	var $wajibValidasi = "";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanSKPDPerubahan\" title='RKBMD'  > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanSKPDPerubahan\" title='RKBMD PENGELOLA'  style='color : blue;' > PEMELIHARAAN </a> |
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaanSKPDPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPemeliharaanSKPDPerubahan['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPDPerubahan['c'];
					$parentD = $getParentrkbmdPemeliharaanSKPDPerubahan['d'];
					$parentE = $getParentrkbmdPemeliharaanSKPDPerubahan['e'];
					$parentE1= $getParentrkbmdPemeliharaanSKPDPerubahan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaanSKPDPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaanSKPDPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaanSKPDPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaanSKPDPerubahan['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPDPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaanSKPDPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaanSKPDPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPemeliharaanSKPDPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaanSKPDPerubahannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif( $getrkbmdPemeliharaanSKPDPerubahannya['volume_barang'] >= $angkaKoreksi ) {
						...
						if( $getrkbmdPemeliharaanSKPDPerubahannya['volume_barang'] >= $angkaKoreksi )  {
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanSKPDPerubahan.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPDPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPDPerubahan.koreksi('$id_anggaran');></img> ";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaanSKPDPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaanSKPDPerubahan' id='cmbJenisrkbmdPemeliharaanSKPDPerubahan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaanSKPDPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaanSKPDPerubahanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaanSKPDPerubahan = $_REQUEST['cmbJenisrkbmdPemeliharaanSKPDPerubahan'];
		$arrKondisi = array();
		if(isset($e1)){
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPemeliharaanSKPDPerubahanSkpdfmUrusan'];
	 $c = $dt['rkbmdPemeliharaanSKPDPerubahanSkpdfmSKPD'];
	 $d = $dt['rkbmdPemeliharaanSKPDPerubahanSkpdfmUNIT'];
	 $e = $dt['rkbmdPemeliharaanSKPDPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPemeliharaanSKPDPerubahanSkpdfmSEKSI'];
...
$rkbmdPemeliharaanSKPDPerubahan = new rkbmdPemeliharaanSKPDPerubahanObj();
...
$rkbmdPemeliharaanSKPDPerubahan->jenisForm = $jenisForm;
$rkbmdPemeliharaanSKPDPerubahan->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanSKPDPerubahan->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanSKPDPerubahan->tahun = $tahun;
$rkbmdPemeliharaanSKPDPerubahan->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanSKPDPerubahan->idTahap = $idTahap;
$rkbmdPemeliharaanSKPDPerubahan->username = $_COOKIE['coID'];
$rkbmdPemeliharaanSKPDPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaanSKPDPerubahan->wajibValidasi == TRUE){
	$rkbmdPemeliharaanSKPDPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanSKPDPerubahan->sqlValidasi = " ";
}
$rkbmdPemeliharaanSKPDPerubahan->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaanSKPDPerubahan->kota = $arrayResult['kota'];
$rkbmdPemeliharaanSKPDPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaanSKPDPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaanSKPDPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaanSKPDPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaanSKPDPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaanSKPDPerubahan->nipPejabat = $arrayResult['nipPejabat'];
