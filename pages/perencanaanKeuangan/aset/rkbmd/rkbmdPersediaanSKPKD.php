...
class rkbmdPersediaanSKPKDObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanSKPKD';
	...
	var $FormName = 'rkbmdPersediaanSKPKDForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $nipPejabat = "";
	var $nipPengurus ="";
	var $kondisiBarang = "and f != '01' and f!='02' and f!='03' and f!='03' and f!='04' and f!='05' and f!='06' and f!='07'";
	var $reportURL7 = "pages.php?Pg=rkbmdPersediaanSKPKD&tipe=Persediaan7";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanSKPKD\" title='RKBMD PENGELOLA'  > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanSKPKD\" title='RKBMD PERSEDIAAN'  style='color : blue;'   > PERSEDIAAN </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($rkbmdPersediaanSKPKDSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPersediaanSKPKDSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPersediaanSKPKDSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPersediaanSKPKDSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPersediaanSKPKDSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanSKPKDSkpdfmUrusan' and c = '$rkbmdPersediaanSKPKDSkpdfmSKPD' and d='$rkbmdPersediaanSKPKDSkpdfmUNIT' and e = '$rkbmdPersediaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPersediaanSKPKDSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanSKPKDSkpdfmUrusan' and c = '$rkbmdPersediaanSKPKDSkpdfmSKPD' and d='$rkbmdPersediaanSKPKDSkpdfmUNIT' and e = '$rkbmdPersediaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPersediaanSKPKDSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanSKPKDSkpdfmUrusan' and c = '$rkbmdPersediaanSKPKDSkpdfmSKPD' and d='$rkbmdPersediaanSKPKDSkpdfmUNIT' and e = '$rkbmdPersediaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPersediaanSKPKDSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPersediaanSKPKD = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPersediaanSKPKD['c1'];
					$parentC = $getParentrkbmdPersediaanSKPKD['c'];
					$parentD = $getParentrkbmdPersediaanSKPKD['d'];
					$parentE = $getParentrkbmdPersediaanSKPKD['e'];
					$parentE1= $getParentrkbmdPersediaanSKPKD['e1'];
					...
					if($cmbJenisrkbmdPersediaanSKPKD == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPersediaanSKPKD_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPersediaanSKPKD = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPersediaanSKPKD as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPersediaanSKPKD['c1'];
					$parentC = $getParentrkbmdPersediaanSKPKD['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPersediaanSKPKD_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPersediaanSKPKD_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPersediaanSKPKDnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPersediaanSKPKDnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanSKPKDnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPersediaanSKPKDnya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPersediaanSKPKD.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanSKPKD.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanSKPKD.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPersediaanSKPKDSkpdfmUrusan'];
	 $c = $dt['rkbmdPersediaanSKPKDSkpdfmSKPD'];
	 $d = $dt['rkbmdPersediaanSKPKDSkpdfmUNIT'];
	 $e = $dt['rkbmdPersediaanSKPKDSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPersediaanSKPKDSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPersediaanSKPKDSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPersediaanSKPKD' id='cmbJenisrkbmdPersediaanSKPKD' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPersediaanSKPKDSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPersediaanSKPKDSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPersediaanSKPKDSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPersediaanSKPKDSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPersediaanSKPKDSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPersediaanSKPKD = $_REQUEST['cmbJenisrkbmdPersediaanSKPKD'];
		$arrKondisi = array();
...
$rkbmdPersediaanSKPKD = new rkbmdPersediaanSKPKDObj();
...
$rkbmdPersediaanSKPKD->jenisForm = $jenisForm;
$rkbmdPersediaanSKPKD->nomorUrut = $nomorUrut;
$rkbmdPersediaanSKPKD->urutTerakhir = $nomorUrut;
$rkbmdPersediaanSKPKD->tahun = $tahun;
$rkbmdPersediaanSKPKD->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanSKPKD->idTahap = $idTahap;
$rkbmdPersediaanSKPKD->username = $_COOKIE['coID'];
$rkbmdPersediaanSKPKD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPersediaanSKPKD->wajibValidasi == TRUE){
	$rkbmdPersediaanSKPKD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanSKPKD->sqlValidasi = " ";
}

$rkbmdPersediaanSKPKD->provinsi = $arrayResult['provinsi'];
$rkbmdPersediaanSKPKD->kota = $arrayResult['kota'];
$rkbmdPersediaanSKPKD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPersediaanSKPKD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPersediaanSKPKD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPersediaanSKPKD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPersediaanSKPKD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPersediaanSKPKD->nipPejabat = $arrayResult['nipPejabat'];
