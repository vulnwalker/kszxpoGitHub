...
class rkbmdPenghapusanUnitKerjaObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPenghapusanUnitKerja';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 't_rencana_penghapusan'; //daftar
	var $TblName_Hapus = 't_rencana_penghapusan';
	var $MaxFlush = 10;
	...
	var $FieldSum_Cp2 = array( 8, 3, 3);	
	var $checkbox_rowspan = 2;
	var $PageTitle = 'Perencanaan Kebutuhan dan Penganggaran';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='Rencana Penghapusan.xls';
	var $Cetak_Judul = 'RENCANA PENGHAPUSAN';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	
	var $FormName = 'rkbmdPenghapusanUnitKerjaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	var $nipPengurus ="";		
	function setTitle(){
		return 'Rencana Penghapusan Barang Milik Daerah (RHBMD)';
	}
	...
	function setMenuView(){
		return 
			...
			"<td>".genPanelIcon("javascript:".$this->Prefix.".exportXls()","export_xls.png","Excell", 'Excell');
	...
	function simpan(){
	 ...
	 $idbi_awal=$_REQUEST['fmidbi_awal'];
		...
		if($err==''){ 
			...
			//Simpan DATA
			//==================================
				$ck_penghapusan = mysql_fetch_array(mysql_query("SELECT count(*) as cnt FROM t_rencana_penghapusan WHERE $kondisi1 "));
				if($ck_penghapusan['cnt']>0 && $err=="") $err="Barang Sudah Masuk Ke Rencana Penghapusan!";
		
				if($err==''){ 
					$aqry= "insert into t_rencana_penghapusan (".
			...
			//==================================					
				if($err==''){
					$aqry= "update t_rencana_penghapusan set ".
	...
	function setPage_OtherScript(){
		...
		return 
		 ...
		 "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/".$this->Prefix.".js' language='JavaScript' ></script>".
	...
	global $Main;
		...
		$aqry = "select * from t_rencana_penghapusan where Id='".$this->form_idplh."'"; $cek.=$aqry;
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rkbmdPenghapusanUnitKerja_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkiba' name='rkbmdPenghapusanUnitKerja_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkibb' name='rkbmdPenghapusanUnitKerja_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkibc' name='rkbmdPenghapusanUnitKerja_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkibd' name='rkbmdPenghapusanUnitKerja_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkibe' name='rkbmdPenghapusanUnitKerja_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanUnitKerja_formkibf' name='rkbmdPenghapusanUnitKerja_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rkbmdPenghapusanUnitKerja' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rkbmdPenghapusanUnitKerja' name='det_rkbmdPenghapusanUnitKerja' >".$rkbmdPenghapusanUnitKerja_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
		$this->form_menubawah =	
			...
			"<input type='button' value='Batal' onclick ='".$this->Prefix.".Close()' title='Batal Rencana Penghapusan' >";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPenghapusanUnitKerja\" title='RKBMD PENGHAPUSAN' style='color : blue;' > PENGHAPUSAN </a> 
...
$rkbmdPenghapusanUnitKerja = new rkbmdPenghapusanUnitKerjaObj();

$arrayResult = tahapPerencanaanV3($rkbmdPenghapusanUnitKerja->modul);
...
$rkbmdPenghapusanUnitKerja->jenisForm = $jenisForm;
$rkbmdPenghapusanUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPenghapusanUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPenghapusanUnitKerja->tahun = $tahun;
$rkbmdPenghapusanUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPenghapusanUnitKerja->idTahap = $idTahap;
$rkbmdPenghapusanUnitKerja->username = $_COOKIE['coID'];
$rkbmdPenghapusanUnitKerja->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPenghapusanUnitKerja->wajibValidasi == TRUE){
	$rkbmdPenghapusanUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPenghapusanUnitKerja->sqlValidasi = " ";
}
$rkbmdPenghapusanUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPenghapusanUnitKerja->kota = $arrayResult['kota'];

$rkbmdPenghapusanUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPenghapusanUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPenghapusanUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPenghapusanUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPenghapusanUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPenghapusanUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
