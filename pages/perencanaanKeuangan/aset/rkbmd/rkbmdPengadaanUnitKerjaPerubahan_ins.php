<?php
class rkbmdPengadaanUnitKerjaPerubahan_insObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPengadaanUnitKerjaPerubahan_ins';
	...
	var $FormName = 'rkbmdPengadaanUnitKerjaPerubahan_insForm';
	var $noModul=14; 
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanUnitKerjaPerubahan_ins.js' language='JavaScript' ></script>".
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerjaPerubahan_ins.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerjaPerubahan_ins.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPengadaanUnitKerjaPerubahan_ins.CekAda(); ','-- KEGIATAN --');  
					...
					$this->isiform(
						array(
							...
							array( 
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPengadaanUnitKerjaPerubahan_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"				
							),
							array( 
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly /> 
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPengadaanUnitKerjaPerubahan_ins.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'> 
						<a class='toolbar' id='btsave' href='javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.$tujuan'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.closeTab()'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='finish' href='javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.finish()'> 
...
$rkbmdPengadaanUnitKerjaPerubahan_ins = new rkbmdPengadaanUnitKerjaPerubahan_insObj();

$arrayResult = tahapPerencanaanV3($rkbmdPengadaanUnitKerjaPerubahan_ins->modul,"PERUBAHAN");
...
$rkbmdPengadaanUnitKerjaPerubahan_ins->jenisForm = $jenisForm;
$rkbmdPengadaanUnitKerjaPerubahan_ins->nomorUrut = $nomorUrut;
$rkbmdPengadaanUnitKerjaPerubahan_ins->urutTerakhir = $nomorUrut;
$rkbmdPengadaanUnitKerjaPerubahan_ins->tahun = $tahun;
$rkbmdPengadaanUnitKerjaPerubahan_ins->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanUnitKerjaPerubahan_ins->idTahap = $idTahap;
$rkbmdPengadaanUnitKerjaPerubahan_ins->username = $_COOKIE['coID'];
$rkbmdPengadaanUnitKerjaPerubahan_ins->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPengadaanUnitKerjaPerubahan_ins->wajibValidasi == TRUE){
	$rkbmdPengadaanUnitKerjaPerubahan_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanUnitKerjaPerubahan_ins->sqlValidasi = " ";
}
