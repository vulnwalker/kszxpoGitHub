...
class rkbmdPemindahtangananSKPDObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPemindahtangananSKPD';
	...
	var $FormName = 'rkbmdPemindahtangananSKPDForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	var $nipPengurus ="";			
	function setTitle(){
		return 'PEMINDAHTANGANAN PENGGUNA BARANG';
	}
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rkbmdPemindahtangananSKPD_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkiba' name='rkbmdPemindahtangananSKPD_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkibb' name='rkbmdPemindahtangananSKPD_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkibc' name='rkbmdPemindahtangananSKPD_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkibd' name='rkbmdPemindahtangananSKPD_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkibe' name='rkbmdPemindahtangananSKPD_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahtangananSKPD_formkibf' name='rkbmdPemindahtangananSKPD_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rkbmdPemindahtangananSKPD' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rkbmdPemindahtangananSKPD' name='det_rkbmdPemindahtangananSKPD' >".$rkbmdPemindahtangananSKPD_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPemindahtangananSKPD\" title='RKBMD PEMINDAHTANGANAN' style='color : blue;'> PEMINDAHTANGANAN </a> |
...
$rkbmdPemindahtangananSKPD = new rkbmdPemindahtangananSKPDObj();

$arrayResult = tahapPerencanaanV3($rkbmdPemindahtangananSKPD->modul);
...
$rkbmdPemindahtangananSKPD->jenisForm = $jenisForm;
$rkbmdPemindahtangananSKPD->nomorUrut = $nomorUrut;
$rkbmdPemindahtangananSKPD->urutTerakhir = $nomorUrut;
$rkbmdPemindahtangananSKPD->tahun = $tahun;
$rkbmdPemindahtangananSKPD->jenisAnggaran = $jenisAnggaran;
$rkbmdPemindahtangananSKPD->idTahap = $idTahap;
$rkbmdPemindahtangananSKPD->username = $_COOKIE['coID'];
$rkbmdPemindahtangananSKPD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemindahtangananSKPD->wajibValidasi == TRUE){
	$rkbmdPemindahtangananSKPD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemindahtangananSKPD->sqlValidasi = " ";
}
$rkbmdPemindahtangananSKPD->provinsi = $arrayResult['provinsi'];
$rkbmdPemindahtangananSKPD->kota = $arrayResult['kota'];

$rkbmdPemindahtangananSKPD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemindahtangananSKPD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemindahtangananSKPD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemindahtangananSKPD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemindahtangananSKPD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemindahtangananSKPD->nipPejabat = $arrayResult['nipPejabat'];
