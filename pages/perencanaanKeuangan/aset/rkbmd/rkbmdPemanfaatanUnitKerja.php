...
class rkbmdPemanfaatanUnitKerjaObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPemanfaatanUnitKerja';
	...
	var $FormName = 'rkbmdPemanfaatanUnitKerjaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setForm($dt){	
	 ...
	 $this->form_height = $sh-100;
	  if ($this->form_fmST==0) {
		...
		$rkbmdPemanfaatanUnitKerja_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(	
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkiba' name='rkbmdPemanfaatanUnitKerja_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkibb' name='rkbmdPemanfaatanUnitKerja_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkibc' name='rkbmdPemanfaatanUnitKerja_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkibd' name='rkbmdPemanfaatanUnitKerja_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkibe' name='rkbmdPemanfaatanUnitKerja_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanUnitKerja_formkibf' name='rkbmdPemanfaatanUnitKerja_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
				'det_rencana_pemanfaatan' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rencana_pemanfaatan' name='det_rencana_pemanfaatan' >".$rkbmdPemanfaatanUnitKerja_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPemanfaatanUnitKerja\" title='RKBMD PEMANFAATAN' style='color : blue;' > PEMANFAATAN </a> |
	...
	function getDaftarOpsi($Mode=1){
		...
		$fmPILCARI = cekPOST('fmPILCARI');
		$fmPILCARIVALUE = cekPOST('fmPILCARIVALUE');
		/*$fmURUSAN = cekPOST('rkbmdPemanfaatanUnitKerjaSkpdfmURUSAN');
...
$rkbmdPemanfaatanUnitKerja = new rkbmdPemanfaatanUnitKerjaObj();


$arrayResult = tahapPerencanaanV3($rkbmdPemanfaatanUnitKerja->modul);
...
$rkbmdPemanfaatanUnitKerja->jenisForm = $jenisForm;
$rkbmdPemanfaatanUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPemanfaatanUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPemanfaatanUnitKerja->tahun = $tahun;
$rkbmdPemanfaatanUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPemanfaatanUnitKerja->idTahap = $idTahap;
$rkbmdPemanfaatanUnitKerja->username = $_COOKIE['coID'];
$rkbmdPemanfaatanUnitKerja->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemanfaatanUnitKerja->wajibValidasi == TRUE){
	$rkbmdPemanfaatanUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemanfaatanUnitKerja->sqlValidasi = " ";
}
$rkbmdPemanfaatanUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPemanfaatanUnitKerja->kota = $arrayResult['kota'];

$rkbmdPemanfaatanUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemanfaatanUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemanfaatanUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemanfaatanUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemanfaatanUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemanfaatanUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
