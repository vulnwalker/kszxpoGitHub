...
class rkbmdPemindahTangananUnitKerjaObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPemindahTangananUnitKerja';
	...
	var $FormName = 'rkbmdPemindahTangananUnitKerjaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rkbmdPemindahTangananUnitKerja_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkiba' name='rkbmdPemindahTangananUnitKerja_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkibb' name='rkbmdPemindahTangananUnitKerja_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkibc' name='rkbmdPemindahTangananUnitKerja_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkibd' name='rkbmdPemindahTangananUnitKerja_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkibe' name='rkbmdPemindahTangananUnitKerja_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemindahTangananUnitKerja_formkibf' name='rkbmdPemindahTangananUnitKerja_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rkbmdPemindahTangananUnitKerja' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rkbmdPemindahTangananUnitKerja' name='det_rkbmdPemindahTangananUnitKerja' >".$rkbmdPemindahTangananUnitKerja_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPemindahTangananUnitKerja\" title='RKBMD PEMINDAHTANGANAN' style='color : blue;' > PEMINDAHTANGANAN </a> |
...
$rkbmdPemindahTangananUnitKerja = new rkbmdPemindahTangananUnitKerjaObj();

$arrayResult = tahapPerencanaanV3($rkbmdPemindahTangananUnitKerja->modul);
...
$rkbmdPemindahTangananUnitKerja->jenisForm = $jenisForm;
$rkbmdPemindahTangananUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPemindahTangananUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPemindahTangananUnitKerja->tahun = $tahun;
$rkbmdPemindahTangananUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPemindahTangananUnitKerja->idTahap = $idTahap;
$rkbmdPemindahTangananUnitKerja->username = $_COOKIE['coID'];
$rkbmdPemindahTangananUnitKerja->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemindahTangananUnitKerja->wajibValidasi == TRUE){
	$rkbmdPemindahTangananUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemindahTangananUnitKerja->sqlValidasi = " ";
}
$rkbmdPemindahTangananUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPemindahTangananUnitKerja->kota = $arrayResult['kota'];

$rkbmdPemindahTangananUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemindahTangananUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemindahTangananUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemindahTangananUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemindahTangananUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemindahTangananUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
