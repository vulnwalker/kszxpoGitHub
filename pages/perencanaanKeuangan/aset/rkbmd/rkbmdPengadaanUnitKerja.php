...
class rkbmdPengadaanUnitKerjaObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPengadaanUnitKerja';
	...
	var $FormName = 'rkbmdPengadaanUnitKerjaForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPengadaanUnitKerja&tipe=Pengadaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPengadaanUnitKerja&tipe=Pengadaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPengadaanUnitKerja&tipe=Pengadaan3";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanUnitKerja\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPengadaanUnitKerjaSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPengadaanUnitKerjaSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPengadaanUnitKerjaSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPengadaanUnitKerjaSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPengadaanUnitKerjaSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPengadaanUnitKerjaSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPengadaanUnitKerjaSkpdfmUrusan;
		   $parentC = $rkbmdPengadaanUnitKerjaSkpdfmSKPD;
			 $parentD = $rkbmdPengadaanUnitKerjaSkpdfmUNIT;
			 $parentE = $rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPengadaanUnitKerjaSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPengadaanUnitKerja == 'PENGADAAN'){
						$kemana = 'ins';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPengadaanUnitKerja_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaanUnitKerja = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPengadaanUnitKerja as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPengadaanUnitKerja['c1'];
					$parentC = $getParentrkbmdPengadaanUnitKerja['c'];
					$parentD = $getParentrkbmdPengadaanUnitKerja['d'];
					$parentE = $getParentrkbmdPengadaanUnitKerja['e'];
					$parentE1= $getParentrkbmdPengadaanUnitKerja['e1'];
					$parentBK = $getParentrkbmdPengadaanUnitKerja['bk'];
					$parentCK = $getParentrkbmdPengadaanUnitKerja['ck'];
					$parentDK = $getParentrkbmdPengadaanUnitKerja['dk'];
					$parentP = $getParentrkbmdPengadaanUnitKerja['p'];
					$parentQ = $getParentrkbmdPengadaanUnitKerja['q'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPengadaanUnitKerja_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPengadaanUnitKerja_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPengadaanUnitKerjanya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPengadaanUnitKerjanya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaanUnitKerjanya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPengadaanUnitKerjanya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
 	  ...
 	  return
 	    ...
 	    <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
 	     "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanUnitKerja.js' language='JavaScript' ></script>".
 	    $scriptload;
 	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerja.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerja.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPengadaanUnitKerjaSkpdfmUrusan'];
	 $c = $dt['rkbmdPengadaanUnitKerjaSkpdfmSKPD'];
	 $d = $dt['rkbmdPengadaanUnitKerjaSkpdfmUNIT'];
	 $e = $dt['rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPengadaanUnitKerjaSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPengadaanUnitKerjaSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPengadaanUnitKerja' id='cmbJenisrkbmdPengadaanUnitKerja' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPengadaanUnitKerjaSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPengadaanUnitKerjaSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPengadaanUnitKerjaSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPengadaanUnitKerjaSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPengadaanUnitKerjaSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPengadaanUnitKerja = $_REQUEST['cmbJenisrkbmdPengadaanUnitKerja'];
		$arrKondisi = array();
...
function Pengadaan1($xls =FALSE){
		...
		echo "
								<br>
								<table table width='100%' class='cetak' border='1' style='margin:-10 0 0 0;width:100%;'>
								<thead>
									<tr>
...
$rkbmdPengadaanUnitKerja = new rkbmdPengadaanUnitKerjaObj();
$arrayResult = tahapPerencanaanV3($rkbmdPengadaanUnitKerja->modul,"MURNI");
...
$rkbmdPengadaanUnitKerja->jenisForm = $jenisForm;
$rkbmdPengadaanUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPengadaanUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPengadaanUnitKerja->tahun = $tahun;
$rkbmdPengadaanUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanUnitKerja->idTahap = $idTahap;
$rkbmdPengadaanUnitKerja->username = $_COOKIE['coID'];
$rkbmdPengadaanUnitKerja->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPengadaanUnitKerja->wajibValidasi == TRUE){
	$rkbmdPengadaanUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanUnitKerja->sqlValidasi = " ";
}
$rkbmdPengadaanUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPengadaanUnitKerja->kota = $arrayResult['kota'];

$rkbmdPengadaanUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPengadaanUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPengadaanUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPengadaanUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPengadaanUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPengadaanUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPengadaanUnitKerja->settingAnggaran = $arrayResult['settingAnggaran'];
