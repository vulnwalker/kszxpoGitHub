...
class koreksiPengelolaPemeliharaanPerubahanObj  extends DaftarObj2{	
	var $Prefix = 'koreksiPengelolaPemeliharaanPerubahan';
	...
	var $FormName = 'koreksiPengelolaPemeliharaanPerubahanForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD'   > RKBMD </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaanPerubahan\" title='RKBMD PENGELOLA'  style='color : blue;'> RKBMD PENGELOLA </a> 

		&nbsp&nbsp&nbsp	
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaanPerubahan\" title='RKBMD' > PENGADAAN </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaanPerubahan\" title='RKBMD PENGELOLA'  style='color : blue;'  > PEMELIHARAAN </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPersediaanPerubahan\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a> 
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 /*if($koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan' and c = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD' and d='$koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT' and e = '$koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPengelolaPemeliharaanPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPemeliharaanPerubahan['c1'];
					$parentC = $getParentkoreksiPengelolaPemeliharaanPerubahan['c'];
					$parentD = $getParentkoreksiPengelolaPemeliharaanPerubahan['d'];
					$parentE = $getParentkoreksiPengelolaPemeliharaanPerubahan['e'];
					$parentE1= $getParentkoreksiPengelolaPemeliharaanPerubahan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPemeliharaanPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPemeliharaanPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPemeliharaanPerubahan as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentkoreksiPengelolaPemeliharaanPerubahan['c1'];
					$parentC = $getParentkoreksiPengelolaPemeliharaanPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPemeliharaanPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPemeliharaanPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPemeliharaanPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPemeliharaanPerubahannya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if( $getkoreksiPengelolaPemeliharaanPerubahannya['volume_barang'] >= $angkaKoreksi ) {
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPengelolaPemeliharaanPerubahannya['volume_barang'] < $angkaKoreksi){
	...
	function setPage_OtherScript(){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPemeliharaanPerubahan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPemeliharaanPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPemeliharaanPerubahan.koreksi('$id_anggaran');></img> ";
...
function Pemeliharaan14($xls =FALSE){
		global $Main;
		
	
		
		$this->fileNameExcel = "PERUBAHAN RKBMD PEMELIHARAAN PROVINSI/KABUPATEN/KOTA";
		$align = "right";
		$xls = $_GET['xls'];
		...
		$getLastTahap = mysql_fetch_array(mysql_query("select max(id_anggaran) from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran'  and j!='000'  and uraian_pemeliharaan != 'RKBMD PENGADAAN' and uraian_pemeliharaan != 'RKBMD PERSEDIAAN' and jenis_form_modul ='KOREKSI PENGELOLA'"));
		...
		/*$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan != 'RKBMD PENGADAAN' and uraian_pemeliharaan != 'RKBMD PERSEDIAAN'  and p !='0' and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			...
			$grabKegiatan = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan != 'RKBMD PENGADAAN' and uraian_pemeliharaan != 'RKBMD PERSEDIAAN' and bk='$bk' and ck='$ck'  and p ='$p' and q!='0' and j='000'");
				while($row2s = mysql_fetch_array($grabKegiatan)){
					...
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan !=''  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' ")) == 0){
						...
						$grabBarang = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and uraian_pemeliharaan != 'RKBMD PENGADAAN' and uraian_pemeliharaan != 'RKBMD PERSEDIAAN' and bk='$bk' and ck='$ck'  and p ='$p' and q='$q' and j!='000'");
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and uraian_pemeliharaan != 'RKBMD PENGADAAN' and uraian_pemeliharaan != 'RKBMD PERSEDIAAN' $this->kondisiBarang  $Kondisi order by urut";
		$aqry = mysql_query($qry);
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and no_urut = '5' and jenis_anggaran = 'MURNI' and tahun ='$this->tahun' "));
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');
				
				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and no_urut = '3' and jenis_anggaran = 'PERUBAHAN' and tahun ='$this->tahun' "));
...
function excel($dt){	
	 ...
	 $c1 = $dt['koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan'];
	 $c = $dt['koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD'];
	 $d = $dt['koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT'];
	 $e = $dt['koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI'];
	 ...
	 /*if($e1 != '000'){
	 	...
	 	$arrayJenisLaporan = array(
							   array('Pemeliharaan14', 'PERUBAHAN RKBMD PEMELIHARAAN PROVINSI/KABUPATEN/KOTA'),
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("koreksiPengelolaPemeliharaanPerubahanSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPemeliharaanPerubahan' id='cmbJeniskoreksiPengelolaPemeliharaanPerubahan' value='PEMELIHARAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['koreksiPengelolaPemeliharaanPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPemeliharaanPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPemeliharaanPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPemeliharaanPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPemeliharaanPerubahanSkpdfmSEKSI'];	
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPemeliharaanPerubahan = $_REQUEST['cmbJeniskoreksiPengelolaPemeliharaanPerubahan'];
		$arrKondisi = array();
		if(isset($e1)){
...
$koreksiPengelolaPemeliharaanPerubahan = new koreksiPengelolaPemeliharaanPerubahanObj();
...
$koreksiPengelolaPemeliharaanPerubahan->jenisForm = $jenisForm;
$koreksiPengelolaPemeliharaanPerubahan->nomorUrut = $nomorUrut;
$koreksiPengelolaPemeliharaanPerubahan->urutTerakhir = $nomorUrut;
$koreksiPengelolaPemeliharaanPerubahan->tahun = $tahun;
$koreksiPengelolaPemeliharaanPerubahan->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPemeliharaanPerubahan->idTahap = $idTahap;
$koreksiPengelolaPemeliharaanPerubahan->username = $_COOKIE['coID'];
$koreksiPengelolaPemeliharaanPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPemeliharaanPerubahan->wajibValidasi == TRUE){
	$koreksiPengelolaPemeliharaanPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPemeliharaanPerubahan->sqlValidasi = " ";
}
$koreksiPengelolaPemeliharaanPerubahan->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPemeliharaanPerubahan->kota = $arrayResult['kota'];
$koreksiPengelolaPemeliharaanPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPemeliharaanPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPemeliharaanPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPemeliharaanPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPemeliharaanPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPemeliharaanPerubahan->nipPejabat = $arrayResult['nipPejabat'];
