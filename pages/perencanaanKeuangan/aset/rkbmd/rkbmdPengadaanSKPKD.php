...
class rkbmdPengadaanSKPKDObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPengadaanSKPKD';
	...
	var $FormName = 'rkbmdPengadaanSKPKDForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL7 = "pages.php?Pg=rkbmdPengadaanSKPKD&tipe=Pengadaan7";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanSKPKD\" title='RKBMD'   style='color : blue;'  > PENGADAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($rkbmdPengadaanSKPKDSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPengadaanSKPKDSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPengadaanSKPKDSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPengadaanSKPKDSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPengadaanSKPKDSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPKDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPKDSkpdfmSKPD' and d='$rkbmdPengadaanSKPKDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPKDSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPKDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPKDSkpdfmSKPD' and d='$rkbmdPengadaanSKPKDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPKDSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPKDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPKDSkpdfmSKPD' and d='$rkbmdPengadaanSKPKDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPKDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPKDSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPengadaanSKPKD = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPengadaanSKPKD['c1'];
					$parentC = $getParentrkbmdPengadaanSKPKD['c'];
					$parentD = $getParentrkbmdPengadaanSKPKD['d'];
					$parentE = $getParentrkbmdPengadaanSKPKD['e'];
					$parentE1= $getParentrkbmdPengadaanSKPKD['e1'];
					...
					if($cmbJenisrkbmdPengadaanSKPKD == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPengadaanSKPKD_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaanSKPKD = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPengadaanSKPKD as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPengadaanSKPKD['c1'];
					$parentC = $getParentrkbmdPengadaanSKPKD['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPengadaanSKPKD_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPengadaanSKPKD_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPengadaanSKPKDnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPengadaanSKPKDnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaanSKPKDnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPengadaanSKPKDnya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanSKPKD.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanSKPKD.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanSKPKD.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPengadaanSKPKDSkpdfmUrusan'];
	 $c = $dt['rkbmdPengadaanSKPKDSkpdfmSKPD'];
	 $d = $dt['rkbmdPengadaanSKPKDSkpdfmUNIT'];
	 $e = $dt['rkbmdPengadaanSKPKDSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPengadaanSKPKDSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPengadaanSKPKDSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPengadaanSKPKD' id='cmbJenisrkbmdPengadaanSKPKD' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPengadaanSKPKDSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPengadaanSKPKDSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPengadaanSKPKDSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPengadaanSKPKDSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPengadaanSKPKDSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPengadaanSKPKD = $_REQUEST['cmbJenisrkbmdPengadaanSKPKD'];
		$arrKondisi = array();
...
$rkbmdPengadaanSKPKD = new rkbmdPengadaanSKPKDObj();
...
$rkbmdPengadaanSKPKD->jenisForm = $jenisForm;
$rkbmdPengadaanSKPKD->nomorUrut = $nomorUrut;
$rkbmdPengadaanSKPKD->urutTerakhir = $nomorUrut;
$rkbmdPengadaanSKPKD->tahun = $tahun;
$rkbmdPengadaanSKPKD->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanSKPKD->idTahap = $idTahap;
$rkbmdPengadaanSKPKD->username = $_COOKIE['coID'];
$rkbmdPengadaanSKPKD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPengadaanSKPKD->wajibValidasi == TRUE){
	$rkbmdPengadaanSKPKD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanSKPKD->sqlValidasi = " ";
}

$rkbmdPengadaanSKPKD->provinsi = $arrayResult['provinsi'];
$rkbmdPengadaanSKPKD->kota = $arrayResult['kota'];
$rkbmdPengadaanSKPKD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPengadaanSKPKD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPengadaanSKPKD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPengadaanSKPKD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPengadaanSKPKD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPengadaanSKPKD->nipPejabat = $arrayResult['nipPejabat'];
