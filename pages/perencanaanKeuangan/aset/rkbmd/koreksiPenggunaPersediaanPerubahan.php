...
class koreksiPenggunaPersediaanPerubahanObj  extends DaftarObj2{	
	var $Prefix = 'koreksiPenggunaPersediaanPerubahan';
	...
	var $FormName = 'koreksiPenggunaPersediaanPerubahanForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPersediaanPerubahan\" title='RKBMD PENGELOLA' > RKBMD PENGELOLA </a> 
		...
		<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan\" title='RKBMD PENGELOLA'  > PEMELIHARAAN </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD PERSEDIAAN' style='color : blue;' > PERSEDIAAN </a> 

		&nbsp&nbsp&nbsp	
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD'   > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD PENGELOLA' style='color : blue;'> KOREKSI </a> 
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 if($koreksiPenggunaPersediaanPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPenggunaPersediaanPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPenggunaPersediaanPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPersediaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPersediaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPersediaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPersediaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPersediaanPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPersediaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPersediaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPersediaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPersediaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPersediaanPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPersediaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPersediaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPersediaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPersediaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPersediaanPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPenggunaPersediaanPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPenggunaPersediaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPersediaanPerubahan['c'];
					$parentD = $getParentkoreksiPenggunaPersediaanPerubahan['d'];
					$parentE = $getParentkoreksiPenggunaPersediaanPerubahan['e'];
					$parentE1= $getParentkoreksiPenggunaPersediaanPerubahan['e1'];
					...
					if($cmbJeniskoreksiPenggunaPersediaanPerubahan == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPenggunaPersediaanPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPersediaanPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPenggunaPersediaanPerubahan as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentkoreksiPenggunaPersediaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPersediaanPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPenggunaPersediaanPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPenggunaPersediaanPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
			...
			for($i = 0 ; $i < sizeof($id) ; $i++ ){
				...
				$get = mysql_query("select * from tabel_anggaran where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and ((id_jenis_pemeliharaan = '0' and f !='00') or uraian_pemeliharaan = 'RKBMD PERSEDIAAN') and id_anggaran!='$id[$i]' ");
		...
		case 'koreksi':{
			...
			$getkoreksiPenggunaPersediaanPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPenggunaPersediaanPerubahannya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPenggunaPersediaanPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPenggunaPersediaanPerubahannya['volume_barang'] < $angkaKoreksi){
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) ) && $getkoreksiPenggunaPersediaanPerubahannya['volume_barang'] >= $angkaKoreksi ){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPenggunaPersediaanPerubahan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	 ...
	 if($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						// $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPersediaanPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPersediaanPerubahan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){	
	 ...
	 $c1 = $dt['koreksiPenggunaPersediaanPerubahanSkpdfmUrusan'];
	 $c = $dt['koreksiPenggunaPersediaanPerubahanSkpdfmSKPD'];
	 $d = $dt['koreksiPenggunaPersediaanPerubahanSkpdfmUNIT'];
	 $e = $dt['koreksiPenggunaPersediaanPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPenggunaPersediaanPerubahanSkpdfmSEKSI'];
	 ...
	 /*if($e1 != '000'){
	 	 ...
	 	 $arrayJenisLaporan = array(
							   ...
							   array('Persediaan11', 'PERUBAHAN USULAN RKBMD PERSEDIAAN PADA PENGGUNA BARANG'),
							   array('Persediaan12', 'PERUBAHAN HASIL PENELAAHAN RKBMD PERSEDIAAN OLEH PENGELOLA BARANG'),
							   array('Persediaan13', 'PERUBAHAN RKBMD PERSEDIAAN PADA PENGGUNA BARANG'),
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("koreksiPenggunaPersediaanPerubahanSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPenggunaPersediaanPerubahan' id='cmbJeniskoreksiPenggunaPersediaanPerubahan' value='PERSEDIAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['koreksiPenggunaPersediaanPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPenggunaPersediaanPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPenggunaPersediaanPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPenggunaPersediaanPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPenggunaPersediaanPerubahanSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPenggunaPersediaanPerubahan = $_REQUEST['cmbJeniskoreksiPenggunaPersediaanPerubahan'];
		$arrKondisi = array();		
...
function Persediaan11($xls =FALSE){
	global $Main;
		$this->fileNameExcel = "PERUBAHAN USULAN RKBMD PERSEDIAAN PADA PENGGUNA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
		...
		$getAllParent = mysql_query("select * from view_rkbmd where  tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='3' and f='00' and q !='0' and c1 ='$c1' and c='$c' and d='$d' and id_jenis_pemeliharaan = '0' ");
				while($rows = mysql_fetch_array($getAllParent)){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='3' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1'  and bk='$bk' and ck='$ck' and p='$p' and q='$q'  and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang  "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat'";
						$cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='3' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang"));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
		...
		$qry ="select * from view_rkbmd where no_urut = '3' and jenis_anggaran ='PERUBAHAN' and tahun ='$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and uraian_pemeliharaan !='RKBMD PENGADAAN'  $this->kondisiBarang $Kondisi order by urut";
		$aqry = mysql_query($qry);
		...
		echo 
			...
			"<body >
				...
				<span style='font-size:18px;font-weight:bold;text-decoration: '>
					PERUBAHAN USULAN RENCANA KEBUTUHAN PERSEDIAAN BARANG MILIK DAERAH<br>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '5' and jenis_anggaran ='MURNI' and tahun ='$this->tahun' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan = '0'"));
	...
	function Persediaan12($xls =FALSE){
		global $Main;
		$this->fileNameExcel = "PERUBAHAN HASIL PENELAAHAN RKBMD PERSEDIAAN OLEH PENGELOLA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		$getAllParent = mysql_query("select * from view_rkbmd where  tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and f='00' and q !='0' and c1 ='$c1' and c='$c' and d='$d' and id_jenis_pemeliharaan = '0' ");
				while($rows = mysql_fetch_array($getAllParent)){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q'  and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang  "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat'";
						$cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$this->nomorUrut' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang"));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
		...
		$qry ="select * from view_rkbmd where id_tahap = '$this->idTahap' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and uraian_pemeliharaan !='RKBMD PENGADAAN' $this->kondisiBarang $Kondisi order by urut";
		$aqry = mysql_query($qry);
				...
				<div style='width:$this->Cetak_WIDTH_Landscape;'>
					<table class=\"rangkacetak\" style='width:33cm;font-family:Times New Roman;margin-left:2cm;margin-top:2cm;'>
						<tr>
							<td valign=\"top\"> <div style='text-align:center;'>
				<span style='font-size:18px;font-weight:bold;text-decoration: '>
					PERUBAHAN HASIL PENELAAHAN RENCANA KEBUTUHAN PERSEDIAAN BARANG MILIK DAERAH<br>
					(PERUBAHAN RENCANA PERSEDIAAN)<br>
		...
		echo "
								...
								<table table width='100%' class='cetak' border='1' style='margin:4 0 0 0;width:100%;'>
									<tr>
										...
										<th class='th02' rowspan='1' colspan='8' >USULAN RENCANA KEBUTUHAN PERSEDIAAN BARANG MILIK DAERAH</th>
										<th class='th02' rowspan='1' colspan='2' >KEBUTUHAN MAKSIMUM</th>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '3' and jenis_anggaran = 'PERUBAHAN' and tahun ='$this->tahun' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan='0' "));
	...
	function Persediaan13($xls =FALSE){
		global $Main;
		$this->fileNameExcel = "PERUBAHAN RKBMD PERSEDIAAN PADA PENGGUNA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($p == '0'){
				...
				$getDataSebelumnya = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '$nomorUrutSebelumnya' and tahun='$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and bk ='$bk' and ck='$ck' and p='$p' and q='$q'"));
				$jumlahBarangSebelumnya = $getDataSebelumnya['volume_barang'];
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '5' and jenis_anggaran = 'MURNI' and tahun ='$this->tahun' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_jenis_pemeliharaan = '0'"));
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');
				$getJumlahMenjadi = mysql_fetch_array(mysql_query("select * from view_rkbmd where no_urut = '3' and jenis_anggaran = 'PERUBAHAN' and tahun ='$this->tahun' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_jenis_pemeliharaan = '0'"));
				$jumlahMenjadi = number_format($getJumlahMenjadi['volume_barang'],0,'.',',');
	...
	function Persediaan7($xls =FALSE){
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and uraian_pemeliharaan !='RKBMD PENGADAAN'  $Kondisi order by urut";
		$aqry = mysql_query($qry);
...
$koreksiPenggunaPersediaanPerubahan = new koreksiPenggunaPersediaanPerubahanObj();
...
$koreksiPenggunaPersediaanPerubahan->jenisForm = $jenisForm;
$koreksiPenggunaPersediaanPerubahan->nomorUrut = $nomorUrut;
$koreksiPenggunaPersediaanPerubahan->urutTerakhir = $nomorUrut;
$koreksiPenggunaPersediaanPerubahan->tahun = $tahun;
$koreksiPenggunaPersediaanPerubahan->jenisAnggaran = $jenisAnggaran;
$koreksiPenggunaPersediaanPerubahan->idTahap = $idTahap;
$koreksiPenggunaPersediaanPerubahan->username = $_COOKIE['coID'];
$koreksiPenggunaPersediaanPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPenggunaPersediaanPerubahan->wajibValidasi == TRUE){
	$koreksiPenggunaPersediaanPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPenggunaPersediaanPerubahan->sqlValidasi = " ";
}

$koreksiPenggunaPersediaanPerubahan->provinsi = $arrayResult['provinsi'];
$koreksiPenggunaPersediaanPerubahan->kota = $arrayResult['kota'];
$koreksiPenggunaPersediaanPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPenggunaPersediaanPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPenggunaPersediaanPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPenggunaPersediaanPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPenggunaPersediaanPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPenggunaPersediaanPerubahan->nipPejabat = $arrayResult['nipPejabat'];
