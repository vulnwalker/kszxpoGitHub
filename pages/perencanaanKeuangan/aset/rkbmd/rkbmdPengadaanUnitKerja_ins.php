<?php
class rkbmdPengadaanUnitKerja_insObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPengadaanUnitKerja_ins';
	...
	var $FormName = 'rkbmdPengadaanUnitKerja_insForm';
	var $noModul=14;
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'Simpan':{
			...
			$username = $_COOKIE['coID'];
			$cekAda = mysql_num_rows(mysql_query("select * from temp_rkbmd_pengadaan where  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and user='$username'"));
			if($cekAda == 1){
	...
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,' disabled','-- KEGIATAN --');
	 ...
	 return
	   ...
	   "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanUnitKerja_ins.js' language='JavaScript' ></script>".
	   ...
	   <script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/popupBarangRKBMD.js' language='JavaScript' ></script>
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerja_ins.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerja_ins.edit('$id');></img> ";
	...
	$cekMayoritas = mysql_fetch_array(mysql_query("select * from temp_rkbmd_pengadaan where user = '$this->username'"));
	$e = $cekMayoritas['e'];
	$e1 = $cekMayoritas['e1'];
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPengadaanUnitKerja_ins.CekAda(); ','-- KEGIATAN --');
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPengadaanUnitKerja_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPengadaanUnitKerja_ins.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPengadaanUnitKerja_ins.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPengadaanUnitKerja_ins.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPengadaanUnitKerja_ins.finish()'>
...
$rkbmdPengadaanUnitKerja_ins = new rkbmdPengadaanUnitKerja_insObj();

$arrayResult = tahapPerencanaanV3($rkbmdPengadaanUnitKerja_ins->modul,"MURNI");
...
$rkbmdPengadaanUnitKerja_ins->jenisForm = $jenisForm;
$rkbmdPengadaanUnitKerja_ins->nomorUrut = $nomorUrut;
$rkbmdPengadaanUnitKerja_ins->urutTerakhir = $nomorUrut;
$rkbmdPengadaanUnitKerja_ins->tahun = $tahun;
$rkbmdPengadaanUnitKerja_ins->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanUnitKerja_ins->idTahap = $idTahap;
$rkbmdPengadaanUnitKerja_ins->username = $_COOKIE['coID'];
$rkbmdPengadaanUnitKerja_ins->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPengadaanUnitKerja_ins->wajibValidasi == TRUE){
	$rkbmdPengadaanUnitKerja_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanUnitKerja_ins->sqlValidasi = " ";
}
