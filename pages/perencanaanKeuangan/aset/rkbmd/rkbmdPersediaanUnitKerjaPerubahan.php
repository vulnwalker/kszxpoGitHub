...
class rkbmdPersediaanUnitKerjaPerubahanObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanUnitKerjaPerubahan';
	...
	var $FormName = 'rkbmdPersediaanUnitKerjaPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setTitle(){
		...
		return "RKBMD $this->jenisAnggaran PERSEDIAAN KUASA PENGGUNA BARANG";
	}
	function setPage_Header($IconPage='', $TitlePage=''){

		return createHeaderPage($this->PageIcon, "RKBMD $this->jenisAnggaran PERSEDIAAN TAHUN $this->tahun");
	}
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan\" title='RKBMD'   > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan\"  title='RKBMD PENGELOLA'  > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanUnitKerjaPerubahan\" title='RKBMD PERSEDIAAN'  style='color : blue;'> PERSEDIAAN </a>
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'koreksiAlasanPerubahan':{
			...
			$getrkbmdPersediaanUnitKerjaPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPersediaanUnitKerjaPerubahannya as $key => $value) {
				  $$key = $value;
			}
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $nextNomorUrut = $this->nomorUrut + 1;
			   	  $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanUnitKerjaPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan;
		     $parentC = $rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD;
			 $parentD = $rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT;
			 $parentE = $rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPersediaanUnitKerjaPerubahan == 'PERSEDIAAN'){
						$kemana = 'ins';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPersediaanUnitKerjaPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPersediaanUnitKerjaPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPersediaanUnitKerjaPerubahan['c1'];
					$parentC = $getParentrkbmdPersediaanUnitKerjaPerubahan['c'];
					$parentD = $getParentrkbmdPersediaanUnitKerjaPerubahan['d'];
					$parentE = $getParentrkbmdPersediaanUnitKerjaPerubahan['e'];
					$parentE1= $getParentrkbmdPersediaanUnitKerjaPerubahan['e1'];
					$getIdRenja = mysql_fetch_array(mysql_query("select * from view_renja where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$parentC1' and c = '$parentC' and d = '$parentD' and e = '$parentE' and e1 = '$parentE1' and p = '0' and q = '0' and no_urut = '$nomorUrutSebelumnya' "));
					$idrenja = $getIdRenja['id_anggaran'];
					if($idrenja == 0){
						$parentE = '00';
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPersediaanUnitKerjaPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPersediaanUnitKerjaPerubahan_idplh'");
			 mysql_query($query);
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPersediaanUnitKerjaPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPersediaanUnitKerjaPerubahannya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPersediaanUnitKerjaPerubahan.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerjaPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerjaPerubahan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan'];
	 $c = $dt['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD'];
	 $d = $dt['rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT'];
	 $e = $dt['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI'];



	 	 $arrayJenisLaporan = array(
	 						   array('Persediaan8', 'PERUBAHAN USULAN RKBMD PERSEDIAAN PADA KUASA PENGGUNA BARANG'),
							   array('Persediaan10', 'PERUBAHAN HASIL PENELAAHAN RKBMD PERSEDIAAN OLEH PENGGUNA BARANG'),
	 						   array('Persediaan9', 'PERUBAHAN RKBMD PERSEDIAAN PADA KUASA PENGGUNA BARANG'),
							   );
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPersediaanUnitKerjaPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPersediaanUnitKerjaPerubahan' id='cmbJenisrkbmdPersediaanUnitKerjaPerubahan' value='PERSEDIAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
			...
			while($rows = mysql_fetch_array($getAll)){
				foreach ($rows as $key => $value) {
				 ...
				 if(mysql_num_rows(mysql_query("select * from pindah_rkbmd_v3 where id_anggaran = '$id_anggaran'")) != 0){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck = '$ck' and dk = '$dk' and p = '$p' and q= '$q' and  f ='00' and id_tahap='$this->idTahap' and uraian_pemeliharaan = 'RKBMD PERSEDIAAN'"));
					if($cekKegiatan < 1){
						$data = array('jenis_anggaran' => $this->jenisAnggaran,
									  'tahun' => $this->tahun,
									  'c1' => $c1,
		...
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPersediaanUnitKerjaPerubahanSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPersediaanUnitKerjaPerubahan = $_REQUEST['cmbJenisrkbmdPersediaanUnitKerjaPerubahan'];
		$arrKondisi = array();
...
function Persediaan8($xls =FALSE){
		global $Main;

		$this->fileNameExcel = "PERUBAHAN USULAN RKBMD PERSEDIAAN PADA KUASA PENGGUNA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
...
function Persediaan9($xls =FALSE){
		global $Main;

		$this->fileNameExcel = "PERUBAHAN RKBMD PERSEDIAAN PADA KUASA PENGGUNA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		echo "
								...
								<table table width='100%' class='cetak' border='1' style='margin:4 0 0 0;width:100%;'>
									<tr>
										...
										<th class='th02' rowspan='1' colspan='2' >MENJADI</th>
										<th class='th01' rowspan='2' >ALASAN PERUBAHAN</th>
										<th class='th02' rowspan='1' colspan='2' >PERUBAHAN RENCANA KEBUTUHAN PERSEDIAAN BMD (Yang Disetujui)</th>
										<th class='th01' rowspan='2' >KETERANGAN</th>
									</tr>
									<tr>
										<th class='th01' >JUMLAH</th>
...
function Persediaan10($xls =FALSE){
		global $Main;

		$this->fileNameExcel = "PERUBAHAN HASIL PENELAAHAN RKBMD PERSEDIAAN OLEH PENGGUNA BARANG";
		$align = "right";
		$xls = $_GET['xls'];
		$pisah = "<td width='1%' valign='top'> : </td>";
		if($xls){
		...
		$getLastTahap = mysql_fetch_array(mysql_query("select max(id_anggaran) from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and j!='000' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN') and uraian_pemeliharaan  !='RKBMD PENGADAAN' and jenis_form_modul ='KOREKSI PENGGUNA'"));
		$lastIdAnggaran = $getLastTahap['max(id_anggaran)'];
		$getLastTahap = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran ='$lastIdAnggaran'"));
		$lastNomorUrut = "6";
		$arrKondisi = array();
		...
		$qry ="select * from view_rkbmd where id_tahap = '$this->idTahap' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' ) and uraian_pemeliharaan !='RKBMD PENGADAAN' and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' $this->kondisiBarang $Kondisi order by urut";
		$aqry = mysql_query($qry);
		$getKuasapenggunaBarang = mysql_fetch_array(mysql_query("select * from ref_skpd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1'"));
		$kuasaPenggunaBarang = $getKuasapenggunaBarang['nm_skpd'];
...
$rkbmdPersediaanUnitKerjaPerubahan = new rkbmdPersediaanUnitKerjaPerubahanObj();
$arrayResult = tahapPerencanaanV3($rkbmdPersediaanUnitKerjaPerubahan->modul,"PERUBAHAN");
...
$rkbmdPersediaanUnitKerjaPerubahan->jenisForm = $jenisForm;
$rkbmdPersediaanUnitKerjaPerubahan->nomorUrut = $nomorUrut;
$rkbmdPersediaanUnitKerjaPerubahan->urutTerakhir = $nomorUrut;
$rkbmdPersediaanUnitKerjaPerubahan->tahun = $tahun;
$rkbmdPersediaanUnitKerjaPerubahan->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanUnitKerjaPerubahan->idTahap = $idTahap;
$rkbmdPersediaanUnitKerjaPerubahan->username = $_COOKIE['coID'];
$rkbmdPersediaanUnitKerjaPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPersediaanUnitKerjaPerubahan->wajibValidasi == TRUE){
	$rkbmdPersediaanUnitKerjaPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanUnitKerjaPerubahan->sqlValidasi = " ";
}
$rkbmdPersediaanUnitKerjaPerubahan->provinsi = $arrayResult['provinsi'];
$rkbmdPersediaanUnitKerjaPerubahan->kota = $arrayResult['kota'];

$rkbmdPersediaanUnitKerjaPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPersediaanUnitKerjaPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPersediaanUnitKerjaPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPersediaanUnitKerjaPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPersediaanUnitKerjaPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPersediaanUnitKerjaPerubahan->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPersediaanUnitKerjaPerubahan->settingAnggaran = $arrayResult['settingAnggaran'];
