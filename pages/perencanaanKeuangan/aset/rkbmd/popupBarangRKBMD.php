...
class popupBarangRKBMDObj  extends DaftarObj2{	
	var $Prefix = 'popupBarangRKBMD';
	...
	var $FormName = 'popupBarangRKBMDForm'; 	
...
/*			'' => array( 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($isi['j'] == '000'){
 	 ...
 	 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangRKBMD.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
$popupBarangRKBMD = new popupBarangRKBMDObj();
