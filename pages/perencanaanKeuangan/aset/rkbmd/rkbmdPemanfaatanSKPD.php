...
class rkbmdPemanfaatanSKPDObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPemanfaatanSKPD';
	...
	var $FormName = 'rkbmdPemanfaatanSKPDForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setForm($dt){	
	 ...
	 $this->form_height = $sh-100;
	  if ($this->form_fmST==0) {
		...
		$rkbmdPemanfaatanSKPD_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(	
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkiba' name='rkbmdPemanfaatanSKPD_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkibb' name='rkbmdPemanfaatanSKPD_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkibc' name='rkbmdPemanfaatanSKPD_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkibd' name='rkbmdPemanfaatanSKPD_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkibe' name='rkbmdPemanfaatanSKPD_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPemanfaatanSKPD_formkibf' name='rkbmdPemanfaatanSKPD_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
				'det_rencana_pemanfaatan' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rencana_pemanfaatan' name='det_rencana_pemanfaatan' >".$rkbmdPemanfaatanSKPD_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPemanfaatanSKPD\" title='RKBMD PEMANFAATAN' style='color : blue;'> PEMANFAATAN </a> |
	...
	function getDaftarOpsi($Mode=1){
		...
		$fmPILCARI = cekPOST('fmPILCARI');
		$fmPILCARIVALUE = cekPOST('fmPILCARIVALUE');
		/*$fmURUSAN = cekPOST('rkbmdPemanfaatanSKPDSkpdfmURUSAN');
...
$rkbmdPemanfaatanSKPD = new rkbmdPemanfaatanSKPDObj();


$arrayResult = tahapPerencanaanV3($rkbmdPemanfaatanSKPD->modul);
...
$rkbmdPemanfaatanSKPD->jenisForm = $jenisForm;
$rkbmdPemanfaatanSKPD->nomorUrut = $nomorUrut;
$rkbmdPemanfaatanSKPD->urutTerakhir = $nomorUrut;
$rkbmdPemanfaatanSKPD->tahun = $tahun;
$rkbmdPemanfaatanSKPD->jenisAnggaran = $jenisAnggaran;
$rkbmdPemanfaatanSKPD->idTahap = $idTahap;
$rkbmdPemanfaatanSKPD->username = $_COOKIE['coID'];
$rkbmdPemanfaatanSKPD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemanfaatanSKPD->wajibValidasi == TRUE){
	$rkbmdPemanfaatanSKPD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemanfaatanSKPD->sqlValidasi = " ";
}
$rkbmdPemanfaatanSKPD->provinsi = $arrayResult['provinsi'];
$rkbmdPemanfaatanSKPD->kota = $arrayResult['kota'];

$rkbmdPemanfaatanSKPD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemanfaatanSKPD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemanfaatanSKPD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemanfaatanSKPD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemanfaatanSKPD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemanfaatanSKPD->nipPejabat = $arrayResult['nipPejabat'];
