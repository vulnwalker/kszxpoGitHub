...
class popupBarangRKBMDPersediaanObj  extends DaftarObj2{	
	var $Prefix = 'popupBarangRKBMDPersediaan';
	...
	var $FormName = 'popupBarangRKBMDPersediaanForm'; 	
...
/*			'' => array( 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($isi['j'] == '000'){
 	 ...
 	 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangRKBMDPersediaan.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
*/
	...
	$TampilOpt = 
			...
			<td>".
			cmbQuery1("cmbJenis",$cmbJenis,"select f as valueCmbJenis, nm_barang from ref_barang where f != '00'  and g ='00' and h ='00' and i='00' and f != '01' and f!='02' and f!='03' and f!='04' and f!='05' and f!='06' and f!='07' and j = '000'","onChange=\"$this->Prefix.refreshList(true)\"",'Pilih','').
			"</td>
			</tr><tr>
...
$popupBarangRKBMDPersediaan = new popupBarangRKBMDPersediaanObj();
