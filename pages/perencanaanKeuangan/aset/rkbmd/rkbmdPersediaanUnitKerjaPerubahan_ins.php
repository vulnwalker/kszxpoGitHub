<?php
class rkbmdPersediaanUnitKerjaPerubahan_insObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanUnitKerjaPerubahan_ins';
	...
	var $FormName = 'rkbmdPersediaanUnitKerjaPerubahan_insForm';
	var $noModul=14;
	  ...
	  switch($tipe){
		...
		case 'Simpan':{
			...
			if($err == ''){
				...
				mysql_query($query);
					$codeAndNameKegiatan = "select q, concat(q,'. ', nama) from ref_program where bk = '$bk' and ck = '$ck' and dk = '$dk'  and p = '$p' and q !='0' ";
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,' disabled','-- KEGIATAN --');
	 ...
	 function setPage_OtherScript(){
 	 ...
 	 return
 	   ...
 	   "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPersediaanUnitKerjaPerubahan_ins.js' language='JavaScript' ></script>".
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerjaPerubahan_ins.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerjaPerubahan_ins.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPersediaanUnitKerjaPerubahan_ins.CekAda(); ','-- KEGIATAN --');
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPersediaanUnitKerjaPerubahan_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPersediaanUnitKerjaPerubahan_ins.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.finish()'>
...
$rkbmdPersediaanUnitKerjaPerubahan_ins = new rkbmdPersediaanUnitKerjaPerubahan_insObj();

$arrayResult = tahapPerencanaanV3($rkbmdPersediaanUnitKerjaPerubahan_ins->modul,"PERUBAHAN");
...
$rkbmdPersediaanUnitKerjaPerubahan_ins->jenisForm = $jenisForm;
$rkbmdPersediaanUnitKerjaPerubahan_ins->nomorUrut = $nomorUrut;
$rkbmdPersediaanUnitKerjaPerubahan_ins->urutTerakhir = $nomorUrut;
$rkbmdPersediaanUnitKerjaPerubahan_ins->tahun = $tahun;
$rkbmdPersediaanUnitKerjaPerubahan_ins->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanUnitKerjaPerubahan_ins->idTahap = $idTahap;
$rkbmdPersediaanUnitKerjaPerubahan_ins->username = $_COOKIE['coID'];
$rkbmdPersediaanUnitKerjaPerubahan_ins->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPersediaanUnitKerjaPerubahan_ins->wajibValidasi == TRUE){
	$rkbmdPersediaanUnitKerjaPerubahan_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanUnitKerjaPerubahan_ins->sqlValidasi = " ";
}
