<?php
class rkbmdPemeliharaanUnitKerja_insObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanUnitKerja_ins';
	...
	var $FormName = 'rkbmdPemeliharaanUnitKerja_insForm';
	var $noModul=14;
	...
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,' disabled','-- KEGIATAN --');
	 ...
	 function setPage_OtherScript(){
	  ...
	  return
	    ...
	    "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanUnitKerja_ins.js' language='JavaScript' ></script>".
	...
	if($hitungData > 1){
		...
		if($realConcat == $min){
			...
			$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja_ins.subHapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja_ins.moveList('$id');></img> ";
		}else{
	...
	function tabelPemeliharaan(){
		...
		while($dt = mysql_fetch_array($aqry)){
			...
			if($dt['id_jenis_pemeliharaan'] == '' || $dt['id_jenis_pemeliharaan'] == '0'){
				$action = "<img id='action$id' src='datepicker/save.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja_ins.subSubSave('$id');>";
				...
				$action = "<img id='action$id' src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja_ins.subSubDel('$id');>";
			...
			$datanya.="
				...
				<tr class='row0'>
					<td class='GarisDaftar' align='right'><a onclick=rkbmdPemeliharaanUnitKerja_ins.subSubEdit($id) style='cursor:pointer;'>$no</a></td>
				...
				array("
					<table class='koptable' style='min-width:900px;' border='1'>
						<tr>
							...
							<th class='th01'>
								<span id='atasbutton'>
								<a href='javascript:rkbmdPemeliharaanUnitKerja_ins.$tujuan' id='linkAtasButton' /><img id='gambarAtasButton' src='$gambar' style='width:20px;height:20px;' /></a>
								</span>
							</th>
						</tr>
						$datanya
	...
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,'onchange=rkbmdPemeliharaanUnitKerja_ins.CekAda(); ','-- KEGIATAN --');
	$username = $_COOKIE['coID'];
	$matiButton = "";
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPemeliharaanUnitKerja_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $matiButton >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<button type='button' id='findBarang' onclick=rkbmdPemeliharaanUnitKerja_ins.CariBarang('$filterSKPD'); > Cari </button>
									",
								),
							array(
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPemeliharaanUnitKerja_ins.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPemeliharaanUnitKerja_ins.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPemeliharaanUnitKerja_ins.finish()'>
...
$rkbmdPemeliharaanUnitKerja_ins = new rkbmdPemeliharaanUnitKerja_insObj();

$arrayResult = tahapPerencanaanV3($rkbmdPemeliharaanUnitKerja_ins->modul,"MURNI");
...
$rkbmdPemeliharaanUnitKerja_ins->jenisForm = $jenisForm;
$rkbmdPemeliharaanUnitKerja_ins->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanUnitKerja_ins->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanUnitKerja_ins->tahun = $tahun;
$rkbmdPemeliharaanUnitKerja_ins->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanUnitKerja_ins->idTahap = $idTahap;
$rkbmdPemeliharaanUnitKerja_ins->username = $_COOKIE['coID'];
$rkbmdPemeliharaanUnitKerja_ins->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPemeliharaanUnitKerja_ins->wajibValidasi == TRUE){
	$rkbmdPemeliharaanUnitKerja_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanUnitKerja_ins->sqlValidasi = " ";
}
