<?php
class rkbmdPersediaanUnitKerja_insObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPersediaanUnitKerja_ins';
	...
	var $FormName = 'rkbmdPersediaanUnitKerja_insForm';
	var $noModul=14;
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'Simpan':{
			...
			$username = $_COOKIE['coID'];
			$cekAda = mysql_num_rows(mysql_query("select * from temp_rkbmd_persediaan where  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and user='$username'"));
			if($cekAda == 1){
	...
	$cmbKegiatan = cmbQuery('q', $q, $codeAndNameKegiatan,' disabled','-- KEGIATAN --');
	 ...
	 function setPage_OtherScript(){
	  ...
	  return
	    ...
	    "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPersediaanUnitKerja_ins.js' language='JavaScript' ></script>".
	    ...
	    <script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/popupBarangRKBMDPersediaan.js' language='JavaScript' ></script>
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerja_ins.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanUnitKerja_ins.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=rkbmdPersediaanUnitKerja_ins.CekAda(); ','-- KEGIATAN --');
					...
					$this->isiform(
						array(
							...
							array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='rkbmdPersediaanUnitKerja_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							),
							array(
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly />
										...
										<input type='button' id='findBarang' value='CARI' onclick='rkbmdPersediaanUnitKerja_ins.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
...
/*							array(  'name' => "jumlahKebutuhanRiil",
				...
				genFilterBar(
					...
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkbmdPersediaanUnitKerja_ins.$tujuan'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkbmdPersediaanUnitKerja_ins.closeTab()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='finish' href='javascript:rkbmdPersediaanUnitKerja_ins.finish()'>
...
$rkbmdPersediaanUnitKerja_ins = new rkbmdPersediaanUnitKerja_insObj();

$arrayResult = tahapPerencanaanV3($rkbmdPersediaanUnitKerja_ins->modul,"MURNI");
...
$rkbmdPersediaanUnitKerja_ins->jenisForm = $jenisForm;
$rkbmdPersediaanUnitKerja_ins->nomorUrut = $nomorUrut;
$rkbmdPersediaanUnitKerja_ins->urutTerakhir = $nomorUrut;
$rkbmdPersediaanUnitKerja_ins->tahun = $tahun;
$rkbmdPersediaanUnitKerja_ins->jenisAnggaran = $jenisAnggaran;
$rkbmdPersediaanUnitKerja_ins->idTahap = $idTahap;
$rkbmdPersediaanUnitKerja_ins->username = $_COOKIE['coID'];
$rkbmdPersediaanUnitKerja_ins->wajibValidasi = $Main->wajibValidasi;
if($rkbmdPersediaanUnitKerja_ins->wajibValidasi == TRUE){
	$rkbmdPersediaanUnitKerja_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPersediaanUnitKerja_ins->sqlValidasi = " ";
}
