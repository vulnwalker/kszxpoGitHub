...
class rkbmdPenghapusanSKPDObj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPenghapusanSKPD';
	...
	var $FormName = 'rkbmdPenghapusanSKPDForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	var $nipPengurus ="";		
	function setTitle(){
		return 'PENGHAPUSAN PENGGUNA BARANG';
	}
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rkbmdPenghapusanSKPD_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkiba' name='rkbmdPenghapusanSKPD_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkibb' name='rkbmdPenghapusanSKPD_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkibc' name='rkbmdPenghapusanSKPD_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkibd' name='rkbmdPenghapusanSKPD_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkibe' name='rkbmdPenghapusanSKPD_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rkbmdPenghapusanSKPD_formkibf' name='rkbmdPenghapusanSKPD_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rkbmdPenghapusanSKPD' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rkbmdPenghapusanSKPD' name='det_rkbmdPenghapusanSKPD' >".$rkbmdPenghapusanSKPD_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPenghapusanSKPD\" title='RKBMD PENGHAPUSAN' style='color : blue;' > PENGHAPUSAN </a> 
...
$rkbmdPenghapusanSKPD = new rkbmdPenghapusanSKPDObj();

$arrayResult = tahapPerencanaanV3($rkbmdPenghapusanSKPD->modul);
...
$rkbmdPenghapusanSKPD->jenisForm = $jenisForm;
$rkbmdPenghapusanSKPD->nomorUrut = $nomorUrut;
$rkbmdPenghapusanSKPD->urutTerakhir = $nomorUrut;
$rkbmdPenghapusanSKPD->tahun = $tahun;
$rkbmdPenghapusanSKPD->jenisAnggaran = $jenisAnggaran;
$rkbmdPenghapusanSKPD->idTahap = $idTahap;
$rkbmdPenghapusanSKPD->username = $_COOKIE['coID'];
$rkbmdPenghapusanSKPD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPenghapusanSKPD->wajibValidasi == TRUE){
	$rkbmdPenghapusanSKPD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPenghapusanSKPD->sqlValidasi = " ";
}
$rkbmdPenghapusanSKPD->provinsi = $arrayResult['provinsi'];
$rkbmdPenghapusanSKPD->kota = $arrayResult['kota'];

$rkbmdPenghapusanSKPD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPenghapusanSKPD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPenghapusanSKPD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPenghapusanSKPD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPenghapusanSKPD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPenghapusanSKPD->nipPejabat = $arrayResult['nipPejabat'];
