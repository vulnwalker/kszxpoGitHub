...
class rkbmdPengadaanUnitKerjaPerubahanObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPengadaanUnitKerjaPerubahan';
	...
	var $FormName = 'rkbmdPengadaanUnitKerjaPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan&tipe=Pengadaan8";
	var $reportURL3 = "pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan&tipe=Pengadaan9";
	var $reportURL2 = "pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan&tipe=Pengadaan10";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan\" title='RKBMD PENGELOLA' > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanUnitKerjaPerubahan\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a>
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan;
		     $parentC = $rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD;
			 $parentD = $rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT;
			 $parentE = $rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPengadaanUnitKerjaPerubahan == 'PENGADAAN'){
						$kemana = 'ins';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaanUnitKerjaPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPengadaanUnitKerjaPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPengadaanUnitKerjaPerubahan['c1'];
					$parentC = $getParentrkbmdPengadaanUnitKerjaPerubahan['c'];
					$parentD = $getParentrkbmdPengadaanUnitKerjaPerubahan['d'];
					$parentE = $getParentrkbmdPengadaanUnitKerjaPerubahan['e'];
					$parentE1= $getParentrkbmdPengadaanUnitKerjaPerubahan['e1'];
					$getIdRenja = mysql_fetch_array(mysql_query("select * from view_renja where tahun = '$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and c1 = '$parentC1' and c = '$parentC' and d = '$parentD' and e = '$parentE' and e1 = '$parentE1' and p = '0' and q = '0' and no_urut = '$nomorUrutSebelumnya' "));
					$idrenja = $getIdRenja['id_anggaran'];
					if($idrenja == 0){
						$parentE = '00';
					...
					$execute = mysql_query("select * from view_rkbmd where  c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and f !='00' and id_jenis_pemeliharaan = '0' $exceptID $this->kondisiBarang ");
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPengadaanUnitKerjaPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPengadaanUnitKerjaPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksiAlasanPerubahan':{
			...
			$getrkbmdPengadaanUnitKerjaPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPengadaanUnitKerjaPerubahannya as $key => $value) {
				  $$key = $value;
			}
			  ...
			  $concat = $kodeSKPD.".".$kodeBarang;
				  ...
				  $nextNomorUrut = $this->nomorUrut + 1;
			   	  $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaanUnitKerjaPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanUnitKerjaPerubahan.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
		if($this->jenisForm == "PENYUSUNAN"){
					$tergantung = "<th class='th01' align='center' rowspan='2' colspan='1' width='100'>AKSI</th>";
					if($this->wajibValidasi == TRUE){
						$tergantung = "<th class='th01' align='center' rowspan='2' colspan='1' width='200'>VALIDASI</th>".
									  "<th class='th01' align='center' rowspan='2' colspan='1' width='100'>AKSI</th>";
					}
					...
					$headerTable =
					 ...
					 <tr>
					   ...
					   <th class='th01' align='center' rowspan='2' colspan='1' width='200'>SKPD/PROGRAM/KEGIATAN/OUTPUT</th>
				   	   <th class='th02' align='center' rowspan='1' colspan='2' width='200'>USULAN BMD</th>
					   ...
					   <th class='th02' align='center' rowspan='1' colspan='2' width='100'>SEMULA</th>
					   <th class='th02' align='center' rowspan='1' colspan='2' width='100'>MENJADI</th>
					   ...
					   <tr>
						  ...
						  <th class='th01' align='center' rowspan='2' colspan='1' width='100'>ALASAN PERUBAHAN</th>
	   ...
	   if($this->jenisForm=="PENYUSUNAN"){
				...
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					// $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
					 ...
					 $getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran = 'MURNI' and no_urut = '5' and id_jenis_pemeliharaan = '0'"));
					 ...
					 $Koloms.= "<td class='$cssclass' align='left'>".$getJumlahSemula['cara_pemenuhan']."</td>";
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerjaPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanUnitKerjaPerubahan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan'];
	 $c = $dt['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD'];
	 $d = $dt['rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT'];
	 $e = $dt['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPengadaanUnitKerjaPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPengadaanUnitKerjaPerubahan' id='cmbJenisrkbmdPengadaanUnitKerjaPerubahan' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
			...
			while($rows = mysql_fetch_array($getAll)){
				foreach ($rows as $key => $value) {
				 ...
				 if(mysql_num_rows(mysql_query("select * from pindah_rkbmd_v3 where id_anggaran = '$id_anggaran'")) != 0){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck = '$ck' and dk = '$dk' and p = '$p' and q= '$q' and  f ='00' and id_tahap='$this->idTahap' and uraian_pemeliharaan = 'RKBMD PENGADAAN'"));
					if($cekKegiatan < 1){
						$data = array('jenis_anggaran' => $this->jenisAnggaran,
									  'tahun' => $this->tahun,
									  'c1' => $c1,
		...
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPengadaanUnitKerjaPerubahanSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPengadaanUnitKerjaPerubahan = $_REQUEST['cmbJenisrkbmdPengadaanUnitKerjaPerubahan'];
		$arrKondisi = array();
...
function Pengadaan8($xls =FALSE){
		...
		$arrayTandaTangan1 = explode(';', $getJenisReport2['tanda_tangan']);
  		...
  		<script type='text/javascript' src='assets/js/bootstrap.min.js'></script>".
			...
			"$body
								...
								<tr>
									...
									<td style='text-align: center;'>
										<span style='font-size:18px;font-weight:bold;text-decoration: '>
											...
											KUASA PENGUNA BARANG DINAS PENDIDIKAN
										</span>
									</td>
									<td style='width: 9%;'>
				...
				<table width=\"100%\" border=\"0\" class='subjudulcetak' style='font-family: sans-serif;'>
										...
										<tr>
						<td width='13%' valign='top'>PEMERINTAH PROVINSI</td>
						$pisah
						<td valign='top'>".$this->provinsi."</td>
					</tr>
					<tr>
						<td width='13%' valign='top'>KABUPATEN / KOTA</td>
						$pisah
						<td valign='top'>".$this->kota."</td>
					</tr>
					<tr>
		...
		echo "
								...
								<table  width='100%' class='cetak' border='1' style='margin:-25 0 0 0;width:100%;'>
								<thead>
									<tr>
										<th class='th01' rowspan='2' style='width:20px;' >NO</th>
										<th class='th01' rowspan='2' >PROGRAM/KEGIATAN/OUTPUT</th>
										<th class='th01' rowspan='2' colspan='2'>KODE BARANG / NAMA BARANG</th>
									...
									<tr>
										...
										<th class='th01' >JUMLAH</th>
										<th class='th01' >SATUAN</th>
										<th class='th01' colspan='2' >KODE BARANG / NAMA BARANG</th>
										<th class='th01' >JUMLAH</th>
										<th class='th01' >SATUAN</th>
										<th class='th01' >JUMLAH</th>
										<th class='th01' >SATUAN</th>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$getJumlaSemua = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and tahun = '$this->tahun' and no_urut = '5' and jenis_anggaran ='MURNI' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_jenis_pemeliharaan = '0' "));
...
function Pengadaan9($xls =FALSE){
		...
		echo "
								<br>
								<table table width='100%' class='cetak' border='1' style='margin:20 0 0 0;width:100%;'>
								<thead>
									<tr>
										<th class='th01' rowspan='2' style='width:20px;' >NO</th>
										<th class='th01' rowspan='2' >PROGRAM/KEGIATAN/OUTPUT</th>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$getJumlaSemua = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and tahun = '$this->tahun' and no_urut = '5' and jenis_anggaran ='MURNI' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_jenis_pemeliharaan = '0'"));
				$jumlahSemula =  number_format($getJumlaSemua['volume_barang'],0,'.',',');
				$getJumlahBarangYangDisetujui = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and tahun = '$this->tahun' and no_urut = '4' and jenis_anggaran ='PERUBAHAN' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and id_jenis_pemeliharaan = '0'"));
			...
			";
				...
				<tr valign='top'>
				     ...
				     <td align='left' class='GarisCetak' colspan='2'>".$namaBarang." <br> ".$kodeBarang."</td>
				     <td align='right' class='GarisCetak'>$jumlahSemula</td>
				     <td align='left' class='GarisCetak' >".$satuan_barang."</td>
				     <td align='right' class='GarisCetak'>$volume_barang</td>
				     <td align='left' class='GarisCetak' >".$satuan_barang."</td>
				     ...
				     <td align='right' class='GarisCetak'>$jumlahBarangYangDisetujui</td>
				     <td align='left' class='GarisCetak' >".$satuan_barang."</td>
				         <td align='left' class='GarisCetak' >".$getJumlahBarangYangDisetujui['cara_pemenuhan']."</td>
				     <td align='left' class='GarisCetak' >".$catatan."</td>
			              </tr>
			";
			}
...
function Pengadaan10($xls =FALSE){
		...
		$arrayTandaTangan2 = explode(';', $getJenisReport1['tanda_tangan']);
  		...
  		<script type='text/javascript' src='assets/js/bootstrap.min.js'></script>".
			...
			"$body
				...
				<table class=\"rangkacetak\" style='width: $width; font-family: sans-serif; margin-left :1.5cm; margin-top: 1.5cm; height: $height;'>
						<tr>
							<td valign=\"top\"> <div style='text-align:center;'>
					<table style='width: 100%; border: none; margin-bottom: 1%; margin-top:2%;' >
								<tr>
									<td>
										<img src='assets/images/kabupaten-bandung.jpeg' style='width: 100px; height: 100px;'>
									</td>
					...
					<table width=\"100%\" border=\"0\" class='subjudulcetak' style='margin-bottom:1%;margin-top:1%;'>
					<tr>
						<td width='10%' valign='top'>PEMERINTAH PROVINSI</td>
						$pisah
						<td valign='top'>".$this->provinsi."</td>
			...
			if ($q != "0") {
				...
				$namaKegiatan = "<td align='left' style='padding-left: 10px;' class='GarisCetak' colspan='5'>".$programKegiatan;
			}else{
		...
		echo "
								<br>
								<table table width='100%' class='cetak' border='1' style='margin:-18 0 0 0;width:100%;'>
								<thead>
									<tr>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$getJumlahSetuju = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q' and tahun='$this->tahun' and jenis_anggaran = 'PERUBAHAN' and no_urut = '4' and id_jenis_pemeliharaan = '0'"));
	...
	if (sizeof($arrayTandaTangan2)==1) {
			...
			echo
					...
					<div style='margin-left:-195px;width:50%;' >Telah Diperiksa : </div>
					<table table width='100%' class='cetak' border='1' style='margin-left:90px;width:50%;'>
						<tr>
							<th class='th01'>No</th>
							<th class='th01'>Nama</th>
...
$rkbmdPengadaanUnitKerjaPerubahan = new rkbmdPengadaanUnitKerjaPerubahanObj();
$arrayResult = tahapPerencanaanV3($rkbmdPengadaanUnitKerjaPerubahan->modul,"PERUBAHAN");
...
$rkbmdPengadaanUnitKerjaPerubahan->jenisForm = $jenisForm;
$rkbmdPengadaanUnitKerjaPerubahan->nomorUrut = $nomorUrut;
$rkbmdPengadaanUnitKerjaPerubahan->urutTerakhir = $nomorUrut;
$rkbmdPengadaanUnitKerjaPerubahan->tahun = $tahun;
$rkbmdPengadaanUnitKerjaPerubahan->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanUnitKerjaPerubahan->idTahap = $idTahap;
$rkbmdPengadaanUnitKerjaPerubahan->username = $_COOKIE['coID'];
$rkbmdPengadaanUnitKerjaPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPengadaanUnitKerjaPerubahan->wajibValidasi == TRUE){
	$rkbmdPengadaanUnitKerjaPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanUnitKerjaPerubahan->sqlValidasi = " ";
}
$rkbmdPengadaanUnitKerjaPerubahan->provinsi = $arrayResult['provinsi'];
$rkbmdPengadaanUnitKerjaPerubahan->kota = $arrayResult['kota'];

$rkbmdPengadaanUnitKerjaPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPengadaanUnitKerjaPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPengadaanUnitKerjaPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPengadaanUnitKerjaPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPengadaanUnitKerjaPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPengadaanUnitKerjaPerubahan->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPengadaanUnitKerjaPerubahan->settingAnggaran = $arrayResult['settingAnggaran'];
