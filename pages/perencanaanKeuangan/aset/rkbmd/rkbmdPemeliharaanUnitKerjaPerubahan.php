...
class rkbmdPemeliharaanUnitKerjaPerubahanObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanUnitKerjaPerubahan';
	...
	var $FormName = 'rkbmdPemeliharaanUnitKerjaPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $username = "";
	var $reportURL8 = "pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan&tipe=Pemeliharaan8";
	var $reportURL9 = "pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan&tipe=Pemeliharaan9";
	var $reportURL10 = "pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan&tipe=Pemeliharaan10";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan\"  title='RKBMD PENGELOLA' style='color : blue;' > PEMELIHARAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
	  	case 'koreksiAlasanPerubahan':{
			...
			$getrkbmdPemeliharaanUnitKerjaPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaanUnitKerjaPerubahannya as $key => $value) {
				  $$key = $value;
			}
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan;
		     $parentC = $rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD;
			 $parentD = $rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT;
			 $parentE = $rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
				 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT' and e = '00' and e1='000' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				 $lastID = $getDatarenja['id_anggaran'];
				 $parentE = '00';
			 	 $parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaanUnitKerjaPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaanUnitKerjaPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaanUnitKerjaPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaanUnitKerjaPerubahan['c1'];
					$parentC = $getParentrkbmdPemeliharaanUnitKerjaPerubahan['c'];
					$parentD = $getParentrkbmdPemeliharaanUnitKerjaPerubahan['d'];
					$parentE = $getParentrkbmdPemeliharaanUnitKerjaPerubahan['e'];
					$parentE1= $getParentrkbmdPemeliharaanUnitKerjaPerubahan['e1'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaanUnitKerjaPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaanUnitKerjaPerubahan_idplh'");
			 mysql_query($query);
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if( $getrkbmdPemeliharaanUnitKerjaPerubahannya['volume_barang'] >= $angkaKoreksi ) {
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPemeliharaanUnitKerjaPerubahannya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanUnitKerjaPerubahan.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerjaPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerjaPerubahan.koreksi('$id_anggaran');></img> ";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaanUnitKerjaPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaanUnitKerjaPerubahan' id='cmbJenisrkbmdPemeliharaanUnitKerjaPerubahan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		...
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaanUnitKerjaPerubahan = $_REQUEST['cmbJenisrkbmdPemeliharaanUnitKerjaPerubahan'];
		$arrKondisi = array();
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUrusan'];
	 $c = $dt['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSKPD'];
	 $d = $dt['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmUNIT'];
	 $e = $dt['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPemeliharaanUnitKerjaPerubahanSkpdfmSEKSI'];
...
$rkbmdPemeliharaanUnitKerjaPerubahan = new rkbmdPemeliharaanUnitKerjaPerubahanObj();
$arrayResult = tahapPerencanaanV3($rkbmdPemeliharaanUnitKerjaPerubahan->modul,"PERUBAHAN");
...
$rkbmdPemeliharaanUnitKerjaPerubahan->jenisForm = $jenisForm;
$rkbmdPemeliharaanUnitKerjaPerubahan->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanUnitKerjaPerubahan->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanUnitKerjaPerubahan->tahun = $tahun;
$rkbmdPemeliharaanUnitKerjaPerubahan->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanUnitKerjaPerubahan->idTahap = $idTahap;
$rkbmdPemeliharaanUnitKerjaPerubahan->username = $_COOKIE['coID'];
$rkbmdPemeliharaanUnitKerjaPerubahan->wajibValidasi =  $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaanUnitKerjaPerubahan->wajibValidasi == TRUE){
	$rkbmdPemeliharaanUnitKerjaPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanUnitKerjaPerubahan->sqlValidasi = " ";
}

$rkbmdPemeliharaanUnitKerjaPerubahan->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaanUnitKerjaPerubahan->kota = $arrayResult['kota'];
$rkbmdPemeliharaanUnitKerjaPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaanUnitKerjaPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaanUnitKerjaPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaanUnitKerjaPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaanUnitKerjaPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaanUnitKerjaPerubahan->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPemeliharaanUnitKerjaPerubahan->settingAnggaran = $arrayResult['settingAnggaran'];
