...
class rkbmdPemeliharaanSKPDObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanSKPD';
	...
	var $FormName = 'rkbmdPemeliharaanSKPDForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL4 = "pages.php?Pg=rkbmdPemeliharaanSKPD&tipe=Pemeliharaan4";
	var $reportURL5 = "pages.php?Pg=rkbmdPemeliharaanSKPD&tipe=Pemeliharaan5";
	var $reportURL6 = "pages.php?Pg=rkbmdPemeliharaanSKPD&tipe=Pemeliharaan6";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanSKPD\" title='RKBMD'   > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanSKPD\" title='RKBMD PENGELOLA' style='color : blue;' > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanSKPD\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemanfaatanSKPD\" title='RKBMD PEMANFAATAN' > PEMANFAATAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemindahtangananSKPD\" title='RKBMD PEMINDAHTANGANAN' > PEMINDAHTANGANAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPenghapusanSKPD\" title='RKBMD PENGHAPUSAN' > PENGHAPUSAN </a>
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPemeliharaanSKPDSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPemeliharaanSKPDSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPemeliharaanSKPDSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPDSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPDSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPDSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPDSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaanSKPD = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPemeliharaanSKPD['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPD['c'];
					$parentD = $getParentrkbmdPemeliharaanSKPD['d'];
					$parentE = $getParentrkbmdPemeliharaanSKPD['e'];
					$parentE1= $getParentrkbmdPemeliharaanSKPD['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaanSKPD_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaanSKPD = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaanSKPD as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaanSKPD['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPD['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaanSKPD_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaanSKPD_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPemeliharaanSKPDnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaanSKPDnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif( $getrkbmdPemeliharaanSKPDnya['volume_barang'] >= $angkaKoreksi ) {
						...
						if( $getrkbmdPemeliharaanSKPDnya['volume_barang'] >= $angkaKoreksi )  {
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanSKPD.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPD.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPD.koreksi('$id_anggaran');></img> ";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaanSKPDSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaanSKPD' id='cmbJenisrkbmdPemeliharaanSKPD' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaanSKPDSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaanSKPDSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaanSKPDSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaanSKPDSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaanSKPDSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaanSKPD = $_REQUEST['cmbJenisrkbmdPemeliharaanSKPD'];
		$arrKondisi = array();
		if(isset($e1)){
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPemeliharaanSKPDSkpdfmUrusan'];
	 $c = $dt['rkbmdPemeliharaanSKPDSkpdfmSKPD'];
	 $d = $dt['rkbmdPemeliharaanSKPDSkpdfmUNIT'];
	 $e = $dt['rkbmdPemeliharaanSKPDSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPemeliharaanSKPDSkpdfmSEKSI'];
...
$rkbmdPemeliharaanSKPD = new rkbmdPemeliharaanSKPDObj();
...
$rkbmdPemeliharaanSKPD->jenisForm = $jenisForm;
$rkbmdPemeliharaanSKPD->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanSKPD->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanSKPD->tahun = $tahun;
$rkbmdPemeliharaanSKPD->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanSKPD->idTahap = $idTahap;
$rkbmdPemeliharaanSKPD->username = $_COOKIE['coID'];
$rkbmdPemeliharaanSKPD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaanSKPD->wajibValidasi == TRUE){
	$rkbmdPemeliharaanSKPD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanSKPD->sqlValidasi = " ";
}
$rkbmdPemeliharaanSKPD->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaanSKPD->kota = $arrayResult['kota'];
$rkbmdPemeliharaanSKPD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaanSKPD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaanSKPD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaanSKPD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaanSKPD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaanSKPD->nipPejabat = $arrayResult['nipPejabat'];
