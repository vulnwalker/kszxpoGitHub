...
class rkbmdPemeliharaanSKPKDPerubahanObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanSKPKDPerubahan';
	...
	var $FormName = 'rkbmdPemeliharaanSKPKDPerubahanForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanSKPKDPerubahan\" title='RKBMD' > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanSKPKDPerubahan\" title='RKBMD PENGELOLA'  style='color : blue;'  > PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanSKPKDPerubahan\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a>
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 /*if($rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan' and c = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD' and d='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT' and e = '$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaanSKPKDPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPemeliharaanSKPKDPerubahan['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPKDPerubahan['c'];
					$parentD = $getParentrkbmdPemeliharaanSKPKDPerubahan['d'];
					$parentE = $getParentrkbmdPemeliharaanSKPKDPerubahan['e'];
					$parentE1= $getParentrkbmdPemeliharaanSKPKDPerubahan['e1'];
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaanSKPKDPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaanSKPKDPerubahan as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaanSKPKDPerubahan['c1'];
					$parentC = $getParentrkbmdPemeliharaanSKPKDPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaanSKPKDPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaanSKPKDPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPemeliharaanSKPKDPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaanSKPKDPerubahannya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if( $getrkbmdPemeliharaanSKPKDPerubahannya['volume_barang'] >= $angkaKoreksi ) {
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPemeliharaanSKPKDPerubahannya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanSKPKDPerubahan.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPKDPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanSKPKDPerubahan.koreksi('$id_anggaran');></img> ";
...
function excel($dt){
	 ...
	 $c1 = $dt['rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan'];
	 $c = $dt['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD'];
	 $d = $dt['rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT'];
	 $e = $dt['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaanSKPKDPerubahanSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaanSKPKDPerubahan' id='cmbJenisrkbmdPemeliharaanSKPKDPerubahan' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaanSKPKDPerubahanSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaanSKPKDPerubahan = $_REQUEST['cmbJenisrkbmdPemeliharaanSKPKDPerubahan'];
		$arrKondisi = array();
		if(isset($e1)){
...
$rkbmdPemeliharaanSKPKDPerubahan = new rkbmdPemeliharaanSKPKDPerubahanObj();
...
$rkbmdPemeliharaanSKPKDPerubahan->jenisForm = $jenisForm;
$rkbmdPemeliharaanSKPKDPerubahan->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanSKPKDPerubahan->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanSKPKDPerubahan->tahun = $tahun;
$rkbmdPemeliharaanSKPKDPerubahan->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanSKPKDPerubahan->idTahap = $idTahap;
$rkbmdPemeliharaanSKPKDPerubahan->username = $_COOKIE['coID'];
$rkbmdPemeliharaanSKPKDPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaanSKPKDPerubahan->wajibValidasi == TRUE){
	$rkbmdPemeliharaanSKPKDPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanSKPKDPerubahan->sqlValidasi = " ";
}
$rkbmdPemeliharaanSKPKDPerubahan->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaanSKPKDPerubahan->kota = $arrayResult['kota'];
$rkbmdPemeliharaanSKPKDPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaanSKPKDPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaanSKPKDPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaanSKPKDPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaanSKPKDPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaanSKPKDPerubahan->nipPejabat = $arrayResult['nipPejabat'];
