...
class rkbmdPengadaanSKPDObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPengadaanSKPD';
	...
	var $FormName = 'rkbmdPengadaanSKPDForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL4 = "pages.php?Pg=rkbmdPengadaanSKPD&tipe=Pengadaan4";
	var $reportURL5 = "pages.php?Pg=rkbmdPengadaanSKPD&tipe=Pengadaan5";
	var $reportURL6 = "pages.php?Pg=rkbmdPengadaanSKPD&tipe=Pengadaan6";
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanSKPD\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanSKPD\" title='RKBMD PENGELOLA' > PEMELIHARAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPengadaanSKPDSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPengadaanSKPDSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPengadaanSKPDSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
	...
	case 'formBaru':{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPDSkpdfmSKPD' and d='$rkbmdPengadaanSKPDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPDSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPDSkpdfmSKPD' and d='$rkbmdPengadaanSKPDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPDSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaanSKPDSkpdfmUrusan' and c = '$rkbmdPengadaanSKPDSkpdfmSKPD' and d='$rkbmdPengadaanSKPDSkpdfmUNIT' and e = '$rkbmdPengadaanSKPDSkpdfmSUBUNIT' and e1='$rkbmdPengadaanSKPDSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPengadaanSKPD = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentrkbmdPengadaanSKPD['c1'];
					$parentC = $getParentrkbmdPengadaanSKPD['c'];
					$parentD = $getParentrkbmdPengadaanSKPD['d'];
					$parentE = $getParentrkbmdPengadaanSKPD['e'];
					$parentE1= $getParentrkbmdPengadaanSKPD['e1'];
					...
					if($cmbJenisrkbmdPengadaanSKPD == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPengadaanSKPD_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaanSKPD = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPengadaanSKPD as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPengadaanSKPD['c1'];
					$parentC = $getParentrkbmdPengadaanSKPD['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPengadaanSKPD_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPengadaanSKPD_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPengadaanSKPDnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPengadaanSKPDnya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaanSKPDnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPengadaanSKPDnya['volume_barang'] < $angkaKoreksi){
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) ) && $getrkbmdPengadaanSKPDnya['volume_barang'] >= $angkaKoreksi ){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPengadaanSKPD.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	 ...
	 if($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						// $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanSKPD.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaanSKPD.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPengadaanSKPDSkpdfmUrusan'];
	 $c = $dt['rkbmdPengadaanSKPDSkpdfmSKPD'];
	 $d = $dt['rkbmdPengadaanSKPDSkpdfmUNIT'];
	 $e = $dt['rkbmdPengadaanSKPDSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPengadaanSKPDSkpdfmSEKSI'];
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPengadaanSKPDSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPengadaanSKPD' id='cmbJenisrkbmdPengadaanSKPD' value='PENGADAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPengadaanSKPDSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPengadaanSKPDSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPengadaanSKPDSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPengadaanSKPDSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPengadaanSKPDSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPengadaanSKPD = $_REQUEST['cmbJenisrkbmdPengadaanSKPD'];
		$arrKondisi = array();
		...
		if($this->jenisForm == "PENYUSUNAN"){
			...
			if($jenisTahapSebelumnya == "PENYUSUNAN"){
					...
					while($rows = mysql_fetch_array($getAllParent)){
						...
						$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and q='$q'  and f !='00' and id_jenis_pemeliharaan ='0' $this->sqlValidasi $this->kondisiBarang "));
						if($cekKegiatan == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p.".".$q;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p,'.',q) != '$concat'";
							$cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p='$p' and f !='00' and id_jenis_pemeliharaan ='0' $this->sqlValidasi $this->kondisiBarang"));
							if($cekProgram == 0){
								$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$dk.".".$p;
								$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',dk,'.',p) != '$concat'";
   ...
   //    }
	...
	function Pengadaan7($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and dk='$dk' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$dk.".".$p;
...
$rkbmdPengadaanSKPD = new rkbmdPengadaanSKPDObj();
...
$rkbmdPengadaanSKPD->jenisForm = $jenisForm;
$rkbmdPengadaanSKPD->nomorUrut = $nomorUrut;
$rkbmdPengadaanSKPD->urutTerakhir = $nomorUrut;
$rkbmdPengadaanSKPD->tahun = $tahun;
$rkbmdPengadaanSKPD->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaanSKPD->idTahap = $idTahap;
$rkbmdPengadaanSKPD->username = $_COOKIE['coID'];
$rkbmdPengadaanSKPD->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPengadaanSKPD->wajibValidasi == TRUE){
	$rkbmdPengadaanSKPD->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaanSKPD->sqlValidasi = " ";
}

$rkbmdPengadaanSKPD->provinsi = $arrayResult['provinsi'];
$rkbmdPengadaanSKPD->kota = $arrayResult['kota'];
$rkbmdPengadaanSKPD->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPengadaanSKPD->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPengadaanSKPD->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPengadaanSKPD->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPengadaanSKPD->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPengadaanSKPD->nipPejabat = $arrayResult['nipPejabat'];
