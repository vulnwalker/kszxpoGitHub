...
class rkbmdPemeliharaanUnitKerjaObj  extends DaftarObj2{
	var $Prefix = 'rkbmdPemeliharaanUnitKerja';
	...
	var $FormName = 'rkbmdPemeliharaanUnitKerjaForm';
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	var $reportURL1 = "pages.php?Pg=rkbmdPemeliharaanUnitKerja&tipe=Pemeliharaan1";
	var $reportURL2 = "pages.php?Pg=rkbmdPemeliharaanUnitKerja&tipe=Pemeliharaan2";
	var $reportURL3 = "pages.php?Pg=rkbmdPemeliharaanUnitKerja&tipe=Pemeliharaan3";
	//untuk view
	function setTitle(){
	...
	function setPage_HeaderOther(){
	  ...
	  <A href=\"pages.php?Pg=rkbmdPengadaanUnitKerja\" title='RKBMD PENGADAAN'   > PENGADAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemeliharaanUnitKerja\" title='RKBMD PEMELIHARAAN'  style='color : blue;'> PEMELIHARAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPersediaanUnitKerja\" title='RKBMD PERSEDIAAN' > PERSEDIAAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemanfaatanUnitKerja\" title='RKBMD PEMANFAATAN' > PEMANFAATAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPemindahTangananUnitKerja\" title='RKBMD PEMINDAHTANGANAN' > PEMINDAHTANGANAN </a> |
	  <A href=\"pages.php?Pg=rkbmdPenghapusanUnitKerja\" title='RKBMD PENGHAPUSAN' > PENGHAPUSAN </a>
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) {
			 ...
			 if($rkbmdPemeliharaanUnitKerjaSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPemeliharaanUnitKerjaSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPemeliharaanUnitKerjaSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaSkpdfmUNIT' and e = '$rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT' and e1='$rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPemeliharaanUnitKerjaSkpdfmUrusan;
		     $parentC = $rkbmdPemeliharaanUnitKerjaSkpdfmSKPD;
			 $parentD = $rkbmdPemeliharaanUnitKerjaSkpdfmUNIT;
			 $parentE = $rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT;
			 $parentE1= $rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
				 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaSkpdfmUNIT' and e = '00' and e1='000' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));
				 $lastID = $getDatarenja['id_anggaran'];
				 $parentE = '00';
			 	 $parentE1= '000';
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPemeliharaanUnitKerjaSkpdfmUrusan' and c = '$rkbmdPemeliharaanUnitKerjaSkpdfmSKPD' and d='$rkbmdPemeliharaanUnitKerjaSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}

					$getParentrkbmdPemeliharaanUnitKerja = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPemeliharaanUnitKerja_cb'];
			foreach ($_REQUEST as $key => $value) {
				  $$key = $value;
			 }
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPemeliharaanUnitKerja = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPemeliharaanUnitKerja as $key => $value) {
				 		 $$key = $value;
					 }
					$parentC1 = $getParentrkbmdPemeliharaanUnitKerja['c1'];
					$parentC = $getParentrkbmdPemeliharaanUnitKerja['c'];
					$parentD = $getParentrkbmdPemeliharaanUnitKerja['d'];
					$parentE = $getParentrkbmdPemeliharaanUnitKerja['e'];
					$parentE1= $getParentrkbmdPemeliharaanUnitKerja['e1'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) {
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPemeliharaanUnitKerja_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPemeliharaanUnitKerja_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{
		...
		case 'koreksi':{
			...
			$getrkbmdPemeliharaanUnitKerjanya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPemeliharaanUnitKerjanya as $key => $value) {
				  $$key = $value;
			}
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and dk='$dk' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if( $getrkbmdPemeliharaanUnitKerjanya['volume_barang'] >= $angkaKoreksi ) {
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPemeliharaanUnitKerjanya['volume_barang'] < $angkaKoreksi){
	 ...
	 function setPage_OtherScript(){
	   ...
	   return
	     ...
	     <script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".
	      "<script type='text/javascript' src='js/perencanaanKeuangan/aset/rkbmd/rkbmdPemeliharaanUnitKerja.js' language='JavaScript' ></script>".
	     $scriptload;
	 }
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPemeliharaanUnitKerja.koreksi('$id_anggaran');></img> ";
	...
	$TampilOpt =
			...
			<td width=\"100%\" valign=\"top\">" .
				WilSKPD_ajxVW("rkbmdPemeliharaanUnitKerjaSkpd") .
			"</td>
			<td >" .
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPemeliharaanUnitKerja' id='cmbJenisrkbmdPemeliharaanUnitKerja' value='PEMELIHARAAN'>
			</td></tr>
			</table>";
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID'];
		$c1   = $_REQUEST['rkbmdPemeliharaanUnitKerjaSkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPemeliharaanUnitKerjaSkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPemeliharaanUnitKerjaSkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI'];
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPemeliharaanUnitKerja = $_REQUEST['cmbJenisrkbmdPemeliharaanUnitKerja'];
		$arrKondisi = array();
	...
	function Laporan($dt){
	 ...
	 $c1 = $dt['rkbmdPemeliharaanUnitKerjaSkpdfmUrusan'];
	 $c = $dt['rkbmdPemeliharaanUnitKerjaSkpdfmSKPD'];
	 $d = $dt['rkbmdPemeliharaanUnitKerjaSkpdfmUNIT'];
	 $e = $dt['rkbmdPemeliharaanUnitKerjaSkpdfmSUBUNIT'];
	 $e1 = $dt['rkbmdPemeliharaanUnitKerjaSkpdfmSEKSI'];
...
$rkbmdPemeliharaanUnitKerja = new rkbmdPemeliharaanUnitKerjaObj();
$arrayResult = tahapPerencanaanV3($rkbmdPemeliharaanUnitKerja->modul,"MURNI");
...
$rkbmdPemeliharaanUnitKerja->jenisForm = $jenisForm;
$rkbmdPemeliharaanUnitKerja->nomorUrut = $nomorUrut;
$rkbmdPemeliharaanUnitKerja->urutTerakhir = $nomorUrut;
$rkbmdPemeliharaanUnitKerja->tahun = $tahun;
$rkbmdPemeliharaanUnitKerja->jenisAnggaran = $jenisAnggaran;
$rkbmdPemeliharaanUnitKerja->idTahap = $idTahap;
$rkbmdPemeliharaanUnitKerja->username = $_COOKIE['coID'];
$rkbmdPemeliharaanUnitKerja->wajibValidasi =  $arrayResult['wajib_validasi'];
if($rkbmdPemeliharaanUnitKerja->wajibValidasi == TRUE){
	$rkbmdPemeliharaanUnitKerja->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPemeliharaanUnitKerja->sqlValidasi = " ";
}

$rkbmdPemeliharaanUnitKerja->provinsi = $arrayResult['provinsi'];
$rkbmdPemeliharaanUnitKerja->kota = $arrayResult['kota'];
$rkbmdPemeliharaanUnitKerja->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPemeliharaanUnitKerja->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPemeliharaanUnitKerja->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPemeliharaanUnitKerja->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPemeliharaanUnitKerja->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPemeliharaanUnitKerja->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPemeliharaanUnitKerja->settingAnggaran = $arrayResult['settingAnggaran'];
