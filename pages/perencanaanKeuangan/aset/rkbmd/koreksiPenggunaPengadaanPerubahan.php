...
class koreksiPenggunaPengadaanPerubahanObj  extends DaftarObj2{	
	var $Prefix = 'koreksiPenggunaPengadaanPerubahan';
	...
	var $FormName = 'koreksiPenggunaPengadaanPerubahanForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		<A href=\"pages.php?Pg=koreksiPengelolaPengadaanPerubahan\" title='RKBMD PENGELOLA' > RKBMD PENGELOLA </a> 

		&nbsp&nbsp&nbsp	
		</td></tr>

		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=koreksiPenggunaPengadaanPerubahan\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD'  > INPUT </a> |
		<A href=\"pages.php?Pg=koreksiPenggunaPengadaanPerubahan\" title='RKBMD PENGELOLA' style='color : blue;' > KOREKSI </a> 
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 if($koreksiPenggunaPengadaanPerubahanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPenggunaPengadaanPerubahanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPenggunaPengadaanPerubahanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }else{
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanPerubahanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanPerubahanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanPerubahanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanPerubahanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanPerubahanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanPerubahanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanPerubahanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPenggunaPengadaanPerubahan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPenggunaPengadaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPengadaanPerubahan['c'];
					$parentD = $getParentkoreksiPenggunaPengadaanPerubahan['d'];
					$parentE = $getParentkoreksiPenggunaPengadaanPerubahan['e'];
					$parentE1= $getParentkoreksiPenggunaPengadaanPerubahan['e1'];
					...
					if($cmbJeniskoreksiPenggunaPengadaanPerubahan == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPenggunaPengadaanPerubahan_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPengadaanPerubahan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPenggunaPengadaanPerubahan as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentkoreksiPenggunaPengadaanPerubahan['c1'];
					$parentC = $getParentkoreksiPenggunaPengadaanPerubahan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPenggunaPengadaanPerubahan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPenggunaPengadaanPerubahan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
			...
			for($i = 0 ; $i < sizeof($id) ; $i++ ){
				...
				$get = mysql_query("select * from tabel_anggaran where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and ((id_jenis_pemeliharaan = '0' and f !='00') or uraian_pemeliharaan = 'RKBMD PENGADAAN') and id_anggaran!='$id[$i]' ");
		...
		case 'koreksi':{
			...
			$getkoreksiPenggunaPengadaanPerubahannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPenggunaPengadaanPerubahannya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						}elseif($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPenggunaPengadaanPerubahannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPenggunaPengadaanPerubahannya['volume_barang'] < $angkaKoreksi){
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) ) && $getkoreksiPenggunaPengadaanPerubahannya['volume_barang'] >= $angkaKoreksi ){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPenggunaPengadaanPerubahan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	 ...
	 if($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						// $Koloms.= "<td class='$cssclass' align='center'>$no</td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPengadaanPerubahan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPenggunaPengadaanPerubahan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){	
	 ...
	 $c1 = $dt['koreksiPenggunaPengadaanPerubahanSkpdfmUrusan'];
	 $c = $dt['koreksiPenggunaPengadaanPerubahanSkpdfmSKPD'];
	 $d = $dt['koreksiPenggunaPengadaanPerubahanSkpdfmUNIT'];
	 $e = $dt['koreksiPenggunaPengadaanPerubahanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPenggunaPengadaanPerubahanSkpdfmSEKSI'];
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("koreksiPenggunaPengadaanPerubahanSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPenggunaPengadaanPerubahan' id='cmbJeniskoreksiPenggunaPengadaanPerubahan' value='PENGADAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['koreksiPenggunaPengadaanPerubahanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPenggunaPengadaanPerubahanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPenggunaPengadaanPerubahanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPenggunaPengadaanPerubahanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPenggunaPengadaanPerubahanSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPenggunaPengadaanPerubahan = $_REQUEST['cmbJeniskoreksiPenggunaPengadaanPerubahan'];
		$arrKondisi = array();		
...
function Pengadaan11($xls =FALSE){
		...
		echo "
								...
								<table table width='100%' class='cetak' border='1' style='margin:4 0 0 0;width:100%;'>
									<tr>
										...
										<th class='th02' rowspan='1' colspan='8' >USULAN RENCANA KEBUTUHAN PENGADAAN BARANG MILIK DAERAH</th>
										<th class='th02' rowspan='1' colspan='2' >KEBUTUHAN MAKSIMUM</th>
	...
	function Pengadaan7($xls =FALSE){
		...
		$arrKondisi = array();
		$grabProgram = mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and p !='0' and q='0'");
		while($rows = mysql_fetch_array($grabProgram)){
			foreach ($rows as $key => $value) { 
				  $$key = $value; 
			}
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' ")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
		...
		$qry ="select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and uraian_pemeliharaan !='RKBMD PERSEDIAAN'  $Kondisi order by urut";
		$aqry = mysql_query($qry);
...
$koreksiPenggunaPengadaanPerubahan = new koreksiPenggunaPengadaanPerubahanObj();
...
$koreksiPenggunaPengadaanPerubahan->jenisForm = $jenisForm;
$koreksiPenggunaPengadaanPerubahan->nomorUrut = $nomorUrut;
$koreksiPenggunaPengadaanPerubahan->urutTerakhir = $nomorUrut;
$koreksiPenggunaPengadaanPerubahan->tahun = $tahun;
$koreksiPenggunaPengadaanPerubahan->jenisAnggaran = $jenisAnggaran;
$koreksiPenggunaPengadaanPerubahan->idTahap = $idTahap;
$koreksiPenggunaPengadaanPerubahan->username = $_COOKIE['coID'];
$koreksiPenggunaPengadaanPerubahan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPenggunaPengadaanPerubahan->wajibValidasi == TRUE){
	$koreksiPenggunaPengadaanPerubahan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPenggunaPengadaanPerubahan->sqlValidasi = " ";
}

$koreksiPenggunaPengadaanPerubahan->provinsi = $arrayResult['provinsi'];
$koreksiPenggunaPengadaanPerubahan->kota = $arrayResult['kota'];
$koreksiPenggunaPengadaanPerubahan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPenggunaPengadaanPerubahan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPenggunaPengadaanPerubahan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPenggunaPengadaanPerubahan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPenggunaPengadaanPerubahan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPenggunaPengadaanPerubahan->nipPejabat = $arrayResult['nipPejabat'];
