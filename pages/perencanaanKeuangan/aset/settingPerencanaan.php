...
class settingperencanaanObj  extends DaftarObj2{	
	...
	function SimpanUbah(){
	 ...
	 $qry = "UPDATE settingperencanaan  SET  jenis_anggaran = '".$_REQUEST['cmbJenisAnggaran']."',  tahun = '$tahun', provinsi = '$provinsi' , kota='$kota' , pejabat = '$pejabat' , pengelola ='$pengelola' , pengurus ='$pengurus' ";$cek.=$qry;
