			...
			<div id='pagetitle'>					
					...
					<td align='right'>
						...
						<a style='background: no-repeat url(images/administrator/images/home_24.png);	
									width:24;height:24;display: inline-block;position:absolute' href='index.php' title='Main Menu'> 											
						</a>
						</div>
						...
						<a style='background: no-repeat url(images/administrator/images/Setting2_24.png);	
									width:24;height:24;display: inline-block;position:absolute' href='pages.php?Pg=settingperencanaan' title='Tahap'> 											
						</a>
						</div>
