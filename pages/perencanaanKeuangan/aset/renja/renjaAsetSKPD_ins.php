<?php
class renjaAsetSKPD_insObj  extends DaftarObj2{
	var $Prefix = 'renjaAsetSKPD_ins';
	...
	var $FormName = 'renjaAsetSKPD_insForm';
	var $noModul=14;
	...
	$tujuan = "Simpan()";
	$codeAndNameKegiatan = "select q, concat(q, '. ', nama_program_kegiatan) as vnama from ref_programkegiatan where p='$selectedProgram' and q!='0'";
	if($ID_RENJA != '' && $ID_RENJA > 0){
		...
		$codeAndNameKegiatan = "select q, concat(q, '. ', nama) as vnama from ref_program where bk='$selectedBK' and ck = '$selectedCK' and dk = '$selectedDK' and p='$selectedProgram' and q!='0' ";//and q='$selectedKegiatan'
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							array(
							 ...
							 array(
								...
								<input type='button' value='Cari' id='findProgram' onclick ='renjaAsetSKPD_ins.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							  ),
							  array(
								'label'=>'KEGIATAN',
								'labelWidth'=>150,
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renjaAsetSKPD_ins_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renjaAsetSKPD_ins = new renjaAsetSKPD_insObj();

$arrayResult = tahapPerencanaanV3($renjaAsetSKPD_ins->modul,"MURNI");
...
$renjaAsetSKPD_ins->jenisForm = $jenisForm;
$renjaAsetSKPD_ins->nomorUrut = $nomorUrut;
$renjaAsetSKPD_ins->tahun = $tahun;
$renjaAsetSKPD_ins->jenisAnggaran = $jenisAnggaran;
$renjaAsetSKPD_ins->idTahap = $idTahap;
$renjaAsetSKPD_ins->username = $_COOKIE['coID'];
$renjaAsetSKPD_ins->wajibValidasi = $Main->wajibValidasi;
