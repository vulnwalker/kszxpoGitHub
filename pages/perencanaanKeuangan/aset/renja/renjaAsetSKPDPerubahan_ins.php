<?php
class renjaAsetSKPDPerubahan_insObj  extends DaftarObj2{
	var $Prefix = 'renjaAsetSKPDPerubahan_ins';
	...
	var $FormName = 'renjaAsetSKPDPerubahan_insForm';
	var $noModul=14;
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		if(!empty($cmbUnitForm) && empty($cmbSubUnitForm))$err = "Pilih Unit Pelaksana";
			...
			$content = array("1" => '1', "gblk" => $cekUrusanProgram , "ucing" =>  $cekSubUnit , "cek_unit" => $cekUnit, "insertK" => $queryK,'cekProgram' => $cekProgram );
	 ...
	 function setPage_OtherScript(){
	  ...
	  return
	    ...
	    "<script type='text/javascript' src='js/perencanaanKeuangan/aset/renja/renjaAsetSKPDPerubahan_ins.js' language='JavaScript' ></script>".
...
$waktuPelaksanaan = $mulai."&nbsp&nbsp s/d &nbsp&nbsp ".$selesai." &nbsp&nbsp ".$tahunJamak;
						...
						array(
							...
							array(
							 ...
							 array(
								'label'=>'PROGRAM',
								'labelWidth'=>250,
								'value'=>"<input type='hidden' name='bk' id='bk' value='$selectedBK'><input type='hidden' name='ck' id='ck' value='$selectedCK'><input type='hidden' name='dk' id='dk' value='$selectedDK'><input type='hidden' name='p' id='p' value='$selectedP'><input type='text' name='program' value='".$program."' style='width:600px;' id='program' readonly>&nbsp
								<input type='button' value='Cari' id='findProgram' onclick ='renjaAsetSKPDPerubahan_ins.CariProgramKegiatan()'  title='Cari Program dan Kegiatan' $disabledCariProgram >"
							  ),
							  array(
								'label'=>'KEGIATAN',
								'labelWidth'=>150,
	...
	function rincianpenerimaanDET(){
		...
		$idplh = addslashes($_REQUEST['renjaAsetSKPDPerubahan_ins_idplh']);
		$ID_RENJA = $_REQUEST['ID_RENJA'];
...
$renjaAsetSKPDPerubahan_ins = new renjaAsetSKPDPerubahan_insObj();

$arrayResult = tahapPerencanaanV3($renjaAsetSKPDPerubahan_ins->modul,"PERUBAHAN");
...
$renjaAsetSKPDPerubahan_ins->jenisForm = $jenisForm;
$renjaAsetSKPDPerubahan_ins->nomorUrut = $nomorUrut;
$renjaAsetSKPDPerubahan_ins->tahun = $tahun;
$renjaAsetSKPDPerubahan_ins->jenisAnggaran = $jenisAnggaran;
$renjaAsetSKPDPerubahan_ins->idTahap = $idTahap;
$renjaAsetSKPDPerubahan_ins->username = $_COOKIE['coID'];
$renjaAsetSKPDPerubahan_ins->wajibValidasi = $Main->wajibValidasi;
