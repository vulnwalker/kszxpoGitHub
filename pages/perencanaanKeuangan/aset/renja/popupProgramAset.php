...
class popupProgramRenjaAsetObj  extends DaftarObj2{
	var $Prefix = 'popupProgramRenjaAset';
	...
	var $FormName = 'popupProgramRenjaAsetForm';
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $kode_jurnal=genNumber($isi['bk']).'.'.genNumber($isi['ck']).'.'.genNumber($isi['dk']).".".genNumber($isi['p']).'.'.genNumber($isi['q']);
	 $Koloms = array();
	 ...
	 $Koloms[] = array('align="left" width=""',"<a style='cursor:pointer;' onclick=$this->Prefix.windowSave('$kodeProgram')>".$isi['nama']."</a>");
	 return $Koloms;
	}
...
$popupProgramRenjaAset = new popupProgramRenjaAsetObj();
