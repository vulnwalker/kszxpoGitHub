...
$Kondisi = getKondisiSKPD($fmKEPEMILIKAN,$Main->DEF_PROPINSI,$Main->DEF_WILAYAH,$fmURUSAN,$fmSKPD,$fmUNIT,$fmSUBUNIT,$fmSEKSI);
...
if (!empty($fmKIB)) $Kondisi .= $genKonKIB;
//if (!empty($fmPilihThn))
$Kondisi .= !empty($fmPilihThn) ? " and year(tgl_pengamanan)='$fmPilihThn'" : " and year(tgl_pengamanan)='$thn_login'";
...
/*$PilihThnBuku = " <div style='float:left;padding:1 8 0 8;'>".
			cmbQuery('',$fmPilihThn,'select year(tgl_buku)as thn_aman ,year(tgl_buku)as thn_aman from v_pengaman group by thn_aman desc',
				'', 'Semua Tahun Buku', '').
			"</div>";*/
$PilihThnBuku = "";
