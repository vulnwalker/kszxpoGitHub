...
class Rekaprpbmd_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekaprpbmd_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	...
	var $FormName = 'Rekaprpbmd_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap RPBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekaprpbmd_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP RPBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP RPBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekaprpbmd_skpd_rinci = new Rekaprpbmd_skpd_rinciObj();
