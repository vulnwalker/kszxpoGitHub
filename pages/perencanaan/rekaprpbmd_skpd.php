...
class rekaprpbmd_skpdObj  extends DaftarObj2{	
	var $Prefix = 'rekaprpbmd_skpd';
	...
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='Rekap RPBMD SKPD.xls';
	var $Cetak_Judul = 'REKAP RPBMD SKPD';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	
	var $FormName = 'rekaprpbmd_skpdForm'; 	
			
	function setTitle(){
		return 'Rekap Rencana Pemanfaatan Barang Milik Daerah (SKPD)';
	}
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'BidangAfter':{
			$content= $this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekaprpbmd_skpd.refreshList(true)','--- Pilih SKPD ---','00');
		break;
	    }
		case 'SKPDAfter':{
	...
	function setNavAtas(){
		...
		return
			...
			<tr>
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				<a href="pages.php?Pg=rencana_pemanfaatan" title="Rencana Pemanfaatan Barang Milik Daerah">RPBMD</a> |	
				<a href="pages.php?Pg=rekaprpbmd" title="Rekap Rencana Kebutuhan Barang Milik Daerah">Rekap RPBMD</a> |
				<a style="color:blue;" href="pages.php?Pg=rekaprpbmd_skpd" title="Rencana Kebutuhan Pemeliharaan Barang Milik Daerah">Rekap RPBMD (SKPD)</a>
				  &nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
			</table>';
	...
	$TampilOpt = 
			...
			"<table><tr><td width='100'>Bidang</td><td width='10'>:</td><td>".
				$this->cmbQueryBidang('fmSKPDBidang',$fmSKPDBidang,'','onchange=rekaprpbmd_skpd.BidangAfter() '.$disabled1,'--- Pilih BIDANG ---','00')."</td></tr>".
			"<tr><td width='100'>SKPD</td><td width='10'>:</td><td>".
				$this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekaprpbmd_skpd.SKPDAfter() '.$disabled1,'--- Pilih SKPD ---','00').
			"</td></tr></table>".
			"</td>
			</tr></table>".
...
$rekaprpbmd_skpd = new rekaprpbmd_skpdObj();
