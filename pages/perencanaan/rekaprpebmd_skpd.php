...
class rekaprpebmd_skpdObj  extends DaftarObj2{	
	var $Prefix = 'rekaprpebmd_skpd';
	...
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='Rekap RPTBMD SKPD.xls';
	var $Cetak_Judul = 'REKAP RPTBMD SKPD';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	
	var $FormName = 'rekaprpebmd_skpdForm'; 	
			
	function setTitle(){
		return 'Rekap Rencana Pemindahtanganan Barang Milik Daerah (SKPD)';
	}
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'BidangAfter':{
			$content= $this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekaprpebmd_skpd.refreshList(true)','--- Pilih SKPD ---','00');
		break;
	    }
		case 'SKPDAfter':{
	...
	function setNavAtas(){
		...
		return
			...
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				...
				<a href="pages.php?Pg=rekaprptbmd" title="Rekap Rencana Pemindahtanganan Barang Milik Daerah">Rekap RPTBMD</a> |
				<a style="color:blue;" href="pages.php?Pg=rekaprpebmd_skpd" title="Rencana Pemindahtanganan Barang Milik Daerah">Rekap RPTBMD (SKPD)</a>
				  &nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
			</table>';
	...
	$TampilOpt = 
			...
			"<table><tr><td width='100'>Bidang</td><td width='10'>:</td><td>".
				$this->cmbQueryBidang('fmSKPDBidang',$fmSKPDBidang,'','onchange=rekaprpebmd_skpd.BidangAfter() '.$disabled1,'--- Pilih BIDANG ---','00')."</td></tr>".
			"<tr><td width='100'>SKPD</td><td width='10'>:</td><td>".
				$this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekaprpebmd_skpd.SKPDAfter() '.$disabled1,'--- Pilih SKPD ---','00').
			"</td></tr></table>".
			"</td>
			</tr></table>".
...
$rekaprpebmd_skpd = new rekaprpebmd_skpdObj();
