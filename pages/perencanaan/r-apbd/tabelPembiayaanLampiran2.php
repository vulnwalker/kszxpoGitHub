...
class tabelPembiayaanLampiran2Obj  extends DaftarObj2{	
	var $Prefix = 'tabelPembiayaanLampiran2';
	...
	var $FormName = 'tabelPembiayaanLampiran2Form'; 
	var $kdbrg = '';	
	var $pemisahID = ';';
	var $modul = "RKA-SKPD";
	var $jenisForm = "";
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($d =='00'){
	 	$getPenerimaan = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and rincian_perhitungan !='' and c1='$c1' and c='$c'  and k='6' and l='1' $kondisiFilter  "));
	 	$Koloms[] = array('align="right"',number_format($getPenerimaan['sum(jumlah_harga)'],2,',','.'));
		$getPengeluaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and rincian_perhitungan !='' and c1='$c1' and c='$c'  and k='6' and l='2' $kondisiFilter  "));
		...
		$Koloms[] = array('align="right"',number_format( $getPenerimaan['sum(jumlah_harga)'] - $getPengeluaran['sum(jumlah_harga)'],2,',','.'));
	 	...
	 	$getPenerimaan = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and rincian_perhitungan !='' and c1='$c1' and c='$c' and d='$d' and k='6' and l='1' $kondisiFilter  "));
	 	$Koloms[] = array('align="right"',number_format($getPenerimaan['sum(jumlah_harga)'],2,',','.'));
		$getPengeluaran = mysql_fetch_array(mysql_query("select sum(jumlah_harga) from tabel_anggaran where o1 !='0' and rincian_perhitungan !='' and c1='$c1' and c='$c' and d='$d' and k='6' and l='2' $kondisiFilter  "));
	 	$Koloms[] = array('align="right"',number_format($getPengeluaran['sum(jumlah_harga)'],2,',','.'));
		$Koloms[] = array('align="right"',number_format( $getPenerimaan['sum(jumlah_harga)'] - $getPengeluaran['sum(jumlah_harga)'],2,',','.'));
	 }
	...
	function getDaftarOpsi($Mode=1){
		...
		$arrKondisi = array();	
 		$arrKondisi[] = "d !='00'";
		$getAllD = mysql_query("select *  from tabel_anggaran where o1 !='0' and rincian_perhitungan !=''  ");
...
$tabelPembiayaanLampiran2 = new tabelPembiayaanLampiran2Obj();
$arrayResult = VulnWalkerTahap($tabelPembiayaanLampiran2->modul);
...
$tabelPembiayaanLampiran2->jenisForm = $jenisForm;
$tabelPembiayaanLampiran2->nomorUrut = $nomorUrut;
$tabelPembiayaanLampiran2->tahun = $tahun;
$tabelPembiayaanLampiran2->jenisAnggaran = $jenisAnggaran;
$tabelPembiayaanLampiran2->idTahap = $idTahap;


if(empty($tabelPembiayaanLampiran2->tahun)){
	...
	/*$tabelPembiayaanLampiran2->tahun = "select max(id_anggaran) as max from view_r_apbd where nama_modul = 'apbd'";*/
	$tabelPembiayaanLampiran2->tahun  = $get2['tahun'];
	$tabelPembiayaanLampiran2->jenisAnggaran = $get2['jenis_anggaran'];
	$tabelPembiayaanLampiran2->urutTerakhir = $get2['no_urut'];
	$tabelPembiayaanLampiran2->jenisFormTerakhir = $get2['jenis_form_modul'];
	$tabelPembiayaanLampiran2->urutSebelumnya = $tabelPembiayaanLampiran2->urutTerakhir - 1;
	...
	$tabelPembiayaanLampiran2->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$tabelPembiayaanLampiran2->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$tabelPembiayaanLampiran2->noUrutTerakhirapbd = $namaTahap['no_urut'];
	...
	$tabelPembiayaanLampiran2->masaTerakhir = $lastTanggalMulai." JAM : ".$namaTahap['jam_mulai']."  s/d  ".$lastTanggalSelesai." JAM : ".$namaTahap['jam_selesai'];
	
	$arrayHasil =  VulnWalkerLASTTahap();
	$tabelPembiayaanLampiran2->currentTahap = $arrayHasil['currentTahap'];
}else{
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$tabelPembiayaanLampiran2->idTahap'"));
	$tabelPembiayaanLampiran2->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$tabelPembiayaanLampiran2->idTahap'"));
	$tabelPembiayaanLampiran2->jenisFormTerakhir =  $namaTahap['jenis_form_modul'];
	$tabelPembiayaanLampiran2->namaTahapTerakhir = $namaTahap['nama_tahap'];
	$tabelPembiayaanLampiran2->noUrutTerakhirapbd = $namaTahap['no_urut'];
	$arrayMasa = explode("-",$namaTahap['tanggal_mulai']);
