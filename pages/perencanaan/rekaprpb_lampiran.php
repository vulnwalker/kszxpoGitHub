...
class Rekaprpb_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekaprpb_lampiran';
	...
	var $PageTitle = 'Lampiran Rekap RPBMD ';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekaprpb_lampiran.xls';
	var $Cetak_Judul = 'Rekap RPB Lampiran';	
	var $Cetak_Mode=1;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekaprpb_lampiran_form'; 
	var $totalCol = 4;	
	
	function setTitle(){
		return 'Rekap RPB Lampiran';
	}	
...
$Rekaprpb_lampiran = new Rekaprpb_lampiranObj();
