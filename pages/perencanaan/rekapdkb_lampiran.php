...
class Rekapdkb_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekapdkb_lampiran';
	...
	var $PageTitle = 'Lampiran Rekap DKBMD';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekapdkb_lampiran.xls';
	var $Cetak_Judul = 'Rekap DKB Lampiran';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekapdkb_lampiran_form'; 	
	var $totalCol = 4;
	
	
	function setTitle(){
		return 'Rekap DKB Lampiran';
	}
...
$Rekapdkb_lampiran = new Rekapdkb_lampiranObj();
