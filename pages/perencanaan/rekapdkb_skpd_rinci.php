...
class Rekapdkb_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekapdkb_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	...
	var $FormName = 'Rekapdkb_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap DKBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekapdkb_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP DKBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP DKBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekapdkb_skpd_rinci = new Rekapdkb_skpd_rinciObj();
