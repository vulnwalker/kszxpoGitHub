...
class Rekaprkb_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekaprkb_lampiran';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'rkb'; //daftar
	...
	var $PageTitle = 'Lampiran Rekap RKBMD ';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekaprkb_lampiran.xls';
	var $Cetak_Judul = 'Rekap RKB Lampiran';	
	var $Cetak_Mode=1;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekaprkb_lampiran_form'; 
	var $totalCol = 4;	
	
	function setTitle(){
		return 'Rekap RKB Lampiran';
	}	
	...
	function setDaftar_query($Kondisi='', $Order='', $Limit=''){		
		$aqry = "select id,c,d,sum(jml_barang) as jml_barang, sum(jml_harga) as jml_harga from $this->TblName $Kondisi $Order $Limit ";	
		return $aqry;		
	}
	
	function setSumHal_query($Kondisi, $fsum){
		//return "select $fsum from $this->TblName $Kondisi "; //echo $aqry;
		return "select $fsum from (select id,c,d,sum(jml_barang) as jml_barang, sum(jml_harga) as jml_harga from $this->TblName $Kondisi ) aa "; //echo $aqry;
...
$Rekaprkb_lampiran = new Rekaprkb_lampiranObj();
