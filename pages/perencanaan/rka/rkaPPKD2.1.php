...
class rkaPPKD21Obj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=rka-ppkd-2.1\" title='RKA-PPKD MURNI' style='color:blue;'  > RKA-PPKD 2.1 </a> |
   ...
   function setPage_OtherScript(){
		...
		return 	
			...
			<script type='text/javascript' src='js/perencanaan/rka/rkaPPKD2.1.js' language='JavaScript' ></script> 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 //TAHAP PENYUSUNAN
			 ...
			 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkaPPKD21.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkaPPKD21.koreksi('$id_anggaran');></img> ";
			 if ($rincian_perhitungan == '') {
			 $aksi = "";
			 }
			 if(empty($rincian_perhitungan)){
...
$fmORDER1 = $_REQUEST['fmORDER1'];
	...
	foreach ($_COOKIE as $key => $value) { 
		...
		$skpd= cmbQuery('cmbSKPD',$selectedD,$codeAndNameSKPD,'onchange=rkaPPKD21.refreshList(true);','-- SKPD --');
...
$arrayResult = VulnWalkerTahap($rkaPPKD21->modul);
$jenisForm = $arrayResult['jenisForm'];
$nomorUrut = $arrayResult['nomorUrut'];
$tahun = $arrayResult['tahun'];
$jenisAnggaran = $arrayResult['jenisAnggaran'];
