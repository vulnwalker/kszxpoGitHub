...
class Rekaprphbmd_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekaprphbmd_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	var $TblName = 't_rencana_penghapusan';//view2_sensus';
	var $TblName_Hapus = 't_rencana_penghapusan';
	var $TblName_Edit = 't_rencana_penghapusan';
	...
	var $FormName = 'Rekaprphbmd_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap RHBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekaprphbmd_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP RHBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP RHBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekaprphbmd_skpd_rinci = new Rekaprphbmd_skpd_rinciObj();
