...
class Rekapdkpb_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekapdkpb_lampiran';
	...
	var $PageTitle = 'Lampiran Rekap DKPBMD';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekapdkpb_lampiran.xls';
	var $Cetak_Judul = 'Rekap DKPB Lampiran';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekapdkpb_lampiran_form';
	var $totalCol = 4; 	
	
	
	function setTitle(){
		return 'Rekap DKPB Lampiran';
	}
	...
	function setSumHal_query($Kondisi, $fsum){
		...
		return "select $fsum from (select id,c,d,sum(jml_barang) as jml_barang, sum(jml_biaya) as jml_harga from $this->TblName $Kondisi ) aa "; //echo $aqry;
...
$Rekapdkpb_lampiran = new Rekapdkpb_lampiranObj();
