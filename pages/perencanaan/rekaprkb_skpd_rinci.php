...
class Rekaprkb_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekaprkb_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	...
	var $FormName = 'Rekaprkb_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap RKBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekaprkb_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP RKBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP RKBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekaprkb_skpd_rinci = new Rekaprkb_skpd_rinciObj();
