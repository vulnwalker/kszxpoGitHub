...
class rekapdkpbmd_skpdObj  extends DaftarObj2{	
	var $Prefix = 'rekapdkpbmd_skpd';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'dkpb'; //daftar
	...
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='Rekap DKPBMD SKPD.xls';
	var $Cetak_Judul = 'REKAP DKPBMD SKPD';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	
	var $FormName = 'rekapdkpbmd_skpdForm'; 	
			
	function setTitle(){
		return 'Rekap Daftar Kebutuhan Pemeliharaan Barang Milik Daerah (SKPD)';
	}
	...
	function set_selector_other($tipe){
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		case 'BidangAfter':{
			$content= $this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekapdkpbmd_skpd.refreshList(true)','--- Pilih SKPD ---','00');
		break;
	    }
		case 'SKPDAfter':{
	...
	function setNavAtas(){
		...
		return
			...
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				...
				<a href="pages.php?Pg=dkpb" title="Daftar Kebutuhan Barang Milik Daerah">DKBMD</a>  |  
				<a href="pages.php?Pg=rekapdkpb" title="Rekap Daftar Kebutuhan Barang Milik Daerah">Rekap DKBMD</a>  |  
				<a style="color:blue;"  href="pages.php?Pg=rekapdkpb_skpd" title="Rekap Daftar Kebutuhan Pemeliharaan Barang Milik Daerah">Rekap DKBMD (SKPD)</a>
				  &nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
			</table>';
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 global $Main;
		...
		$Koloms[] = array('align=right', number_format( ifempty( $isi['jml_brg_a'],0) ,0,',','.'));
		$Koloms[] = array('align=right', number_format( ifempty($isi['jml_biaya_a'],0) ,2,',','.'));
	...
	$TampilOpt = 
			...
			"<table><tr><td width='100'>Bidang</td><td width='10'>:</td><td>".
				$this->cmbQueryBidang('fmSKPDBidang',$fmSKPDBidang,'','onchange=rekapdkpbmd_skpd.BidangAfter() '.$disabled1,'--- Pilih BIDANG ---','00')."</td></tr>".
			"<tr><td width='100'>SKPD</td><td width='10'>:</td><td>".
				$this->cmbQuerySKPD('fmSKPDskpd',$fmSKPDskpd,'','onchange=rekapdkpbmd_skpd.SKPDAfter() '.$disabled1,'--- Pilih SKPD ---','00').
			"</td></tr></table>".
			"</td>
			</tr></table>".
...
$rekapdkpbmd_skpd = new rekapdkpbmd_skpdObj();
