...
class Rekaprpt_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekaprpt_lampiran';
	...
	var $PageTitle = 'Lampiran Rekap RPTBMD ';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekaprpt_lampiran.xls';
	var $Cetak_Judul = 'Rekap RPT Lampiran';	
	var $Cetak_Mode=1;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekaprpt_lampiran_form'; 
	var $totalCol = 4;	
	
	function setTitle(){
		return 'Rekap RPT Lampiran';
	}	
...
$Rekaprpt_lampiran = new Rekaprpt_lampiranObj();
