...
class popupProgramRKBMDObj  extends DaftarObj2{	
	var $Prefix = 'popupProgramRKBMD';
	...
	var $FormName = 'popupProgramRKBMDForm';
	var $noModul=14; 
   ...
   function setPage_OtherScript(){
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="left"',"<a style='cursor:pointer;' onclick = popupProgramRKBMD.windowSave('$tak'); >" .$isi['nama']."</a>" );
	 return $Koloms;
	}
...
$popupProgramRKBMD = new popupProgramRKBMDObj();
?>