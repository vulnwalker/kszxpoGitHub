	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
		...
		/*$fmThnAnggaran=  $_COOKIE['coThnAnggaran'];
		 ...
		 $content = array('kodeBarang'=>$kode_barang, 'namaBarang'=>$get['nm_barang'],'satuanBarang'=>$get['satuan'] , 'kebutuhanMaksimal' =>$getKebutuhanMaksimal['jumlah'], "kebutuhanOptimal"=> $kebutuhanOptimal, "kebutuhanRill" => $getKebutuhanMaksimal['jumlah'] - $kebutuhanOptimal );	
		break;
	   }
