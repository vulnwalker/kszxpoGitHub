...
class Rekapdkpbmd_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekapdkpbmd_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	var $TblName = 'dkpb';//view2_sensus';
	var $TblName_Hapus = 'dkpb';
	var $TblName_Edit = 'dkpb';
	var $KeyFields = array('id');
	var $FieldSum = array('jml_biaya');
	var $SumValue = array('jml_biaya');
	var $FieldSum_Cp1 = array( 7, 6, 6);
	var $FieldSum_Cp2 = array( 5, 2, 2);	
	var $FormName = 'Rekapdkpbmd_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap DKPBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekapdkpbmd_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP DKPBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP DKPBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekapdkpbmd_skpd_rinci = new Rekapdkpbmd_skpd_rinciObj();
