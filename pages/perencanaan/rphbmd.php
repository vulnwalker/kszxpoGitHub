...
class rphbmdObj  extends DaftarObj2{	
	...
	function setNavAtas(){
		...
		return
			...
			<tr>
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				<a style="color:blue;" href="pages.php?Pg=rphbmd" title="Rencana Penghapusan Barang Milik Daerah">RHBMD</a> |	
				<a href="pages.php?Pg=rekaprphbmd" title="Rekap Rencana Penghapusan Barang Milik Daerah">Rekap RHBMD</a> |
				<a href="pages.php?Pg=rekaprphbmd_skpd" title="Rencana Penghapusan Barang Milik Daerah">Rekap RHBMD (SKPD)</a>
				  &nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
			</table>';
