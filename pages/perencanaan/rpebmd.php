...
class rpebmdObj  extends DaftarObj2{	
	...
	function setNavAtas(){
		...
		return
			...
			<tr>
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				<a style="color:blue;" href="pages.php?Pg=rpebmd" title="Rencana Pemindahtanganan Barang Milik Daerah">RPTBMD</a> |	
				<a href="pages.php?Pg=rekaprptbmd" title="Rekap Rencana Pemindahtanganan Barang Milik Daerah">Rekap RPTBMD</a> |
				<a href="pages.php?Pg=rekaprpebmd_skpd" title="Rencana Pemindahtanganan Barang Milik Daerah">Rekap RPTBMD (SKPD)</a>
				  &nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
			</table>';
