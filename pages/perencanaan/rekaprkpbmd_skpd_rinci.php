...
class Rekaprkpbmd_skpd_rinciObj extends DaftarObj2{
	var $Prefix = 'Rekaprkpbmd_skpd_rinci';
	//var $SHOW_CEK = TRUE;	
	var $TblName = 'rkpb';//view2_sensus';
	...
	var $FormName = 'Rekaprkpbmd_skpd_rinciForm';
	//var $pagePerHal = 7;
	//var $thnsensus_default = 2013;
	//var $periode_sensus = 5;// tahun
	
	var $PageTitle = 'Rincian Rekap RKPBMD (SKPD)';
	var $PageIcon = 'images/perencanaan_ico.png';
	var $ico_width = '';
	var $ico_height = '';
	
	var $fileNameExcel='rekaprkpbmd_skpd_rinci.xls';
	var $Cetak_Judul = 'RINCIAN REKAP RKPBMD (SKPD)';	
	var $Cetak_Mode=2;
	...
	function setTitle(){
		return 'RINCIAN REKAP RKPBMD (SKPD)';
	}
	function setNavAtas(){
		return "";
...
$Rekaprkpbmd_skpd_rinci = new Rekaprkpbmd_skpd_rinciObj();
