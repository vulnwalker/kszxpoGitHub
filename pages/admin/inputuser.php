...
$fmKODEPENGGUNA_lama = cekPOST("fmKODEPENGGUNA_lama","");
...
if($Act == "Simpan")
{
	...
	if($BARU == "1" || $BARU=="0")
	{
		...
		else
		{
			...
			if($Cek && $BARU=="1")
			{
				$Info = "<script>alert('ID Pengguna $fmKODEPENGGUNA sudah ada, data tidak disimpan');</script>";
			}
			else
			{
				//SIMPAN DATA
				...
				if($BARU=="0")
				{
					...
					password='$PWD',
						...
						moduladm='$fmMODULadm',
						status='$fmStatus'
						where uid='$fmKODEPENGGUNA_lama' limit 1";
						$Simpan = mysql_query($aqy);
				} 
				if($Simpan)
				{
...
if ($Main->URUSAN=='0'){
	$fmGROUPPENGGUNA1 = $fmSKPD.".".$fmUNIT.".".$fmSUBUNIT.".".$fmSEKSI;
}else{
	$fmGROUPPENGGUNA1 = $fmURUSAN.".".$fmSKPD.".".$fmUNIT.".".$fmSUBUNIT.".".$fmSEKSI;
}
...
if($Act == "Add")
{
	...
	$fmGROUPPENGGUNA = $fmGROUPPENGGUNA1;
	$fmMODUL01 = "0";
	$fmMODUL02 = "0";
	$fmMODUL03 = "0";
	$fmMODUL04 = "0";
...
if ($Main->URUSAN=='0'){
	...
	if($fmUNIT != '' && $fmUNIT !='00') {
		...
		if($fmSUBUNIT != ''  && $fmSUBUNIT !='00') {
			$arrkond[] = $fmSUBUNIT;
			if($fmSEKSI != ''  && $fmSEKSI !=$kdSubUnit0 ) $arrkond[] = $fmSEKSI ;
		}
	}
}
}else{
...
$ListSEKSI = cmbQuery1("fmSEKSI",$fmSEKSI,"select e1,nm_skpd from ref_skpd where c='$fmSKPD' and d ='$fmUNIT' and e = '$fmSUBUNIT' and e1!='$kdSubUnit0' ","onChange=\"adminForm.submit()\" ",'Pilih Semua',$kdSubUnit0);
	...
	$ListURUSAN = cmbQuery1("fmURUSAN",$fmURUSAN,"select c1,nm_skpd from ref_skpd where c1!='0' and c='00' and d ='00' and e = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','0');
$ListSKPD = cmbQuery1("fmSKPD",$fmSKPD,"select c,nm_skpd from ref_skpd where c1='$fmURUSAN' and c!='00' and d ='00' and e = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListUNIT = cmbQuery1("fmUNIT",$fmUNIT,"select d,nm_skpd from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d !='00' and e = '00'  ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListSUBUNIT = cmbQuery1("fmSUBUNIT",$fmSUBUNIT,"select e,nm_skpd from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d ='$fmUNIT' and e != '00' and e1='$kdSubUnit0'","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListSEKSI = cmbQuery1("fmSEKSI",$fmSEKSI,"select e1,nm_skpd from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d ='$fmUNIT' and e = '$fmSUBUNIT' and e1!='$kdSubUnit0' ","onChange=\"adminForm.submit()\" ",'Pilih Semua',$kdSubUnit0);
}
/*$ListURUSAN = cmbQuery1("fmURUSAN",$fmURUSAN,"select c1,nm_skpd from ref_skpd where c1!='0' and c='00' and d ='00' and e = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','0');
$ListSKPD = cmbQuery1("fmSKPD",$fmSKPD,"select c,nm_skpd from ref_skpd where c1='$fmURUSAN' and c!='00' and d ='00' and e = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListUNIT = cmbQuery1("fmUNIT",$fmUNIT,"select d,nm_skpd from ref_skpd where c1='$fmURUSAN' and c='$fmSKPD' and d !='00' and e = '00'  ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
...
$aqry = "select * from admin where $Kondisi order by `group` $LimitHalPENGGUNA "; $cek.= $aqry;
...
if($Act=="Baru" || $Act=="Tambah" || $Act=="TambahEdit"|| $Act=="Add"|| ($Act=="Edit" && !empty($fmID)))
{
	...
	<table width=\"100%\" height=\"100%\" class=\"adminform\">
		...
		<tr>
			...
			<td WIDTH='1%'>:</td>
			<td ><INPUT TYPE='TEXT' NAME='fmKODEPENGGUNA' VALUE='$fmKODEPENGGUNA'>
				<INPUT TYPE='hidden' NAME='fmKODEPENGGUNA_lama' VALUE='$fmKODEPENGGUNA'></td>
		</tr>
		<tr>
