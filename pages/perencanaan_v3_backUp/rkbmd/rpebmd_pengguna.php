...
class rpebmd_penggunaObj  extends DaftarObj2{	
	var $Prefix = 'rpebmd_pengguna';
	...
	var $FormName = 'rpebmd_penggunaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rpebmd_pengguna_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkiba' name='rpebmd_pengguna_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkibb' name='rpebmd_pengguna_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkibc' name='rpebmd_pengguna_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkibd' name='rpebmd_pengguna_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkibe' name='rpebmd_pengguna_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rpebmd_pengguna_formkibf' name='rpebmd_pengguna_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rpebmd_pengguna' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rpebmd_pengguna' name='det_rpebmd_pengguna' >".$rpebmd_pengguna_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	<A href=\"pages.php?Pg=rpebmd_pengguna\" title='RKBMD PEMANFAATAN MURNI' style='color : blue;' > PEMINDAHTANGANAN </a> |
...
$rpebmd_pengguna = new rpebmd_penggunaObj();

$arrayResult = tahapPerencanaanV3($rpebmd_pengguna->modul);
...
$rpebmd_pengguna->jenisForm = $jenisForm;
$rpebmd_pengguna->nomorUrut = $nomorUrut;
$rpebmd_pengguna->urutTerakhir = $nomorUrut;
$rpebmd_pengguna->tahun = $tahun;
$rpebmd_pengguna->jenisAnggaran = $jenisAnggaran;
$rpebmd_pengguna->idTahap = $idTahap;
$rpebmd_pengguna->username = $_COOKIE['coID'];
$rpebmd_pengguna->wajibValidasi = $arrayResult['wajib_validasi'];
if($rpebmd_pengguna->wajibValidasi == TRUE){
	$rpebmd_pengguna->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rpebmd_pengguna->sqlValidasi = " ";
}
$rpebmd_pengguna->provinsi = $arrayResult['provinsi'];
$rpebmd_pengguna->kota = $arrayResult['kota'];

$rpebmd_pengguna->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rpebmd_pengguna->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rpebmd_pengguna->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rpebmd_pengguna->nipPengelola = $arrayResult['nipPengelola'];
$rpebmd_pengguna->nipPengurus = $arrayResult['nipPengurus'];
$rpebmd_pengguna->nipPejabat = $arrayResult['nipPejabat'];
