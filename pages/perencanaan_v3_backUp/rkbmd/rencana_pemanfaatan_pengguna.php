...
class rencana_pemanfaatan_penggunaObj  extends DaftarObj2{	
	var $Prefix = 'rencana_pemanfaatan_pengguna';
	...
	var $FormName = 'rencana_pemanfaatan_penggunaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	var $nipPengurus ="";		
	function setTitle(){
		return 'PEMANFAATAN PENGGUNA BARANG';
	}
		...
		if($err==''){ 
			...
			//==================================
				...
				if($err==''){ 
					...
					" a1,a,b,".
					" c1,c,d,e,e1,f,g,h,i,j,nm_barang,".
	...
	function setForm($dt){	
	 ...
	 $this->form_height = $sh-100;
	  if ($this->form_fmST==0) {
		...
		$rencana_pemanfaatan_pengguna_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(	
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkiba' name='rencana_pemanfaatan_pengguna_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkibb' name='rencana_pemanfaatan_pengguna_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkibc' name='rencana_pemanfaatan_pengguna_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkibd' name='rencana_pemanfaatan_pengguna_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkibe' name='rencana_pemanfaatan_pengguna_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rencana_pemanfaatan_pengguna_formkibf' name='rencana_pemanfaatan_pengguna_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
				'det_rencana_pemanfaatan' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rencana_pemanfaatan' name='det_rencana_pemanfaatan' >".$rencana_pemanfaatan_pengguna_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	<A href=\"pages.php?Pg=rencana_pemanfaatan_pengguna\" title='RKBMD PEMANFAATAN MURNI' style='color : blue;' > PEMANFAATAN </a> |
	<A href=\"pages.php?Pg=rpebmd_pengguna\" title='RKBMD PEMANFAATAN MURNI' > PEMINDAHTANGANAN </a> |
	...
	$TampilOpt = 
			...
			genFilterBar(
				array(	
					boxFilter( 'Tahun Anggaran : '.	"<input type='text' value='$this->tahun' id='fmThnAnggaran' name='fmThnAnggaran' readonly>"	 )				
	...
	function getDaftarOpsi($Mode=1){
		...
		$fmPILCARI = cekPOST('fmPILCARI');
		$fmPILCARIVALUE = cekPOST('fmPILCARIVALUE');
		/*$fmURUSAN = cekPOST('rencana_pemanfaatan_penggunaSkpdfmURUSAN');
...
$rencana_pemanfaatan_pengguna = new rencana_pemanfaatan_penggunaObj();


$arrayResult = tahapPerencanaanV3($rencana_pemanfaatan_pengguna->modul);
...
$rencana_pemanfaatan_pengguna->jenisForm = $jenisForm;
$rencana_pemanfaatan_pengguna->nomorUrut = $nomorUrut;
$rencana_pemanfaatan_pengguna->urutTerakhir = $nomorUrut;
$rencana_pemanfaatan_pengguna->tahun = $tahun;
$rencana_pemanfaatan_pengguna->jenisAnggaran = $jenisAnggaran;
$rencana_pemanfaatan_pengguna->idTahap = $idTahap;
$rencana_pemanfaatan_pengguna->username = $_COOKIE['coID'];
$rencana_pemanfaatan_pengguna->wajibValidasi = $arrayResult['wajib_validasi'];
if($rencana_pemanfaatan_pengguna->wajibValidasi == TRUE){
	$rencana_pemanfaatan_pengguna->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rencana_pemanfaatan_pengguna->sqlValidasi = " ";
}
$rencana_pemanfaatan_pengguna->provinsi = $arrayResult['provinsi'];
$rencana_pemanfaatan_pengguna->kota = $arrayResult['kota'];

$rencana_pemanfaatan_pengguna->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rencana_pemanfaatan_pengguna->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rencana_pemanfaatan_pengguna->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rencana_pemanfaatan_pengguna->nipPengelola = $arrayResult['nipPengelola'];
$rencana_pemanfaatan_pengguna->nipPengurus = $arrayResult['nipPengurus'];
$rencana_pemanfaatan_pengguna->nipPejabat = $arrayResult['nipPejabat'];
