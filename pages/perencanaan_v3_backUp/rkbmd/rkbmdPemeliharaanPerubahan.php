...
class rkbmdPemeliharaanPerubahan_v3Obj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD PENGADAAN MURNI' > PENGADAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPemeliharaanPerubahan_v3\" title='RKBMD PEMELIHARAAN MURNI'  style='color : blue;' > PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD PENGADAAN MURNI' > PERSEDIAAN </a> 
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>"
	.
	"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=rkbmdPemeliharaanPerubahan_v3\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > INPUT </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaanPerubahan\" title='RKBMD PENGADAAN MURNI' > KOREKSI </a> |
	  ...
	  switch($tipe){
	   ...
	   case 'remove':{				
			...
			for($i = 0 ; $i < sizeof($id) ; $i++ ){
				...
				$p = $getData['p'];
				$q = $getData['q'];
				$get = mysql_query("select * from tabel_anggaran where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and ((id_jenis_pemeliharaan != '0' and f !='00') or uraian_pemeliharaan = 'RKBMD PEMELIHARAAN') and id_anggaran!='$id[$i]' $exceptID ");
...
function Pemeliharaan8($xls =FALSE){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$status_barang = "MILIK";
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' and tahun = '$this->tahun' and no_urut = '5' and jenis_anggaran ='MURNI'  "));
...
function Pemeliharaan9($xls =FALSE){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$getJumlahSemula = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' and tahun = '$this->tahun' and no_urut = '5' and jenis_anggaran ='MURNI' "));
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');
				$getJumlahSetuju = mysql_fetch_array(mysql_query("select * from view_rkbmd where concat(f,'.',g,'.',h,'.',i,'.',j) = '$kodeBarang' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and id_jenis_pemeliharaan = '$id_jenis_pemeliharaan' and tahun = '$this->tahun' and no_urut = '4' and jenis_anggaran ='PERUBAHAN' "));
...
function Pemeliharaan10($xls =FALSE){
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if($q == '0' && $j =='000'){
				...
				$jumlahSemula = number_format($getJumlahSemula['volume_barang'],0,'.',',');
				$getJumlahSetuju = mysql_fetch_array(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk ='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j ='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and no_urut = '4' and jenis_anggaran ='PERUBAHAN' and tahun ='$this->tahun' "));
