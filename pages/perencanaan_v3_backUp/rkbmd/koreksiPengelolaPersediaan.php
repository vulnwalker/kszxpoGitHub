...
class koreksiPengelolaPersediaanObj  extends DaftarObj2{	
	var $Prefix = 'koreksiPengelolaPersediaan';
	...
	var $FormName = 'koreksiPengelolaPersediaanForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	<A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD PERSEDIAAN MURNI'  > PENGADAAN </a> |
	<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI' > PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=koreksiPengelolaPersediaan\" title='RKBMD PERSEDIAAN MURNI' style='color : blue;' > PERSEDIAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 /*if($koreksiPengelolaPersediaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPersediaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPersediaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPersediaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPersediaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanSkpdfmSKPD' and d='$koreksiPengelolaPersediaanSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanSkpdfmSKPD' and d='$koreksiPengelolaPersediaanSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPersediaanSkpdfmUrusan' and c = '$koreksiPengelolaPersediaanSkpdfmSKPD' and d='$koreksiPengelolaPersediaanSkpdfmUNIT' and e = '$koreksiPengelolaPersediaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPersediaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPengelolaPersediaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPersediaan['c1'];
					$parentC = $getParentkoreksiPengelolaPersediaan['c'];
					$parentD = $getParentkoreksiPengelolaPersediaan['d'];
					$parentE = $getParentkoreksiPengelolaPersediaan['e'];
					$parentE1= $getParentkoreksiPengelolaPersediaan['e1'];
					...
					if($cmbJeniskoreksiPengelolaPersediaan == 'PERSEDIAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPersediaan_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPersediaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPersediaan as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentkoreksiPengelolaPersediaan['c1'];
					$parentC = $getParentkoreksiPengelolaPersediaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPersediaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPersediaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPersediaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPersediaannya as $key => $value) { 
				  $$key = $value; 
			} 
			...
			}elseif(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '3' and tahun ='$this->tahun' and jenis_anggaran ='PERUBAHAN' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan'")) != 0){
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPengelolaPersediaannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPengelolaPersediaannya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPersediaan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPersediaan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPersediaan.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){	
	 ...
	 $c1 = $dt['koreksiPengelolaPersediaanSkpdfmUrusan'];
	 $c = $dt['koreksiPengelolaPersediaanSkpdfmSKPD'];
	 $d = $dt['koreksiPengelolaPersediaanSkpdfmUNIT'];
	 $e = $dt['koreksiPengelolaPersediaanSkpdfmSUBUNIT'];
	 $e1 = $dt['koreksiPengelolaPersediaanSkpdfmSEKSI'];
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("koreksiPengelolaPersediaanSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPersediaan' id='cmbJeniskoreksiPengelolaPersediaan' value='PERSEDIAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['koreksiPengelolaPersediaanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPersediaanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPersediaanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPersediaanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPersediaanSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPersediaan = $_REQUEST['cmbJeniskoreksiPengelolaPersediaan'];
		$arrKondisi = array();		
		...
		if($this->jenisForm == "PENYUSUNAN"){
			...
			$jenisTahapSebelumnya = $getJenisTahapSebelumnya['jenis_form_modul'];
				...
				while($rows = mysql_fetch_array($getAllParent)){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c'  and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and q='$q'  and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang "));
					if($cekKegiatan == 0){
						$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p,'.',q) != '$concat'";
						$cekProgram = mysql_num_rows(mysql_query("select * from view_rkbmd where tahun='$this->tahun' and jenis_anggaran ='$this->jenisAnggaran' and no_urut ='$nomorUrutSebelumnya' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p='$p' and f !='00' and id_jenis_pemeliharaan ='0' $this->kondisiBarang"));
						if($cekProgram == 0){
							$concat = $c1.".".$c.".".$d.".".$e.".".$e1.".".$bk.".".$ck.".".$p;
							$arrKondisi[] = "concat(c1,'.',c,'.',d,'.',e,'.',e1,'.',bk,'.',ck,'.',p) != '$concat'";
...
function Persediaan2($xls =FALSE){
	...
	function Persediaan7($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' $this->kondisiBarang ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PERSEDIAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
					}
...
$koreksiPengelolaPersediaan = new koreksiPengelolaPersediaanObj();
...
$koreksiPengelolaPersediaan->jenisForm = $jenisForm;
$koreksiPengelolaPersediaan->nomorUrut = $nomorUrut;
$koreksiPengelolaPersediaan->urutTerakhir = $nomorUrut;
$koreksiPengelolaPersediaan->tahun = $tahun;
$koreksiPengelolaPersediaan->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPersediaan->idTahap = $idTahap;
$koreksiPengelolaPersediaan->username = $_COOKIE['coID'];
$koreksiPengelolaPersediaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPersediaan->wajibValidasi == TRUE){
	$koreksiPengelolaPersediaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPersediaan->sqlValidasi = " ";
}

$koreksiPengelolaPersediaan->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPersediaan->kota = $arrayResult['kota'];
$koreksiPengelolaPersediaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPersediaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPersediaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPersediaan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPersediaan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPersediaan->nipPejabat = $arrayResult['nipPejabat'];
