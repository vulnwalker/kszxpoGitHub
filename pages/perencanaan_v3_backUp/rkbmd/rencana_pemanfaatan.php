...
class rencana_pemanfaatanObj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=rencana_pemanfaatan\" title='RKBMD PEMANFAATAN MURNI' style='color : blue;' > PEMANFAATAN </a> |
	...
	function getDaftarOpsi($Mode=1){
		...
		$fmPILCARI = cekPOST('fmPILCARI');
		$fmPILCARIVALUE = cekPOST('fmPILCARIVALUE');
		/*$fmURUSAN = cekPOST('rencana_pemanfaatanSkpdfmURUSAN');
...
$arrayResult = tahapPerencanaanV3($rencana_pemanfaatan->modul);
...
$rencana_pemanfaatan->jenisForm = $jenisForm;
$rencana_pemanfaatan->nomorUrut = $nomorUrut;
$rencana_pemanfaatan->urutTerakhir = $nomorUrut;
$rencana_pemanfaatan->tahun = $tahun;
$rencana_pemanfaatan->jenisAnggaran = $jenisAnggaran;
$rencana_pemanfaatan->idTahap = $idTahap;
$rencana_pemanfaatan->username = $_COOKIE['coID'];
$rencana_pemanfaatan->wajibValidasi = $arrayResult['wajib_validasi'];
if($rencana_pemanfaatan->wajibValidasi == TRUE){
	$rencana_pemanfaatan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rencana_pemanfaatan->sqlValidasi = " ";
}
$rencana_pemanfaatan->provinsi = $arrayResult['provinsi'];
$rencana_pemanfaatan->kota = $arrayResult['kota'];

$rencana_pemanfaatan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rencana_pemanfaatan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rencana_pemanfaatan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rencana_pemanfaatan->nipPengelola = $arrayResult['nipPengelola'];
$rencana_pemanfaatan->nipPengurus = $arrayResult['nipPengurus'];
$rencana_pemanfaatan->nipPejabat = $arrayResult['nipPejabat'];
