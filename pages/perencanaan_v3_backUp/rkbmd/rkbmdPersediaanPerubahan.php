...
class rkbmdPersediaanPerubahan_v3Obj  extends DaftarObj2{	
	...
	<A href=\"pages.php?Pg=rkbmdPengadaanPerubahan_v3\" title='RKBMD PEMELIHARAAN MURNI' > PENGADAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPemeliharaanPerubahan_v3\" title='RKBMD PEMELIHARAAN MURNI' > PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD PERSEDIAAN MURNI' style='color : blue;' >PERSEDIAAN </a>
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>"
	.
	"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=rkbmdPersediaanPerubahan_v3\" title='RKBMD PERSEDIAAN MURNI' style='color : blue;' > INPUT </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPersediaanPerubahan\" title='RKBMD PERSEDIAAN MURNI' > KOREKSI </a> |
			...
			while($rows = mysql_fetch_array($getAll)){
				foreach ($rows as $key => $value) { 
				 ...
				 if(mysql_num_rows(mysql_query("select * from pindah_rkbmd_v3 where id_anggaran = '$id_anggaran'")) != 0){
					...
					$cekKegiatan = mysql_num_rows(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and bk = '$bk' and ck = '$ck' and p = '$p' and q= '$q' and  f ='00' and id_tahap='$this->idTahap' and uraian_pemeliharaan = 'RKBMD PERSEDIAAN'"));												
					if($cekKegiatan < 1){
						$data = array('jenis_anggaran' => $this->jenisAnggaran,
									  'tahun' => $this->tahun,
									  'c1' => $c1,
