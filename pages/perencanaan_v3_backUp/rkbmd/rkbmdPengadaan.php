...
class rkbmdPengadaan_v3Obj  extends DaftarObj2{	
	var $Prefix = 'rkbmdPengadaan_v3';
	...
	var $FormName = 'rkbmdPengadaan_v3Form'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > PENGADAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPemeliharaan_v3\" title='RKBMD PEMELIHARAAN MURNI' > PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=rkbmdPersediaan_v3\" title='RKBMD PESEDIAAN MURNI' > PERSEDIAAN </a> |
	...
	"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > INPUT </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPengadaan\" title='RKBMD PENGADAAN MURNI' > KOREKSI </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 if($rkbmdPengadaan_v3SkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($rkbmdPengadaan_v3SkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($rkbmdPengadaan_v3SkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($rkbmdPengadaan_v3SkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($rkbmdPengadaan_v3SkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$rkbmdPengadaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPengadaan_v3SkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$rkbmdPengadaan_v3SkpdfmSUBUNIT' and e1='$rkbmdPengadaan_v3SkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $rkbmdPengadaan_v3SkpdfmUrusan;
		     $parentC = $rkbmdPengadaan_v3SkpdfmSKPD;
			 $parentD = $rkbmdPengadaan_v3SkpdfmUNIT;
			 $parentE = $rkbmdPengadaan_v3SkpdfmSUBUNIT;
			 $parentE1= $rkbmdPengadaan_v3SkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$rkbmdPengadaan_v3SkpdfmUrusan' and c = '$rkbmdPengadaan_v3SkpdfmSKPD' and d='$rkbmdPengadaan_v3SkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenisrkbmdPengadaan_v3 == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['rkbmdPengadaan_v3_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentrkbmdPengadaan_v3 = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentrkbmdPengadaan_v3 as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentrkbmdPengadaan_v3['c1'];
					$parentC = $getParentrkbmdPengadaan_v3['c'];
					$parentD = $getParentrkbmdPengadaan_v3['d'];
					$parentE = $getParentrkbmdPengadaan_v3['e'];
					$parentE1= $getParentrkbmdPengadaan_v3['e1'];
					$parentBK = $getParentrkbmdPengadaan_v3['bk'];
					$parentCK = $getParentrkbmdPengadaan_v3['ck'];
					$parentP = $getParentrkbmdPengadaan_v3['p'];
					$parentQ = $getParentrkbmdPengadaan_v3['q'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$rkbmdPengadaan_v3_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$rkbmdPengadaan_v3_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getrkbmdPengadaan_v3nya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getrkbmdPengadaan_v3nya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getrkbmdPengadaan_v3nya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getrkbmdPengadaan_v3nya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/rkbmdPengadaan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaan_v3.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPengadaan_v3.koreksi('$id_anggaran');></img>";
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("rkbmdPengadaan_v3Skpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenisrkbmdPengadaan_v3' id='cmbJenisrkbmdPengadaan_v3' value='PENGADAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['rkbmdPengadaan_v3SkpdfmUrusan'];
		$c    = $_REQUEST['rkbmdPengadaan_v3SkpdfmSKPD'];
		$d    = $_REQUEST['rkbmdPengadaan_v3SkpdfmUNIT'];
		$e    = $_REQUEST['rkbmdPengadaan_v3SkpdfmSUBUNIT'];
		$e1   = $_REQUEST['rkbmdPengadaan_v3SkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisrkbmdPengadaan_v3 = $_REQUEST['cmbJenisrkbmdPengadaan_v3'];
		$arrKondisi = array();		
...
function Pengadaan1($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and p ='$p' and j!='000' $kondisiValid $this->kondisiBarang")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' $kondisiValid $this->kondisiBarang")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and urut !='$c1.$c.$d.$e.$e1.0.0.0.0.0.0.00.00.00.00.000.00' and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' $kondisiValid $this->kondisiBarang")) == 0){
						if($j != '000'){
...
function Pengadaan2($xls =FALSE){
	...
	global $Main;
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' $kondisiValid")) == 0){
				if($p !='0'){
					$concat = $bk.".".$ck.".".$p;
					$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
				}
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d' and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' $kondisiValid")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
					}
	...
	function Pengadaan5($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' ) and bk='$bk' and ck='$ck' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' ")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
					}
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 ='$c1' and c='$c' and d='$d'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
						if($j != '000'){
							$arrKondisi[] = " concat(f,'.',g,'.',h,'.',i,'.',j) !='$concat' ";
						}
					}
	...
	function Pengadaan7($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' ")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
					}
						...
						$concat = $f.".".$g.".".$h.".".$i.".".$j;
					if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and concat(f,'.',g,'.',h,'.',i,'.',j) = '$concat' ")) == 0){
						if($j != '000'){
							$arrKondisi[] = " concat(f,'.',g,'.',h,'.',i,'.',j) !='$concat' ";
						}
					}
...
$rkbmdPengadaan_v3 = new rkbmdPengadaan_v3Obj();
$arrayResult = tahapPerencanaanV3($rkbmdPengadaan_v3->modul,"MURNI");
...
$rkbmdPengadaan_v3->jenisForm = $jenisForm;
$rkbmdPengadaan_v3->nomorUrut = $nomorUrut;
$rkbmdPengadaan_v3->urutTerakhir = $nomorUrut;
$rkbmdPengadaan_v3->tahun = $tahun;
$rkbmdPengadaan_v3->jenisAnggaran = $jenisAnggaran;
$rkbmdPengadaan_v3->idTahap = $idTahap;
$rkbmdPengadaan_v3->username = $_COOKIE['coID'];
$rkbmdPengadaan_v3->wajibValidasi = $arrayResult['wajib_validasi'];
if($rkbmdPengadaan_v3->wajibValidasi == TRUE){
	$rkbmdPengadaan_v3->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rkbmdPengadaan_v3->sqlValidasi = " ";
}
$rkbmdPengadaan_v3->provinsi = $arrayResult['provinsi'];
$rkbmdPengadaan_v3->kota = $arrayResult['kota'];

$rkbmdPengadaan_v3->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rkbmdPengadaan_v3->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rkbmdPengadaan_v3->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rkbmdPengadaan_v3->nipPengelola = $arrayResult['nipPengelola'];
$rkbmdPengadaan_v3->nipPengurus = $arrayResult['nipPengurus'];
$rkbmdPengadaan_v3->nipPejabat = $arrayResult['nipPejabat'];
$rkbmdPengadaan_v3->settingAnggaran = $arrayResult['settingAnggaran'];
