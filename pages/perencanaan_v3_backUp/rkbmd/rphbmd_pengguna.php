...
class rphbmd_penggunaObj  extends DaftarObj2{	
	var $Prefix = 'rphbmd_pengguna';
	...
	var $FormName = 'rphbmd_penggunaForm'; 	
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	var $nomorUrut = "";
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rphbmd_pengguna_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkiba' name='rphbmd_pengguna_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkibb' name='rphbmd_pengguna_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkibc' name='rphbmd_pengguna_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkibd' name='rphbmd_pengguna_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkibe' name='rphbmd_pengguna_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_pengguna_formkibf' name='rphbmd_pengguna_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rphbmd_pengguna' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rphbmd_pengguna' name='det_rphbmd_pengguna' >".$rphbmd_pengguna_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	<A href=\"pages.php?Pg=rphbmd_pengguna\" title='RKBMD PEMANFAATAN MURNI' style='color : blue;' > PENGHAPUSAN </a> |
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>";
	}
...
$rphbmd_pengguna = new rphbmd_penggunaObj();

$arrayResult = tahapPerencanaanV3($rphbmd_pengguna->modul);
...
$rphbmd_pengguna->jenisForm = $jenisForm;
$rphbmd_pengguna->nomorUrut = $nomorUrut;
$rphbmd_pengguna->urutTerakhir = $nomorUrut;
$rphbmd_pengguna->tahun = $tahun;
$rphbmd_pengguna->jenisAnggaran = $jenisAnggaran;
$rphbmd_pengguna->idTahap = $idTahap;
$rphbmd_pengguna->username = $_COOKIE['coID'];
$rphbmd_pengguna->wajibValidasi = $arrayResult['wajib_validasi'];
if($rphbmd_pengguna->wajibValidasi == TRUE){
	$rphbmd_pengguna->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rphbmd_pengguna->sqlValidasi = " ";
}
$rphbmd_pengguna->provinsi = $arrayResult['provinsi'];
$rphbmd_pengguna->kota = $arrayResult['kota'];

$rphbmd_pengguna->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rphbmd_pengguna->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rphbmd_pengguna->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rphbmd_pengguna->nipPengelola = $arrayResult['nipPengelola'];
$rphbmd_pengguna->nipPengurus = $arrayResult['nipPengurus'];
$rphbmd_pengguna->nipPejabat = $arrayResult['nipPejabat'];
