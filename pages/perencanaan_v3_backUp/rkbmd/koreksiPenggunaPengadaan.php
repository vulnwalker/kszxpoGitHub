...
class koreksiPenggunaPengadaanObj  extends DaftarObj2{	
	...
	"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=rkbmdPengadaan_v3\" title='RKBMD PENGADAAN MURNI'  > INPUT </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPengadaan\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > KOREKSI </a> |
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPenggunaPengadaanSkpdfmUrusan' and c = '$koreksiPenggunaPengadaanSkpdfmSKPD' and d='$koreksiPenggunaPengadaanSkpdfmUNIT' and e = '$koreksiPenggunaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPenggunaPengadaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPenggunaPengadaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			...
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
					...
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPenggunaPengadaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPenggunaPengadaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPenggunaPengadaan_idplh'");
			 mysql_query($query);
