...
class koreksiPengelolaPengadaanObj  extends DaftarObj2{	
	var $Prefix = 'koreksiPengelolaPengadaan';
	...
	var $FormName = 'koreksiPengelolaPengadaanForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	<A href=\"pages.php?Pg=koreksiPengelolaPengadaan\" title='RKBMD PENGADAAN MURNI' style='color : blue;' > PENGADAAN </a> |
	<A href=\"pages.php?Pg=koreksiPengelolaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI' > PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=koreksiPengelolaPersediaan\" title='RKBMD PERSEDIAAN MURNI' > PERSEDIAAN </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 /*if($koreksiPengelolaPengadaanSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($koreksiPengelolaPengadaanSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($koreksiPengelolaPengadaanSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($koreksiPengelolaPengadaanSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($koreksiPengelolaPengadaanSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{*/
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$koreksiPengelolaPengadaanSkpdfmUrusan' and c = '$koreksiPengelolaPengadaanSkpdfmSKPD' and d='$koreksiPengelolaPengadaanSkpdfmUNIT' and e = '$koreksiPengelolaPengadaanSkpdfmSUBUNIT' and e1='$koreksiPengelolaPengadaanSkpdfmSEKSI' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentkoreksiPengelolaPengadaan = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
					$parentC1 = $getParentkoreksiPengelolaPengadaan['c1'];
					$parentC = $getParentkoreksiPengelolaPengadaan['c'];
					$parentD = $getParentkoreksiPengelolaPengadaan['d'];
					$parentE = $getParentkoreksiPengelolaPengadaan['e'];
					$parentE1= $getParentkoreksiPengelolaPengadaan['e1'];
					...
					if($cmbJeniskoreksiPengelolaPengadaan == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['koreksiPengelolaPengadaan_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentkoreksiPengelolaPengadaan = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentkoreksiPengelolaPengadaan as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentkoreksiPengelolaPengadaan['c1'];
					$parentC = $getParentkoreksiPengelolaPengadaan['c'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$koreksiPengelolaPengadaan_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$koreksiPengelolaPengadaan_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getkoreksiPengelolaPengadaannya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getkoreksiPengelolaPengadaannya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $getkoreksiPengelolaPengadaannya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getkoreksiPengelolaPengadaannya['volume_barang'] < $angkaKoreksi){
	   ...
	   if($this->jenisForm == "KOREKSI"){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/koreksiPengelolaPengadaan.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPengadaan.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=koreksiPengelolaPengadaan.koreksi('$id_anggaran');></img>";
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("koreksiPengelolaPengadaanSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJeniskoreksiPengelolaPengadaan' id='cmbJeniskoreksiPengelolaPengadaan' value='PENGADAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['koreksiPengelolaPengadaanSkpdfmUrusan'];
		$c    = $_REQUEST['koreksiPengelolaPengadaanSkpdfmSKPD'];
		$d    = $_REQUEST['koreksiPengelolaPengadaanSkpdfmUNIT'];
		$e    = $_REQUEST['koreksiPengelolaPengadaanSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['koreksiPengelolaPengadaanSkpdfmSEKSI'];
		if(isset($e1)){
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJeniskoreksiPengelolaPengadaan = $_REQUEST['cmbJeniskoreksiPengelolaPengadaan'];
		$arrKondisi = array();		
...
function Pengadaan2($xls =FALSE){
	...
	function Pengadaan7($xls =FALSE){
		...
		while($rows = mysql_fetch_array($grabProgram)){
			...
			if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'  and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and j!='000' $this->kondisiBarang ")) == 0){
				$concat = $bk.".".$ck.".".$p;
				$arrKondisi[] = " concat(bk,'.',ck,'.',p) !='$concat'";
			}else{
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '$lastNomorUrut' and jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun'   and (uraian_pemeliharaan ='' or uraian_pemeliharaan ='RKBMD PENGADAAN' )  and bk='$bk' and ck='$ck' and p ='$p' and q='$q' and j!='000' $this->kondisiBarang")) == 0){
					if($q != '0'){
						$concat = $bk.".".$ck.".".$p.".".$q;
						$arrKondisi[] = " concat(bk,'.',ck,'.',p,'.',q) !='$concat'";
					}
...
$koreksiPengelolaPengadaan = new koreksiPengelolaPengadaanObj();
...
$koreksiPengelolaPengadaan->jenisForm = $jenisForm;
$koreksiPengelolaPengadaan->nomorUrut = $nomorUrut;
$koreksiPengelolaPengadaan->urutTerakhir = $nomorUrut;
$koreksiPengelolaPengadaan->tahun = $tahun;
$koreksiPengelolaPengadaan->jenisAnggaran = $jenisAnggaran;
$koreksiPengelolaPengadaan->idTahap = $idTahap;
$koreksiPengelolaPengadaan->username = $_COOKIE['coID'];
$koreksiPengelolaPengadaan->wajibValidasi = $arrayResult['wajib_validasi'];
if($koreksiPengelolaPengadaan->wajibValidasi == TRUE){
	$koreksiPengelolaPengadaan->sqlValidasi = " and status_validasi ='1' ";
}else{
	$koreksiPengelolaPengadaan->sqlValidasi = " ";
}

$koreksiPengelolaPengadaan->provinsi = $arrayResult['provinsi'];
$koreksiPengelolaPengadaan->kota = $arrayResult['kota'];
$koreksiPengelolaPengadaan->pengelolaBarang = $arrayResult['pengelolaBarang'];
$koreksiPengelolaPengadaan->pejabatPengelolaBarang = $arrayResult['pejabat'];
$koreksiPengelolaPengadaan->pengurusPengelolaBarang = $arrayResult['pengurus'];
$koreksiPengelolaPengadaan->nipPengelola = $arrayResult['nipPengelola'];
$koreksiPengelolaPengadaan->nipPengurus = $arrayResult['nipPengurus'];
$koreksiPengelolaPengadaan->nipPejabat = $arrayResult['nipPejabat'];
