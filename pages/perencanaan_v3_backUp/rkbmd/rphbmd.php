...
class rphbmdObj  extends DaftarObj2{	
	var $Prefix = 'rphbmd';
	...
	function setForm($dt){	
	 ...
	 $this->form_width = $sw-50;
	  ...
	  if ($this->form_fmST==0) {
		...
		$rphbmd_formdet = "<table style='width:100%' >".$this->setForm_content_fields()."</table>";
		 ...
		 *****************************************************************/
		  $this->form_fields = array(
			...
			'fmkiba' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkiba' name='rphbmd_formkiba' $fmkibavisible>".$formKIBA."</div>",
				'type'=>'merge'
				),
			'fmkibb' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkibb' name='rphbmd_formkibb' $fmkibbvisible>".$formKIBB."</div>",
				'type'=>'merge'
				),
			'fmkibc' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkibc' name='rphbmd_formkibc' $fmkibcvisible>".$formKIBC."</div>",
				'type'=>'merge'
				),
			'fmkibd' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkibd' name='rphbmd_formkibd' $fmkibdvisible>".$formKIBD."</div>",
				'type'=>'merge'
				),
			'fmkibe' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkibe' name='rphbmd_formkibe' $fmkibevisible>".$formKIBE."</div>",
				'type'=>'merge'
				),
			'fmkibf' => array(
				'label'=> '',
				'value'=> "<div id='rphbmd_formkibf' name='rphbmd_formkibf' $fmkibfvisible>".$formKIBF."</div>",
				'type'=>'merge'
				),
			'det_rphbmd' => array(
				'label'=> '',
				'labelWidth'=>150,
				'value'=> "<div id='det_rphbmd' name='det_rphbmd' >".$rphbmd_formdet."</div>",
				'type'=>'merge'
			),
			);
		//tombol
	...
	<A href=\"pages.php?Pg=rkbmdPersediaan_v3\" title='RKBMD PERSEDIAAN MURNI' > PERSEDIAAN </a> |
	<A href=\"pages.php?Pg=rencana_pemanfaatan\" title='RKBMD PEMANFAATAN MURNI' >  PEMANFAATAN </a> |
	<A href=\"pages.php?Pg=rpebmd\" title='RKBMD PEMANFAATAN MURNI'  > PEMINDAHTANGANAN </a> |
	<A href=\"pages.php?Pg=rphbmd\" title='RKBMD PEMANFAATAN MURNI' style='color : blue;' > PENGHAPUSAN </a> 
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>";
	}
...
$rphbmd = new rphbmdObj();

$arrayResult = tahapPerencanaanV3($rphbmd->modul);
...
$rphbmd->jenisForm = $jenisForm;
$rphbmd->nomorUrut = $nomorUrut;
$rphbmd->urutTerakhir = $nomorUrut;
$rphbmd->tahun = $tahun;
$rphbmd->jenisAnggaran = $jenisAnggaran;
$rphbmd->idTahap = $idTahap;
$rphbmd->username = $_COOKIE['coID'];
$rphbmd->wajibValidasi = $arrayResult['wajib_validasi'];
if($rphbmd->wajibValidasi == TRUE){
	$rphbmd->sqlValidasi = " and status_validasi ='1' ";
}else{
	$rphbmd->sqlValidasi = " ";
}
$rphbmd->provinsi = $arrayResult['provinsi'];
$rphbmd->kota = $arrayResult['kota'];

$rphbmd->pengelolaBarang = $arrayResult['pengelolaBarang'];
$rphbmd->pejabatPengelolaBarang = $arrayResult['pejabat'];
$rphbmd->pengurusPengelolaBarang = $arrayResult['pengurus'];
$rphbmd->nipPengelola = $arrayResult['nipPengelola'];
$rphbmd->nipPengurus = $arrayResult['nipPengurus'];
$rphbmd->nipPejabat = $arrayResult['nipPejabat'];
