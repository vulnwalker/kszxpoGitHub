<?php
class pengadaanPengguna_insObj  extends DaftarObj2{	
	var $Prefix = 'pengadaanPengguna_ins';
	...
	var $FormName = 'pengadaanPengguna_insForm';
	var $noModul=14; 
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'finish':{				
			...
			mysql_query("delete from tabel_anggaran where c1='$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk='$bk' and ck='$ck' and p='$p' and q='$q' and tahun='$this->tahun' and id_tahap ='$this->idTahap' and ((id_jenis_pemeliharaan = '0' and f !='00') or uraian_pemeliharaan = 'RKBMD PENGADAAN') and status_validasi !='1' $exceptID ");
			$cekSKPD = mysql_num_rows(mysql_query("select * from view_rkbmd where c1='$c1' and c='$c' and d='$d' and e='00' and e1='000' and bk = '0' and ck = '0' and p = '0' and q= '0' and id_tahap='$this->idTahap'"));
			if($cekSKPD < 1){
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaan_v3/rkbmd/pengadaanPengguna_ins.js' language='JavaScript' ></script>".
	...
	$aksi  = "<img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=pengadaanPengguna_ins.hapus('$id');></img>&nbsp &nbsp <img src='images/administrator/images/edit_f2.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=pengadaanPengguna_ins.edit('$id');></img> ";
	...
	$cmbKegiatan = cmbQuery('q', $selecteQ, $codeAndNameKegiatan,' onchange=pengadaanPengguna_ins.CekAda(); ','-- KEGIATAN --');  
					...
					$this->isiform(
						array(
							...
							array( 
								...
								<input type='button' value='Cari' id='findProgram' onclick ='pengadaanPengguna_ins.CariProgram($ID_RENJA)'  title='Cari Program dan Kegiatan' $disabledCariProgram >"				
							),
							array( 
								'label'=>'KEGIATAN',
								'label-width'=>'200px;',
			...
			genFilterBar(
						...
						array(
							...
							array(
									...
									'value'=>"<input type='text' name='kodeBarang' onkeyup='cariBarang.pilBar2(this.value)' id='kodeBarang' placeholder='KODE BARANG' style='width:150px;' value='".$dt['kodebarangnya']."' readonly /> 
										...
										<input type='button' id='findBarang' value='CARI' onclick='pengadaanPengguna_ins.CariBarang();'/>
									",
								),
							array(
									'label'=>'JUMLAH',
				...
				genFilterBar(
					...
					<td class='border:none'> 
						<a class='toolbar' id='btsave' href='javascript:pengadaanPengguna_ins.$tujuan'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='btcancel' href='javascript:pengadaanPengguna_ins.closeTab()'> 
					...
					<tbody><tr valign='middle' align='center'> 
					<td class='border:none'> 
						<a class='toolbar' id='finish' href='javascript:pengadaanPengguna_ins.finish()'> 
...
$pengadaanPengguna_ins = new pengadaanPengguna_insObj();

$arrayResult = tahapPerencanaanV3($pengadaanPengguna_ins->modul,"MURNI");
...
$pengadaanPengguna_ins->jenisForm = $jenisForm;
$pengadaanPengguna_ins->nomorUrut = $nomorUrut;
$pengadaanPengguna_ins->urutTerakhir = $nomorUrut;
$pengadaanPengguna_ins->tahun = $tahun;
$pengadaanPengguna_ins->jenisAnggaran = $jenisAnggaran;
$pengadaanPengguna_ins->idTahap = $idTahap;
$pengadaanPengguna_ins->username = $_COOKIE['coID'];
$pengadaanPengguna_ins->wajibValidasi = $Main->wajibValidasi;
if($pengadaanPengguna_ins->wajibValidasi == TRUE){
	$pengadaanPengguna_ins->sqlValidasi = " and status_validasi ='1' ";
}else{
	$pengadaanPengguna_ins->sqlValidasi = " ";
}
