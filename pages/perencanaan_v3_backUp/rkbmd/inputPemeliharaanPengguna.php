...
class inputPemeliharaanPenggunaObj  extends DaftarObj2{	
	var $Prefix = 'inputPemeliharaanPengguna';
	...
	var $FormName = 'inputPemeliharaanPenggunaForm'; 	
	var $kode_skpd = '';
	var $modul = "RKBMD";
	var $jenisForm = "";
	var $tahun = "";
	...
	function setMenuEdit(){
			if ($this->jenisForm == "PENYUSUNAN"){
				...
				if(mysql_num_rows(mysql_query("select * from view_rkbmd where no_urut = '6' and tahun ='$this->tahun' and jenis_anggaran = 'PERUBAHAN' ")) != 0){
					$listMenu = 
	...
	<A href=\"pages.php?Pg=koreksiPenggunaPengadaan\" title='RKBMD PENGADAAN MURNI'  > PENGADAAN </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI'  style='color : blue;'> PEMELIHARAAN </a> |
	<A href=\"pages.php?Pg=rencana_pemanfaatan_pengguna\" title='RKBMD PEMANFAATAN MURNI' >  PEMANFAATAN </a> |
	<A href=\"pages.php?Pg=rpebmd_pengguna\" title='RKBMD PEMANFAATAN MURNI'  > PEMINDAH TANGANAN </a> |
	<A href=\"pages.php?Pg=rphbmd_pengguna\" title='RKBMD PEMANFAATAN MURNI'  > PENGHAPUSAN </a> |
	&nbsp&nbsp&nbsp	
	</td></tr>
	</table>
	...
	<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
	<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
	<A href=\"pages.php?Pg=inputPemeliharaanPengguna\" title='RKBMD PENGADAAN MURNI'  style='color : blue;'  > INPUT </a> |
	<A href=\"pages.php?Pg=koreksiPenggunaPemeliharaan\" title='RKBMD PEMELIHARAAN MURNI'  > KOREKSI </a> |
	  ...
	  switch($tipe){
		...
		case 'Laporan':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 if($inputPemeliharaanPenggunaSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($inputPemeliharaanPenggunaSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($inputPemeliharaanPenggunaSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($inputPemeliharaanPenggunaSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($inputPemeliharaanPenggunaSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$inputPemeliharaanPenggunaSkpdfmUrusan' and c = '$inputPemeliharaanPenggunaSkpdfmSKPD' and d='$inputPemeliharaanPenggunaSkpdfmUNIT' and e = '$inputPemeliharaanPenggunaSkpdfmSUBUNIT' and e1='$inputPemeliharaanPenggunaSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$inputPemeliharaanPenggunaSkpdfmUrusan' and c = '$inputPemeliharaanPenggunaSkpdfmSKPD' and d='$inputPemeliharaanPenggunaSkpdfmUNIT' and e = '$inputPemeliharaanPenggunaSkpdfmSUBUNIT' and e1='$inputPemeliharaanPenggunaSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $inputPemeliharaanPenggunaSkpdfmUrusan;
		     $parentC = $inputPemeliharaanPenggunaSkpdfmSKPD;
			 $parentD = $inputPemeliharaanPenggunaSkpdfmUNIT;
			 $parentE = $inputPemeliharaanPenggunaSkpdfmSUBUNIT;
			 $parentE1= $inputPemeliharaanPenggunaSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$inputPemeliharaanPenggunaSkpdfmUrusan' and c = '$inputPemeliharaanPenggunaSkpdfmSKPD' and d='$inputPemeliharaanPenggunaSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));		
				 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$inputPemeliharaanPenggunaSkpdfmUrusan' and c = '$inputPemeliharaanPenggunaSkpdfmSKPD' and d='$inputPemeliharaanPenggunaSkpdfmUNIT' and e = '00' and e1='000' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
				 $lastID = $getDatarenja['id_anggaran'];
				 $parentE = '00';
			 	 $parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' && $this->wajibValidasi == TRUE ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$inputPemeliharaanPenggunaSkpdfmUrusan' and c = '$inputPemeliharaanPenggunaSkpdfmSKPD' and d='$inputPemeliharaanPenggunaSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
						if($getJumlahRenjaValidasi == 0){
							$err = "Renja Belum Di Validasi";
						}
					}
					
					$getParentinputPemeliharaanPengguna = mysql_fetch_array(mysql_query("select * from view_renja where id_anggaran = '$lastID'"));
		...
		case 'editTab':{
			 $id = $_REQUEST['inputPemeliharaanPengguna_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParentinputPemeliharaanPengguna = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParentinputPemeliharaanPengguna as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParentinputPemeliharaanPengguna['c1'];
					$parentC = $getParentinputPemeliharaanPengguna['c'];
					$parentD = $getParentinputPemeliharaanPengguna['d'];
					$parentE = $getParentinputPemeliharaanPengguna['e'];
					$parentE1= $getParentinputPemeliharaanPengguna['e1'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$inputPemeliharaanPengguna_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$inputPemeliharaanPengguna_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$getinputPemeliharaanPenggunanya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($getinputPemeliharaanPenggunanya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and  f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if( $getinputPemeliharaanPenggunanya['volume_barang'] >= $angkaKoreksi ) {
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($getinputPemeliharaanPenggunanya['volume_barang'] < $angkaKoreksi){
	...
	function setPage_OtherScript(){
		...
		return 
			...
			<script type='text/javascript' src='js/skpd.js' language='JavaScript' ></script>".		
			 "<script type='text/javascript' src='js/perencanaan_v3/rkbmd/inputPemeliharaanPengguna.js' language='JavaScript' ></script>".			
			$scriptload;
	}
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
				if($f == '00' && $q =='0')$TampilCheckBox = "";
					...
					$Koloms.= "<td class='$cssclass' align='left'></td>";
					 ...
					 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=inputPemeliharaanPengguna.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=inputPemeliharaanPengguna.koreksi('$id_anggaran');></img> ";
	...
	//data order ------------------------------
	 ...
	 $selectedC1 = $_REQUEST[$this->Prefix.'SkpdfmUrusan'];
	$selectedC  = $_REQUEST[$this->Prefix.'SkpdfmSKPD'];
	$selectedD = $_REQUEST[$this->Prefix.'SkpdfmUNIT'];
	...
	foreach ($_COOKIE as $key => $value) { 
		...
		$urusan = cmbQuery($this->Prefix.'SkpdfmUrusan',$selectedC1,$codeAndNameUrusan,"onchange=$this->Prefix.refreshList(true);",'-- URUSAN --',"0");
		
		$codeAndNameBidang = "select c, concat(c, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c !='00' and d='00' and e='00' and e1='000' ";
		$bidang = cmbQuery($this->Prefix.'SkpdfmSKPD',$selectedC,$codeAndNameBidang,"onchange=$this->Prefix.refreshList(true);",'-- BIDANG --',"00");
		
		$codeAndNameSKPD = "select d, concat(d, '. ', nm_skpd) from ref_skpd where c1='$selectedC1' and c='$selectedC' and d!='00' and e='00' and e1='000' ";
		$skpd= cmbQuery($this->Prefix.'SkpdfmUNIT',$selectedD,$codeAndNameSKPD,"onchange=$this->Prefix.refreshList(true);",'-- SKPD --',"00");
	...
	$TampilOpt = 
			...
			<input type='hidden' name='cmbJenisinputPemeliharaanPengguna' id='cmbJenisinputPemeliharaanPengguna' value='PEMELIHARAAN'>	
			</table>".
			"</div>"
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['inputPemeliharaanPenggunaSkpdfmUrusan'];
		$c    = $_REQUEST['inputPemeliharaanPenggunaSkpdfmSKPD'];
		$d    = $_REQUEST['inputPemeliharaanPenggunaSkpdfmUNIT'];
		$e    = $_REQUEST['inputPemeliharaanPenggunaSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['inputPemeliharaanPenggunaSkpdfmSEKSI'];	
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenisinputPemeliharaanPengguna = $_REQUEST['cmbJenisinputPemeliharaanPengguna'];
		$arrKondisi = array();	
	...
	function Laporan($dt){	
	 ...
	 $c1 = $dt['inputPemeliharaanPenggunaSkpdfmUrusan'];
	 $c = $dt['inputPemeliharaanPenggunaSkpdfmSKPD'];
	 $d = $dt['inputPemeliharaanPenggunaSkpdfmUNIT'];
	 $e = $dt['inputPemeliharaanPenggunaSkpdfmSUBUNIT'];
	 $e1 = $dt['inputPemeliharaanPenggunaSkpdfmSEKSI'];
...
$inputPemeliharaanPengguna = new inputPemeliharaanPenggunaObj();
$arrayResult = tahapPerencanaanV3($inputPemeliharaanPengguna->modul,"MURNI");
...
$inputPemeliharaanPengguna->jenisForm = $jenisForm;
$inputPemeliharaanPengguna->nomorUrut = $nomorUrut;
$inputPemeliharaanPengguna->urutTerakhir = $nomorUrut;
$inputPemeliharaanPengguna->tahun = $tahun;
$inputPemeliharaanPengguna->jenisAnggaran = $jenisAnggaran;
$inputPemeliharaanPengguna->idTahap = $idTahap;
$inputPemeliharaanPengguna->username = $_COOKIE['coID'];
$inputPemeliharaanPengguna->wajibValidasi =  $arrayResult['wajib_validasi'];
if($inputPemeliharaanPengguna->wajibValidasi == TRUE){
	$inputPemeliharaanPengguna->sqlValidasi = " and status_validasi ='1' ";
}else{
	$inputPemeliharaanPengguna->sqlValidasi = " ";
}

$inputPemeliharaanPengguna->provinsi = $arrayResult['provinsi'];
$inputPemeliharaanPengguna->kota = $arrayResult['kota'];
$inputPemeliharaanPengguna->pengelolaBarang = $arrayResult['pengelolaBarang'];
$inputPemeliharaanPengguna->pejabatPengelolaBarang = $arrayResult['pejabat'];
$inputPemeliharaanPengguna->pengurusPengelolaBarang = $arrayResult['pengurus'];
$inputPemeliharaanPengguna->nipPengelola = $arrayResult['nipPengelola'];
$inputPemeliharaanPengguna->nipPengurus = $arrayResult['nipPengurus'];
$inputPemeliharaanPengguna->nipPejabat = $arrayResult['nipPejabat'];
