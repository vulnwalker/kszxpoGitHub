...
class popupBarangRKBMD_v2Obj  extends DaftarObj2{	
	var $Prefix = 'popupBarangRKBMD_v2';
	...
	var $FormName = 'popupBarangRKBMD_v2Form'; 	
...
/*			'' => array( 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($isi['j'] == '000'){
 	 ...
 	 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarangRKBMD_v2.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
$popupBarangRKBMD_v2 = new popupBarangRKBMD_v2Obj();
