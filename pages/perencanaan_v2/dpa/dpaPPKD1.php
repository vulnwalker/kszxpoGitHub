...
class dpaPPKD1_v2Obj  extends DaftarObj2{	
	...
	$getJumlahBarang = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$dpaPPKD1_v2_idplh'"));
...
if(empty($dpaPPKD1_v2->tahun)){
	...
	$getCurrenttahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$dpaPPKD1_v2->idTahap'"));
	$dpaPPKD1_v2->currentTahap = $getCurrenttahap['nama_tahap'];
	
	$namaTahap = mysql_fetch_array(mysql_query("select * from ref_tahap_anggaran where id_tahap = '$dpaPPKD1_v2->idTahap'"));
