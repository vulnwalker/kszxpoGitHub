...
class rekapdpbObj  extends DaftarObj2{	
	var $Prefix = 'rekapdpb';
	var $elCurrPage="HalDefault";
	var $SHOW_CEK = TRUE;
	var $TblName = 'pengadaan'; //daftar
	...
	//var $pagePerHal ='100';
	var $cetak_xls=TRUE;
	var $fileNameExcel='rekapdpb.xls';
	var $Cetak_Judul = 'Rekap Hasil Pengadaan Barang';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rekapdpbForm'; 	
	...
	function setNavAtas(){
		...
		return
			...
			<td class="menudottedline" width="60%" height="20" style="text-align:right"><b>
				<a href="pages.php?Pg=dpb_rencana" title="Daftar Pengadaan milik Daerah">Rencana</a> |				
				<a  href="pages.php?Pg=dpb_spk" title="Daftar Pengadaan Barang Milik Daerah SPK">SPK</a>  |  
				<a href="pages.php?Pg=dpb" title="Daftar Pengadaan milik Daerah">pengadaan</a>  |
				<a style="color:blue;" href="pages.php?Pg=rekapdpb" title="Rekap Pengadaan milik Daerah">Rekap</a>  |  
				<a href="pages.php?Pg=rekapdpb_skpd" title="Rekap Pengadaan milik Daerah">Rekap (SKPD)</a> '.
					$persediaan.
				  '&nbsp;&nbsp;&nbsp;
			</b></td>
			</tr>
	...
	function setDaftar_query($Kondisi='', $Order='', $Limit=''){
		...
		if($semester==1){
			$KondSemester="and MONTH(spk_tgl)>=1 and MONTH(spk_tgl)<7";
		}elseif($semester==2){
			$KondSemester="and MONTH(spk_tgl)>=7 and MONTH(spk_tgl)<=12";
		}
		if(!empty($fmThnAnggaran)){
			if($Kondisi==''){
				 $KondTahunPengadaan = "WHERE YEAR(spk_tgl)='$fmThnAnggaran'";								
				 $KondTahunDPB = "WHERE tahun='$fmThnAnggaran'";	
			}else{
				 $KondTahunPengadaan = "AND YEAR(spk_tgl)='$fmThnAnggaran'";								
				 $KondTahunDPB = "AND tahun='$fmThnAnggaran'";				}			
		}
...
//		if( $fmBerdasarkan == 2 ) $arrKondisi[] = " concat(ka, '.', kb, '.', kc, '.', kd, '.', ke) like '$kdakun%' ";	
		...
		switch($fmLevel){
			case '1' : {
				...
				$KondJoinBarangPengadaan='aa.f=bb.f';
				$KondJoinBarangDKB='aa.f=cc.f';				 
				$KondJoinAkunPengadaan='aa.ka=bb.k';
				$KondJoinAkunDKB='aa.ka=cc.k';
				$GroupbyBarang='f'; 
				$GroupbyAkun='k'; 
				break;
			} 
			case '2' : {
				...
				$KondJoinBarangPengadaan='aa.f=bb.f and aa.g=bb.g';
				$KondJoinBarangDKB='aa.f=cc.f and aa.g=cc.g';						 
				$KondJoinAkunPengadaan='aa.ka=bb.k and aa.kb=bb.l';
				$KondJoinAkunDKB='aa.ka=cc.k and aa.kb=cc.l';
				$GroupbyBarang='f,g'; 
				$GroupbyAkun='k,l'; 
				break;
			}
			case '3' : {
				...
				$KondJoinBarangPengadaan='aa.f=bb.f and aa.g=bb.g and aa.h=bb.h'; 
				$KondJoinBarangDKB='aa.f=cc.f and aa.g=cc.g and aa.h=cc.h'; 
				$KondJoinAkunPengadaan='aa.ka=bb.k and aa.kb=bb.l and aa.kc=bb.m';
				$KondJoinAkunDKB='aa.ka=cc.k and aa.kb=cc.l and aa.kc=cc.m';
				$GroupbyBarang='f,g,h'; 
				$GroupbyAkun='k,l,m'; 
				break;
			} 
			case '4' : {
				...
				$KondJoinBarangPengadaan='aa.f=bb.f and aa.g=bb.g and aa.h=bb.h and aa.i=bb.i'; 
				$KondJoinBarangDKB='aa.f=cc.f and aa.g=cc.g and aa.h=cc.h and aa.i=cc.i';
				$KondJoinAkunPengadaan='aa.ka=bb.k and aa.kb=bb.l and aa.kc=bb.m and aa.kd=bb.n';
				$KondJoinAkunDKB='aa.ka=cc.k and aa.kb=cc.l and aa.kc=cc.m and aa.kd=cc.n';				
			...
			default: case '5' : {
				...
				$KondJoinBarangPengadaan='aa.f=bb.f and aa.g=bb.g and aa.h=bb.h and aa.i=bb.i and aa.j=bb.j';
				$KondJoinBarangDKB='aa.f=cc.f and aa.g=cc.g and aa.h=cc.h and aa.i=cc.i and aa.j=cc.j';				 
				$KondJoinAkunPengadaan='aa.ka=bb.k and aa.kb=bb.l and aa.kc=bb.m and aa.kd=bb.n and aa.ke=bb.o';
				$KondJoinAkunDKB='aa.ka=cc.k and aa.kb=cc.l and aa.kc=cc.m and aa.kd=cc.n and aa.ke=cc.o';				
...
//ifNULL(bb.tahun,'0000') as tahun
					...
					"LEFT JOIN ".
						...
						"sum(jml_harga) as realisasi, ket, tahun ".
						//"from pengadaan ". 
						"from v1_pengadaan ". 
						"$Kondisi $KondTahunPengadaan $KondSemester ".
						"group by $GroupbyAkun ) as bb ".
					"on $KondJoinAkunPengadaan ".
					"LEFT JOIN ".
						"(select c,d,ifNULL(k,'ftot') as k, ifNULL(l,'0') as l, ifNULL(m,'0') as m, ifNULL(n,'0') as n, ifNULL(o,'0') as o, ".
						"sum(jml_harga) as rencana, ket, tahun ".
						"from dkb ". 
						"$Kondisi $KondTahunDPB ".
						"group by $GroupbyAkun ) as cc ".
					"on $KondJoinAkunDKB) where aa.ka not in ('ftot') $kondLevelAkun $Limit";
		}else{
...
//ifNULL(bb.tahun,'0000') as tahun
				...
				"Left Join ".
					...
					"ifNULL(i,'00') AS i,ifNULL(j,'000') AS j, sum(jml_harga) as realisasi , ket, tahun ".
					//"from pengadaan ".
					"from v1_pengadaan ". 
					"$Kondisi $KondTahunPengadaan $KondSemester ".
					"group by $GroupbyBarang with ROLLUP) as bb ".
				"On $KondJoinBarangPengadaan ".
				"Left Join ".
					"(select c,d,ifNULL(f,'ftot') AS f, ifNULL(g,'00') AS g,ifNULL(h,'00') AS h, ". 
					"ifNULL(i,'00') AS i,ifNULL(j,'000') AS j, sum(jml_harga) as rencana , ket, tahun ".
					"from dkb ". 
					"$Kondisi $KondTahunDPB ".
					"group by $GroupbyBarang with ROLLUP) as cc ".
				"On $KondJoinBarangDKB)	 where aa.f not in ('ftot') $kondLevelBarang $Limit ";		
		...
		switch($fmLevel){
			case '1':case '2':case '3':default:{
				if($kode1!=0  && $kode2!=0 && $kode3==0){
					...
					$qh=mysql_fetch_array(mysql_query("select sum(rencana) as rencana, sum(realisasi) as realisasi, sum(selisih) as selisih  
														from
															(SELECT 0 as rencana, jml_harga as realisasi,(0-jml_harga) as selisih from pengadaan WHERE k='$kode1' and l='$kode2' and YEAR(spk_tgl)='$fmThnAnggaran' $KondThnAkun $KondSKPD $KondSemester
															UNION
															select jml_harga as rencana, 0 as realisasi,(jml_harga-0) as selisih from dkb WHERE k='$kode1' and l='$kode2' and tahun='$fmThnAnggaran' $KondThnAkun $KondSKPD) 
														as aa"));
			...
			case '4':{
				if($kode1!=0  && $kode2!=0 && $kode3==0){
					...
					$qh=mysql_fetch_array(mysql_query("select sum(rencana) as rencana, sum(realisasi) as realisasi, sum(selisih) as selisih  
														from
															(SELECT 0 as rencana, jml_harga as realisasi,(0-jml_harga) as selisih from pengadaan WHERE k='$kode1' and l='$kode2' and m='$kode3' and YEAR(spk_tgl)='$fmThnAnggaran' $KondThnAkun $KondSKPD $KondSemester
															UNION
															select jml_harga as rencana, 0 as realisasi,(jml_harga-0) as selisih from dkb WHERE k='$kode1' and l='$kode2' and m='$kode3' and tahun='$fmThnAnggaran' $KondThnAkun $KondSKPD) 
														as aa"));
					$realisasi=$qh['realisasi'];	
					$rencana=$qh['rencana'];		
					$selisih=$qh['selisih'];	
			...
			case '5':{
				if($kode1!=0  && $kode2!=0 && $kode3==0){
					...
					$qh=mysql_fetch_array(mysql_query("select sum(rencana) as rencana, sum(realisasi) as realisasi, sum(selisih) as selisih  
														from
															(SELECT 0 as rencana, jml_harga as realisasi,(0-jml_harga) as selisih from pengadaan WHERE k='$kode1' and l='$kode2' and m='$kode3' and n='$kode4' and YEAR(spk_tgl)='$fmThnAnggaran' $KondThnAkun $KondSKPD $KondSemester
															UNION
															select jml_harga as rencana, 0 as realisasi,(jml_harga-0) as selisih from dkb WHERE k='$kode1' and l='$kode2' and m='$kode3' and n='$kode4' and tahun='$fmThnAnggaran' $KondThnAkun $KondSKPD) 
														as aa"));
					$realisasi=$qh['realisasi'];	
					$rencana=$qh['rencana'];			
					$selisih=$qh['selisih'];	
		...
		if($berdasarkan==2){
			return "select $fsum
					...
					LEFT JOIN
						 ...
						 $Kondisi $KondTahunDPB 
						 group by $GroupbyAkun) as cc
					on $KondJoinAkunDKB) where aa.ka not in ('ftot') $kondLevelAkun";
		}else{
			return "select $fsum
				from (
					((select f,g,h,i,j,nm_barang from ref_barang)
				...
				Left Join
					...
					$Kondisi $KondTahunDPB 
					group by $GroupbyBarang with ROLLUP) as cc
				On $KondJoinBarangDKB) where aa.f not in ('ftot') $kondLevelBarang";		
		}
	}
	
	function setSumHal2_query($Kondisi, $fsum){
		$kdakun = $_REQUEST['kdakun'];
		$kdakun = array_map('utf8_encode', $kdakun);
		$berdasarkan=$_REQUEST['fmBerdasarkan'];		
		$fmThnAnggaran = $_REQUEST['fmThnAnggaran']; 		
		$semester=$_REQUEST['fmSemester'];
		if($semester==1){
		...
		if($berdasarkan==2){
			return "select $fsum 
					from
						(SELECT id, 0 as rencana, jml_harga as realisasi,(0-jml_harga) as selisih from v1_pengadaan $Kondisi $KondTahunPengadaan $KondSemester and concat(k, '.', l, '.', m, '.', n, '.', o, '.', kf) like '$kdakun%'
						UNION
						select id, jml_harga as rencana, 0 as realisasi,(jml_harga-0) as selisih from dkb $Kondisi $KondTahunDPB and concat(k, '.', l, '.', m, '.', n, '.', o, '.', kf) like '$kdakun%') 
					as aa";	
		}else{
			return "select $fsum 
					from
						(SELECT id, 0 as rencana, jml_harga as realisasi,(0-jml_harga) as selisih from v1_pengadaan $Kondisi $KondTahunPengadaan $KondSemester 
						UNION
						select id, jml_harga as rencana, 0 as realisasi,(jml_harga-0) as selisih from dkb $Kondisi $KondTahunDPB) 
					as aa";
		}
