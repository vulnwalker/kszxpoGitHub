...
class popupProgramREFObj  extends DaftarObj2{
	var $Prefix = 'popupProgramREF';
	...
	var $FormName = 'popupProgramREFForm';
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="left" width=""',"<a style='cursor:pointer;' onclick=popupProgramREF.windowSave('$kodeProgram')>".$isi['nama']."</a>");
	 return $Koloms;
	}
...
$popupProgramREF = new popupProgramREFObj();
