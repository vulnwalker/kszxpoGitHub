...
class saldo_awal_keuangan_neraca_insObj  extends DaftarObj2{	
	var $Prefix = 'saldo_awal_keuangan_neraca_ins';
	...
	var $PageTitle = 'Data Saldo Awal Keuangan - Neraca';
	...
	var $FormName = 'saldo_awal_keuangan_neraca_insForm';
	var $noModul=14; 
	...
	function setTitle(){
		return 'SALDO AWAL KEUANGAN - NERACA';
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		//	1.1.1.02.02
			...
			if($daqry['nm_account']=='') $err="Kode Akun '$ka.$kb.$kc.$kde_dt.$kde_de' tidak ada";
			$content['namarekening'] = $daqry['nm_account'];
			$content['idrek'] = $idrek;
		...
		case 'Editinput':{
			...
			$content['koderek'] = "
				<input type='text' onkeyup='setTimeout(function myFunction() {saldo_awal_keuangan_neraca_ins.namajurnal();},1000);' name='Id_jurnal' id='Id_jurnal' value='".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$dt['kd'].".".$dt['ke']."' style='width:70px;' maxlength='25' />"
				...
				";
			/*$content['koderek'] = "
				<input type='text' onkeyup='setTimeout(function myFunction() {saldo_awal_keuangan_neraca_ins.namajurnal();},1000);' name='Id_jurnal' id='Id_jurnal' value='".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$kode_dt.".".$kode_de."' style='width:70px;' maxlength='25' />"
				."<input type='hidden' name='idrek' id='idrek' value='".$idrek."' />
			...
			$content['jml_saldo'] = "<input type='text' name='jml_saldo' id='jml_saldo' value='".floatval($jml_saldo_)."' style='text-align:right;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatsaldo`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatsaldo'></span>";
							
			$content['jml_anggaran'] = "<input type='text' name='jml_anggaran' id='jml_anggaran' value='".floatval($dt['anggaran'])."' style='text-align:right;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatanggaran`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatanggaran'></span>";
											
			$content['idrek'] = $idrek;
			$content['option'] = "
				<a href='javascript:saldo_awal_keuangan_neraca_ins.updKodeJurnal()' />
			...
			$content['atasbutton'] = "<a href='javascript:saldo_awal_keuangan_neraca_ins.dat_saldo_awal()' /><img src='datepicker/cancel.png' style='width:20px;height:20px;' /></a>";
		break;
	    }
		...
		$IDUBAH = $_REQUEST['idubah'];
		if ($idplh!=0){
			$qry_jurnal_det="INSERT INTO t_saldo_keu_det (refid_jurnal,status,tipe_jurnal,thn_anggaran) values ('$idplh','1','1','$coThnAnggaran')";$cek.=$qry_jurnal_det;
			$qry_jurnal_keuangan_det = mysql_query($qry_jurnal_det);
			
		}else{
			$qry_jurnal_det="INSERT INTO t_saldo_keu_det (refid_jurnal,status,tipe_jurnal,thn_anggaran) values ('$IDUBAH','1','1','$coThnAnggaran')";$cek.=$qry_jurnal_det;
		$qry_jurnal_keuangan_det = mysql_query($qry_jurnal_det);
		}
			$get= $this->data_saldo_awal();
			$cek = $get['cek'];
		...
		//	$kode_jurnal=mysql_fetch_array(mysql_query("select * from ref_jurnal where ka in(1,2,3)"));	
			if($ka ==$kd_4) $err="Kode Akun '$ka.$kb.$kc.$kd.$ke' Tidak bisa di input khusus LRA & LAK";
			if($ka ==$kd_5) $err="Kode Akun '$ka.$kb.$kc.$kd.$ke' Tidak bisa di input khusus LRA & LAK";
			if($ka ==$kd_6) $err="Kode Akun '$ka.$kb.$kc.$kd.$ke' Tidak bisa di input khusus LRA & LAK";
			if($ka ==$kd_7) $err="Kode Akun '$ka.$kb.$kc.$kd.$ke' Tidak bisa di input khusus LRA & LAK";
		...
		//	if($ka ==$ka && $kb==$kb && $kc==$kc && $kd=='') $err='Kode Akun 3';
			...
			$cek_dat=mysql_fetch_array(mysql_query("select count(*) as cnt from t_saldo_keu_det where ka='$ka' and kb='$kb' and kc='$kc' and kd='$kd' and ke='$ke' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='1'"));
			$cek.="select count(*) as cnt from t_saldo_keu_det where ka='$ka' and kb='$kb' and kc='$kc' and kd='$kd' and ke='$ke' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='1'";
		...
		//	$kode_jurnal=mysql_fetch_array(mysql_query("select * from ref_jurnal where ka in(1,2,3)"));	
			...
			$cek_dat=mysql_fetch_array(mysql_query("select * from t_saldo_keu_det where ka='$ka' and kb='$kb' and kc='$kc' and kd='$kd' and ke='$ke' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='1'"));
			$cek_dat2=mysql_fetch_array(mysql_query("select count(*) as cnt,Id from t_saldo_keu_det where ka='$ka' and kb='$kb' and kc='$kc' and kd='$kd' and ke='$ke' and c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='1'"));
   ...
   function setNavAtas(){
	...
	if($total!=0){
		...
		$aqry ="UPDATE t_saldo_keu_det set status='3' ,jns_jurnal='$jnsJurnal',tgl_anggaran='$tgl_anggaran2',tgl_saldo_awal='$tgl_saldo_awal2',tipe_jurnal='1',tgl_create=NOW(),uid='$uid' where refid_jurnal='".$IDUBAH."'";$cek.=$aqry;
	...
	if($total==0){
		...
		$aqry ="UPDATE t_saldo_keu_det set status='0' ,jns_jurnal='$jnsJurnal',tgl_saldo_awal='$tgl_saldo_awal2',tgl_anggaran='$tgl_anggaran2',tipe_jurnal='1',tgl_create=NOW(),uid='$uid' where refid_jurnal='".$IDUBAH."'";$cek.=$aqry;
		$qry = mysql_query($aqry);
	...
	//	$cek.="select * from t_saldo_keu_det where refid_jurnal='$IDUBAH'";
	...
	//	$saldo_anggaran_dat=mysql_fetch_array(mysql_query("select * from t_saldo_keu_det where refid_jurnal='$IDUBAH'"));
		...
		if($IDUBAH != null){
			...
			array("<table>			
					...
					<input type='hidden' name='jns_jurnal' id='jns_jurnal' value='".$jenis_jurnal['Id']."' size=7px readonly>
					</td>
					</td></tr>
   ...
   function data_saldo_awal(){
	...
	//new	
		...
		while($dt = mysql_fetch_array($aqry)){
			...
			$kode_dt = sprintf("%02s",$dt['kd']);
			$kode_de = sprintf("%02s",$dt['ke']);
			$kode = "<a href='javascript:saldo_awal_keuangan_neraca_ins.Editinput(`".$dt['Id']."`,`".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$kode_dt.".".$kode_de.".".$dt['kf']."`);' />
				...
				$btn ="
				<a href='javascript:saldo_awal_keuangan_neraca_ins.HapusJurnal_1(`".$dt['Id']."`)' />
			...
			if($dt['status'] == '1'){	
			$kode = "<input type='text' onkeyup='setTimeout(function myFunction() {saldo_awal_keuangan_neraca_ins.namajurnal();},1000);' name='Id_jurnal' id='Id_jurnal' value='".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$dt['kd'].".".$dt['ke']."' style='width:70px;' maxlength='25' />"
			."<a href='javascript:cr_jurnal.windowShow(".$dt['Id'].");'> <img src='datepicker/search.png' style='width:20px;height:20px;margin-bottom:-5px;'  /></a>";	
			...
			$nama_jurnal='';			
			$jml_saldo ="<input type='text' name='jml_saldo' id='jml_saldo' value='".floatval($dt['jumlah'])."' style='text-align:right' ;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatsaldo`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatsaldo'></span>";
			$jml_anggaran ="<input type='text' name='jml_anggaran' id='jml_anggaran' value='".floatval($dt['jumlah'])."' style='text-align:right' ;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatanggaran`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatanggaran'></span>";
		...
		$kode_de = sprintf("%02s",$dt['ke']);
			...
			if($dt['status'] == '0'){
				$kode = "
					<a href='javascript:saldo_awal_keuangan_neraca_ins.Editinput(`".$dt['Id']."`,`".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$dt['kd'].".".$kode_de.".".$dt['kf']."`);' />
						".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$kode_dt.".".$kode_de."
					</a>";
			...
			$jml_saldo_ ="<input type='text' name='jml_saldo' id='jml_saldo' value='".floatval($dt['jumlah'])."' style='text-align:right' ;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatsaldo`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatsaldo'></span>";
			$jml_anggaran_ ="<input type='text' name='jml_anggaran' id='jml_anggaran' value='".floatval($dt['jumlah'])."' style='text-align:right' ;' onkeypress='return isNumberKey(event)' onkeyup='document.getElementById(`formatanggaran`).innerHTML = saldo_awal_keuangan_neraca_ins.formatCurrency(this.value);' />
							<span id='formatanggaran'></span>";
			...
			$kode = "
					<a href='javascript:saldo_awal_keuangan_neraca_ins.Editinput(`".$dt['Id']."`,`".$dt['ka'].".".$dt['kb'].".".$dt['kc'].".".$dt['kd'].".".$dt['ke'].".".$dt['kf']."`);' />
		...
		$TombolBaru = "<a href='javascript:saldo_awal_keuangan_neraca_ins.input_Jurnal()' /><img src='datepicker/add-256.png' style='width:20px;height:20px;' /></a>";
	...
	$content['atasbutton'] = "<a href='javascript:saldo_awal_keuangan_neraca_ins.dat_saldo_awal(`".$dt['Id']."`)' /><img src='datepicker/cancel.png' style='width:20px;height:20px;' /></a>";
		return	array ('cek'=>$cek, 'err'=>$err, 'content'=>$content);
	}
   ...
   function SimpanAll(){
	...
	function setPage_OtherScript(){
		...
		return 	
			...
			"<script type='text/javascript' src='js/saldo_awal_keuangan/saldo_awal_keuangan_neraca_ins.js' language='JavaScript' ></script>".
			'
	...
	function pageShow(){
		...
		$cbid = $_REQUEST['saldo_awal_keuangan_neraca_cb'];
		if(addslashes($_REQUEST['YN']) == '2')$cbid[0]='';
		
			$c1input = $_REQUEST['saldo_awal_keuangan_neracaSKPDfmURUSAN'];
			$cinput = $_REQUEST['saldo_awal_keuangan_neracaSKPDfmSKPD'];
			$dinput = $_REQUEST['saldo_awal_keuangan_neracaSKPDfmUNIT'];
			$einput = $_REQUEST['saldo_awal_keuangan_neracaSKPDfmSUBUNIT'];
			$e1input = $_REQUEST['saldo_awal_keuangan_neracaSKPDfmSEKSI'];
		...
		"<html>".
			...
			"<table id='KerangkaHal' class='menubar' cellspacing='0' cellpadding='0' border='0' width='100%' height='100%' >".
				...
				"<tr height='*' valign='top'> <td >".
					...
					"<div class='main' >".
					$form1.
					"<input type='hidden' name='saldo_awal_keuangan_neracaSKPDfmURUSAN' value='".$c1input."' />".
					"<input type='hidden' name='saldo_awal_keuangan_neracaSKPDfmSKPD' value='".$cinput."' />".
					"<input type='hidden' name='saldo_awal_keuangan_neracaSKPDfmUNIT' value='".$dinput."' />".
					"<input type='hidden' name='saldo_awal_keuangan_neracaSKPDfmSUBUNIT' value='".$einput."' />".
					"<input type='hidden' name='saldo_awal_keuangan_neracaSKPDfmSEKSI' value='".$e1input."' />".
...
$saldo_awal_keuangan_neraca_ins = new saldo_awal_keuangan_neraca_insObj();
?>