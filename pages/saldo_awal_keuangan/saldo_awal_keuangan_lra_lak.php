...
class saldo_awal_keuangan_lra_lakObj  extends DaftarObj2{	
	var $Prefix = 'saldo_awal_keuangan_lra_lak';
	...
	var $Cetak_Judul = 'Saldo Awal Keuangan LRA & LAK';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'saldo_awal_keuangan_lra_lakForm';
	var $noModul=14; 
...
//	if($err=='' && count($cbid2)<1 && $c1=='00' && $c=='00' && $d=='00' && $e=='00' && $e1=='000')$err='Urusan Belum Dipilih';
	...
	$cek_sal=mysql_fetch_array(mysql_query("select count(*) as cnt from t_saldo_keu where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='2'"));
	$cek.="select count(*) as cnt from t_saldo_keu where c1='$c1' and c='$c' and d='$d' and e='$e' and e1='$e1' and tipe_jurnal='2'";
	if($cek_sal['cnt']>0){
	...
	$qrybarupenerimaan = "INSERT INTO t_saldo_keu(c1,c,d,e,e1,uid,status,thn_anggaran,tgl_create,tipe_jurnal) values ('$c1', '$c', '$d', '$e', '$e1', '$uid','1','$coThnAnggaran',NOW(),'2')";
		...
		"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin:0 0 0 0'>
			<tr>
				<td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
					...
					<A href=\"pages.php?Pg=saldo_awal_keuangan_lra_lak\" title='LRA & LAK' style='color:blue'>LRA & LAK</a>  |
...
$saldo_awal_keuangan_lra_lak = new saldo_awal_keuangan_lra_lakObj();
?>