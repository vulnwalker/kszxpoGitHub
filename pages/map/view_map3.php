...
<script language='JavaScript' src='js/wilayahgps.js' type='text/javascript'></script>
$Main->HeadStyle
</head>".
...
"<div id='menu_overlay' style='position:fixed;left:0;height:100%;

$Style_backgnd
	'>  ".
	"<form name='adminForm' id='adminForm' method='post' action=''>".
	"<div id='menu_content' style='float:left;display:block;height:100%;
	...
	"<tr>		
			...
			<tr><td style='width:20'>
				<input type='checkbox'' id='tampilbidang' name='tampilbidang' value='1'>
			</td>
			<td>
				Bidang
			</td>
			<td align='right' style='padding-right: 100px;'>
				...
				//"<input type='button' id='bttes' value='clear' onclick='Map.clearMap()'> <input type='button' id='btTampil' value='show' onclick='Map.showx()'><input type='button' id='btTampil' value='show' onclick='Map.showMap()'>".
			"</td></tr></table>".
			"</td></tr>".
			"<tr><td>".
	...
	"</table>".
	"</div>".
	"<div id='menu_home' style='left:100%;float:left;display:block;padding: 4 0 0 0;height: 60;background-color:#EB7B01;box-shadow: rgba(0, 0, 0, 0.298039) 5px 7px 5px;'>
	<div class=menuv>
