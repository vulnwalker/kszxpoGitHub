...
//kondisi ---------------------------------------
$Kondisi = getKondisiSKPD($fmKEPEMILIKAN,$Main->DEF_PROPINSI,$Main->DEF_WILAYAH,$fmSKPD,$fmUNIT,$fmSUBUNIT,$fmSEKSI,$fmURUSAN);
$fmKIB = $_POST['fmKIB'];
...
$byTampilkan = $_REQUEST['byTampilkan'];
if ($byTampilkan == 0) {
...
switch($SSPg){
			case '04': $KondisiKib ='and '.$vf04; break;
			case '05': $KondisiKib ='and '.$vf05; break;
			case '06': $KondisiKib ='and '.$vf06; break;
			case '07': $KondisiKib ='and '.$vf07; break;
			case '08': $KondisiKib ='and '.$vf08; break;
			case '09': $KondisiKib ='and '.$vf09; break;				
			case '10': $KondisiKib ='and '.$vf10; break;				
			default: $KondisiKib =''; 
		}	
...
if (!empty($SSPg)) $Kondisi .= " $KondisiKib ";
...
if (!empty($fmid)) $Kondisi .= " and id_bukuinduk like '%$fmid%' ";
if (!empty($fmidawal)) $Kondisi .= " and idbi_awal like '%$fmidawal%' ";

//hal limit ------------------------------------
$HalPLH = cekPOST("HalPLH",1);
$LimitHalPLH = " limit ".(($HalPLH*1) - 1) * $Main->PagePerHal.",".$Main->PagePerHal;
$KondOrd = $Main->KD_BARANG_P108?"order by a1,a,b,c,d,e,e1,f1,f2,f,g,h,i,j,thn_perolehan,noreg ":"order by a1,a,b,c,d,e,e1,f,g,h,i,j,thn_perolehan,noreg ";
$OrderBy = $KondOrd;
...
/*$PilihThn = " <div style='float:left;padding:1 8 0 8; border-right:1px solid #E5E5E5;'>".
			...
			"</div>";*/
$PilihThn = " <div style='float:left;padding:1 8 0 8; border-right:1px solid #E5E5E5;'>
	<input type=text name='fmPilihThn' id='fmPilihThn' value='$fmPilihThn' size=4 ></div>";
/*			
...
*/
$tombolTampil = " <input type='hidden' name='byTampilkan' id='byTampilkan' value = '$byTampilkan'>".
					"<div style='float:left;padding:0 8 0 8;'>
					<input type=button id='btTampil' name='btTampil' value='Tampilkan' 
					onclick=\"document.getElementById('byTampilkan').value='1';adminForm.action='';adminForm.target='';adminForm.submit()\">
					</div>";
$MenuCari = "
...
$Title ="
	<table class=\"adminheading\" style='margin:4 0 0 0'><tr>
		<th height=\"47\" class=\"user\">Daftar Penghapusan Sebagian</th>
		<th>$ToolbarAtas</th>
	</tr></table>";
$Menu_NavAtas = "
