...
class Rekappemanfaatan_lampiranObj  extends DaftarObj2{	
	var $Prefix = 'Rekappemanfaatan_lampiran';
	...
	var $PageTitle = 'Lampiran Rekap Pemanfaatan';
	var $PageIcon = 'images/pemanfaatan_ico.gif';
	var $ico_width = '24';
	var $ico_height = '24';	
	var $pagePerHal ='';
	var $cetak_xls=TRUE ;
	var $fileNameExcel='rekappemanfaatan_lampiran.xls';
	var $Cetak_Judul = 'Rekap Pemanfaatan Lampiran';	
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'Rekappemanfaatan_lampiran_form'; 	
	var $totalCol = 5;
	
	
	function setTitle(){
		return 'Rekap Pemanfaatan Lampiran';
	}
	...
	function setDaftar_query($Kondisi='', $Order='', $Limit=''){		
		...
		if(!($k=='' || $k=='00') )$arrKondisiAkun[] = "ka='$k'";	
		if(!($l=='' || $l=='00') )$arrKondisiAkun[] = "kb='$l'";	
		if(!($m=='' || $m=='00') )$arrKondisiAkun[] = "kc='$m'";	
		if(!($n=='' || $n=='00') )$arrKondisiAkun[] = "kd='$n'";	
		if(!($o=='' || $o=='00') )$arrKondisiAkun[] = "ke='$o'";
		...
		//KONDISI T_RENCANA_PEMANFAATAN
		if(!($tahun=='') ) $kondRencana = "and thn_anggaran='$tahun'";
		
		//KONDISI PEMANFAATAN
		if($sem==1){//semester 1
			$kondRealisasi="and tgl_pemanfaatan>='$tahun-01-01' and tgl_pemanfaatan<='$tahun-06-30'";
		}elseif($sem==2){//semester 2
			$kondRealisasi="and tgl_pemanfaatan>'$tahun-06-30' and tgl_pemanfaatan<='$tahun-12-31'";
		}else{//semua semester 
			$kondRealisasi="and tgl_pemanfaatan>='$tahun-01-01' and tgl_pemanfaatan<='$tahun-12-31'";			
		}		
		...
		$aqry = "select c,d,e,e1,sum(rencana) as rencana,sum(realisasi) as realisasi,sum(rencana)-sum(realisasi) as selisih from ".
				"( ".
				"(select c,d,e,e1,harga as rencana,0 as realisasi ".
				"from t_rencana_pemanfaatan ".
				"$kondisi_rencana ) ".
				"union ".
				"(select c,d,e,e1,0 as rencana,hrg_perolehan as realisasi from pemanfaatan".
				"$kondisi_realisasi ) ".
...
$Rekappemanfaatan_lampiran = new Rekappemanfaatan_lampiranObj();
