...
*/
include_once('common/fnMenu.php');
$Main->NavAtas = '';
$jns = $_REQUEST['jns'];
...
if ($Main->VERSI_NAME=='JABAR' && $Main->MENU_VERSI <3){ 
	...
	if ($Pg=='05'){
		...
		$menu_pembukuan1 =
			...
			switch($SPg){
				...
				case		'KIP': $styleMenu1_14a = " style='color:blue;'"; break;
		...
		if($Main->MENU_VERSI == 3){
			if($Pg == '09'){
				$styleMenuMutasi = " style='color:blue;'";
			}elseif($Pg == '05'){
				if($jns == 'tetap'){
					$styleMenuAset = " style='color:blue;'";
				}elseif($jns=='pindah' || $jns=='mitra' || $jns=='tgr' || $jns=='atb' || $jns=='lain'){
					$styleMenuAsetLain = " style='color:blue;'";
				}
			}elseif($Pg == 'pemusnahan'){
				$styleMenuMusnah = " style='color:blue;'";
			}
			if($jns <>''){		//menu akuntansi & pelaporan -------------------------------------------------------------------
			
				/**if($Pg == '05' && $jns == 'tetap'){ //aset tetap
					$menubar4 = 
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>".
					"<A href=\"?Pg=$Pg&SPg=04&jns=tetap\" $styleMenu3_3 title='Aset Tetap Tanah'>TANAH</a>  |  
					<A href=\"?Pg=$Pg&SPg=05&jns=tetap\" $styleMenu3_4 title='Aset Tetap Peralatan & Mesin'>P & M</a>  |  
					...
					"&nbsp&nbsp&nbsp".
					"</td></tr>";
				}elseif(($Pg == '05' && ($jns=='pindah' || $jns=='mitra' || $jns=='tgr' || $jns=='atb' || $jns=='lain')) || $Pg=='pemusnahan'){ //aset lainnya
					$menubar4 = 
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>".
					"<A href=\"?Pg=$Pg&SPg=03&jns=pindah\" $styleMenu3_13 title='Pemindahtanganan'>PEMINDAHTANGANAN</a> |    
					<A href=\"pages.php?Pg=pemusnahan&jns=pelaporan\" $styleMenuMusnah title='Pemusnahan'>PEMUSNAHAN</a> |   
					<A href=\"?Pg=$Pg&SPg=03&jns=mitra\" $styleMenu3_15 title='Kemitraan Dengan Pihak Ke Tiga'>KEMITRAAN</a> | 
					<A href=\"?Pg=$Pg&SPg=03&jns=tgr\" $styleMenu3_14 title='Tuntutan Ganti Rugi'>TGR</a> |        
					$menu_kibg1
					<A href=\"?Pg=$Pg&SPg=03&jns=lain\" $styleMenu3_10 title='Aset Lain-lain'>ASET LAIN LAIN</a> ".
				...
				$Main->NavAtas = "
					...
					<A href=\"?Pg=$Pg&SPg=03&jns=intra\" $styleMenu3_1 title='Intrakomptabel'>INTRAKOMPTABEL</a> |
					<A href=\"?Pg=$Pg&SPg=03&jns=ekstra\" $styleMenu3_2 title='Ekstrakomptabel'>EKSTRAKOMPTABEL</a> |
					<A href=\"?Pg=$Pg&SPg=04&jns=tetap\" $styleMenuAset title='Aset Tetap Tanah'>ASET TETAP</a>  |    
					<A href=\"?Pg=$Pg&SPg=03&jns=pindah\" $styleMenuAsetLain title='Aset Lainnya'>ASET LAINNYA</a> |    
					<A href=\"?Pg=09&SPg=01&SSPg=03&mutasi=1\" $styleMenuMutasi title='Mutasi'>MUTASI</a>  |
					<A href=\"pages.php?Pg=Rekap3\" title='Rekap Mutasi' >REKAP MUTASI</a>
					$menu_rekapneraca_2
					| <A href=\"pages.php?Pg=Rekap1\" title='Rekap BI' $styleMenu3_11b >NERACA</a>
					<!--| <A href=\"pages.php?Pg=Jurnal\" title='Jurnal' $styleMenu>JURNAL</a> -->
					  &nbsp&nbsp&nbsp
					</td></tr>$menubar4</table>
					";
				**/	
					
				$Main->NavAtas = "<!--menubar_page-->".$Menu->genMenu();	
					
				if($jns == 'penyusutan'){ 	//menu penyusutan
					$Main->NavAtas = "
				...
				/***
					$Main->NavAtas = "
						...
						|<A href=\"?Pg=$Pg&SPg=kibg\" $styleMenu1_9 title='Aset Tak Berwujud'>KIB G</a>	
						| <A href=\"?Pg=$Pg&SPg=KIR\" $styleMenu1_14 title='Kartu Inventaris Ruangan'>KIR</a>	
						<!--| <A href=\"?Pg=$Pg&SPg=KIP\" $styleMenu1_14a title='Kartu Inventaris Pegawai'>KIP</a>-->	
		...
		else if($Main->MENU_VERSI==4){ //PETA SEBARAN
			$Main->NavAtas = "
				...
				<A href=\"?Pg=$Pg&SPg=06\" $styleMenu1_5 title='Gedung & Bangunan'>KIB C</a>  |
				<A href=\"pages.php?Pg=map&SPg=03\" title='Peta Sebaran' target='_blank'>PETA</a> |
				<A href=\"index.php?Pg=ref\" title='Master Data' target='_blank'>MASTER</a> |
				<A href=\"index.php?Pg=Admin\" title='Administrasi' target='_blank'>ADMIN</a> 
				&nbsp&nbsp&nbsp 
				</table>
				 
				";
		}
		else{ //menu versi 0,1,2 --------------------------
			$Main->NavAtas = "
	...
	if ($SPg == 'belumsensus' || $SPg=='KIR' || $SPg=='KIP' ) {
				...
				if($Main->MENU_VERSI == 3){
					if($SPg=='belumsensus'){
						$jns = $_REQUEST['jns'];
						$styleMenu2_1_1 = $jns == 'inventarisasi' ? $styleMenu2_1 :'';
						$styleMenu2_1_2 = $jns == '' ? $styleMenu2_1 :'';
						
						$vjns = $jns == 'inventarisasi' ?'&jns=inventarisasi' : '';
						
						$Main->NavAtas = 
						"<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style='margin: 1 0 0 0'>
						<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
						<A href=\"index.php?Pg=05&SPg=belumsensus&jns=inventarisasi\" title='Inventarisasi' $styleMenu2_1_1 >INVENTARISASI</a> | 
						<A href=\"index.php?Pg=05&SPg=belumsensus\" title='Sensus' $styleMenu2_1_2>SENSUS</a> 
						  &nbsp&nbsp&nbsp
						</td></tr>
						...
						<A href=\"index.php?Pg=05&SPg=belumsensus\" title='Belum Cek' $styleMenu2_1>Belum Cek</a> | 
						<A href=\"pages.php?Pg=SensusScan$vjns\" title='Hasil Scan' $styleMenu2_9>Hasil Scan</a> | 
						<A href=\"pages.php?Pg=SensusTidakTercatat$vjns\" title='Barang Tidak Tercatat' $styleMenu2_8>Tidak Tercatat</a> | 
						<!--<A href=\"pages.php?Pg=sensus$vjns\" title='Sudah Cek' $styleMenu2_2>Sudah Cek</a>  |  -->
						<A href=\"pages.php?Pg=sensus&menu=ada$vjns\" title='Ada Barang' $styleMenu2_2>Ada</a>  |  
						<A href=\"pages.php?Pg=sensus&menu=tidakada$vjns\" title='Tidak Ada Barang' $styleMenu2_5>Tidak Ada</a>  |  
						
						
						<A href=\"pages.php?Pg=SensusHasil2$vjns\" title='Rekapitulasi Hasil Sensus' $styleMenu2_4>Hasil Sensus</a>  | 
						<A href=\"pages.php?Pg=SensusProgres$vjns\" title='Sensus Progress' $styleMenu2_4_>Sensus Progress</a>   
						  &nbsp&nbsp&nbsp
						</td></tr>	</table>";
					}
		...
		$bentuk= $_REQUEST['bentukmanfaat'];
		switch($bentuk){
			case '1' : $style1 = "style='color:blue;'"; break; 
			case '2' : $style2 = "style='color:blue;'"; break; 
			case '3' : $style3 = "style='color:blue;'"; break; 
			case '4' : $style4 = "style='color:blue;'"; break; 
			case '5' : $style5 = "style='color:blue;'"; break; 
			case '6' : $style6 = "style='color:blue;'"; break; 
			default : $style7 = "style='color:blue;'"; break;
		}
		$Main->NavAtas = "
		<table width=\"100%\" class=\"menubar\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\">
		<!--<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		...
		<A href=\"?Pg=$Pg&bentukmanfaat=\" $style7 title='Semua'>Semua</a> |
		<A href=\"?Pg=$Pg&bentukmanfaat=1\" $style1 title='Pinjam Pakai'>Pinjam Pakai</a>  |  
		<A href=\"?Pg=$Pg&bentukmanfaat=2\" $style2 title='Sewa'>Sewa</a>  |  
		<A href=\"?Pg=$Pg&bentukmanfaat=3\" $style3 title='Kerjasama Pemanfaatan'>Kerjasama Pemanfaatan</a>  |  
		<A href=\"?Pg=$Pg&bentukmanfaat=4\" $style4 title='Bangun Guna Serah'>Bangun Guna Serah</a>  |  
		<A href=\"?Pg=$Pg&bentukmanfaat=5\" $style5 title='Bangun Serah Guna'>Bangun Serah Guna</a>  |  
		<A href=\"?Pg=$Pg&bentukmanfaat=6\" $style6 title='Kerjasama Penyediaan Infrastruktur'>Kerjasama Penyediaan Infrastruktur</a>  &nbsp&nbsp&nbsp
		...
		if($Main->MODUL_PEMUSNAHAN==1){			
			$pemisah=" |";
			$menu_hps="<A href=\"pages.php?Pg=pemusnahan\" title='PEMUSNAHAN'>PEMUSNAHAN</a>&nbsp&nbsp&nbsp";		
		}
		$Main->NavAtas = "
		...
		switch($SSPg){
			...
			if($mutasi=='1'){
				...
				$submenubarx="
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=03$mut\" $menustyle1a style=\"color:red;\" title='Buku Inventaris'>BI</a> |
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=04$mut\" $menustyle1 style=\"color:red;\" title='Tanah'>KIB A</a>  |  
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=05$mut\" $menustyle2 style=\"color:red;\" title='Peralatan & Mesin'>KIB B</a>  |  
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=06$mut\" $menustyle3 style=\"color:red;\" title='Gedung & Bangunan'>KIB C</a>  |  
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=07$mut\" $menustyle4 style=\"color:red;\" title='Jalan, Irigasi & Jaringan'>KIB D</a>  |  
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=08$mut\" $menustyle5 style=\"color:red;\" title='Aset Tetap Lainnya'>KIB E</a>  |  
				<A href=\"?Pg=$Pg&SPg=$SPg&SSPg=09$mut\" $menustyle6 style=\"color:red;\" title='Konstruksi Dalam Pengerjaan'>KIB F</a>
				 | <A href=\"?Pg=$Pg&SPg=$SPg&SSPg=10$mut\" $menustyle7 style=\"color:red;\" title='Aset Tak Berwujud'>ATB</a>
				  &nbsp&nbsp&nbsp
			...
			if($Main->MENU_VERSI==3){
				...
				//if($mutasi<>""){ //mutasi dan reklas menu v3
					/***
					$menupenghapusann =
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
					<A href=\"?Pg=05&SPg=03&jns=intra\"  title='Intrakomptabel'>INTRAKOMPTABEL</a> |
					<A href=\"?Pg=05&SPg=03&jns=ekstra\"  title='Ekstrakomptabel'>EKSTRAKOMPTABEL</a> |
					<A href=\"?Pg=05&SPg=04&jns=tetap\"  title='Aset Tetap Tanah'>ASET TETAP</a>  |    
					<A href=\"?Pg=05&SPg=03&jns=pindah\"  title='Aset Lainnya'>ASET LAINNYA</a> |    
					<A href=\"?Pg=09&SPg=01&SSPg=03&mutasi=1\" style='color:blue' title='Mutasi'>MUTASI</a>  |
					<A href=\"pages.php?Pg=Rekap3\" title='Rekap Mutasi' >REKAP MUTASI</a>
					...
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
					<A href=\"?Pg=$Pg&SPg=01&SSPg=03&mutasi=1\" $mutstyle1 title='Daftar Mutasi'>PINDAH SKPD</a>  |
					<A href=\"?Pg=$Pg&SPg=01&SSPg=03&mutasi=2\" $mutstyle2 title='Daftar Reklas Kib'>REKLAS KIB</a> |
					...
					<A href=\"pages.php?Pg=Kondisi\" title='Daftar Kondisi'>KONDISI</a> 
					 | <A href=\"?Pg=$Pg&SPg=01&SSPg=03&mutasi=4\" $mutstyle4 title='Daftar Penggabungan'>PENGGABUNGAN</a> 
					 | <A href=\"?Pg=$Pg&SPg=01&SSPg=03&mutasi=5\" $mutstyle5 title='Daftar Double Catat'>DOUBLE CATAT</a> 
					 | <A href=\"pages.php?Pg=Jurnal\" title='Jurnal' >HISTORI</a> 
					
					&nbsp&nbsp&nbsp	
					</td></tr>";
					***/ 
					$menupenghapusann=$Menu->genMenu();
				//}else{ //penghapusan menuv3
					/*$menupenghapusann = 
					"<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		...
		if($Main->MENU_VERSI==3 && $mutasi<>"" ){
			$Main->NavAtas = $menupenghapusann;
		}else{
			$Main->NavAtas = "
