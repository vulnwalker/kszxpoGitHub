...
// $Qry = mysql_query("select Id from view_kib_a where $Kondisi  ");
// $jmlDataKIB_A = mysql_num_rows($Qry);
$jmlDataKIB_A=0;
$Qry = mysql_query("select * from view_kib_a2 where $Kondisi order by $Urutkan a1,a,b,c,d,e,f,g,h,i,j,tahun,noreg  $LimitHalKIB_A");
...
$tampilTotal = number_format($JmlTotalHargaListKIB_A, 0, '.', '');
