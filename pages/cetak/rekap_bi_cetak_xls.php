...
list($ListData, $jmlData) = 
	Mutasi_RekapByBrg_GetList2_xls($fmKEPEMILIKAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, 
			$Main->PagePerHal * (($HalDefault*1) - 1),0,
			array(50,50,50,'',100,100), !empty($cbxDlmRibu), FALSE, 3, $fmSEKSI, $fmKONDBRG
...
$ListData =list_header($SKPD,$UNIT,$SUBUNIT,$WILAYAH,'JAWA BARAT',$KODELOKASI,$SEKSI).
