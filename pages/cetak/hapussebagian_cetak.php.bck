...
$ListHSBG = HapusSebagian_List($Tbl, '*',$Kondisi, $LimitHalPLH, $OrderBy, 2,'cetak', TRUE,$Main->PagePerHal * (($HalPLH*1) - 1), FALSE,$fmKIB,$xls);
...
header('Content-disposition: attachment; filename="Daftar Penghapusan Sebagian.xls"');
ob_flush();
flush(); 
...
<td valign=\"top\">
	...
	<table style='width:30cm' border=\"0\">
		<tr>
			<td class=\"judulcetak\" ALIGN='CENTER' colspan=16>
				DAFTAR PENGHAPUSAN SEBAGIAN<br>
				$subpagetitle
				$tampilTahun
			</td>
		</tr>
	...
	<table width=\"100%\" border=\"0\">
		<tr>
			<td class=\"subjudulcetak\" colspan=5 >".PrintSKPD($xls)."</td>
		</tr>
	</table>
...
<br>
	...
	<table class=\"cetak\">
		...
		<TR>
			...
			<TH class=\"th01\" style='width:40'>Nomor<br>Reg.</TH>
	...
	<table style='width:30cm' border=\"0\">
		<tr>
			<td class=\"judulcetak\" ALIGN='CENTER'>
				DAFTAR PENGHAPUSAN SEBAGIAN BARANG MILIK DAERAH<br>
				$subpagetitle
				$tampilTahun
			</td>
		</tr>
