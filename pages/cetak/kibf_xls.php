...
<td valign="top">
	...
	<table style="width:30cm" border="0">
		<tr>
			...
			<td class="judulcetak" colspan="17"><DIV ALIGN=CENTER>KARTU INVENTARIS BARANG (KIB) F</DIV></td>
		</tr>
		<tr>
			<td class="judulcetak" colspan="17"><DIV ALIGN=CENTER>KONSTRUKSI DALAM PENGERJAAN</DIV></td>
		</tr>
	</table>
...
{
$sharga = !empty($dlmribuan)?'Harga Kontrak (Ribuan)':'Harga Kontrak';
$isix='	<thead>
		<tr>
			...
			<th class="th01" rowspan="2">Bangunan (P,SP,B)</th>
			...
			<th class="th01" rowspan="2" style="width:60">Tanggal Mulai</th>
			<th class="th01" rowspan="2">Status Tanah</th>
			<th class="th01" rowspan="2">Kode Tanah</th>
...
function list_table($XXNO='',$XXKDB='',$XXREG='',$XXNB='',$XXJB='',$XXKBTK='',$XXKBTN='',
$XXLUAS=0,$XXLOK='',$XXDTGL='',$XXDNO='',$XXTGL='',$XXST='',$XXKDT='',$XXASAL='',$XXHARGA=0,$XXKET='')
{
$isix='<tr>
			...
			<td class="GCTK">'.$XXJB.'</td>
			<td class="GCTK">'.$XXKBTK.'</td>

			<td class="GCTK">'.$XXKBTN.'</td>
			...
			<td class="GCTK" align=center>'.$XXTGL.'</td>

			<td class="GCTK" align=center>'.$XXST.'</td>
			<td class="GCTK" align=center>'.$XXKDT.'</td>
...
$isix='<tr><td class="GCTK" colspan=15 ><b>'.$sharga.'</b></td><td class="GCTK" align=right><b><div class="nfmt4">'.$XXJML.'</div></b></td>
