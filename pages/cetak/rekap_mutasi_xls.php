...
$XXBIRO='BIRO',$XXKOTA='KOTA',$XXPROP='PROPINSI',$XXKDLOK='KDLOKASI',$XXSEMESTER='',$XXTAHUN='') {
$isix='<html><head>
...
<td valign="top">
	...
	<table style="width:30cm" border="0">
		...
		<tr>
			<td class="judulcetak" colspan="13"><DIV ALIGN=CENTER>REKAPITULASI MUTASI BARANG '.$XXSEMESTER.'</DIV></td>
		</tr>

		<tr>
			<td class="judulcetak" colspan="13"><DIV ALIGN=CENTER>MILIK '.$XXPROP.'</DIV></td>
		</tr>
		<tr>
			<td class="judulcetak" colspan="13"><DIV ALIGN=CENTER>TAHUN ANGGARAN '.$XXTAHUN.'</DIV></td>
		</tr>
...
<table cellpadding=0 cellspacing=0 border=0 width="100%"> 
			...
			<td  colspan="10" style="font-weight:bold;font-size:9pt" >'.$XXBIDANG.'</td> 
			</tr> 
			<tr>
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >ASISTEN / OPD</td>
			<td align=center style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="10" style="font-weight:bold;font-size:9pt" >'.$XXASISTEN.'</td>
			</tr> 
			<tr>
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >BIRO / UPTD/B</td>
			<td align=center style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="10" style="font-weight:bold;font-size:9pt" >'.$XXBIRO.'</td> </tr> 
			<tr>
			...
			<td  colspan="10" style="font-weight:bold;font-size:9pt" >'.$XXKOTA.'</td> </tr> 
			<tr> 
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >PROVINSI</td>
			<td align=center colspan="1" style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="10" style="font-weight:bold;font-size:9pt" > JAWA BARAT</td> </tr> 
			</table>  
</td>
</tr>
<tr>
...
function list_tableheader($XXheaderTglAwal='',$XXheaderTglAkhir='')
{

$isix='<thead>
<tr>
		<th class="th02" rowspan="3" width="20">No Urut</th>
		<th class="th02" rowspan="3" width="20">Gol.</th>
		<th class="th02" rowspan="3" width="40">Kode Bidang Barang</th>
		<th class="th02" rowspan="3" >Nama Bidang Barang</th>
		
		<th class="th02" colspan="2" >Keadaan per <br>'.$XXheaderTglAwal.'</th>
		<th class="th02" colspan="4" >Mutasi Perubahan Selama  <br>'.$XXheaderTglAwal.' s/d '.$XXheaderTglAkhir.' </th>
		<th class="th02" colspan="2" >Keadaan per <br>'.$XXheaderTglAkhir.'</th>
		
		<th class="th02" rowspan="3" >Keterangan</th>
	</tr>	
	<tr>
		<th class="th02" rowspan="2" width="20">Jumlah Barang</th>
		<th class="th02" rowspan="2" width="100">Jumlah Harga <br>(Rp.)</th>
		<th class="th02" colspan="2" width="20">Berkurang</th>
		<th class="th02" colspan="2" width="100">Bertambah</th>
		<th class="th02" rowspan="2" width="20">Jumlah Barang</th>
		<th class="th02" rowspan="2" width="100">Jumlah Harga <br>(Rp.)</th>
	</tr>
	<tr>
		<th class="th02" width="20">Jumlah Barang</th>
		<th class="th02" width="100">Jumlah Harga <br>(Rp.)</th>
		<th class="th02" width="20">Jumlah Barang</th>
		<th class="th02" width="100">Jumlah Harga <br>(Rp.)</th>
	</tr>
	<tr>
...
function Mutasi_RekapByBrg_GetListXLS($fmKEPEMILIKAN, $fmSKPD, $fmUNIT, $fmSUBUNIT, $noawal, $limitHal, $kolomwidth, $dlmRibuan=false, $cetak=FALSE,$Style=1, $fmSEKSI='00', $fmKONDBRG='7'){
   // ------------------------------
    ...
    $clGaris = $cetak == TRUE ? "GCTK" : "GarisCetak";
    //get kondisi (skpd) ----------------------------------------------------------------------------------
        ...
        */
        ...
        switch ($Style) {
            case 1: {
					...
					<td class=\"$clGaris\" align=right width=\"$kolomwidth[4]\"><div class=\"nfmt4\">$tampil_jmlBrgTambah_curr</div></td>
