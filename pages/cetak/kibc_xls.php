...
<td valign="top">
	...
	<table style="width:30cm" border="0">
		<tr>
			...
			<td class="judulcetak" colspan="18"><DIV ALIGN=CENTER>KARTU INVENTARIS BARANG (KIB) C</DIV></td>
		</tr>
		<tr>
			<td class="judulcetak" colspan="18"><DIV ALIGN=CENTER>GEDUNG DAN BANGUNAN</DIV></td>
		</tr>
	</table>
...
<table cellpadding=0 cellspacing=0 border=0 width="100%"> 
			...
			<td  colspan="15" style="font-weight:bold;font-size:9pt" >'.$XXBIDANG.'</td> 
			</tr> 
			<tr>
			...
			<td  colspan="15" style="font-weight:bold;font-size:9pt" >'.$XXASISTEN.'</td>
			</tr> 
			<tr>
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >BIRO / UPTD/B</td>
			<td align=center colspan="1" style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="15" style="font-weight:bold;font-size:9pt" >'.$XXBIRO.'</td> </tr> 
			<tr>
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >KABUPATEN/KOTA</td>
			<td align=center colspan="1" style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="15" style="font-weight:bold;font-size:9pt" >'.$XXKOTA.'</td> </tr> 
			<tr> 
			<td  colspan="2" style="font-weight:bold;font-size:9pt" >PROVINSI</td>
			<td align=center colspan="1" style="font-weight:bold;font-size:9pt" >:</td>
			<td  colspan="15" style="font-weight:bold;font-size:9pt" > JAWA BARAT</td> </tr> 
			</table>
...
$isix='	<thead>
		<tr>
			...
			<th class="th01" rowspan="2" style="width:180">Nama Barang</th>
			<th class="th01" rowspan="2">Tahun Perolehan</th>

			<th class="th01" rowspan="2" style="width:60">Kondisi Bangunan (B, KB, RB)</th>
			<th class="th02" colspan="2">Konstruksi Bangunan</th>
			<th class="th01" rowspan="2" style="width:40">Luas Lantai (M2)</th>

			<th class="th01" rowspan="2" style="width:100">Letak / Alamat</th>
			<th class="th02" colspan="2">Dokumen Gedung</th>
			<th class="th01" rowspan="2" style="width:40">Luas Tanah (M2)</th>
		...
		<tr>
			<th class="th01" style="width:60">Bertingkat/ Tidak</th>

			<th class="th01" style="width:40">Beton/ Tidak</th>
...
function list_table($XXNO='',$XXKDB='',$XXREG='',$XXNB='',$XXKB='',$XXBTK='',$XXBTN='',
$XXLUASL=0,$XXLOK='',$XXDTGL='',$XXDNO='',$XXLUAST=0,$XXST='',$XXNKT='',$XXASAL='',$XXTHNP='',$XXHARGA=0,$XXKET='')
{
$isix='<tr>
			...
			<td class="GCTK" style="width:180">'.$XXNB.'</td>
			<td class="GCTK" align=center>'.$XXTHNP.'</td>
			<td class="GCTK">'.$XXKB.'</td>
			<td class="GCTK">'.$XXBTK.'</td>

			<td class="GCTK">'.$XXBTN.'</td>
			<td class="GCTK" align=right><div class="nfmt4">'.$XXLUASL.'</div></td>
			<td class="GCTK">'.$XXLOK.'</td>
			<td class="GCTK" align=center>'.$XXDTGL.'</td>
			<td class="GCTK">'.$XXDNO.'</td>
			<td class="GCTK" align=right><div class="nfmt4">'.$XXLUAST.'</div></td>

			<td class="GCTK">'.$XXST.'</td>
...
$isix='<tr><td class="GCTK" colspan=16 ><b>'.$sharga.'</b></td><td class="GCTK" align=right><b><div class="nfmt4">'.$XXJML.'</div></b></td><td class="GCTK" colspan=1 >&nbsp;</td></tr> 
	</table>
';
return $isix;			
}
