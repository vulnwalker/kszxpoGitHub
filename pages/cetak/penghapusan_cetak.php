...
switch($mutasi){
	case '1': $fname='Mutasi.xls'; $pagetitle = 'PENGHAPUSAN KARENA MUTASI'; break;
	case '2': $fname='Reklas.xls'; $pagetitle = 'REKLAS BARANG'; break;
	case '4': $fname='Penghapusan karena Penggabungan.xls'; $pagetitle = 'PENGHAPUSAN KARENA PENGGABUNGAN'; break;
	case '5': $fname='Penghapusan Karena Koreksi (Double Catat).xls'; $pagetitle = 'PENGHAPUSAN KARENA KOREKSI (DOUBLE CATAT)'; break;
	case '' : $fname='Penghapusan.xls'; $pagetitle = 'PENGHAPUSAN BARANG MILIK DAERAH'; break;
}
	...
	$Main->Isi = 
		...
		<td valign=\"top\">
			...
			<table style='width:30cm' border=\"0\">
				<tr>
					<td class=\"judulcetak\"><DIV ALIGN=CENTER>$pagetitle $subpagetitle</td>
				</tr>
			</table>
