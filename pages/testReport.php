...
class testReportObj  extends DaftarObj2{	
	var $Prefix = 'testReport';
	...
	var $reportURL1 = "pages.php?Pg=testReport&tipe=Pengadaan1";
	var $reportURL2 = "pages.php?Pg=testReport&tipe=Pengadaan2";
	var $reportURL3 = "pages.php?Pg=testReport&tipe=Pengadaan3";
	...
	function setPage_HeaderOther(){
		...
		<A href=\"pages.php?Pg=testReport\" title='RKBMD'  style='color : blue;' > RKBMD </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=testReport\" title='RKBMD'  style='color : blue;' > PENGADAAN </a> |
		...
		<tr><td class=\"menudottedline\" width=\"40%\" height=\"20\" style='text-align:right'><B>
		<A href=\"pages.php?Pg=testReport\" title='RKBMD'  style='color : blue;' > INPUT </a> |
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  case 'excel':{
			foreach ($_REQUEST as $key => $value) { 
			 ...
			 if($testReportSkpdfmUrusan =='0'){
			 	$err = "Pilih Urusan";
			 }elseif($testReportSkpdfmSKPD =='00'){
			 	$err = "Pilih Bidang";
			 }elseif($testReportSkpdfmUNIT =='00'){
			 	$err = "Pilih SKPD";
			 }elseif($testReportSkpdfmSUBUNIT =='00'){
			 	$err = "Pilih Unit";
			 }elseif($testReportSkpdfmSEKSI =='000'){
			 	$err = "Pilih Sub Unit";
			 }else{
	...
	case 'formBaru':{				
		...
		case 'newTab':{
			 ...
			 $cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$testReportSkpdfmUrusan' and c = '$testReportSkpdfmSKPD' and d='$testReportSkpdfmUNIT' and e = '$testReportSkpdfmSUBUNIT' and e1='$testReportSkpdfmSEKSI'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 $getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$testReportSkpdfmUrusan' and c = '$testReportSkpdfmSKPD' and d='$testReportSkpdfmUNIT' and e = '$testReportSkpdfmSUBUNIT' and e1='$testReportSkpdfmSEKSI' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
			 $lastID = $getDatarenja['id_anggaran'];
			 $parentC1 = $testReportSkpdfmUrusan;
		     $parentC = $testReportSkpdfmSKPD;
			 $parentD = $testReportSkpdfmUNIT;
			 $parentE = $testReportSkpdfmSUBUNIT;
			 $parentE1= $testReportSkpdfmSEKSI;
			 if($cekKeberadaanMangkluk == 0){
			 	$cekKeberadaanMangkluk =  mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$testReportSkpdfmUrusan' and c = '$testReportSkpdfmSKPD' and d='$testReportSkpdfmUNIT' and e = '00' and e1='000'  and q!='0' and no_urut ='$nomorUrutSebelumnya' "));
			 	$getDatarenja = mysql_fetch_array(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$testReportSkpdfmUrusan' and c = '$testReportSkpdfmSKPD' and d='$testReportSkpdfmUNIT' and e = '00' and e1='00' and q!='0' and no_urut = '$nomorUrutSebelumnya'"));	 
				$lastID = $getDatarenja['id_anggaran'];
				$parentE = '00';
				$parentE1= '000';
			 }
			 	...
			 	if($cekKeberadaanMangkluk != 0){
					if($getDatarenja['jenis_form_modul']  == 'PENYUSUNAN' ){
						$getJumlahRenjaValidasi = mysql_num_rows(mysql_query("select * from view_renja where jenis_anggaran = '$this->jenisAnggaran' and tahun = '$this->tahun' and c1 = '$testReportSkpdfmUrusan' and c = '$testReportSkpdfmSKPD' and d='$testReportSkpdfmUNIT' and e = '$parentE' and e1='$parentE1' and q!='0' $this->sqlValidasi and no_urut = '$nomorUrutSebelumnya'"));
					...
					if($cmbJenistestReport == 'PENGADAAN'){
						$kemana = 'ins_v3';
					}else{
		...
		case 'editTab':{
			 $id = $_REQUEST['testReport_cb'];
			foreach ($_REQUEST as $key => $value) { 
				  $$key = $value; 
			 } 
					$nomorUrutSebelumnya = $this->nomorUrut - 1;
					$getParenttestReport = mysql_fetch_array(mysql_query("select * from view_rkbmd where id_anggaran = '$id[0]'"));
					foreach ($getParenttestReport as $key => $value) { 
				 		 $$key = $value; 
					 } 
					$parentC1 = $getParenttestReport['c1'];
					$parentC = $getParenttestReport['c'];
					$parentD = $getParenttestReport['d'];
					$parentE = $getParenttestReport['e'];
					$parentE1= $getParenttestReport['e1'];
					$parentBK = $getParenttestReport['bk'];
					$parentCK = $getParenttestReport['ck'];
					$parentP = $getParenttestReport['p'];
					$parentQ = $getParenttestReport['q'];
		...
		case 'SaveValid':{
	    	foreach ($_REQUEST as $key => $value) { 
			 ...
			 $getSKPD = mysql_fetch_array(mysql_query("select * from tabel_anggaran where id_anggaran = '$testReport_idplh'"));
			 ...
			 $query = VulnWalkerUpdate("tabel_anggaran",$data," id_anggaran = '$testReport_idplh'");
			 mysql_query($query);
	   ...
	   case 'remove':{				
		...
		case 'koreksi':{
			...
			$gettestReportnya = mysql_fetch_array(mysql_query($queryRows));
			foreach ($gettestReportnya as $key => $value) { 
				  $$key = $value; 
			} 
			 ...
			 $dataSesuai = array(           'jenis_anggaran' => $this->jenisAnggaran,
			  ...
			  if($cekKoreksi > 0 ){
			   	 $getID = mysql_fetch_array(mysql_query("select * from tabel_anggaran where c1 = '$c1' and c='$c' and d = '$d' and e='$e' and e1='$e1' and bk='$bk' and ck='$ck' and p = '$p' and q='$q'  and f1='$f1' and f2='$f2' and f='$f' and g='$g' and h='$h' and i='$i' and j='$j' and id_jenis_pemeliharaan ='$id_jenis_pemeliharaan' and tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and id_tahap = '$this->idTahap' "));
						...
						if($angkaKoreksi <= $kebutuhanRiil || (empty($jumlahOptimal) && empty($kebutuhanMax) && $gettestReportnya['volume_barang'] >= $angkaKoreksi )  ){
							mysql_query("update tabel_anggaran set volume_barang = '$angkaKoreksi' , cara_pemenuhan = '$caraPemenuhan' where id_anggaran='$idnya'");
						}elseif($gettestReportnya['volume_barang'] < $angkaKoreksi){
...
/*		$nomorUrutSebelumnya = $this-> -1;*/
	   ...
	   elseif($this->jenisForm=="KOREKSI PENGGUNA"){
					...
					if($f == '00' && $q =='0')$TampilCheckBox = "";
						...
						$Koloms.= "<td class='$cssclass' align='left'></td>";
						 ...
						 $aksi  = "<img src='images/administrator/images/valid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=testReport.sesuai('$id_anggaran');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=testReport.koreksi('$id_anggaran');></img>";
	...
	function Laporan($dt){	
	 ...
	 $c1 = $dt['testReportSkpdfmUrusan'];
	 $c = $dt['testReportSkpdfmSKPD'];
	 $d = $dt['testReportSkpdfmUNIT'];
	 $e = $dt['testReportSkpdfmSUBUNIT'];
	 $e1 = $dt['testReportSkpdfmSEKSI'];
	...
	$TampilOpt = 
			...
			<td width=\"100%\" valign=\"top\">" . 
				WilSKPD_ajxVW("testReportSkpd") . 
			"</td>
			<td >" . 		
			"</td></tr>
			<tr><td>
			<input type='hidden' name='cmbJenistestReport' id='cmbJenistestReport' value='PENGADAAN'>	
			</td></tr>			
			</table>";		
	...
	function getDaftarOpsi($Mode=1){
		global $Main, $HTTP_COOKIE_VARS;
		$UID  = $_COOKIE['coID']; 
		$c1   = $_REQUEST['testReportSkpdfmUrusan'];
		$c    = $_REQUEST['testReportSkpdfmSKPD'];
		$d    = $_REQUEST['testReportSkpdfmUNIT'];
		$e    = $_REQUEST['testReportSkpdfmSUBUNIT'];
		$e1   = $_REQUEST['testReportSkpdfmSEKSI'];
		...
		$fmKODE = $_REQUEST['fmKODE'];
		$fmBARANG = $_REQUEST['fmBARANG'];
		$cmbJenistestReport = $_REQUEST['cmbJenistestReport'];
		$arrKondisi = array();		
...
function Pengadaan1($xls =FALSE){
		...
		$css = $xls	? "<style>.nfmt5 {mso-number-format:'\@';}</style>":"<link rel=\"stylesheet\" href=\"css/cssReport.css\" type=\"text/css\" />";
		echo 
			"<html>
  		...
  		<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=$ContentFontStyle[option_value]'>
								      <link rel='stylesheet' href='pageNumber.css'>

      <script type='text/javascript' src='https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>
    <script type='text/javascript' src='pageNumber.js'></script>
  		<script type='text/javascript' src='assets/js/bootstrap.min.js'></script>".
			...
			"<body >
				<div style='width:$this->Cetak_WIDTH_Landscape;'>
					<table class=\"rangkacetak\" style='width:33cm;font-family:sans-serif;margin-left:1.5cm;margin-top:1.5cm;'>
						<tr>
		...
		while($daqry = mysql_fetch_array($aqry)){
			...
			if ($q != "0") {
				$getIdRenja = mysql_fetch_array(mysql_query("SELECT * from view_renja where tahun = '$this->tahun' and jenis_anggaran = '$this->jenisAnggaran' and c1 = '$c1' and c = '$c' and d = '$d' and bk = '$bk' and ck = '$ck' and p = '$p' and q = '$q' "));
				...
				$namaKegiatan = "<td align='left' style='padding-left: 10px;' class='GarisCetak' colspan='5'>".$programKegiatan."</br>OUTPUT : $outputan </td>";
			}else{
...
function Pengadaan2($xls =FALSE){
	...
	function Pengadaan3($xls =FALSE){
		...
		echo 
			...
			"<body >
				<div style='width:$this->Cetak_WIDTH_Landscape;'>
					<table class=\"rangkacetak\" style='width:33cm;font-family:Times New Roman;margin-left:1.5cm;margin-top:1.5cm;'>
						<tr>
							<td valign=\"top\"> <div style='text-align:center;'>
							<table style='width: 100%; border: none; margin-bottom: 1%;'>
								<tr>
...
$testReport = new testReportObj();
$arrayResult = tahapPerencanaanV3($testReport->modul,"MURNI");
...
$testReport->jenisForm = $jenisForm;
$testReport->nomorUrut = $nomorUrut;
$testReport->urutTerakhir = $nomorUrut;
$testReport->tahun = $tahun;
$testReport->jenisAnggaran = $jenisAnggaran;
$testReport->idTahap = $idTahap;
$testReport->username = $_COOKIE['coID'];
$testReport->wajibValidasi = $arrayResult['wajib_validasi'];
if($testReport->wajibValidasi == TRUE){
	$testReport->sqlValidasi = " and status_validasi ='1' ";
}else{
	$testReport->sqlValidasi = " ";
}
$testReport->provinsi = $arrayResult['provinsi'];
$testReport->kota = $arrayResult['kota'];

$testReport->pengelolaBarang = $arrayResult['pengelolaBarang'];
$testReport->pejabatPengelolaBarang = $arrayResult['pejabat'];
$testReport->pengurusPengelolaBarang = $arrayResult['pengurus'];
$testReport->nipPengelola = $arrayResult['nipPengelola'];
$testReport->nipPengurus = $arrayResult['nipPengurus'];
$testReport->nipPejabat = $arrayResult['nipPejabat'];
$testReport->settingAnggaran = $arrayResult['settingAnggaran'];
