...
if (!CekLogin()) {
    include("pages/base_login_v5.php");
} else {
	 //if($Main->MENU_VERSI == 5){
		include("pages/base_main_v6.php");
	/*}
	else if($Main->MENU_VERSI == 4){
		include("pages/base.php");
		include("pages/base_main_peta.php");
    ...
    switch ($Pg) {
       /* case "01":
		...
		case "perencanaan":
			if($Main->MODUL_PERENCANAAN)
			if (empty($disModul01)) {			
                include("pages/perencanaan/base.php");
                include("pages/perencanaan/perencanaan.php");
            }
		break;
		case "perencanaan_v2":
			if($Main->MODUL_PERENCANAAN)
			if (empty($disModul01)) {			
                include("pages/perencanaan_v2/base.php");
                include("pages/perencanaan_v2/perencanaan.php");
            }
		break;
		case "perencanaan_v3":
			if($Main->MODUL_PERENCANAAN)
			if (empty($disModul01)) {			
                include("pages/perencanaan_v3/base.php");
                include("pages/perencanaan_v3/perencanaan.php");
            }
		break;
        case "02":
        ...
        case "05":
			...
			if($Main->PENATAUSAHA_VERSI==1){ //penatausahaan v1
				...
				switch($jns){
					...
					case 'lain' : {
					//die($jns);
						if($Main->MODUL_PELAPORAN){
							//echo('tes');
							include("pages/base.php"); //get main->base
							include("pages/05/selector_akun.php");
						}
						break;
					}
					default: {
						...
						if ($SPg=='belumsensus'){
							...
							if(empty($disModul05) && $Main->MODUL_PENATAUSAHAAN){
								include("pages/base.php"); //get main->base
								include("pages/05/selector.php");
							}
						}
