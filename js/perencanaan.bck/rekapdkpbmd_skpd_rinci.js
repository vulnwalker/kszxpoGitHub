var Rekapdkpbmd_rinciSkpd = new SkpdCls({
	prefix : 'Rekapdkpbmd_rinciSkpd', formName:'adminForm'
});

var Rekapdkpbmd_skpd_rinci = new DaftarObj2({
	prefix : 'Rekapdkpbmd_skpd_rinci',	
	url : 'pages.php?Pg=rekapdkpbmd_skpd_rinci',
	formName : 'Rekapdkpbmd_skpd_rinciForm',
