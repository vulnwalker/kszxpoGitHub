var rekaprkpbmd_skpd = new DaftarObj2({
	prefix : 'rekaprkpbmd_skpd',
	url : 'pages.php?Pg=rekaprkpbmd_skpd', 
	formName : 'rekaprkpbmd_skpdForm',
	...
	rincian:function(){		
		...
		if(err ==''){ 
			...
			var ci = kode[0];
			var di = kode[1];
			aForm.action= 'pages.php?Pg=rekaprkpbmd_skpd_rinci&c='+ci+'&d='+di+'&tahun='+tahun;
			aForm.target='_blank';
			aForm.submit();	
		}else{
			alert(err);
