var Rekapdkb_rinciSkpd = new SkpdCls({
	prefix : 'Rekapdkb_rinciSkpd', formName:'adminForm'
});

var Rekapdkb_skpd_rinci = new DaftarObj2({
	prefix : 'Rekapdkb_skpd_rinci',	
	url : 'pages.php?Pg=rekapdkb_skpd_rinci',
	formName : 'Rekapdkb_skpd_rinciForm',
