var saldo_awal_keuangan_neracaSKPD = new SkpdCls({
	...
	pilihUrusanfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihBidangAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihUnitAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihSubUnitAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihSeksiAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);}
	
	
	/*pilihUrusanAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihBidangAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihSKPDAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihUnitAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);},
	pilihSubUnitAfter : function(){saldo_awal_keuangan_neraca.refreshList(true);}*/
});

var saldo_awal_keuangan_neraca = new DaftarObj2({
	prefix : 'saldo_awal_keuangan_neraca',
	url : 'pages.php?Pg=saldo_awal_keuangan_neraca', 
	formName : 'saldo_awal_keuangan_neracaForm',
	withPilih:true,
			...
			$.ajax({
				...
				url: this.url+'&tipe=formEdit',
			  	success: function(data) {		
					...
					if(resp.err==''){
						var aForm = document.getElementById(saldo_awal_keuangan_neraca.formName);		
						aForm.action= saldo_awal_keuangan_neraca.url+'_ins&YN=2';//'?Op='+op+'&Pg=2&idprs=cetak_hal';		
						aForm.target='_blank';
						aForm.submit();	
						aForm.target='';
					}else{
