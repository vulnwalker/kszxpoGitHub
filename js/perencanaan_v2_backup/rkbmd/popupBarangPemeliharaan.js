var popupBarangPemeliharaan_v2 = new DaftarObj2({
	prefix : 'popupBarangPemeliharaan_v2',
	url : 'pages.php?Pg=popupBarangPemeliharaan_v2', 
	formName : 'popupBarangPemeliharaan_v2Form',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=popupBarangPemeliharaan_v2&tipe=getdata&id='+id,
				type : 'POST',
