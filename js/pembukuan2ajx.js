...
var Pembukuan2Ajx = new DaftarObj2({
	...
	filterRenderAfter : function () {
		//if(this.active==false){
			Cekbi.cekInitial('cek1','cont_cekbi', 'Pembukuan2AjxSkpdfmURUSAN', 'Pembukuan2AjxSkpdfmSKPD','Pembukuan2AjxSkpdfmUNIT', 'Pembukuan2AjxSkpdfmSUBUNIT', 'Pembukuan2AjxSkpdfmSEKSI');
