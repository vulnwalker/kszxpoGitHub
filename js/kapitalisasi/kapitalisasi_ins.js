var kapitalisasi_ins = new DaftarObj2({
	prefix : 'kapitalisasi_ins',
	url : 'pages.php?Pg=kapitalisasi_ins', 
	formName : 'kapitalisasi_insForm',
	...
	var me = this; var errmsg ='';
		...
		if(errmsg ==''){ 
			...
			if(confirm('Reclass Extra '+jmlcek+' Data ?')){
				if(errmsg ==''){ 							
				...
				success: function(data) {	
					...
					if(resp.err==''){
						...
						if(persen<100) {
							...
							document.getElementById('progressbar').style.width = persen +'%';				
							setTimeout(function(){ alert('Reclass Extra Selesai !'); }, 1000);
