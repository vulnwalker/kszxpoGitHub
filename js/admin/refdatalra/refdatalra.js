var refdatalra = new DaftarObj2({
	prefix : 'refdatalra',
	url : 'pages.php?Pg=refdatalra', 
	formName : 'refdatalraForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refdatalra_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refdatalra&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
