var refmigrasi = new DaftarObj2({
	prefix : 'refmigrasi',
	url : 'pages.php?Pg=refmigrasi', 
	formName : 'refmigrasiForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refmigrasi_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refmigrasi&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
