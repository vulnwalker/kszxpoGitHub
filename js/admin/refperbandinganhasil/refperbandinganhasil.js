var refperbandinganhasil = new DaftarObj2({
	prefix : 'refperbandinganhasil',
	url : 'pages.php?Pg=refperbandinganhasil', 
	formName : 'refperbandinganhasilForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refperbandinganhasil_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refperbandinganhasil&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
