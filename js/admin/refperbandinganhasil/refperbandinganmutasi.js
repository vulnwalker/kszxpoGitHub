var refperbandinganmutasi = new DaftarObj2({
	prefix : 'refperbandinganmutasi',
	url : 'pages.php?Pg=refperbandinganmutasi', 
	formName : 'refperbandinganmutasiForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refperbandinganmutasi_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refperbandinganmutasi&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
