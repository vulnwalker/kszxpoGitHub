var Rekapdpb_rinciSkpd = new SkpdCls({
	prefix : 'Rekapdpb_rinciSkpd', formName:'adminForm'
});

var Rekapdpb_skpd_rinci = new DaftarObj2({
	prefix : 'Rekapdpb_skpd_rinci',	
	url : 'pages.php?Pg=rekapdpb_skpd_rinci',
	formName : 'Rekapdpb_skpd_rinciForm',
