...
var Dpb_Rencana = new DaftarObj2({
	prefix : 'Dpb_Rencana',	
	url : 'pages.php?Pg=dpb_rencana',
	formName : 'adminForm',
	fmSKPD:'',
	fmUNIT:'',
	el_iddkb:'',
				...
				url: 'pages.php?Pg=dkb&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					...
					if(resp.err==''){
						...
						if(document.getElementById(me.el_nm_account)) document.getElementById(me.el_nama_account).value= resp.content.nama_account;
						me.windowClose();
						me.windowSaveAfter();
					}else{
						alert(resp.err)	
