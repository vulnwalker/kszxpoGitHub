...
var rekapdpb_skpd = new DaftarObj2({
	prefix : 'rekapdpb_skpd',
	url : 'pages.php?Pg=rekapdpb_skpd', 
	formName : 'rekapdpb_skpdForm',
	...
	rincian:function(){		
		...
		var Semester = document.getElementById('fmPILSEMESTER').value;
		var err='';
		...
		if(err ==''){ 
			...
			var ci = kode[0];
			var di = kode[1];
			aForm.action= 'pages.php?Pg=rekapdpb_skpd_rinci&c='+ci+'&d='+di+'&tahun='+tahun+'&sem='+Semester;
			aForm.target='_blank';
			aForm.submit();	
		}else{
			alert(err);
