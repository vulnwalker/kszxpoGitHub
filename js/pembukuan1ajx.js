var Pembukuan1AjxSkpd = new SkpdCls({
	prefix : 'Pembukuan1AjxSkpd', formName:'adminForm'
});


var Pembukuan1Ajx = new DaftarObj2({
	prefix : 'Pembukuan1Ajx',
	url : 'pages.php?Pg=Rekap1', 
	...
	exportXls2 : function(){
	    ...
	    a.href = tableToExcel('divcetak','neraca');
	    a.download = 'neraca.xls';
