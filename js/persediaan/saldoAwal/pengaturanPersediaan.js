var pengaturanPersediaan = new DaftarObj2({
	prefix : 'pengaturanPersediaan',
	url : 'pages.php?Pg=pengaturanPersediaan',
	formName : 'pengaturanPersediaanForm',
				...
				if(resp.err==''){
					...
					$.ajax({
						type:'POST',
							...
							success: function(data) {
							var resp = eval('(' + data + ')');
							$('#tanggalPersediaanAwal').datepicker({
								  dateFormat: 'dd-mm-yy',
									showAnim: 'slideDown',
								  inline: true,
									showOn: "button",
