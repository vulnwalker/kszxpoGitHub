var listBarangSaldoAwal = new DaftarObj2({
	prefix : 'listBarangSaldoAwal',
	url : 'pages.php?Pg=listBarangSaldoAwal',
	formName : 'listBarangSaldoAwalForm',
 ...
 sum : function(id) {
	...
	windowSave: function(){
		var me= this;
			...
			$.ajax({
			type : 'POST',
				url: 'pages.php?Pg=listBarangSaldoAwal&tipe=setValueTemplate',
				data:{id : document.getElementById('idTemplate').value,
					  c  : document.getElementById('c').value,
					  d  : document.getElementById('d').value,
					  e  : document.getElementById('cmbUnit').value,
					  currentPosition : document.getElementById("listBarangSaldoAwal_hal_fmHAL").value
					 },
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					var limit = resp.cek;
