var SkpdCls = function(params_){	
	...
	this.pilihUrusan = function(){
		...
		$.ajax({
		  url: 'pages.php?Pg=skpd&nm='+this.prefix+'&style='+this.style,
		  type : 'POST',
		  ...
		  success: function(data) {		
			...
			document.getElementById(me.prefix+'CbxBidang').innerHTML = resp.bidang;
