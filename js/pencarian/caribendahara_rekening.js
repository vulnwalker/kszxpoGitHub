var caribendahara_rekening = new DaftarObj2({
	prefix : 'caribendahara_rekening',
	url : 'pages.php?Pg=caribendahara_rekening', 
	formName : 'caribendahara_rekeningForm',
			...
			url: this.url+'&tipe=pilData&id='+id,
		  	success: function(data) {		
				...
				if(resp.err==''){
					delElem(cover);
					me.windowClose();
					DataPengaturan.Set_cekDcID_val("refid_penyedia",resp.content);
					DataPengaturan.Set_cekDcID_val("refid_penyedia_jns","1");
					me.AfterGet_PilData();
				}else{
					alert(resp.err);
				}
