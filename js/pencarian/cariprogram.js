var cariprogram = new DaftarObj2({
	...
	filterRenderAfter : function(){
		var me = this;		
		//DataPengaturan.DataSkpd("cariprogram_skpd", "100px", me.def_c1, me.def_c, me.def_d);
		DataPengaturan.formName = me.formName;
		DataPengaturan.DataSkpd_After= function(dt){
			me.refreshList(true);
		};						
	},
	...
	pilProg: function(bk,ck,dk,p){
		...
		$.ajax({
			...
			url: this.url+'&tipe=getp&bknya='+bk+'&cknya='+ck+'&dknya='+dk+'&pnya='+p,
