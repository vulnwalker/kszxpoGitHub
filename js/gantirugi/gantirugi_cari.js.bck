var gantirugi_cariSkpd = new SkpdCls({
	prefix : 'gantirugi_cariSkpd', 
	formName: 'gantirugi_cariForm',
});

var gantirugi_cari = new DaftarObj2({
	prefix : 'gantirugi_cari',
	url : 'pages.php?Pg=gantirugi_cari', 
	formName: 'gantirugi_cariForm',// 'adminForm'
