var formRkaPpkd32SKPD = new SkpdCls({
	prefix : 'formRkaPpkd32SKPD', formName:'formRkaPpkd32Form', kolomWidth:120,
...
var formRkaPpkd32 = new DaftarObj2({
	prefix : 'formRkaPpkd32',
	url : 'pages.php?Pg=formRkaPpkd32', 
	formName : 'formRkaPpkd32Form',
	...
	loading: function(){
		...
		this.topBarRender();
		this.filterRender();
		formRkaPpkd32.refreshList(true);
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+formRkaPpkd32.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);	
		$("#bantuPenjumlahan").text("Rp. "+formRkaPpkd32.formatCurrency(jumlahHargaAlokasi)  );		
		$("#bantuSelisih").text("Rp. "+formRkaPpkd32.formatCurrency(selisih)  );				
	},
					...
					data : {
				  	...
				  	success: function(data) {		
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd32.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}			
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+formRkaPpkd32.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd32.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				formRkaPpkd32.hitungSelisih('bantuJan');
				formRkaPpkd32.hitungSelisih('bantuFeb');
				formRkaPpkd32.hitungSelisih('bantuApr');
				formRkaPpkd32.hitungSelisih('bantuMei');
				formRkaPpkd32.hitungSelisih('bantuJul');
				formRkaPpkd32.hitungSelisih('bantuAgu');
				formRkaPpkd32.hitungSelisih('bantuOkt');
				formRkaPpkd32.hitungSelisih('bantuNop');
				formRkaPpkd32.hitungSelisih('bantuMar');
				formRkaPpkd32.hitungSelisih('bantuJun');
				formRkaPpkd32.hitungSelisih('bantuSep');
				formRkaPpkd32.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {	
					formRkaPpkd32.formAlokasiTriwulan();
				}
			});	
	...
	cancelEdit : function(){
		formRkaPpkd32.refreshList(true);
		setTimeout(function myFunction() {formRkaPpkd32.refreshList(true);},1000);
	},
				...
				success: function(data) {	
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","formRkaPpkd32.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","formRkaPpkd32.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:formRkaPpkd32.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:formRkaPpkd32.cancelEdit()');
				...
				success: function(data) {	
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							formRkaPpkd32.formRincianVolume();
						}else{
							alert(resp.err);
						}
