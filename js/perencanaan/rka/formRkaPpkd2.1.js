var formRkaPpkd21SKPD = new SkpdCls({
	prefix : 'formRkaPpkd21SKPD', formName:'formRkaPpkd21Form', kolomWidth:120,
...
var formRkaPpkd21 = new DaftarObj2({
	prefix : 'formRkaPpkd21',
	url : 'pages.php?Pg=formRkaPpkd21', 
	formName : 'formRkaPpkd21Form',
	...
	loading: function(){
		...
		this.topBarRender();
		this.filterRender();
		formRkaPpkd21.refreshList(true);
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+formRkaPpkd21.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);	
		$("#bantuPenjumlahan").text("Rp. "+formRkaPpkd21.formatCurrency(jumlahHargaAlokasi)  );		
		$("#bantuSelisih").text("Rp. "+formRkaPpkd21.formatCurrency(selisih)  );				
	},
					...
					data : {
				  	...
				  	success: function(data) {		
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd21.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}			
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+formRkaPpkd21.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd21.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				formRkaPpkd21.hitungSelisih('bantuJan');
				formRkaPpkd21.hitungSelisih('bantuFeb');
				formRkaPpkd21.hitungSelisih('bantuApr');
				formRkaPpkd21.hitungSelisih('bantuMei');
				formRkaPpkd21.hitungSelisih('bantuJul');
				formRkaPpkd21.hitungSelisih('bantuAgu');
				formRkaPpkd21.hitungSelisih('bantuOkt');
				formRkaPpkd21.hitungSelisih('bantuNop');
				formRkaPpkd21.hitungSelisih('bantuMar');
				formRkaPpkd21.hitungSelisih('bantuJun');
				formRkaPpkd21.hitungSelisih('bantuSep');
				formRkaPpkd21.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {	
					formRkaPpkd21.formAlokasiTriwulan();
				}
			});	
	...
	cancelEdit : function(){
		formRkaPpkd21.refreshList(true);
		setTimeout(function myFunction() {formRkaPpkd21.refreshList(true);},1000);
	},
				...
				success: function(data) {	
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","formRkaPpkd21.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","formRkaPpkd21.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:formRkaPpkd21.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:formRkaPpkd21.cancelEdit()');
				...
				success: function(data) {	
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							formRkaPpkd21.formRincianVolume();
						}else{
							alert(resp.err);
						}
