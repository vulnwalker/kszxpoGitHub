var formRkaPpkd1SKPD = new SkpdCls({
	prefix : 'formRkaPpkd1SKPD', formName:'formRkaPpkd1Form', kolomWidth:120,
...
var formRkaPpkd1 = new DaftarObj2({
	prefix : 'formRkaPpkd1',
	url : 'pages.php?Pg=formRkaPpkd1', 
	formName : 'formRkaPpkd1Form',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+formRkaPpkd1.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);	
		$("#bantuPenjumlahan").text("Rp. "+formRkaPpkd1.formatCurrency(jumlahHargaAlokasi)  );		
		$("#bantuSelisih").text("Rp. "+formRkaPpkd1.formatCurrency(selisih)  );				
	},
					...
					data : {
				  	...
				  	success: function(data) {		
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd1.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}			
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+formRkaPpkd1.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd1.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				formRkaPpkd1.hitungSelisih('bantuJan');
				formRkaPpkd1.hitungSelisih('bantuFeb');
				formRkaPpkd1.hitungSelisih('bantuApr');
				formRkaPpkd1.hitungSelisih('bantuMei');
				formRkaPpkd1.hitungSelisih('bantuJul');
				formRkaPpkd1.hitungSelisih('bantuAgu');
				formRkaPpkd1.hitungSelisih('bantuOkt');
				formRkaPpkd1.hitungSelisih('bantuNop');
				formRkaPpkd1.hitungSelisih('bantuMar');
				formRkaPpkd1.hitungSelisih('bantuJun');
				formRkaPpkd1.hitungSelisih('bantuSep');
				formRkaPpkd1.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {	
					formRkaPpkd1.formAlokasiTriwulan();
				}
			});	
	...
	cancelEdit : function(){
		formRkaPpkd1.refreshList(true);
		setTimeout(function myFunction() {formRkaPpkd1.refreshList(true);},1000);
	},
				...
				success: function(data) {	
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","formRkaPpkd1.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","formRkaPpkd1.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:formRkaPpkd1.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:formRkaPpkd1.cancelEdit()');
				...
				success: function(data) {	
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							formRkaPpkd1.formRincianVolume();
						}else{
							alert(resp.err);
						}
