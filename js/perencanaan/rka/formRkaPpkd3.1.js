var formRkaPpkd31SKPD = new SkpdCls({
	prefix : 'formRkaPpkd31SKPD', formName:'formRkaPpkd31Form', kolomWidth:120,
...
var formRkaPpkd31 = new DaftarObj2({
	prefix : 'formRkaPpkd31',
	url : 'pages.php?Pg=formRkaPpkd31', 
	formName : 'formRkaPpkd31Form',
	...
	loading: function(){
		...
		this.topBarRender();
		this.filterRender();
		formRkaPpkd31.refreshList(true);
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+formRkaPpkd31.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);	
		$("#bantuPenjumlahan").text("Rp. "+formRkaPpkd31.formatCurrency(jumlahHargaAlokasi)  );		
		$("#bantuSelisih").text("Rp. "+formRkaPpkd31.formatCurrency(selisih)  );				
	},
					...
					data : {
				  	...
				  	success: function(data) {		
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd31.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}			
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+formRkaPpkd31.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+formRkaPpkd31.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				formRkaPpkd31.hitungSelisih('bantuJan');
				formRkaPpkd31.hitungSelisih('bantuFeb');
				formRkaPpkd31.hitungSelisih('bantuApr');
				formRkaPpkd31.hitungSelisih('bantuMei');
				formRkaPpkd31.hitungSelisih('bantuJul');
				formRkaPpkd31.hitungSelisih('bantuAgu');
				formRkaPpkd31.hitungSelisih('bantuOkt');
				formRkaPpkd31.hitungSelisih('bantuNop');
				formRkaPpkd31.hitungSelisih('bantuMar');
				formRkaPpkd31.hitungSelisih('bantuJun');
				formRkaPpkd31.hitungSelisih('bantuSep');
				formRkaPpkd31.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {	
					formRkaPpkd31.formAlokasiTriwulan();
				}
			});	
	...
	cancelEdit : function(){
		formRkaPpkd31.refreshList(true);
		setTimeout(function myFunction() {formRkaPpkd31.refreshList(true);},1000);
	},
				...
				success: function(data) {	
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","formRkaPpkd31.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","formRkaPpkd31.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:formRkaPpkd31.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:formRkaPpkd31.cancelEdit()');
				...
				success: function(data) {	
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							formRkaPpkd31.formRincianVolume();
						}else{
							alert(resp.err);
						}
