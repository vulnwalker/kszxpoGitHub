...
var rekaprpbmd_skpd = new DaftarObj2({
	prefix : 'rekaprpbmd_skpd',
	url : 'pages.php?Pg=rekaprpbmd_skpd', 
	formName : 'rekaprpbmd_skpdForm',
	...
	rincian:function(){		
		...
		if(err ==''){ 
			...
			var ci = kode[0];
			var di = kode[1];
			aForm.action= 'pages.php?Pg=rekaprpbmd_skpd_rinci&c='+ci+'&d='+di+'&tahun='+tahun;
			aForm.target='_blank';
			aForm.submit();	
		}else{
			alert(err);
