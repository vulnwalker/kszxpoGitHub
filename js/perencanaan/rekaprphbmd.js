...
var rekaprphbmd = new DaftarObj2({
	...
	Lampiran: function(){		
		...
		if(errmsg ==''){ 
			...
			aForm.action= 'pages.php?Pg=rekaprph_lampiran&c='+cb[0]+'&d='+cb[1]+'&'+kode1+'='+cb[2]+'&'+kode2+'='+cb[3]+'&'+kode3+'='+cb[4]+'&'+kode4+'='+cb[5]+'&'+kode5+'='+cb[6]+'&tahun='+cb[7]+'&berdasarkan='+berdasarkan;//'?Op='+op+'&Pg=2&idprs=cetak_hal';		
			aForm.target='_blank';
			aForm.submit();	
			aForm.target='';
		}else{
