var rekapdkpbmd_skpd = new DaftarObj2({
	prefix : 'rekapdkpbmd_skpd',
	url : 'pages.php?Pg=rekapdkpb_skpd', 
	formName : 'rekapdkpbmd_skpdForm',
	...
	rincian:function(){		
		...
		if(err ==''){ 
			...
			var ci = kode[0];
			var di = kode[1];
			aForm.action= 'pages.php?Pg=rekapdkpbmd_skpd_rinci&c='+ci+'&d='+di+'&tahun='+tahun;
			aForm.target='_blank';
			aForm.submit();	
		}else{
			alert(err);
