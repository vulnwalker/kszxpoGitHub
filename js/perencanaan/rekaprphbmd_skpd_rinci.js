var Rekaprphbmd_rinciSkpd = new SkpdCls({
	prefix : 'Rekaprphbmd_rinciSkpd', formName:'adminForm'
});

var Rekaprphbmd_skpd_rinci = new DaftarObj2({
	prefix : 'Rekaprphbmd_skpd_rinci',	
	url : 'pages.php?Pg=rekaprphbmd_skpd_rinci',
	formName : 'Rekaprphbmd_skpd_rinciForm',
