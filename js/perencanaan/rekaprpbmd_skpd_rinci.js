var Rekaprpbmd_rinciSkpd = new SkpdCls({
	prefix : 'Rekaprpbmd_rinciSkpd', formName:'adminForm'
});

var Rekaprpbmd_skpd_rinci = new DaftarObj2({
	prefix : 'Rekaprpbmd_skpd_rinci',	
	url : 'pages.php?Pg=rekaprpbmd_skpd_rinci',
	formName : 'Rekaprpbmd_skpd_rinciForm',
