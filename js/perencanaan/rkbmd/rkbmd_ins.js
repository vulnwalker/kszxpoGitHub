var rkbmd_insSKPD = new SkpdCls({
	prefix : 'rkbmd_insSKPD', formName:'rkbmd_insForm', kolomWidth:120,
...
var rkbmd_ins = new DaftarObj2({
	prefix : 'rkbmd_ins',
	url : 'pages.php?Pg=rkbmd_ins', 
	formName : 'rkbmd_insForm',
    ...
    CariProgram: function(idRenja){
		...
		popupProgramRKBMD.kategori = "PENGADAAN";
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:rkbmd_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmd_ins.subCancel();'; 
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmd_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmd_ins.closeTab();'; 
