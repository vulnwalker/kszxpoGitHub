var rkbmd_pemeliharaanSKPD = new SkpdCls({
	prefix : 'rkbmd_pemeliharaanSKPD', formName:'rkbmd_pemeliharaanForm', kolomWidth:120,
...
var rkbmd_pemeliharaan = new DaftarObj2({
	prefix : 'rkbmd_pemeliharaan',
	url : 'pages.php?Pg=rkbmd_pemeliharaan', 
	formName : 'rkbmd_pemeliharaanForm',
			...
			$.ajax({
				...
				success: function(data) {	
					...
					if(resp.content.status == 'ada'){
						rkbmd_pemeliharaan.refreshList(true);	
					}		
    ...
    CariProgram: function(idRenja){
		...
		popupProgramRKBMD.kategori = "PEMELIHARAAN";
		...
		$.ajax({
				...
				success: function(data) {	
					...
					if(resp.err==''){
						...
						rkbmd_pemeliharaan.tabelPemeliharaan(1);
						document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan.subSimpan();';
						document.getElementById('btcancel').href = 'javascript:rkbmd_pemeliharaan.subCancel();'; 
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
						...
						rkbmd_pemeliharaan.tabelPemeliharaan(idnya);
	...
	subSubEdit: function(id){
		/*rkbmd_pemeliharaan.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:rkbmd_pemeliharaan.subSubCancel()');
		...
		$("#action"+id).attr('onclick','rkbmd_pemeliharaan.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {	
				var resp = eval('(' + data + ')');	
				document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan.moveBack();';
				document.getElementById('btcancel').href = 'javascript:rkbmd_pemeliharaan.subCancel();'; 
				rkbmd_pemeliharaan.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmd_pemeliharaan.subCancel();'; 
					document.getElementById('findBarang').disabled = true;
				}
			});	
	...
	subCancel : function(){
		$.ajax({
				...
				success: function(data) {	
					...
					$("#keterangan").val('');
					$("#jumlah").val('');
					document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmd_pemeliharaan.closeTab();'; 
