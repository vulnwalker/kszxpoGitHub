/*var JenisPemeliharaanSkpd = new SkpdCls({
	prefix : 'JabatanSkpd', formName:'JabatanForm',
	
	pilihBidangAfter : function(){JenisPemeliharaan.refreshList(true);},
	pilihUnitAfter : function(){JenisPemeliharaan.refreshList(true);},
	pilihSubUnitAfter : function(){JenisPemeliharaan.refreshList(true);},
	pilihSeksiAfter : function(){JenisPemeliharaan.refreshList(true);}
});*/

var ref_jenis_pemeliharaan = new DaftarObj2({
	prefix : 'ref_jenis_pemeliharaan',
	url : 'pages.php?Pg=ref_jenis_peneliharaan', 
	formName : 'ref_jenis_pemeliharaanForm',
