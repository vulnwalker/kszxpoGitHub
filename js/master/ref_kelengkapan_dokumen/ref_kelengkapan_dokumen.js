var ref_kelengkapan_dokumen = new DaftarObj2({
	prefix : 'ref_kelengkapan_dokumen',
	url : 'pages.php?Pg=ref_kelengkapan_dokumen', 
	formName : 'ref_kelengkapan_dokumenForm',
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#ref_kelengkapan_dokumen_form').serialize(),
