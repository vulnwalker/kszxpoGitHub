...
var rincianBelanjaModal = new DaftarObj2({
	prefix : 'rincianBelanjaModal',
	url : 'pages.php?Pg=rincianBelanjaModal', 
	formName : 'rincianBelanjaModalForm',
				...
				data:$('#'+this.formName).serialize(),
			  	...
			  	success: function(data) {		
					...
					if (resp.err ==''){
						...
						listBarangBelanjaModal.loading();
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#listBarangBelanjaModalForm').serialize(),
