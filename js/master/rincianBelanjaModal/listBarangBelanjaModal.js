var listBarangBelanjaModal = new DaftarObj2({
	prefix : 'listBarangBelanjaModal',
	url : 'pages.php?Pg=listBarangBelanjaModal',
	formName : 'listBarangBelanjaModalForm',
	...
	windowSave: function(){
		var me= this;
			...
			$.ajax({
			type : 'POST',
				url: 'pages.php?Pg=listBarangBelanjaModal&tipe=setValueTemplate',
				data:{id : document.getElementById('idTemplate').value,
					  c  : document.getElementById('c').value,
					  d  : document.getElementById('d').value,
					  e  : document.getElementById('cmbUnit').value,
					  currentPosition : document.getElementById("listBarangBelanjaModal_hal_fmHAL").value
					 },
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					var limit = resp.cek;
