var ref_potongan2 = new DaftarObj2({
	prefix : 'ref_potongan2',
	url : 'pages.php?Pg=ref_potongan2', 
	formName : 'ref_potongan2Form',
	...
	windowSave: function(id){
		...
		//alert('save');
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=ref_potongan2&tipe=getdata&id='+id,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
						...
						if(document.getElementById('persen'))document.getElementById('persen').value=resp.content.persen;
						me.windowClose();
						me.windowSaveAfter();
					}else{
						alert(resp.err)	
