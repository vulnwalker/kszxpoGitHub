var ref_potongan_spm = new DaftarObj2({
	prefix : 'ref_potongan_spm',
	url : 'pages.php?Pg=ref_potongan_spm', 
	formName : 'ref_potongan_spmForm',
	...
	cariRekening: function(){
		...
		ref_rekening3.el_kode_rekening = 'kode_rekening';
		ref_rekening3.el_nama_rekening = 'nama_rekening';
		ref_rekening3.windowSaveAfter= function(){};
		ref_rekening3.filterRekening='7';//kode akun aset tetap
		ref_rekening3.windowShow();	
	},
