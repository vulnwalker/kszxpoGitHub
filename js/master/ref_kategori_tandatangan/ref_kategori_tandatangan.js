var ref_kategori_tandatangan = new DaftarObj2({
	prefix : 'ref_kategori_tandatangan',
	url : 'pages.php?Pg=ref_kategori_tandatangan', 
	formName : 'ref_kategori_tandatanganForm',
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#ref_kategori_tandatangan_form').serialize(),
