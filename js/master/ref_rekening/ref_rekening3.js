var ref_rekening3Skpd = new SkpdCls({
	prefix : 'ref_rekening3Skpd', formName:'ref_rekening3Form',
...
var ref_rekening3 = new DaftarObj2({
	prefix : 'ref_rekening3',
	url : 'pages.php?Pg=ref_rekening3', 
	formName : 'ref_rekening3Form',
	el_kode_rekening : '',
	el_nama_rekening: '',
	filterRekening : '',
	...
	windowSave: function(id){
		...
		if(errmsg ==''){ 
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=ref_rekening3&tipe=getdata&id='+id,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
