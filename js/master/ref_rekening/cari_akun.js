var cari_akun = new DaftarObj2({
	prefix : 'cari_akun',
	url : 'pages.php?Pg=cari_akun', 
	formName : 'cari_akunForm',
	el_kode_account : '',
	el_nama_account: '',
	el_tahun_account:'',
	filterAkun : '',
	...
	//alert('masuk');
		var me= this;
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=cari_akun&tipe=getdata&id='+id,
				
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
					if(document.getElementById(me.el_kode_jurnal)) document.getElementById(me.el_kode_jurnal).value= resp.content.kode_jurnal;
					if(document.getElementById(me.el_nama_jurnal)) document.getElementById(me.el_nama_jurnal).value= resp.content.nama_jurnal;
					
					
					
						/*if(document.getElementById('kode_akun'))document.getElementById('kode_akun').value=resp.content.kode_akun;
						if(document.getElementById('nama_akun'))document.getElementById('nama_akun').value=resp.content.nama_akun;*/
