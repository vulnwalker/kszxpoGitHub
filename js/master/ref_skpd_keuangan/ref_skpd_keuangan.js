var ref_skpd_keuangan = new DaftarObj2({
	prefix : 'ref_skpd_keuangan',
	url : 'pages.php?Pg=ref_skpd_keuangan', 
	formName : 'ref_skpd_keuanganForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'ref_skpd_keuangan_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=ref_skpd_keuangan&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
