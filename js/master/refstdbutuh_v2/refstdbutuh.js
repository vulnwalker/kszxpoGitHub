var refstdbutuh_v2Skpd = new SkpdCls({
	prefix : 'refstdbutuh_v2Skpd', 
	formName: 'refstdbutuh_v2Form',
	pilihBidangAfter : function(){refstdbutuh_v2.refreshList(true);},
	pilihUnitAfter : function(){refstdbutuh_v2.refreshList(true);},
	pilihSubUnitAfter : function(){refstdbutuh_v2.refreshList(true);},
	pilihSeksiAfter : function(){refstdbutuh_v2.refreshList(true);}
});

var refstdbutuh_v2 = new DaftarObj2({
	prefix : 'refstdbutuh_v2',
	url : 'pages.php?Pg=ref_std_butuh_v2', 
	formName : 'refstdbutuh_v2Form',
