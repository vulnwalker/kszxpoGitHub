var ref_tahap_anggaran_v2 = new DaftarObj2({
	prefix : 'ref_tahap_anggaran_v2',
	url : 'pages.php?Pg=ref_tahap_anggaran_v2', 
	formName : 'ref_tahap_anggaran_v2Form',
	ref_tahap_anggaran_v2_form : '0',//default js ref_tahap_anggaran_v2
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
...
/*				me.sumHalRender();*/
	...
	Baru: function(){	
		...
		if (err =='' ){		
			...
			if(me.ref_tahap_anggaran_v2_form==0){//baru dari ref_tahap_anggaran_v2
