var refMapping_SKPD = new DaftarObj2({
	prefix : 'refMapping_SKPD',
	url : 'pages.php?Pg=refMapping_SKPD', 
	formName : 'refMapping_SKPDForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refMapping_SKPD_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refMapping_SKPD&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
