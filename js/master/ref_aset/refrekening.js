var RefRekening = new DaftarObj2({
	prefix : 'RefRekening',
	url : 'pages.php?Pg=refrekening', 
	formName : 'RefRekeningForm',
	el_kode_rekening : '',
	el_nama_rekening: '',
	el_tahun_rekening:'',
	filterAkun : '',
	...
	windowSave: function(id){
		...
		//alert('save');
			...
			var cover = 'RefRekening_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refrekening&tipe=getdata&id='+id,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
