var detailTemplate = new DaftarObj2({
	prefix : 'detailTemplate',
	url : 'pages.php?Pg=detailTemplate', 
	formName : 'detailTemplateForm',
	...
	setCookiesUnit: function(){
		...
		$.ajax({
		  ...
		  success: function(data) {
				...
				detailTemplate.refreshList(true);
		  }
		});
	...
	windowSave: function(){
		var me= this;
			...
			$.ajax({
			type : 'POST',
				url: 'pages.php?Pg=detailTemplate&tipe=setValueTemplate',
				data:{id : document.getElementById('idTemplate').value,
					  c  : document.getElementById('c').value,
					  d  : document.getElementById('d').value,
					  e  : document.getElementById('cmbUnit').value,
					  currentPosition : document.getElementById("detailTemplate_hal_fmHAL").value
					 },
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					var limit = resp.cek;
