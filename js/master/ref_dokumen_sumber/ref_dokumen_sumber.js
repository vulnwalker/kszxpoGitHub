var ref_dokumen_sumber = new DaftarObj2({
	prefix : 'ref_dokumen_sumber',
	url : 'pages.php?Pg=ref_dokumen_sumber', 
	formName : 'ref_dokumen_sumberForm',
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#ref_dokumen_sumber_form').serialize(),
