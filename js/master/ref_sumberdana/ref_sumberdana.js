/*var ref_sumberdanaSkpd = new SkpdCls({
	prefix : 'ref_sumberdanaSkpd', formName:'ref_sumberdanaForm',
	
	pilihBidangAfter : function(){ref_sumberdana.refreshList(true);},
	pilihUnitAfter : function(){ref_sumberdana.refreshList(true);},
	pilihSubUnitAfter : function(){ref_sumberdana.refreshList(true);},
	pilihSeksiAfter : function(){ref_sumberdana.refreshList(true);}
});*/

var ref_sumberdana = new DaftarObj2({
	prefix : 'ref_sumberdana',
	url : 'pages.php?Pg=ref_sumberdana&ajx=3', 
	formName : 'ref_sumberdanaForm',
