var RekapPenyusutan2Skpd = new SkpdCls({
	prefix : 'RekapPenyusutan2Skpd', formName:'adminForm'
});


var RekapPenyusutan2 = new DaftarObj2({
	prefix : 'RekapPenyusutan2',
	//url : 'pages.php?Pg=Rekap2Ajx', 
	url : 'pages.php?Pg=RekapPenyusutan2', 
	...
	reqTotal : function(href_, idel_,iterator_){
		var me = this;
		var href__ = href_.replace("JurnalPenyusutan2", "RekapPenyusutan2");		
		//alert(iterator_);
		if(href_!=''){
				...
				data:$('#'+this.formName).serialize(), 
			  	success: function(data) {		
					...
					if(document.getElementById('fmTplDetail').checked){
						...
						if(document.getElementById(arrid[0]+'_'+arrid[1]+'_'+1)) document.getElementById(arrid[0]+'_'+arrid[1]+'_'+1).innerHTML = resp.content.vtotal1;//+"<input type='hidden' value='"+resp.content.vSaldoAkBrg+"'>"; //saldo akhit
						if(document.getElementById(arrid[0]+'_'+arrid[1]+'_'+15)) document.getElementById(arrid[0]+'_'+arrid[1]+'_'+15).innerHTML = resp.content.vtotal5;//+"<input type='hidden' value='"+resp.content.vSaldoAkBrg+"'>"; //saldo akhit					
