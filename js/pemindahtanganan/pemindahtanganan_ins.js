var pemindahtanganan_ins = new DaftarObj2({
	prefix : 'pemindahtanganan_ins',
	url : 'pages.php?Pg=pemindahtanganan_ins', 
	formName : 'pemindahtanganan_insForm',
	...
	var me = this; var errmsg ='';
		...
		if(errmsg ==''){ 
			...
			if(confirm('Pemindahtanganan '+jmlcek+' Data ?')){
				if(errmsg ==''){ 							
				...
				success: function(data) {	
					...
					if(resp.err==''){
						...
						if(persen<100) {
							...
							document.getElementById('progressbar').style.width = persen +'%';				
							setTimeout(function(){ alert('Pemindahtanganan Selesai !'); }, 1000);
