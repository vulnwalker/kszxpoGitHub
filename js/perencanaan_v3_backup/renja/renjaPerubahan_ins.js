var renjaPerubahan_ins_v3SKPD = new SkpdCls({
	prefix : 'renjaPerubahan_ins_v3SKPD', formName:'renjaPerubahan_ins_v3Form', kolomWidth:120,
...
var renjaPerubahan_ins_v3 = new DaftarObj2({
	prefix : 'renjaPerubahan_ins_v3',
	url : 'pages.php?Pg=renjaPerubahan_ins_v3', 
	formName : 'renjaPerubahan_ins_v3Form',
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renjaPerubahan_ins_v3.CekSesuai()},1000);
