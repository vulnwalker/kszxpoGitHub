var rencana_pemanfaatan_penggunaSkpd = new SkpdCls({
	prefix : 'rencana_pemanfaatan_penggunaSkpd', 
	formName: 'rencana_pemanfaatan_penggunaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rencana_pemanfaatan_pengguna.refreshList(true);
	},
...
var rencana_pemanfaatan_pengguna = new DaftarObj2({
	prefix : 'rencana_pemanfaatan_pengguna',
	url : 'pages.php?Pg=rencana_pemanfaatan_pengguna', 
	formName : 'rencana_pemanfaatan_penggunaForm',
				...
				url: this.url +'&tipe=pilihcaribi',
			  	success: function(data) {
					...
					if (resp.err ==''){
						...
						document.getElementById('valasalusul').value = resp.content.plhasalusul;
						document.getElementById('valkondisi').value = resp.content.plhkondisi;
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rencana_pemanfaatan_pengguna_formkiba').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_pengguna_formkibb').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_pengguna_formkibc').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_pengguna_formkibd').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_pengguna_formkibe').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_pengguna_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rencana_pemanfaatan_pengguna_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rencana_pemanfaatan_pengguna_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rencana_pemanfaatan_pengguna_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rencana_pemanfaatan_pengguna_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rencana_pemanfaatan_pengguna_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rencana_pemanfaatan_pengguna_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='fmURUSAN' name='fmURUSAN' value='"+urusan+"'>"+
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rencana_pemanfaatan_pengguna'>"+
