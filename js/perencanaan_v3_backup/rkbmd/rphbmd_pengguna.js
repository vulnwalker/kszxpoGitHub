var rphbmd_penggunaSkpd = new SkpdCls({
	prefix : 'rphbmd_penggunaSkpd', 
	formName: 'rphbmd_penggunaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rphbmd_pengguna.refreshList(true);
	},
...
var rphbmd_pengguna = new DaftarObj2({
	prefix : 'rphbmd_pengguna',
	url : 'pages.php?Pg=rphbmd_pengguna', 
	formName : 'rphbmd_penggunaForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rphbmd_pengguna_formkiba').style.display = 'none';
		document.getElementById('rphbmd_pengguna_formkibb').style.display = 'none';
		document.getElementById('rphbmd_pengguna_formkibc').style.display = 'none';
		document.getElementById('rphbmd_pengguna_formkibd').style.display = 'none';
		document.getElementById('rphbmd_pengguna_formkibe').style.display = 'none';
		document.getElementById('rphbmd_pengguna_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rphbmd_pengguna_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rphbmd_pengguna_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rphbmd_pengguna_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rphbmd_pengguna_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rphbmd_pengguna_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rphbmd_pengguna_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rphbmd_pengguna'>"+
