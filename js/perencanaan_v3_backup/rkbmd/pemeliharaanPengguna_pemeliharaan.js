var pemeliharaanPengguna_pemeliharaanSKPD = new SkpdCls({
	prefix : 'pemeliharaanPengguna_pemeliharaanSKPD', formName:'pemeliharaanPengguna_pemeliharaanForm', kolomWidth:120,
...
var pemeliharaanPengguna_pemeliharaan = new DaftarObj2({
	prefix : 'pemeliharaanPengguna_pemeliharaan',
	url : 'pages.php?Pg=pemeliharaanPengguna_pemeliharaan', 
	formName : 'pemeliharaanPengguna_pemeliharaanForm',
			...
			$.ajax({
				...
				success: function(data) {	
					...
					if(resp.content.status == 'ada'){
						pemeliharaanPengguna_pemeliharaan.refreshList(true);	
					}		
		...
		$.ajax({
				...
				success: function(data) {	
					...
					if(resp.err==''){
						...
						pemeliharaanPengguna_pemeliharaan.tabelPemeliharaan(1);
						document.getElementById('btsave').href = 'javascript:pemeliharaanPengguna_pemeliharaan.subSimpan();';
						document.getElementById('btcancel').href = 'javascript:pemeliharaanPengguna_pemeliharaan.subCancel();'; 
						...
						if(resp.content.hubla != 0){
							setTimeout(function(){
							 pemeliharaanPengguna_pemeliharaan.subSubEdit(resp.content.hubla);
							}, 500);
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
						...
						pemeliharaanPengguna_pemeliharaan.tabelPemeliharaan(idnya);
	...
	subSubEdit: function(id){
		/*pemeliharaanPengguna_pemeliharaan.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:pemeliharaanPengguna_pemeliharaan.subSubCancel()');
		...
		$("#action"+id).attr('onclick','pemeliharaanPengguna_pemeliharaan.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {	
				var resp = eval('(' + data + ')');	
				document.getElementById('btsave').href = 'javascript:pemeliharaanPengguna_pemeliharaan.moveBack();';
				document.getElementById('btcancel').href = 'javascript:pemeliharaanPengguna_pemeliharaan.subCancel();'; 
				pemeliharaanPengguna_pemeliharaan.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:pemeliharaanPengguna_pemeliharaan.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:pemeliharaanPengguna_pemeliharaan.subCancel();'; 
					document.getElementById('findBarang').disabled = true;
				}
			});	
	...
	subCancel : function(){
		$.ajax({
				...
				success: function(data) {	
					...
					$("#keterangan").val('');
					$("#jumlah").val('');
					document.getElementById('btsave').href = 'javascript:pemeliharaanPengguna_pemeliharaan.Simpan();';
					document.getElementById('btcancel').href = 'javascript:pemeliharaanPengguna_pemeliharaan.closeTab();'; 
