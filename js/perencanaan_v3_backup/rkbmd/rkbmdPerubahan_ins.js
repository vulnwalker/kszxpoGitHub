var rkbmdPerubahan_ins_v3SKPD = new SkpdCls({
	prefix : 'rkbmdPerubahan_ins_v3SKPD', formName:'rkbmdPerubahan_ins_v3Form', kolomWidth:120,
...
var rkbmdPerubahan_ins_v3 = new DaftarObj2({
	prefix : 'rkbmdPerubahan_ins_v3',
	url : 'pages.php?Pg=rkbmdPerubahan_ins_v3', 
	formName : 'rkbmdPerubahan_ins_v3Form',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {	
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPerubahan_ins_v3.refreshList(true);			
				}
			});
		}else{
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_ins_v3.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_ins_v3.subCancel();'; 
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_ins_v3.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_ins_v3.closeTab();'; 
