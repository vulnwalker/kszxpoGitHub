var rkbmd_pemeliharaan_v3_v3SKPD = new SkpdCls({
	prefix : 'rkbmd_pemeliharaan_v3_v3SKPD', formName:'rkbmd_pemeliharaan_v3Form', kolomWidth:120,
...
var rkbmd_pemeliharaan_v3 = new DaftarObj2({
		...
		$.ajax({
				...
				success: function(data) {	
					...
					if(resp.err==''){
						...
						document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan_v3.subSimpan();';
						...
						if(resp.content.hubla != 0){
							setTimeout(function(){
							 rkbmd_pemeliharaan_v3.subSubEdit(resp.content.hubla);
							}, 500);
	...
	subSubEdit: function(id){
		/*rkbmd_pemeliharaan_v3.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:rkbmd_pemeliharaan_v3.subSubCancel()');
		...
		$("#action"+id).attr('onclick','rkbmd_pemeliharaan_v3.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {	
				var resp = eval('(' + data + ')');	
				document.getElementById('btsave').href = 'javascript:rkbmd_pemeliharaan_v3.moveBack();';
				document.getElementById('btcancel').href = 'javascript:rkbmd_pemeliharaan_v3.subCancel();'; 
				rkbmd_pemeliharaan_v3.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
