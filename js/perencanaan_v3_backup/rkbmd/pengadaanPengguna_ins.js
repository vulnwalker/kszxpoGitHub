var pengadaanPengguna_insSKPD = new SkpdCls({
	prefix : 'pengadaanPengguna_insSKPD', formName:'pengadaanPengguna_insForm', kolomWidth:120,
...
var pengadaanPengguna_ins = new DaftarObj2({
	prefix : 'pengadaanPengguna_ins',
	url : 'pages.php?Pg=pengadaanPengguna_ins', 
	formName : 'pengadaanPengguna_insForm',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {	
					...
					$("#q").val('');
					$("#program").val('');
					pengadaanPengguna_ins.refreshList(true);			
				}
			});
		}else{
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:pengadaanPengguna_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:pengadaanPengguna_ins.subCancel();'; 
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:pengadaanPengguna_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:pengadaanPengguna_ins.closeTab();'; 
