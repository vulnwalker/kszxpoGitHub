var rpebmd_penggunaSkpd = new SkpdCls({
	prefix : 'rpebmd_penggunaSkpd', 
	formName: 'rpebmd_penggunaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rpebmd_pengguna.refreshList(true);
	},
...
var rpebmd_pengguna = new DaftarObj2({
	prefix : 'rpebmd_pengguna',
	url : 'pages.php?Pg=rpebmd_pengguna', 
	formName : 'rpebmd_penggunaForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rpebmd_pengguna_formkiba').style.display = 'none';
		document.getElementById('rpebmd_pengguna_formkibb').style.display = 'none';
		document.getElementById('rpebmd_pengguna_formkibc').style.display = 'none';
		document.getElementById('rpebmd_pengguna_formkibd').style.display = 'none';
		document.getElementById('rpebmd_pengguna_formkibe').style.display = 'none';
		document.getElementById('rpebmd_pengguna_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rpebmd_pengguna_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rpebmd_pengguna_formkibb').style.display = 'block';
				break;
			}
			case '03': {
				document.getElementById('rpebmd_pengguna_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rpebmd_pengguna_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rpebmd_pengguna_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rpebmd_pengguna_formkibf').style.display = 'block';
				break;
			}
		}	
