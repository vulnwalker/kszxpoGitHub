var tesmenuv5Skpd = new SkpdCls({
	prefix : 'tesmenuv5Skpd', 
	formName: 'tesmenuv5Form',
});

var tesmenuv5CariSkpd = new SkpdCls({
	prefix : 'tesmenuv5CariSkpd', 
	formName: 'adminForm',
});

var tesmenuv5 = new DaftarObj2({
	prefix : 'tesmenuv5',
	url : 'pages.php?Pg=tesmenuv5', 
	formName: 'tesmenuv5Form',// 'adminForm'
	...
	KetetapanTanpaUsulan:function(setUrusan){
		var me = this;
		var err='';
		if(setUrusan==1){
		...
		$.ajax({
			...
			url: 'pages.php?Pg=tesmenuv5',
		  	success: function(data) {
				var resp = eval('(' + data + ')');	
				if (resp.ErrMsg =='')	{	
					document.getElementById('tesmenuv5_cont_opt').innerHTML = resp.content;
				}else{
					alert(resp.ErrMsg);					
	...
	caribarang1:function(jns_usul,settingurusan){		
