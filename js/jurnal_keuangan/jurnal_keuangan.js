var jurnal_keuanganSKPD = new SkpdCls({
	...
	pilihUrusanfter : function(){jurnal_keuangan.refreshList(true);},
	pilihBidangAfter : function(){jurnal_keuangan.refreshList(true);},
	pilihUnitAfter : function(){jurnal_keuangan.refreshList(true);},
	pilihSubUnitAfter : function(){jurnal_keuangan.refreshList(true);},
	pilihSeksiAfter : function(){jurnal_keuangan.refreshList(true);}
});

var jurnal_keuangan = new DaftarObj2({
	prefix : 'jurnal_keuangan',
	url : 'pages.php?Pg=jurnal_keuangan', 
	formName : 'jurnal_keuanganForm',
	withPilih:true,
	...
	Cari: function(){
		var me = this;
		//var j = document.getElementById('nip_penerima').value;
		//alert('ok');
		...
		Pegawaidata.windowShow(c,d,e,e1);	
	...
	Baru: function(){	
		...
		c1 = document.getElementById('jurnal_keuanganSKPDfmURUSAN').value;
		c = document.getElementById('jurnal_keuanganSKPDfmSKPD').value;
		d = document.getElementById('jurnal_keuanganSKPDfmUNIT').value;
		e = document.getElementById('jurnal_keuanganSKPDfmSUBUNIT').value;
		e1 = document.getElementById('jurnal_keuanganSKPDfmSEKSI').value;
		err='';
			...
			//	url: this.url+'&tipe=PengecekanUbah&CekUbah=1',
				url: this.url+'&tipe=formEdit',
			  	success: function(data) {		
					...
					if(resp.err==''){
						var aForm = document.getElementById(jurnal_keuangan.formName);		
						aForm.action= jurnal_keuangan.url+'_ins&YN=2';//'?Op='+op+'&Pg=2&idprs=cetak_hal';		
						aForm.target='_blank';
						aForm.submit();	
						aForm.target='';
					}else{
