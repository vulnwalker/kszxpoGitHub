var rkaPPKD31_insSKPD = new SkpdCls({
	prefix : 'rkaPPKD31_insSKPD', formName:'rkaPPKD31_insForm', kolomWidth:120,
...
var rkaPPKD31_ins = new DaftarObj2({
	prefix : 'rkaPPKD31_ins',
	url : 'pages.php?Pg=rkaPPKD31_ins',
	formName : 'rkaPPKD31_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD31_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD31_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaPPKD31_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD31_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD31_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD31_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD31_ins.hitungSelisih('bantuJan');
				rkaPPKD31_ins.hitungSelisih('bantuFeb');
				rkaPPKD31_ins.hitungSelisih('bantuApr');
				rkaPPKD31_ins.hitungSelisih('bantuMei');
				rkaPPKD31_ins.hitungSelisih('bantuJul');
				rkaPPKD31_ins.hitungSelisih('bantuAgu');
				rkaPPKD31_ins.hitungSelisih('bantuOkt');
				rkaPPKD31_ins.hitungSelisih('bantuNop');
				rkaPPKD31_ins.hitungSelisih('bantuMar');
				rkaPPKD31_ins.hitungSelisih('bantuJun');
				rkaPPKD31_ins.hitungSelisih('bantuSep');
				rkaPPKD31_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaPPKD31_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaPPKD31_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaPPKD31_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD31_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD31_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD31_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD31_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD31_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD31_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
