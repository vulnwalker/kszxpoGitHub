var rkaSKPD1PADNew = new DaftarObj2({
	prefix : 'rkaSKPD1PADNew',
	url : 'pages.php?Pg=rkaSKPD1PADNew',
	formName : 'rkaSKPD1PADNewForm',
	rkaSKPD1PADNew_form : '0',//default js rkaSKPD1PADNew
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
	...
	programChanged : function(){
		...
		$("#hiddenP").val(hiddenP);
		$("#q").val('');
		rkaSKPD1PADNew.refreshList(true);
	},
	detail: function(){
		//alert('detail');
		var me = this;
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD1PADNew.formatCurrency(hasilKali));
	},
	...
	SaveRincianVolume : function(id){
			...
			if(err ==''){
				...
				//me.bantu();
				rkaSKPD1PADNew.hitungVolume(id);
				var satuan = '';
				if($("#jumlah3").val() !=''){
