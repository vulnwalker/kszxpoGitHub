var detailVolume = new DaftarObj2({
	prefix : 'detailVolume',
	url : 'pages.php?Pg=detailVolume', 
	formName : 'detailVolumeForm',
	...
	windowSave: function(){
		var me= this;
			...
			$.ajax({
			type : 'POST',
				url: 'pages.php?Pg=detailVolume&tipe=setValueTemplate',
				data:{id : document.getElementById('idTemplate').value,
					  c  : document.getElementById('c').value,
					  d  : document.getElementById('d').value,
					  e  : document.getElementById('cmbUnit').value,
					  currentPosition : document.getElementById("detailVolume_hal_fmHAL").value
					 },
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					var limit = resp.cek;				
