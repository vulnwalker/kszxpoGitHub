var rkaSKPD31_insSKPD = new SkpdCls({
	prefix : 'rkaSKPD31_insSKPD', formName:'rkaSKPD31_insForm', kolomWidth:120,
...
var rkaSKPD31_ins = new DaftarObj2({
	prefix : 'rkaSKPD31_ins',
	url : 'pages.php?Pg=rkaSKPD31_ins',
	formName : 'rkaSKPD31_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaSKPD31_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaSKPD31_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaSKPD31_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaSKPD31_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaSKPD31_ins.hitungSelisih('bantuJan');
				rkaSKPD31_ins.hitungSelisih('bantuFeb');
				rkaSKPD31_ins.hitungSelisih('bantuApr');
				rkaSKPD31_ins.hitungSelisih('bantuMei');
				rkaSKPD31_ins.hitungSelisih('bantuJul');
				rkaSKPD31_ins.hitungSelisih('bantuAgu');
				rkaSKPD31_ins.hitungSelisih('bantuOkt');
				rkaSKPD31_ins.hitungSelisih('bantuNop');
				rkaSKPD31_ins.hitungSelisih('bantuMar');
				rkaSKPD31_ins.hitungSelisih('bantuJun');
				rkaSKPD31_ins.hitungSelisih('bantuSep');
				rkaSKPD31_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaSKPD31_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaSKPD31_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaSKPD31_ins.refreshList(true);
		setTimeout(function myFunction() {rkaSKPD31_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaSKPD31_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaSKPD31_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaSKPD31_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaSKPD31_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaSKPD31_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
