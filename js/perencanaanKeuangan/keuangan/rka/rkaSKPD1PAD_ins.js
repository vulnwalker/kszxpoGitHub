var rkaSKPD1PAD_insSKPD = new SkpdCls({
	prefix : 'rkaSKPD1PAD_insSKPD', formName:'rkaSKPD1PAD_insForm', kolomWidth:120,
...
var rkaSKPD1PAD_ins = new DaftarObj2({
	prefix : 'rkaSKPD1PAD_ins',
	url : 'pages.php?Pg=rkaSKPD1PAD_ins',
	formName : 'rkaSKPD1PAD_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaSKPD1PAD_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaSKPD1PAD_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaSKPD1PAD_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaSKPD1PAD_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaSKPD1PAD_ins.hitungSelisih('bantuJan');
				rkaSKPD1PAD_ins.hitungSelisih('bantuFeb');
				rkaSKPD1PAD_ins.hitungSelisih('bantuApr');
				rkaSKPD1PAD_ins.hitungSelisih('bantuMei');
				rkaSKPD1PAD_ins.hitungSelisih('bantuJul');
				rkaSKPD1PAD_ins.hitungSelisih('bantuAgu');
				rkaSKPD1PAD_ins.hitungSelisih('bantuOkt');
				rkaSKPD1PAD_ins.hitungSelisih('bantuNop');
				rkaSKPD1PAD_ins.hitungSelisih('bantuMar');
				rkaSKPD1PAD_ins.hitungSelisih('bantuJun');
				rkaSKPD1PAD_ins.hitungSelisih('bantuSep');
				rkaSKPD1PAD_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaSKPD1PAD_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaSKPD1PAD_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaSKPD1PAD_ins.refreshList(true);
		setTimeout(function myFunction() {rkaSKPD1PAD_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaSKPD1PAD_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaSKPD1PAD_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaSKPD1PAD_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaSKPD1PAD_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaSKPD1PAD_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
