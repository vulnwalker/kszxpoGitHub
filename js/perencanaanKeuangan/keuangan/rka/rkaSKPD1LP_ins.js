var rkaSKPD1LP_insSKPD = new SkpdCls({
	prefix : 'rkaSKPD1LP_insSKPD', formName:'rkaSKPD1LP_insForm', kolomWidth:120,
...
var rkaSKPD1LP_ins = new DaftarObj2({
	prefix : 'rkaSKPD1LP_ins',
	url : 'pages.php?Pg=rkaSKPD1LP_ins',
	formName : 'rkaSKPD1LP_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaSKPD1LP_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaSKPD1LP_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaSKPD1LP_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaSKPD1LP_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaSKPD1LP_ins.hitungSelisih('bantuJan');
				rkaSKPD1LP_ins.hitungSelisih('bantuFeb');
				rkaSKPD1LP_ins.hitungSelisih('bantuApr');
				rkaSKPD1LP_ins.hitungSelisih('bantuMei');
				rkaSKPD1LP_ins.hitungSelisih('bantuJul');
				rkaSKPD1LP_ins.hitungSelisih('bantuAgu');
				rkaSKPD1LP_ins.hitungSelisih('bantuOkt');
				rkaSKPD1LP_ins.hitungSelisih('bantuNop');
				rkaSKPD1LP_ins.hitungSelisih('bantuMar');
				rkaSKPD1LP_ins.hitungSelisih('bantuJun');
				rkaSKPD1LP_ins.hitungSelisih('bantuSep');
				rkaSKPD1LP_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaSKPD1LP_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaSKPD1LP_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaSKPD1LP_ins.refreshList(true);
		setTimeout(function myFunction() {rkaSKPD1LP_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaSKPD1LP_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaSKPD1LP_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaSKPD1LP_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaSKPD1LP_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaSKPD1LP_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
