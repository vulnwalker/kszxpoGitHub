<?php
class rkaSKPD1PAD_insObj  extends DaftarObj2{
	var $Prefix = 'rkaSKPD1PAD_ins';
	...
	var $Cetak_Judul = 'RKA-SKPD 1 PAD';
	var $Cetak_Mode=2;
	var $Cetak_WIDTH = '30cm';
	var $Cetak_OtherHTMLHead;
	var $FormName = 'rkaSKPD1PAD_insForm';
	var $noModul=14;
	...
	function setTitle(){
		...
		return 'RKA-SKPD 1 PAD TAHUN '.$this->tahun ;
	}
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){
			...
			case 'saveNewRekening':{
				...
				if(empty($kodeRekening)){
				...
				}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_pad where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' ")) != 0){
					...
					$query = VulnWalkerInsert("temp_rekening_rka_pendapatan_pad",$data);
					mysql_query($query);
					$cek = $query;
				}
		...
		case 'saveEditRekening':{
			...
			if(empty($kodeRekening)){
				...
				$err = "Pilih Sumber Dana";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rekening_rka_pendapatan_pad where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'")) != 0){
				$err = "Rekening Sudah Ada ! select * from temp_rekening_rka_pendapatan_pad where username = '$this->username' and concat(k,'.',l,'.',m,'.',n,'.',o) = '$kodeRekening' and id !='$id'";
			}else{
				$explodeKodeRekening = explode('.', $kodeRekening);
				$k = $explodeKodeRekening[0];
				$l = $explodeKodeRekening[1];
				...
				$query = VulnWalkerUpdate("temp_rekening_rka_pendapatan_pad",$data,"id = '$id'");
				mysql_query($query);
			}
		...
		case 'deleteRekening':{
			$getDataRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id ='".$_REQUEST['id']."'"));
			//mysql_query("insert into temp_remove_rka_1_pad values('".$getDataRekening['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rekening_rka_pendapatan_pad where id ='".$_REQUEST['id']."'");

			$getAllRincian = mysql_query("select * from temp_rincian_pendapatan_pad where id_rekening_belanja = '".$_REQUEST['id']."'");
			while ($dataRincian = mysql_fetch_array($getAllRincian)) {
					mysql_query("insert into temp_remove_rka_1_pad values('".$dataRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_rincian_pendapatan_pad where id ='".$dataRincian['id']."'");
					$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_pad where id_rincian_belanja = '".$dataRincian['id']."'");
					while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
						  mysql_query("insert into temp_remove_rka_1_pad values('".$dataSubRincian['id_anggaran']."','$this->username')");
							mysql_query("delete from temp_sub_rincian_pendapatan_pad where id ='".$dataSubRincian['id']."'");
					}
		...
		case 'rincianBelanja':{
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id ='".$_REQUEST['id']."'"));
		...
		case 'saveNewRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian !";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_pad where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' ")) != 0){
				...
				$query = VulnWalkerInsert("temp_rincian_pendapatan_pad",$data);
				mysql_query($query);
			}
		...
		case 'saveEditRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				$err = "Isi Uraian";
			}elseif(mysql_num_rows(mysql_query("select * from temp_rincian_pendapatan_pad where uraian = '$uraianBelanja' and id_rekening_belanja ='$idRekeningBelanja' and id !='$idEdit' ")) != 0){
				$err = "Uraian Sudah Ada !";
			} else{
				...
				$query = VulnWalkerUpdate("temp_rincian_pendapatan_pad",$data,"id = '$idEdit'");
				mysql_query($query);
			}
		...
		case 'deleteRincianBelanja':{
			$getDataRincian = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_pad values('".$getDataRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_rincian_pendapatan_pad where id ='".$_REQUEST['id']."'");
			$getAllSubRincian =  mysql_query("select * from temp_sub_rincian_pendapatan_pad where id_rincian_belanja = '".$_REQUEST['id']."'");
			while ($dataSubRincian = mysql_fetch_array($getAllSubRincian)) {
					mysql_query("insert into temp_remove_rka_1_pad values('".$dataSubRincian['id_anggaran']."','$this->username')");
					mysql_query("delete from temp_sub_rincian_pendapatan_pad where id ='".$dataSubRincian['id']."'");
			}
		...
		case 'subRincianBelanja':{
			$cek = '';
			$err = '';
			$getData = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id ='".$_REQUEST['idRekeningBelanja']."'"));
			$getNamaRekening = mysql_fetch_array(mysql_query("select * from ref_rekening where k ='".$getData['k']."' and l ='".$getData['l']."' and m ='".$getData['m']."' and n ='".$getData['n']."' and o ='".$getData['o']."'"));
			$namaRekening = $getNamaRekening['nm_rekening'];

			$getDataRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad where id = '".$_REQUEST['id']."'"));
		...
		case 'deleteSubRincianBelanja':{
			$getDataSubRincian = mysql_fetch_array(mysql_query("select * from temp_sub_rincian_pendapatan_pad where id ='".$_REQUEST['id']."'"));
			mysql_query("insert into temp_remove_rka_1_pad values('".$getDataSubRincian['id_anggaran']."','$this->username')");
			mysql_query("delete from temp_sub_rincian_pendapatan_pad where id ='".$_REQUEST['id']."'");
			$cek = '';
			$err = '';
		...
		case 'saveNewSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$getUrutanPosisi = mysql_fetch_array(mysql_query("select max(urutan_posisi) from temp_sub_rincian_pendapatan_pad where username = '$this->username' and id_rincian_belanja = '$idRincianBelanja' order by urutan_posisi"));
				...
				$query = VulnWalkerInsert("temp_sub_rincian_pendapatan_pad",$data);
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'saveEditSubRincianBelanja':{
			...
			if(empty($uraianBelanja)){
				...
				$query = VulnWalkerUpdate("temp_sub_rincian_pendapatan_pad",$data,"id = '$idEdit'");
				mysql_query($query);
				$cek = $query;
			}
		...
		case 'finish':{
			...
			$getRekeningKosong = mysql_query("select * from temp_rekening_rka_pendapatan_pad where username = '$this->username'");
			while($dataRekening = mysql_fetch_array($getRekeningKosong)){
					$dataRincianBelanjaKosong = mysql_query("select * from temp_rincian_pendapatan_pad where id_rekening_belanja = '".$dataRekening['id']."'");
					...
					while ($dataRincianBelanja = mysql_fetch_array($dataRincianBelanjaKosong)) {
							if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_pad where username = '$this->username' and id_rincian_belanja ='".$dataRincianBelanja['id']."'")) == 0){
			...
			if(empty($err)){
				if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_pad where username = '$this->username' and id_anggaran !=''")) == 0){
						$execute = mysql_query("select * from temp_sub_rincian_pendapatan_pad  where username ='$username' ");
						while($subRincianBelanja = mysql_fetch_array($execute)){
							$getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
							$getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
							...
							$getUplineName = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
				...
				$getAllRemoved = mysql_query("select * from temp_remove_rka_1_pad where username = '$this->username'");
   ...
   function setPage_OtherScript(){
		...
		return
			...
			"<script type='text/javascript' src='js/perencanaanKeuangan/keuangan/rka/rkaSKPD1PAD_ins.js' language='JavaScript' ></script>".
	...
	$vOrder=
			...
			,'','','').
				...
				genFilterBar(
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btsave' href='javascript:rkaSKPD1PAD_ins.finish()'>
					...
					<tbody><tr valign='middle' align='center'>
					<td class='border:none'>
						<a class='toolbar' id='btcancel' href='javascript:rkaSKPD1PAD_ins.closeTab()'>
	...
	function tabelRekening(){
		...
		$qry = "select * from temp_rekening_rka_pendapatan_pad where username = '$this->username' order by k,l,m,n,o ";$cek.=$qry;
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			$getDataRincianBelanja = mysql_query("select * from temp_rincian_pendapatan_pad where id_rekening_belanja = '$id'");
			while ($dataRincianBelanja = mysql_fetch_array($getDataRincianBelanja)) {
					if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_pad where id_rincian_belanja = '".$dataRincianBelanja['id']."'")) !=0){
							if($statusMerah == ''){
									$warna = "black";
							}
					}else{
	...
	function tabelRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pendapatan_pad where id_rekening_belanja = '$idRekeningBelanja' and username = '$this->username' order by id ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
		...
		foreach ($dt as $key => $value) {
			...
			$warna = "red";
			if(mysql_num_rows(mysql_query("select * from temp_sub_rincian_pendapatan_pad where username = '$this->username' and id_rincian_belanja = '$id'")) != 0 ){
				$warna = "black";
			}
	...
	function tabelSubRincianBelanja($idRincianBelanja){
		...
		$qry = "select * from temp_sub_rincian_pendapatan_pad where id_rincian_belanja = '$idRincianBelanja' order by urutan_posisi ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function addSubRincianBelanja($idRincianBelanja,$idRekeningBelanja){
		...
		// $getKodeRekening = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id ='$idRekeningBelanja'"));
	...
	function addRincianBelanja($idRekeningBelanja){
		...
		$qry = "select * from temp_rincian_pendapatan_pad where id_rekening_belanja = '$idRekeningBelanja' ";$cek.=$qry;
		$aqry = mysql_query($qry);
		$no=1;
		$status =$_REQUEST['status'];
	...
	function editData(){
		 ...
		 $execute = mysql_query("select * from temp_sub_rincian_pendapatan_pad  where username ='$this->username' ");
		 while($subRincianBelanja = mysql_fetch_array($execute)){
			 $getRincianBelanja = mysql_fetch_array(mysql_query("select * from temp_rincian_pendapatan_pad where id = '".$subRincianBelanja['id_rincian_belanja']."'"));
			 $getRekeningBelanja = mysql_fetch_array(mysql_query("select * from temp_rekening_rka_pendapatan_pad where id = '".$getRincianBelanja['id_rekening_belanja']."'"));
...
$rkaSKPD1PAD_ins = new rkaSKPD1PAD_insObj();
...
$rkaSKPD1PAD_ins->jenisForm = $jenisForm;
$rkaSKPD1PAD_ins->nomorUrut = $nomorUrut;
$rkaSKPD1PAD_ins->tahun = $tahun;
$rkaSKPD1PAD_ins->jenisAnggaran = $jenisAnggaran;
$rkaSKPD1PAD_ins->idTahap = $idTahap;
$rkaSKPD1PAD_ins->username = $_COOKIE['coID'];
