...
/*				me.sumHalRender();*/
	...
	koreksi:function(id){
		...
		$("#buttonSubmitKoreksi"+id).html("<img src='datepicker/save.png' width='20px' height='20px' style='cursor : pointer;' onclick=rkaSKPD221_v2_koreksi.submitKoreksi('"+id+"');></img>&nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkaSKPD221_v2_koreksi.refreshList(true);></img>");
