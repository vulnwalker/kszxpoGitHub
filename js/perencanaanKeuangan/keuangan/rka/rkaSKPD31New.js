var rkaSKPD31New = new DaftarObj2({
	prefix : 'rkaSKPD31New',
	url : 'pages.php?Pg=rkaSKPD31New',
	formName : 'rkaSKPD31NewForm',
	rkaSKPD31New_form : '0',//default js rkaSKPD31New
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD31New.formatCurrency(hasilKali));
	},
