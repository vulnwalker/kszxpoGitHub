var rkaSKPD1LP = new DaftarObj2({
	prefix : 'rkaSKPD1LP',
	url : 'pages.php?Pg=rkaSKPD1LP',
	formName : 'rkaSKPD1LPForm',
	rkaSKPD1LP_form : '0',//default js rkaSKPD1LP
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
	...
	Laporan:function(){
		var me = this;
			...
			$.ajax({
				type:'POST',
				data:$('#'+this.formName).serialize()+"&dari=rkaSKPD1LP",
			  	url: 'pages.php?Pg=rkaSKPD1PADNew'+'&tipe=Laporan',
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
			...
			alert("Pilih SKPD");
				...
				data : {cmbUrusan : $("#cmbUrusan").val(),
			  	...
			  	success: function(data) {
						...
						aForm.action= 'pages.php?Pg=rkaSKPD1LP_ins&skpd='+skpd;
						aForm.target='_blank';
						aForm.submit();
						aForm.target='';
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD1LP.formatCurrency(hasilKali));
	},
	...
	findRekening : function(id){
		...
		popupRekening.filterAkun="RKA 1 LP";
