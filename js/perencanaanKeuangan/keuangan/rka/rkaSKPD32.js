var rkaSKPD32 = new DaftarObj2({
	prefix : 'rkaSKPD32',
	url : 'pages.php?Pg=rkaSKPD32',
	formName : 'rkaSKPD32Form',
	rkaSKPD32_form : '0',//default js rkaSKPD32
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
		...
		var me = this;
			...
			$.ajax({
				...
				data:$('#'+this.formName).serialize()+"&dari=rkaSKPD32",
			  	url: 'pages.php?Pg=rkaSKPD3New'+'&tipe=Laporan',
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
			...
			alert("Pilih SKPD");
				...
				data : {cmbUrusan : $("#cmbUrusan").val(),
			  	...
			  	success: function(data) {
						...
						aForm.action= 'pages.php?Pg=rkaSKPD32_ins&skpd='+skpd;
						aForm.target='_blank';
						aForm.submit();
						aForm.target='';
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD32.formatCurrency(hasilKali));
	},
	...
	findRekening : function(id){
		...
		popupRekening.filterAkun="RKA 3.2";
