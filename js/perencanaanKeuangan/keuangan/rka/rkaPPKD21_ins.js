var rkaPPKD21_insPPKD = new SkpdCls({
	prefix : 'rkaPPKD21_insPPKD', formName:'rkaPPKD21_insForm', kolomWidth:120,
...
var rkaPPKD21_ins = new DaftarObj2({
	prefix : 'rkaPPKD21_ins',
	url : 'pages.php?Pg=rkaPPKD21_ins',
	formName : 'rkaPPKD21_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD21_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD21_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaPPKD21_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD21_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD21_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD21_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	CariBarang: function(kodePPKD){
		var me = this;
		popupBarangPemeliharaan.skpd = kodePPKD;
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD21_ins.hitungSelisih('bantuJan');
				rkaPPKD21_ins.hitungSelisih('bantuFeb');
				rkaPPKD21_ins.hitungSelisih('bantuApr');
				rkaPPKD21_ins.hitungSelisih('bantuMei');
				rkaPPKD21_ins.hitungSelisih('bantuJul');
				rkaPPKD21_ins.hitungSelisih('bantuAgu');
				rkaPPKD21_ins.hitungSelisih('bantuOkt');
				rkaPPKD21_ins.hitungSelisih('bantuNop');
				rkaPPKD21_ins.hitungSelisih('bantuMar');
				rkaPPKD21_ins.hitungSelisih('bantuJun');
				rkaPPKD21_ins.hitungSelisih('bantuSep');
				rkaPPKD21_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaPPKD21_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaPPKD21_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaPPKD21_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD21_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD21_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD21_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD21_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD21_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD21_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
