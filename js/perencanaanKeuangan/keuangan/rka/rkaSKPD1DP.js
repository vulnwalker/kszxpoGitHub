var rkaSKPD1DP = new DaftarObj2({
	prefix : 'rkaSKPD1DP',
	url : 'pages.php?Pg=rkaSKPD1DP',
	formName : 'rkaSKPD1DPForm',
	rkaSKPD1DP_form : '0',//default js rkaSKPD1DP
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
	...
	Laporan:function(){
		var me = this;
			...
			$.ajax({
				type:'POST',
				data:$('#'+this.formName).serialize()+"&dari=rkaSKPD1DP",
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
			...
			alert("Pilih SKPD");
				...
				data : {cmbUrusan : $("#cmbUrusan").val(),
			  	...
			  	success: function(data) {
						...
						aForm.action= 'pages.php?Pg=rkaSKPD1DP_ins&skpd='+skpd;
						aForm.target='_blank';
						aForm.submit();
						aForm.target='';
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD1DP.formatCurrency(hasilKali));
	},
	...
	findRekening : function(id){
		...
		popupRekening.filterAkun="RKA 1 DP";
