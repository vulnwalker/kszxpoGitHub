var rkaPPKD1_insSKPD = new SkpdCls({
	prefix : 'rkaPPKD1_insSKPD', formName:'rkaPPKD1_insForm', kolomWidth:120,
...
var rkaPPKD1_ins = new DaftarObj2({
	prefix : 'rkaPPKD1_ins',
	url : 'pages.php?Pg=rkaPPKD1_ins', 
	formName : 'rkaPPKD1_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD1_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);	
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD1_ins.formatCurrency(jumlahHargaAlokasi)  );		
		$("#bantuSelisih").text("Rp. "+rkaPPKD1_ins.formatCurrency(selisih)  );				
	},
					...
					data : {
				  	...
				  	success: function(data) {		
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}			
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD1_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD1_ins.hitungSelisih('bantuJan');
				rkaPPKD1_ins.hitungSelisih('bantuFeb');
				rkaPPKD1_ins.hitungSelisih('bantuApr');
				rkaPPKD1_ins.hitungSelisih('bantuMei');
				rkaPPKD1_ins.hitungSelisih('bantuJul');
				rkaPPKD1_ins.hitungSelisih('bantuAgu');
				rkaPPKD1_ins.hitungSelisih('bantuOkt');
				rkaPPKD1_ins.hitungSelisih('bantuNop');
				rkaPPKD1_ins.hitungSelisih('bantuMar');
				rkaPPKD1_ins.hitungSelisih('bantuJun');
				rkaPPKD1_ins.hitungSelisih('bantuSep');
				rkaPPKD1_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {	
					rkaPPKD1_ins.formAlokasiTriwulan();
				}
			});	
	...
	cancelEdit : function(){
		rkaPPKD1_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD1_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {	
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD1_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD1_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD1_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD1_ins.cancelEdit()');
				...
				success: function(data) {	
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD1_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
