var rkaPPKD1LP_insSKPD = new SkpdCls({
	prefix : 'rkaPPKD1LP_insSKPD', formName:'rkaPPKD1LP_insForm', kolomWidth:120,
...
var rkaPPKD1LP_ins = new DaftarObj2({
	prefix : 'rkaPPKD1LP_ins',
	url : 'pages.php?Pg=rkaPPKD1LP_ins',
	formName : 'rkaPPKD1LP_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD1LP_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD1LP_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaPPKD1LP_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1LP_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD1LP_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1LP_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD1LP_ins.hitungSelisih('bantuJan');
				rkaPPKD1LP_ins.hitungSelisih('bantuFeb');
				rkaPPKD1LP_ins.hitungSelisih('bantuApr');
				rkaPPKD1LP_ins.hitungSelisih('bantuMei');
				rkaPPKD1LP_ins.hitungSelisih('bantuJul');
				rkaPPKD1LP_ins.hitungSelisih('bantuAgu');
				rkaPPKD1LP_ins.hitungSelisih('bantuOkt');
				rkaPPKD1LP_ins.hitungSelisih('bantuNop');
				rkaPPKD1LP_ins.hitungSelisih('bantuMar');
				rkaPPKD1LP_ins.hitungSelisih('bantuJun');
				rkaPPKD1LP_ins.hitungSelisih('bantuSep');
				rkaPPKD1LP_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaPPKD1LP_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaPPKD1LP_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaPPKD1LP_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD1LP_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD1LP_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD1LP_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD1LP_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD1LP_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD1LP_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
