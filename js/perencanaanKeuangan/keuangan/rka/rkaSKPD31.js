var rkaSKPD31 = new DaftarObj2({
	prefix : 'rkaSKPD31',
	url : 'pages.php?Pg=rkaSKPD31',
	formName : 'rkaSKPD31Form',
	rkaSKPD31_form : '0',//default js rkaSKPD31
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
		...
		var me = this;
			...
			$.ajax({
				...
				data:$('#'+this.formName).serialize()+"&dari=rkaSKPD32",
			  	url: 'pages.php?Pg=rkaSKPD31New'+'&tipe=Laporan',
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
			...
			alert("Pilih SKPD");
				...
				data : {cmbUrusan : $("#cmbUrusan").val(),
			  	...
			  	success: function(data) {
						...
						aForm.action= 'pages.php?Pg=rkaSKPD31_ins&skpd='+skpd;
						aForm.target='_blank';
						aForm.submit();
						aForm.target='';
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD31.formatCurrency(hasilKali));
	},
	...
	findRekening : function(id){
		...
		popupRekening.filterAkun="RKA 3.1";
