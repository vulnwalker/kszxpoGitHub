var rkaPPKD1DP_insSKPD = new SkpdCls({
	prefix : 'rkaPPKD1DP_insSKPD', formName:'rkaPPKD1DP_insForm', kolomWidth:120,
...
var rkaPPKD1DP_ins = new DaftarObj2({
	prefix : 'rkaPPKD1DP_ins',
	url : 'pages.php?Pg=rkaPPKD1DP_ins',
	formName : 'rkaPPKD1DP_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD1DP_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD1DP_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaPPKD1DP_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1DP_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD1DP_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD1DP_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD1DP_ins.hitungSelisih('bantuJan');
				rkaPPKD1DP_ins.hitungSelisih('bantuFeb');
				rkaPPKD1DP_ins.hitungSelisih('bantuApr');
				rkaPPKD1DP_ins.hitungSelisih('bantuMei');
				rkaPPKD1DP_ins.hitungSelisih('bantuJul');
				rkaPPKD1DP_ins.hitungSelisih('bantuAgu');
				rkaPPKD1DP_ins.hitungSelisih('bantuOkt');
				rkaPPKD1DP_ins.hitungSelisih('bantuNop');
				rkaPPKD1DP_ins.hitungSelisih('bantuMar');
				rkaPPKD1DP_ins.hitungSelisih('bantuJun');
				rkaPPKD1DP_ins.hitungSelisih('bantuSep');
				rkaPPKD1DP_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaPPKD1DP_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaPPKD1DP_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaPPKD1DP_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD1DP_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD1DP_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD1DP_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD1DP_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD1DP_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD1DP_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
