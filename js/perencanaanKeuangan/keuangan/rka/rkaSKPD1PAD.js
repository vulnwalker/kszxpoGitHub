var rkaSKPD1PAD = new DaftarObj2({
	prefix : 'rkaSKPD1PAD',
	url : 'pages.php?Pg=rkaSKPD1PAD',
	formName : 'rkaSKPD1PADForm',
	rkaSKPD1PAD_form : '0',//default js rkaSKPD1PAD
	loading: function(){
		//alert('loading');
		this.topBarRender();
		this.filterRender();
	...
	Laporan:function(){
		var me = this;
			...
			$.ajax({
				type:'POST',
				data:$('#'+this.formName).serialize()+"&dari=rkaSKPD1PAD",
...
/*		RefBarangButuh.el_nama_barang= 'nama_barang';		*/
			...
			alert("Pilih SKPD");
				...
				data : {cmbUrusan : $("#cmbUrusan").val(),
			  	...
			  	success: function(data) {
						...
						aForm.action= 'pages.php?Pg=rkaSKPD1PAD_ins&skpd='+skpd;
						aForm.target='_blank';
						aForm.submit();
						aForm.target='';
	...
	hitungVolume: function(id){
			...
			$("#spanTotalJumlah"+id).text(rkaSKPD1PAD.formatCurrency(hasilKali));
	},
