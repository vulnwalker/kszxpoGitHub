var rkaSKPD1DP_insSKPD = new SkpdCls({
	prefix : 'rkaSKPD1DP_insSKPD', formName:'rkaSKPD1DP_insForm', kolomWidth:120,
...
var rkaSKPD1DP_ins = new DaftarObj2({
	prefix : 'rkaSKPD1DP_ins',
	url : 'pages.php?Pg=rkaSKPD1DP_ins',
	formName : 'rkaSKPD1DP_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaSKPD1DP_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaSKPD1DP_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaSKPD1DP_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaSKPD1DP_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaSKPD1DP_ins.hitungSelisih('bantuJan');
				rkaSKPD1DP_ins.hitungSelisih('bantuFeb');
				rkaSKPD1DP_ins.hitungSelisih('bantuApr');
				rkaSKPD1DP_ins.hitungSelisih('bantuMei');
				rkaSKPD1DP_ins.hitungSelisih('bantuJul');
				rkaSKPD1DP_ins.hitungSelisih('bantuAgu');
				rkaSKPD1DP_ins.hitungSelisih('bantuOkt');
				rkaSKPD1DP_ins.hitungSelisih('bantuNop');
				rkaSKPD1DP_ins.hitungSelisih('bantuMar');
				rkaSKPD1DP_ins.hitungSelisih('bantuJun');
				rkaSKPD1DP_ins.hitungSelisih('bantuSep');
				rkaSKPD1DP_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaSKPD1DP_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaSKPD1DP_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaSKPD1DP_ins.refreshList(true);
		setTimeout(function myFunction() {rkaSKPD1DP_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaSKPD1DP_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaSKPD1DP_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaSKPD1DP_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaSKPD1DP_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaSKPD1DP_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
