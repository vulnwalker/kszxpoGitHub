var rkaPPKD32_insSKPD = new SkpdCls({
	prefix : 'rkaPPKD32_insSKPD', formName:'rkaPPKD32_insForm', kolomWidth:120,
...
var rkaPPKD32_ins = new DaftarObj2({
	prefix : 'rkaPPKD32_ins',
	url : 'pages.php?Pg=rkaPPKD32_ins',
	formName : 'rkaPPKD32_insForm',
	...
	hitungSelisih:function(namaBantu){
		...
		$("#"+namaBantu).text("Rp. "+rkaPPKD32_ins.formatCurrency($("#"+idPost).val())  );
		...
		$("#selisih").val(selisih);
		$("#bantuPenjumlahan").text("Rp. "+rkaPPKD32_ins.formatCurrency(jumlahHargaAlokasi)  );
		$("#bantuSelisih").text("Rp. "+rkaPPKD32_ins.formatCurrency(selisih)  );
	},
					...
					data : {
				  	...
				  	success: function(data) {
						...
						if(resp.err == ''){
							...
							$("#bantuJumlahHarga").text("Rp. "+rkaPPKD32_ins.formatCurrency($("#jumlahHarga").val()));
						}else{
							alert(resp.err);
						}
				  	}
	...
	bantu : function(){
		$("#bantuSatuanHarga").text("Rp. "+rkaPPKD32_ins.formatCurrency($("#hargaSatuan").val())  );
		$("#jumlahHarga").val($("#hargaSatuan").val() * $("#volumeBarang").val());
		$("#bantuJumlahHarga").text("Rp. "+rkaPPKD32_ins.formatCurrency($("#jumlahHarga").val()));
		$("#teralokasi").val('');
	},
	...
	hitung: function(){
		if($("#jenisAlokasi").val() == '' ){
			...
			if($("#jenisAlokasi").val() == "BULANAN"){
				...
				rkaPPKD32_ins.hitungSelisih('bantuJan');
				rkaPPKD32_ins.hitungSelisih('bantuFeb');
				rkaPPKD32_ins.hitungSelisih('bantuApr');
				rkaPPKD32_ins.hitungSelisih('bantuMei');
				rkaPPKD32_ins.hitungSelisih('bantuJul');
				rkaPPKD32_ins.hitungSelisih('bantuAgu');
				rkaPPKD32_ins.hitungSelisih('bantuOkt');
				rkaPPKD32_ins.hitungSelisih('bantuNop');
				rkaPPKD32_ins.hitungSelisih('bantuMar');
				rkaPPKD32_ins.hitungSelisih('bantuJun');
				rkaPPKD32_ins.hitungSelisih('bantuSep');
				rkaPPKD32_ins.hitungSelisih('bantuDes');
	...
	jenisAlokasiChanged : function(){
		...
		if($("#jenisAlokasi").val() == "BULANAN"){
			...
			$.ajax({
				...
				url: this.url+'&tipe=clearAlokasi',
				success: function(data) {
					rkaPPKD32_ins.formAlokasiTriwulan();
				}
			});
	...
	hapus : function(id){
		$.ajax({
				...
				success: function(data) {
					rkaPPKD32_ins.refreshList(true);
	...
	cancelEdit : function(){
		rkaPPKD32_ins.refreshList(true);
		setTimeout(function myFunction() {rkaPPKD32_ins.refreshList(true);},1000);
	},
				...
				success: function(data) {
					...
					if(resp.content.kunci == '0'){
						...
						if(resp.content.jenis_alokasi_kas == "TRIWULAN"){
							$("#tombolAlokasi").attr("onclick","rkaPPKD32_ins.formAlokasiTriwulan();");
						}else{
							$("#tombolAlokasi").attr("onclick","rkaPPKD32_ins.formAlokasi();");
						}
						...
						$("#btsave").attr('href','javascript:rkaPPKD32_ins.saveEdit('+id+')');
						$("#btcancel").attr('href','javascript:rkaPPKD32_ins.cancelEdit()');
				...
				success: function(data) {
					...
					if(resp.err == ''){
						...
						if(resp.err == "Lengkapi Alokasi"){
							...
							rkaPPKD32_ins.formRincianVolume();
						}else{
							alert(resp.err);
						}
