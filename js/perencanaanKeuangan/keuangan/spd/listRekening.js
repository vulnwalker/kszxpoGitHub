var listRekening = new DaftarObj2({
	prefix : 'listRekening',
	url : 'pages.php?Pg=listRekening', 
	formName : 'listRekeningForm',
	...
	windowSave: function(){
		var me= this;
			...
			$.ajax({
			type : 'POST',
				url: 'pages.php?Pg=listRekening&tipe=setValueTemplate',
				data:{id : document.getElementById('idTemplate').value,
					  c  : document.getElementById('c').value,
					  d  : document.getElementById('d').value,
					  e  : document.getElementById('cmbUnit').value,
					  currentPosition : document.getElementById("listRekening_hal_fmHAL").value
					 },
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					var limit = resp.cek;
