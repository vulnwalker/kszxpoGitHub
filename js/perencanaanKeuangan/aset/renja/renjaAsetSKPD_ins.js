var renjaAsetSKPD_insSKPD = new SkpdCls({
	prefix : 'renjaAsetSKPD_insSKPD', formName:'renjaAsetSKPD_insForm', kolomWidth:120,
...
var renjaAsetSKPD_ins = new DaftarObj2({
	prefix : 'renjaAsetSKPD_ins',
	url : 'pages.php?Pg=renjaAsetSKPD_ins',
	formName : 'renjaAsetSKPD_insForm',
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renjaAsetSKPD_ins.CekSesuai()},1000);
