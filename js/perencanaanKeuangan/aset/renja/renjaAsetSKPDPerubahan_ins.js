var renjaAsetSKPDPerubahan_insSKPD = new SkpdCls({
	prefix : 'renjaAsetSKPDPerubahan_insSKPD', formName:'renjaAsetSKPDPerubahan_insForm', kolomWidth:120,
...
var renjaAsetSKPDPerubahan_ins = new DaftarObj2({
	prefix : 'renjaAsetSKPDPerubahan_ins',
	url : 'pages.php?Pg=renjaAsetSKPDPerubahan_ins', 
	formName : 'renjaAsetSKPDPerubahan_insForm',
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renjaAsetSKPDPerubahan_ins.CekSesuai()},1000);
