var renja_ins_v3SKPD = new SkpdCls({
	prefix : 'renja_ins_v3SKPD', formName:'renja_ins_v3Form', kolomWidth:120,
...
var renja_ins_v3 = new DaftarObj2({
	prefix : 'renja_ins_v3',
	url : 'pages.php?Pg=renja_ins_v3', 
	formName : 'renja_ins_v3Form',
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renja_ins_v3.CekSesuai()},1000);
