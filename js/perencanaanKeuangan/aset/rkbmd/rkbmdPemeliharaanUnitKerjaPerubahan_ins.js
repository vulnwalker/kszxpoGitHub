var rkbmdPemeliharaanUnitKerjaPerubahan_insSKPD = new SkpdCls({
	prefix : 'rkbmdPemeliharaanUnitKerjaPerubahan_insSKPD', formName:'rkbmdPemeliharaanUnitKerjaPerubahan_insForm', kolomWidth:120,
...
var rkbmdPemeliharaanUnitKerjaPerubahan_ins = new DaftarObj2({
	prefix : 'rkbmdPemeliharaanUnitKerjaPerubahan_ins',
	url : 'pages.php?Pg=rkbmdPemeliharaanUnitKerjaPerubahan_ins',
	formName : 'rkbmdPemeliharaanUnitKerjaPerubahan_insForm',
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(resp.content.status == 'ada'){
						rkbmdPemeliharaanUnitKerjaPerubahan_ins.refreshList(true);
					}
    ...
    CariProgram: function(idRenja){
		var me = this;
		popupProgramRKBMDUnitKerja.idRenja = idRenja;
		popupProgramRKBMDUnitKerja.kategori = "PEMELIHARAAN";
		popupProgramRKBMDUnitKerja.windowShow();
	...
	CariBarang: function(kodeSKPD){
		...
		if($("#q").val() == ''){
			...
			popupBarangRKBMDPemeliharaan.skpd = kodeSKPD;
			popupBarangRKBMDPemeliharaan.windowShow();
		}
		...
		$.ajax({
				...
				success: function(data) {
					...
					if(resp.err==''){
						...
						rkbmdPemeliharaanUnitKerjaPerubahan_ins.tabelPemeliharaan(1);
						document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subSimpan();';
						document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subCancel();';
						...
						if(resp.content.hubla != 0){
							setTimeout(function(){
							 rkbmdPemeliharaanUnitKerjaPerubahan_ins.subSubEdit(resp.content.hubla);
							}, 500);
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(resp.err==''){
						...
						rkbmdPemeliharaanUnitKerjaPerubahan_ins.tabelPemeliharaan(idnya);
	...
	subSubEdit: function(id){
		/*rkbmdPemeliharaanUnitKerjaPerubahan_ins.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subSubCancel()');
		...
		$("#action"+id).attr('onclick','rkbmdPemeliharaanUnitKerjaPerubahan_ins.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {
				var resp = eval('(' + data + ')');
				document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.moveBack();';
				document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subCancel();';
				rkbmdPemeliharaanUnitKerjaPerubahan_ins.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.subCancel();';
					document.getElementById('findBarang').disabled = true;
				}
			});
	...
	subCancel : function(){
		$.ajax({
				...
				success: function(data) {
					...
					$("#keterangan").val('');
					$("#jumlah").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerjaPerubahan_ins.closeTab();';
