var rkbmdPersediaanUnitKerja_insSKPD = new SkpdCls({
	prefix : 'rkbmdPersediaanUnitKerja_insSKPD', formName:'rkbmdPersediaanUnitKerja_insForm', kolomWidth:120,
...
var rkbmdPersediaanUnitKerja_ins = new DaftarObj2({
	prefix : 'rkbmdPersediaanUnitKerja_ins',
	url : 'pages.php?Pg=rkbmdPersediaanUnitKerja_ins',
	formName : 'rkbmdPersediaanUnitKerja_insForm',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPersediaanUnitKerja_ins.refreshList(true);
				}
			});
		}else{
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanUnitKerja_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanUnitKerja_ins.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanUnitKerja_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanUnitKerja_ins.closeTab();';
