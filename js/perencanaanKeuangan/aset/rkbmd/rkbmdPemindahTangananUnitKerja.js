var rkbmdPemindahTangananUnitKerjaSkpd = new SkpdCls({
	prefix : 'rkbmdPemindahTangananUnitKerjaSkpd', 
	formName: 'rkbmdPemindahTangananUnitKerjaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPemindahTangananUnitKerja.refreshList(true);
	},
...
var rkbmdPemindahTangananUnitKerja = new DaftarObj2({
	prefix : 'rkbmdPemindahTangananUnitKerja',
	url : 'pages.php?Pg=rkbmdPemindahTangananUnitKerja', 
	formName : 'rkbmdPemindahTangananUnitKerjaForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkiba').style.display = 'none';
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkibb').style.display = 'none';
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkibc').style.display = 'none';
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkibd').style.display = 'none';
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkibe').style.display = 'none';
		document.getElementById('rkbmdPemindahTangananUnitKerja_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkibb').style.display = 'block';
				break;
			}
			case '03': {
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPemindahTangananUnitKerja_formkibf').style.display = 'block';
				break;
			}
		}	
