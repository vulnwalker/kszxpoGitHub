var rkbmdPemindahtangananSKPDSkpd = new SkpdCls({
	prefix : 'rkbmdPemindahtangananSKPDSkpd', 
	formName: 'rkbmdPemindahtangananSKPDForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPemindahtangananSKPD.refreshList(true);
	},
...
var rkbmdPemindahtangananSKPD = new DaftarObj2({
	prefix : 'rkbmdPemindahtangananSKPD',
	url : 'pages.php?Pg=rkbmdPemindahtangananSKPD', 
	formName : 'rkbmdPemindahtangananSKPDForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPemindahtangananSKPD_formkiba').style.display = 'none';
		document.getElementById('rkbmdPemindahtangananSKPD_formkibb').style.display = 'none';
		document.getElementById('rkbmdPemindahtangananSKPD_formkibc').style.display = 'none';
		document.getElementById('rkbmdPemindahtangananSKPD_formkibd').style.display = 'none';
		document.getElementById('rkbmdPemindahtangananSKPD_formkibe').style.display = 'none';
		document.getElementById('rkbmdPemindahtangananSKPD_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPemindahtangananSKPD_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPemindahtangananSKPD_formkibb').style.display = 'block';
				break;
			}
			case '03': {
				document.getElementById('rkbmdPemindahtangananSKPD_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPemindahtangananSKPD_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPemindahtangananSKPD_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPemindahtangananSKPD_formkibf').style.display = 'block';
				break;
			}
		}	
