var rkbmdPemanfaatanSKPDSkpd = new SkpdCls({
	prefix : 'rkbmdPemanfaatanSKPDSkpd', 
	formName: 'rkbmdPemanfaatanSKPDForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPemanfaatanSKPD.refreshList(true);
	},
...
var rkbmdPemanfaatanSKPD = new DaftarObj2({
	prefix : 'rkbmdPemanfaatanSKPD',
	url : 'pages.php?Pg=rkbmdPemanfaatanSKPD', 
	formName : 'rkbmdPemanfaatanSKPDForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPemanfaatanSKPD_formkiba').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanSKPD_formkibb').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanSKPD_formkibc').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanSKPD_formkibd').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanSKPD_formkibe').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanSKPD_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPemanfaatanSKPD_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPemanfaatanSKPD_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rkbmdPemanfaatanSKPD_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPemanfaatanSKPD_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPemanfaatanSKPD_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPemanfaatanSKPD_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rkbmdPemanfaatanSKPD'>"+
