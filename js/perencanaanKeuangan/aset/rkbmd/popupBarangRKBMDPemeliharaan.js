var popupBarangRKBMDPemeliharaan = new DaftarObj2({
	prefix : 'popupBarangRKBMDPemeliharaan',
	url : 'pages.php?Pg=popupBarangRKBMDPemeliharaan', 
	formName : 'popupBarangRKBMDPemeliharaanForm',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=popupBarangRKBMDPemeliharaan&tipe=getdata&id='+id,
				type : 'POST',
