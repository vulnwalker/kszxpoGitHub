var rkbmdPemeliharaanUnitKerja_ins_v3SKPD = new SkpdCls({
	prefix : 'rkbmdPemeliharaanUnitKerja_ins_v3SKPD', formName:'rkbmdPemeliharaanUnitKerja_insForm', kolomWidth:120,
...
var rkbmdPemeliharaanUnitKerja_ins = new DaftarObj2({
	prefix : 'rkbmdPemeliharaanUnitKerja_ins',
	url : 'pages.php?Pg=rkbmdPemeliharaanUnitKerja_ins',
	formName : 'rkbmdPemeliharaanUnitKerja_insForm',
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(resp.content.status == 'ada'){
						rkbmdPemeliharaanUnitKerja_ins.refreshList(true);
					}
		...
		$.ajax({
				...
				success: function(data) {
					...
					if(resp.err==''){
						...
						rkbmdPemeliharaanUnitKerja_ins.tabelPemeliharaan(1);
						document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.subSimpan();';
						document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.subCancel();';
						...
						if(resp.content.hubla != 0){
							setTimeout(function(){
							 rkbmdPemeliharaanUnitKerja_ins.subSubEdit(resp.content.hubla);
							}, 500);
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(resp.err==''){
						...
						rkbmdPemeliharaanUnitKerja_ins.tabelPemeliharaan(idnya);
	...
	subSubEdit: function(id){
		/*rkbmdPemeliharaanUnitKerja_ins.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:rkbmdPemeliharaanUnitKerja_ins.subSubCancel()');
		...
		$("#action"+id).attr('onclick','rkbmdPemeliharaanUnitKerja_ins.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {
				var resp = eval('(' + data + ')');
				document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.moveBack();';
				document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.subCancel();';
				rkbmdPemeliharaanUnitKerja_ins.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.subCancel();';
					document.getElementById('findBarang').disabled = true;
				}
			});
	...
	subCancel : function(){
		$.ajax({
				...
				success: function(data) {
					...
					$("#keterangan").val('');
					$("#jumlah").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPemeliharaanUnitKerja_ins.closeTab();';
