var rkbmdPengadaanUnitKerjaPerubahan_insSKPD = new SkpdCls({
	prefix : 'rkbmdPengadaanUnitKerjaPerubahan_insSKPD', formName:'rkbmdPengadaanUnitKerjaPerubahan_insForm', kolomWidth:120,
...
var rkbmdPengadaanUnitKerjaPerubahan_ins = new DaftarObj2({
	prefix : 'rkbmdPengadaanUnitKerjaPerubahan_ins',
	url : 'pages.php?Pg=rkbmdPengadaanUnitKerjaPerubahan_ins', 
	formName : 'rkbmdPengadaanUnitKerjaPerubahan_insForm',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {	
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPengadaanUnitKerjaPerubahan_ins.refreshList(true);			
				}
			});
		}else{
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {	
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.subCancel();'; 
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPengadaanUnitKerjaPerubahan_ins.closeTab();'; 
