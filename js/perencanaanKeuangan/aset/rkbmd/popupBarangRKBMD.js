var popupBarangRKBMD = new DaftarObj2({
	prefix : 'popupBarangRKBMD',
	url : 'pages.php?Pg=popupBarangRKBMD', 
	formName : 'popupBarangRKBMDForm',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=popupBarangRKBMD&tipe=getdata&id='+id,
				type : 'POST',
				data : dataRKBMD,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
