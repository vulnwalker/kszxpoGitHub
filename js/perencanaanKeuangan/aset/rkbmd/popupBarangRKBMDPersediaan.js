var popupBarangRKBMDPersediaan = new DaftarObj2({
	prefix : 'popupBarangRKBMDPersediaan',
	url : 'pages.php?Pg=popupBarangRKBMDPersediaan', 
	formName : 'popupBarangRKBMDPersediaanForm',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=popupBarangRKBMDPersediaan&tipe=getdata&id='+id,
				type : 'POST',
