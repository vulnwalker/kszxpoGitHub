var rkbmdPersediaanUnitKerjaPerubahan_insSKPD = new SkpdCls({
	prefix : 'rkbmdPersediaanUnitKerjaPerubahan_insSKPD', formName:'rkbmdPersediaanUnitKerjaPerubahan_insForm', kolomWidth:120,
...
var rkbmdPersediaanUnitKerjaPerubahan_ins = new DaftarObj2({
	prefix : 'rkbmdPersediaanUnitKerjaPerubahan_ins',
	url : 'pages.php?Pg=rkbmdPersediaanUnitKerjaPerubahan_ins',
	formName : 'rkbmdPersediaanUnitKerjaPerubahan_insForm',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPersediaanUnitKerjaPerubahan_ins.refreshList(true);
				}
			});
		}else{
    ...
    CariProgram: function(idRenja){
		...
		popupProgramRKBMDUnitKerja.kategori = "PENGADAAN";
		popupProgramRKBMDUnitKerja.windowShow();

	},
	CariBarang: function(){
		var me = this;
		popupBarangRKBMDPersediaan.windowShow();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanUnitKerjaPerubahan_ins.closeTab();';
