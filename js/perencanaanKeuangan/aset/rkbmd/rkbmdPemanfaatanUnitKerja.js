var rkbmdPemanfaatanUnitKerjaSkpd = new SkpdCls({
	prefix : 'rkbmdPemanfaatanUnitKerjaSkpd', 
	formName: 'rkbmdPemanfaatanUnitKerjaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPemanfaatanUnitKerja.refreshList(true);
	},
...
var rkbmdPemanfaatanUnitKerja = new DaftarObj2({
	prefix : 'rkbmdPemanfaatanUnitKerja',
	url : 'pages.php?Pg=rkbmdPemanfaatanUnitKerja', 
	formName : 'rkbmdPemanfaatanUnitKerjaForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkiba').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkibb').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkibc').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkibd').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkibe').style.display = 'none';
		document.getElementById('rkbmdPemanfaatanUnitKerja_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPemanfaatanUnitKerja_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rkbmdPemanfaatanUnitKerja'>"+
