var rkbmdPenghapusanUnitKerjaSkpd = new SkpdCls({
	prefix : 'rkbmdPenghapusanUnitKerjaSkpd', 
	formName: 'rkbmdPenghapusanUnitKerjaForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPenghapusanUnitKerja.refreshList(true);
	},
...
var rkbmdPenghapusanUnitKerja = new DaftarObj2({
	prefix : 'rkbmdPenghapusanUnitKerja',
	url : 'pages.php?Pg=rkbmdPenghapusanUnitKerja', 
	formName : 'rkbmdPenghapusanUnitKerjaForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPenghapusanUnitKerja_formkiba').style.display = 'none';
		document.getElementById('rkbmdPenghapusanUnitKerja_formkibb').style.display = 'none';
		document.getElementById('rkbmdPenghapusanUnitKerja_formkibc').style.display = 'none';
		document.getElementById('rkbmdPenghapusanUnitKerja_formkibd').style.display = 'none';
		document.getElementById('rkbmdPenghapusanUnitKerja_formkibe').style.display = 'none';
		document.getElementById('rkbmdPenghapusanUnitKerja_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPenghapusanUnitKerja_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPenghapusanUnitKerja_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rkbmdPenghapusanUnitKerja_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPenghapusanUnitKerja_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPenghapusanUnitKerja_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPenghapusanUnitKerja_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rkbmdPenghapusanUnitKerja'>"+
