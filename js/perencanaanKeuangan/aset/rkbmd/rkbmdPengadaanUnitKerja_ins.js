var rkbmdPengadaanUnitKerja_insSKPD = new SkpdCls({
	prefix : 'rkbmdPengadaanUnitKerja_insSKPD', formName:'rkbmdPengadaanUnitKerja_insForm', kolomWidth:120,
...
var rkbmdPengadaanUnitKerja_ins = new DaftarObj2({
	prefix : 'rkbmdPengadaanUnitKerja_ins',
	url : 'pages.php?Pg=rkbmdPengadaanUnitKerja_ins',
	formName : 'rkbmdPengadaanUnitKerja_insForm',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPengadaanUnitKerja_ins.refreshList(true);
				}
			});
		}else{
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPengadaanUnitKerja_ins.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPengadaanUnitKerja_ins.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPengadaanUnitKerja_ins.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPengadaanUnitKerja_ins.closeTab();';
