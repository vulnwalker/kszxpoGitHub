var rkbmdPenghapusanSKPDSkpd = new SkpdCls({
	prefix : 'rkbmdPenghapusanSKPDSkpd', 
	formName: 'rkbmdPenghapusanSKPDForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rkbmdPenghapusanSKPD.refreshList(true);
	},
...
var rkbmdPenghapusanSKPD = new DaftarObj2({
	prefix : 'rkbmdPenghapusanSKPD',
	url : 'pages.php?Pg=rkbmdPenghapusanSKPD', 
	formName : 'rkbmdPenghapusanSKPDForm',
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rkbmdPenghapusanSKPD_formkiba').style.display = 'none';
		document.getElementById('rkbmdPenghapusanSKPD_formkibb').style.display = 'none';
		document.getElementById('rkbmdPenghapusanSKPD_formkibc').style.display = 'none';
		document.getElementById('rkbmdPenghapusanSKPD_formkibd').style.display = 'none';
		document.getElementById('rkbmdPenghapusanSKPD_formkibe').style.display = 'none';
		document.getElementById('rkbmdPenghapusanSKPD_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rkbmdPenghapusanSKPD_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rkbmdPenghapusanSKPD_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rkbmdPenghapusanSKPD_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rkbmdPenghapusanSKPD_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rkbmdPenghapusanSKPD_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rkbmdPenghapusanSKPD_formkibf').style.display = 'block';
				break;
			}
		}	
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {		
				...
				if (resp.err ==''){		
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rkbmdPenghapusanSKPD'>"+
