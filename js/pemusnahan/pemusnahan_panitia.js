var pemusnahan_panitiaSkpd = new SkpdCls({
	prefix : 'pemusnahan_panitiaSkpd', formName:'pemusnahan_panitiaForm'
});

var pemusnahan_panitia = new DaftarObj2({
	prefix : 'pemusnahan_panitia',	
	url : 'pages.php?Pg=pemusnahan_panitia&ajx=1',
