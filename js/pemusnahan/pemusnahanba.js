var pemusnahanbaSkpd = new SkpdCls({
	prefix : 'pemusnahanbaSkpd', formName:'pemusnahanbaForm'
});

var pemusnahanba = new DaftarObj2({
	prefix : 'pemusnahanba',	
	url : 'pages.php?Pg=pemusnahanba&ajx=1',
	formName : 'pemusnahanbaForm',
	...
	Baru2: function(){	
		...
		var settingurusan = document.getElementById('settingurusan').value;
		if(settingurusan==1){
		...
		if(err=='' && ( (settingurusan==1) && (urusan=='0' || urusan=='') ) ) err='Urusan belum dipilih!';
	...
	*/
	AfterFormBaru:function(){		
		//alert("tes");
		idp = document.getElementById('pemusnahanba_idplh').value;
		document.getElementById('divPanitiaList').innerHTML = 
			//"<div id='pemusnahan_panitia_cont_title' style='position:relative'></div>"+
			"<div id='pemusnahan_panitia_cont_opsi' style='position:relative'>"+
			"<input type='hidden' name='idp' id='idp' value='"+idp+"'>"+
			"</div>"+
			"<div id='pemusnahan_panitia_cont_daftar' style='position:relative'></div>"+
			"<div id='pemusnahan_panitia_cont_hal' style='position:relative'></div>";
		//generate data
		pemusnahan_panitia.loading();
	},
	
	AfterFormBaru2:function(){		
		//alert("tes");
		idp = document.getElementById('pemusnahanba_idplh').value;
		document.getElementById('divBarangList').innerHTML = 
			//"<div id='pemusnahan_det_cont_title' style='position:relative'></div>"+
			"<div id='pemusnahan_det_cont_opsi' style='position:relative'>"+
			"<input type='hidden' name='idp' id='idp' value='"+idp+"'>"+
			"</div>"+
			"<div id='pemusnahan_det_cont_daftar' style='position:relative'></div>"+
			"<div id='pemusnahan_det_cont_hal' style='position:relative'></div>";
		//generate data
		pemusnahan_det.loading();
	},
	...
	showPanitia:function(divID) {
     var item = document.getElementById(divID);
	 var img = document.getElementById('barPanitia_ico');
	 ...
	 showBarang:function(divID) {
     var item = document.getElementById(divID);
	 var img = document.getElementById('barBarang_ico');
	 if(item.style.display == 'none'){
          item.style.display = 'block';
		  img.src  = 'images/tumbs/down.png';
