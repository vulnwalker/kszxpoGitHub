var RekapNeracaSKPDSkpd = new SkpdCls({
	prefix : 'RekapNeracaSKPDSkpd', formName:'adminForm'
});


var RekapNeracaSKPD = new DaftarObj2({
	prefix : 'RekapNeracaSKPD',
	//url : 'pages.php?Pg=Rekap2Ajx', 
	url : 'pages.php?Pg=RekapNeracaSKPD', 
	...
	reqTotal : function(href_, idel_,iterator_){
		var me = this;	
		var href_ = href_.replace("Jurnal","RekapNeracaSKPD");	
		if(href_!=''){
