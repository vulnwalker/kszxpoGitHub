var ref_urusan2 = new DaftarObj2({
	prefix : 'ref_urusan2',
	url : 'pages.php?Pg=ref_urusan2', 
	formName : 'ref_urusan2Form',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'ref_urusan2_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=ref_urusan2&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
