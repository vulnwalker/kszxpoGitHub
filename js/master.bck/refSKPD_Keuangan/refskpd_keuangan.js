var refSKPD_Keuangan = new DaftarObj2({
	prefix : 'refSKPD_Keuangan',
	url : 'pages.php?Pg=refSKPD_Keuangan', 
	formName : 'refSKPD_KeuanganForm',
	el_kode_urusan : '',
	el_nama_urusan: '',
	...
	windowSave: function(){
		...
		if(errmsg ==''){ 
			...
			var cover = 'refSKPD_Keuangan_getdata';
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=refSKPD_Keuangan&tipe=getdata&id='+this.idpilih,
			  	success: function(data) {		
					var resp = eval('(' + data + ')');			
					delElem(cover);
					if(resp.err==''){
