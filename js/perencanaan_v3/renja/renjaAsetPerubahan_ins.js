var renjaAsetPerubahan_insSKPD = new SkpdCls({
	prefix : 'renjaAsetPerubahan_insSKPD', formName:'renjaAsetPerubahan_insForm', kolomWidth:120,
...
var renjaAsetPerubahan_ins = new DaftarObj2({
	prefix : 'renjaAsetPerubahan_ins',
	url : 'pages.php?Pg=renjaAsetPerubahan_ins',
	formName : 'renjaAsetPerubahan_insForm',
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renjaAsetPerubahan_ins.CekSesuai()},1000);
