var renjaAset_insSKPD = new SkpdCls({
	prefix : 'renjaAset_insSKPD', formName:'renjaAset_insForm', kolomWidth:120,
...
var renjaAset_ins = new DaftarObj2({
	prefix : 'renjaAset_ins',
	url : 'pages.php?Pg=renjaAset_ins', 
	formName : 'renjaAset_insForm',
		...
		$.ajax({
			...
			success: function(data) {	
				...
				if(resp.err==''){
					...
					setTimeout(function myFunction() {renjaAset_ins.CekSesuai()},1000);
