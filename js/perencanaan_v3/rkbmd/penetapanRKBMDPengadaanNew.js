var penetapanRKBMDPengadaanNewSkpd = new SkpdCls({
	prefix : 'penetapanRKBMDPengadaanNewSkpd',
	formName: 'penetapanRKBMDPengadaanNewForm',
	pilihBidangAfter : function(){penetapanRKBMDPengadaanNew.refreshList(true);},
	pilihUnitAfter : function(){penetapanRKBMDPengadaanNew.refreshList(true);},
	pilihSubUnitAfter : function(){penetapanRKBMDPengadaanNew.refreshList(true);},
	pilihSeksiAfter : function(){penetapanRKBMDPengadaanNew.refreshList(true);}
});

var penetapanRKBMDPengadaanNew = new DaftarObj2({
	prefix : 'penetapanRKBMDPengadaanNew',
	url : 'pages.php?Pg=penetapanRKBMDPengadaanNew',
	formName : 'penetapanRKBMDPengadaanNewForm',
	...
	daftarRender:function(){
		var jenisKegiatan = document.getElementById('cmbJenispenetapanRKBMDPengadaanNew');
		/*cmbJenispenetapanRKBMDPengadaanNew.remove(0);*/
	...
	remove:function(){
		...
		if(errmsg ==''){
			...
			$.ajax({
			  ...
			  success: function(data) {
					var resp = eval('(' + data + ')');
					penetapanRKBMDPengadaanNew.refreshList(true);
	...
	Baru: function(){
		var me = this;
		var err='';
		var urusan = document.getElementById('penetapanRKBMDPengadaanSkpdfmUrusan').value; 
		var bidang = document.getElementById('penetapanRKBMDPengadaanSkpdfmSKPD').value; 
		var skpd = document.getElementById('penetapanRKBMDPengadaanSkpdfmUNIT').value;
			...
			url: this.url+'&tipe=Report',
		  	success: function(data) {
				...
				if(resp.err==''){
					...
					aForm.action= url2+'&tipe='+resp.content.to+'&urusan='+$("#penetapanRKBMDPengadaanSkpdfmUrusan").val()+'&bidang='+$("#penetapanRKBMDPengadaanSkpdfmSKPD").val()+'&skpd='+$("#penetapanRKBMDPengadaanSkpdfmUNIT").val()+'&kota='+resp.content.namaPemda+'&tanggalCetak='+resp.content.cetakjang+'&ttd='+resp.content.ttd;
					aForm.target='_blank';
					aForm.submit();
					aForm.target='';
					me.Close();
	...
	bantu : function(id){
		...
		$("#bantu"+id).text(penetapanRKBMDPengadaanNew.formatCurrency(angka));
	},
			...
			url: this.url+'&tipe=Report',
		  	success: function(data) {
				...
				if(resp.err==''){
					...
					aForm.action= url2+'&tipe='+resp.content.to+'&xls=1'+'&urusan='+$("#penetapanRKBMDPengadaanSkpdfmUrusan").val()+'&bidang='+$("#penetapanRKBMDPengadaanSkpdfmSKPD").val()+'&skpd='+$("#penetapanRKBMDPengadaanSkpdfmUNIT").val()+'&kota='+resp.content.namaPemda+'&tanggalCetak='+resp.content.cetakjang+'&ttd='+resp.content.ttd;
					aForm.target='_blank';
					aForm.submit();
					aForm.target='';
					me.Close();
