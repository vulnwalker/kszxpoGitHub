var rencana_pemanfaatanSkpd = new SkpdCls({
	prefix : 'rencana_pemanfaatanSkpd',
	formName: 'rencana_pemanfaatanForm',// 'adminForm'
	pilihBidangAfter:function(){
		//rencana_pemanfaatan.refreshList(true);
	},
...
var rencana_pemanfaatan = new DaftarObj2({
	prefix : 'rencana_pemanfaatan',
	url : 'pages.php?Pg=rencana_pemanfaatan',
	formName : 'rencana_pemanfaatanForm',
	...
	CetakSemua:function(){
		var me = this;
			...
			$.ajax({
				type:'POST',
				data:$('#'+this.formName).serialize(),
			  	url: 'pages.php?Pg=rencanaPemanfaatanNew'+'&tipe=CetakSemua',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					if(resp.err == ''){
						document.getElementById(cover).innerHTML = resp.content;
	...
	CetakHal:function(){
		var me = this;
			...
			$.ajax({
				type:'POST',
				data:$('#'+this.formName).serialize(),
			  	url: 'pages.php?Pg=rencanaPemanfaatanNew'+'&tipe=CetakHal',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					if(resp.err == ''){
						document.getElementById(cover).innerHTML = resp.content;
	...
	formSetDetailEntry : function(){
		...
		document.getElementById('rencana_pemanfaatan_formkiba').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_formkibb').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_formkibc').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_formkibd').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_formkibe').style.display = 'none';
		document.getElementById('rencana_pemanfaatan_formkibf').style.display = 'none';
		switch(jnsbrg){
			case '01': {
				document.getElementById('rencana_pemanfaatan_formkiba').style.display = 'block';
				break;
			}
			case '02': {
				document.getElementById('rencana_pemanfaatan_formkibb').style.display = 'block';
				break;
			}
			case '03':  {
				document.getElementById('rencana_pemanfaatan_formkibc').style.display = 'block';
				break;
			}
			case '04':{
				document.getElementById('rencana_pemanfaatan_formkibd').style.display = 'block';
				break;
			}
			case '05': {
				document.getElementById('rencana_pemanfaatan_formkibe').style.display = 'block';
				break;
			}
			case '06': {
				document.getElementById('rencana_pemanfaatan_formkibf').style.display = 'block';
				break;
			}
		}
			...
			url: this.url+'&tipe=formCari&sw='+sw+'&sh='+sh,
		  	success: function(data) {
				...
				if (resp.err ==''){
					...
					"<input type='hidden' id='formcaribi' name='formcaribi' value='rencana_pemanfaatan'>"+
