var popupBarangRKBMDPersediaan_v3 = new DaftarObj2({
	prefix : 'popupBarangRKBMDPersediaan_v3',
	url : 'pages.php?Pg=popupBarangRKBMDPersediaan_v3', 
	formName : 'popupBarangRKBMDPersediaan_v3Form',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);				
			$.ajax({
				url: 'pages.php?Pg=popupBarangRKBMDPersediaan_v3&tipe=getdata&id='+id,
				type : 'POST',
