var rkbmd_ins_v3SKPD = new SkpdCls({
	prefix : 'rkbmd_ins_v3SKPD', formName:'rkbmd_ins_v3Form', kolomWidth:120,
...
var rkbmd_ins_v3 = new DaftarObj2({
	prefix : 'rkbmd_ins_v3',
	url : 'pages.php?Pg=rkbmd_ins_v3',
	formName : 'rkbmd_ins_v3Form',
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmd_ins_v3.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmd_ins_v3.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmd_ins_v3.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmd_ins_v3.closeTab();';
