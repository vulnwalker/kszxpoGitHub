var rkbmdPerubahan_pemeliharaan_v3SKPD = new SkpdCls({
	prefix : 'rkbmdPerubahan_pemeliharaan_v3SKPD', formName:'rkbmdPerubahan_pemeliharaan_v3Form', kolomWidth:120,
...
var rkbmdPerubahan_pemeliharaan_v3 = new DaftarObj2({
	prefix : 'rkbmdPerubahan_pemeliharaan_v3',
	url : 'pages.php?Pg=rkbmdPerubahan_pemeliharaan_v3',
	formName : 'rkbmdPerubahan_pemeliharaan_v3Form',
			...
			$.ajax({
				...
				success: function(data) {
					...
					if(resp.content.status == 'ada'){
						rkbmdPerubahan_pemeliharaan_v3.refreshList(true);
					}
		...
		$.ajax({
				...
				success: function(data) {
					...
					if(resp.err==''){
						...
						rkbmdPerubahan_pemeliharaan_v3.tabelPemeliharaan(1);
						document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.subSimpan();';
						document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.subCancel();';
						...
						if(resp.content.hubla != 0){
							setTimeout(function(){
							 rkbmdPerubahan_pemeliharaan_v3.subSubEdit(resp.content.hubla);
							}, 500);
		...
		$.ajax({
			...
			success: function(data) {
				...
				if(resp.err==''){
						...
						rkbmdPerubahan_pemeliharaan_v3.tabelPemeliharaan(idnya);
	...
	subSubEdit: function(id){
		/*rkbmdPerubahan_pemeliharaan_v3.tabelPemeliharaan(1);*/
		$("#linkAtasButton").attr('href','javascript:rkbmdPerubahan_pemeliharaan_v3.subSubCancel()');
		...
		$("#action"+id).attr('onclick','rkbmdPerubahan_pemeliharaan_v3.subSubSave('+id+')');
	...
	moveList: function(id){
		$.ajax({
			...
			success: function(data) {
				var resp = eval('(' + data + ')');
				document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.moveBack();';
				document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.subCancel();';
				rkbmdPerubahan_pemeliharaan_v3.tabelPemeliharaan(1);
				$("#tbl_pemeliharaan").show();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.subCancel();';
					document.getElementById('findBarang').disabled = true;
				}
			});
	...
	subCancel : function(){
		$.ajax({
				...
				success: function(data) {
					...
					$("#keterangan").val('');
					$("#jumlah").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPerubahan_pemeliharaan_v3.closeTab();';
