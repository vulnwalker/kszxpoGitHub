var rkbmdPersediaan_ins_v3SKPD = new SkpdCls({
	prefix : 'rkbmdPersediaan_ins_v3SKPD', formName:'rkbmdPersediaan_ins_v3Form', kolomWidth:120,
...
var rkbmdPersediaan_ins_v3 = new DaftarObj2({
	prefix : 'rkbmdPersediaan_ins_v3',
	url : 'pages.php?Pg=rkbmdPersediaan_ins_v3',
	formName : 'rkbmdPersediaan_ins_v3Form',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPersediaan_ins_v3.refreshList(true);
				}
			});
		}else{
				...
				success: function(data) {
					...
					if(resp.err==''){
						...
						if (confirm('Input Lagi ?')) {
								rkbmdPersediaan_ins_v3.CariBarang();
						}
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaan_ins_v3.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaan_ins_v3.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaan_ins_v3.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaan_ins_v3.closeTab();';
