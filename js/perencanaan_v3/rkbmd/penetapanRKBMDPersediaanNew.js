var penetapanRKBMDPersediaanNewSkpd = new SkpdCls({
	prefix : 'penetapanRKBMDPersediaanNewSkpd',
	formName: 'penetapanRKBMDPersediaanNewForm',
	pilihBidangAfter : function(){penetapanRKBMDPersediaanNew.refreshList(true);},
	pilihUnitAfter : function(){penetapanRKBMDPersediaanNew.refreshList(true);},
	pilihSubUnitAfter : function(){penetapanRKBMDPersediaanNew.refreshList(true);},
	pilihSeksiAfter : function(){penetapanRKBMDPersediaanNew.refreshList(true);}
});

var penetapanRKBMDPersediaanNew = new DaftarObj2({
	prefix : 'penetapanRKBMDPersediaanNew',
	url : 'pages.php?Pg=penetapanRKBMDPersediaanNew',
	formName : 'penetapanRKBMDPersediaanNewForm',
	...
	daftarRender:function(){
		var jenisKegiatan = document.getElementById('cmbJenispenetapanRKBMDPersediaanNew');
		/*cmbJenispenetapanRKBMDPersediaanNew.remove(0);*/
	...
	remove:function(){
		...
		if(errmsg ==''){
			...
			$.ajax({
			  ...
			  success: function(data) {
					var resp = eval('(' + data + ')');
					penetapanRKBMDPersediaanNew.refreshList(true);
	...
	Baru: function(){
		var me = this;
		var err='';
		var urusan = document.getElementById('penetapanRKBMDPersediaanSkpdfmUrusan').value; 
		var bidang = document.getElementById('penetapanRKBMDPersediaanSkpdfmSKPD').value; 
		var skpd = document.getElementById('penetapanRKBMDPersediaanSkpdfmUNIT').value;
			...
			url: this.url+'&tipe=Report',
		  	success: function(data) {
				...
				if(resp.err==''){
					...
					aForm.action= url2+'&tipe='+resp.content.to+'&urusan='+$("#penetapanRKBMDPersediaanSkpdfmUrusan").val()+'&bidang='+$("#penetapanRKBMDPersediaanSkpdfmSKPD").val()+'&skpd='+$("#penetapanRKBMDPersediaanSkpdfmUNIT").val()+'&kota='+resp.content.namaPemda+'&tanggalCetak='+resp.content.cetakjang+'&ttd='+resp.content.ttd;
					aForm.target='_blank';
					aForm.submit();
					aForm.target='';
					me.Close();
	...
	bantu : function(id){
		...
		$("#bantu"+id).text(penetapanRKBMDPersediaanNew.formatCurrency(angka));
	},
			...
			url: this.url+'&tipe=Report',
		  	success: function(data) {
				...
				if(resp.err==''){
					...
					aForm.action= url2+'&tipe='+resp.content.to+'&xls=1'+'&urusan='+$("#penetapanRKBMDPersediaanSkpdfmUrusan").val()+'&bidang='+$("#penetapanRKBMDPersediaanSkpdfmSKPD").val()+'&skpd='+$("#penetapanRKBMDPersediaanSkpdfmUNIT").val()+'&kota='+resp.content.namaPemda+'&tanggalCetak='+resp.content.cetakjang+'&ttd='+resp.content.ttd;
					aForm.target='_blank';
					aForm.submit();
					aForm.target='';
					me.Close();
