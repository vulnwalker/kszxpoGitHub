var rkbmdPersediaanPerubahan_ins_v3SKPD = new SkpdCls({
	prefix : 'rkbmdPersediaanPerubahan_ins_v3SKPD', formName:'rkbmdPersediaanPerubahan_ins_v3Form', kolomWidth:120,
...
var rkbmdPersediaanPerubahan_ins_v3 = new DaftarObj2({
	prefix : 'rkbmdPersediaanPerubahan_ins_v3',
	url : 'pages.php?Pg=rkbmdPersediaanPerubahan_ins_v3',
	formName : 'rkbmdPersediaanPerubahan_ins_v3Form',
		...
		if(document.getElementById('q').disabled == true){
			$.ajax({
				...
				success: function(data) {
					...
					$("#q").val('');
					$("#program").val('');
					rkbmdPersediaanPerubahan_ins_v3.refreshList(true);
				}
			});
		}else{
    ...
    CariProgram: function(idRenja){
		...
		popupProgramRKBMD_v3.kategori = "PENGADAAN";
		popupProgramRKBMD_v3.windowShow();

	},
	CariBarang: function(){
		var me = this;
		popupBarangRKBMDPersediaan_v3.windowShow();
	...
	edit : function(id){
		$.ajax({
				...
				success: function(data) {
					...
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanPerubahan_ins_v3.subEdit('+id+');';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanPerubahan_ins_v3.subCancel();';
	...
	subCancel : function(){
					...
					$("#satuanBarang").val('');
					$("#keterangan").val('');
					document.getElementById('btsave').href = 'javascript:rkbmdPersediaanPerubahan_ins_v3.Simpan();';
					document.getElementById('btcancel').href = 'javascript:rkbmdPersediaanPerubahan_ins_v3.closeTab();';
