...
var rkbmdPersediaanPerubahan_v3 = new DaftarObj2({
	...
	koreksiAlasanPerubahan:function(id){
		...
		$("#save"+id).html("<img src='datepicker/save.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_v3.submitKoreksiAlasanPerubahan('"+id+"');></img> &nbsp  &nbsp <img src='images/administrator/images/invalid.png' width='20px' heigh='20px' style='cursor : pointer;' onclick=rkbmdPersediaanPerubahan_v3.cancelKoreksi('"+id+"');></img> ");
	},
