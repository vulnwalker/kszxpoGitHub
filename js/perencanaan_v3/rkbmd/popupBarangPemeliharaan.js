var popupBarangPemeliharaan_v3 = new DaftarObj2({
	prefix : 'popupBarangPemeliharaan_v3',
	url : 'pages.php?Pg=popupBarangPemeliharaan_v3',
	formName : 'popupBarangPemeliharaan_v3Form',
	...
	windowSave: function(id){
		...
		/*var errmsg = this.CekCheckbox();*/
			...
			addCoverPage2(cover,1,true,false);
			$.ajax({
				url: 'pages.php?Pg=popupBarangPemeliharaan_v3&tipe=getdata&id='+id,
				type : 'POST',
				data : {c1 : c1, c : c, d : d,e : e,e1 : e1},
			  	success: function(data) {
					...
					if(resp.err==''){
						...
						me.windowClose();
						rkbmd_pemeliharaan_v3.Simpan(resp.content.kodeBarang);
					}else{
						alert(resp.err)
					}
			  	}
