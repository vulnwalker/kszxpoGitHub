var pemasukan_ins_det = new DaftarObj2({
	prefix : 'pemasukan_ins_det',
	url : 'pages.php?Pg=pemasukan_ins_det', 
	formName : 'pemasukan_ins_detForm',
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#pemasukan_ins_det_form').serialize(),
