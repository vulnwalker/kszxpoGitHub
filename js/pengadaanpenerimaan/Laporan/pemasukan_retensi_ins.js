var pemasukan_retensi_baru_ins = new DaftarObj2({
	prefix : 'pemasukan_retensi_baru_ins',
	url : 'pages.php?Pg=pemasukan_retensi_baru_ins', 
	formName : 'pemasukan_retensi_baru_insForm',
	...
	Simpan: function(){
		...
		$.ajax({
			type:'POST', 
			data:$('#pemasukan_retensi_baru_ins_form').serialize(),
