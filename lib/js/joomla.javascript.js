...
function checkAll1( n, fldName ,fldChecked) {
...
function checkAll1b( n, fldName ,fldChecked, elcheckbox) {
  ...
  if (!fldName) {
   ...
   if (!fldChecked) {
	...
	if (c) {
		//document.adminForm.boxchecked.value = n2;
		document.getElementById(elcheckbox).value = n2;
	} else {
		//document.adminForm.boxchecked.value = 0;
		document.getElementById(elcheckbox).value = 0;
	}
}

function checkAll2( n, fldName, m) {
...
function CheckAll3( n, fldName, m) {
//unchek all except m
...
function isChecked2(isitchecked, elname){
	if (isitchecked == true){
		//document.adminForm.boxchecked.value++;
