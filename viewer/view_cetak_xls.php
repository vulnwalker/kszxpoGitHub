...
<tr><td colspan=6 class='judulcetak'>
<div align='center'>
...
list($rekap->listtable, $jmlData) =  
	getList_RekapByOPD2_xls2($SPg, $noawal, $LimitHal, '', TRUE, '',$tgl);
