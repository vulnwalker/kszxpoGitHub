...
echo "/*<br>";
echo "CEK KIB B<br>";
$sqry = "select * from v_cek_kibb_dbl where jml>=2 ";
...
$cntx=0;
	...
	$xqry = "select id,a1,a,b,c,d,e,e1,f,g,h,i,j,tahun,noreg,idbi from kib_b where a1<>'' $kondisi ";
...
//	if ($cntx==1) $old_bi=$delisi['idbi'];
	...
	{
		$qrydelkib="delete from kib_b where id='".$delisi['id']."'";
